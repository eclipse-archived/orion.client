		...
		var deleteCommand = new mCommands.Command({
			...
			callback: function(data) {
				...
				if(Array.isArray(item) && item.length > 1){
					if(confirm(i18nUtil.formatMessage(messages["Are you sure you want to delete these ${0} users?\n\nWARNING: This will delete the users' workspaces and projects!"], item.length))){
					...
					if (confirm(i18nUtil.formatMessage(messages["Are you sure you want to delete user ${0}?\n\nWARNING: This will delete the user's workspaces and projects!"], item.login))) {

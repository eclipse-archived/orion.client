...
define({
	...
	"Find User": "Find User",
	"Delete User": "Delete User",
	"Are you sure you want to delete these ${0} users?\n\nWARNING: This will delete the users' workspaces and projects!": "Are you sure you want to delete these ${0} users?\n\nWARNING: This will delete the users' workspaces and projects!",
	"Are you sure you want to delete user ${0}?\n\nWARNING: This will delete the user's workspaces and projects!": "Are you sure you want to delete user ${0}?\n\nWARNING: This will delete the user's workspaces and projects!",

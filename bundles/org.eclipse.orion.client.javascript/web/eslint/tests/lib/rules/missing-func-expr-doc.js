...
describe(RULE_ID, function() {
	...
	it("Should not flag missing functioon doc for member expression assignment", function() {
	...
	it("Should not flag missing functioon doc for member literal expression assignment", function() {
		var topic = "var Foo; /***/Foo[\'bar\'] = function() {};";
	...
	it("Should not flag missing functioon doc for member expression assignment excessive space", function() {
		var topic = "var Foo; /***/\n\n\n\n\nFoo.bar = function() {};";
	...
	it("Should not flag missing functioon doc for member literal expression assignment excessive space", function() {
		var topic = "var Foo; /***/\n\n\n\n\nFoo[\'bar\'] = function() {};";
	...
	it("Should not flag missing functioon doc for member expression assignment line comment", function() {
	...
	it("Should not flag missing functioon doc for member literal expression assignment line comment", function() {
		var topic = "var Foo; //comment\nFoo[\'bar\'] = function() {};";
	...
	it("Should not flag missing functioon doc for member expression assignment line comment excessive space", function() {
		var topic = "var Foo; //comment\n\n\n\n\n\nFoo.bar = function() {};";
	...
	it("Should not flag missing functioon doc for member literal expression assignment line comment excessive space", function() {
		var topic = "var Foo; //comment\n\n\n\n\n\nFoo[\'bar\'] = function() {};";
	...
	describe("Found missing documentation problems", function() {
		...
		it("Should flag missing documentation for function member", function() {
		...
		it("Should flag missing documentation for function literal member", function() {
			var topic = "var Foo; Foo[\'member\'] = function() {};";

...
'./rules/no-extend-native'
		...
		noObjCalls, noSelfCompare, noIrregularWhitespace, noConstAssign, noImplicitCoercion, noExtendNative) {
    ...
    var rules = {
		...
		"no-extra-bind": function(context) {
			var scopeInfo = null;

...
define({
	...
	'no-caller': '“arguments.${0}”已被弃用。', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'no-fallthrough' : '输入的 switch case 可能与先前的 case 交叉。', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'no-shadow' : '“${0}”已在上层作用域中声明。', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'radix': '缺少 radix 参数。', //$NON-NLS-0$  //$NON-NLS-1$

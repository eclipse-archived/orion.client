...
define({
	...
	'no-caller': '\'arguments.${0}\' est obsolète.', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'no-fallthrough' : 'Une instruction switch case peut être indiquée en effectuant un fall-through au cas précédent.', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'no-shadow' : '\'${0}\' est déjà déclaré dans la portée supérieure.', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'radix': 'Paramètre de base manquant.', //$NON-NLS-0$  //$NON-NLS-1$

...
/*eslint-env amd */
define({
    'syntaxErrorIncomplete': 'Errore di sintassi,  istruzione incompleta',  //$NON-NLS-0$  //$NON-NLS-1$
    'syntaxErrorBadToken': 'Errore di sintassi sul token \'${0}\', eliminare questo token.',  //$NON-NLS-0$  //$NON-NLS-1$
    'esprimaParseFailure': 'Esprima non è riuscito ad analizzare questo file perché si è verificato un errore: ${0}',  //$NON-NLS-0$ //$NON-NLS-1$
    'eslintValidationFailure': 'La convalida di questo file da parte di ESLint non è riuscita a causa di un errore: ${0}',  //$NON-NLS-0$  //$NON-NLS-1$
	'curly': 'L\'istruzione deve essere racchiusa tra parentesi.',  //$NON-NLS-0$  //$NON-NLS-1$
	...
	'no-unreachable' : 'Codice non raggiungibile.', //$NON-NLS-0$  //$NON-NLS-1$
	'no-unused-params' : 'Il parametro \'${0}\' non è mai utilizzato.', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'valid-typeof' : 'Confronto typeof non valido.',  //$NON-NLS-0$ //$NON-NLS-1$
});

...
define({
	...
	'no-caller': '\'引數。${0}\' 已淘汰。', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'no-fallthrough' : '上一個 case 失敗會進入 Switch case。', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'no-shadow' : '\'${0}\' 已經在上方範圍中宣告。', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'radix': '遺漏基數參數。', //$NON-NLS-0$  //$NON-NLS-1$

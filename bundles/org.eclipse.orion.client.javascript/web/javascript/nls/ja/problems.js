...
define({
	...
	'no-caller': '\'arguments.${0}\' は使用すべきではありません。', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'no-fallthrough' : 'switch 文において、case ラベルの処理後に break などが抜けている可能性があります。', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'no-shadow' : '\'${0}\' は既に上位のスコープで宣言されています。', //$NON-NLS-0$  //$NON-NLS-1$
	...
	'radix': '基数パラメーターが欠落しています。', //$NON-NLS-0$  //$NON-NLS-1$

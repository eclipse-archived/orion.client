...
/*global dojo console document window confirm */
...
confirmOpenId = function(openid) {
	if (openid !== "" && openid !== null) {
		win = window.open("../mixlogin/manageopenids/openid?openid=" + encodeURIComponent(openid), "openid_popup", "width=790,height=580");
	}

...
define("orion/service",["dojo"], function(dojo){
	...
	return {
		ServiceReference : eclipse.ServiceReference,
		Service: eclipse.Service,
		ServiceRegistry: eclipse.ServiceRegistry,
		ServiceRegistration: eclipse.ServiceRegistration,
		EventTarget: eclipse.EventTarget
	};

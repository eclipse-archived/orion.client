...
define("testcase", ["orion/assert", "orion/service", "orion/plugin"], function(assert, mService, mPlugin) {
	var tests = {};
	
	tests["test empty registry"] = function() {
		var storage = {};
		var serviceRegistry = new mService.ServiceRegistry();
		var pluginRegistry = new mPlugin.PluginRegistry(serviceRegistry, storage);

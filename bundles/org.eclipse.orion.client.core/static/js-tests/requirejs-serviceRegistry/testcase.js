...
define("testcase", ["orion/assert", "orion/service"], function(assert, service) {
	var tests = {};
	tests.testRegisterAndGetService = function() {
		var count = 0;

		var registry = new service.ServiceRegistry();
	...
	tests.testRegisterUnregisterMultipleServices = function() {
		...
		var serviceRegistry = new service.ServiceRegistry();

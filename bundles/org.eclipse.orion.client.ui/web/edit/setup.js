	...
	createInputManager: function() {
		var inputManager = this.inputManager = new mInputManager.InputManager({
			...
			confirm:function(message,onCancel,additionalButtonStringCallList,afterBlockCallBack){
				this.commandRegistry.confirmWithAdditionButtons(this.domNode, message, "Don't Save", "Cancel", null, onCancel, additionalButtonStringCallList, afterBlockCallBack);
			}.bind(this),

...
define(["chai/chai", "orion/Deferred"/*, "orion/test"*/], function(chai, Deferred/*, mTest*/) {
	...
	describe("Test RunAsynch", function() {
		// dummy change
		it("test basic synch", function() {});

		it("test basic asynch", function() {
			var d = new Deferred();
			setTimeout(function() {
				assert.ok(true);
				d.resolve();
		...
		it.skip("test expected asynch failure", function() {
		...
		it("test basic asynch2", function() {
			var d = new Deferred();
			setTimeout(function() {
				d.resolve();
			}, 100);
		...
		it("test expected asynch2 failure", function() {
			var d = new Deferred();
			setTimeout(function() {
				d.resolve();
			}, 100);
		...
		it.skip("test basic list", function() {
			var listTests = {
				"test 1": function() {},
					"test obj": {
					"test2": function() {}
		...
		it("test blow stack with promise", function() {
		...
		it("test blow stack with value", function() {
			var first = new Deferred(),
				d = first,
				i, recurses = 0,
				max = 1500;
		...
		it("test blow stack with exception", function() {
			var first = new Deferred(),
				d = first,
				i, recurses = 0,
				max = 1500;
		...
		it.skip("test timeout causes reject", function() {
			var timeout = 2000;
			var timeoutTest = {

...
define({//Default message bundle
	...
	"desktopSelectionPolicy": "Desktop Mode (Modifier Keys+Click, Editor Tabs):",
	"desktopSelectionPolicyTooltip": "The mode applies to the cases when a file or folder link is clicked while Ctrl, Shift or Cmd keys are pressed. The file or folder will be selected if this policy is checked. Otherwise the file or folder link will be opened in a new tab or window as the normal web behavior. Editor tab support will also be enabled",
	...
	"textTheme": "...or paste editor themes here",
	"Import": "Import",

					...
					if (commandInvocation.parameters.shouldCollectParameters()) {
						...
						if (!collecting) {
							...
							var focusNode = this._parameterCollector.getFillFunction(commandInvocation, function() {
								...
								tooltip.destroy();
								if (commandInvocation.domParent) commandInvocation.domParent.classList.remove("parameterPopupOpen");
							}, cancelCallback)(parameterArea);
							tooltip.show();
							if (commandInvocation.domParent) commandInvocation.domParent.classList.add("parameterPopupOpen");
							if (focusNode) {
								window.setTimeout(function() {
										focusNode.focus();
										if (focusNode.select) {

	...
	objects.mixin(Sidebar.prototype, /** @lends orion.sidebar.Sidebar.prototype */ {
		...
		_createInlineSearchPane: function() {
 		...
 		_createBookmarkSearchPane: function() {
			...
			this.commandRegistry.addCommand(openSearchCommand);
			this.commandRegistry.registerCommandContribution(this.editScope, "orion.openbookmarkSearch", 102, "orion.menuBarEditGroup/orion.findGroup", false, new mKeyBinding.KeyBinding('k', true, true)); //$NON-NLS-2$ //$NON-NLS-1$ //$NON-NLS-3$
 		}
	});

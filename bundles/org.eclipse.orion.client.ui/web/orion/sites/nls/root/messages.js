...
define({
	...
	"Sites": "Sites",
	"Mappings": "Mappings",
	// The create button will be inserted between the pre and post text
	"SitesExplorer.NoSitesPreText" : "You have no sites. Click",
	"SitesExplorer.NoSitesPostText" : "to create a site."
});

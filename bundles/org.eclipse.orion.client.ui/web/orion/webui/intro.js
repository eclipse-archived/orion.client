...
define(["orion/webui/littlelib",
		"text!orion/webui/intro.json",
		"i18n!orion/nls/messages",
		"marked/marked"
	],
	function(lib, tutorialJson, messages, Markdown) {
		...
		Intro.prototype = /** @lends orion.webui.Intro.prototype */ {
			...
			IntroTemplate: '<div class="tutorialModal">' +
				'<div id="tutorialSkip" class="tutorialClose">Skip</div>' +
				'<div class="tutorialContent">' +
				'<div id="tutorialTitle" class="tutorialTitle"></div>' +
				'<img id="tutorialImg" class="tutorialImg" alt=""/>' +
				'<div id="tutorialDescription" class="tutorialDescription"></div>' +
				'<a id="tutorialBack" class="tutorialBack"></a>' +
				'<a id="tutorialForward" class="tutorialForward"></a>' +
				'</div>' +
				'<div class="controlButtons">' +
				'<div id="turorialProgress" class="turorialProgress"></div>' +
				'</div>' +
				'</div>',
			...
			initializeTutorialModal: function(id) {
				...
				var frameFragment = range.createContextualFragment(this.IntroTemplate);
			...
			registerButtonsAndInitialImg: function(id) {
				var self = this;
				var tutorial = JSON.parse(tutorialJson).tutorials.find(function(each) {
					return each.id === id;
				});
			...
			showNotifications: function() {
				...
				var seenTutorialIDs = JSON.parse(localStorage.getItem("seenTutorials")) || [];
				var notSeenTutorials = JSON.parse(tutorialJson).tutorials.map(function(tutorial) {

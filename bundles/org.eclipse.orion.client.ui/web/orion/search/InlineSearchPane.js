...
define([
	...
	objects.mixin(InlineSearchPane.prototype, /** @lends orion.search.InlineSearchPane.prototype */ {
		...
		_initControls: function(){
			...
			if (this._replaceBoxIsHidden()) {
	        	this._toggleReplaceLink.classList.remove("checkedReplaceModeButton"); //$NON-NLS-0$	
	        }
		...
		_initToolTips: function(){
			generateTooltips(this._toggleReplaceLink,messages["Replace Mode Tooltip"]);
			generateTooltips(lib.$("#advSearchCaseSensitiveLabel", this._searchWrapper),messages["Case sensitive"]);
			generateTooltips(lib.$("#advSearchWholeWordLabel", this._searchWrapper),messages["Whole Word"]);
			generateTooltips(lib.$("#advSearchRegExLabel", this._searchWrapper),messages["Regular expression"]);
			generateTooltips(lib.$("#searchScopeSelectButton", this._searchWrapper),messages["Choose a Folder"]);
			generateTooltips(this._previewButtonSpan,messages["Show replacement preview"]);
			generateTooltips(lib.$("#advSearchScopeSelectedLabel", this._searchWrapper),messages["Current Folder Tooltip"]);
			generateTooltips(lib.$("#advSearchScopeProjectLabel", this._searchWrapper),messages["Root Folder Tooltip"]);
			generateTooltips(lib.$("#advSearchScopeAllProjectLabel", this._searchWrapper),messages["All Folders Tooltip"]);
			generateTooltips(lib.$("#advSearchScopeOtherLabel", this._searchWrapper),messages["Other Folder Tooltip"]);
			generateTooltips(lib.$("#fileNamePatternsLabel", this._searchWrapper),messages["File Patterns Box Tooltip"]);
			generateTooltips(lib.$("#excludeFilesLabel", this._searchWrapper),messages["Exclude Files Box Tooltip"]);
			function generateTooltips(node,message){
		...
		_showReplaceField: function() {
			...
			this._toggleReplaceLink.classList.add("checkedReplaceModeButton");
		},
		...
		_hideReplaceField: function() {
			...
			this._toggleReplaceLink.classList.remove("checkedReplaceModeButton");
			this.hideReplacePreview();
		},

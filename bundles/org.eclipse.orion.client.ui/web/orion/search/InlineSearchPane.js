...
define([
	...
	objects.mixin(InlineSearchPane.prototype, /** @lends orion.search.InlineSearchPane.prototype */ {
		...
		setOtherSearchScope: function(scope){
			...
			localStorage.setItem("/inlineSearchOtherScope", scope.Location);
		},
		...
		updateScopeOptions: function(scopeOption){
			switch(scopeOption){
				...
				case "all_project":
					...
					this.setSearchScope("/file");
					break;
				case "other":
					this._searchScopeOther.checked = true;
					this.setSearchScope(this._getOtherScope());
					break;
			}
		},
		...
		_getOtherScope: function(){
			return this._otherScope || localStorage.getItem("/inlineSearchOtherScope") || "/file";
		},

...
define([
	...
	objects.mixin(InlineSearchPane.prototype, /** @lends orion.search.InlineSearchPane.prototype */ {
		...
		_initHTMLLabels: function(){
			...
			lib.$("#advSearchCaseSensitiveLabel", this._searchWrapper).title = messages["Case sensitive Tooltip"]; //$NON-NLS-1$ //$NON-NLS-0$
			lib.$("#advSearchWholeWordLabel", this._searchWrapper).title = messages["Whole Word Tooltip"]; //$NON-NLS-1$ //$NON-NLS-0$
			lib.$("#advSearchRegExLabel", this._searchWrapper).title = messages["Regular expression Tooltip"]; //$NON-NLS-1$ //$NON-NLS-0$
//			lib.$("#advSearchCaseSensitiveLabel", this._searchWrapper).appendChild(document.createTextNode(messages["Case sensitive Icon"]));
//			lib.$("#advSearchWholeWordLabel", this._searchWrapper).appendChild(document.createTextNode(messages["Whole Word Icon"]));
//			lib.$("#advSearchRegExLabel", this._searchWrapper).appendChild(document.createTextNode(messages["Regular expression Icon"]));

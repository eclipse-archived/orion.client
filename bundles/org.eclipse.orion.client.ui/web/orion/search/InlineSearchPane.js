...
define([
	...
	objects.mixin(InlineSearchPane.prototype, /** @lends orion.search.InlineSearchPane.prototype */ {
		...
		_initToolTips: function(){
			this._generateTooltips(lib.$("#advSearchCaseSensitiveLabel", this._searchWrapper),messages["Case sensitive"]);
			this._generateTooltips(lib.$("#advSearchWholeWordLabel", this._searchWrapper),messages["Whole Word"]);
			this._generateTooltips(lib.$("#advSearchRegExLabel", this._searchWrapper),messages["Regular expression"]);
			this._generateTooltips(lib.$("#searchScopeSelectButton", this._searchWrapper),messages["Choose a Folder"]);
			this._generateTooltips(this._previewButtonSpan,messages["Show replacement preview"]);
		...
		_showReplaceField: function() {
			...
			this._toRaplceModeToolTip.destroy();
		...
		_hideReplaceField: function() {
			...
			this._toSearchModeToolTip.destroy();
			this._toRaplceModeToolTip = this._generateTooltips(this._toggleReplaceLink,messages["To Replace Mode Tooltip"]);
			this.hideReplacePreview();
		},

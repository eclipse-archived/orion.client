                    ...
                    for (var k = 0; k < target.length; k++) {
                        if (target[k].trim() === "Comment") { //$NON-NLS-0$
                            ...
                            if (restKey[i].dict.key instanceof Array) {
                                for (l = 0; l< restKey[i].dict.key.length; l++) {
                                    if (restKey[i].dict.key[l]["#text"] === "foreground") { //$NON-NLS-0$
                                        newStyle.styles.markup.italic.color = restKey[i].dict.string[l]["#text"];
                                ...
                                if (restKey[i].dict.key["#text"] === "foreground") { //$NON-NLS-0$
                                    newStyle.styles.markup.italic.color = restKey[i].dict.string["#text"];
                            ...
                            if (restKey[i].dict.key instanceof Array) {
                                for (l = 0; l< restKey[i].dict.key.length; l++) {
                                    if (restKey[i].dict.key[l]["#text"] === "foreground") { //$NON-NLS-0$
                                        ...
                                        newStyle.styles.markup.underline.link.color = restKey[i].dict.string[l]["#text"];
                                    }
                                }
                            }
                            else {
                                if (restKey[i].dict.key["#text"] === "foreground") { //$NON-NLS-0$
                                    ...
                                    newStyle.styles.markup.underline.link.color = restKey[i].dict.string["#text"];
                                }
                            }
                        }
                    ...
                    try{
                        ...
                        if (classes[l].substr(classes[l].length - scrollString.length) === scrollString) { //$NON-NLS-0$
                            ...
                            if (rules[i].style.color) {
                                ...
                                // Brackets styles markdown links as strings
                                newStyle.styles.markup.underline.link.color = newStyle.styles.string.color;
                            }
                        }

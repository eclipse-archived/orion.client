	...
	ThemePreferences.prototype = /** @lends orion.editor.ThemePreferences.prototype */ {
		...
		getTheme: function(callback) {
			...
			return themeData.getThemeVersion().then(function(themeVersion) {
				this._preferences.get(themeInfo.storage).then(function(prefs) {
					this._initialize(themeInfo, themeData, themeVersion, prefs).then(function() {
						...
						this._getCurrentStyle(styles, selected[themeInfo.selectedKey]).then(function (style) {

...
define(['i18n!orion/settings/nls/messages', 'orion/objects', 'orion/webui/littlelib'], function(messages, objects, lib) {
	...
	objects.mixin(ServiceCarousel.prototype, {
		...
		templateString:'<div class="plugin-service-carousel" ><div class="serviceContainer"><div class="serviceContainerClosed" tabindex="0" role="button" aria-pressed="false"><span class="serviceCount">0</span><span>${Services}</span></div>' + //$NON-NLS-2$ //$NON-NLS-0$
						'</div>' + //$NON-NLS-0$

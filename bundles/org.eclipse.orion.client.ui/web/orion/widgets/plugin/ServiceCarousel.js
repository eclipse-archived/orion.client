...
define(['i18n!orion/settings/nls/messages', 'orion/objects', 'orion/webui/littlelib'], function(messages, objects, lib) {
	...
	objects.mixin(ServiceCarousel.prototype, {
		...
		templateString:'<div class="plugin-service-carousel" tabindex="-1"><div class="serviceContainer"><div class="serviceContainerClosed" tabindex="0" role="button" aria-pressed="false">${Services}</div>' + //$NON-NLS-2$ //$NON-NLS-0$

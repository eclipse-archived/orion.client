...
define([
	...
	objects, lib, messages, mSlideout,mBookmarksExplorer
) {
	...
	objects.mixin(BookmarkSearchPane.prototype, /** @lends orion.search.InlineSearchPane.prototype */ {
		_initialize: function() {
			...
			var BookmarkSearchPaneTemplate= '' +  //$NON-NLS-0$
				'<div class="searchBookmarksFilter"></div>' +	//$NON-NLS-0$
				'<div class="searchBookmarksActions"></div>' +	//$NON-NLS-0$
				'<div class="searchBookmarksList"></div>';	//$NON-NLS-0$

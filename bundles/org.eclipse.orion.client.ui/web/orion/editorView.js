	...
	EditorView.prototype = /** @lends orion.EditorView.prototype */ {
		...
		updateSettings: function(prefs) {
			...
			annotationModel.addEventListener("Changed", function(e) {
					if (e.changed.some(function(annotation) {return annotation.type === "orion.annotation.bookmark";	}))	{
					...
					if (e.removed.some(function(annotation) {return annotation.type === "orion.annotation.bookmark";	})) {
			...
			editor.addEventListener("InputChanged", function(evt) {
				if (!evt.contentsSaved) {
					if(localStorage.bookmarks){
						...
						var thisfileBookmarks = allBookmarks[editor.getTitle()];

			...
			switch(searchScope){
				case "selected":
					if(this._searchLocation_selected){
						...
						return this._searchLocation_selected.Location !== "/workspace/orionode" ? this._searchLocation_selected.Location : this._fileClient.fileServiceRootURL();
					}
					break;
				case "project":
					if(this._searchLocation_project){
						return this._searchLocation_project.Location !== "/workspace/orionode" ? this._searchLocation_selected.Location : this._fileClient.fileServiceRootURL();
					}
					break;
				case "workspace":

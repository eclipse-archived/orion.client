...
define([
	...
	Searcher.prototype = /**@lends orion.searchClient.Searcher.prototype*/ {
		...
		setLocationByMetaData: function(meta, useParentLocation){
			...
			if(noneRootMeta){
				this.setGeneralLocationbyURL(noneRootMeta.Location);
				locationName = noneRootMeta.Name;
				this._childrenLocation = noneRootMeta.ChildrenLocation;
			} else if(meta){
				this.setGeneralLocationbyURL(this._searchRootLocation);
		...
		setGeneralLocationbyURL: function(locationURL){
		...
		createSearchParams: function(keyword, nameSearch, useRoot, advancedOptions, searchScope)  {
			...
			return {
				...
				excludeFiles: (advancedOptions && advancedOptions.excludeFiles) ? advancedOptions.excludeFiles : undefined,
				keyword: keyword,

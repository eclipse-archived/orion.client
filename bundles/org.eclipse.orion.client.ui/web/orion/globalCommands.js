...
define([
	...
	var customGlobalCommands = {
		createMenuGenerator: mCustomGlobalCommands.createMenuGenerator || function (serviceRegistry, keyAssistFunction) {
			...
			if (util.isElectron) {
				lib.node("userTrigger").innerHTML = "<span class=\"commandSprite core-sprite-questionmark\" style=\"height: 22px;\"></span>";
			}
			else {
				lib.node("userTrigger").innerHTML = "<span class=\"commandSprite core-sprite-silhouette\"></span>";
			}

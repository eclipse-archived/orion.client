...
function(l,r,p,h,e,c,b,k,m,g,a,t,f,n,d,u,s,v,y,F,z,D,B,C,q,x,w,E,K,O,H,I,G){function M(a){this._parent=a.parent;this.id=a.id||"";this.activateContext=a.activateContext;this.renderToolbars=a.renderToolbars;this.serviceRegistry=a.serviceRegistry;this.contentTypeRegistry=a.contentTypeRegistry;this.commandRegistry=a.commandRegistry;this.progress=a.progress;this.statusService=a.statusService;this.editorCommands=a.editorCommands;this.fileClient=a.fileService;this.inputManager=a.inputManager;this.preferences=
a.preferences;this.readonly=a.readonly;this.searcher=a.searcher;this.statusReporter=a.statusReporter;this.model=a.model;this.undoStack=a.undoStack;this.problemsServiceID=a.problemsServiceID||"orion.core.marker";this.editContextServiceID=a.editContextServiceID||"orion.edit.context";this.syntaxHighlighter=new D.SyntaxHighlighter(this.serviceRegistry);this.typeDefRegistry=new z(this.serviceRegistry);(a=v.getKeyAssist?v.getKeyAssist():null)&&a.addProvider(this.editorCommands);var b=v.getMainSplitter?
v.getMainSplitter():null;b&&b.splitter.addEventListener("resize",function(a){this.editor&&a.node===b.main&&this.editor.resize()}.bind(this));v.getGlobalEventTarget&&v.getGlobalEventTarget().addEventListener("toggleTrim",function(){this.editor&&this.editor.resize()}.bind(this));this.settings={};this._init()}var Q=y.Dispatcher;M.prototype={updateKeyMode:function(b,c){this.emacs&&c.removeKeyMode(this.emacs);this.vi&&c.removeKeyMode(this.vi);"Emacs"===b.keyBindings?(this.emacs||(this.emacs=new g.EmacsMode(c)),
c.addKeyMode(this.emacs)):"vi"===b.keyBindings&&(this.vi||(this.vi=new a.VIMode(c,this.statusReporter)),c.addKeyMode(this.vi))},setContents:function(a,b){var c=this.contentTypeRegistry.getContentType(b),d="txt";c&&(c.extension&&0<c.extension.length)&&(d=c.extension[0]);var e="/__embed/"+this.id+"/foo."+d;return(e===this.lastFileLocation||!this.lastFileLocation?(new H).resolve():this.fileClient.deleteFile(this.lastFileLocation)).then(function(){return this.fileClient.write(e,a).then(function(){this.lastFileLocation=
e;this.inputManager.setInput(e)}.bind(this))}.bind(this))},getParent:function(){return this._parent},getSettings:function(){return this.settings},setParent:function(a){this._parent=a},updateSourceCodeActions:function(a,b){b&&(b.setAutoPairParentheses(a.autoPairParentheses),b.setAutoPairBraces(a.autoPairBraces),b.setAutoPairSquareBrackets(a.autoPairSquareBrackets),b.setAutoPairAngleBrackets(a.autoPairAngleBrackets),b.setAutoPairQuotations(a.autoPairQuotations),b.setAutoCompleteComments(a.autoCompleteComments),
b.setSmartIndentation(a.smartIndentation))},updateViewOptions:function(a){var b=0;a.showMargin&&(b=a.marginOffset,"number"!==typeof b&&(b=a.marginOffset=parseInt(b,10)));var c=0;a.wordWrap&&(c=b);return{readonly:this.readonly||this.inputManager.getReadOnly(),tabSize:a.tabSize||4,expandTab:a.expandTab,wrapMode:a.wordWrap,wrapOffset:c,marginOffset:b,scrollAnimation:a.scrollAnimation?a.scrollAnimationTimeout:0}},updateSettings:function(a){this.settings=a;var b=this.editor,c=this.inputManager;c.setAutoLoadEnabled(a.autoLoad);
c.setAutoSaveTimeout(a.autoSave?a.autoSaveTimeout:-1);c.setSaveDiffsEnabled(a.saveDiffs);this.differ.setEnabled(this.settings.diffService);this.updateStyler(a);var d=b.getTextView();d&&(this.updateKeyMode(a,d),d.setOptions(this.updateViewOptions(a)));this.updateSourceCodeActions(a,b.getSourceCodeActions());b.setAnnotationRulerVisible(a.annotationRuler);b.setLineNumberRulerVisible(a.lineNumberRuler);b.setFoldingRulerVisible(a.foldingRuler);b.setOverviewRulerVisible(a.overviewRuler);b.setZoomRulerVisible(a.zoomRuler);
this.renderToolbars&&this.renderToolbars(c.getFileMetadata());this.markOccurrences.setOccurrencesVisible(a.showOccurrences);b.getContentAssist()&&b.getContentAssist().setAutoTriggerEnabled(a.contentAssistAutoTrigger);this.dispatchEvent({type:"Settings",newSettings:this.settings})},updateStyler:function(a){var b=this.syntaxHighlighter.getStyler();b&&b.setWhitespacesVisible&&b.setWhitespacesVisible(a.showWhitespaces,!0)},recordSession:function(){var a=this.editor,b=a.getTextView(),c=this.inputManager;
if(b&&c&&(c=c.getFileMetadata())){var d=sessionStorage.editorViewSection?JSON.parse(sessionStorage.editorViewSection):{},a=a.getSelections().map(function(a){return a.getOrientedSelection()});d[c.Location]={ETag:c.ETag,topIndex:b.getTopIndex(),selections:a};sessionStorage.editorViewSection=JSON.stringify(d)}},loadSession:function(a){var b=this.editor,c=b.getTextView(),d=this.inputManager;if(c&&d&&(d=d.getFileMetadata())){var e=(sessionStorage.editorViewSection?JSON.parse(sessionStorage.editorViewSection):
{})[d.Location];e&&e.ETag===d.ETag&&(a.session={apply:function(){b.setSelections(e.selections);c.setTopIndex(e.topIndex)}})}},_init:function(){this.preferences&&(this.editorCommands.editorPreferences=this.editorPreferences=this.editorCommands.editorPreferences||new t.EditorPreferences(this.preferences),this.editorPreferences.addEventListener("Changed",function(a){(a=a.preferences)?this.updateSettings(a):this.editorPreferences.getPrefs(this.updateSettings.bind(this))}.bind(this)),this.editorCommands.themePreferences=
this.themePreferences=this.editorCommands.themePreferences||new f.ThemePreferences(this.preferences,new n.ThemeData),this.themePreferences.apply());var a=this,g=this.commandRegistry,p=this.serviceRegistry,v=this.activateContext,y=this.inputManager,z=this.progress,A=this.contentTypeRegistry,D=this.editorCommands,I=function(b,c,d){var e=y.getContentType(),f=b.getTitle();b=p.getServiceReferences("orion.edit.contentAssist").concat(p.getServiceReferences("orion.edit.contentassist"));(d=d&&d.providers)||
(d=b.map(function(a){var b=a.getProperty("contentType"),c=a.getProperty("pattern");if(b&&A.isSomeExtensionOf(e,b)||c&&RegExp(c).test(f)){var b=p.getService(a),c=a.getProperty("service.id").toString(),d=a.getProperty("charTriggers");a=a.getProperty("excludedStyles");d&&(d=RegExp(d));a&&(a=RegExp(a));return{provider:b,id:c,charTriggers:d,excludedStyles:a}}return null}).filter(function(a){return!!a}));var g={};Object.keys(F).forEach(function(b){"function"===typeof F[b]&&(g[b]=F[b].bind(null,p,a.editContextServiceID))});
c.setEditorContextProvider(g);c.setProviders(d);c.setAutoTriggerEnabled(a.settings.contentAssistAutoTrigger);c.setProgress(z);c.setStyleAccessor(a.getStyleAccessor())},H=this.readonly?null:{createContentAssistMode:function(a){var b=new m.ContentAssist(a.getTextView());b.addEventListener("Activating",I.bind(null,a,b));var c=new m.ContentAssistWidget(b,"contentassist"),c=new m.ContentAssistMode(b,c);b.setMode(c);I(a,b);b.initialize();return c}},J=this.editor=new r.Editor({textViewFactory:function(){var b=

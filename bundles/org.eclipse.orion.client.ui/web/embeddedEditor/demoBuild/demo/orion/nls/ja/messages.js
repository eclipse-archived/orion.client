...
define({//Default message bundle
	...
	"Expected '<\\/' and instead saw '</'.": "を希望 '<\\/' and instead saw '</'.",
	"Expected {a} and instead saw {b}.": "${0}を希望 and instead saw ${1}.",
	"Expected '{a}' and instead saw '{b}'.": "を希望 '${0}' and instead saw '${1}'.",
	"Expected a number and instead saw '{a}'.": "を希望 a number and instead saw '${0}'.",
	"Expected a string and instead saw {a}.": "を希望 a string andを希望を希望を希望を希望 instead saw ${0}.",

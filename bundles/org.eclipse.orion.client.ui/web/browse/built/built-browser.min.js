...
(function(f){function m(a,c){var h,d,q,t,A,n,C,k,b,e=c&&c.split("/"),l=r.map,s=l&&l["*"]||{};if(a&&"."===a.charAt(0))if(c){e=e.slice(0,e.length-1);a=e.concat(a.split("/"));for(k=0;k<a.length;k+=1)if(h=a[k],"."===h)a.splice(k,1),k-=1;else if(".."===h)if(1===k&&(".."===a[2]||".."===a[0]))break;else 0<k&&(a.splice(k-1,2),k-=2);a=a.join("/")}else 0===a.indexOf("./")&&(a=a.substring(2));if((e||s)&&l){h=a.split("/");for(k=h.length;0<k;k-=1){d=h.slice(0,k).join("/");if(e)for(b=e.length;0<b;b-=1)if(q=l[e.slice(0,
b).join("/")])if(q=q[d]){t=q;A=k;break}if(t)break;!n&&(s&&s[d])&&(n=s[d],C=k)}!t&&n&&(t=n,A=C);t&&(h.splice(0,A,t),a=h.join("/"))}return a}function p(a,c){return function(){return k.apply(f,y.call(arguments,0).concat([a,c]))}}function b(a){return function(c){return m(c,a)}}function l(a){return function(c){h[a]=c}}function g(a){if(s.call(n,a)){var c=n[a];delete n[a];u[a]=!0;d.apply(f,c)}if(!s.call(h,a)&&!s.call(u,a))throw Error("No "+a);return h[a]}function e(a){var c,h=a?a.indexOf("!"):-1;-1<h&&(c=
a.substring(0,h),a=a.substring(h+1,a.length));return[c,a]}var d,k,c,a,h={},n={},r={},u={},s=Object.prototype.hasOwnProperty,y=[].slice;c=function(a,c){var h,d=e(a),q=d[0],a=d[1];q&&(q=m(q,c),h=g(q));q?a=h&&h.normalize?h.normalize(a,b(c)):m(a,c):(a=m(a,c),d=e(a),q=d[0],a=d[1],q&&(h=g(q)));return{f:q?q+"!"+a:a,n:a,pr:q,p:h}};a={require:function(a){return p(a)},exports:function(a){var c=h[a];return"undefined"!==typeof c?c:h[a]={}},module:function(a){return{id:a,uri:"",exports:h[a],config:function(){return r&&
r.config&&r.config[a]||{}}}}};d=function(d,k,r,b){var q,t,A,e,C=[],y,b=b||d;if("function"===typeof r){k=!k.length&&r.length?["require","exports","module"]:k;for(e=0;e<k.length;e+=1)if(A=c(k[e],b),t=A.f,"require"===t)C[e]=a.require(d);else if("exports"===t)C[e]=a.exports(d),y=!0;else if("module"===t)q=C[e]=a.module(d);else if(s.call(h,t)||s.call(n,t)||s.call(u,t))C[e]=g(t);else if(A.p)A.p.load(A.n,p(b,!0),l(t),{}),C[e]=h[t];else throw Error(d+" missing "+t);k=r.apply(h[d],C);if(d)if(q&&q.exports!==
f&&q.exports!==h[d])h[d]=q.exports;else if(k!==f||!y)h[d]=k}else d&&(h[d]=r)};requirejs=require=k=function(h,n,b,e,q){if("string"===typeof h)return a[h]?a[h](n):g(c(h,n).f);h.splice||(r=h,n.splice?(h=n,n=b,b=null):h=f);n=n||function(){};"function"===typeof b&&(b=e,e=q);e?d(f,h,n,b):setTimeout(function(){d(f,h,n,b)},4);return k};k.config=function(a){r=a;return k};define=function(a,c,d){c.splice||(d=c,c=[]);!s.call(h,a)&&!s.call(n,a)&&(n[a]=[a,c,d])};define.amd={jQuery:!0}})();define("almond",function(){});
define("orion/PageUtil",[],function(){var f=/^http[s]?/i;return{hash:function(){var f=window.location.href.split("#")[1];return f?"#"+f:""},matchResourceParameters:function(f){var f=f||window.location.toString(),p={resource:""},b=f.indexOf("#");if(-1!==b&&(f=f.substring(b+1),0!==f.length)){f=f.split(",");p.resource=decodeURIComponent(f[0]);for(b=1;b<f.length;b++){var l=/([^=]*)(=?)(.*)/.exec(f[b]),g=decodeURIComponent(l[1]||""),l=decodeURIComponent(l[3]||"");""!==g&&"resource"!==g&&(p[g]=l)}}return p},
validateURLScheme:function(m,p){var b=m;if(-1===m.indexOf("://")){var l=document.createElement("a");l.href=m;b=l.href}l=!1;if(l=p?p.some(function(l){return RegExp("^"+l+":","i").test(b)}):f.test(b))return m;console.log("Illegal URL Scheme: '"+m+"'");return""}}});
(function(){function f(p,b,l){for(var g in b)b.hasOwnProperty(g)&&(!p.hasOwnProperty(g)||l)?p[g]=b[g]:"object"===typeof b[g]&&f(p[g],b[g],l)}var m=/(^.*(^|\/)nls(\/|$))([^\/]*)\/?([^\/]*)/;define("i18n",["module"],function(p){var b=p.config?p.config():{};return{version:"2.0.1+",load:function(l,g,e,d){d=d||{};d.locale&&(b.locale=d.locale);var k=m.exec(l),c=k[1],a=k[4],h=k[5],n=a.split("-"),r=[],u={},s,y="";k[5]?(c=k[1],l=c+h):(h=k[4],a=b.locale,a||(a=b.locale="undefined"===typeof navigator?"root":
(navigator.language||navigator.userLanguage||"root").toLowerCase()),n=a.split("-"));if(d.isBuild){r.push(l);d=c+"root/"+h;require._fileExists(g.toUrl(d+".js"))&&r.push(d);for(s=0;s<n.length;s++)d=n[s],y+=(y?"-":"")+d,d=r,k=c+y+"/"+h,require._fileExists(g.toUrl(k+".js"))&&d.push(k);g(r,function(){e()})}else g([l],function(a){var d=[],k;k=c;var b=h;a.root&&(d.push("root"),(!0===a.root||1===a.root)&&r.push(k+"root/"+b));for(s=0;s<n.length;s++){k=n[s];k=y+=(y?"-":"")+k;var b=a,q=r,t=c,A=h;b[k]&&(d.push(k),
(!0===b[k]||1===b[k])&&q.push(t+k+"/"+A))}g(r,function(){var q,t,A;for(q=d.length-1;-1<q&&d[q];q--){A=d[q];t=a[A];if(!0===t||1===t)t=g(c+A+"/"+h);f(u,t)}e(u)})})}}})})();define("orion/i18n",{load:function(f,m,p){m.specified&&m.specified("orion/bootstrap")?m(["orion/i18n!"+f],function(b){p(b)}):p({})}});
...
define("orion/edit/nls/messages",["orion/i18n!orion/edit/nls/messages","orion/edit/nls/root/messages"],function(f,m){var p={root:m};Object.keys(f).forEach(function(b){"undefined"===typeof p[b]&&(p[b]=f[b])});return p});
(function(f,m){"function"===typeof define&&define.amd?define("orion/Deferred",m):"object"===typeof exports?module.exports=m():(f.orion=f.orion||{},f.orion.Deferred=m())})(this,function(){function f(){for(var b;b=l.shift();)b();g=!1}function m(b){l.push(b);g||(g=!0,setTimeout(f,0))}function p(b){return function(){b.apply(void 0,arguments)}}function b(){function e(){for(var c;c=n.shift();){var d=c.deferred,k="fulfilled"===h?"resolve":"reject";if("function"===typeof c[k])try{var r=(0,c[k])(a),b=r&&("object"===
typeof r||"function"===typeof r)&&r.then;if("function"===typeof b)if(r===d.promise)d.reject(new TypeError);else{var e=r.cancel;"function"===typeof e?d._protected(l).parentCancel=e.bind(r):delete d._protected(l).parentCancel;b.call(r,p(d.resolve),p(d.reject),p(d.progress))}else d.resolve(r)}catch(q){d.reject(q)}else d[k](a)}}function d(c){delete u.parentCancel;h="rejected";a=c;n.length&&m(e)}function k(c){function l(q){return function(a){g||(g=!0,q(a))}}var g=!1;delete u.parentCancel;try{var f=c&&
("object"===typeof c||"function"===typeof c)&&c.then;if("function"===typeof f)if(c===r)d(new TypeError);else{h="assumed";var v=c&&c.cancel;if("function"!==typeof v){var p=new b,c=p.promise;try{f(p.resolve,p.reject,p.progress)}catch(q){p.reject(q)}v=c.cancel;f=c.then}a=c;f.call(c,l(k),l(d));u.parentCancel=v.bind(c)}else h="fulfilled",a=c,n.length&&m(e)}catch(t){l(d)(t)}}function c(){var a=u.parentCancel;a?(delete u.parentCancel,a()):h||(a=Error("Cancel"),a.name="Cancel",d(a))}var a,h,n=[],r=this,u=
{};Object.defineProperty(this,"_protected",{value:function(a){if(a!==l)throw Error("protected");return u}});this.resolve=function(a){h||k(a);return r};this.reject=function(a){h||d(a);return r};this.progress=function(a){h||n.forEach(function(c){if(c.progress)try{c.progress(a)}catch(h){}});return r.promise};this.cancel=function(){u.parentCancel?setTimeout(c,0):c();return r};this.then=function(a,c,d){a={resolve:a,reject:c,progress:d,deferred:new b};n.push(a);a.deferred._protected(l).parentCancel=r.promise.cancel.bind(r);
("fulfilled"===h||"rejected"===h)&&m(e);return a.deferred.promise};this.promise={then:r.then,cancel:r.cancel}}var l=[],g=!1;b.all=function(e,d){function k(c,d){n||(h[c]=d,0===--a&&r.resolve(h))}function c(a,c){if(!n){if(d)try{k(a,d(c));return}catch(h){c=h}r.reject(c)}}var a=e.length,h=[],n=!1,r=new b;r.then(void 0,function(){n=!0;e.forEach(function(a){a.cancel&&a.cancel()})});0===a?r.resolve(h):e.forEach(function(a,h){a.then(k.bind(void 0,h),c.bind(void 0,h))});return r.promise};b.when=function(e,
d,k,c){var a;e&&"function"===typeof e.then||(a=new b,a.resolve(e),e=a.promise);return e.then(d,k,c)};return b});
define("orion/i18nUtil",["require","orion/Deferred"],function(f,m){var p={};return{getMessageBundle:function(b){function l(){f(["i18n!"+b],function(c){if(c){var a=b;c._expires=(new Date).getTime()+9E5;localStorage.setItem("orion/messageBundle/"+a,JSON.stringify(c));delete c._expires}e.resolve(c)})}function g(c){e.reject(c)}if(p[b])return p[b];var e=new m;p[b]=e;var d;a:{if(d=localStorage.getItem("orion/messageBundle/"+b))if(d=JSON.parse(d),d._expires&&d._expires>(new Date).getTime()){delete d._expires;
break a}d=null}if(d)return e.resolve(d),e;try{f([b],l,g)}catch(k){f(["orion/i18n!"+b],l,g)}return e},formatMessage:function(b){var l=arguments;return b.replace(/\$\{([^\}]+)\}/g,function(b,e){return l[(e<<0)+1]})}}});
define("orion/EventTarget",[],function(){function f(){this._namedListeners={}}f.prototype={dispatchEvent:function(f){if(!f.type)throw Error("unspecified type");var p=this._namedListeners[f.type];p&&p.forEach(function(b){try{"function"===typeof b?b(f):b.handleEvent(f)}catch(l){"undefined"!==typeof console&&console.log(l)}});return!f.defaultPrevented},addEventListener:function(f,p){if("function"===typeof p||p.handleEvent)this._namedListeners[f]=this._namedListeners[f]||[],this._namedListeners[f].push(p)},
removeEventListener:function(f,p){var b=this._namedListeners[f];if(b)for(var l=0;l<b.length;l++)if(b[l]===p){1===b.length?delete this._namedListeners[f]:b.splice(l,1);break}}};f.prototype.constructor=f;f.attach=function(m){var p=new f;m.dispatchEvent=p.dispatchEvent.bind(p);m.addEventListener=p.addEventListener.bind(p);m.removeEventListener=p.removeEventListener.bind(p)};return f});
define("orion/objects",[],function(){function f(f){for(var p=1;p<arguments.length;p++){var b=arguments[p],l;for(l in b)Object.prototype.hasOwnProperty.call(b,l)&&(f[l]=b[l])}return f}return{clone:function(m){if(Array.isArray(m))return Array.prototype.slice.call(m);var p=Object.create(Object.getPrototypeOf(m));f(p,m);return p},mixin:f,toArray:function(f){return Array.isArray(f)?f:[f]}}});
define("orion/inputManager","i18n!orion/edit/nls/messages orion/i18nUtil orion/Deferred orion/EventTarget orion/objects orion/PageUtil".split(" "),function(f,m,p,b,l,g){function e(c){this._document=c.document||document;this._timeout=c.timeout;for(var c="keypress keydown keyup mousemove mousedown mousemove".split(" "),a=function(){this._resetTimer()}.bind(this),h=0;h<c.length;h++)this._document.addEventListener(c[h],a,!0);b.attach(this)}function d(c,a){if(c){if(0===a.status)a={Severity:"Error",Message:f.noResponse};
else{var h=a.responseText;if(h)try{a=JSON.parse(h)}catch(d){a={Severity:"Error",Message:h}}}c.setProgressResult(a)}else window.console.log(a)}function k(c){b.attach(this);this.serviceRegistry=c.serviceRegistry;this.statusService=c.statusService;this.fileClient=c.fileClient;this.progressService=c.progressService;this.contentTypeRegistry=c.contentTypeRegistry;this.selection=c.selection;this._input=this._title="";this.dispatcher=null;this._unsavedChanges=[]}e.prototype={_resetTimer:function(){var c=
this._document.defaultView||this._document.parentWindow;this._timer&&(c.clearTimeout(this._timer),this._timer=null);-1!==this._timeout&&(this._timer=c.setTimeout(function(){this.onIdle({type:"Idle"});this._timer=null;this._resetTimer()}.bind(this),this._timeout))},onIdle:function(c){return this.dispatchEvent(c)},setTimeout:function(c){this._timeout=c;this._resetTimer()}};l.mixin(k.prototype,{_maybeLoadWorkspace:function(c){var a=this.fileClient;return c===a.fileServiceRootURL(c)?a.loadWorkspace(c).then(function(a){return a.Location}):
(new p).resolve(c)},_read:function(c){var a=this.fileClient,h=Array.prototype.slice.call(arguments,1);return this._maybeLoadWorkspace(c).then(function(c){return a.read.apply(a,[c].concat(h))})},load:function(){var c=this.getInput();if(c){var a=this.fileClient,h=this._parsedLocation.resource,k=this.progressService,r=function(q,a,c){return!k?q:k.progress(q,m.formatMessage(a,c))},b=this.getEditor();if(this._fileMetadata)!this._saving&&(!this._fileMetadata.Directory&&!this._readonly)&&r(a.read(h,!0),
f.ReadingMetadata,c).then(function(q){this._fileMetadata&&(this._fileMetadata.Location===q.Location&&this._fileMetadata.ETag!==q.ETag)&&(this._fileMetadata=q,(!b.isDirty()||window.confirm(f.loadOutOfSync))&&r(a.read(h),f.Reading,c).then(function(q){b.setInput(c,null,q);this._unsavedChanges=[]}.bind(this)))}.bind(this));else{var e=h;if(0===e.indexOf("/gitapi/commit/")){var l=e.indexOf("/file"),g=e.indexOf("?",l);-1===g&&(g=e.length);e=e.substring(l,g);this._readonly=!0}var p=window.setTimeout(function(){p=
null;this.reportStatus(m.formatMessage(f.Fetching,c))}.bind(this),800),v=function(){this.reportStatus("");p&&window.clearTimeout(p)}.bind(this),z=function(q){v();var a=null;this.serviceRegistry?a=this.serviceRegistry.getService("orion.page.message"):this.statusService&&(a=this.statusService);d(a,q);this._setNoInput()}.bind(this);this._acceptPatch=null;r(this._read(e,!0),f.ReadingMetadata,e).then(function(q){q?q.Directory?r(a.fetchChildren(q.ChildrenLocation),f.Reading,c).then(function(a){v();q.Children=
a;this._setInputContents(this._parsedLocation,c,a,q)}.bind(this),z):this._isText(q)?r(a.read(h,!1,!0),f.Reading,c).then(function(a){v();"string"!==typeof a&&(this._acceptPatch=a.acceptPatch,a=a.result);this._setInputContents(this._parsedLocation,c,a,q)}.bind(this),z):r(a._getService(h).readBlob(h),f.Reading,c).then(function(a){v();this._setInputContents(this._parsedLocation,c,a,q)}.bind(this),z):z({responseText:m.formatMessage(f.ReadingMetadataError,e)})}.bind(this),z)}}},processParameters:function(c){var a=
...
onFocus:function(){this._autoSaveEnabled&&this._errorSaving?this.save():this._autoLoadEnabled&&this.load()},onChanging:function(c){if(this._getSaveDiffsEnabled()){var a=this._unsavedChanges.length,h=c.removedCharCount,d=c.start,k=c.start+h,b=0;0===c.addedCharCount?b=-1:0===h&&(b=1);if(0<a&&b===this.previousChangeType){a=this._unsavedChanges[a-1];if(0===h&&d===a.end+a.text.length){a.text+=c.text;return}if(0===c.addedCharCount&&k===a.start){a.start=d;return}}this.previousChangeType=b;this._unsavedChanges.push({start:d,
end:k,text:c.text})}},reportStatus:function(c){this.statusReporter?this.statusReporter(c):this.editor&&this.editor.reportStatus(c)},save:function(){function c(a){r===t.getInput()&&(t.getFileMetadata().ETag=a.ETag,h.setInput(r,null,b,!0));t.reportStatus("");k&&q&&q.setProgressResult({Message:f.Saved,Severity:"Normal"});t.afterSave&&t.afterSave();t._saving=!1}function a(a){t.reportStatus("");d(q,a);t._saving=!1;t._errorSaving=!0}if(!this._saving){var h=this.getEditor();if(h&&h.isDirty()&&!this.getReadOnly()){var k=
this._errorSaving;this._saving=!0;var r=this.getInput();this.reportStatus(f["Saving..."]);this.dispatchEvent({type:"Saving",inputManager:this});h.markClean();var b=h.getText(),e=b;if(this._getSaveDiffsEnabled()&&!this._errorSaving){for(var l=this._unsavedChanges,g=0,p=0;p<l.length;p++)g+=l[p].text.length;b.length>g&&(e={diff:l})}this._unsavedChanges=[];this._errorSaving=!1;var l={ETag:this.getFileMetadata().ETag},v=this._parsedLocation.resource,e=this.fileClient.write(v,e,l),z=this.progressService,
q=null;this.serviceRegistry&&(q=this.serviceRegistry.getService("orion.page.message"));z&&(e=z.progress(e,m.formatMessage(f.savingFile,r)));var t=this;e.then(c,function(q){412===q.status?window.confirm(f.saveOutOfSync)?(q=t.fileClient.write(v,b),z&&(q=z.progress(q,m.formatMessage(f.savingFile,r))),q.then(c,a)):t._saving=!1:a(q)})}}},setAutoLoadEnabled:function(c){this._autoLoadEnabled=c},setAutoSaveTimeout:function(c){this._autoSaveEnabled=-1!==c;this._idle?this._idle.setTimeout(c):(this._idle=new e({document:document,
timeout:c}),this._idle.addEventListener("Idle",function(){this._errorSaving||this.save()}.bind(this)))},setContentType:function(c){this._contentType=c},setInput:function(c){if(!this._ignoreInput&&(c||(c=g.hash()),"string"===typeof c)){var a=this.getEditor();c&&"#"!==c[0]&&(c="#"+c);var h=g.matchResourceParameters(c),d=this._parsedLocation||{};if(a&&a.isDirty()){var k=this._location;if(d.resource!==h.resource)if(this._autoSaveEnabled)this.save();else if(!window.confirm(f.confirmUnsavedChanges)){window.location.hash=
k;return}}a=a&&d.editor!==h.editor;this._location=c;this._parsedLocation=h;this._ignoreInput=!0;this.selection&&this.selection.setSelections(c);this._ignoreInput=!1;(c=h.resource)?c===this._input?a?(this.reportStatus(""),this._setInputContents(h,c,null,this._fileMetadata,this._isText(this._fileMetadata))):this.processParameters(h):(this._input=c,this._readonly=!1,this._fileMetadata=null,this.load()):this._setNoInput(!0)}},setTitle:function(c){var a=c.lastIndexOf("/");-1!==a&&(c=c.substring(a+1));
...
a.ChildrenLocation;this._setInputContents(a.ChildrenLocation,null,a,a)}.bind(this)):(this._input=this._title=this._fileMetadata=null,this.setContentType(null),this.dispatchEvent({type:"InputChanged",input:null}))},_setInputContents:function(c,a,d,k,r){var b,e=!1;k?(this._fileMetadata=k,this.setTitle(k.Location||String(k)),this.setContentType(this.contentTypeRegistry.getFileContentType(k)),b=k.Name,e=k.Directory):(this._fileMetadata=null,this.setTitle(a),this.setContentType(this.contentTypeRegistry.getFilenameContentType(this.getTitle())),
b=this.getTitle());var l=this.getEditor();this._focusListener&&(l&&(l.getTextView&&l.getTextView())&&l.getTextView().removeEventListener("Focus",this._focusListener),this._focusListener=null);this._changingListener&&(l&&(l.getModel&&l.getModel())&&l.getModel().removeEventListener("Changing",this._changingListener),this._changingListener=null);k={type:"InputChanged",input:c,name:b,title:a,contentType:this.getContentType(),metadata:k,location:window.location,contents:d};this.dispatchEvent(k);this.editor=
l=k.editor;e||(l&&(l.getTextView&&l.getTextView())&&l.getTextView().addEventListener("Focus",this._focusListener=this.onFocus.bind(this)),l&&(l.getModel&&l.getModel())&&l.getModel().addEventListener("Changing",this._changingListener=this.onChanging.bind(this)),r||l.setInput(a,null,d),this._unsavedChanges=[],this.processParameters(c))}});return{InputManager:k}});
define("orion/util",[],function(){var f=navigator.userAgent,m=-1!==f.indexOf("MSIE")||-1!==f.indexOf("Trident")?document.documentMode:void 0,p=parseFloat(f.split("Firefox/")[1]||f.split("Minefield/")[1])||void 0,b=-1!==f.indexOf("Opera")?parseFloat(f.split("Version/")[1]):void 0,l=parseFloat(f.split("Chrome/")[1])||void 0,g=-1!==f.indexOf("Safari")&&!l,e=parseFloat(f.split("WebKit/")[1])||void 0,d=-1!==f.indexOf("Android"),k=-1!==f.indexOf("iPad"),f=-1!==f.indexOf("iPhone"),c=k||f,a=-1!==navigator.platform.indexOf("Mac"),
h=-1!==navigator.platform.indexOf("Win"),n=-1!==navigator.platform.indexOf("Linux");return{formatMessage:function(a){var c=arguments;return a.replace(/\$\{([^\}]+)\}/g,function(a,d){return c[(d<<0)+1]})},createElement:function(a,c){return a.createElementNS?a.createElementNS("http://www.w3.org/1999/xhtml",c):a.createElement(c)},isIE:m,isFirefox:p,isOpera:b,isChrome:l,isSafari:g,isWebkit:e,isAndroid:d,isIPad:k,isIPhone:f,isIOS:c,isMac:a,isWindows:h,isLinux:n,platformDelimiter:h?"\r\n":"\n"}});
define("orion/webui/littlelib",["orion/util"],function(f){function m(d,c){c||(c=document);return c.querySelectorAll(d)}function p(d){var c=d.tabIndex;0===c&&f.isIE&&!{a:!0,body:!0,button:!0,frame:!0,iframe:!0,img:!0,input:!0,isindex:!0,object:!0,select:!0,textarea:!0}[d.nodeName.toLowerCase()]&&!d.attributes.tabIndex&&(c=-1);return c}function b(d){if(0<=p(d))return d;if(d.hasChildNodes())for(var c=0;c<d.childNodes.length;c++){var a=b(d.childNodes[c]);if(a)return a}return null}function l(d){if(0<=
...
"You cannot copy files directly into the workspace.  Create a folder first.":"You cannot copy files directly into the workspace.  Create a folder first.","Unzip ${0}?":"Unzip ${0}?",NoFile:"Use the ${0} menu to create new files and folders. Click a file to start coding."});define("orion/navigate/nls/messages",["orion/i18n!orion/navigate/nls/messages","orion/navigate/nls/root/messages"],function(f,m){var p={root:m};Object.keys(f).forEach(function(b){"undefined"===typeof p[b]&&(p[b]=f[b])});return p});
...
"To view the browser's context menu, trigger the context menu again.":"To view the browser's context menu, trigger the context menu again.",Edit:"Edit",CentralNavTooltip:"Toggle Navigation Menu"});define("orion/nls/messages",["orion/i18n!orion/nls/messages","orion/nls/root/messages"],function(f,m){var p={root:m};Object.keys(f).forEach(function(b){"undefined"===typeof p[b]&&(p[b]=f[b])});return p});
(function(){function f(q){if("string"!==typeof q)throw new TypeError;}function m(q){return q?q.split("&"):[]}function p(q){return 0===q.length?"":q.join("&")}function b(q){var a=/([^=]*)(?:=?)(.*)/.exec(q),q=a[1]?decodeURIComponent(a[1]):"",a=a[2]?decodeURIComponent(a[2]):"";return[q,a]}function l(q){var a=encodeURIComponent(q[0]);q[1]&&(a+="="+encodeURIComponent(q[1]));return a}function g(q,a){var c="",t=[],d=0;return{next:function(){c!==q.query&&(c=q.query,t=m(c));if(d<t.length){var h=b(t[d++]);
switch(a){case "keys":return h[0];case "values":return h[1];case "keys+values":return[h[0],h[1]];default:throw new TypeError;}}throw A;}}}function e(q){Object.defineProperty(this,"_url",{get:function(){return q._url}})}function d(q){return q?/[1-9]\d*$/.exec(q)[0]:""}function k(q){var a=[];q.split("/").forEach(function(q){".."===q?a.pop():"."!==q&&a.push(q)});return a.join("/")}function c(q,a){if("string"!==typeof q)throw new TypeError;var q=q.replace(/\s/g,function(q){return"%"+q.charCodeAt(0).toString(16)}),
c=r.exec(q);if(!c)return null;var t={};t.scheme=c[1]||"";if(t.scheme&&!s.test(t.scheme))return null;var h=c[2];if(h&&(h=u.exec(h),t.userinfo=h[1],t.host=h[2],t.port=h[3],t.port&&!y.test(t.port)))return null;t.path=c[3];t.query=c[4];t.fragment=c[5];!t.scheme&&a&&(t.scheme=a.scheme,!t.host&&a.host&&(t.userinfo=a.userinfo,t.host=a.host,t.port=a.port,t.pathRelative=!0));t.pathRelative&&(t.path?"/"!==t.path[0]&&(c=/^(.*\/)[^\/]*$/.exec(a.path)[1]||"/",t.path=c+t.path):t.path=a.path);t.scheme&&(t.scheme=
t.scheme.toLowerCase());t.port&&(t.port=d(t.port));t.host&&t.path&&(t.path=k(t.path));return t}function a(q,a){var t;if(a){a=a.href||a;t=c(a);if(!t||!t.scheme)throw new SyntaxError;Object.defineProperty(this,"_baseURL",{value:t})}t=c(q,t);if(!t)throw new SyntaxError;Object.defineProperty(this,"_input",{value:q,writable:!0});Object.defineProperty(this,"_url",{value:t,writable:!0});var d=new e(this);Object.defineProperty(this,"query",{get:function(){return this._url?d:null},enumerable:!0})}try{var h;
if("function"===typeof window.URL&&0!==window.URL.length&&"http:"===(h=new window.URL("http://www.w3.org?q")).protocol&&h.query)return}catch(n){}var r=/^(?:([^:\/?#]+):)?(?:\/\/([^\/?#]*))?([^?#]*)(?:\?([^#]*))?(?:#(.*))?$/,u=/^(?:(.*)@)?(\[[^\]]*\]|[^:]*)(?::(.*))?$/,s=/^([a-zA-Z](?:[a-zA-Z0-9+-.])*)$/,y=/^\d*$/,x=/^(\[[^\]\/?#\s]*\]|[^:\/?#\s]*)$/,w=/^(\[[^\]\/?#\s]*\]|[^:\/?#\s]*)(?::(\d*))?$/,v=/^([^?#\s]*)$/,z=/^([^\s]*)$/,q=/^\S*$/,t=/([^:]*):?(.*)/,A="undefined"!==typeof StopIteration?StopIteration:
Error("Stop Iteration"),D={"ftp:":"21","gopher:":"70","http:":"80","https:":"443","ws:":"80","wss:":"443"};Object.defineProperties(e.prototype,{get:{value:function(q){f(q);var a;m(this._url.query).some(function(t){t=b(t);if(t[0]===q)return a=t[1],!0});return a},enumerable:!0},set:{value:function(q,a){f(q);f(a);var t=m(this._url.query);t.some(function(c,d){var h=b(c);if(h[0]===q)return h[1]=a,t[d]=l(h),!0})||t.push(l([q,a]));this._url.query=p(t)},enumerable:!0},has:{value:function(q){f(q);return m(this._url.query).some(function(a){if(b(a)[0]===
q)return!0})},enumerable:!0},"delete":{value:function(q){f(q);var a=m(this._url.query),t=a.filter(function(a){return b(a)[0]!==q});return t.length!==a.length?(this._url.query=p(t),!0):!1},enumerable:!0},clear:{value:function(){this._url.query=""},enumerable:!0},forEach:{value:function(q,a){if("function"!==typeof q)throw new TypeError;var t=g(this._url,"keys+values");try{for(;;){var c=t.next();q.call(a,c[1],c[0],this)}}catch(d){if(d!==A)throw d;}},enumerable:!0},keys:{value:function(){return g(this._url,
"keys")},enumerable:!0},values:{value:function(){return g(this._url,"values")},enumerable:!0},items:{value:function(){return g(this._url,"keys+values")}},size:{get:function(){return m(this._url.query).length},enumerable:!0},getAll:{value:function(q){f(q);var a=[];m(this._url.query).forEach(function(t){t=b(t);t[0]===q&&a.push(t[1])});return a},enumerable:!0},append:{value:function(q,a){f(q);f(a);var t=m(this._url.query);t.push(l([q,a]));this._url.query=p(t)},enumerable:!0}});Object.defineProperties(a.prototype,
...
this._url.scheme+":":":"},set:function(q){f(q);if(this._url&&(q=":"===q.slice(-1)?q.substring(0,q.length-1):q,""===q||s.test(q)))this._url.scheme=q.toLowerCase()},enumerable:!0},_userinfo:{get:function(){return this._url?this._url.userinfo:""},set:function(q){f(q);this._url&&(this._url.userinfo=q)}},username:{get:function(){if(!this._url)return"";var q=t.exec(this._userinfo);return decodeURIComponent(q[1]||"")},set:function(q){f(q);if(this._url){var a=t.exec(this._userinfo),q=[encodeURIComponent(q||
"")];a[2]&&q.push(a[2]);this._userinfo=q.join(":")}},enumerable:!0},password:{get:function(){if(!this._url)return"";var q=t.exec(this._userinfo);return decodeURIComponent(q[2]||"")},set:function(q){f(q);if(this._url){var a=[t.exec(this._userinfo)[1]||""];q&&a.push(encodeURIComponent(q));this._userinfo=a.join(":")}},enumerable:!0},host:{get:function(){var q="";this._url&&this._url.host&&(q+=this._url.host,this._url.port&&(q+=":"+this._url.port));return q},set:function(q){f(q);if(this._url&&(q=w.exec(q)))this._url.host=
q[1],this._url.port=d(q[2])},enumerable:!0},hostname:{get:function(){return this._url?this._url.host:""},set:function(q){f(q);this._url&&x.exec(q)&&(this._url.host=q)},enumerable:!0},port:{get:function(){var q=this._url?this._url.port||"":"";q&&q===D[this.protocol]&&(q="");return q},set:function(q){f(q);this._url&&y.exec(q)&&(this._url.port=d(q))},enumerable:!0},pathname:{get:function(){return this._url?this._url.path:""},set:function(q){f(q);this._url&&v.exec(q)&&(this._url.host&&(q&&"/"!==q[0])&&
(q="/"+q),this._url.path=q?k(q):"")},enumerable:!0},search:{get:function(){return this._url&&this._url.query?"?"+this._url.query:""},set:function(q){f(q);this._url&&(q&&"?"===q[0]&&(q=q.substring(1)),z.exec(q)&&(this._url.query=q))},enumerable:!0},hash:{get:function(){return this._url&&this._url.fragment?"#"+this._url.fragment:""},set:function(a){f(a);this._url&&(a&&"#"===a[0]&&(a=a.substring(1)),q.exec(a)&&(this._url.fragment=a))},enumerable:!0}});if((h=window.URL||window.webkitURL)&&h.createObjectURL)Object.defineProperty(a,
...
this._indent*l+"px";this._renderer.rowCallback&&this._renderer.rowCallback(d,b[e]);g?(this._bodyElement.insertBefore(d,g.nextSibling),g&&(g=d)):this._bodyElement.appendChild(d)}},_rowsChanged:function(){this._renderer.rowsChanged&&this._renderer.rowsChanged()},getSelected:function(){return this._renderer.getSelected()},refresh:function(b,l,g){var e=this._treeModel.getId(b),d;if(e===this._id)this._removeChildRows(e),this._generateChildren(l,0),this._rowsChanged();else{var k=m.node(e);k?(k._item=b,
k&&(g||k._expanded)?(this._removeChildRows(e),l?(k._expanded=!0,this._renderer.updateExpandVisuals(k,!0),this._generateChildren(l,k._depth+1,k),this._rowsChanged()):(d=this,this._renderer.updateExpandVisuals(k,"progress"),l=this._treeModel.getChildren(k._item,function(c){d.destroyed||(d._renderer.updateExpandVisuals(k,!0),k._expanded||(k._expanded=!0,d._generateChildren(c,k._depth+1,k),d._rowsChanged()))}))):this._renderer.updateExpandVisuals(k,!1)):console.log(f["could not find table row "]+e)}},
...
"+":"=";break;case 188:d=b.mod2?"<":",";break;case 190:d=b.mod2?">":".";break;case 191:d=b.mod2?"?":"/";break;case 192:d=b.mod2?"~":"`";break;case 219:d=b.mod2?"{":"[";break;case 220:d=b.mod2?"|":"\\";break;case 221:d=b.mod2?"}":"]";break;case 222:d=b.mod2?'"':"'"}return d?l+d:112<=b.keyCode&&123>=b.keyCode?l+"F"+(b.keyCode-111):l+String.fromCharCode(b.keyCode)}function p(b){var l=-1!==window.navigator.platform.indexOf("Mac");return l&&b.metaKey||!l&&b.ctrlKey}return{getUserKeyString:function(b){for(var l=
"",b=b.getKeys(),g=0;g<b.length;g++)0!==g&&(l+=" "),l+=m(b[g]);return l},getUserText:function(b){var l=b.id,g=b.refNode,e=b.hideRefNode,d=b.initialText,k=b.onComplete,c=b.onEditDestroy,a=b.selectTo,h=b.isInitialValid,b=b.insertAsChild,n=!1,r=function(a){return function(b){if(!n){var r=f.node(l),u=r.value;r&&(a&&b.keyCode===f.KEY.ESCAPE?(e&&(g.style.display="inline"),n=!0,r.parentNode.removeChild(r),c&&c()):a&&b.keyCode!==f.KEY.ENTER||(0===u.length||!h&&u===d?e&&(g.style.display="inline"):(k(u),e&&
g.parentNode&&(g.style.display="inline")),n=!0,r.parentNode&&r.parentNode.removeChild(r),c&&c()))}}},u=document.createElement("input");u.id=l;u.value=d||"";b?g.appendChild(u):g.parentNode.insertBefore(u,g.nextSibling);u.classList.add("userEditBoxPrompt");e&&(g.style.display="none");u.addEventListener("keydown",r(!0),!1);u.addEventListener("blur",r(!1),!1);window.setTimeout(function(){u.focus();if(d){var c=f.node(l),h=a?d.indexOf(a):-1;0<h?c.createTextRange?(c=c.createTextRange(),c.collapse(!0),c.moveStart("character",
0),c.moveEnd("character",h),c.select()):c.setSelectionRange?c.setSelectionRange(0,h):void 0!==c.selectionStart&&(c.selectionStart=0,c.selectionEnd=h):c.select()}},0)},openInNewWindow:p,followLink:function(b,l){l&&p(l)?window.open(b):window.location=b},createButton:function(b,l){var g=document.createElement("button");g.className="orionButton commandButton commandMargins";g.addEventListener("click",function(b){l();f.stop(b)},!1);b&&g.appendChild(document.createTextNode(b));return g},createDropdownButton:function(){},
...
c.classList.remove("treeIterationCursorRow_Dotted"))},currentModel:function(){return this._modelIterator.cursor()},cursorOn:function(d,b,c,a){var h,n;if(d||b){if(n===this._modelIterator.cursor())return;h=this._modelIterator.cursor();n=d;this._modelIterator.setCursor(n)}else h=this._modelIterator.prevCursor(),n=this._modelIterator.cursor();if(h!==n||b)if(this.toggleCursor(h,!1),!b||n){this.moveColumn(null,0);this.toggleCursor(n,!0);if((d=this.getRowDiv())&&!a){a=d.parentNode;for(b=document.documentElement;a&&
a!==b;){var r=window.getComputedStyle(a,null);if(!r)break;r=r.getPropertyValue("overflow-y");if("auto"===r||"scroll"===r)break;a=a.parentNode}a&&(b=!0,d.offsetTop<=a.scrollTop?(b=!1,void 0===c&&(c=!1)):d.offsetTop+d.offsetHeight>=a.scrollTop+a.clientHeight&&(b=!1,void 0===c&&(c=!0)),b||d.scrollIntoView(!c))}if(this.explorer.onCursorChanged)this.explorer.onCursorChanged(h,n)}},getSelection:function(){return this._selections},getSelectionIds:function(){for(var d=[],b=0;b<this._selections.length;b++)d.push(this.model.getId(this._selections[b]));
...
define("text",["module"],function(f){var m,p,b=["Msxml2.XMLHTTP","Microsoft.XMLHTTP","Msxml2.XMLHTTP.4.0"],l=/^\s*<\?xml(\s)+version=[\'\"](\d)*.(\d)*[\'\"](\s)*\?>/im,g=/<body[^>]*>\s*([\s\S]+)\s*<\/body>/im,e="undefined"!==typeof location&&location.href,d=e&&location.protocol&&location.protocol.replace(/\:/,""),k=e&&location.hostname,c=e&&(location.port||void 0),a=[],h=f.config&&f.config()||{};m={version:"2.0.5",strip:function(a){if(a){var a=a.replace(l,""),c=a.match(g);c&&(a=c[1])}else a="";return a},
...
d,h=!1,b=a.indexOf(".");c=0===a.indexOf("./")||0===a.indexOf("../");-1!==b&&(!c||1<b)?(c=a.substring(0,b),d=a.substring(b+1,a.length)):c=a;a=d||c;b=a.indexOf("!");-1!==b&&(h="strip"===a.substring(b+1),a=a.substring(0,b),d?d=a:c=a);return{moduleName:c,ext:d,strip:h}},xdRegExp:/^((\w+)\:)?\/\/([^\/\\]+)/,useXhr:function(a,c,d,b){var h,e;h=m.xdRegExp.exec(a);if(!h)return!0;a=h[2];h=h[3];h=h.split(":");e=h[1];h=h[0];return(!a||a===c)&&(!h||h.toLowerCase()===d.toLowerCase())&&(!e&&!h||e===b)},finishLoad:function(c,
d,b,e){b=d?m.strip(b):b;h.isBuild&&(a[c]=b);e(b)},load:function(a,b,l,s){if(s.isBuild&&!s.inlineText)l();else{h.isBuild=s.isBuild;var g=m.parseName(a),s=g.moduleName+(g.ext?"."+g.ext:""),f=b.toUrl(s),p=h.useXhr||m.useXhr;!e||p(f,d,k,c)?m.get(f,function(c){m.finishLoad(a,g.strip,c,l)},function(a){l.error&&l.error(a)}):b([s],function(a){m.finishLoad(g.moduleName+"."+g.ext,g.strip,a,l)})}},write:function(c,d,b){if(a.hasOwnProperty(d)){var h=m.jsEscape(a[d]);b.asModule(c+"!"+d,"define(function () { return '"+
h+"';});\n")}},writeFile:function(a,c,d,b,h){var c=m.parseName(c),e=c.ext?"."+c.ext:"",k=c.moduleName+e,l=d.toUrl(c.moduleName+e)+".js";m.load(k,d,function(){var c=function(q){return b(l,q)};c.asModule=function(q,a){return b.asModule(q,l,a)};m.write(a,k,c,h)},h)}};if("node"===h.env||!h.env&&"undefined"!==typeof process&&process.versions&&process.versions.node)p=require.nodeRequire("fs"),m.get=function(a,c){var d=p.readFileSync(a,"utf8");0===d.indexOf("\ufeff")&&(d=d.substring(1));c(d)};else if("xhr"===
h.env||!h.env&&m.createXhr())m.get=function(a,c,d,b){var e=m.createXhr(),k;e.open("GET",a,!0);if(b)for(k in b)b.hasOwnProperty(k)&&e.setRequestHeader(k.toLowerCase(),b[k]);if(h.onXhr)h.onXhr(e,a);e.onreadystatechange=function(){var b;4===e.readyState&&(b=e.status,399<b&&600>b?(b=Error(a+" HTTP status: "+b),b.xhr=e,d(b)):c(e.responseText))};e.send(null)};else if("rhino"===h.env||!h.env&&"undefined"!==typeof Packages&&"undefined"!==typeof java)m.get=function(a,c){var d,b,h=new java.io.File(a),e=java.lang.System.getProperty("line.separator"),
h=new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(h),"utf-8")),k="";try{d=new java.lang.StringBuffer;(b=h.readLine())&&(b.length()&&65279===b.charAt(0))&&(b=b.substring(1));for(null!==b&&d.append(b);null!==(b=h.readLine());)d.append(e),d.append(b);k=String(d.toString())}finally{h.close()}c(k)};return m});define("text!orion/webui/dropdowntriggerbutton.html",[],function(){return'<button class="dropdownTrigger">${ButtonText}<\!--span class="dropdownArrowDown core-sprite-openarrow"></span--\></button><ul class="dropdownMenu"></ul>'});
...
this._tailSize-1;break;default:d=e.top-this._tailSize/2,e=e.left+e.width+this._tailSize+1}var k=m.bounds(document.documentElement);if(d+g.height>k.height)if(l)d=k.height-g.height-1;else return!1;if(e+g.width>k.width)if(l)e=k.width-g.width-1;else return!1;if(0>e)if(l)e=4;else return!1;if(0>d)if(l)d=4;else return!1;this._tail&&this._tail.previousPosition!==b&&(this._tip.removeChild(this._tail),this._tail=null);this._tail||(this._tail=document.createElement("span"),this._tail.classList.add("tooltipTailFrom"+
...
var x=null,w={};r.prototype={setProxy:function(a){this.proxy=a},setKeyBindings:function(a){this.bindings=a},_init:function(){var a=this;document.addEventListener("keydown",function(c){return n(c,function(q){var c=a.proxy,d=a.bindings;if(d&&c)for(var b=0;b<d.length;b++)d[b].match(q)&&(c.processKey({type:q.type,keyCode:q.keyCode,altKey:q.altKey,ctrlKey:q.ctrlKey,metaKey:q.metaKey,shiftKey:q.shiftKey}),m.stop(q))})})}};window.document.addEventListener("keydown",n,!1);s.prototype={collectsParameters:function(){return this.commandRegistry&&
...
d){var q=this.getChoices(c,q,t),b=q.some(function(q){return q.checked});q.forEach(function(q){if(q.name){var t=document.createElement("li");a.appendChild(t);var h=document.createElement("span");h.tabIndex=0;h.role="menuitem";h.classList.add("dropdownMenuItem");if(b){var r=document.createElement("span");r.classList.add("check");r.appendChild(document.createTextNode(q.checked?"\u25cf":""));h.appendChild(r)}r=document.createTextNode(q.name);h.appendChild(r);t.appendChild(h);h.choice=q;h.addEventListener("click",
function(q){q.target.choice&&q.target.choice.callback.call(q.target.choice,c)},!1);h.addEventListener("keydown",function(q){(q.keyCode===m.KEY.ENTER||q.keyCode===m.KEY.SPACE)&&q.target.choice&&q.target.choice.callback.call(q.target.choice,c)},!1)}else d._generateMenuSeparator(a)})},getChoices:function(a,c,q){return this.choiceCallback?this.choiceCallback.call(c,a,q):null},makeChoiceCallback:function(a,c){return function(q){a.callback&&a.callback.call(a,c,q)}},hasImage:function(){return this.imageClass||
"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAAtJREFUCNdjIBEAAAAwAAFletZ8AAAAAElFTkSuQmCC"!==this.image}};y.prototype.constructor=y;return{Command:y,CommandInvocation:s,createDropdownMenu:function(a,c,q,t,d,h,r,e,n){a=m.node(a);if(!a)throw"no parent node was specified";var k=document.createRange();k.selectNode(a);k=n?k.createContextualFragment(l):k.createContextualFragment(b);m.processTextNodes(k,{ButtonText:c});a.appendChild(k);var a=
a.lastChild,s;n?(n=a.previousSibling,s=n.lastChild):n=a.previousSibling;t?n.classList.add(t):(n.classList.add("orionButton"),n.classList.add("commandButton"));d&&(h||(n.textContent="",n.setAttribute("aria-label",c)),u({spriteClass:"commandSprite",imageClass:d},n,c),n.classList.add("orionButton"));n.dropdown=new p.Dropdown({dropdown:a,populate:q,selectionClass:r,skipTriggerEventListeners:!!s,positioningNode:e});a.dropdown=n.dropdown;return{menuButton:n,menu:a,dropdown:n.dropdown,dropdownArrow:s}},
createCheckedMenuItem:function(a,c,q,t){a=m.node(a);if(!a)throw"no parent node was specified";var d=document.createRange();d.selectNode(a);d=d.createContextualFragment(e);m.processTextNodes(d,{ItemText:c});a.appendChild(d);a=m.$(".checkedMenuItem",a.lastChild);a.checked=q;a.addEventListener("change",t,!1);return a},createCommandItem:function(a,c,q,t,b,h,r){var n,h=h||!c.name&&c.hasImage();if(c.hrefCallback)n=document.createElement("a"),n.id=t,h&&c.hasImage()?u(c,n,t):(n.className="commandLink",n.appendChild(document.createTextNode(c.name))),
r=c.hrefCallback.call(q.handler,q),r.then?r.then(function(q){n.href=q}):n.href=r?r:"#";else{n=document.createElement("button");n.className="orionButton";h?c.hasImage()?(u(c,n,t),c.name&&n.setAttribute("aria-label",c.name)):(n.classList.add("commandButton"),n.classList.add("commandMissingImageButton"),n.appendChild(document.createTextNode(c.name))):(n.classList.add("commandButton"),t=document.createTextNode(c.name),n.appendChild(t));var e=r||c.callback;e&&(c.onClick=e,n.addEventListener("click",function(){e.call(q.handler,
q)},!1))}"ul"===a.nodeName.toLowerCase()?(r=document.createElement("li"),a.appendChild(r),a=r):n.classList.add("commandMargins");a.appendChild(n);c.tooltip&&(n.commandTooltip=new d.Tooltip({node:n,text:c.tooltip,position:["above","below","right","left"]}));b&&(w[c.id]={keyBinding:b,command:c,invocation:q});return n},createCommandMenuItem:function(a,c,q,t,b,h){var r,n=a.dropdown;if(c.hrefCallback){r=document.createElement("a");var e=document.createElement("span");e.appendChild(document.createTextNode(c.name));
e.classList.add("dropdownCommandName");r.appendChild(e);b=c.hrefCallback.call(q.handler,q);b.then?b.then(function(q){r.href=q}):r.href=b?b:"#";r.addEventListener("keydown",function(q){(q.keyCode===m.KEY.ENTER||q.keyCode===m.KEY.SPACE)&&r.click()},!1)}else{r=document.createElement("span");r.tabIndex=0;e=document.createElement("span");e.appendChild(document.createTextNode(c.name));e.classList.add("dropdownCommandName");r.appendChild(e);var k=b||c.callback;k&&(c.onClick=k,r.addEventListener("click",
function(){n.close(!0);k.call(q.handler,q)},!1),r.addEventListener("keydown",function(q){if(q.keyCode===m.KEY.ENTER||q.keyCode===m.KEY.SPACE)q.preventDefault(),r.click()},!1))}r.className="dropdownMenuItem";r.role="menuitem";c.tooltip&&(r.commandTooltip=new d.Tooltip({node:r,text:c.tooltip,position:["above","below","right","left"]}));h&&(b=r,e=document.createElement("span"),e.classList.add("dropdownKeyBinding"),e.appendChild(document.createTextNode(h)),b.appendChild(e));h=document.createElement("li");
a.appendChild(h);h.appendChild(r);t&&(w[c.id]={keyBinding:t,command:c,invocation:q});return r},executeBinding:k,setKeyBindingProvider:function(a){x=a},localKeyBindings:w,CommandsProxy:r,getKeyBindings:a,processKey:h,NO_IMAGE:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAAtJREFUCNdjIBEAAAAwAAFletZ8AAAAAElFTkSuQmCC",_testMethodProcessKey:c}});
define("orion/explorers/explorer","i18n!orion/nls/messages require orion/webui/littlelib orion/webui/treetable orion/explorers/explorerNavHandler orion/commands".split(" "),function(f,m,p,b,l,g){var m={},e=function(d,b,c,a){this.registry=d;this.renderer=c;this.selection=b;this.commandService=a;this.renderer&&(this.renderer.explorer=this);this.myTree=null};e.prototype={destroy:function(){this._navHandler&&this._navHandler.destroy();this.model&&this.model.destroy();this.myTree&&this.myTree.destroy();
...
var h={};a.forEach(function(a){a=a.parent;h[a.Location]=a});return m.all(Object.keys(h).map(function(a){return c.changedItem(h[a],!0)}))},modelHandler:{copy:function(a){if(!a.count)return this.onModelCopy(a)},copyMultiple:function(a){return this.onModelCopy(a)},create:function(a){return this.onModelCreate(a)},"delete":function(a){if(!a.count)return this.onModelDelete(a)},deleteMultiple:function(a){return this.onModelDelete(a)},"import":function(a){return this.changedItem(a.target,!0)},move:function(a){if(!a.count)return this.onModelMove(a)},
moveMultiple:function(a){return this.onModelMove(a)}},_makeDropTarget:function(a,c,d){if(this.dragAndDrop){var e=this,g=this.dragAndDrop,m=function(a){h=a.target};d&&(this._oldDragStart&&c.removeEventListener("dragstart",this._oldDragStart,!1),this._oldDragStart=m);c.addEventListener("dragstart",m,!1);m=function(){h=null};d&&(this._oldDragEnd&&c.removeEventListener("dragend",this._oldDragEnd,!1),this._oldDragEnd=m);c.addEventListener("dragend",m,!1);m=function(a){c.classList.remove("dragOver");a.preventDefault();
a.stopPropagation()};d&&(this._oldDragLeave&&c.removeEventListener("dragleave",this._oldDragLeave,!1),this._oldDragLeave=m);c.addEventListener("dragleave",m,!1);m=function(a){if(h)n=a.dataTransfer.dropEffect=(k.isMac?a.altKey:a.ctrlKey)?"copy":"move";else if(!k.isIE&&("all"===a.dataTransfer.effectAllowed||"uninitialized"===a.dataTransfer.effectAllowed||0<=a.dataTransfer.effectAllowed.indexOf("copy")))a.dataTransfer.dropEffect="copy";c.classList.add("dragOver");p.stop(a)};d&&(this._oldDragEnter&&c.removeEventListener("dragenter",
this._oldDragEnter,!1),this._oldDragEnter=m);c.addEventListener("dragenter",m,!1);m=function(a){if(h)n=a.dataTransfer.dropEffect=(k.isMac?a.altKey:a.ctrlKey)?"copy":"move";else if(!k.isIE&&("all"===a.dataTransfer.effectAllowed||"uninitialized"===a.dataTransfer.effectAllowed||0<=a.dataTransfer.effectAllowed.indexOf("copy")))a.dataTransfer.dropEffect="copy";p.stop(a)};d&&!this._oldDragOver&&(c.addEventListener("dragover",m,!1),this._oldDragOver=m);var v=null;e.registry&&(v=e.registry.getService("orion.page.progress"));
var z=function(a){v?v.setProgressResult(a):window.console.log(a)},q=function(c,d,h,e,n,k){!h.Location&&h.fileMetadata&&(h=h.fileMetadata);d=d||"";if(c.isFile)l.isAtRoot(h.Location)?e.registry&&e.registry.getService("orion.page.message").setProgressResult({Severity:"Error",Message:f["You cannot copy files directly into the workspace.  Create a folder first."]}):c.file(function(a){n(h,a,e,a.name.indexOf(".zip")===a.name.length-4&&window.confirm(b.formatMessage(f["Unzip ${0}?"],a.name)))});else if(c.isDirectory){var g=
c.createReader(),s=function(a){g.readEntries(function(b){for(var h=0;h<b.length;h++)q(b[h],d+c.name+"/",a,e,n,k)})};l.isAtRoot(h.Location)?(v?v.progress(k.createProject(h.ChildrenLocation,c.name),b.formatMessage(f["Creating ${0}"],c.name)):k.createProject(h.ChildrenLocation,c.name)).then(function(a){e.loadResourceList(e.treeRoot.Path,!0);(v?v.progress(k.read(a.ContentLocation,!0),f["Loading "]+a.name):k.read(a.ContentLocation,!0)).then(function(a){s(a)},z)},z):(v?v.progress(k.createFolder(h.Location,
c.name),b.formatMessage(f["Creating ${0}"],c.name)):k.createFolder(h.Location,c.name)).then(function(q){e.modelEventDispatcher.dispatchEvent({type:"create",parent:a,newValue:q});s(q)},z)}},m=function(d){var A;c.classList.remove("dragOver");if(h){A=e.fileClient;for(var D=h,C;D;){if(D._item){C=D._item;break}D=D.parentNode}if(!C)return;var k="copy"===n,D=k?A.copyFile:A.moveFile;(v?v.showWhile(D.apply(A,[C.Location,a.Location]),b.formatMessage(f[k?"Copying ${0}":"Moving ${0}"],C.Location)):D.apply(A,
[C.Location,a.Location])).then(function(q){e.modelEventDispatcher.dispatchEvent({type:k?"copy":"move",oldValue:C,newValue:q,parent:a})},z)}else if(d.dataTransfer.items&&0<d.dataTransfer.items.length)for(A=0;A<d.dataTransfer.items.length;A++)D=null,"function"===typeof d.dataTransfer.items[A].getAsEntry?D=d.dataTransfer.items[A].getAsEntry():"function"===typeof d.dataTransfer.items[A].webkitGetAsEntry&&(D=d.dataTransfer.items[A].webkitGetAsEntry()),D&&q(D,null,a,e,g,e.fileClient);else if(d.dataTransfer.files&&
...
c.setSelection(a));return a}.bind(this))},reroot:function(){return(new m).reject()},isExpanded:function(a){a=this.model.getId(a);return this.renderer.tableTree.isExpanded(a)},getNameNode:function(a){if(a=this.model.getId(a))return p.node(a+"NameLink")},scopeUp:function(){},scopeDown:function(){},loadResourceList:function(a,c,b){a&&"object"===typeof a&&(a=a.ChildrenLocation||a.ContentLocation);a=l.makeRelative(a);if(!c&&a===this._lastPath)return(new m).resolve(this.treeRoot);this._lastPath=a;var d=
this;return c||a!==this.treeRoot.Path?this.load(this.fileClient.loadWorkspace(a),f["Loading "]+a).then(function(){d.treeRoot.Path=a;"function"===typeof b&&b();d.dispatchEvent({type:"rootChanged",root:d.treeRoot});return(new m).resolve(d.treeRoot)},function(a){d.treeRoot.Path=null;d.dispatchEvent({type:"rootChanged",root:d.treeRoot});return(new m).reject(a)}):(new m).resolve(d.treeRoot)},load:function(a,c,b){var d=p.node(this.parentId),h=p.node("progress");h||(h=document.createElement("div"),h.id=
"progress",p.empty(d),d.appendChild(h));p.empty(h);var e=setTimeout(function(){p.empty(h);h.appendChild(document.createTextNode(c))},500),n=this;return m.when(a,function(a){clearTimeout(e);if(!n.destroyed){n.treeRoot={};for(var q in a)n.treeRoot[q]=a[q];n.model=n.createModel();n.dragAndDrop&&(n._hookedDrag?n._makeDropTarget(n.treeRoot,d,!0):(a=(a=d&&("draggable"in d||"ondragstart"in d&&"ondrop"in d))&&!(!window.File||!window.FileList||!window.FileReader),n._hookedDrag=!0,a?n._makeDropTarget(n.treeRoot,
...
define("orion/URITemplate",[],function(){function f(a){this._text=a}function m(a){return a.replace("%25","%")}function p(a,b){if("U"===b)return encodeURIComponent(a).replace(/[!'()*]/g,function(a){return"%"+a.charCodeAt(0).toString(16).toUpperCase()});if("U+R"===b)return encodeURI(a).replace(/%5B/g,"[").replace(/%5D/g,"]").replace(c,m);if("U+R-,"===b)return encodeURI(a).replace(/%5B/g,"[").replace(/%5D/g,"]").replace(/,/g,"%2C");throw Error("Unknown allowed character set: "+b);}function b(a,c,b){for(var d=
[],e=0;e<a.length;e++)"undefined"!==typeof a[e]&&d.push(p(a[e],c));return d.join(b)}function l(a,c,b,d){for(var e=Object.keys(a),l=[],k=0;k<e.length;k++)"undefined"!==typeof a[e[k]]&&l.push(p(e[k],c)+b+p(a[e[k]],c));return l.join(d)}function g(a){if(0===a.length)throw Error("Invalid Expression: 0 length expression");(this._operator=d[a[0]])?a=a.substring(1):this._operator=d.NUL;for(var c=[],b=a.split(","),e=0;e<b.length;e++){var l=b[e].match(k);if(null===l)throw Error("Bad VarSpec: "+a);c.push({name:l[1],
...
"/":{first:"/",sep:"/",named:!1,ifemp:"",allow:"U"},";":{first:";",sep:";",named:!0,ifemp:"",allow:"U"},"?":{first:"?",sep:"&",named:!0,ifemp:"=",allow:"U"},"&":{first:"&",sep:"&",named:!0,ifemp:"=",allow:"U"},"#":{first:"#",sep:",",named:!1,ifemp:"",allow:"U+R"},",":{first:"",sep:",",named:!1,ifemp:"",allow:"U+R-,"}},k=/^((?:(?:[a-zA-Z0-9_])|(?:%[0-9A-F][0-9A-F]))(?:(?:[a-zA-Z0-9_.])|(?:%[0-9A-F][0-9A-F]))*)(?:(\*)|:([0-9]+))?$/,c=/%25[0-9A-F][0-9A-F]/g;f.prototype={expand:function(){return encodeURI(this._text)}};
g.prototype={expand:function(a){for(var c=[],d=0;d<this._varSpecList.length;d++){var e=this._varSpecList[d],k=e.name,g=a[k],f=typeof g;if("undefined"!==f&&null!==g){var x=0===c.length?this._operator.first:this._operator.sep,m=x;if("string"===f)this._operator.named&&(m+=p(k,"U+R"),m+=0===g.length?this._operator.ifemp:"="),-1!==e.prefix&&e.prefix<g.length&&(g=g.substring(0,e.prefix)),m+=p(g,this._operator.allow);else if(Array.isArray(g))e.explode?m+=b(g,this._operator.allow,this._operator.sep):(this._operator.named&&
(m+=p(k,"U+R"),m+=0===g.length?this._operator.ifemp:"="),m+=b(g,this._operator.allow,","));else if("object"===f)e.explode?m+=l(g,this._operator.allow,"=",this._operator.sep):(this._operator.named&&(m+=p(k,"U+R"),m+=0===Object.keys(g).length?this._operator.ifemp:"="),m+=l(g,this._operator.allow,",",","));else throw Error("bad param type: "+k+" : "+f);(m!==x||d<this._varSpecList.length-1)&&c.push(m)}}return c.join("")}};e.prototype={expand:function(a){for(var c=[],b=0;b<this._templateComponents.length;b++)c.push(this._templateComponents[b].expand(a));
return c.join("")}};return e});
define("orion/explorers/navigatorRenderer","i18n!orion/navigate/nls/messages orion/Deferred orion/explorers/explorer orion/explorers/navigationUtils orion/extensionCommands orion/objects orion/URITemplate orion/webui/littlelib".split(" "),function(f,m,p,b,l,g,e,d){function k(a){switch(a&&a.id){case "image/jpeg":case "image/png":case "image/gif":case "image/ico":case "image/tiff":case "image/svg":return!0}return!1}function c(a,c,b,d,f,x,p,v,z,q){var c=g.clone(c),t;if(c.Directory)t=document.createElement("a"),
t.className="navlinkonpage",t.href=!a?h:(new e(a+"#{,resource,params*}")).expand({resource:c.ChildrenLocation}),c.Name&&t.appendChild(document.createTextNode(c.Name));else{f||(f=l.getOpenWithCommands(b));if(!x)for(a=0;a<f.length;a++)"default"===f[a].isEditor&&(x=f[a]);t=document.createElement("a");t.className="navlink targetSelector";p&&"object"===typeof p&&Object.keys(p).forEach(function(a){t[a]=p[a]});var A=null,D=null;if(A=z?z.holderDom:t)D=document.createElement("span"),D.className="core-sprite-file modelDecorationSprite thumbnail",
A.appendChild(D);c.Name&&t.appendChild(document.createTextNode(c.Name));var C=!1,I=c.Location;v&&"object"===typeof v&&(c.params={},g.mixin(c.params,v));for(a=0;a<f.length;a++)if(v=f[a],v.visibleWhen(c)){I=v.hrefCallback({items:c});C=!0;break}m.when(d.getFileContentType(c),function(a){!C&&(x&&!k(a))&&(I=x.hrefCallback({items:c}));if(A){var b=A,d=D;if(a){var h,e=a.imageClass,n=a.image;e?(h=document.createElement("span"),h.className+=e,h.classList.add("thumbnail")):n&&(h=document.createElement("img"),
h.src=n,h.classList.add("thumbnail"));h&&b.replaceChild(h,d)}}t.href=I;q&&"function"===typeof q.updateFileNode&&q.updateFileNode(c,t,k(a))})}return t}function a(a,c,b,d){this.explorer=c;this.commandService=b;this.contentTypeService=d;this.openWithCommands=null;this.actionScopeId=a.actionScopeId;this._init(a);this.target="_self"}var h=new e("#{,resource,params*}");a.prototype=new p.SelectionRenderer;a.prototype.wrapperCallback=function(a){a.setAttribute("role","tree")};a.prototype.tableCallback=function(a){a.setAttribute("aria-label",
f.Navigator);a.setAttribute("role","presentation")};a.prototype.rowCallback=function(a){a.setAttribute("role","treeitem")};a.prototype.emptyCallback=function(a){var c=document.createElement("tr"),b=document.createElement("td");b.colSpan=this.oneColumn?1:3;var h=document.createElement("div");h.classList.add("noFile");h.textContent=f.NoFile;var e=document.createElement("span");e.appendChild(document.createTextNode(f.File));d.processDOMNodes(h,[e]);b.appendChild(h);c.appendChild(b);a.appendChild(c)};
...
this.contentTypeService),(a=this.getFolderImage(a))&&b.insertBefore(a,b.firstChild)):(b=document.createElement("span"),b.textContent=a.Name);return b};a.prototype.updateFileNode=function(){};a.prototype.showFolderLinks=!0;a.prototype.getCellElement=function(a,d,h){switch(a){case 0:var a=document.createElement("td"),e=document.createElement("span");e.id=h.id+"MainCol";e.setAttribute("role","presentation");a.appendChild(e);a.setAttribute("role","presentation");e.className="mainNavColumn";var k;if(d.Directory)this.getExpandImage(h,
e),k=this.createFolderNode(d),e.appendChild(k),this.explorer._makeDropTarget(d,k),this.explorer._makeDropTarget(d,h);else{if(!this.openWithCommands){this.openWithCommands=l.getOpenWithCommands(this.commandService);for(k=0;k<this.openWithCommands.length;k++)"default"===this.openWithCommands[k].isEditor&&(this.defaultEditor=this.openWithCommands[k])}k=c("",d,this.commandService,this.contentTypeService,this.openWithCommands,this.defaultEditor,{target:this.target},null,null,this);e.appendChild(k)}k&&
(k.id=h.id+"NameLink",1===k.nodeType&&(b.addNavGrid(this.explorer.getNavDict(),d,k),k.setAttribute("role","link"),k.setAttribute("tabindex","-1")));this.actionScopeId&&this.commandService.renderCommands(this.actionScopeId,e,d,this.explorer,"tool",null,!0);return a;case 1:if(this.oneColumn)return null;h=document.createElement("td");d.LocalTimeStamp&&(h.textContent=(new Date(d.LocalTimeStamp)).toLocaleString());return h;case 2:if(this.oneColumn)return null;h=document.createElement("td");!d.Directory&&
"number"===typeof d.Length&&(d=parseInt(d.Length,10)/1024,h.textContent=Math.ceil(d).toLocaleString()+" KB");h.style.textAlign="right";return h}};a.prototype.constructor=a;return{NavigatorRenderer:a,isImage:k,createLink:c}});
(function(){function f(a){this.tokens=[];this.tokens.links={};this.options=a||d.defaults;this.rules=k.normal;this.options.gfm&&(this.rules=this.options.tables?k.tables:k.gfm)}function m(a,b){this.options=b||d.defaults;this.links=a;this.rules=c.normal;if(!this.links)throw Error("Tokens array requires a `links` property.");this.options.gfm?this.rules=this.options.breaks?c.breaks:c.gfm:this.options.pedantic&&(this.rules=c.pedantic)}function p(a){this.tokens=[];this.token=null;this.options=a||d.defaults}
...
typeof c){n||(n=c,c=null);c&&(c=e({},d.defaults,c));var l=c.highlight,k,g,y=0;try{k=f.lex(a,c)}catch(m){return n(m)}g=k.length;var w=function(a){var q,b;!0!==a&&delete c.highlight;try{q=p.parse(k,c)}catch(d){b=d}c.highlight=l;return b?n(b):n(null,q)};if(!l||3>l.length)return w(!0);if(!g)return w();for(;y<k.length;y++)(function(a){return"code"!==a.type?--g||w():l(a.text,a.lang,function(q,c){if(null==c||c===a.text)return--g||w();a.text=c;a.escaped=!0;--g||w()})})(k[y])}else try{return c&&(c=e({},d.defaults,
c)),p.parse(f.lex(a,c),c)}catch(v){v.message+="\nPlease report this to https://github.com/chjj/marked.";if((c||d.defaults).silent)return"<p>An error occured:</p><pre>"+b(v.message+"",!0)+"</pre>";throw v;}}var k={newline:/^\n+/,code:/^( {4}[^\n]+\n*)+/,fences:g,hr:/^( *[-*_]){3,} *(?:\n+|$)/,heading:/^ *(#{1,6}) *([^\n]+?) *#* *(?:\n+|$)/,nptable:g,lheading:/^([^\n]+)\n *(=|-){3,} *\n*/,blockquote:/^( *>[^\n]+(\n[^\n]+)*\n*)+/,list:/^( *)(bull) [\s\S]+?(?:hr|\n{2,}(?! )(?!\1bull )\n*|\s*$)/,html:/^ *(?:comment|closed|closing) *(?:\n{2,}|\s*$)/,
...
k.html=l(k.html)("comment",/<\!--[\s\S]*?--\>/)("closed",/<(tag)[\s\S]+?<\/\1>/)("closing",/<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g,k._tag)();k.paragraph=l(k.paragraph)("hr",k.hr)("heading",k.heading)("lheading",k.lheading)("blockquote",k.blockquote)("tag","<"+k._tag)("def",k.def)();k.normal=e({},k);k.gfm=e({},k.normal,{fences:/^ *(`{3,}|~{3,}) *(\S+)? *\n([\s\S]+?)\s*\1 *(?:\n+|$)/,paragraph:/^/});k.gfm.paragraph=l(k.paragraph)("(?!","(?!"+k.gfm.fences.source.replace("\\1","\\2")+"|")();k.tables=
e({},k.gfm,{nptable:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,table:/^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/});f.rules=k;f.lex=function(a,c){return(new f(c)).lex(a)};f.prototype.lex=function(a){a=a.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ").replace(/\u00a0/g," ").replace(/\u2424/g,"\n");return this.token(a,!0)};f.prototype.token=function(a,c){for(var a=a.replace(/^ +$/gm,""),b,d,e,l,g,f,m;a;){if(e=this.rules.newline.exec(a))a=a.substring(e[0].length),1<
...
m;f++)g=e[f],d=g.length,g=g.replace(/^ *([*+-]|\d+\.) +/,""),~g.indexOf("\n ")&&(d-=g.length,g=!this.options.pedantic?g.replace(RegExp("^ {1,"+d+"}","gm"),""):g.replace(/^ {1,4}/gm,"")),this.options.smartLists&&f!==m-1&&(d=k.bullet.exec(e[f+1])[0],l!==d&&!(1<l.length&&1<d.length)&&(a=e.slice(f+1).join("\n")+a,f=m-1)),d=b||/\n\n(?!\s*$)/.test(g),f!==m-1&&(b="\n"===g[g.length-1],d||(d=b)),this.tokens.push({type:d?"loose_item_start":"list_item_start"}),this.token(g,!1),this.tokens.push({type:"list_item_end"});
...
this.token.text;case "paragraph":return"<p>"+this.inline.output(this.token.text)+"</p>\n";case "text":return"<p>"+this.parseText()+"</p>\n"}};g.exec=g;d.options=d.setOptions=function(a){e(d.defaults,a);return d};d.defaults={gfm:!0,tables:!0,breaks:!1,pedantic:!1,sanitize:!1,smartLists:!1,silent:!1,highlight:null,langPrefix:"lang-",smartypants:!1};d.Parser=p;d.parser=p.parse;d.Lexer=f;d.lexer=f.lex;d.InlineLexer=m;d.inlineLexer=m.output;d.parse=d;"object"===typeof exports?module.exports=d:"function"===
typeof define&&define.amd?define("marked/marked",[],function(){return d}):this.marked=d}).call(function(){return this||("undefined"!==typeof window?window:global)}());define("orion/editor/i18n",{load:function(f,m,p){m.specified&&m.specified("orion/bootstrap")?m(["orion/i18n!"+f],function(b){p(b)}):p({})}});
...
define("orion/editor/nls/messages",["orion/editor/i18n!orion/editor/nls/messages","orion/editor/nls/root/messages"],function(f,m){var p={root:m},b;for(b in f)f.hasOwnProperty(b)&&"undefined"===typeof p[b]&&(p[b]=f[b]);return p});
define("orion/editor/eventTarget",[],function(){function f(){}f.addMixin=function(m){var p=f.prototype,b;for(b in p)p.hasOwnProperty(b)&&(m[b]=p[b])};f.prototype={addEventListener:function(f,p,b){this._eventTypes||(this._eventTypes={});var l=this._eventTypes[f];l||(l=this._eventTypes[f]={level:0,listeners:[]});l.listeners.push({listener:p,useCapture:b})},dispatchEvent:function(f){var p=f.type;this._dispatchEvent("pre"+p,f);this._dispatchEvent(p,f);this._dispatchEvent("post"+p,f)},_dispatchEvent:function(f,
...
p,b){if(this._eventTypes){var l=this._eventTypes[f];if(l){for(var g=l.listeners,e=0,d=g.length;e<d;e++){var k=g[e];if(k&&k.listener===p&&k.useCapture===b){0!==l.level?(g[e]=null,l.compact=!0):g.splice(e,1);break}}0===g.length&&delete this._eventTypes[f]}}}};return{EventTarget:f}});define("orion/regex",[],function(){return{escape:function(f){return f.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g,"\\$&")},parse:function(f){return(f=/^\s*\/(.+)\/([gim]{0,3})\s*$/.exec(f))?{pattern:f[1],flags:f[2]}:null}}});
define("orion/editor/textModel",["orion/editor/eventTarget","orion/regex","orion/util"],function(f,m,p){function b(b,g){this._lastLineIndex=-1;this._text=[""];this._lineOffsets=[0];this.setText(b);this.setLineDelimiter(g)}b.prototype={destroy:function(){},find:function(b){1<this._text.length&&(this._text=[this._text.join("")]);var g=b.string,e=b.regex,d=g,k="",c=b.caseInsensitive;if(d)if(e){if(g=m.parse(d))d=g.pattern,k=g.flags}else d=g.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g,"\\$&"),c&&(d=d.replace(/[iI\u0130\u0131]/g,
"[Ii\u0130\u0131]"));var a=null,h;if(d){var g=b.reverse,n=b.wrap,e=b.wholeWord,r=b.start||0,b=b.end,f=null!==b&&void 0!==b;-1===k.indexOf("g")&&(k+="g");-1===k.indexOf("m")&&(k+="m");c&&-1===k.indexOf("i")&&(k+="i");e&&(d="\\b"+d+"\\b");var s=this._text[0],y,x,p=0;f&&(c=r<b?r:b,s=s.substring(c,r<b?b:r),p=c);var v=RegExp(d,k);g?h=function(){var a=null;for(v.lastIndex=0;;){x=v.lastIndex;y=v.exec(s);if(x===v.lastIndex)return null;if(y){if(!(y.index+p<r)){if(!n||a)break;r=s.length+p}a={start:y.index+
p,end:v.lastIndex+p}}else break}a&&(r=a.start);return a}:(f||(v.lastIndex=r),h=function(){for(;;){x=v.lastIndex;y=v.exec(s);if(x===v.lastIndex)break;if(y)return{start:y.index+p,end:v.lastIndex+p};if(!(0!==x&&n))break}return null});a=h()}return{next:function(){var c=a;c&&(a=h());return c},hasNext:function(){return null!==a}}},getCharCount:function(){for(var b=0,g=0;g<this._text.length;g++)b+=this._text[g].length;return b},getLine:function(b,g){var e=this.getLineCount();if(!(0<=b&&b<e))return null;
var d=this._lineOffsets[b];if(b+1<e){e=this.getText(d,this._lineOffsets[b+1]);if(g)return e;for(var d=e.length,k;10===(k=e.charCodeAt(d-1))||13===k;)d--;return e.substring(0,d)}return this.getText(d)},getLineAtOffset:function(b){var g=this.getCharCount();if(!(0<=b&&b<=g))return-1;var e=this.getLineCount();if(b===g)return e-1;var d,k,c=this._lastLineIndex;if(0<=c&&c<e&&(d=this._lineOffsets[c],k=c+1<e?this._lineOffsets[c+1]:g,d<=b&&b<k))return c;for(var a=e,h=-1;1<a-h;)if(c=Math.floor((a+h)/2),d=this._lineOffsets[c],
k=c+1<e?this._lineOffsets[c+1]:g,b<=d)a=c;else if(b<k){a=c;break}else h=c;return this._lastLineIndex=a},getLineCount:function(){return this._lineOffsets.length},getLineDelimiter:function(){return this._lineDelimiter},getLineEnd:function(b,g){var e=this.getLineCount();if(!(0<=b&&b<e))return-1;if(b+1<e){e=this._lineOffsets[b+1];if(g)return e;for(var d=this.getText(Math.max(this._lineOffsets[b],e-2),e),k=d.length,c;10===(c=d.charCodeAt(k-1))||13===c;)k--;return e-(d.length-k)}return this.getCharCount()},
getLineStart:function(b){return!(0<=b&&b<this.getLineCount())?-1:this._lineOffsets[b]},getText:function(b,g){void 0===b&&(b=0);void 0===g&&(g=this.getCharCount());if(b===g)return"";for(var e=0,d=0,k;d<this._text.length;){k=this._text[d].length;if(b<=e+k)break;e+=k;d++}for(var c=e,a=d;d<this._text.length;){k=this._text[d].length;if(g<=e+k)break;e+=k;d++}if(a===d)return this._text[a].substring(b-c,g-e);c=this._text[a].substring(b-c);e=this._text[d].substring(0,g-e);return c+this._text.slice(a+1,d).join("")+
e},onChanging:function(b){return this.dispatchEvent(b)},onChanged:function(b){return this.dispatchEvent(b)},setLineDelimiter:function(b,g){"auto"===b&&(b=void 0,1<this.getLineCount()&&(b=this.getText(this.getLineEnd(0),this.getLineEnd(0,!0))));this._lineDelimiter=b?b:p.platformDelimiter;if(g){var e=this.getLineCount();if(1<e){for(var d=Array(e),k=0;k<e;k++)d[k]=this.getLine(k);this.setText(d.join(this._lineDelimiter))}}},setText:function(b,g,e){void 0===b&&(b="");void 0===g&&(g=0);void 0===e&&(e=
this.getCharCount());if(!(g===e&&""===b)){for(var d=this.getLineAtOffset(g),k=this.getLineAtOffset(e),c=g,a=e-g,h=k-d,n=b.length,r=0,f=this.getLineCount(),s=0,y=0,m=0,p=[];;){-1!==s&&s<=m&&(s=b.indexOf("\r",m));-1!==y&&y<=m&&(y=b.indexOf("\n",m));if(-1===y&&-1===s)break;m=-1!==s&&-1!==y?s+1===y?y+1:(s<y?s:y)+1:-1!==s?s+1:y+1;p.push(g+m);r++}this.onChanging({type:"Changing",text:b,start:c,removedCharCount:a,addedCharCount:n,removedLineCount:h,addedLineCount:r});0===p.length&&(m=this.getLineStart(d),
k=k+1<f?this.getLineStart(k+1):this.getCharCount(),g!==m&&(b=this.getText(m,g)+b,g=m),e!==k&&(b+=this.getText(e,k),e=k));m=n-a;for(k=d+h+1;k<f;k++)this._lineOffsets[k]+=m;if(5E4>p.length)d=[d+1,h].concat(p),Array.prototype.splice.apply(this._lineOffsets,d);else{m=d+1;this._lineOffsets.splice(m,h);for(f=0;f<p.length;f+=5E4)d=[m,0].concat(p.slice(f,Math.min(p.length,f+5E4))),Array.prototype.splice.apply(this._lineOffsets,d),m+=5E4}for(m=f=0;m<this._text.length;){k=this._text[m].length;if(g<=f+k)break;
f+=k;m++}d=f;for(p=m;m<this._text.length;){k=this._text[m].length;if(e<=f+k)break;f+=k;m++}k=this._text[m];g=this._text[p].substring(0,g-d);e=k.substring(e-f);p=[p,m-p+1];g&&p.push(g);b&&p.push(b);e&&p.push(e);Array.prototype.splice.apply(this._text,p);0===this._text.length&&(this._text=[""]);this.onChanged({type:"Changed",start:c,removedCharCount:a,addedCharCount:n,removedLineCount:h,addedLineCount:r})}}};f.EventTarget.addMixin(b.prototype);return{TextModel:b}});
define("orion/keyBinding",["orion/util"],function(f){function m(b,l,g,e,d,k){this.type=k||"keydown";this.keyCode="string"===typeof b&&"keydown"===this.type?b.toUpperCase().charCodeAt(0):b;this.mod1=void 0!==l&&null!==l?l:!1;this.mod2=void 0!==g&&null!==g?g:!1;this.mod3=void 0!==e&&null!==e?e:!1;this.mod4=void 0!==d&&null!==d?d:!1}function p(b){this.keys=b}m.prototype={getKeys:function(){return[this]},match:function(b,l){if(void 0!==l){if(0!==l)return!1}else if(b instanceof Array){if(1<b.length)return!1;
...
define("orion/editor/textTheme",["require","orion/editor/eventTarget","orion/util"],function(f,m,p){function b(b){b=b||{};this._document=b.document||document}var l={};b.getTheme=function(g){var g=g||"default",e=l[g];e||(e=l[g]=new b);return e};b.prototype={getThemeClass:function(){return this._themeClass},setThemeClass:function(b,e){var d=this,k=d._themeClass;d._themeClass=b;this._load(b,e,function(){d.onThemeChanged({type:"ThemeChanged",oldValue:k,newValue:d.getThemeClass()})})},onThemeChanged:function(b){return this.dispatchEvent(b)},
buildStyleSheet:function(b,e){function d(c,a,d){a&&(k.push("."+b+" ."+c+" {"),k.push("\t"+(d?"background-color":"color")+": "+a+";"),k.push("}"))}var k=[];k.push("");k.push("."+b+" {");e.fontFamily&&k.push("\tfont-family: "+e.fontFamily+";");e.fontSize&&k.push("\tfont-size: "+e.fontSize+";");e.fontSize&&k.push("\tcolor: "+e.text+";");k.push("}");k.push("."+b+".textview {");e.background&&k.push("\tbackground-color: "+e.background+";");k.push("}");d("ruler.annotations",e.annotationRuler,!0);d("ruler.lines",
...
d("comment.block.documentation",e.comment,!1);d("keyword.other.documentation.markup",e.comment,!1);return k.join("\n")},_createStyle:function(b,e,d,k){var c=this._document,b="orion-theme-"+b,a=c.getElementById(b);if(a){if(k||a.firstChild.data===e)return;a.removeChild(a.firstChild);a.appendChild(c.createTextNode(e))}else k?(a=p.createElement(c,"link"),a.rel="stylesheet",a.type="text/css",a.href=e,a.addEventListener("load",function(){d()})):(a=p.createElement(c,"style"),a.appendChild(c.createTextNode(e))),
a.id=b,(c.getElementsByTagName("head")[0]||c.documentElement).appendChild(a);k||d()},_load:function(b,e,d){if(b)if("string"===typeof e)this._createStyle(b,e,d);else if(e=e.href,".css"!==e.substring(e.length-4)&&(e+=".css"),/^\//.test(e)||/[a-zA-Z0-9]+:\/\//i.test(e)||!f.toUrl)this._createStyle(b,e,d,!0);else{var k=this;f(["text!"+e],function(c){k._createStyle(b,c,d,!1)})}else d()}};m.EventTarget.addMixin(b.prototype);return{TextTheme:b}});
define("orion/editor/util",[],function(){return{contains:function(f,m){if(!m)return!1;if(!f.compareDocumentPosition){for(var p=m;p;){if(f===p)return!0;p=p.parentNode}return!1}return f===m||0!==(f.compareDocumentPosition(m)&16)},addEventListener:function(f,m,p,b){"function"===typeof f.addEventListener?f.addEventListener(m,p,!0===b):f.attachEvent("on"+m,p)},removeEventListener:function(f,m,p,b){"function"===typeof f.removeEventListener?f.removeEventListener(m,p,!0===b):f.detachEvent("on"+m,p)}}});
define("orion/editor/textView","i18n!orion/editor/nls/messages orion/editor/textModel orion/editor/keyModes orion/editor/eventTarget orion/editor/textTheme orion/editor/util orion/util".split(" "),function(f,m,p,b,l,g,e){function d(a,c,b){if(b){c.className="";for(var b=c.attributes,d=b.length;0<d--;)(!e.isIE||9<=e.isIE||9>e.isIE&&b[d].specified)&&c.removeAttribute(b[d].name)}if(a){a.styleClass&&(c.className=a.styleClass);if(b=a.style)for(var h in b)b.hasOwnProperty(h)&&(c.style[h]=b[h]);if(a=a.attributes)for(var n in a)a.hasOwnProperty(n)&&
c.setAttribute(n,a[n])}}function k(a){return a instanceof Array?a.slice(0):a}function c(a,c){if(!a)return c;if(!c)return a;for(var b in c)c.hasOwnProperty(b)&&(a.hasOwnProperty(b)||(a[b]=c[b]));return a}function a(q,c){if(q===c)return!0;if(q&&!c||!q&&c||q&&q.constructor===String||c&&c.constructor===String)return!1;if(q instanceof Array||c instanceof Array){if(!(q instanceof Array&&c instanceof Array)||q.length!==c.length)return!1;for(var b=0;b<q.length;b++)if(!a(q[b],c[b]))return!1;return!0}if(!(q instanceof
Object)||!(c instanceof Object))return!1;for(b in q)if(q.hasOwnProperty(b)&&(!c.hasOwnProperty(b)||!a(q[b],c[b])))return!1;for(b in c)if(!q.hasOwnProperty(b))return!1;return!0}function h(a,c,b){for(var d=0,h=0,e=0,n=a.length;e<n;){-1!==d&&d<=e&&(d=a.indexOf("\r",e));-1!==h&&h<=e&&(h=a.indexOf("\n",e));var k=e,g;if(-1===h&&-1===d){c(a.substring(e));break}-1!==d&&-1!==h?d+1===h?(g=d,e=h+1):(g=d<h?d:h,e=(d<h?d:h)+1):-1!==d?(g=d,e=d+1):(g=h,e=h+1);c(a.substring(k,g));b()}}function n(a){var c,b,d,h,e=
...
this.end+(this.caret?" caret is at start":" caret is at end")},isEmpty:function(){return this.start===this.end},equals:function(a){return this.caret===a.caret&&this.start===a.start&&this.end===a.end}};s.prototype={toString:function(){return"{l="+this.left+", t="+this.top+", r="+this.right+", b="+this.bottom+"}"}};y.prototype={create:function(a,c){if(!this._lineDiv){var b=this._lineDiv=this._createLine(a,c,this.lineIndex);b._line=this;return b}},_createLine:function(q,c,b){var h=this.view,n=h._model,
k=n.getLine(b),g=n.getLineStart(b),f={type:"LineStyle",textView:h,lineIndex:b,lineText:k,lineStart:g};if(2E3>k.length)h.onLineStyle(f);n=c||e.createElement(q.ownerDocument,"div");if(!c||!a(c.viewStyle,f.style))d(f.style,n,c),c&&(c._trim=null),n.viewStyle=f.style,n.setAttribute("role","presentation");n.lineIndex=b;b=[];this._createRanges(f.ranges,k,0,k.length,g,{tabOffset:0,ranges:b});k=" ";!h._fullSelection&&9>e.isIE&&(k="\ufeff");f={text:k,style:h._metrics.largestFontStyle,ignoreChars:1};0===b.length||
!b[b.length-1].style||"div"!==b[b.length-1].style.tagName?b.push(f):b.splice(b.length-1,0,f);var r,l,s,m,u,k=h=0,y,v;if(c){if(l=c.modelChangedEvent)0===l.removedLineCount&&0===l.addedLineCount?(v=l.start-g,y=l.addedCharCount-l.removedCharCount):v=-1,c.modelChangedEvent=void 0;l=c.firstChild}for(g=0;g<b.length;g++){f=b[g];m=f.text;h+=m.length;r=f.style;if(l)if(u=l.firstChild.data,s=l.viewStyle,u===m&&a(r,s)){k+=u.length;l._rectsCache=void 0;r=l=l.nextSibling;continue}else for(;l;){if(-1!==v){s=h;s>=
v&&(s-=y);u=(u=l.firstChild.data)?u.length:0;if(k+u>s)break;k+=u}s=l.nextSibling;n.removeChild(l);l=s}r=this._createSpan(n,m,r,f.ignoreChars);l?n.insertBefore(r,l):n.appendChild(r);c&&(c.lineWidth=void 0)}if(c)for(q=r?r.nextSibling:null;q;)s=q.nextSibling,c.removeChild(q),q=s;else q.appendChild(n);return n},_createRanges:function(q,c,b,d,h,e){if(!(b>d)){if(q)for(var n=0;n<q.length;n++){var k=q[n];if(!(k.end<h+b)){var f=Math.max(h+b,k.start)-h;if(f>d)break;var g=Math.min(h+d,k.end)-h;if(f<=g){f=Math.max(b,
f);g=Math.min(d,g);b<f&&this._createRange(c,b,f,null,e);if(!k.style||!k.style.unmergeable)for(;n+1<q.length&&q[n+1].start-h===g&&a(k.style,q[n+1].style);)k=q[n+1],g=Math.min(h+d,k.end)-h,n++;this._createRange(c,f,g,k.style,e);b=g}}}b<d&&this._createRange(c,b,d,null,e)}},_createRange:function(a,c,b,d,h){if(!(c>b)){var e=this.view._customTabSize;if(e&&8!==e)for(var n=a.indexOf("\t",c);-1!==n&&n<b;){c<n&&(c={text:a.substring(c,n),style:d},h.ranges.push(c),h.tabOffset+=c.text.length);c=e-h.tabOffset%
e;if(0<c){for(var k="\u00a0",f=1;f<c;f++)k+=" ";c={text:k,style:d,ignoreChars:c-1};h.ranges.push(c);h.tabOffset+=c.text.length}c=n+1;if(c===b)return;n=a.indexOf("\t",c)}c<=b&&(c={text:a.substring(c,b),style:d},h.ranges.push(c),h.tabOffset+=c.text.length)}},_createSpan:function(a,c,b,h){var n=this.view,k="span";b&&b.tagName&&(k=b.tagName.toLowerCase());var f="a"===k;f&&(a.hasLink=!0);f&&!n._linksVisible&&(k="span");f=a.ownerDocument;a=e.createElement(a.ownerDocument,k);b&&b.html?(a.innerHTML=b.html,
a.ignore=!0):b&&b.node?(a.appendChild(b.node),a.ignore=!0):a.appendChild(f.createTextNode(b&&b.text?b.text:c));d(b,a);if("a"===k){var g=n._getWindow();w(a,"click",function(a){return n._handleLinkClick(a?a:g.event)},!1)}a.viewStyle=b;h&&(a.ignoreChars=h);return a},_ensureCreated:function(){return this._lineDiv?this._lineDiv:this._createdDiv=this.create(this.view._clientDiv,null)},getBoundingClientRect:function(a,c){var b=this._ensureCreated(),d=this.view;if(void 0===a)return this._getLineBoundingClientRect(b,
!0);var h=d._model,n=b.ownerDocument,k=this.lineIndex,f=null;if(a<h.getLineEnd(k)){k=h.getLineStart(k);for(h=b.firstChild;h;){if(!h.ignore){var g=h.firstChild,r=g.length;h.ignoreChars&&(r-=h.ignoreChars);if(k+r>a){f=a-k;if(1===g.length)f=new s(h.getBoundingClientRect());else if(d._isRangeRects)n=n.createRange(),n.setStart(g,f),n.setEnd(g,f+1),f=new s(n.getBoundingClientRect());else if(e.isIE)n=n.body.createTextRange(),n.moveToElementText(h),n.collapse(),(k=0===f&&8===e.isIE)&&(f=1),n.moveEnd("character",
f+1),n.moveStart("character",f),f=new s(n.getBoundingClientRect()),k&&(f.left=h.getClientRects()[0].left);else{var l=g.data;h.removeChild(g);h.appendChild(n.createTextNode(l.substring(0,f)));var m=e.createElement(n,"span");m.appendChild(n.createTextNode(l.substring(f,f+1)));h.appendChild(m);h.appendChild(n.createTextNode(l.substring(f+1)));f=new s(m.getBoundingClientRect());h.innerHTML="";h.appendChild(g);this._createdDiv||(n=d._getSelection(),(k<=n.start&&n.start<k+r||k<=n.end&&n.end<k+r)&&d._updateDOMSelection())}e.isIE&&
(n=b.ownerDocument.defaultView||b.ownerDocument.parentWindow,b=n.screen.logicalXDPI/n.screen.deviceXDPI,n=n.screen.logicalYDPI/n.screen.deviceYDPI,f.left*=b,f.right*=b,f.top*=n,f.bottom*=n);break}k+=r}h=h.nextSibling}}b=this.getBoundingClientRect();f||(d._wrapMode?(d=this.getClientRects(),f=d[d.length-1],f.left=f.right,f.left+=b.left,f.top+=b.top,f.right+=b.left,f.bottom+=b.top):(f=new s(b),f.left=f.right));if(c||void 0===c)f.left-=b.left,f.top-=b.top,f.right-=b.left,f.bottom-=b.top;return f},_getClientRects:function(a,
c){var b,d,h,e;if(!a._rectsCache){b=a.getClientRects();d=Array(b.length);for(e=0;e<b.length;e++)h=d[e]=new s(b[e]),h.left-=c.left,h.top-=c.top,h.right-=c.left,h.bottom-=c.top;a._rectsCache=d}b=a._rectsCache;d=[b.length];for(e=0;e<b.length;e++)d[e]=new s(b[e]);return d},getClientRects:function(a){if(!this.view._wrapMode)return[this.getBoundingClientRect()];for(var c=this._ensureCreated(),b=[],d=c.firstChild,h,e=c.getBoundingClientRect();d;){if(!d.ignore)for(var n=this._getClientRects(d,e),c=0;c<n.length;c++){var k=
n[c],f;if(k.top!==k.bottom){var g=k.top+(k.bottom-k.top)/2;for(f=0;f<b.length&&!(h=b[f],h.top<=g&&g<h.bottom);f++);f===b.length?b.push(k):(k.left<h.left&&(h.left=k.left),k.top<h.top&&(h.top=k.top),k.right>h.right&&(h.right=k.right),k.bottom>h.bottom&&(h.bottom=k.bottom))}}d=d.nextSibling}return void 0!==a?b[a]:b},_getLineBoundingClientRect:function(a,c){var b=new s(a.getBoundingClientRect());if(!this.view._wrapMode){b.right=b.left;for(var d=a.lastChild;d&&d.ignoreChars===d.firstChild.length;)d=d.previousSibling;
...
var c=this.getClientRects();return this.getOffset(c[a].left+1,c[a].top+1)},getOffset:function(a,c){var b=this.view,d=b._model,h=this.lineIndex,n=d.getLineStart(h),k=d.getLineEnd(h);if(n===k)return n;var f=this._ensureCreated(),g=this.getBoundingClientRect(),r,l;if(b._wrapMode){r=this.getClientRects();c<r[0].top&&(c=r[0].top);for(var s=0;s<r.length&&!(l=r[s],l.top<=c&&c<l.bottom);s++);a<l.left&&(a=l.left);a>l.right&&(a=l.right-1)}else 0>a&&(a=0),a>g.right-g.left&&(a=g.right-g.left);var m=f.ownerDocument,
s=m.defaultView||m.parentWindow,u=e.isIE?s.screen.logicalXDPI/s.screen.deviceXDPI:1,y=e.isIE?s.screen.logicalYDPI/s.screen.deviceYDPI:1,s=n,v=f.firstChild;a:for(;v;){if(!v.ignore){var p=v.firstChild,f=p.length;v.ignoreChars&&(f-=v.ignoreChars);var x,z,w;r=this._getClientRects(v,g);for(var L=0;L<r.length;L++)if(l=r[L],l.left<=a&&a<l.right&&(!b._wrapMode||l.top<=c&&c<l.bottom)){var L=l.left+g.left,H;if(e.isIE||b._isRangeRects){for(var m=b._isRangeRects?m.createRange():m.body.createTextRange(),G=f,M=
-1;1<G-M;){var V=Math.floor((G+M)/2);r=M+1;l=V===f-1&&v.ignoreChars?p.length:V+1;H=0===r&&8===e.isIE;b._isRangeRects?(m.setStart(p,r),m.setEnd(p,l)):(H&&(r=1),m.moveToElementText(v),m.move("character",r),m.moveEnd("character",l-r));r=m.getClientRects();for(var X=!1,W=0;W<r.length;W++)if(l=r[W],x=(H?L:l.left)*u-g.left,w=l.right*u-g.left,z=l.top*y-g.top,l=l.bottom*y-g.top,x<=a&&a<w&&(!b._wrapMode||z<=c&&c<l)){X=!0;break}X?G=V:M=V}s+=G;r=G;l=G===f-1&&v.ignoreChars?p.length:Math.min(G+1,p.length);b._isRangeRects?
(m.setStart(p,r),m.setEnd(p,l)):(m.moveToElementText(v),m.move("character",r),m.moveEnd("character",l-r));r=m.getClientRects();b=!1;0<r.length&&(l=r[0],x=(H?L:l.left)*u-g.left,w=l.right*u-g.left,b=a>x+(w-x)/2);g=s-n;d=d.getLine(h);h=d.charCodeAt(g);55296<=h&&56319>=h&&b?g<d.length&&(h=d.charCodeAt(g+1),56320<=h&&57343>=h&&(s+=1)):56320<=h&&(57343>=h&&!b)&&0<g&&(h=d.charCodeAt(g-1),55296<=h&&56319>=h&&(s-=1));b&&s++}else{d=[];for(h=0;h<f;h++)d.push("<span>"),h===f-1?d.push(p.data.substring(h)):d.push(p.data.substring(h,
h+1)),d.push("</span>");v.innerHTML=d.join("");for(d=v.firstChild;d;){l=d.getBoundingClientRect();x=l.left-g.left;w=l.right-g.left;if(x<=a&&a<w){a>x+(w-x)/2&&s++;break}s++;d=d.nextSibling}this._createdDiv||(v.innerHTML="",v.appendChild(p),g=b._getSelection(),(s<=g.start&&g.start<s+f||s<=g.end&&g.end<s+f)&&b._updateDOMSelection())}break a}s+=f}v=v.nextSibling}return Math.min(k,Math.max(n,s))},getNextOffset:function(a,c){if("line"===c.unit){var b=this.view._model,d=b.getLineAtOffset(a);if(0<c.count)return c.count--,
b.getLineEnd(d);c.count++;return b.getLineStart(d)}return"wordend"===c.unit||"wordWS"===c.unit||"wordendWS"===c.unit?this._getNextOffset_W3C(a,c):e.isIE?this._getNextOffset_IE(a,c):this._getNextOffset_W3C(a,c)},_getNextOffset_W3C:function(a,c){function b(a){return 33<=a&&47>=a||58<=a&&64>=a||91<=a&&94>=a||96===a||123<=a&&126>=a}function d(a){return 32===a||9===a}var h=this.view._model,e=h.getLineAtOffset(a),n=h.getLine(e),k=h.getLineStart(e),h=h.getLineEnd(e),e=n.length,f=a-k,g,r=0>c.count?-1:1;if("word"===
c.unit||"wordend"===c.unit||"wordWS"===c.unit||"wordendWS"===c.unit)for(var l,s,m;0!==c.count;){if(0<c.count){if(f===e)return h;g=n.charCodeAt(f);l=b(g);s=!l&&!d(g);for(f++;f<e;){g=n.charCodeAt(f);if("wordWS"!==c.unit&&"wordendWS"!==c.unit){m=b(g);if("wordend"===c.unit){if(!m&&l)break}else if(m&&!l)break;g=!m&&!d(g)}else g=!d(g);if("wordend"===c.unit||"wordendWS"===c.unit){if(!g&&s)break}else if(g&&!s)break;s=g;l=m;f++}}else{if(0===f)return k;f--;g=n.charCodeAt(f);l=b(g);for(s=!l&&!d(g);0<f;){g=n.charCodeAt(f-
1);if("wordWS"!==c.unit&&"wordendWS"!==c.unit){m=b(g);if("wordend"===c.unit){if(m&&!l)break}else if(!m&&l)break;g=!m&&!d(g)}else g=!d(g);if("wordend"===c.unit||"wordendWS"===c.unit){if(g&&!s)break}else if(!g&&s)break;s=g;l=m;f--}}c.count-=r}else for(;0!==c.count&&0<=f+r&&f+r<=e;)f+=r,g=n.charCodeAt(f),56320<=g&&57343>=g&&0<f&&(g=n.charCodeAt(f-1),55296<=g&&56319>=g&&(f+=r)),c.count-=r;return k+f},_getNextOffset_IE:function(a,c){var b=this._ensureCreated(),d=this.view._model,h=this.lineIndex,e=0,n;
n=d.getLineStart(h);var k=b.ownerDocument,f=0>c.count?-1:1;if(a===d.getLineEnd(h)){for(b=b.lastChild;b&&b.ignoreChars===b.firstChild.length;)b=b.previousSibling;if(!b)return n;e=k.body.createTextRange();e.moveToElementText(b);n=e.text.length;e.moveEnd(c.unit,f);e=a+e.text.length-n}else if(a===n&&0>c.count)e=n;else for(b=b.firstChild;b;){d=b.firstChild.length;b.ignoreChars&&(d-=b.ignoreChars);if(n+d>a){e=k.body.createTextRange();if(a===n&&0>c.count){for(n=b.previousSibling;n&&(!n.firstChild||!n.firstChild.length);)n=
n.previousSibling;e.moveToElementText(n?n:b.previousSibling)}else e.moveToElementText(b),e.collapse(),e.moveEnd("character",a-n);n=e.text.length;e.moveEnd(c.unit,f);e=a+e.text.length-n;break}n=d+n;b=b.nextSibling}c.count-=f;return e},destroy:function(){var a=this._createdDiv;a&&(a.parentNode.removeChild(a),this._createdDiv=null)}};x.prototype={addKeyMode:function(a,c){var b=this._keyModes;void 0!==c?b.splice(c,0,a):b.push(a);a._modeAdded&&a._modeAdded()},addRuler:function(a,c){a.setView(this);var b=
this._rulers;if(void 0!==c){var d,h;for(h=d=0;d<b.length&&h<c;d++)a.getLocation()===b[d].getLocation()&&h++;b.splice(h,0,a);c=h}else b.push(a);this._createRuler(a,c);this._update()},computeSize:function(){var a=0,c=0,b=this._model,d=this._clientDiv;if(!d)return{width:a,height:c};var h=d.style.width;e.isWebkit&&(d.style.width="0x7fffffffpx");for(var b=b.getLineCount(),n=0;n<b;n++){var k=this._getLine(n),f=k.getBoundingClientRect(),a=Math.max(a,f.right-f.left),c=c+(f.bottom-f.top);k.destroy()}e.isWebkit&&
...
d=b-this._lastMouseTime,h=Math.abs(this._lastMouseX-a.clientX),n=Math.abs(this._lastMouseY-a.clientY),k=this._lastMouseButton===c;this._lastMouseX=a.clientX;this._lastMouseY=a.clientY;this._lastMouseTime=b;this._lastMouseButton=c;1===c&&(this._isMouseDown=!0,k&&d<=this._clickTime&&h<=this._clickDist&&n<=this._clickDist?this._clickCount++:this._clickCount=1);if(this.isListening("MouseDown")&&(b=this._createMouseEvent("MouseDown",a),this.onMouseDown(b),b.defaultPrevented)){a.preventDefault();return}if(1===
...
a.target?a.target:a.srcElement,b=c.lineIndex;c&&!c._ruler;)void 0===b&&void 0!==c.lineIndex&&(b=c.lineIndex),c=c.parentNode;var d=c?c._ruler:null;if(void 0===b&&d&&"document"===d.getOverview()){var b=this._getClientHeight(),h=this._model.getLineCount(),e=this._getViewPadding(),n=this._viewDiv.getBoundingClientRect(),b=Math.floor((a.clientY-n.top-this._metrics.scrollWidth)*h/(b+e.top+e.bottom-2*this._metrics.scrollWidth));0<=b&&b<h||(b=void 0)}if(d)switch(a.type){case "click":if(d.onClick)d.onClick(b,
a);break;case "dblclick":if(d.onDblClick)d.onDblClick(b,a);break;case "mousemove":if(d.onMouseMove)d.onMouseMove(b,a);break;case "mouseover":if(d.onMouseOver)d.onMouseOver(b,a);break;case "mouseout":if(d.onMouseOut){for(h=a.relatedTarget;h&&h!==this._rootDiv;){if(h===c)return;h=h.parentNode}d.onMouseOut(b,a)}}},_handleScroll:function(){var a=this._getScroll(!1),c=this._hScroll,b=this._vScroll;if(c!==a.x||b!==a.y)this._hScroll=a.x,this._vScroll=a.y,this._commitIME(),this._update(b===a.y),this.onScroll({type:"Scroll",
...
-1;var c=this._getWindow().getSelection();if(c.anchorNode!==this._anchorNode||c.focusNode!==this._focusNode||c.anchorOffset!==this._anchorOffset||c.focusOffset!==this._focusOffset){for(var b=c.anchorNode;b&&void 0===b.lineIndex;)b=b.parentNode;if(b){var d=this._model,h=b.lineIndex,e=d.getLine(h),n=e,k=0,d=d.getLineStart(h);0<c.rangeCount&&(c.getRangeAt(0).deleteContents(),h=b.ownerDocument.createTextNode(a.data),c.getRangeAt(0).insertNode(h),k=this._getDOMText(b,h),n=k.text,k=k.offset,h.parentNode.removeChild(h));
b.lineRemoved=!0;for(b=0;e.charCodeAt(b)===n.charCodeAt(b)&&b<k;)b++;c=e.length-1;for(h=n.length-e.length;e.charCodeAt(c)===n.charCodeAt(c+h)&&c+h>=k+a.data.length;)c--;c++;e=n.substring(b,c+h);this._modifyContent({text:e,start:b+d,end:c+d,_ignoreDOMSelection:!0},!0)}}else this._doContent(a.data);a.preventDefault()}},_handleTouchStart:function(a){this._commitIME();var c=this._getWindow();this._touchScrollTimer&&(this._vScrollDiv.style.display="none",this._hScrollDiv.style.display="none",c.clearInterval(this._touchScrollTimer),
this._touchScrollTimer=null);var b=a.touches;if(1===b.length){var b=b[0],d=b.clientX,h=b.clientY;this._touchStartX=d;this._touchStartY=h;if(e.isAndroid&&(h<b.pageY-c.pageYOffset||d<b.pageX-c.pageXOffset))d=b.pageX-c.pageXOffset,h=b.pageY-c.pageYOffset;c=this.convert({x:d,y:h},"page","document");this._lastTouchOffset=this.getOffsetAtLocation(c.x,c.y);this._touchStartTime=a.timeStamp;this._touching=!0}},_handleTouchMove:function(a){var c=a.touches;if(1===c.length){c=c[0];this._touchCurrentX=c.clientX;
...
(c=c.match(a),void 0!==c))return this.invokeAction(c);return!1},_doMove:function(a,c){var b=this._model,d=c.getCaret(),h=b.getLineAtOffset(d);a.count||(a.count=1);for(;0!==a.count;){var e=b.getLineStart(h);if(0>a.count&&d===e)if(0<h)"character"===a.unit&&a.count++,h--,c.extend(b.getLineEnd(h));else break;else if(0<a.count&&d===b.getLineEnd(h))if(h+1<b.getLineCount())"character"===a.unit&&a.count--,h++,c.extend(b.getLineStart(h));else break;else{var n=!1;a.expandTab&&("character"===a.unit&&0===(d-
e)%this._tabSize)&&(e=b.getText(e,d),n=!/[^ ]/.test(e));n?(c.extend(d-this._tabSize),a.count+=0>a.count?1:-1):(e=this._getLine(h),c.extend(e.getNextOffset(d,a)),e.destroy())}d=c.getCaret()}return c},_doBackspace:function(a){var c=this._getSelection();c.isEmpty()&&(a.count||(a.count=1),a.count*=-1,a.expandTab=this._expandTab,this._doMove(a,c));this._modifyContent({text:"",start:c.start,end:c.end},!0);return!0},_doCase:function(a){var c=this._getSelection();this._doMove(a,c);var b=this.getText(c.start,
c.end);this._setSelection(c,!0);switch(a.type){case "lower":b=b.toLowerCase();break;case "capitalize":b=b.replace(/(?:^|\s)\S/g,function(a){return a.toUpperCase()});break;case "reverse":a="";for(c=0;c<b.length;c++)var d=b[c],h=d.toLowerCase(),d=h!==d?h:d.toUpperCase(),a=a+d;b=a;break;default:b=b.toUpperCase()}this._doContent(b);return!0},_doContent:function(a){var c=this._getSelection();if(this._overwriteMode&&c.isEmpty()){var b=this._model,d=b.getLineAtOffset(c.end);c.end<b.getLineEnd(d)&&(b=this._getLine(d),
...
d;if(a.ctrl)c.extend(b.getCharCount()),d=function(){};else{var h=c.getCaret(),e=b.getLineAtOffset(h);if(this._wrapMode){var n=this._getLine(e),h=n.getLineIndex(h),h=h===n.getLineCount()-1?b.getLineEnd(e):n.getLineStart(h+1)-1;n.destroy()}else a.count&&0<a.count&&(e=Math.min(e+a.count-1,b.getLineCount()-1)),h=b.getLineEnd(e);c.extend(h)}a.select||c.collapse();this._setSelection(c,!0,!0,d);return!0},_doEnter:function(a){var c=this._model,b=this._getSelection();this._doContent(c.getLineDelimiter());
a&&a.noCursor&&(b.end=b.start,this._setSelection(b,!0));return!0},_doHome:function(a){var c=this._getSelection(),b=this._model,d;if(a.ctrl)c.extend(0),d=function(){};else{var h=c.getCaret(),e=b.getLineAtOffset(h);this._wrapMode?(b=this._getLine(e),h=b.getLineIndex(h),h=b.getLineStart(h),b.destroy()):h=b.getLineStart(e);c.extend(h)}a.select||c.collapse();this._setSelection(c,!0,!0,d);return!0},_doLineDown:function(a){var c=this._model,b=this._getSelection(),d=b.getCaret(),h=c.getLineAtOffset(d),n=
this._getLine(h),k=this._columnX,f=1,g=!1;if(-1===k||a.wholeLine||a.select&&e.isIE)k=a.wholeLine?c.getLineEnd(h+1):d,k=n.getBoundingClientRect(k).left;(d=n.getLineIndex(d))<n.getLineCount()-1?f=n.getClientRects(d+1).top+1:(d=c.getLineCount()-1,g=h===d,a.count&&0<a.count?h=Math.min(h+a.count,d):h++);d=!1;if(g){if(a.select||e.isMac||e.isLinux)b.extend(c.getCharCount()),d=!0}else n.lineIndex!==h&&(n.destroy(),n=this._getLine(h)),b.extend(n.getOffset(k,f)),d=!0;d&&(a.select||b.collapse(),this._setSelection(b,
!0,!0));this._columnX=k;n.destroy();return!0},_doLineUp:function(a){var c=this._model,b=this._getSelection(),d=b.getCaret(),h=c.getLineAtOffset(d),n=this._getLine(h),k=this._columnX,f=!1,g;if(-1===k||a.wholeLine||a.select&&e.isIE)k=a.wholeLine?c.getLineStart(h-1):d,k=n.getBoundingClientRect(k).left;0<(d=n.getLineIndex(d))?g=n.getClientRects(d-1).top+1:(f=0===h,f||(a.count&&0<a.count?h=Math.max(h-a.count,0):h--,g=this._getLineHeight(h)-1));d=!1;if(f){if(a.select||e.isMac||e.isLinux)b.extend(0),d=!0}else n.lineIndex!==
h&&(n.destroy(),n=this._getLine(h)),b.extend(n.getOffset(k,g)),d=!0;d&&(a.select||b.collapse(),this._setSelection(b,!0,!0));this._columnX=k;n.destroy();return!0},_doNoop:function(){return!0},_doPageDown:function(a){var c=this,b=this._model,d=this._getSelection(),h=d.getCaret(),n=b.getLineAtOffset(h),k=b.getLineCount(),f=this._getScroll(),b=this._getClientHeight(),g,r;if(this._lineHeight){g=this._columnX;f=this._getBoundsAtOffset(h);if(-1===g||a.select&&e.isIE)g=f.left;h=this._getLineIndex(f.top+b);
r=this._getLine(h);n=this._getLinePixel(h);h=r.getOffset(g,f.top+b-n);b=r.getBoundingClientRect(h);r.destroy();d.extend(h);a.select||d.collapse();this._setSelection(d,!0,!0,function(){c._columnX=g},b.top+n-f.top);return!0}if(n<k-1){var l=this._getLineHeight(),s=Math.min(k-n-1,Math.floor(b/l)),s=Math.max(1,s);g=this._columnX;if(-1===g||a.select&&e.isIE)r=this._getLine(n),g=r.getBoundingClientRect(h).left,r.destroy();r=this._getLine(n+s);d.extend(r.getOffset(g,0));r.destroy();a.select||d.collapse();
a=k*l;h=f.y+s*l;h+b>a&&(h=a-b);this._setSelection(d,!0,!0,function(){c._columnX=g},h-f.y)}return!0},_doPageUp:function(a){var c=this,b=this._model,d=this._getSelection(),h=d.getCaret(),n=b.getLineAtOffset(h),k=this._getScroll(),f=this._getClientHeight(),g;if(this._lineHeight){g=this._columnX;k=this._getBoundsAtOffset(h);if(-1===g||a.select&&e.isIE)g=k.left;h=this._getLineIndex(k.bottom-f);b=this._getLine(h);n=this._getLinePixel(h);h=b.getOffset(g,k.bottom-f-n);f=b.getBoundingClientRect(h);b.destroy();
d.extend(h);a.select||d.collapse();this._setSelection(d,!0,!0,function(){c._columnX=g},f.top+n-k.top);return!0}if(0<n){var r=this._getLineHeight(),f=Math.max(1,Math.min(n,Math.floor(f/r)));g=this._columnX;if(-1===g||a.select&&e.isIE)b=this._getLine(n),g=b.getBoundingClientRect(h).left,b.destroy();b=this._getLine(n-f);d.extend(b.getOffset(g,this._getLineHeight(n-f)-1));b.destroy();a.select||d.collapse();a=Math.max(0,k.y-f*r);this._setSelection(d,!0,!0,function(){c._columnX=g},a-k.y)}return!0},_doPaste:function(a){var c=
this;return null!==this._getClipboardText(a,function(a){a&&(e.isLinux&&2===c._lastMouseButton&&(new Date).getTime()-c._lastMouseTime<=c._clickTime&&c._setSelectionTo(c._lastMouseX,c._lastMouseY),c._doContent(a))})},_doScroll:function(a){var c=a.type,b=this._model,d=b.getLineCount(),a=this._getClientHeight(),h=this._getLineHeight(),d=d*h,e=this._getScroll().y,n;switch(c){case "textStart":n=0;break;case "textEnd":n=d-a;break;case "pageDown":n=e+a;break;case "pageUp":n=e-a;break;case "lineDown":n=e+
h;break;case "lineUp":n=e-h;break;case "centerLine":c=this._getSelection(),n=b.getLineAtOffset(c.start),b=(b.getLineAtOffset(c.end)-n+1)*h,n=n*h-a/2+b/2}void 0!==n&&(n=Math.min(Math.max(0,n),d-a),this._scrollViewAnimated(0,n-e,function(){}));return!0},_doSelectAll:function(){var a=this._model,c=this._getSelection();c.setCaret(0);c.extend(a.getCharCount());this._setSelection(c,!1);return!0},_doTab:function(){if(this._tabMode&&!this._readonly){var a="\t";if(this._expandTab)var c=this._model,a=this._getSelection().getCaret(),
...
c=this._getSelection(),b=this.convert({x:this._autoScrollX,y:this._autoScrollY},"page","document"),d=c.getCaret(),h=a.getLineCount(),n=a.getLineAtOffset(d),k;if("up"===this._autoScrollDir||"down"===this._autoScrollDir)d=this._autoScrollY/this._getLineHeight(),d=0>d?Math.floor(d):Math.ceil(d),k=Math.max(0,Math.min(h-1,n+d));else if("left"===this._autoScrollDir||"right"===this._autoScrollDir)k=this._getLineIndex(b.y),n=this._getLine(n),b.x+=n.getBoundingClientRect(d,!1).left,n.destroy();0===k&&(e.isMac||
e.isLinux)?c.extend(0):k===h-1&&(e.isMac||e.isLinux)?c.extend(a.getCharCount()):(n=this._getLine(k),c.extend(n.getOffset(b.x,b.y-this._getLinePixel(k))),n.destroy());this._setSelection(c,!0)},_autoScrollTimer:function(){this._autoScroll();var a=this;this._autoScrollTimerID=this._getWindow().setTimeout(function(){a._autoScrollTimer()},this._AUTO_SCROLL_RATE)},_calculateLineHeightTimer:function(a){if(this._lineHeight&&!this._calculateLHTimer){var c=this._model.getLineCount(),b=0;if(a){for(var a=0,d=
(new Date).getTime(),h=0;b<c&&!(this._lineHeight[b]||(a++,h||(h=b),this._lineHeight[b]=this._calculateLineHeight(b)),b++,100<(new Date).getTime()-d););this.redrawRulers(0,c);this._queueUpdate()}a=this._getWindow();if(b!==c){var e=this;this._calculateLHTimer=a.setTimeout(function(){e._calculateLHTimer=null;e._calculateLineHeightTimer(!0)},0)}else this._calculateLHTimer&&(a.clearTimeout(this._calculateLHTimer),this._calculateLHTimer=void 0)}},_calculateLineHeight:function(a){var a=this._getLine(a),
c=a.getBoundingClientRect();a.destroy();return Math.max(1,c.bottom-c.top)},_calculateMetrics:function(){var a=this._clientDiv,c=a.ownerDocument,b=e.createElement(c,"div");b.style.lineHeight="normal";var h={type:"LineStyle",textView:this,"0":0,lineText:this._model.getLine(0),lineStart:0};this.onLineStyle(h);d(h.style,b);b.style.position="fixed";b.style.left="-1000px";var k=e.createElement(c,"span");k.appendChild(c.createTextNode(" "));b.appendChild(k);var f=e.createElement(c,"span");f.style.fontStyle=
"italic";f.appendChild(c.createTextNode(" "));b.appendChild(f);var g=e.createElement(c,"span");g.style.fontWeight="bold";g.appendChild(c.createTextNode(" "));b.appendChild(g);h=e.createElement(c,"span");h.style.fontWeight="bold";h.style.fontStyle="italic";h.appendChild(c.createTextNode(" "));b.appendChild(h);a.appendChild(b);var l=b.getBoundingClientRect(),k=k.getBoundingClientRect(),f=f.getBoundingClientRect(),g=g.getBoundingClientRect(),h=h.getBoundingClientRect(),k=k.bottom-k.top,f=f.bottom-f.top,
g=g.bottom-g.top,s=h.bottom-h.top,m=0,h=0>=l.bottom-l.top,l=Math.max(1,l.bottom-l.top);f>k&&(m=1);g>f&&(m=2);s>g&&(m=3);var v;0!==m&&(v={style:{}},0!==(m&1)&&(v.style.fontStyle="italic"),0!==(m&2)&&(v.style.fontWeight="bold"));k=r(b);a.removeChild(b);s=n(this._viewDiv);b=e.createElement(c,"div");b.style.position="fixed";b.style.left="-1000px";b.style.paddingLeft=s.left+"px";b.style.paddingTop=s.top+"px";b.style.paddingRight=s.right+"px";b.style.paddingBottom=s.bottom+"px";b.style.width="100px";b.style.height=
"100px";s=e.createElement(c,"div");s.style.width="100%";s.style.height="100%";b.appendChild(s);a.appendChild(b);m=b.getBoundingClientRect();f=s.getBoundingClientRect();g=0;this._singleMode||(b.style.overflow="hidden",s.style.height="200px",g=b.clientWidth,b.style.overflow="scroll",g-=b.clientWidth);a.removeChild(b);s={left:f.left-m.left,top:f.top-m.top,right:m.right-f.right,bottom:m.bottom-f.bottom};f=m=0;if(!h&&(this._wrapOffset||this._marginOffset))b=e.createElement(c,"div"),b.style.position="fixed",
b.style.left="-1000px",b.innerHTML=Array(this._wrapOffset+1).join(" "),a.appendChild(b),m=b.getBoundingClientRect(),m=Math.ceil(m.right-m.left),b.innerHTML=Array(this._marginOffset+1).join(" "),f=b.getBoundingClientRect(),f=Math.ceil(f.right-f.left),a.removeChild(b);return{lineHeight:l,largestFontStyle:v,lineTrim:k,viewPadding:s,scrollWidth:g,wrapWidth:m,marginWidth:f,invalid:h}},_cancelAnimation:function(){this._animation&&(this._animation.stop(),this._animation=null)},_clearSelection:function(a){var c=
...
b=this._getLinePixel(c.lineIndex);a.top+=b;a.bottom+=b;c.destroy();return a},_getClientHeight:function(){var a=this._getViewPadding();return Math.max(0,this._viewDiv.clientHeight-a.top-a.bottom)},_getClientWidth:function(){var a=this._getViewPadding();return Math.max(0,this._viewDiv.clientWidth-a.left-a.right)},_getClipboardText:function(a,c){var b=this._model.getLineDelimiter(),d,n,k=this._getWindow(),f=k.clipboardData;!f&&a&&(f=a.clipboardData);if(f)return d=[],n=f.getData(e.isIE?"Text":"text/plain"),
h(n,function(a){d.push(a)},function(){d.push(b)}),n=d.join(""),c&&c(n),n;if(e.isFirefox){this._ignoreFocus=!0;var g=this._clipboardDiv,f=this._rootDiv.ownerDocument;g||(this._clipboardDiv=g=e.createElement(f,"div"),g.style.position="fixed",g.style.whiteSpace="pre",g.style.left="-1000px",this._rootDiv.appendChild(g));g.innerHTML="<pre contenteditable=''></pre>";g.firstChild.focus();var r=this,l=function(){var a=r._getTextFromElement(g);g.innerHTML="";d=[];h(a,function(a){d.push(a)},function(){d.push(b)});
return d.join("")},s=!1;this._ignorePaste=!0;if(!e.isLinux||2!==this._lastMouseButton)try{s=f.execCommand("paste",!1,null)}catch(m){s=1<g.childNodes.length||g.firstChild&&0<g.firstChild.childNodes.length}this._ignorePaste=!1;if(!s){if(a)return k.setTimeout(function(){r.focus();(n=l())&&c&&c(n);r._ignoreFocus=!1},0),null;this.focus();this._ignoreFocus=!1;return""}this.focus();this._ignoreFocus=!1;(n=l())&&c&&c(n);return n}return""},_getDOMText:function(a,c){for(var b=a.firstChild,d="",h=0;b;){var e;
if(!b.ignore)if(b.ignoreChars){e=b.lastChild;for(var n=0,k=[],f=-1;e;){var g=e.data;if(g)for(var r=g.length-1;0<=r;r--){var l=g.substring(r,r+1);n<b.ignoreChars&&(" "===l||"\u200b"===l||"\ufeff"===l)?n++:k.push("\u00a0"===l?"\t":l)}c===e&&(f=k.length);e=e.previousSibling}k=k.reverse().join("");-1!==f&&(h=d.length+k.length-f);d+=k}else for(e=b.firstChild;e;)c===e&&(h=d.length),d+=e.data,e=e.nextSibling;b=b.nextSibling}return{text:d,offset:h}},_getTextFromElement:function(a){var c=a.ownerDocument,b=
...
type:"keypress",handler:function(c){return a._handleKeyPress(c?c:f.event)}});c.push({target:b,type:"keyup",handler:function(c){return a._handleKeyUp(c?c:f.event)}});e.isIE&&c.push({target:k,type:"keyup",handler:function(c){return a._handleDocKeyUp(c?c:f.event)}});c.push({target:b,type:"contextmenu",handler:function(c){return a._handleContextMenu(c?c:f.event)}});c.push({target:b,type:"copy",handler:function(c){return a._handleCopy(c?c:f.event)}});c.push({target:b,type:"cut",handler:function(c){return a._handleCut(c?
c:f.event)}});c.push({target:b,type:"paste",handler:function(c){return a._handlePaste(c?c:f.event)}});if(e.isIOS||e.isAndroid)c.push({target:k,type:"selectionchange",handler:function(c){return a._handleSelectionChange(c?c:f.event)}}),c.push({target:b,type:"touchstart",handler:function(c){return a._handleTouchStart(c?c:f.event)}}),c.push({target:b,type:"touchmove",handler:function(c){return a._handleTouchMove(c?c:f.event)}}),c.push({target:b,type:"touchend",handler:function(c){return a._handleTouchEnd(c?
c:f.event)}});else{c.push({target:b,type:"selectstart",handler:function(c){return a._handleSelectStart(c?c:f.event)}});c.push({target:b,type:"mousedown",handler:function(c){return a._handleMouseDown(c?c:f.event)}});c.push({target:b,type:"mouseover",handler:function(c){return a._handleMouseOver(c?c:f.event)}});c.push({target:b,type:"mouseout",handler:function(c){return a._handleMouseOut(c?c:f.event)}});c.push({target:g,type:"mouseup",handler:function(c){return a._handleMouseUp(c?c:f.event)}});c.push({target:g,
type:"mousemove",handler:function(c){return a._handleMouseMove(c?c:f.event)}});c.push({target:h,type:"mousedown",handler:function(c){return a._handleRootMouseDown(c?c:f.event)}});c.push({target:h,type:"mouseup",handler:function(c){return a._handleRootMouseUp(c?c:f.event)}});c.push({target:n,type:"dragstart",handler:function(c){return a._handleDragStart(c?c:f.event)}});c.push({target:n,type:"drag",handler:function(c){return a._handleDrag(c?c:f.event)}});c.push({target:n,type:"dragend",handler:function(c){return a._handleDragEnd(c?
c:f.event)}});c.push({target:n,type:"dragenter",handler:function(c){return a._handleDragEnter(c?c:f.event)}});c.push({target:n,type:"dragover",handler:function(c){return a._handleDragOver(c?c:f.event)}});c.push({target:n,type:"dragleave",handler:function(c){return a._handleDragLeave(c?c:f.event)}});c.push({target:n,type:"drop",handler:function(c){return a._handleDrop(c?c:f.event)}});c.push({target:this._clientDiv,type:e.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(c){return a._handleMouseWheel(c?
...
type:"dblclick",handler:function(c){return a._handleDblclick(c?c:f.event)}})}this._hookRulerEvents(this._leftDiv,c);this._hookRulerEvents(this._rightDiv,c);this._hookRulerEvents(this._marginDiv,c);for(d=0;d<c.length;d++)h=c[d],w(h.target,h.type,h.handler,h.capture)},_hookRulerEvents:function(a,c){if(a){var b=this,d=this._getWindow();e.isIE&&c.push({target:a,type:"selectstart",handler:function(){return!1}});c.push({target:a,type:e.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(a){return b._handleMouseWheel(a?
...
this._getSelection(),b.setCaret(a.start+a.text.length),this._setSelection(b,!0));this.onModify({type:"Modify"})}},_onModelChanged:function(a){a.type="ModelChanged";this.onModelChanged(a);a.type="Changed";var c=a.start,b=a.addedCharCount,d=a.removedCharCount,h=a.addedLineCount,e=a.removedLineCount,n=this._getSelection();n.end>c&&(n.end>c&&n.start<c+d?n.setCaret(c+b):(n.start+=b-d,n.end+=b-d),this._setSelection(n,!1,!1));c=this._model.getLineAtOffset(c);for(b=this._getLineNext();b;)d=b.lineIndex,c<=
...
e.isFirefox&&(this._ignoreFocus=!1,(c=this._hasFocus)&&a.blur(),a.contentEditable=!1,a.contentEditable=!0,c&&a.focus(),this._ignoreFocus=!1)}},_scrollViewAnimated:function(a,c,b){var d=this._getWindow();if(b&&this._scrollAnimation){var h=this;this._animation=new z({window:d,duration:this._scrollAnimation,curve:[c,0],onAnimate:function(a){a=c-Math.floor(a);h._scrollView(0,a);c-=a},onEnd:function(){h._animation=null;h._scrollView(a,c);b&&d.setTimeout(b,0)}});this._animation.play()}else this._scrollView(a,
c),b&&d.setTimeout(b,0)},_scrollView:function(a,c){this._ensureCaretVisible=!1;var b=this._viewDiv;a&&(b.scrollLeft+=a);c&&(b.scrollTop+=c)},_setClipboardText:function(a,c){var b,d=this._getWindow(),n=d.clipboardData;!n&&c&&(n=c.clipboardData);if(n&&(b=[],h(a,function(a){b.push(a)},function(){b.push(e.platformDelimiter)}),n.setData(e.isIE?"Text":"text/plain",b.join(""))))return!0;var k=this._parent.ownerDocument,f=e.createElement(k,"pre");f.style.position="fixed";f.style.left="-1000px";h(a,function(a){f.appendChild(k.createTextNode(a))},
function(){f.appendChild(e.createElement(k,"br"))});f.appendChild(k.createTextNode(" "));this._clientDiv.appendChild(f);n=k.createRange();n.setStart(f.firstChild,0);n.setEndBefore(f.lastChild);var g=d.getSelection();0<g.rangeCount&&g.removeAllRanges();g.addRange(n);var r=this,n=function(){f&&f.parentNode===r._clientDiv&&r._clientDiv.removeChild(f);r._updateDOMSelection()},g=!1;this._ignoreCopy=!0;try{g=k.execCommand("copy",!1,null)}catch(l){}this._ignoreCopy=!1;if(!g&&c)return d.setTimeout(n,0),!1;
n();return!0},_setDOMSelection:function(a,c,b,d,h){for(var n,f,k,g,r=0,l=a.firstChild,s,m,v=this._model.getLine(a.lineIndex).length;l;){if(!l.ignore){s=l.firstChild;m=s.length;l.ignoreChars&&(m-=l.ignoreChars);if(r+m>c||r+m>=v){n=s;f=c-r;l.ignoreChars&&(0<m&&f===m)&&(f+=l.ignoreChars);break}r+=m}l=l.nextSibling}for(var r=0,l=b.firstChild,u=this._model.getLine(b.lineIndex).length;l;){if(!l.ignore){s=l.firstChild;m=s.length;l.ignoreChars&&(m-=l.ignoreChars);if(m+r>d||r+m>=u){k=s;g=d-r;l.ignoreChars&&
(0<m&&g===m)&&(g+=l.ignoreChars);break}r+=m}l=l.nextSibling}this._setDOMFullSelection(a,c,v,b,d,u);a=this._getWindow();c=this._parent.ownerDocument;if(a.getSelection){b=a.getSelection();a=c.createRange();a.setStart(n,f);a.setEnd(k,g);if(this._hasFocus&&(b.anchorNode!==n||b.anchorOffset!==f||b.focusNode!==k||b.focusOffset!==g||b.anchorNode!==k||b.anchorOffset!==g||b.focusNode!==n||b.focusOffset!==f))this._anchorNode=n,this._anchorOffset=f,this._focusNode=k,this._focusOffset=g,this._ignoreSelect=!1,
0<b.rangeCount&&b.removeAllRanges(),b.addRange(a),this._ignoreSelect=!0;this._cursorDiv&&(a=c.createRange(),h?(a.setStart(n,f),a.setEnd(n,f)):(a.setStart(k,g),a.setEnd(k,g)),k=a.getClientRects()[0],g=this._cursorDiv.parentNode,n=g.getBoundingClientRect(),k&&n&&(this._cursorDiv.style.top=k.top-n.top+g.scrollTop+"px",this._cursorDiv.style.left=k.left-n.left+g.scrollLeft+"px"))}else c.selection&&this._hasFocus&&(h=c.body,a=e.createElement(c,"div"),h.appendChild(a),h.removeChild(a),a=h.createTextRange(),
a.moveToElementText(n.parentNode),a.moveStart("character",f),n=h.createTextRange(),n.moveToElementText(k.parentNode),n.moveStart("character",g),a.setEndPoint("EndToStart",n),this._ignoreSelect=!1,a.select(),this._ignoreSelect=!0)},_setDOMFullSelection:function(a,c,b,d,h){if(this._selDiv1&&(b=this._selDiv1,b.style.width="0px",b.style.height="0px",b=this._selDiv2,b.style.width="0px",b.style.height="0px",b=this._selDiv3,b.style.width="0px",b.style.height="0px",!(a===d&&c===h))){var e=this._model,n=this._getViewPadding(),
k=this._clientDiv.getBoundingClientRect(),f=this._viewDiv.getBoundingClientRect(),b=f.left+n.left,g=k.right,n=f.top+n.top,r=k.bottom,f=k=0;this._clipDiv?(f=this._clipDiv.getBoundingClientRect(),k=f.left-this._clipDiv.scrollLeft):(f=this._rootDiv.getBoundingClientRect(),k=f.left);f=f.top;this._ignoreDOMSelection=!0;var l=(new y(this,a.lineIndex,a)).getBoundingClientRect(e.getLineStart(a.lineIndex)+c,!1),s=l.left,c=(new y(this,d.lineIndex,d)).getBoundingClientRect(e.getLineStart(d.lineIndex)+h,!1),
e=c.left;this._ignoreDOMSelection=!1;var m=this._selDiv1,s=Math.min(g,Math.max(b,s)),v=Math.min(r,Math.max(n,l.top)),u=g,h=Math.min(r,Math.max(n,l.bottom));m.style.left=s-k+"px";m.style.top=v-f+"px";m.style.width=Math.max(0,u-s)+"px";m.style.height=Math.max(0,h-v)+"px";a.lineIndex===d.lineIndex?(u=Math.min(e,g),m.style.width=Math.max(0,u-s)+"px"):(l=Math.min(r,Math.max(n,c.top)),e=Math.min(g,Math.max(b,e)),n=Math.min(r,Math.max(n,c.bottom)),r=this._selDiv3,r.style.left=b-k+"px",r.style.top=l-f+"px",
r.style.width=Math.max(0,e-b)+"px",r.style.height=Math.max(0,n-l)+"px",1<Math.abs(a.lineIndex-d.lineIndex)&&(a=this._selDiv2,a.style.left=b-k+"px",a.style.top=h-f+"px",a.style.width=Math.max(0,g-b)+"px",a.style.height=Math.max(0,l-h)+"px"))}},_setGrab:function(a){a!==this._grabControl&&(a?(a.setCapture&&a.setCapture(),this._grabControl=a):(this._grabControl.releaseCapture&&this._grabControl.releaseCapture(),this._grabControl=null))},_setLinksVisible:function(a){if(this._linksVisible!==a){this._linksVisible=
...
b,d,h){if(a){this._columnX=-1;void 0===b&&(b=!0);var e=this._selection;this._selection=a;!1!==c&&this._showCaret(!1,d,c,h);b&&this._updateDOMSelection();if(!e.equals(a))this.onSelection({type:"Selection",oldValue:{start:e.start,end:e.end},newValue:{start:a.start,end:a.end}})}},_setSelectionTo:function(a,c,b,d){var h=this._model,e=this._getSelection(),c=this.convert({x:a,y:c},"page","document"),a=this._getLineIndex(c.y);if(1===this._clickCount){h=this._getLine(a);a=h.getOffset(c.x,c.y-this._getLinePixel(a));
h.destroy();if(d&&!b&&e.start<=a&&a<e.end)return this._dragOffset=a,!1;e.extend(a);b||e.collapse()}else 0===(this._clickCount&1)?(h=this._getLine(a),a=h.getOffset(c.x,c.y-this._getLinePixel(a)),this._doubleClickSelection?a>=this._doubleClickSelection.start?(b=this._doubleClickSelection.start,d=h.getNextOffset(a,{unit:"wordend",count:1})):(b=h.getNextOffset(a,{unit:"word",count:-1}),d=this._doubleClickSelection.end):(b=h.getNextOffset(a,{unit:"word",count:-1}),d=h.getNextOffset(b,{unit:"wordend",count:1})),
h.destroy()):this._doubleClickSelection?(d=h.getLineAtOffset(this._doubleClickSelection.start),a>=d?(b=h.getLineStart(d),d=h.getLineEnd(a)):(b=h.getLineStart(a),d=h.getLineEnd(d))):(b=h.getLineStart(a),d=h.getLineEnd(a)),e.setCaret(b),e.extend(d);this._setSelection(e,!0,!0);return!0},_setFullSelection:function(a,c){this._fullSelection=a;e.isWebkit&&(this._fullSelection=!0);var b=this._clipDiv||this._rootDiv;if(b)if(this._fullSelection){if(!this._selDiv1&&this._fullSelection&&!e.isIOS){var d=b.ownerDocument;
this._highlightRGB=e.isWebkit?"transparent":"Highlight";var h=e.createElement(d,"div");this._selDiv1=h;h.style.position="absolute";h.style.borderWidth="0px";h.style.margin="0px";h.style.padding="0px";h.style.outline="none";h.style.background=this._highlightRGB;h.style.width="0px";h.style.height="0px";h.style.zIndex="0";b.appendChild(h);var n=e.createElement(d,"div");this._selDiv2=n;n.style.position="absolute";n.style.borderWidth="0px";n.style.margin="0px";n.style.padding="0px";n.style.outline="none";
...
this._redrawCount)&&!this._ignoreDOMSelection&&this._clientDiv){var a=this._getSelection(),c=this._model,b=c.getLineAtOffset(a.start),d=c.getLineAtOffset(a.end),h=this._getLineNext();if(h){var e=this._getLinePrevious(),n;b<h.lineIndex?(n=h,b=0):b>e.lineIndex?(n=e,b=0):(n=this._getLineNode(b),b=a.start-c.getLineStart(b));d<h.lineIndex?c=0:d>e.lineIndex?(h=e,c=0):(h=this._getLineNode(d),c=a.end-c.getLineStart(d));this._setDOMSelection(n,b,h,c,a.caret)}}},_update:function(a){if(!(0<this._redrawCount)){this._updateTimer&&
(this._getWindow().clearTimeout(this._updateTimer),this._updateTimer=null,a=!1);var c=this._clientDiv,b=this._viewDiv;if(c){this._metrics.invalid&&(this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1);var d=this._model,h=this._getScroll(!1),n=this._getViewPadding(),f=d.getLineCount(),k=this._getLineHeight(),g=!1,r=!1,l=!1,s=this._metrics.scrollWidth;this._wrapMode&&(c.style.width=(this._metrics.wrapWidth||this._getClientWidth())+"px");var m,v,u,p,x=0,z=0,w;if(this._lineHeight){for(;z<
f;){w=this._getLineHeight(z);if(x+w>h.y)break;x+=w;z++}m=z;v=Math.max(0,m-1);u=d=h.y-x;0<m&&(d+=this._getLineHeight(m-1))}else p=Math.max(0,h.y)/k,m=Math.floor(p),v=Math.max(0,m-1),d=Math.round((p-v)*k),u=Math.round((p-m)*k);this._topIndexY=u;p=this._rootDiv;var P=p.clientWidth,L=p.clientHeight;if(a){k=0;this._leftDiv&&(m=this._leftDiv.getBoundingClientRect(),k=m.right-m.left);m=this._getClientWidth();p=this._getClientHeight();r=m;this._wrapMode?this._metrics.wrapWidth&&(r=this._metrics.wrapWidth):
r=Math.max(this._maxLineWidth,r);for(;z<f;)w=this._getLineHeight(z,!1),x+=w,z++;f=x}else{p=this._getClientHeight();u=Math.min(m+Math.floor((p+u)/k),f-1);var h=Math.min(u+1,f-1),H;for(w=c.firstChild;w;){H=w.lineIndex;var G=w.nextSibling;if(!(v<=H&&H<=h)||w.lineRemoved||-1===w.lineIndex)this._mouseWheelLine===w?(w.style.display="none",w.lineIndex=-1):c.removeChild(w);w=G}w=this._getLineNext();var G=b.ownerDocument,M=G.createDocumentFragment();for(H=v;H<=h;H++)!w||w.lineIndex>H?(new y(this,H)).create(M,
null):(M.firstChild&&(c.insertBefore(M,w),M=G.createDocumentFragment()),w&&w.lineChanged&&(w=(new y(this,H)).create(M,w),w.lineChanged=!1),w=this._getLineNext(w));M.firstChild&&c.insertBefore(M,w);e.isWebkit&&!this._wrapMode&&(c.style.width="0x7fffffffpx");w=this._getLineNext();H=p+d;for(M=!1;w;)v=w.lineWidth,void 0===v&&(G=w._line.getBoundingClientRect(),v=w.lineWidth=Math.ceil(G.right-G.left),G=G.bottom-G.top,this._lineHeight?this._lineHeight[w.lineIndex]=G:0!==k&&(0!==G&&Math.ceil(k)!==Math.ceil(G))&&
(this._variableLineHeight=!0,this._lineHeight=[],this._lineHeight[w.lineIndex]=G)),this._lineHeight&&!M&&(H-=this._lineHeight[w.lineIndex],0>H&&(u=w.lineIndex,M=!0)),this._wrapMode||(v>=this._maxLineWidth&&(this._maxLineWidth=v,this._maxLineIndex=w.lineIndex),this._checkMaxLineIndex===w.lineIndex&&(this._checkMaxLineIndex=-1)),w.lineIndex===m&&(this._topChild=w),w.lineIndex===u&&(this._bottomChild=w),w=this._getLineNext(w);-1!==this._checkMaxLineIndex&&(H=this._checkMaxLineIndex,this._checkMaxLineIndex=
-1,0<=H&&H<f&&(k=new y(this,H),G=k.getBoundingClientRect(),v=G.right-G.left,v>=this._maxLineWidth&&(this._maxLineWidth=v,this._maxLineIndex=H),k.destroy()));for(;z<f;)w=this._getLineHeight(z,z<=u),x+=w,z++;f=x;this._updateRuler(this._leftDiv,m,h,L);this._updateRuler(this._rightDiv,m,h,L);this._updateRuler(this._marginDiv,m,h,L);k=0;this._leftDiv&&(m=this._leftDiv.getBoundingClientRect(),k=m.right-m.left);h=0;this._rightDiv&&(h=this._rightDiv.getBoundingClientRect(),h=h.right-h.left);b.style.left=
k+"px";b.style.right=h+"px";h=this._scrollDiv;h.style.height=f+"px";m=this._getClientWidth();!this._singleMode&&!this._wrapMode&&(x=g=p,(z="scroll"===b.style.overflowX)?g+=s:x-=s,w=u=m,(v="scroll"===b.style.overflowY)?u+=s:w-=s,p=g,m=u,f>p&&(l=!0,m=w),this._maxLineWidth>m&&(r=!0,p=x,f>p&&(l=!0,m=w)),z!==r&&(b.style.overflowX=r?"scroll":"hidden"),v!==l&&(b.style.overflowY=l?"scroll":"hidden"),g=z!==r||v!==l);l=m;this._wrapMode?this._metrics.wrapWidth&&(l=this._metrics.wrapWidth):l=Math.max(this._maxLineWidth,
l);r=l;if((!e.isIE||9<=e.isIE)&&this._maxLineWidth>m)l+=n.right+n.left;h.style.width=l+"px";this._clipScrollDiv&&(this._clipScrollDiv.style.width=l+"px");h=this._getScroll(!1)}this._vScrollDiv&&(l=p-8,x=Math.max(15,Math.ceil(Math.min(1,l/(f+n.top+n.bottom))*l)),this._vScrollDiv.style.left=k+m-8+"px",this._vScrollDiv.style.top=Math.floor(Math.max(0,h.y*l/f))+"px",this._vScrollDiv.style.height=x+"px");!this._wrapMode&&this._hScrollDiv&&(l=m-8,x=Math.max(15,Math.ceil(Math.min(1,l/(this._maxLineWidth+
n.left+n.right))*l)),this._hScrollDiv.style.left=k+Math.floor(Math.max(0,Math.floor(h.x*l/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=p-9+"px",this._hScrollDiv.style.width=x+"px");z=h.x;x=this._clipDiv;l=this._overlayDiv;if(u=this._marginDiv)u.style.left=-z+k+this._metrics.marginWidth+n.left+"px",u.style.bottom=("scroll"===b.style.overflowX?s:0)+"px";x?(x.scrollLeft=z,x.scrollTop=0,b=k+n.left,s=n.top,a=m,k=p,z=0,u=-d,0===h.x&&(b-=n.left,a+=n.left,z=n.left),h.x+m===r&&(a+=n.right),0===h.y&&
(s-=n.top,k+=n.top,u+=n.top),h.y+p===f&&(k+=n.bottom),x.style.left=b+"px",x.style.top=s+"px",x.style.right=P-a-b+"px",x.style.bottom=L-k-s+"px",c.style.left=z+"px",c.style.top=u+"px",c.style.width=r+"px",c.style.height=p+d+"px",l&&(l.style.left=c.style.left,l.style.top=c.style.top,l.style.width=c.style.width,l.style.height=c.style.height)):(b=z,s=d,P=z+m,L=d+p,0===b&&(b-=n.left),0===s&&(s-=n.top),P===r&&(P+=n.right),h.y+p===f&&(L+=n.bottom),c.style.clip="rect("+s+"px,"+P+"px,"+L+"px,"+b+"px)",c.style.left=
-z+k+n.left+"px",c.style.width=(this._wrapMode||e.isWebkit?r:m+z)+"px",a||(c.style.top=-d+n.top+"px",c.style.height=p+d+"px"),l&&(l.style.clip=c.style.clip,l.style.left=c.style.left,l.style.width=c.style.width,a||(l.style.top=c.style.top,l.style.height=c.style.height)));this._updateDOMSelection();g&&(c=this._ensureCaretVisible,this._ensureCaretVisible=!1,c&&this._showCaret(),this._queueUpdate())}}},_updateOverflow:function(){var a=this._viewDiv;this._wrapMode?(a.style.overflowX="hidden",a.style.overflowY=
"scroll"):a.style.overflow="hidden"},_updateRuler:function(a,c,b,h){if(a)for(var n=this._parent.ownerDocument,k=this._getLineHeight(),f=this._getViewPadding(),a=a.firstChild;a;){var g=a._ruler,r=k,l=g.getOverview();"page"===l&&(r+=this._topIndexY);a.style.top=-r+"px";a.style.height=h+r+"px";a.rulerChanged&&d(g.getRulerStyle(),a);var s,m=a.firstChild;m?(s=m,m=m.nextSibling):(s=e.createElement(n,"div"),s.style.visibility="hidden",a.appendChild(s));var v;if(a.rulerChanged&&s){r=-1;if(v=g.getWidestAnnotation())d(v.style,
s),v.html&&(s.innerHTML=v.html);s.lineIndex=r;s.style.height=k+f.top+"px"}var u;if("page"===l){for(g=g.getAnnotations(c,b+1);m;)r=m.lineIndex,v=m.nextSibling,(!(c<=r&&r<=b)||m.lineChanged)&&a.removeChild(m),m=v;m=a.firstChild.nextSibling;u=n.createDocumentFragment();for(r=c;r<=b;r++)if(!m||m.lineIndex>r){s=e.createElement(n,"div");if(v=g[r])d(v.style,s),v.html&&(s.innerHTML=v.html),s.annotation=v;s.lineIndex=r;s.style.height=this._getLineHeight(r)+"px";u.appendChild(s)}else u.firstChild&&(a.insertBefore(u,
m),u=n.createDocumentFragment()),m&&(m=m.nextSibling);u.firstChild&&a.insertBefore(u,m)}else{v=this._getClientHeight();r=this._model.getLineCount();m=v+f.top+f.bottom-2*this._metrics.scrollWidth;l=k*r<m?k:m/r;if(a.rulerChanged){for(v=a.childNodes.length;1<v;)a.removeChild(a.lastChild),v--;g=g.getAnnotations(0,r);u=n.createDocumentFragment();for(var p in g)r=p>>>0,0>r||(s=e.createElement(n,"div"),v=g[p],d(v.style,s),s.style.position="absolute",s.style.top=this._metrics.scrollWidth+k+Math.floor(r*l)+
"px",v.html&&(s.innerHTML=v.html),s.annotation=v,s.lineIndex=r,u.appendChild(s));a.appendChild(u)}else if(a._oldTrackHeight!==m)for(s=a.firstChild?a.firstChild.nextSibling:null;s;)s.style.top=this._metrics.scrollWidth+k+Math.floor(s.lineIndex*l)+"px",s=s.nextSibling;a._oldTrackHeight=m}a.rulerChanged=!1;a=a.nextSibling}},_updateStyleSheet:function(){var a="";e.isWebkit&&0<this._metrics.scrollWidth&&(a+="\n.textview ::-webkit-scrollbar-corner {background: #eeeeee;}");e.isFirefox&&(e.isMac&&this._highlightRGB&&
...
define("orion/editor/projectionTextModel",["orion/editor/textModel","orion/editor/eventTarget"],function(f,m){function p(b){this._model=b;this._projections=[];var f=this;this._listener={onChanged:function(b){f._onChanged(b)},onChanging:function(b){f._onChanging(b)}};b.addEventListener("postChanged",this._listener.onChanged);b.addEventListener("preChanging",this._listener.onChanging)}p.prototype={destroy:function(){this._model&&(this._model.removeEventListener("postChanged",this._listener.onChanged),
this._model.removeEventListener("preChanging",this._listener.onChanging),this._model=null)},addProjection:function(b){if(b){var l=this._model,g=this._projections;b._lineIndex=l.getLineAtOffset(b.start);b._lineCount=l.getLineAtOffset(b.end)-b._lineIndex;var e=b.text;e||(e="");b._model="string"===typeof e?new f.TextModel(e,l.getLineDelimiter()):e;var l=this.mapOffset(b.start,!0),e=b.end-b.start,d=b._lineCount,k=b._model.getCharCount(),c=b._model.getLineCount()-1,a={type:"Changing",text:b._model.getText(),
start:l,removedCharCount:e,addedCharCount:k,removedLineCount:d,addedLineCount:c};this.onChanging(a);a=this._binarySearch(g,b.start);g.splice(a,0,b);this.onChanged({type:"Changed",start:l,removedCharCount:e,addedCharCount:k,removedLineCount:d,addedLineCount:c})}},getProjections:function(){return this._projections.slice(0)},getBaseModel:function(){return this._model},mapOffset:function(b,f){var g=this._projections,e=0,d,k;if(f){for(d=0;d<g.length;d++){k=g[d];if(k.start>b)break;if(k.end>b)return-1;e+=
k._model.getCharCount()-(k.end-k.start)}return b+e}for(d=0;d<g.length;d++){k=g[d];if(k.start>b-e)break;var c=k._model.getCharCount();if(k.start+c>b-e)return-1;e+=c-(k.end-k.start)}return b-e},removeProjection:function(b){var f,g=0;for(f=0;f<this._projections.length;f++){var e=this._projections[f];if(e===b){b=e;break}g+=e._model.getCharCount()-(e.end-e.start)}if(f<this._projections.length){var e=this._model,g=b.start+g,d=b.end-b.start,k=b._lineCount,c=b._model.getCharCount(),a=b._model.getLineCount()-
1,b={type:"Changing",text:e.getText(b.start,b.end),start:g,removedCharCount:c,addedCharCount:d,removedLineCount:a,addedLineCount:k};this.onChanging(b);this._projections.splice(f,1);this.onChanged({type:"Changed",start:g,removedCharCount:c,addedCharCount:d,removedLineCount:a,addedLineCount:k})}},_binarySearch:function(b,f){for(var g=b.length,e=-1,d;1<g-e;)d=Math.floor((g+e)/2),f<=b[d].start?g=d:e=d;return g},getCharCount:function(){for(var b=this._model.getCharCount(),f=this._projections,g=0;g<f.length;g++)var e=
f[g],b=b+(e._model.getCharCount()-(e.end-e.start));return b},getLine:function(b,f){if(0>b)return null;var g=this._model,e=this._projections,d=0,k=[],c=0,a,h,n;for(a=0;a<e.length;a++){n=e[a];if(n._lineIndex>=b-d)break;h=n._model.getLineCount()-1;if(n._lineIndex+h>=b-d){c=b-(n._lineIndex+d);if(c<h)return n._model.getLine(c,f);k.push(n._model.getLine(h))}c=n.end;d+=h-n._lineCount}for(c=Math.max(c,g.getLineStart(b-d));a<e.length;a++){n=e[a];if(n._lineIndex>b-d)break;k.push(g.getText(c,n.start));h=n._model.getLineCount()-
1;if(n._lineIndex+h>b-d)return k.push(n._model.getLine(0,f)),k.join("");k.push(n._model.getText());c=n.end;d+=h-n._lineCount}e=g.getLineEnd(b-d,f);c<e&&k.push(g.getText(c,e));return k.join("")},getLineAtOffset:function(b){for(var f=this._model,g=this._projections,e=0,d=0,k=0;k<g.length;k++){var c=g[k];if(c.start>b-e)break;var a=c._model.getCharCount();if(c.start+a>b-e){g=b-(c.start+e);d+=c._model.getLineAtOffset(g);e+=g;break}d+=c._model.getLineCount()-1-c._lineCount;e+=a-(c.end-c.start)}return f.getLineAtOffset(b-
e)+d},getLineCount:function(){for(var b=this._projections,f=this._model.getLineCount(),g=0;g<b.length;g++)var e=b[g],f=f+(e._model.getLineCount()-1-e._lineCount);return f},getLineDelimiter:function(){return this._model.getLineDelimiter()},getLineEnd:function(b,f){if(0>b)return-1;for(var g=this._model,e=this._projections,d=0,k=0,c=0;c<e.length;c++){var a=e[c];if(a._lineIndex>b-d)break;var h=a._model.getLineCount()-1;if(a._lineIndex+h>b-d)return a._model.getLineEnd(b-(a._lineIndex+d),f)+a.start+k;k+=
a._model.getCharCount()-(a.end-a.start);d+=h-a._lineCount}return g.getLineEnd(b-d,f)+k},getLineStart:function(b){if(0>b)return-1;for(var f=this._model,g=this._projections,e=0,d=0,k=0;k<g.length;k++){var c=g[k];if(c._lineIndex>=b-e)break;var a=c._model.getLineCount()-1;if(c._lineIndex+a>=b-e)return c._model.getLineStart(b-(c._lineIndex+e))+c.start+d;d+=c._model.getCharCount()-(c.end-c.start);e+=a-c._lineCount}return f.getLineStart(b-e)+d},getText:function(b,f){void 0===b&&(b=0);var g=this._model,e=
this._projections,d=0,k=[],c,a,h;for(c=0;c<e.length;c++){a=e[c];if(a.start>b-d)break;h=a._model.getCharCount();if(a.start+h>b-d){if(void 0!==f&&a.start+h>f-d)return a._model.getText(b-(a.start+d),f-(a.start+d));k.push(a._model.getText(b-(a.start+d)));b=a.end+d+h-(a.end-a.start)}d+=h-(a.end-a.start)}var n=b-d;if(void 0!==f){for(;c<e.length;c++){a=e[c];if(a.start>f-d)break;k.push(g.getText(n,a.start));h=a._model.getCharCount();if(a.start+h>f-d)return k.push(a._model.getText(0,f-(a.start+d))),k.join("");
k.push(a._model.getText());n=a.end;d+=h-(a.end-a.start)}k.push(g.getText(n,f-d))}else{for(;c<e.length;c++)a=e[c],k.push(g.getText(n,a.start)),k.push(a._model.getText()),n=a.end;k.push(g.getText(n))}return k.join("")},_onChanged:function(){var b=this._change,f=b.baseStart,g=b.baseEnd,e,d,k=this._projections;for(e=0;e<k.length&&!(d=k[e],d.end>f);e++);var c=e;for(e=0;e<k.length&&!(d=k[e],d.start>=g);e++);var a=e,h=this._model,f=b.baseText.length-(g-f);for(e=a;e<k.length;e++)d=k[e],d.start+=f,d.end+=
f,d._lineIndex=h.getLineAtOffset(d.start);d=k.splice(c,a-c);for(e=0;e<d.length;e++)d[e].annotation&&d[e].annotation._expand();this.onChanged({type:"Changed",start:b.start,removedCharCount:b.removedCharCount,addedCharCount:b.addedCharCount,removedLineCount:b.removedLineCount,addedLineCount:b.addedLineCount});this._change=void 0},_onChanging:function(b){var f=!!this._change,g=this._change||{},e=b.start,d=e+b.removedCharCount;g.baseStart=e;g.baseEnd=d;g.baseText=b.text;g.addedLineCount=b.addedLineCount;
if(!f){this._change=g;g.text=b.text;var k=this._projections,c,a,h,b=function(b){for(c=a=0;a<k.length;a++){h=k[a];if(h.start>b)break;if(h.end>b)return-1;c+=h._model.getCharCount()-(h.end-h.start)}return b+c};g.start=b(e);-1===g.start&&(g.text=this._model.getText(h.start,e)+g.text,g.addedLineCount+=this._model.getLineAtOffset(e)-this._model.getLineAtOffset(h.start),g.start=h.start+c);g.end=b(d);-1===g.end&&(g.text+=this._model.getText(d,h.end),g.addedLineCount+=this._model.getLineAtOffset(h.end)-this._model.getLineAtOffset(d),
...
setText:function(b,f,g){function e(b){for(k=c=0;c<d.length;c++){a=d[c];if(a.start>b-k)break;var h=a._model.getCharCount();if(a.start+h>b-k)return-1;k+=h-(a.end-a.start)}return b-k}this._change={text:b||"",start:f||0,end:void 0===g?this.getCharCount():g};var d=this._projections,k,c,a,h,n,b=e(this._change.start);-1===b&&(h={projection:a,start:this._change.start-(a.start+k)},b=a.end);f=e(this._change.end);-1===f&&(n={projection:a,end:this._change.end-(a.start+k)},f=a.start);h&&n&&h.projection===n.projection?
a._model.setText(this._change.text,h.start,n.end):(this._model.setText(this._change.text,b,f),h&&(a=h.projection,a._model.setText("",h.start)),n&&(a=n.projection,a._model.setText("",0,n.end),a.start=a.end,a._lineCount=0));this._change=void 0}};m.EventTarget.addMixin(p.prototype);return{ProjectionTextModel:p}});
define("orion/editor/tooltip","i18n!orion/editor/nls/messages orion/editor/textView orion/editor/textModel orion/editor/projectionTextModel orion/editor/util orion/util".split(" "),function(f,m,p,b,l,g){function e(b){this._view=b;this._fadeDelay=500;this._hideDelay=200;this._showDelay=500;this._autoHideDelay=5E3;this._create(b.getOptions("parent").ownerDocument)}e.getTooltip=function(b){b._tooltip||(b._tooltip=new e(b));return b._tooltip};e.prototype={_create:function(b){if(!this._tooltipDiv){var e=
...
h;else if(this._isNode(h))a.appendChild(h);else if(h instanceof b.ProjectionTextModel){var n=this._view,f=n.getOptions();f.wrapMode=!1;f.parent=a;var g=f.themeClass;g?((g=g.replace("tooltipTheme",""))&&(g=" "+g),g="tooltipTheme"+g):g="tooltipTheme";f.themeClass=g;f=this._contentsView=new m.TextView(f);f.addEventListener("LineStyle",function(a){n.onLineStyle(a)});f.setModel(h);h=f.computeSize();a.style.width=h.width+"px";a.style.height=h.height+"px";f.resize()}else return;a=c.ownerDocument.documentElement;
"right"===e.anchor?(h=a.clientWidth-e.x,c.style.right=h+"px"):(h=parseInt(this._getNodeStyle(c,"padding-left","0"),10),h+=parseInt(this._getNodeStyle(c,"border-left-width","0"),10),h=e.x-h,c.style.left=h+"px");c.style.maxWidth=a.clientWidth-h-10+"px";h=parseInt(this._getNodeStyle(c,"padding-top","0"),10);h+=parseInt(this._getNodeStyle(c,"border-top-width","0"),10);h=e.y-h;c.style.top=h+"px";c.style.maxHeight=a.clientHeight-h-10+"px";c.style.opacity="1";c.style.visibility="visible";if(d){var l=this,
p=this._getWindow();l._hideTimeout=p.setTimeout(function(){l._hideTimeout=null;var a=parseFloat(l._getNodeStyle(c,"opacity","1"));l._fadeTimeout=p.setInterval(function(){"visible"===c.style.visibility&&0<a?(a-=0.1,c.style.opacity=a):l._hide()},l._fadeDelay/10)},l._autoHideDelay)}}}},_getAnnotationContents:function(d){function e(a){var c=a.title,b=g.createElement(r,"div");b.className="tooltipRow";a.html&&(b.innerHTML=a.html,b.lastChild&&l.addEventListener(b.lastChild,"click",function(){var c=a.start,
b=a.end;s.getBaseModel&&(c=s.mapOffset(c,!0),b=s.mapOffset(b,!0));m.setSelection(c,b,1/3,function(){n._hide()})},!1),b.appendChild(r.createTextNode("\u00a0")));if(!c)var d=a.end,c=p.getLineStart(p.getLineAtOffset(a.start)),d=p.getLineEnd(p.getLineAtOffset(d),!0),c=p.getText(c,d);"function"===typeof c&&(c=a.title());"string"===typeof c&&(d=g.createElement(r,"span"),d.appendChild(r.createTextNode(c)),c=d);b.appendChild(c);return b}for(var c,a=[],h=0;h<d.length;h++)c=d[h],""!==c.title&&!c.groupAnnotation&&
a.push(c);d=a;if(0===d.length)return null;var n=this,r=this._tooltipDiv.ownerDocument,m=this._view,s=m.getModel(),p=s.getBaseModel?s.getBaseModel():s;if(1===d.length){c=d[0];if(void 0!==c.title)return c=e(c),c.firstChild&&((d=c.firstChild.className)&&(d+=" "),c.firstChild.className=d+"single"),c;d=new b.ProjectionTextModel(p);a=p.getLineStart(p.getLineAtOffset(c.start));h=p.getCharCount();c.end!==h&&d.addProjection({start:c.end,end:h});0<a&&d.addProjection({start:0,end:a});return d}a=g.createElement(r,
...
"orion.annotation.currentBlame";var k={};b.registerType=function(c,a){var b=a;"function"!==typeof b&&(b=function(a,c,b){this.start=a;this.end=c;void 0!==b&&(this.title=b)},b.prototype=a);b.prototype.type=c;k[c]=b;return c};b.createAnnotation=function(c,a,b,d){return new (this.getType(c))(a,b,d)};b.getType=function(c){return k[c]};l(b.ANNOTATION_ERROR);l(b.ANNOTATION_WARNING);l(b.ANNOTATION_TASK);l(b.ANNOTATION_BREAKPOINT);l(b.ANNOTATION_BOOKMARK);l(b.ANNOTATION_CURRENT_BRACKET);l(b.ANNOTATION_MATCHING_BRACKET);
l(b.ANNOTATION_CURRENT_SEARCH);l(b.ANNOTATION_MATCHING_SEARCH);l(b.ANNOTATION_READ_OCCURRENCE);l(b.ANNOTATION_WRITE_OCCURRENCE);l(b.ANNOTATION_SELECTED_LINKED_GROUP);l(b.ANNOTATION_CURRENT_LINKED_GROUP);l(b.ANNOTATION_LINKED_GROUP);l(b.ANNOTATION_CURRENT_LINE,!0);l(b.ANNOTATION_BLAME,!0);l(b.ANNOTATION_CURRENT_BLAME,!0);b.registerType(b.ANNOTATION_FOLDING,p);g.addMixin=function(c){var a=g.prototype,b;for(b in a)a.hasOwnProperty(b)&&(c[b]=a[b])};g.prototype={addAnnotationType:function(c){this._annotationTypes||
...
d,e,f,k=[];if(c)for(d=c.length-1;0<=d;d--)f=c[d],e=this._getAnnotationIndex(f),0>e||(f._annotationModel=null,b.splice(e,1),k.splice(0,0,f));a||(a=[]);for(d=0;d<a.length;d++)f=a[d],e=this._binarySearch(b,f.start),f._annotationModel=this,b.splice(e,0,f);this.onChanged({type:"Changed",removed:k,added:a,changed:[]})},setTextModel:function(c){this._model&&this._model.removeEventListener("Changed",this._listener.onChanged);(this._model=c)&&this._model.addEventListener("Changed",this._listener.onChanged)},
_binarySearch:function(c,a){for(var b=c.length,d=-1,e;1<b-d;)e=Math.floor((b+d)/2),a<=c[e].start?b=e:d=e;return b},_getAnnotationIndex:function(c){for(var a=this._annotations,b=this._binarySearch(a,c.start);b<a.length&&a[b].start===c.start;){if(a[b]===c)return b;b++}return-1},_onChanged:function(c){var a=c.start,b=c.addedCharCount,d=c.removedCharCount,e=this._annotations,f=a+d;if(0<e.length){c={type:"Changed",added:[],removed:[],changed:[],textModelChangedEvent:c};b-=d;for(d=0;d<e.length;d++){var k=
e[d];k.start>=f?(k._oldStart=k.start,k._oldEnd=k.end,k.start+=b,k.end+=b,c.changed.push(k)):k.end<=a||(k.start<a&&f<k.end?(k._oldStart=k.start,k._oldEnd=k.end,k.end+=b,c.changed.push(k)):(e.splice(d,1),c.removed.push(k),k._annotationModel=null,k.expand&&k.expand(),d--))}if(0<c.added.length||0<c.removed.length||0<c.changed.length)this.onChanged(c)}}};m.EventTarget.addMixin(e.prototype);d.prototype={destroy:function(){var c=this._view;c&&(c.removeEventListener("Destroy",this._listener.onDestroy),c.removeEventListener("LineStyle",
...
d.getModel(),f=a?e.getLineAtOffset(a.start):-1,g=e.getLineAtOffset(c.start),d=c.start===c.end,l=!a||a.start===a.end,m=e.getLineStart(g),p=e.getLineEnd(g);e.getBaseModel&&(m=e.mapOffset(m),p=e.mapOffset(p));e=this._currentLineAnnotation;if(!(f===g&&l&&d&&e&&e.start===m&&e.end===p)){var f=e?[e]:null,v;d&&(e=k.createAnnotation(k.ANNOTATION_CURRENT_LINE,m,p),v=[e]);this._currentLineAnnotation=e;b.replaceAnnotations(f,v)}}}},installTextView:function(){this.install()},install:function(){if(!this._textView){this._textView=
...
a=c.mapOffset(b.getLineEnd(a)),b=d.getAnnotations(e,a),h=null;b.hasNext();){var f=b.next();if(f.type===k.ANNOTATION_BOOKMARK){h=f;break}}h?d.removeAnnotation(h):(h=k.createAnnotation(k.ANNOTATION_BOOKMARK,e,a),h.title=void 0,d.addAnnotation(h))}};if(this._annotationFactory){var f=a.getModel();f.getBaseModel&&(f=f.getBaseModel());if(this._annotationModel=this._annotationFactory.createAnnotationModel(f))if(f=this._annotationStyler=this._annotationFactory.createAnnotationStyler(a,this._annotationModel))f.addAnnotationType(k.ANNOTATION_CURRENT_SEARCH),
f.addAnnotationType(k.ANNOTATION_MATCHING_SEARCH),f.addAnnotationType(k.ANNOTATION_ERROR),f.addAnnotationType(k.ANNOTATION_WARNING),f.addAnnotationType(k.ANNOTATION_MATCHING_BRACKET),f.addAnnotationType(k.ANNOTATION_CURRENT_BRACKET),f.addAnnotationType(k.ANNOTATION_CURRENT_LINE),f.addAnnotationType(k.ANNOTATION_READ_OCCURRENCE),f.addAnnotationType(k.ANNOTATION_WRITE_OCCURRENCE),f.addAnnotationType(k.ANNOTATION_SELECTED_LINKED_GROUP),f.addAnnotationType(k.ANNOTATION_CURRENT_LINKED_GROUP),f.addAnnotationType(k.ANNOTATION_LINKED_GROUP),
f.addAnnotationType("orion.annotation.highlightError");var f=this._annotationFactory.createAnnotationRulers(this._annotationModel),g=this._annotationRuler=f.annotationRuler;g&&(g.onDblClick=d,g.setMultiAnnotationOverlay({html:"<div class='annotationHTML overlay'></div>"}),g.addAnnotationType(k.ANNOTATION_ERROR),g.addAnnotationType(k.ANNOTATION_WARNING),g.addAnnotationType(k.ANNOTATION_TASK),g.addAnnotationType(k.ANNOTATION_BOOKMARK));this.setAnnotationRulerVisible(this._annotationRulerVisible||void 0===
this._annotationRulerVisible,!0);if(g=this._overviewRuler=f.overviewRuler)g.addAnnotationType(k.ANNOTATION_CURRENT_SEARCH),g.addAnnotationType(k.ANNOTATION_MATCHING_SEARCH),g.addAnnotationType(k.ANNOTATION_READ_OCCURRENCE),g.addAnnotationType(k.ANNOTATION_WRITE_OCCURRENCE),g.addAnnotationType(k.ANNOTATION_CURRENT_BLAME),g.addAnnotationType(k.ANNOTATION_ERROR),g.addAnnotationType(k.ANNOTATION_WARNING),g.addAnnotationType(k.ANNOTATION_TASK),g.addAnnotationType(k.ANNOTATION_BOOKMARK),g.addAnnotationType(k.ANNOTATION_MATCHING_BRACKET),
g.addAnnotationType(k.ANNOTATION_CURRENT_BRACKET),g.addAnnotationType(k.ANNOTATION_CURRENT_LINE);this.setOverviewRulerVisible(this._overviewRulerVisible||void 0===this._overviewRulerVisible,!0)}this._lineNumberRulerFactory&&(this._lineNumberRuler=this._lineNumberRulerFactory.createLineNumberRuler(this._annotationModel),this._lineNumberRuler.addAnnotationType(k.ANNOTATION_CURRENT_BLAME),this._lineNumberRuler.addAnnotationType(k.ANNOTATION_BLAME),this._lineNumberRuler.onDblClick=d,this.setLineNumberRulerVisible(this._lineNumberRulerVisible||
void 0===this._lineNumberRulerVisible,!0));this._foldingRulerFactory&&(this._foldingRuler=this._foldingRulerFactory.createFoldingRuler(this._annotationModel),this._foldingRuler.addAnnotationType(k.ANNOTATION_FOLDING),this.setFoldingRulerVisible(this._foldingRulerVisible||void 0===this._foldingRulerVisible,!0));this.dispatchEvent({type:"TextViewInstalled",textView:a});e.prototype.install.call(this)}},uninstallTextView:function(){this.uninstall()},uninstall:function(){var c=this._textView;c&&(c.destroy(),
...
this.getModel(),a=this.getCaretOffset(),b=c.getLineAtOffset(a),c=c.getLineStart(b),a=a-c,c=this.getKeyModes(),d=0;d<c.length;d++){var e=c[d];if(e.isActive()&&e.isStatusActive&&e.isStatusActive())return}this.reportStatus(g.formatMessage(f.lineColumn,b+1,a+1))},showAnnotations:function(c,a,b,d){var e=this._annotationModel;if(e){for(var f=[],g=[],l=e.getTextModel(),m=e.getAnnotations(),p;m.hasNext();)p=m.next(),-1!==a.indexOf(p.type)&&p.creatorID===this&&f.push(p);if(c)for(a=0;a<c.length;a++)if(p=c[a]){if(b)p=
b(p);else{var v;"number"===typeof p.line?(v=l.getLineStart(p.line-1),m=v+p.start-1,v=v+p.end-1):(m=p.start,v=p.end);var z=d(p);if(!z)continue;p=k.createAnnotation(z,m,v,p.description)}p.creatorID=this;g.push(p)}e.replaceAnnotations(f,g)}},showProblems:function(c){this.showAnnotations(c,[k.ANNOTATION_ERROR,k.ANNOTATION_WARNING,k.ANNOTATION_TASK],null,function(a){switch(a.severity){case "error":return k.ANNOTATION_ERROR;case "warning":return k.ANNOTATION_WARNING;case "task":return k.ANNOTATION_TASK}return null})},
showOccurrences:function(c){this.showAnnotations(c,[k.ANNOTATION_READ_OCCURRENCE,k.ANNOTATION_WRITE_OCCURRENCE],null,function(a){return a.readAccess?k.ANNOTATION_READ_OCCURRENCE:k.ANNOTATION_WRITE_OCCURRENCE})},showBlame:function(c){var a=this._blameRGB,d=this.getTextView().getOptions("parent").ownerDocument;if(!a){var e=g.createElement(d,"div");e.className="annotation blame";d.body.appendChild(e);var r=(d.defaultView||d.parentWindow).getComputedStyle(e).getPropertyValue("background-color");e.parentNode.removeChild(e);
...
-1===c&&(c=this.blame.Message.length);var b=g.createElement(d,"a");b.href=this.blame.CommitLink;b.appendChild(d.createTextNode(this.blame.Message.substring(0,c)));a.appendChild(b);a.appendChild(g.createElement(d,"br"));a.appendChild(d.createTextNode(g.formatMessage(f.committerOnTime,this.blame.AuthorName,this.blame.Time)));return a},x=this.getModel();this.showAnnotations(c,[k.ANNOTATION_BLAME,k.ANNOTATION_CURRENT_BLAME],function(c){var d=x.getLineStart(c.Start-1),e=x.getLineEnd(c.End-1,!0),d=b.AnnotationType.createAnnotation(k.ANNOTATION_BLAME,
d,e,p),e=a.slice(0);e.push(c.Shade);d.style=l.mixin({},d.style);d.style.style=l.mixin({},d.style.style);d.style.style.backgroundColor="rgba("+e.join()+")";d.groupId=c.Name;d.groupType=k.ANNOTATION_CURRENT_BLAME;d.createGroupAnnotation=s;d.html='<img class="annotationHTML blame" src="'+c.AuthorImage+'"/>';d.blame=c;return d})},showSelection:function(c,a,b,d,e){"number"===typeof c?("number"!==typeof a&&(a=c),this.moveSelection(c,a)):"number"===typeof b&&(c=this.getModel().getLineStart(b-1),"number"===
...
k=0;void 0===b&&(b=0);"string"===typeof a?(c=e.getLine(c).indexOf(a),-1!==c&&(k=c,b=k+a.length)):(k=a,a=e.getLineEnd(c)-f,k=Math.min(k,a),b=Math.min(b,a));this.moveSelection(f+k,f+b,d)}}});return{BaseEditor:e,Editor:d}});
...
c,b))},confirm:function(a,c,b,d,e,h){var f=!1;if(this._parameterCollector&&!e){var n=this;this._parameterCollector.close();if(this._parameterCollector.open(a,function(a,e){var h=document.createElement("span");h.classList.add("parameterPrompt");h.textContent=c;a.appendChild(h);h=document.createElement("button");h.addEventListener("click",function(){f=!0;n._parameterCollector.close()},!1);e.appendChild(h);h.appendChild(document.createTextNode(b));h.className="dismissButton";var k=document.createElement("button");
k.addEventListener("click",function(){f=!1;n._parameterCollector.close()},!1);e.appendChild(k);k.appendChild(document.createTextNode(d));k.className="dismissButton";return h},function(){h(f)}))return}f=window.confirm(c);h(f)},closeParameterCollector:function(){this._parameterCollector&&this._parameterCollector.close()},collectsParameters:function(){return this._parameterCollector},_invoke:function(a,c){return this._collectAndInvoke(a.makeCopy(c),!1)},_collectAndInvoke:function(a,c){if(a)if(this._parameterCollector&&
a.parameters&&a.parameters.hasParameters()&&(c||a.parameters.shouldCollectParameters())){var b=!1;a.parameters.updateParameters(a);if(a.parameters.shouldCollectParameters()&&(b=this._parameterCollector.collectParameters(a),!b)){var d=new e.Tooltip({node:a.domNode,afterHiding:function(){this.destroy()},trigger:"click",position:["below","right","above","left"]}),b=d.contentContainer();b.classList.add("parameterPopup");var h=window.document.activeElement,f=this._parameterCollector.getFillFunction(a,
function(){h&&h.focus();d.destroy()})(b);d.show();window.setTimeout(function(){f.focus();f.select()},0);b=!0}b||a.command.callback.call(a.handler||window,a)}else a.command.callback.call(a.handler||window,a);else window.console.log("Client attempted to invoke command without an available (rendered) command invocation")},collectParameters:function(a){this._collectAndInvoke(a,!0)},showKeyBindings:function(a){function c(a){return function(){f.executeBinding(a)}}var d={},e,h,n=[],k;for(k in this._activeBindings)(h=
this._activeBindings[k])&&(h.keyBinding&&h.command&&(h.command.name||h.command.tooltip))&&n.push(h);n.sort(function(a,c){return(a.command.name||a.command.tooltip).localeCompare(c.command.name||c.command.tooltip)});for(k=0;k<n.length;k++)h=n[k],h.keyBinding.scopeName?(d[h.keyBinding.scopeName]||(d[h.keyBinding.scopeName]=[]),d[h.keyBinding.scopeName].push(h)):(e=b.getUserKeyString(h.keyBinding),a.createItem(e,h.command.name||h.command.tooltip,c(h)));for(var g in d)d[g].length&&0<d[g].length&&(a.createHeader(g),
d[g].forEach(function(d){e=b.getUserKeyString(d.keyBinding);a.createItem(e,d.command.name||d.command.tooltip,c(d))}))},addCommand:function(a){this._commandList[a.id]=a;var c=this._pendingBindings[a.id];if(c){var b=this;c.forEach(function(c){b._addBinding(a,c.type,c.binding,c.bindingOnly)});delete this._pendingBindings[a.id]}},addCommandGroup:function(a,c,b,d,e,h,f,n,k,g){this._contributionsByScopeId[a]||(this._contributionsByScopeId[a]={});a=this._contributionsByScopeId[a];e&&(a=this._createEntryForPath(a,
e));a[c]?(d&&(a[c].title=d),b&&(a[c].position=b),f&&(a[c].imageClass=f),n&&(a[c].tooltip=n),k&&(a[c].selectionClass=k),!0===g?a[c].pretendDefaultActionId=!0:a[c].defaultActionId=g,a[c].emptyGroupMessage=h):(a[c]={title:d,position:b,emptyGroupMessage:h,imageClass:f,tooltip:n,selectionClass:k,defaultActionId:!0===g?null:g,pretendDefaultActionId:!0===g,children:{}},a.sortedContributions=null)},_createEntryForPath:function(a,c){c&&c.split("/").forEach(function(c){1<c.length&&(a[c]||(a[c]={position:0,
children:{}},a.sortedContributions=null),a=a[c].children)});return a},registerSelectionService:function(a,c){this._contributionsByScopeId[a]||(this._contributionsByScopeId[a]={});this._contributionsByScopeId[a].localSelectionService=c},registerCommandContribution:function(a,c,b,d,e,h,f){this._contributionsByScopeId[a]||(this._contributionsByScopeId[a]={});a=this._contributionsByScopeId[a];d&&(a=this._createEntryForPath(a,d));a[c]={position:b};h&&((b=this._commandList[c])?this._addBinding(b,"key",
h,e):this._addPendingBinding(c,"key",h,e));f&&((b=this._commandList[c])?this._addBinding(b,"url",f,e):this._addPendingBinding(c,"url",f,e));a.sortedContributions=null},unregisterCommandContribution:function(a,c,b){if(this._contributionsByScopeId[a]){delete this._commandList[c];delete this._activeBindings[c];delete this._urlBindings[c];delete this._pendingBindings[c];var d=this._contributionsByScopeId[a];b&&b.split("/").forEach(function(a){1<a.length&&d[a]&&(d=d[a].children)});delete d[c];d.sortedContributions=
...
1]:null)&&d.classList.contains("commandSeparator"))return b?(a.removeChild(d),!1):!0;if("menu"===c&&(a=l.$$array("li > *",a),0<a.length&&a[a.length-1].classList.contains("dropdownSeparator")))if(d=a[a.length-1],b)d.parentNode.parentNode.removeChild(d.parentNode);else return!0;return!1},renderCommands:function(a,c,b,d,e,h,f){if("string"!==typeof a)throw"a scope id for rendering must be specified";c=l.node(c);if(!c)throw"no parent";var n=this._contributionsByScopeId[a];if(!b&&n){var b=n.localSelectionService||
this._selectionService,k=this;b&&b.getSelections(function(b){k.renderCommands(a,c,b,d,e,h)})}else n&&(this._render(n,c,b,d,e||"button",h,f),this._checkForTrailingSeparator(c,e,!0))},destroy:function(a){a=l.node(a);if(!a)throw"no parent";for(;a.hasChildNodes();){var c=a.firstChild;c.commandTooltip&&c.commandTooltip.destroy();c.emptyGroupTooltip&&c.emptyGroupTooltip.destroy();this.destroy(c);a.removeChild(c)}},_render:function(a,c,d,h,n,k,g){var l=a.sortedContributions;if(!l){var l=[],r=!1,p;for(p in a)if(Object.prototype.hasOwnProperty.call(a,
p)){var u=a[p];u&&"number"===typeof u.position&&(u.id=p,l.push(u),r=!0)}r&&(l.sort(function(a,c){return a.position-c.position}),a.sortedContributions=l)}var I=0,B=this;l.forEach(function(a){var l;a.imageClass||(a.imageClass=null);if(a.children&&0<Object.getOwnPropertyNames(a.children).length){var r=a.children;if("tool"===n||"button"===n)if(a.title){var s;a.defaultActionId&&((r=B._commandList[a.defaultActionId])&&(r.visibleWhen?r.visibleWhen(d):1)?(s=new f.CommandInvocation(h,d,k,r,B),s.domParent=
c):a.pretendDefaultActionId=!0);r=B._createDropdownMenu(c,a.title,null,null,a.imageClass,a.tooltip,a.selectionClass,null,s,a.pretendDefaultActionId);g&&m.generateNavGrid(g,r.menuButton);r&&(B._render(a.children,r.menu,d,h,"menu",k,g),B._checkForTrailingSeparator(r.menu,"menu",!0),0===r.menu.childNodes.length?a.emptyGroupMessage?r.menuButton.emptyGroupTooltip||(r.menuButton.emptyGroupTooltip=new e.Tooltip({node:r.menuButton,text:a.emptyGroupMessage,trigger:"click",position:["below","right","above",
"left"]})):(g&&m.removeNavGrid(g,r.menuButton),a=function(a){a&&a.parentNode&&a.parentNode.removeChild(a)},a(r.menu),a(r.menuButton),a(r.destroyButton)):r.menuButton.style.visibility="visible")}else{var p;0<c.childNodes.length&&!B._checkForTrailingSeparator(c,n)&&(p=B.generateSeparatorImage(c));B._render(r,c,d,h,n,k,g);0<c.childNodes.length&&c.childNodes[c.childNodes.length-1]!==p&&(p=B.generateSeparatorImage(c))}else if(a.title){if(a=B._createDropdownMenu(c,a.title,!0,null,null,a.imageClass))B._render(r,
a.menu,d,h,"menu",k,g),B._checkForTrailingSeparator(a.menu,"menu",!0),0===a.menu.childNodes.length&&a.destroyButton&&c.removeChild(a.destroyButton)}else 0<c.childNodes.length&&B._generateMenuSeparator(c),B._render(r,c,d,h,n,k,g),B._generateMenuSeparator(c)}else{var u=B._commandList[a.id],r=u?!0:!1;s=a=null;u&&(l=new f.CommandInvocation(h,d,k,u,B),l.domParent=c,p=r&&(u.visibleWhen?u.visibleWhen(d):!0),B._activeBindings[u.id]&&B._activeBindings[u.id].keyBinding&&(a=B._activeBindings[u.id],a.invocation=
p?l:null,a.bindingOnly&&(r=!1)),B._urlBindings[u.id]&&B._urlBindings[u.id].urlBinding&&(s=B._urlBindings[u.id],s.invocation=p?l:null,s.bindingOnly&&(r=!1)),r=r&&p);r&&(u.choiceCallback?("tool"===n||"button"===n?(a=c,r=!1,"ul"===c.nodeName.toLowerCase()&&(a=document.createElement("li"),c.appendChild(a))):(a=c,r=!0),B._createDropdownMenu(a,u.name,r,function(a){u.populateChoicesMenu(a,d,h,k,B)}.bind(u),u.imageClass,u.tooltip||u.title,u.selectionClass,u.positioningNode)):(l.handler=l.handler||this,l.domParent=
c,r=function(){B._invoke(l)},"menu"===n?(s=null,a&&a.keyBinding&&(s=b.getUserKeyString(a.keyBinding)),a=f.createCommandMenuItem(c,u,l,null,r,s)):(a=n+u.id+I,a=f.createCommandItem(c,u,l,a,null,"tool"===n,r)),m.generateNavGrid(g,a),l.domNode=a,I++))}})},_createDropdownMenu:function(a,b,d,h,n,k,r,m,p,u){a=l.node(a);if(!a||!l.contains(document.body,a))return null;var C,I,B=a;if(d)k=document.createRange(),k.selectNode(a),k=k.createContextualFragment(c),l.processTextNodes(k,{ButtonText:b}),a.appendChild(k),
I=a.lastChild,n=I.lastChild,b=n.previousSibling,b.dropdown=new g.Dropdown({dropdown:n,populate:h,parentDropdown:a.dropdown}),n.dropdown=b.dropdown;else{"ul"===a.nodeName.toLowerCase()&&(B=document.createElement("li"),a.appendChild(B),I=B);a=null;n&&(a="dropdownButtonWithIcon",k=k||b);var k=n?k||b:k,K=f.createDropdownMenu(B,b,h,a,n,!1,r,m,p||u);C=K.dropdownArrow;b=K.menuButton;if(C){p&&(p.domNode=K.menuButton);var F=this;b.onclick=function(a){var c=l.bounds(C);a.clientX>=c.left&&K.dropdown?K.dropdown.toggle(a):
F._invoke(p)};K.dropdown&&(b.onkeydown=function(a){l.KEY.DOWN===a.keyCode&&(K.dropdown.toggle(a),l.stop(a))})}var n=K.menu,J;(h=p&&p.command&&(p.command.tooltip||p.command.name))?J=p.command.tooltip||p.command.name:h&&(J=k);J&&(b.commandTooltip=new e.Tooltip({node:b,text:J,position:["above","below","right","left"]}))}return{menuButton:b,menu:n,dropdown:b.dropdown,destroyButton:I,dropdownArrow:C}},_generateMenuSeparator:function(a){if(!this._checkForTrailingSeparator(a,"menu")){var c=document.createElement("li");
...
c.type,c.label,c.value,c.lines,c.eventListeners);a.push(c)});var c=new u(a,this._options,this.getParameters);c.clientCollect=this.clientCollect;return c},hasOptionalParameters:function(){return this._hasOptionalParameters}};u.prototype.constructor=u;return{CommandRegistry:a,URLBinding:h,ParametersDescription:u,CommandParameter:r,CommandEventListener:n}});define("text!orion/banner/slideout.html",[],function(){return'<div id="slideContainer" class="slideParameters slideContainer">\r\n\t<span id="pageCommandParameters" class="layoutLeft parameters"></span>\r\n\t<span id="pageCommandDismiss" class="layoutRight parametersDismiss"></span>\r\n</div>'});
define("orion/commonHTMLFragments",["require","orion/webui/littlelib","text!orion/banner/slideout.html"],function(f,m,p){return{slideoutHTMLFragment:function(b){var f=document.createElement("div");f.innerHTML=p;var g=m.$("#slideContainer",f);g.id=b+g.id;g=m.$("#pageCommandParameters",f);g.id=b+g.id;g=m.$("#pageCommandDismiss",f);g.id=b+g.id;return f.innerHTML}}});
define("orion/section","orion/webui/littlelib orion/selection orion/commandRegistry orion/commonHTMLFragments orion/objects orion/selection".split(" "),function(f,m,p,b,l,g){function e(d,c){var a=this;this._expandImageClass="core-sprite-openarrow";this._collapseImageClass="core-sprite-closedarrow";this._twistieSpriteClass="modelDecorationSprite";if(!c.id)throw Error("Missing required argument: id");this.id=c.id;if(!c.title)throw Error("Missing required argument: title");var e=c.useAuxStyle?["sectionWrapper",
...
define("orion/markdownView","marked/marked orion/editor/editor orion/objects orion/webui/littlelib orion/URITemplate orion/section orion/URL-shim".split(" "),function(f,m,p,b,l,g){function e(c,b,d){var e=f.InlineLexer.prototype.outputLink,k=new URL(b,window.location.href),g=f.InlineLexer.prototype,l=-1===b.indexOf(":");g.outputLink=function(c,b){if(-1===b.href.indexOf(":"))try{var f;"filesystem:"===k.protocol?f={href:"filesystem:"+(new URL(b.href,k.pathname)).href}:(f=new URL(b.href,k),l&&(f.protocol=
"",f.host=""));if("!"!==c[0][0])b.href=a.expand({resource:f.href});else{if(d.readBlob){var g="_md_img_"+n++;d.readBlob(f.href).then(function(a){var c=f.href.match(h),a=URL.createObjectURL(new Blob([a],{type:c?"image/"+c[1]:"image/png"}));document.getElementById(g).src=a;URL.revokeObjectURL(a)});return"<img id='"+g+"' src=''>"}b.href=f.href}}catch(r){console.log(r)}return e.call(this,c,b)};c=f(c,{sanitize:!0});f.InlineLexer.prototype.outputLink=e;return c}function d(a){this.fileClient=a.fileClient;
this.progress=a.progress;this.canHide=a.canHide;this._node=null}function k(a){this.id="orion.markdownViewer";r.apply(this,arguments)}function c(a){this._parent=a.parent;this.serviceRegistry=a.serviceRegistry;this.contentTypeRegistry=a.contentTypeRegistry;this.commandRegistry=a.commandRegistry;this.progress=a.progressService;this.model=a.model;this.undoStack=a.undoStack}var a=new l("#{,resource,params*}"),h=/\.([0-9a-z]+)(?:[\?#]|$)/i,n=0;d.prototype={display:function(a,c,b,d){a.classList.add("orionMarkdown");
a.innerHTML=e(c,b,d)},displayContents:function(a,c){var d=c.Location||c;b.empty(a);var e=document.createElement("div");(this.progress?this.progress.progress(this.fileClient.read(d),"Reading file "+(c.Name||d)):this.fileClient.read(d)).then(function(a){this.display.bind(this)(e,a,d,this.fileClient)}.bind(this));a.appendChild(e)},displayInFrame:function(a,c,b,d,e){a=new g.Section(a,{id:"markdownSection",title:c.Name||e||"readme",headerClass:b,canHide:this.canHide});d&&(b=a.getTitleElement())&&b.classList.add(d);
this.displayContents.call(this,a.getContentElement(),c)}};var r=m.BaseEditor;k.prototype=Object.create(r.prototype);p.mixin(k.prototype,{install:function(){var a=this._rootDiv=document.createElement("div");a.style.width="100%";a.style.height="100%";var c=this._contentDiv=document.createElement("div");c.classList.add("orionMarkdown");a.appendChild(c);b.node(this._domNode).appendChild(a);this._contentDiv.innerHTML=e(this.getModel().getText());r.prototype.install.call(this)},setInput:function(a,c,b,
d){r.prototype.setInput.call(this,a,c,b,d);!c&&!d&&(this._contentDiv.innerHTML=e(b))},uninstall:function(){b.empty(this._domNode);r.prototype.uninstall.call(this)}});c.prototype={create:function(){this.editor=new k({domNode:this._parent,model:this.model,undoStack:this.undoStack});this.editor.install()},destroy:function(){this.editor&&this.editor.destroy();this.editor=null}};return{MarkdownEditorView:c,MarkdownView:d}});
define("orion/widgets/browse/browseView","i18n!orion/edit/nls/messages orion/explorers/explorer-table orion/explorers/navigatorRenderer orion/markdownView orion/PageUtil orion/URITemplate orion/webui/littlelib orion/objects orion/Deferred orion/webui/dropdown orion/section".split(" "),function(f,m,p,b,l,g,e,d,k,c,a){function h(){s.apply(this,arguments)}function n(a){a.setFocus=!1;a.cachePrefix=null;a.rendererFactory=function(c){return new h({checkbox:!1,treeTableClass:"sectionTreeTable",cachePrefix:"FolderNavigator"},
...
a.breadCrumbInHeader;this.isMarkdownView=a.isMarkdownView;this.repoURLHandler=a.repoURLHandler;this.breadCrumbMaker=a.breadCrumbMaker;this.branchSelector=a.branchSelector;this.componentSelector=a.componentSelector;this.clickHandler=a.clickHandler;this._init()}var u=m.FileExplorer,s=p.NavigatorRenderer,y=new g("#{,resource,params*}");h.prototype=Object.create(s.prototype);d.mixin(h.prototype,{showFolderImage:!0,createFolderNode:function(a){var c=p.NavigatorRenderer.prototype.createFolderNode.call(this,
...
registerCommands:function(){return(new k).resolve()},updateCommands:function(){},setCommandsVisible:function(a,c){a.actionsNode.style.visibility=c?"":"hidden";var b=c?null:"cursorOnly";this.renderer.selectionPolicy=b;var d=this.getNavHandler();d&&d.setSelectionPolicy(b);c?this.updateCommands():this.actionsSections&&this.actionsSections.forEach(function(a){e.node(a)&&this.commandRegistry.destroy(a)}.bind(this))}});r.prototype={_init:function(){this.markdownView=new b.MarkdownView({fileClient:this.fileClient,
canHide:!this.readonly,progress:this.progress})},_isCommandsVisible:function(){return!this.readonly},displayWorkspaceView:function(){this._node||(this._node=document.createElement("div"),this._node.classList.add("browse_inner_container"));this._parent.appendChild(this._node)},displayBrowseView:function(b){var b=b&&b.Children,d;if(b)for(var h=0;h<b.length;h++){var f=b[h];!f.Directory&&(f.Name&&"readme.md"===f.Name.toLowerCase())&&(d=f)}var k;this._node||(this._node=document.createElement("div"),this._node.classList.add("browse_inner_container"));
...
this._foldersSection.getActionElement();if(h){e.empty(h);var f=document.createElement("div"),g=document.createElement("div");f.classList.add("layoutLeft");g.classList.add("layoutRight");h.appendChild(f);h.appendChild(g);this.actionNode=g;h=document.createRange();h.selectNode(f);h=h.createContextualFragment(this.repoURLHandler.RepoURLTriggerTemplate);f.appendChild(h);this.repoURLDropdown=new c.Dropdown({triggerNode:e.node("orion.browse.repoURLTrigger"),dropdown:e.node("orion.browse.repoURLDropdown")});
...
(this.actionNode=this._foldersSection.getActionElement());!this.messageView&&this.commandRegistry&&this.commandRegistry.renderCommands("orion.browse.sectionActions",this.actionNode,{},"button");if(f=this._foldersSection.getTitleElement())e.empty(f),this.branchSelector&&(f.appendChild(this.branchSelector.parentNode),this.branchSelector.refresh()),this.componentSelector&&(f.appendChild(this.componentSelector.parentNode),this.componentSelector.refresh());this.breadCrumbMaker&&(h=document.createElement("div"),
g=document.createElement("div"),h.appendChild(g),this.breadCrumbInHeader?(h.classList.add("breadCrumbContainerInHeader"),f.appendChild(h),this.breadCrumbMaker(g,this._foldersSection.getHeaderElement().offsetWidth-150-50)):(h.classList.add("breadCrumbContainer"),this.sectionContents.appendChild(h),this.breadCrumbMaker(g,this._foldersSection.getHeaderElement().offsetWidth-5)));if(this.messageView)"string"===typeof this.messageView.message&&this.updateMessageContents(this.messageView.message,this.messageView.classes?
...
a+20;this.editorView.getParent().style.height=a+"px"}.bind(this));this.editor=this.editorView.editor}else this.isMarkdownView?(k=document.createElement("div"),this.markdownView.displayContents(k,this._metadata),this.sectionContents.appendChild(k)):this.imageView?this.imageView.image&&this.updateImage(this.imageView.image):(this.folderNavExplorer=new n({parentId:b,fodlerViewer:this,readonly:this.readonly,breadCrumbMaker:this.breadCrumbMaker,clickHandler:this.clickHandler,fileClient:this.fileClient,
commandRegistry:this.commandRegistry,contentTypeRegistry:this.contentTypeRegistry}),this.sectionContents.appendChild(this.folderNavExplorer.parent),this.folderNavExplorer.setCommandsVisible(this._foldersSection,this._isCommandsVisible()),this.folderNavExplorer.loadRoot(this._metadata))}else"readme"===b&&d&&(k=document.createElement("div"),this.markdownView.displayInFrame(k,d,["sectionTreeTableHeader","readmeHeader"],"readmeTitle"),this._node.appendChild(k))}.bind(this))}).apply(this,[["folderNav",
"readme"]])},updateImage:function(a){var c=document.createElement("table");c.classList.add("imageViewTable");var b=document.createElement("tr"),d=document.createElement("td"),e=document.createElement("div");e.appendChild(a);d.appendChild(e);b.appendChild(d);c.appendChild(b);this.sectionContents.appendChild(c)},updateMessageContents:function(a,c,b,d){var h=document.createElement("table");c&&c.forEach(function(a){h.classList.add(a)});var c=document.createElement("tr"),f=document.createElement("td");
...
define("orion/editor/find","i18n!orion/editor/nls/messages orion/keyBinding orion/editor/keyModes orion/editor/annotations orion/regex orion/objects orion/util".split(" "),function(f,m,p,b,l,g,e){function d(a){var c=a.getTextView();p.KeyMode.call(this,c);this.editor=a;this._active=!1;this._success=!0;this._ignoreSelection=!1;this._prefix="";c.setAction("incrementalFindCancel",function(){this.setActive(!1);return!0}.bind(this));c.setAction("incrementalFindBackspace",function(){return this._backspace()}.bind(this));
var b=this;this._listener={onVerify:function(a){var c=b.editor,d=c.getModel(),e=c.mapOffset(a.start),c=c.mapOffset(a.end),d=d.getText(e,c);if((d=b._prefix.match(RegExp("^"+l.escape(d),"i")))&&0<d.length)b._prefix+=a.text,b._success=!0,b._status(),b.find(b._forward,!0),a.text=null},onSelection:function(){b._ignoreSelection||b.setActive(!1)}}}function k(a,c,b){if(a){this._editor=a;this._undoStack=c;this._showAll=!0;this._visible=!1;this._wrap=this._caseInsensitive=!0;this._wholeWord=!1;this._incremental=
...
this._doReplace(c.start,c.end,a,b),this.endUndo()}this._findAfterReplace&&a&&this._doFind(a,this.getStartOffset())},replaceAll:function(){var a=this.getFindString();if(a){this._replacingAll=!0;var c=this._editor,b=c.getTextView();c.reportStatus(f.replaceAll);var d=this._processReplaceString(this.getReplaceString()),k=this;window.setTimeout(function(){for(var g=0,l=0;;){var m=k._doFind(a,g,null,!0);if(!m)break;l++;1===l&&(b.setRedraw(!1),k.startUndo());k._doReplace(m.start,m.end,a,d);g=k.getStartOffset()}0<
l&&(k.endUndo(),b.setRedraw(!0));0<g?c.reportStatus(e.formatMessage(f.replacedMatches,l)):c.reportStatus(f.nothingReplaced,"error");k._replacingAll=!1},100)}},setOptions:function(a){if(a){if((!0===a.showAll||!1===a.showAll)&&this._showAll!==a.showAll)if(this._showAll=a.showAll,this.isVisible())if(this._showAll)this._markAllOccurrences();else{var c=this._editor.getAnnotationModel();c&&c.removeAnnotations(b.AnnotationType.ANNOTATION_MATCHING_SEARCH)}if(!0===a.caseInsensitive||!1===a.caseInsensitive)this._caseInsensitive=
...
f=b.getLineAtOffset(d.end>d.start?d.end-1:d.end);if(e!==f){var k=[];k.push("");for(var g=e;g<=f;g++)k.push(b.getLine(g,!0));g=b.getLineStart(e);b=b.getLineEnd(f,!0);c=c.getOptions("tabSize","expandTab");c=c.expandTab?Array(c.tabSize+1).join(" "):"\t";a.setText(k.join(c),g,b);a.setSelection(g===d.start?d.start:d.start+c.length,d.end+(f-e+1)*c.length);return!0}return!1}},gotoLastEdit:function(){"number"===typeof this._lastEditLocation&&this.editor.showSelection(this._lastEditLocation);return!0},gotoLine:function(){var a=
this.editor,c=a.getModel().getLineAtOffset(a.getCaretOffset());if(c=prompt(f.gotoLinePrompty,c+1))c=parseInt(c,10),a.onGotoLine(c-1,0);return!0},moveLinesDown:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var c=a.getModel(),b=a.getSelection(),d=c.getLineAtOffset(b.start),e=c.getLineAtOffset(b.end>b.start?b.end-1:b.end),f=c.getLineCount();if(e===f-1)return!0;var d=c.getLineStart(d),b=c.getLineEnd(e,!0),k=c.getLineEnd(e+1,!0)-(b-d),g=0;e!==f-2?c=c.getText(d,b):(e=c.getLineEnd(e),
c=c.getText(e,b)+c.getText(d,e),g+=b-e);this.startUndo();a.setText("",d,b);a.setText(c,k,k);a.setSelection(k+g,k+g+c.length);this.endUndo();return!0},moveLinesUp:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var c=a.getModel(),b=a.getSelection(),d=c.getLineAtOffset(b.start);if(0===d)return!0;var e=c.getLineAtOffset(b.end>b.start?b.end-1:b.end),f=c.getLineCount(),b=c.getLineStart(d-1),k=c.getLineStart(d),g=c.getLineEnd(e,!0),l=c.getText(k,g),m=0;e===f-1&&(e=c.getLineEnd(d-
1),d=c.getLineEnd(d-1,!0),l+=c.getText(e,d),k=e,m=d-e);this.startUndo();a.setText("",k,g);a.setText(l,b,b);a.setSelection(b,b+l.length-m);this.endUndo();return!0},nextAnnotation:function(a){function c(a){return!!a.lineStyle||a.type===k.ANNOTATION_MATCHING_BRACKET||a.type===k.ANNOTATION_CURRENT_BRACKET||!f.isAnnotationTypeVisible(a.type)}var d=this.editor,e=d.getAnnotationModel();if(!e)return!0;var f=d.getOverviewRuler()||d.getAnnotationStyler();if(!f)return!0;for(var g=d.getModel(),l=d.getCaretOffset(),
m=e.getAnnotations(a?l:0,a?g.getCharCount():l),p=null;m.hasNext();){var v=m.next();if(a){if(v.start<=l)continue}else if(v.start>=l)continue;if(!c(v)&&(p=v,a))break}if(p){for(var z=[p],m=e.getAnnotations(p.start,p.start);m.hasNext();)v=m.next(),v!==p&&!c(v)&&z.push(v);var q=d.getTextView(),t=g.getLineAtOffset(p.start),A=b.Tooltip.getTooltip(q);if(!A)return d.moveSelection(p.start),!0;d.moveSelection(p.start,p.start,function(){A.setTarget({getTooltipInfo:function(){var a=q.convert({x:q.getLocationAtOffset(p.start).x,
y:q.getLocationAtOffset(g.getLineStart(t)).y},"document","page");return{contents:z,x:a.x,y:a.y+Math.floor(1.33*q.getLineHeight(t))}}},0)})}return!0},unindentLines:function(){var a=this.editor,c=a.getTextView();if(c.getOptions("readonly"))return!1;if(c.getOptions("tabMode")){for(var b=a.getModel(),d=a.getSelection(),e=b.getLineAtOffset(d.start),f=b.getLineAtOffset(d.end>d.start?d.end-1:d.end),k=c.getOptions("tabSize"),g=Array(k+1).join(" "),l=[],m=c=0,p=e;p<=f;p++){var q=b.getLine(p,!0);if(b.getLineStart(p)!==
b.getLineEnd(p))if(0===q.indexOf("\t"))q=q.substring(1),c++;else if(0===q.indexOf(g))q=q.substring(k),c+=k;else return!0;p===e&&(m=c);l.push(q)}e=b.getLineStart(e);k=b.getLineEnd(f,!0);b=b.getLineStart(f);a.setText(l.join(""),e,k);f=e===d.start?d.start:d.start-m;d=Math.max(f,d.end-c+(d.end===b+1&&d.start!==d.end?1:0));a.setSelection(f,d);return!0}},startUndo:function(){this.undoStack&&this.undoStack.startCompoundChange()},endUndo:function(){this.undoStack&&this.undoStack.endCompoundChange()}};c.TextActions=
...
a.setKeyBinding(new m.KeyBinding('"',!1,!1,!1,!1,"keypress"),"autoPairDblQuotation");a.setAction("autoPairDblQuotation",function(){return this.autoPairQuotations('"')}.bind(this));a.setAction("deletePrevious",function(){return this.deletePrevious()}.bind(this))},autoIndent:function(){var a=this.editor,c=a.getTextView();if(c.getOptions("readonly"))return!1;var b=a.getSelection();if(b.start===b.end){for(var d=a.getModel(),e=d.getLineAtOffset(b.start),f=d.getLine(e,!1),k=d.getLineStart(e),g=0,l=b.start-
k,m;g<l&&(32===(m=f.charCodeAt(g))||9===m);)g++;var k=f.substring(0,g),c=c.getOptions("tabSize","expandTab"),p=c.expandTab?Array(c.tabSize+1).join(" "):"\t",c=d.getLineDelimiter(),q=/^[\s]*\/\*[\*]*[\s]*$/,t=/^[\s]*\*/,A=/\*\/[\s]*$/,D=f.substring(0,l),C=f.substring(l),I;if(this.smartIndentation&&123===f.charCodeAt(I=D.trimRight().length-1))return d=l-I-1,C=C.length-C.trimLeft().length,f=125===f.charCodeAt(l+C)?c+k+p+c+k:c+k+p,a.setText(f,b.start-d,b.end+C),a.setCaretOffset(b.start+c.length+k.length+
p.length-d),!0;if(this.autoCompleteComments&&!A.test(D)&&(q.test(D)||t.test(D))){if(g=q.exec(D)){f=c+k+" * ";f=A.test(C)?f+C.substring(0,C.length-2).trim():f+C.trim();if(d.getLineCount()===e+1||!t.test(d.getLine(e+1)))f+=c+k+" */";a.setText(f,b.start,b.end+C.length);a.setCaretOffset(b.start+c.length+k.length+3);return!0}if(g=t.exec(D))for(e-=1;0<=e;e--){g=d.getLine(e,!1);if(q.test(g))return A.test(C)||47===f.charCodeAt(l)?(f=c+k+"*"+C,k=b.start+c.length+k.length+1):(f=c+k+"* "+C,k=b.start+c.length+
k.length+2),a.setText(f,b.start,b.end+C.length),a.setCaretOffset(k),!0;if(!t.test(g))break}}else{if(A.test(D)&&32===k.charCodeAt(k.length-1))return f=c+k.substring(0,k.length-1),a.setText(f,b.start,b.end),a.setCaretOffset(b.start+f.length),!0;if(0<g){for(g=l;g<f.length&&(32===(m=f.charCodeAt(g++))||9===m);)b.end++;a.setText(d.getLineDelimiter()+k,b.start,b.end);return!0}}}return!1},addBlockComment:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var c=a.getModel(),b=
...
var b=this.editor;if(b.getTextView().getOptions("readonly"))return!1;var d=b.getSelection(),e=b.getModel(),f=b.getCaretOffset()===e.getCharCount()?"":e.getText(d.start,d.start+1).trim(),k=/^$|[)}\]>]/;return d.start===d.end&&k.test(f)?(b.setText(a+c,d.start,d.start),b.setCaretOffset(d.start+1),!0):d.start!==d.end?(e=e.getText(d.start,d.end),b.setText(a+e+c,d.start,d.end),b.setSelection(d.start+1,d.end+1),!0):!1},autoPairQuotations:function(a){if(!this.autoPairQuotation)return!1;var c=this.editor;
if(c.getTextView().getOptions("readonly"))return!1;var b=c.getSelection(),d=c.getModel(),e=c.getCaretOffset(),f=0===e?"":d.getText(b.start-1,b.start).trim(),k=e===d.getCharCount()?"":d.getText(b.start,b.start+1).trim(),e=/^"$|^'$/,g=/\w/,l=/^$|[)}\]>]/;if(b.start!==b.end){d=d.getText(b.start,b.end);if(e.test(d))return!1;c.setText(a+d+a,b.start,b.end);c.setSelection(b.start+1,b.end+1)}else{if(k!==a){if(f===a||e.test(k)||g.test(f)||!l.test(k))return!1;c.setText(a+a,b.start,b.start)}c.setCaretOffset(b.start+
...
e=a.getLineAtOffset(b),f,k,g,l,m,p;for(f=d;0<=f&&!(k=a.getLine(f),g=f===d?c-a.getLineStart(d):k.length,l=k.lastIndexOf("/*",g),k=k.lastIndexOf("*/",g),k>l);f--)if(-1!==l){m=a.getLineStart(f)+l;break}for(f=e;f<a.getLineCount()&&!(k=a.getLine(f),g=f===e?b-a.getLineStart(e):0,l=k.indexOf("/*",g),k=k.indexOf("*/",g),-1!==l&&l<k);f++)if(-1!==k){p=a.getLineStart(f)+k;break}return{commentStart:m,commentEnd:p}},lineStart:function(){for(var a=this.editor,c=a.getModel(),b=a.getCaretOffset(),d=c.getLineAtOffset(b),
e=c.getLineStart(d),c=c.getLine(d),d=0;d<c.length;d++){var f=c.charCodeAt(d);if(!(32===f||9===f))break}d+=e;return b!==d?(a.setSelection(d,d),!0):!1},removeBlockComment:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var c=a.getModel(),b=a.getSelection(),d=c.getText(b.start,b.end),e,f,k;for(k=0;k<d.length;k++)if("/*"===d.substring(k,k+2)){e=b.start+k;break}for(;k<d.length;k++)if("*/"===d.substring(k,k+2)){f=b.start+k;break}if(void 0!==e&&void 0!==f)a.setText(c.getText(e+
2,f),e,f+2),a.setSelection(e,f);else{d=this._findEnclosingComment(c,b.start,b.end);if(void 0===d.commentStart||void 0===d.commentEnd)return!0;c=c.getText(d.commentStart+2,d.commentEnd);a.setText(c,d.commentStart,d.commentEnd+2);a.setSelection(b.start-2,b.end-2)}return!0},toggleLineComment:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;for(var c=a.getModel(),b=a.getSelection(),d=c.getLineAtOffset(b.start),e=c.getLineAtOffset(b.end>b.start?b.end-1:b.end),f=!0,k=[],g,
l,m=d;m<=e;m++)if(g=c.getLine(m,!0),k.push(g),!f||-1===(l=g.indexOf("//")))f=!1;else if(0!==l){var p;for(p=0;p<l&&!(f=g.charCodeAt(p),!(32===f||9===f));p++);f=p===l}m=c.getLineStart(d);p=c.getLineEnd(e,!0);if(f){for(f=0;f<k.length;f++)g=k[f],l=g.indexOf("//"),k[f]=g.substring(0,l)+g.substring(l+2);k=k.join("");g=c.getLineStart(e);c=m===b.start?b.start:b.start-2;b=b.end-2*(e-d+1)+(b.end===g+1?2:0)}else k.splice(0,0,""),k=k.join("//"),c=m===b.start?b.start:b.start+2,b=b.end+2*(e-d+1);a.setText(k,m,
p);a.setSelection(c,b);return!0},trimTrailingWhitespaces:function(){var a=this.editor,c=a.getModel(),b=a.getSelection();a.getTextView().setRedraw(!1);a.getUndoStack().startCompoundChange();for(var d=/(\s+$)/,e=c.getLineCount(),f=0;f<e;f++){var k=c.getLine(f),g=d.exec(k);if(g){var l=c.getLineStart(f),k=g[0].length,g=l+g.index;c.setText("",g,g+k);b.start>g&&(b.start=Math.max(g,b.start-k));b.start!==b.end&&b.end>g&&(b.end=Math.max(g,b.end-k))}}a.getUndoStack().endCompoundChange();a.getTextView().setRedraw(!0);
...
_onDestroy:function(b){(!b||!this.shared)&&this.model.removeEventListener("Changing",this._listener.onChanging);this.view&&(this.view.removeEventListener("Destroy",this._listener.onDestroy),this.view=null)},_onChanging:function(b){if(!this._ignoreUndo){var l=b.text,g=b.start,e=b.addedCharCount,d=b.removedCharCount,b=g+d,k=0;0===e&&1===d?k=-1:1===e&&0===d&&(k=1);e=this.stack.length;d=this.model.getText(g,b);(!(0<e&&this.index===e)||!this.stack[e-1].merge(g,l,d,k,b))&&this.add(new f(this.model,g,l,
d,k))}}};return{UndoStack:p}});
define("orion/editor/rulers",["i18n!orion/editor/nls/messages","orion/editor/annotations","orion/editor/tooltip","orion/util"],function(f,m,p,b){function l(c,a,b,d){this._location=a||"left";this._overview=b||"page";this._rulerStyle=d;this._view=null;var e=this;this._listener={onTextModelChanged:function(a){e._onTextModelChanged(a)},onAnnotationModelChanged:function(a){e._onAnnotationModelChanged(a)}};this.setAnnotationModel(c)}function g(c,a,b,d,e){l.call(this,c,a,"page",b);this._oddStyle=d||{style:{backgroundColor:"white"}};
this._evenStyle=e||{style:{backgroundColor:"white"}};this._numOfDigits=0;this._firstLine=1}function e(c,a,b){l.call(this,c,a,"page",b)}function d(c,a,b){l.call(this,c,a,"document",b)}function k(c,a,b){e.call(this,c,a,b)}l.prototype={getAnnotations:function(c,a){var b=this._annotationModel;if(!b)return[];var d=this._view.getModel(),e=d.getLineStart(c),f=d.getLineEnd(a-1),k=d;d.getBaseModel&&(k=d.getBaseModel(),e=d.mapOffset(e),f=d.mapOffset(f));for(var g=[],b=this.getAnnotationsByType(b,e,f),e=0;e<
b.length;e++)for(var f=b[e],l=k.getLineAtOffset(f.start),m=k.getLineAtOffset(Math.max(f.start,f.end-1)),p=l;p<=m;p++){var z=p;if(d!==k){z=k.getLineStart(p);z=d.mapOffset(z,!0);if(-1===z)continue;z=d.getLineAtOffset(z)}if(c<=z&&z<a){var q=this._mergeAnnotation(g[z],f,p-l,m-l+1);q&&(g[z]=q)}}if(!this._multiAnnotation&&this._multiAnnotationOverlay)for(var t in g)g[t]._multiple&&(g[t].html+=this._multiAnnotationOverlay.html);return g},getAnnotationModel:function(){return this._annotationModel},getLocation:function(){return this._location},
...
c},setView:function(c){this._onTextModelChanged&&this._view&&this._view.removeEventListener("ModelChanged",this._listener.onTextModelChanged);this._view=c;this._onTextModelChanged&&this._view&&this._view.addEventListener("ModelChanged",this._listener.onTextModelChanged)},onClick:function(c){if(void 0!==c){var a=this._view,b=a.getModel(),d=b,e=b.getLineStart(c),f=e,k=e,g=this._annotationModel;if(g){a=a.getSelection();k=b.getLineEnd(c,!0);e<=a.start&&a.start<k&&(e=a.start);b.getBaseModel&&(e=b.mapOffset(e),
k=b.mapOffset(k),d=b.getBaseModel());for(var l,k=g.getAnnotations(e,k),g=null;!l&&k.hasNext();)a=k.next(),this.isAnnotationTypeVisible(a.type)&&(g=a,a.start<=e||(l=a));g&&void 0!==g.groupId&&(this._currentClickGroup=this._currentClickGroup===g.groupId?null:g.groupId,this._setCurrentGroup(c));l&&d.getLineAtOffset(l.start)===d.getLineAtOffset(e)?(e=l.start,k=l.end):k=e=f;b.getBaseModel&&(e=b.mapOffset(e,!0),k=b.mapOffset(k,!0))}(c=p.Tooltip.getTooltip(this._view))&&c.setTarget(null);this._view.setSelection(k,
...
c&&c.setTarget(null)},_getTooltipInfo:function(c,a){if(void 0!==c){var b=this._view,d=b.getModel(),e=this._annotationModel,f=[];if(e){var f=d.getLineStart(c),k=d.getLineEnd(c);d.getBaseModel&&(f=d.mapOffset(f),k=d.mapOffset(k));f=this.getAnnotationsByType(e,f,k)}e=this._getTooltipContents(c,f);if(!e)return null;e={contents:e,anchor:this.getLocation()};f=b.getClientArea();f.y="document"===this.getOverview()?b.convert({y:a},"view","document").y:b.getLocationAtOffset(d.getLineStart(c)).y;b.convert(f,
"document","page");e.x=f.x;e.y=f.y;"right"===e.anchor&&(e.x+=f.width);return e}},_getTooltipContents:function(c,a){return a},_onAnnotationModelChanged:function(c){function a(a){for(var c=0;c<a.length;c++)if(e.isAnnotationTypeVisible(a[c].type)){var f=a[c].start,k=a[c].end;d.getBaseModel&&(f=d.mapOffset(f,!0),k=d.mapOffset(k,!0));-1!==f&&-1!==k&&b.redrawLines(d.getLineAtOffset(f),d.getLineAtOffset(Math.max(f,k-1))+1,e)}}var b=this._view;if(b){var d=b.getModel(),e=this,f=d.getLineCount();c.textModelChangedEvent?
...
define("orion/editor/templates",[],function(){function f(f,b,l,g){this.prefix=f;this.description=b;this.template=l;this.name=g;this._parse()}function m(f,b){this._keywords=f||[];this._templates=[];this.addTemplates(b||[])}f.prototype={getProposal:function(f,b,l){var f=b-f.length,b={},g,e=void 0!==l.delimiter?l.delimiter:"\n";l.indentation&&(e+=l.indentation);for(var d=void 0!==l.tab?l.tab:"\t",k=0,c=this.variables,a=this.segments,l=[],h=0;h<a.length;h++){var n=a[h],m=c[n];if(void 0!==m)switch(n){case "${tab}":n=
d;break;case "${delimiter}":n=e;break;case "${cursor}":n="";g=k;break;default:var u=b[n];u||(u=b[n]={data:m.data,positions:[]});n=m.substitution;u.data&&u.data.values&&(n=u.data.values[0]);u.positions.push({offset:f+k,length:n.length})}l.push(n);k+=n.length}var e=[],s;for(s in b)b.hasOwnProperty(s)&&e.push(b[s]);l=l.join("");void 0===g&&(g=l.length);return{proposal:l,name:this.name,description:this.description,groups:e,escapePosition:f+g,style:"noemphasis"}},match:function(f){return 0===this.prefix.indexOf(f)},
_parse:function(){var f=this.template,b=[],l={},g,e=0,f=f.replace(/\n/g,"${delimiter}"),f=f.replace(/\t/g,"${tab}");f.replace(/\$\{((?:[^\\}]+|\\.))*\}/g,function(d,k,c){var a=d.substring(2,d.length-1),k=d,h=a,n=null,m=h.indexOf(":");-1!==m&&(h=h.substring(0,m),k="${"+h+"}",n=JSON.parse(a.substring(m+1).replace("\\}","}").trim()));(a=l[k])||(a=l[k]={});a.substitution=h;n&&(a.data=n);(g=f.substring(e,c))&&b.push(g);b.push(k);e=c+d.length;return h});(g=f.substring(e,f.length))&&b.push(g);this.segments=
...
this.contentAssist.setProgress(null))}.bind(this),onModelChanged:function(a){if(!this.ignoreVerify){for(var c=this.editor.mapOffset(a.start),b=this.linkedModeModel,d,e;b;)if(d=this._getPositionChanged(b,c,c+a.removedCharCount),e=d.position,void 0===e||e.model!==b)this.exitLinkedMode(!1),b=this.linkedModeModel;else break;if(b){b=0;a=a.addedCharCount-a.removedCharCount;d=d.positions;for(var f,k=0;k<d.length;++k){f=d[k];e=f.position;var h=e.offset<=c&&c<=e.offset+e.length;h&&!f.ansestor?(e.offset+=b,
e.length+=a,b+=a):(e.offset+=b,f.ansestor&&h&&(e.length+=a));f.escape&&(f.model.escapePosition=e.offset)}this._updateAnnotations(d)}}}.bind(this),onVerify:function(a){if(!this.ignoreVerify){for(var c=this.editor,b=c.mapOffset(a.start),d=this.editor.mapOffset(a.end),e=this.linkedModeModel,f,k;e;)if(f=this._getPositionChanged(e,b,d),k=f.position,void 0===k||k.model!==e)this.exitLinkedMode(!1),e=this.linkedModeModel;else break;if(e){var h=this._compoundChange;h?h.owner.model===e&&h.owner.group===k.group||
(this.endUndo(),this.startUndo()):this.startUndo();e.selectedGroupIndex=k.group;var h=0,g=a.text.length-(d-b);f=f.positions;for(var l,b=b-k.position.offset,m=d-k.position.offset,p=0;p<f.length;++p)l=f[p],d=l.position,l.oldOffset=d.offset,l.model===e&&l.group===k.group?(d.offset+=h,d.length+=g,h+=g):(d.offset+=h,l.ansestor&&(d.length+=k.count*g)),l.escape&&(l.model.escapePosition=d.offset);this.ignoreVerify=!0;for(p=f.length-1;0<=p;p--)l=f[p],l.model===e&&l.group===k.group&&c.setText(a.text,l.oldOffset+
...
define("orion/editor/factories","orion/editor/actions orion/editor/undoStack orion/editor/rulers orion/editor/annotations orion/editor/textDND orion/editor/linkedMode".split(" "),function(f,m,p,b,l,g){function e(){}function d(){}function k(){}function c(){}function a(){}function h(){}var n={};e.prototype={createKeyBindings:function(a,b,c,d){var d=new f.TextActions(a,b,d),e=new g.LinkedMode(a,b,c),a=new f.SourceCodeActions(a,b,c,e);return{textActions:d,linkedMode:e,sourceCodeActions:a}}};n.KeyBindingsFactory=
e;d.prototype={createUndoStack:function(a){a=a.getTextView();return new m.UndoStack(a,200)}};n.UndoFactory=d;k.prototype={createLineNumberRuler:function(a){return new p.LineNumberRuler(a,"left",{styleClass:"ruler lines"},{styleClass:"rulerLines odd"},{styleClass:"rulerLines even"})}};n.LineNumberRulerFactory=k;c.prototype={createFoldingRuler:function(a){return new p.FoldingRuler(a,"left",{styleClass:"ruler folding"})}};n.FoldingRulerFactory=c;a.prototype={createAnnotationModel:function(a){return new b.AnnotationModel(a)},
createAnnotationStyler:function(a,c){return new b.AnnotationStyler(a,c)},createAnnotationRulers:function(a){var b=new p.AnnotationRuler(a,"left",{styleClass:"ruler annotations"}),a=new p.OverviewRuler(a,"right",{styleClass:"ruler overview"});return{annotationRuler:b,overviewRuler:a}}};n.AnnotationFactory=a;h.prototype={createTextDND:function(a,b){return new l.TextDND(a.getTextView(),b)}};n.TextDNDFactory=h;return n});
define("orion/editor/editorFeatures",["orion/editor/factories","orion/editor/actions","orion/editor/linkedMode","orion/objects"],function(f,m,p,b){return b.mixin({},f,m,p)});
define("orion/editorPreferences",[],function(){function f(b,f){this._preferences=b;if(this._callback=f)var g=b.listenForChangedSettings(m,function(b){b.key===g&&f()}.bind(this))}var m="/editor/settings",p={autoSave:!1,autoSaveVisible:!0,autoSaveLocalVisible:!0,autoSaveTimeout:1E3,autoSaveTimeoutVisible:!0,themeVisible:!0,themeLocalVisible:!0,fontSizeVisible:!0,fontSizeLocalVisible:!0,autoLoad:!0,autoLoadVisible:!0,saveDiffs:!0,saveDiffsVisible:!0,contentAssistAutoTrigger:!0,contentAssistAutoTriggerVisible:!0,
...
define("orion/widgets/themes/ThemePreferences",[],function(){function f(f,p){this._preferences=f;this._themeData=p;var b=p.getThemeStorageInfo(),l=f.listenForChangedSettings(b.storage,2,function(b){b.key===l&&this.apply()}.bind(this))}f.prototype={_initialize:function(f,p,b){var l=b.get(f.styleset);l||(l=p.getStyles(),b.put(f.styleset,JSON.stringify(l)));(p=b.get("selected"))&&(p=JSON.parse(p));if(!p||void 0===p[f.selectedKey])p=p||{},p[f.selectedKey]=f.defaultTheme,b.put("selected",JSON.stringify(p))},
apply:function(){this.setTheme()},getTheme:function(f){var p=this._themeData,b=p.getThemeStorageInfo();this._preferences.getPreferences(b.storage,2).then(function(l){this._initialize(b,p,l);var g=JSON.parse(l.get("selected")),l=JSON.parse(l.get(b.styleset)),e;if(l)for(var d=0;d<l.length;d++)if(l[d].name===g[b.selectedKey]){e=l[d];break}f({style:e,styles:l})}.bind(this))},setTheme:function(f,p){var b=this._themeData,l=b.getThemeStorageInfo();this._preferences.getPreferences(l.storage,2).then(function(g){this._initialize(l,
b,g);var e=JSON.parse(g.get("selected"));f||(f=e[l.selectedKey]);e[l.selectedKey]=f;g.put("selected",JSON.stringify(e));p?g.put(l.styleset,JSON.stringify(p)):p=JSON.parse(g.get(l.styleset));for(g=0;g<p.length;g++)if(p[g].name===e[l.selectedKey]){b.processSettings(p[g]);break}}.bind(this))},setFontSize:function(f){var p=this._themeData,b=p.getThemeStorageInfo();this._preferences.getPreferences(b.storage,2).then(function(l){this._initialize(b,p,l);var g=JSON.parse(l.get("selected")),e=JSON.parse(l.get(b.styleset)),
d;if(e)for(var k=0;k<e.length;k++)e[k].fontSize=f,e[k].name===g[b.selectedKey]&&(d=e[k]);l.put(b.styleset,JSON.stringify(e));p.processSettings(d)}.bind(this))}};return{ThemePreferences:f}});
...
define("orion/widgets/browse/readonlyEditorView","orion/editor/editor orion/editor/textView orion/editor/textModel orion/editor/projectionTextModel orion/editor/editorFeatures orion/editorPreferences orion/widgets/themes/ThemePreferences orion/widgets/themes/editor/ThemeData orion/objects".split(" "),function(f,m,p,b,l,g,e,d,k){function c(a){this._parent=a.parent;this.renderToolbars=a.renderToolbars;this.inputManager=a.inputManager;this.preferences=a.preferences;this.statusReporter=a.statusReporter;
...
c.apply());var n=this._parent,c=this.inputManager,r=function(){var a=this.updateViewOptions(this.settings);k.mixin(a,{parent:n,model:new b.ProjectionTextModel(this.model||new p.TextModel)});return new m.TextView(a)}.bind(this),u=this.editor=new f.Editor({textViewFactory:r,annotationFactory:new l.AnnotationFactory,foldingRulerFactory:new l.FoldingRulerFactory,lineNumberRulerFactory:new l.LineNumberRulerFactory,statusReporter:this.statusReporter,domNode:n});u.id="orion.editor";c.addEventListener("InputChanged",
...
this.listener);this.commandRegistry.destroy(this.parentNode);m.empty(this.parentNode);this.resourceChangeListener=this.resourceChangeDispatcher=this.listener=this.parentNode=null},registerCommands:function(){if(!this.commandsRegistered){this.commandsRegistered=!0;var b=this.commandRegistry,d=new p.Command({imageClass:"core-sprite-openarrow",id:this.dropDownId,visibleWhen:function(){return!0},choiceCallback:this._switchBrMenuCallback.bind(this),positioningNode:this.parentNode});b.addCommand(d);b.registerCommandContribution(this.commandScopeId,
...
this.menu.classList.add("pageActions");this.parentNode.appendChild(this.resourceName);this.parentNode.appendChild(this.menu);this.registerCommands();this.parentNode.addEventListener("click",this._openMenu.bind(this))},_openMenu:function(){var b=m.$(".dropdownTrigger",this.menu);if(b){var d=document.createEvent("MouseEvents");d.initEvent("click",!0,!0);b.dispatchEvent(d)}},_resourceLabel:function(){var b=document.createDocumentFragment();b.textContent="${0} "+this.activeResourceName;var d=document.createElement("span");
d.appendChild(document.createTextNode(this.labelHeader+":"));d.classList.add("browserResourceSelectorNameLabel");m.processDOMNodes(b,[d]);return b},refresh:function(){m.empty(this.resourceName);this.resourceName.appendChild(this._resourceLabel());this.commandRegistry.destroy(this.menu);this.commandRegistry.renderCommands(this.commandScopeId,this.menu,{},"menu")},setActiveResource:function(b){this.activeResourceName=b.resource.Name;this.activeResourceLocation=b.resource.Location;this.fetchChildren?
...
function(b){console.log(b)}.bind(this)):window.location=g.expand({resource:b.resource.Location})},getActiveResource:function(b){var d=this.allItems[0];this.allItems.some(function(f){if(f.Location===b)return d=f,!0});return d}});return{ResourceSelector:l}});
define("orion/fileClient",["i18n!orion/navigate/nls/messages","orion/Deferred","orion/i18nUtil"],function(f,m,p){function b(b,d,g){if(!b[d])throw d+f[" is not supported in this file system"];return b[d].apply(b,g)}function l(e,d,g,c){if(!e.readBlob)throw f["source file service does not support binary read"];if(!g.writeBlob)throw f["target file service does not support binary write"];if("/"!==d[d.length-1])return b(e,"readBlob",[d]).then(function(a){return b(g,"writeBlob",[c,a])});var a=c.substring(0,
c.length-1),h=decodeURIComponent(a.substring(a.lastIndexOf("/")+1)),a=a.substring(0,a.lastIndexOf("/")+1);return b(g,"createFolder",[a,h]).then(function(){},function(){}).then(function(){return b(e,"fetchChildren",[d]).then(function(a){for(var b=[],d=0;d<a.length;++d){var f=a[d].Location,h=f;a[d].Directory&&(h=f.substring(0,f.length-1));h=decodeURIComponent(h.substring(h.lastIndexOf("/")+1));h=c+encodeURIComponent(h);a[d].Directory&&(h+="/");b[d]=l(e,f,g,h)}return m.all(b)})})}function g(b,d){function g(a){var b=
new m;b.reject(f["No Matching FileService for location:"]+a);return b}var c=b.getServiceReferences("orion.core.file"),a=c;if(d)for(var a=[],h=0;h<c.length;++h)d(c[h])&&a.push(c[h]);for(var l=[],r=[],u=[],s=[],y={fetchChildren:function(){var a=new m;a.resolve(s);return a},createWorkspace:function(){var a=new m;a.reject(f["no file service"]);return a},loadWorkspaces:function(){var a=new m;a.reject(f["no file service"]);return a},loadWorkspace:function(){var a=new m;window.setTimeout(function(){a.resolve({Directory:!0,
...
"^"+h),l[c]=RegExp(h),r[c]=b.getService(a[c]),u[c]=a[c].getProperty("Name"),a[c].getProperty("NameKey")&&a[c].getProperty("nls")&&p.getMessageBundle(a[c].getProperty("nls")).then(function(b,c){s[b].Name=c[a[b].getProperty("NameKey")];u[b]=c[a[b].getProperty("NameKey")]}.bind(this,c));this._getServiceIndex=function(a){if("/"===a)return-1;if(!a||a.length&&0===a.length)return r[0]?0:-1;for(var b=0;b<l.length;++b)if(l[b].test(a))return b;throw f["No Matching FileService for location:"]+a;};this._getService=
function(a){a=this._getServiceIndex(a);return-1===a?y:r[a]};this._getServiceName=function(a){a=this._getServiceIndex(a);return-1===a?y.Name:u[a]};this._getServiceRootURL=function(a){a=this._getServiceIndex(a);return-1===a?y.Location:s[a].Location}}g.prototype={getService:function(b){return this._getService(b)},fileServiceName:function(b){return this._getServiceName(b)},fileServiceRootURL:function(b){return this._getServiceRootURL(b)},fetchChildren:function(e){return b(this._getService(e),"fetchChildren",
...
new p({start:0,contentStart:0,end:e,contentEnd:e},null,this,d);this._computeFolding(this._rootBlock.getBlocks());c&&this.detectTasks&&(e=[],w(this._rootBlock,d,e),c.replaceAnnotations([],e));a.redrawLines()}var g={styleClass:"meta annotation currentLine"},e=/$/,d=/\\(\d)/g,k=/(.*)(?:[\r\n]|$)/g,c={regex:/ /g,style:{styleClass:"punctuation separator space",unmergeable:!0}},a={regex:/\t/g,style:{styleClass:"punctuation separator tab",unmergeable:!0}},h=function(a,b,c,d){var e=c,f=a.lastIndex;k.lastIndex=
c;var c=k.exec(b),g,h;a.lastIndex=0;if(c){for(h=c.index;0<=--h&&!(g=b.charAt(h),"\n"===g||"\r"===g););g=b.substring(h+1,c.index+c[1].length);a.lastIndex=h=c.index-h-1}for(;c&&c.index<b.length;){var l;if(d){var m=a.lastIndex;a.test(g)&&(a.lastIndex=m,l=a.exec(g))}else l=a.exec(g);if(l)return l.index+=e,l.index-=h,a.lastIndex=f,l;h=0;e+=c[0].length;if(c=k.exec(b))g=c[1],a.lastIndex=0}a.lastIndex=f;return null},n=function(a,b){var c=a.toString();d.lastIndex=0;if(!d.test(c))return a;d.lastIndex=0;for(var e=
...
-1:a.result.index>b.result.index?1:a.pattern.pattern.index<b.pattern.pattern.index?-1:1});for(var k=0;0<g.length;){var l=g[0];g.splice(0,1);if(!(l.result.index<k)){var m=l.result.index,p,F=[];if(l.pattern.regex){k=l.result;p=m+k[0].length;p={start:b+m,end:b+p,style:l.pattern.pattern.name};if(!f){l.pattern.pattern.captures&&u(k,l.pattern.pattern.captures,b+m,F);F.sort(function(a,b){return a.start<b.start?-1:a.start>b.start?1:0});for(m=0;m<F.length-1;m++)if(F[m+1].start<F[m].end){var w={start:F[m+1].end,
end:F[m].end,style:F[m].style};F[m].end=F[m+1].start;F.splice(m+2,0,w)}}s(p,F,d)}else k=l.pattern.regexEnd,k=n(k,l.result),k=h(k,a,l.result.index+l.result[0].length),k||(e.lastIndex=0,k=e.exec(a)),p=k.index+k[0].length,d.push({start:b+m,end:b+p,style:l.pattern.pattern.name});k=k.index+k[0].length}r(l,a,g,k)}c.forEach(function(a){a=a.regex||a.regexBegin;a.lastIndex=a.oldLastIndex})}},x=function(a,b,c,d){var f=[];c.getBlockPatterns().forEach(function(a){var c=h(a.regexBegin||a.regex,b,0);c&&f.push({result:c,
pattern:a})}.bind(this));if(!f.length)return f;f.sort(function(a,b){return a.result.index<b.result.index?-1:a.result.index>b.result.index?1:a.pattern.pattern.index<b.pattern.pattern.index?-1:1});for(var g=0,k=[];0<f.length;){var l=f[0];f.splice(0,1);if(!(l.result.index<g)){var m=a.getLineAtOffset(d+l.result.index),s=a.getLine(m),u=[];y(s,a.getLineStart(m),c,u);m=d+l.result.index;for(s=0;s<u.length;s++)if(u[s].start===m){var g=l.result.index,w=null,x=l.pattern.regexEnd;if(x)for(var g=g+l.result[0].length,
x=n(x,l.result),E=g;!w;){E=h(x,b,E);E||(e.lastIndex=0,E=e.exec(b));var O=[],Q=new p({start:m,end:d+E.index+E[0].length,contentStart:d+g,contentEnd:d+E.index},l.pattern,c.getStyler(),a,c);y(b.substring(g,E.index+E[0].length),g,Q,O);if(!O.length||O[O.length-1].end<=E.index)w=Q;E=E.index+E[0].length}else w=new p({start:m,end:m+l.result[0].length,contentStart:m,contentEnd:m+l.result[0].length},l.pattern,c.getStyler(),a,c);k.push(w);g=w.end-d;break}s===u.length&&(g=l.result.index+1)}r(l,b,f,g)}return k},
w=function(a,b,c){if(a.getAnnotationModel()){var d=f.AnnotationType.ANNOTATION_TASK;if(a.getLinePatterns().length&&a.pattern&&a.pattern.pattern.name&&0===a.pattern.pattern.name.indexOf("comment")){var e=[];y(b.getText(a.contentStart,a.end),a.contentStart,a,e,!0);for(var g=0;g<e.length;g++)"meta.annotation.task.todo"===e[g].style&&c.push(f.AnnotationType.createAnnotation(d,e[g].start,e[g].end,b.getText(e[g].start,e[g].end)))}a.getBlocks().forEach(function(a){w(a,b,c)}.bind(this))}};m.prototype={getPatterns:function(a){var b=
...
c.style.indexOf(a.pattern.name)?g.push(c.start+1):0===c.style.indexOf(b.pattern.name)&&g.push(-(c.start+1))}),h=[]);k=p}k<f&&(y(d.substring(k-e,f-e),k,c,h),h.forEach(function(c){0===c.style.indexOf(a.pattern.name)?g.push(c.start+1):0===c.style.indexOf(b.pattern.name)&&g.push(-(c.start+1))}));return g},_findMatchingBracket:function(a,b,c){for(var d=a.getLineAtOffset(c),e=a.getLineEnd(d),f=a.getText(c,e),g,k=b.getEnclosurePatterns(),l=Object.keys(k),m=0;m<l.length;m++){var n=k[l[m]],p=h(n.regex,f,0);
if(p&&0===p.index){g=n;break}}if(!g)return-1;f=!1;-1!==g.pattern.name.indexOf(".begin")?(f=!0,m=g.pattern.name.replace(".begin",".end")):m=g.pattern.name.replace(".end",".begin");k=k[m];if(!k)return-1;l=a.getLine(d);n=a.getLineStart(d);e=this._findBrackets(g,k,b,l,n,e);for(m=0;m<e.length;m++)if(l=0<=e[m]?1:-1,e[m]*l-1===c){c=1;if(f){for(m++;m<e.length;m++)if(l=0<=e[m]?1:-1,c+=l,0===c)return e[m]*l-1;d+=1;for(m=a.getLineCount();d<m;){l=a.getLine(d);n=a.getLineStart(d);e=a.getLineEnd(d);e=this._findBrackets(g,
k,b,l,n,e);for(f=0;f<e.length;f++)if(l=0<=e[f]?1:-1,c+=l,0===c)return e[f]*l-1;d++}}else{for(m--;0<=m;m--)if(l=0<=e[m]?1:-1,c+=l,0===c)return e[m]*l-1;for(d-=1;0<=d;){l=a.getLine(d);n=a.getLineStart(d);e=a.getLineEnd(d);e=this._findBrackets(g,k,b,l,n,e);for(m=e.length-1;0<=m;m--)if(l=0<=e[m]?1:-1,c+=l,0===c)return e[m]*l-1;d--}}break}return-1},_getAnnotationModel:function(){return this.annotationModel},_getLineStyle:function(a){if(this.highlightCaretLine){var b=this.view,c=b.getModel(),b=b.getSelection();
if(b.start===b.end&&c.getLineAtOffset(b.start)===a)return g}return null},_getPatternManager:function(){return this.patternManager},_getStyles:function(a,b,c,d){b.getBaseModel&&(d=b.mapOffset(d));for(var e=d+c.length,f=[],g=d,k=a.getBlocks(),l=this._binarySearch(k,d,!0);l<k.length&&!(k[l].start>=e);l++){var m=k[l].start,n=k[l].end;g<m&&y(c.substring(g-d,m-d),g,a,f);var p=Math.max(g,m);if(p===m&&k[l].pattern.regexBegin){var r=h(k[l].pattern.regexBegin,c.substring(p-d),0);if(r){var s=k[l].pattern.pattern.beginCaptures||
k[l].pattern.pattern.captures;s?u(r,s,p,f):f.push({start:p,end:p+r[0].length,style:k[l].pattern.pattern.name});p+=r[0].length}}var m=Math.min(e,n),w=[];if(m===n&&k[l].pattern.regexEnd&&(g=c.substring(m-g-(k[l].end-k[l].contentEnd)),r=h(k[l].pattern.regexEnd,g,0)))(s=k[l].pattern.pattern.endCaptures||k[l].pattern.pattern.captures)?u(r,s,m-r[0].length,w):k[l].pattern.pattern.name&&w.push({start:m-r[0].length,end:m,style:k[l].pattern.pattern.name}),m-=r[0].length;var g=this._getStyles(k[l],b,c.substring(p-
d,m-d),p),x=k[l].pattern.pattern.contentName||k[l].pattern.pattern.name;if(x){var N=p;g.forEach(function(a){a.start-N&&f.push({start:N,end:a.start,style:x});f.push(a);N=a.end});m-N&&f.push({start:N,end:m,style:x})}else f=f.concat(g);f=f.concat(w);g=n}g<e&&y(c.substring(g-d,e-d),g,a,f);if(b.getBaseModel)for(a=0;a<f.length;a++)c=f[a].end-f[a].start,f[a].start=b.mapOffset(f[a].start,!0),f[a].end=f[a].start+c;return f},_isRenderingWhitespace:function(){return this.whitespacesVisible&&(this.tabsVisible||
...
g,e);-1!==e&&(a.preventDefault(),a=e,c.getBaseModel&&(a=c.mapOffset(a,!0)),d>a&&(d--,a++),b.setSelection(a,d))}}},_onModelChanged:function(a){var b=a.start,c=a.removedCharCount,a=a.addedCharCount-c,d=this.view,e=d.getModel(),g=e.getBaseModel?e.getBaseModel():e,c=b+c,h=g.getCharCount(),k=this._rootBlock.getBlocks(),l=k.length,m=g.getLineStart(g.getLineAtOffset(b)),n=this._binarySearch(k,m,!0),p=this._binarySearch(k,c,!1,n-1,l),r;n<l&&k[n].start<=m&&m<k[n].end?(r=k[n].start,r>b&&(r+=a)):r=n===l&&0<
l&&h-a===k[l-1].end?k[l-1].start:m;var s;do p<l?(s=k[p].end,s>b&&(s+=a),p+=1):(p=l,s=h),m=g.getText(r,s),m=x(g,m,this._rootBlock,r);while(m.length&&k.length&&p<l&&m[m.length-1].pattern.pattern.id!==k[p-1].pattern.pattern.id);for(h=n;h<k.length;h++)l=k[h],l.start>b&&l.adjustStart(a),l.start>b&&l.adjustEnd(a);var u=p-n!==m.length;if(!u)for(h=0;h<m.length;h++){var l=k[n+h],y=m[h];if(l.start!==y.start||l.end!==y.end||l.type!==y.type){u=!0;break}}h=[n,p-n].concat(m);Array.prototype.splice.apply(k,h);u&&
(h=r,l=s,e!==g&&(h=e.mapOffset(h,!0),l=e.mapOffset(l,!0)),d.redrawRange(h,l));if(this.annotationModel){d=[];k=[];n=[];r=this.annotationModel.getAnnotations(r,s);for(s=this.foldingEnabled&&g!==e;r.hasNext();)if(l=r.next(),s&&l.type===f.AnnotationType.ANNOTATION_FOLDING){n.push(l);for(h=0;h<m.length&&!(l.start===m[h].start&&l.end===m[h].end);h++);h===m.length?(d.push(l),l.expand()):(h=l.start,p=l.end,h>b&&(h-=a),p>b&&(p-=a),h<=b&&(b<p&&h<=c&&c<p)&&(h=g.getLineAtOffset(l.start),p=g.getLineAtOffset(l.end),
h!==p?l.expanded||l.expand():this.annotationModel.removeAnnotation(l)));for(h=0;h<m.length;h++){l=m[h];for(p=0;p<n.length&&!(n[p].start===l.start&&n[p].end===l.end);p++);p===n.length&&(l=this._createFoldingAnnotation(e,g,l.start,l.end))&&k.push(l)}}else l.type===f.AnnotationType.ANNOTATION_TASK&&d.push(l);if(this.detectTasks)for(h=0;h<m.length;h++)w(m[h],g,k);this.annotationModel.replaceAnnotations(d,k)}},_spliceStyles:function(a,b,c,d){for(var e=a.regex,f=e.lastIndex=0,g=e.exec(c);g;){for(g=d+g.index;f<
...
define("orion/editor/stylers/text_html/syntax",["orion/editor/stylers/lib/syntax","orion/editor/stylers/application_javascript/syntax","orion/editor/stylers/text_css/syntax","orion/editor/stylers/text_x-php/syntax","orion/editor/stylers/application_xml/syntax"],function(f,m,p,b,l){f=f.grammars.concat(m.grammars).concat(p.grammars).concat(b.grammars).concat(l.grammars);f.push({id:"orion.html",contentTypes:["text/html"],patterns:[{include:"orion.xml"},{begin:"(?i)(<style)([^>]*)(>)",end:"(?i)(</style>)",
...
define("orion/widgets/browse/staticDataSource","orion/Deferred orion/editor/textStyler orion/editor/stylers/application_javascript/syntax orion/editor/stylers/text_css/syntax orion/editor/stylers/text_html/syntax orion/editor/stylers/text_x-java-source/syntax orion/editor/stylers/application_json/syntax orion/editor/stylers/text_x-php/syntax orion/editor/stylers/text_x-python/syntax orion/editor/stylers/text_x-ruby/syntax".split(" "),function(f,m,p,b,l,g,e,d,k,c){function a(){this.styler=null}a.prototype=
{setup:function(a,b,c){this.styler&&(this.styler.destroy&&this.styler.destroy(),this.styler=null);return this.highlight(a,b,c)},highlight:function(a,g,r){this.styler&&(this.styler.destroy(),this.styler=null);if(a)switch(a.id){case "application/javascript":this.styler=new m.TextStyler(g,r,p.grammars,"orion.js");break;case "text/css":this.styler=new m.TextStyler(g,r,b.grammars,"orion.css");break;case "text/html":this.styler=new m.TextStyler(g,r,l.grammars,"orion.html");break;case "text/x-java-source":this.styler=
new m.TextStyler(g,r,p.grammars,"orion.js");break;case "application/json":this.styler=new m.TextStyler(g,r,e.grammars,"orion.json");break;case "text/x-python":this.styler=new m.TextStyler(g,r,k.grammars,"orion.py");break;case "text/x-ruby":this.styler=new m.TextStyler(g,r,c.grammars,"orion.rb");break;case "text/x-php":this.styler=new m.TextStyler(g,r,d.grammars,"orion.php")}return(new f).resolve()},getStyler:function(){return this.styler}};return{ContentTypes:[{id:"text/plain",name:"Text",extension:["txt"],
...
function(f,m,p,b,l,g,e,d,k,c,a,h,n,r,u,s,y,x,w,v,z){function q(){y.attach(this)}function t(a){this.fileBrowser=a}function A(a,b){this.repoURL=a;if(this.baseURL=b){this.RepoURLTriggerTemplate=w;var c=this.repoURL.match(/\/([^\/]+)\/([^\/]+)$/);this.promptValue=c?"teamRepository="+this.baseURL+"\nuserId="+decodeURIComponent(c[1])+"\nuserName="+decodeURIComponent(c[1])+"\nprojectAreaName="+decodeURIComponent(c[1])+" | "+decodeURIComponent(c[2]):this.baseURL}else this.RepoURLTriggerTemplate=x,this.promptValue=
this.repoURL}function D(b){this._parentDomNode=z.node(b.parent);this._parentDomNode.classList.add("browserParentDome");b.fileClient?this._fileClient=b.fileClient:b.serviceRegistry?this._fileClient=new c.FileClient(b.serviceRegistry):b.init||(this._fileClient=new n.FileClient);this.repoURL=b.repoURL;this.baseURL=b.baseURL;this.codeURL=b.codeURL;this._syntaxHighlighter=b.syntaxHighlighter;this._syntaxHighlighter||(this._syntaxHighlighter=new h.SyntaxHighlighter);this._contentTypeService=b.contentTypeService;
...
[];var e=[];this._entries.forEach(function(b){b&&e.push(b.reference)});return e},registerService:function(d,e,c){if("undefined"===typeof e||null===e)throw Error("invalid service");"string"===typeof d?d=[d]:Array.isArray(d)||(d=[]);var a=this._entries.length,f=new p(a,d,c),m=this._namedReferences;d.forEach(function(a){m[a]=m[a]||[];m[a].push(f)});d=new l(e,this._internalRegistry.isRegistered.bind(null,a));this._entries.push({reference:f,service:d});d=this._internalRegistry;this._serviceEventTarget.dispatchEvent(new g("registered",
...
method:"progress",params:Array.prototype.slice.call(arguments)})})):(e.result=f,k(e)))}catch(h){e&&(e.error=g(h),k(e))}}function x(a){try{if(a.method){var b=a.method,d=a.params||[];if("serviceId"in a){var e=Y[a.serviceId];e||s(a.id,"service not found");b in e?y(a.id,e,e[b],d):s(a.id,"method not found")}else if("objectId"in a){var f=T[a.objectId];f||s(a.id,"object not found");b in f?y(a.id,f,f[b],d):s(a.id,"method not found")}else if("requestId"in a){var g=N[a.requestId];g&&("cancel"===b&&g.cancel)&&
g.cancel.apply(g,d)}else if("responseId"in a){var h=S[a.responseId];h&&("progress"===b&&h.progress)&&h.progress.apply(h,d)}else if("plugin"===a.method){var k=a.params[0];U({headers:k.headers,services:k.services}).then(function(){F&&F.resolve(q)})}else if("timeout"===a.method)F&&F.reject(a.error);else throw Error("Bad method: "+a.method);}else{var l=S[String(a.id)];delete S[String(a.id)];if(a.error){var m=c.handleServiceError(q,a.error);l.reject(m)}else l.resolve(a.result)}}catch(p){console.log("Plugin._messageHandler "+
p)}}function w(b){var c=JSON.parse(JSON.stringify(b.properties));c.__plugin__=a;b=b.names||b.type||[];Array.isArray(b)||(b=[b]);c.objectClass=b;return c}function v(a){var b={};if(a.methods&&(a.methods.forEach(function(c){b[c]=function(){var b={serviceId:a.serviceId,method:c,params:Array.prototype.slice.call(arguments)};return"active"===B?l(b):q.start({"transient":!0}).then(function(){return l(b)})}}),b.addEventListener&&b.removeEventListener)){var e=new m,f=Q++;T[f]={handleEvent:e.dispatchEvent.bind(e)};
var g=new d(f,["handleEvent"]),h=b.addEventListener;b.addEventListener=function(a,b){e._namedListeners[a]||h(a,g);e.addEventListener(a,b)};var k=b.removeEventListener;b.removeEventListener=function(a,b){e.removeEventListener(a,b);e._namedListeners[a]||k(a,g)}}f=w(a);f=c.registerService(a.names||a.type,b,f);E[a.serviceId]={registration:f,proxy:b}}function z(){c.persist(a,{created:t,headers:A,services:D,autostart:C,lastModified:I})}var q=this,b=b||{},t=b.created||(new Date).getTime(),A=b.headers||{},
D=b.services||[],C=b.autostart,I=b.lastModified||0,B="installed",K,F,J,R,E={},O=0,Q=0,N={},S={},T={},Y={},U;this._persist=z;this._resolve=function(){B="resolved";c.dispatchEvent(new e("resolved",q))};this._getAutostart=function(){return C};this._getCreated=function(){return t};this.getLocation=function(){return a};this.getHeaders=function(){return JSON.parse(JSON.stringify(A))};this.getName=function(){var a=this.getHeaders();return a?a.name||"":null};this.getVersion=function(){var a=this.getHeaders();
return a?a.version||"0.0.0":null};this.getLastModified=function(){return I};this.getServiceReferences=function(){var a=[];Object.keys(E).forEach(function(b){a.push(E[b].registration.getReference())});return a};this.setParent=function(a){return R!==a?(R=a,q.stop({"transient":!0}).then(function(){if("started"===C)return q.start({"transient":!0});if("lazy"===C)return q.start({lazy:!0,"transient":!0})})):(new f).resolve()};this.getState=function(){return B};this.start=function(b){if("uninstalled"===B)return(new f).reject(Error("Plugin is uninstalled"));
if(K)return K.promise.then(this.start.bind(this,b));if("active"===B)return(new f).resolve();if(!b||!b.transient){var d=b&&b.lazy?"lazy":"started";d!==C&&(C=d,z())}d=c.getState();if("starting"!==d&&"active"!==d)return b.transient?(new f).reject(Error("start transient error")):(new f).resolve();if("installed"===B)try{this._resolve()}catch(g){return(new f).reject(g)}"resolved"===B&&D.forEach(function(a){v(a)});if(b&&b.lazy)return"starting"!==B&&(B="starting",c.dispatchEvent(new e("lazy activation",q))),
(new f).resolve();var h=new f;K=h;B="starting";c.dispatchEvent(new e("starting",q));F=new f;J=c.connect(a,x,R);F.then(function(){F=null;B="active";c.dispatchEvent(new e("started",q));K=null;h.resolve()},function(){F=null;B="stopping";c.dispatchEvent(new e("stopping",q));Object.keys(E).forEach(function(a){E[a].registration.unregister();delete E[a]});c.disconnect(J);J=null;B="resolved";K=null;c.dispatchEvent(new e("stopped",q));h.reject(Error("plugin activation error"))});return h.promise};this.stop=
function(a){if("uninstalled"===B)return(new f).reject(Error("Plugin is uninstalled"));if(K)return K.promise.then(this.stop.bind(this,a));if((!a||!a.transient)&&"stopped"!==C)C="stopped",z();if("active"!==B&&"starting"!==B)return(new f).resolve();K=a=new f;B="stopping";c.dispatchEvent(new e("stopping",q));Object.keys(E).forEach(function(a){E[a].registration.unregister();delete E[a]});J&&(c.disconnect(J),J=null);B="resolved";K=null;c.dispatchEvent(new e("stopped",q));a.resolve();return a.promise};U=
function(b){if("uninstalled"===B)return(new f).reject(Error("Plugin is uninstalled"));if(!b)return 0===I&&(I=(new Date).getTime(),z()),c.loadManifest(a).then(U);var d=A,g=D,h=C;A=b.headers||{};D=b.services||{};C=b.autostart||C;b.lastModified?I=b.lastModified:(I=(new Date).getTime(),z());if(p(A,d)&&p(D,g)&&C===h)return(new f).resolve();if("active"===B||"starting"===B){var k=[];Object.keys(D).forEach(function(a){var b=D[a];k.push(a);var c=E[a];if(c){if(p(b.methods,Object.keys(c.proxy))){var a=w(b),
d=c.registration.getReference(),e={};d.getPropertyKeys().forEach(function(a){e[a]=d.getProperty(a)});p(a,e)||c.registration.setProperties(a);return}c.registration.unregister();delete E[a]}v(b)});Object.keys(E).forEach(function(a){-1===k.indexOf(a)&&(E[a].registration.unregister(),delete E[a])})}"active"===B&&(c.disconnect(J),F=new f,J=c.connect(a,x,R),F.then(function(){F=null},function(){F=null;B="stopping";c.dispatchEvent(new e("stopping"),q);Object.keys(E).forEach(function(a){E[a].registration.unregister();
delete E[a]});c.disconnect(J);J=null;B="resolved";c.dispatchEvent(new e("stopped",q))}));return(new f).resolve()};this.update=function(a){return U(a).then(function(){c.dispatchEvent(new e("updated",q))})};this.uninstall=function(){if("uninstalled"===B)return(new f).reject(Error("Plugin is uninstalled"));if("active"===B||"starting"===B||"stopping"===B)return this.stop().then(this.uninstall.bind(this),this.uninstall.bind(this));c.removePlugin(this);B="uninstalled";c.dispatchEvent(new e("uninstalled",
q));return(new f).resolve()}}var c=/^http[s]?/i;return{Plugin:k,PluginRegistry:function(a,d){function g(a){var b=a.source;z.some(function(c){if(b===c.target){try{var d;if("undefined"===typeof c.useStructuredClone){var e="string"!==typeof a.data;d=e?a.data:JSON.parse(a.data);c.useStructuredClone=e}else d=c.useStructuredClone?a.data:JSON.parse(a.data);c.handler(d)}catch(f){}return!0}})}var d=d||{},l=d.storage||localStorage;if(!l.getItem){var p=l,s=null,y={key:function(a){return(s=s||Object.keys(p))[a]},
getItem:function(a){return p[a]},setItem:function(a,b){p[a]=b;s=null},removeItem:function(a){delete p[a];s=null},clear:function(){(s=s||Object.keys(p)).forEach(function(a){delete p[a]}.bind(this));s=null}};Object.defineProperty(y,"length",{get:function(){return(s=s||Object.keys(p)).length}});l=y}var x="installed",w,v=[],z=[],q=new m,t={},A={registerService:a.registerService.bind(a),connect:function(a,b,c,d){function e(a){a=Error(a);a.name="timeout";b({method:"timeout",error:a})}var f={handler:b,url:a},
...
"active"})};this.stop=function(){if("starting"!==x&&"active"!==x)return(new f).reject("Cannot stop registry. Registry is already "+x+".");x="stopping";var a=[];v.forEach(function(b){a.push(b.stop({"transient":!0}))});return f.all(a,function(a){console.log("PluginRegistry.stop "+a)}).then(function(){if(!d.parent){var a=w.parentNode;a&&a.removeChild(w)}w=null;removeEventListener("message",g);x="resolved"})};this.update=function(){this.stop().then(this.start.bind(this))};this.uninstall=function(){return(new f).reject("Cannot uninstall registry")};
this.installPlugin=function(a,c){var a=b(a),d=this.getPlugin(a);if(d)return(new f).resolve(d);if(t[a])return t[a];if(c)return d=new k(a,c,A),v.push(d),d._persist(),A.dispatchEvent(new e("installed",d)),(new f).resolve(d);var g=A.loadManifest(a).then(function(b){d=new k(a,b,A);v.push(d);d._persist();delete t[a];A.dispatchEvent(new e("installed",d));return d},function(b){delete t[a];throw b;});return t[a]=g};this.getPlugins=function(){return v.slice()};this.getPlugin=function(a){var c=null,a=b(a);v.some(function(b){if(a===
...
define("browse/builder/browse",["orion/widgets/browse/fileBrowser","orion/serviceregistry","orion/pluginregistry","orion/URL-shim"],function(f,m,p){function b(b){"string"===typeof b?(b={parentId:arguments[0],repo:arguments[1]},2<arguments.length&&(b.base=arguments[2]),3<arguments.length&&(b.codeURL=arguments[3])):b=b||{};var g,e=new URL(b.repo||window.location.href),d=e.href,k=b.base,c=1;if(!b.rootName&&(g=d.match(/\/([^/]+)\/([^/]+)$/)))b.rootName=decodeURIComponent(g[1])+" | "+decodeURIComponent(g[2]),
b.rootName.match(/\.git$/)&&(b.rootName=b.rootName.substring(0,b.rootName.length-4));if("github.com"===e.host)g=new URL("../../plugins/GitHubFilePlugin.html?repo="+e.href,_browser_script_source);else if(0===e.pathname.indexOf("/git/"))g=new URL("/gerrit/plugins/gerritfs/static/plugins/GerritFilePlugin.html",e),g.query.set("project",e.pathname.substring(5));else if(0===e.pathname.indexOf("/ccm"))k||(k=e.pathname.match(/^\/ccm[^/]*/),k=(new URL(k,d)).href),g=new URL(k+"/service/com.ibm.team.filesystem.service.jazzhub.IOrionFilesystem/sr/pluginOrionWs.html?"+
d),c=2;else if(0===e.pathname.indexOf("/project/"))k||(k=(new URL("/ccm01",d)).href),g=new URL(k+"/service/com.ibm.team.filesystem.service.jazzhub.IOrionFilesystem/sr/pluginOrionWs.html?"+d),c=2;else throw"Bad Repo URL - "+d;var a=new m.ServiceRegistry,e={};e[g.href]={autostart:"started",lastModified:-1};this._fileBrowser=new f.FileBrowser({parent:b.parentId,repoURL:d,baseURL:2===c?k:null,codeURL:b.codeURL,selectorNumber:c,rootName:b.rootName,maxEditorLines:300,init:!0});(new p.PluginRegistry(a,{storage:{},

...
(function(g){function n(b,c){var d,l,q,v,A,m,h,a,e,k=c&&c.split("/"),t=r.map,s=t&&t["*"]||{};if(b&&"."===b.charAt(0))if(c){k=k.slice(0,k.length-1);b=k.concat(b.split("/"));for(a=0;a<b.length;a+=1)if(d=b[a],"."===d)b.splice(a,1),a-=1;else if(".."===d)if(1===a&&(".."===b[2]||".."===b[0]))break;else 0<a&&(b.splice(a-1,2),a-=2);b=b.join("/")}else 0===b.indexOf("./")&&(b=b.substring(2));if((k||s)&&t){d=b.split("/");for(a=d.length;0<a;a-=1){l=d.slice(0,a).join("/");if(k)for(e=k.length;0<e;e-=1)if(q=t[k.slice(0,
e).join("/")])if(q=q[l]){v=q;A=a;break}if(v)break;!m&&(s&&s[l])&&(m=s[l],h=a)}!v&&m&&(v=m,A=h);v&&(d.splice(0,A,v),b=d.join("/"))}return b}function p(b,c){return function(){return h.apply(g,t.call(arguments,0).concat([b,c]))}}function a(b){return function(c){return n(c,b)}}function k(b){return function(c){l[b]=c}}function f(b){if(x.call(m,b)){var c=m[b];delete m[b];s[b]=!0;d.apply(g,c)}if(!x.call(l,b)&&!x.call(s,b))throw Error("No "+b);return l[b]}function e(b){var c,d=b?b.indexOf("!"):-1;-1<d&&(c=
b.substring(0,d),b=b.substring(d+1,b.length));return[c,b]}var d,h,c,b,l={},m={},r={},s={},x=Object.prototype.hasOwnProperty,t=[].slice;c=function(b,c){var d,l=e(b),q=l[0],b=l[1];q&&(q=n(q,c),d=f(q));q?b=d&&d.normalize?d.normalize(b,a(c)):n(b,c):(b=n(b,c),l=e(b),q=l[0],b=l[1],q&&(d=f(q)));return{f:q?q+"!"+b:b,n:b,pr:q,p:d}};b={require:function(b){return p(b)},exports:function(b){var c=l[b];return"undefined"!==typeof c?c:l[b]={}},module:function(b){return{id:b,uri:"",exports:l[b],config:function(){return r&&
r.config&&r.config[b]||{}}}}};d=function(d,r,a,h){var q,v,A,C,D=[],e,h=h||d;if("function"===typeof a){r=!r.length&&a.length?["require","exports","module"]:r;for(C=0;C<r.length;C+=1)if(A=c(r[C],h),v=A.f,"require"===v)D[C]=b.require(d);else if("exports"===v)D[C]=b.exports(d),e=!0;else if("module"===v)q=D[C]=b.module(d);else if(x.call(l,v)||x.call(m,v)||x.call(s,v))D[C]=f(v);else if(A.p)A.p.load(A.n,p(h,!0),k(v),{}),D[C]=l[v];else throw Error(d+" missing "+v);r=a.apply(l[d],D);if(d)if(q&&q.exports!==
g&&q.exports!==l[d])l[d]=q.exports;else if(r!==g||!e)l[d]=r}else d&&(l[d]=a)};requirejs=require=h=function(l,m,a,e,q){if("string"===typeof l)return b[l]?b[l](m):f(c(l,m).f);l.splice||(r=l,m.splice?(l=m,m=a,a=null):l=g);m=m||function(){};"function"===typeof a&&(a=e,e=q);e?d(g,l,m,a):setTimeout(function(){d(g,l,m,a)},4);return h};h.config=function(b){r=b;return h};define=function(b,c,d){c.splice||(d=c,c=[]);!x.call(l,b)&&!x.call(m,b)&&(m[b]=[b,c,d])};define.amd={jQuery:!0}})();define("almond",function(){});
define("orion/PageUtil",[],function(){var g=/^http[s]?/i;return{hash:function(){var g=window.location.href.split("#")[1];return g?"#"+g:""},matchResourceParameters:function(g){var g=g||window.location.toString(),p={resource:""},a=g.indexOf("#");if(-1!==a&&(g=g.substring(a+1),0!==g.length)){g=g.split(",");p.resource=decodeURIComponent(g[0]);for(a=1;a<g.length;a++){var k=/([^=]*)(=?)(.*)/.exec(g[a]),f=decodeURIComponent(k[1]||""),k=decodeURIComponent(k[3]||"");""!==f&&"resource"!==f&&(p[f]=k)}}return p},
validateURLScheme:function(n,p){var a=n;if(-1===n.indexOf("://")){var k=document.createElement("a");k.href=n;a=k.href}k=!1;if(k=p?p.some(function(k){return RegExp("^"+k+":","i").test(a)}):g.test(a))return n;console.log("Illegal URL Scheme: '"+n+"'");return""}}});
(function(){function g(p,a,k){for(var f in a)a.hasOwnProperty(f)&&(!p.hasOwnProperty(f)||k)?p[f]=a[f]:"object"===typeof a[f]&&g(p[f],a[f],k)}var n=/(^.*(^|\/)nls(\/|$))([^\/]*)\/?([^\/]*)/;define("i18n",["module"],function(p){var a=p.config?p.config():{};return{version:"2.0.1+",load:function(k,f,e,d){d=d||{};d.locale&&(a.locale=d.locale);var h=n.exec(k),c=h[1],b=h[4],l=h[5],m=b.split("-"),r=[],s={},x,t="";h[5]?(c=h[1],k=c+l):(l=h[4],b=a.locale,b||(b=a.locale="undefined"===typeof navigator?"root":
(navigator.language||navigator.userLanguage||"root").toLowerCase()),m=b.split("-"));if(d.isBuild){r.push(k);d=c+"root/"+l;require._fileExists(f.toUrl(d+".js"))&&r.push(d);for(x=0;x<m.length;x++)d=m[x],t+=(t?"-":"")+d,d=r,h=c+t+"/"+l,require._fileExists(f.toUrl(h+".js"))&&d.push(h);f(r,function(){e()})}else f([k],function(b){var d=[],a;a=c;var h=l;b.root&&(d.push("root"),(!0===b.root||1===b.root)&&r.push(a+"root/"+h));for(x=0;x<m.length;x++){a=m[x];a=t+=(t?"-":"")+a;var h=b,q=r,v=c,A=l;h[a]&&(d.push(a),
(!0===h[a]||1===h[a])&&q.push(v+a+"/"+A))}f(r,function(){var q,v,A;for(q=d.length-1;-1<q&&d[q];q--){A=d[q];v=b[A];if(!0===v||1===v)v=f(c+A+"/"+l);g(s,v)}e(s)})})}}})})();define("orion/i18n",{load:function(g,n,p){n.specified&&n.specified("orion/bootstrap")?n(["orion/i18n!"+g],function(a){p(a)}):p({})}});
...
disconnected:"(disconnected)",ChooseFS:"Choose Filesystem",ChooseFSTooltip:"Choose the filesystem you want to view.",FSTitle:"${0} (${1})",Deploy:"Deploy",Import:"Import",Export:"Export",OpenWith:"Open With",Extensions:"Extensions",UnnamedCommand:"Unnamed"});define("orion/edit/nls/messages",["orion/i18n!orion/edit/nls/messages","orion/edit/nls/root/messages"],function(g,n){var p={root:n};Object.keys(g).forEach(function(a){"undefined"===typeof p[a]&&(p[a]=g[a])});return p});
(function(g,n){"function"===typeof define&&define.amd?define("orion/Deferred",n):"object"===typeof exports?module.exports=n():(g.orion=g.orion||{},g.orion.Deferred=n())})(this,function(){function g(){for(var a;a=k.shift();)a();f=!1}function n(a){k.push(a);f||(f=!0,setTimeout(g,0))}function p(a){return function(){a.apply(void 0,arguments)}}function a(){function e(){for(var c;c=m.shift();){var d=c.deferred,r="fulfilled"===l?"resolve":"reject";if("function"===typeof c[r])try{var a=(0,c[r])(b),h=a&&("object"===
typeof a||"function"===typeof a)&&a.then;if("function"===typeof h)if(a===d.promise)d.reject(new TypeError);else{var e=a.cancel;"function"===typeof e?d._protected(k).parentCancel=e.bind(a):delete d._protected(k).parentCancel;h.call(a,p(d.resolve),p(d.reject),p(d.progress))}else d.resolve(a)}catch(q){d.reject(q)}else d[r](b)}}function d(c){delete s.parentCancel;l="rejected";b=c;m.length&&n(e)}function h(c){function k(q){return function(b){f||(f=!0,q(b))}}var f=!1;delete s.parentCancel;try{var g=c&&
("object"===typeof c||"function"===typeof c)&&c.then;if("function"===typeof g)if(c===r)d(new TypeError);else{l="assumed";var u=c&&c.cancel;if("function"!==typeof u){var z=new a,c=z.promise;try{g(z.resolve,z.reject,z.progress)}catch(q){z.reject(q)}u=c.cancel;g=c.then}b=c;g.call(c,k(h),k(d));s.parentCancel=u.bind(c)}else l="fulfilled",b=c,m.length&&n(e)}catch(v){k(d)(v)}}function c(){var b=s.parentCancel;b?(delete s.parentCancel,b()):l||(b=Error("Cancel"),b.name="Cancel",d(b))}var b,l,m=[],r=this,s=
{};Object.defineProperty(this,"_protected",{value:function(b){if(b!==k)throw Error("protected");return s}});this.resolve=function(b){l||h(b);return r};this.reject=function(b){l||d(b);return r};this.progress=function(b){l||m.forEach(function(c){if(c.progress)try{c.progress(b)}catch(d){}});return r.promise};this.cancel=function(){s.parentCancel?setTimeout(c,0):c();return r};this.then=function(b,c,d){b={resolve:b,reject:c,progress:d,deferred:new a};m.push(b);b.deferred._protected(k).parentCancel=r.promise.cancel.bind(r);
("fulfilled"===l||"rejected"===l)&&n(e);return b.deferred.promise};this.promise={then:r.then,cancel:r.cancel}}var k=[],f=!1;a.all=function(e,d){function h(c,d){m||(l[c]=d,0===--b&&r.resolve(l))}function c(b,c){if(!m){if(d)try{h(b,d(c));return}catch(l){c=l}r.reject(c)}}var b=e.length,l=[],m=!1,r=new a;r.then(void 0,function(){m=!0;e.forEach(function(b){b.cancel&&b.cancel()})});0===b?r.resolve(l):e.forEach(function(b,d){b.then(h.bind(void 0,d),c.bind(void 0,d))});return r.promise};a.when=function(e,
d,h,c){var b;e&&"function"===typeof e.then||(b=new a,b.resolve(e),e=b.promise);return e.then(d,h,c)};return a});
define("orion/i18nUtil",["require","orion/Deferred"],function(g,n){var p={};return{getMessageBundle:function(a){function k(){g(["i18n!"+a],function(c){if(c){var b=a;c._expires=(new Date).getTime()+9E5;localStorage.setItem("orion/messageBundle/"+b,JSON.stringify(c));delete c._expires}e.resolve(c)})}function f(c){e.reject(c)}if(p[a])return p[a];var e=new n;p[a]=e;var d;a:{if(d=localStorage.getItem("orion/messageBundle/"+a))if(d=JSON.parse(d),d._expires&&d._expires>(new Date).getTime()){delete d._expires;
break a}d=null}if(d)return e.resolve(d),e;try{g([a],k,f)}catch(h){g(["orion/i18n!"+a],k,f)}return e},formatMessage:function(a){var k=arguments;return a.replace(/\$\{([^\}]+)\}/g,function(a,e){return k[(e<<0)+1]})}}});
define("orion/EventTarget",[],function(){function g(){this._namedListeners={}}g.prototype={dispatchEvent:function(g){if(!g.type)throw Error("unspecified type");var p=this._namedListeners[g.type];p&&p.forEach(function(a){try{"function"===typeof a?a(g):a.handleEvent(g)}catch(k){"undefined"!==typeof console&&console.log(k)}});return!g.defaultPrevented},addEventListener:function(g,p){if("function"===typeof p||p.handleEvent)this._namedListeners[g]=this._namedListeners[g]||[],this._namedListeners[g].push(p)},
removeEventListener:function(g,p){var a=this._namedListeners[g];if(a)for(var k=0;k<a.length;k++)if(a[k]===p){1===a.length?delete this._namedListeners[g]:a.splice(k,1);break}}};g.prototype.constructor=g;g.attach=function(n){var p=new g;n.dispatchEvent=p.dispatchEvent.bind(p);n.addEventListener=p.addEventListener.bind(p);n.removeEventListener=p.removeEventListener.bind(p)};return g});
define("orion/objects",[],function(){function g(g){for(var p=1;p<arguments.length;p++){var a=arguments[p],k;for(k in a)Object.prototype.hasOwnProperty.call(a,k)&&(g[k]=a[k])}return g}return{clone:function(n){if(Array.isArray(n))return Array.prototype.slice.call(n);var p=Object.create(Object.getPrototypeOf(n));g(p,n);return p},mixin:g,toArray:function(g){return Array.isArray(g)?g:[g]}}});
define("orion/inputManager","i18n!orion/edit/nls/messages orion/i18nUtil orion/Deferred orion/EventTarget orion/objects orion/PageUtil".split(" "),function(g,n,p,a,k,f){function e(c){this._document=c.document||document;this._timeout=c.timeout;for(var c="keypress keydown keyup mousemove mousedown mousemove".split(" "),b=function(){this._resetTimer()}.bind(this),d=0;d<c.length;d++)this._document.addEventListener(c[d],b,!0);a.attach(this)}function d(c,b){if(c){if(0===b.status)b={Severity:"Error",Message:g.noResponse};
...
this._timer&&(c.clearTimeout(this._timer),this._timer=null);-1!==this._timeout&&(this._timer=c.setTimeout(function(){this.onIdle({type:"Idle"});this._timer=null;this._resetTimer()}.bind(this),this._timeout))},onIdle:function(c){return this.dispatchEvent(c)},setTimeout:function(c){this._timeout=c;this._resetTimer()}};k.mixin(h.prototype,{_maybeLoadWorkspace:function(c){var b=this.fileClient;return c===b.fileServiceRootURL(c)?b.loadWorkspace(c).then(function(b){return b.Location}):(new p).resolve(c)},
_read:function(c){var b=this.fileClient,d=Array.prototype.slice.call(arguments,1);return this._maybeLoadWorkspace(c).then(function(c){return b.read.apply(b,[c].concat(d))})},load:function(){var c=this.getInput();if(c){var b=this.fileClient,l=this._parsedLocation.resource,m=this.progressService,r=function(q,b,c){return!m?q:m.progress(q,n.formatMessage(b,c))},a=this.getEditor();if(this._fileMetadata)!this._saving&&(!this._fileMetadata.Directory&&!this._readonly)&&r(b.read(l,!0),g.ReadingMetadata,c).then(function(q){this._fileMetadata&&
(this._fileMetadata.Location===q.Location&&this._fileMetadata.ETag!==q.ETag)&&(this._fileMetadata=q,(!a.isDirty()||window.confirm(g.loadOutOfSync))&&r(b.read(l),g.Reading,c).then(function(q){a.setInput(c,null,q);this._unsavedChanges=[]}.bind(this)))}.bind(this));else{var h=l;if(0===h.indexOf("/gitapi/commit/")){var e=h.indexOf("/file"),k=h.indexOf("?",e);-1===k&&(k=h.length);h=h.substring(e,k);this._readonly=!0}var f=window.setTimeout(function(){f=null;this.reportStatus(n.formatMessage(g.Fetching,
c))}.bind(this),800),u=function(){this.reportStatus("");f&&window.clearTimeout(f)}.bind(this),z=function(q){u();var b=null;this.serviceRegistry&&(b=this.serviceRegistry.getService("orion.page.message"));d(b,q);this._setNoInput()}.bind(this);this._acceptPatch=null;r(this._read(h,!0),g.ReadingMetadata,h).then(function(q){q.Directory?r(b.fetchChildren(q.ChildrenLocation),g.Reading,c).then(function(b){u();q.Children=b;this._setInputContents(this._parsedLocation,c,b,q)}.bind(this),z):this._isText(q)?r(b.read(l,
!1,!0),g.Reading,c).then(function(b){u();"string"!==typeof b&&(this._acceptPatch=b.acceptPatch,b=b.result);this._setInputContents(this._parsedLocation,c,b,q)}.bind(this),z):r(b._getService(l).readBlob(l),g.Reading,c).then(function(b){u();this._setInputContents(this._parsedLocation,c,b,q)}.bind(this),z)}.bind(this),z)}}},processParameters:function(c){var b=this.getEditor();b&&b.processParameters&&b.processParameters(c)},getEditor:function(){return this.editor},getInput:function(){return this._input},
...
0===c.addedCharCount?a=-1:0===d&&(a=1);if(0<b&&a===this.previousChangeType){b=this._unsavedChanges[b-1];if(0===d&&m===b.end+b.text.length){b.text+=c.text;return}if(0===c.addedCharCount&&r===b.start){b.start=m;return}}this.previousChangeType=a;this._unsavedChanges.push({start:m,end:r,text:c.text})}},reportStatus:function(c){this.statusReporter?this.statusReporter(c):this.editor&&this.editor.reportStatus(c)},save:function(){function c(b){r===v.getInput()&&(v.getFileMetadata().ETag=b.ETag,l.setInput(r,
null,h,!0));v.reportStatus("");a&&q&&q.setProgressResult({Message:g.Saved,Severity:"Normal"});v.afterSave&&v.afterSave();v._saving=!1}function b(b){v.reportStatus("");d(q,b);v._saving=!1;v._errorSaving=!0}if(!this._saving){var l=this.getEditor();if(l&&l.isDirty()&&!this.getReadOnly()){var a=this._errorSaving;this._saving=!0;var r=this.getInput();this.reportStatus(g["Saving..."]);this.dispatchEvent({type:"Saving",inputManager:this});l.markClean();var h=l.getText(),e=h;if(this._getSaveDiffsEnabled()&&
!this._errorSaving){for(var k=this._unsavedChanges,f=0,p=0;p<k.length;p++)f+=k[p].text.length;h.length>f&&(e={diff:k})}this._unsavedChanges=[];this._errorSaving=!1;var k={ETag:this.getFileMetadata().ETag},u=this._parsedLocation.resource,e=this.fileClient.write(u,e,k),z=this.progressService,q=null;this.serviceRegistry&&(q=this.serviceRegistry.getService("orion.page.message"));z&&(e=z.progress(e,n.formatMessage(g.savingFile,r)));var v=this;e.then(c,function(q){412===q.status?window.confirm(g.saveOutOfSync)?
(q=v.fileClient.write(u,h),z&&(q=z.progress(q,n.formatMessage(g.savingFile,r))),q.then(c,b)):v._saving=!1:b(q)})}}},setAutoLoadEnabled:function(c){this._autoLoadEnabled=c},setAutoSaveTimeout:function(c){this._autoSaveEnabled=-1!==c;this._idle?this._idle.setTimeout(c):(this._idle=new e({document:document,timeout:c}),this._idle.addEventListener("Idle",function(){this._errorSaving||this.save()}.bind(this)))},setContentType:function(c){this._contentType=c},setInput:function(c){if(!this._ignoreInput&&
(c||(c=f.hash()),"string"===typeof c)){var b=this.getEditor();c&&"#"!==c[0]&&(c="#"+c);var d=f.matchResourceParameters(c),a=this._parsedLocation||{};if(b&&b.isDirty()){var r=this._location;if(a.resource!==d.resource)if(this._autoSaveEnabled)this.save();else if(!window.confirm(g.confirmUnsavedChanges)){window.location.hash=r;return}}b=b&&a.editor!==d.editor;this._location=c;this._parsedLocation=d;this._ignoreInput=!0;this.selection&&this.selection.setSelections(c);this._ignoreInput=!1;(c=d.resource)?
...
b,d,a,r){var h,e=!1;a?(this._fileMetadata=a,this.setTitle(a.Location||String(a)),this.setContentType(this.contentTypeRegistry.getFileContentType(a)),h=a.Name,e=a.Directory):(this._fileMetadata=null,this.setTitle(b),this.setContentType(this.contentTypeRegistry.getFilenameContentType(this.getTitle())),h=this.getTitle());var k=this.getEditor();this._focusListener&&(k&&(k.getTextView&&k.getTextView())&&k.getTextView().removeEventListener("Focus",this._focusListener),this._focusListener=null);this._changingListener&&
(k&&(k.getModel&&k.getModel())&&k.getModel().removeEventListener("Changing",this._changingListener),this._changingListener=null);a={type:"InputChanged",input:c,name:h,title:b,contentType:this.getContentType(),metadata:a,location:window.location,contents:d};this.dispatchEvent(a);this.editor=k=a.editor;e||(k&&(k.getTextView&&k.getTextView())&&k.getTextView().addEventListener("Focus",this._focusListener=this.onFocus.bind(this)),k&&(k.getModel&&k.getModel())&&k.getModel().addEventListener("Changing",
this._changingListener=this.onChanging.bind(this)),r||k.setInput(b,null,d),this._unsavedChanges=[],this.processParameters(c))}});return{InputManager:h}});
define("orion/util",[],function(){var g=navigator.userAgent,n=-1!==g.indexOf("MSIE")||-1!==g.indexOf("Trident")?document.documentMode:void 0,p=parseFloat(g.split("Firefox/")[1]||g.split("Minefield/")[1])||void 0,a=-1!==g.indexOf("Opera")?parseFloat(g.split("Version/")[1]):void 0,k=parseFloat(g.split("Chrome/")[1])||void 0,f=-1!==g.indexOf("Safari")&&!k,e=parseFloat(g.split("WebKit/")[1])||void 0,d=-1!==g.indexOf("Android"),h=-1!==g.indexOf("iPad"),g=-1!==g.indexOf("iPhone"),c=h||g,b=-1!==navigator.platform.indexOf("Mac"),
l=-1!==navigator.platform.indexOf("Win"),m=-1!==navigator.platform.indexOf("Linux");return{formatMessage:function(b){var c=arguments;return b.replace(/\$\{([^\}]+)\}/g,function(b,d){return c[(d<<0)+1]})},createElement:function(b,c){return b.createElementNS?b.createElementNS("http://www.w3.org/1999/xhtml",c):b.createElement(c)},isIE:n,isFirefox:p,isOpera:a,isChrome:k,isSafari:f,isWebkit:e,isAndroid:d,isIPad:h,isIPhone:g,isIOS:c,isMac:b,isWindows:l,isLinux:m,platformDelimiter:l?"\r\n":"\n"}});
define("orion/webui/littlelib",["orion/util"],function(g){function n(d,a){a||(a=document);return a.querySelectorAll(d)}function p(d){if(0<=d.tabIndex)return d;if(d.hasChildNodes())for(var a=0;a<d.childNodes.length;a++){var c=p(d.childNodes[a]);if(c)return c}return null}function a(d){if(0<=d.tabIndex)return d;if(d.hasChildNodes())for(var h=d.childNodes.length-1;0<=h;h--){var c=a(d.childNodes[h]);if(c)return c}return null}function k(d,a){if(3===d.nodeType){var c=f.exec(d.nodeValue);c&&1<c.length&&a(d,
c)}if(d.hasChildNodes())for(c=0;c<d.childNodes.length;c++)k(d.childNodes[c],a)}var f=/\$\{([^\}]+)\}/,e=null;return{$:function(d,a){a||(a=document);return a.querySelector(d)},$$:n,$$array:function(d,a){return Array.prototype.slice.call(n(d,a))},node:function(d){var a=d;"string"===typeof d&&(a=document.getElementById(d));return a},contains:function(d,a){if(!d||!a)return!1;if(d===a)return!0;var c=d.compareDocumentPosition(a);return Boolean(c&16)},bounds:function(d){d=d.getBoundingClientRect();return{left:d.left+
document.documentElement.scrollLeft,top:d.top+document.documentElement.scrollTop,width:d.width,height:d.height}},empty:function(d){for(;d.hasChildNodes();)d.removeChild(d.firstChild)},firstTabbable:p,lastTabbable:a,stop:function(d){window.document.all&&(d.keyCode=0);d.preventDefault&&(d.preventDefault(),d.stopPropagation())},processTextNodes:function(d,a){k(d,function(c,b){c.parentNode.replaceChild(document.createTextNode(a[b[1]]||b[1]),c)})},processDOMNodes:function(d,a){k(d,function(c,b){var d=
...
define("orion/breadcrumbs",["require","orion/webui/littlelib"],function(g,n){function p(a){this._init(a)}p.prototype={_init:function(a){var k=n.node(a.container);if(!k)throw"no parent container";this._container=k;k.classList.remove("currentLocation");this._id=a.id||"eclipse.breadcrumbs";this._resource=a.resource||null;this._rootSegmentName=a.rootSegmentName;this._workspaceRootSegmentName=a.workspaceRootSegmentName;this._workspaceRootURL=a.workspaceRootURL;this._makeHref=a.makeHref;this._makeFinalHref=
a.makeFinalHref;this._maxLength=a.maxLength;this.path="";this.measure();this.render()},getNavigatorWorkspaceRootSegment:function(){if(this._workspaceRootSegmentName){var a;if(this._resource&&this._resource.Parents&&!this._resource.skip){a=document.createElement("a");var k=this._workspaceRootURL?this._workspaceRootURL:"";this._makeHref?this._makeHref(a,k):a.href=g.toUrl("edit/edit.html")+"#"+k}else a=document.createElement("span");n.empty(a);a.appendChild(document.createTextNode(this._workspaceRootSegmentName));
return a}return null},MAX_LENGTH:500,INCLUDE_FIRST_SECTION:!0,segments:[],buildSegment:function(a){var k=document.createElement("a");k.classList.add("breadcrumb");k.appendChild(document.createTextNode(a));return k},addSegmentHref:function(a,k){this._makeHref?this._makeHref(a,k.Location,k):a.href=g.toUrl("edit/edit.html")+"#"+k.ChildrenLocation},buildSegments:function(a,k){if(this._resource.Parents){var f=this._resource.Parents.slice(0),e,d;f&&(f=f.slice(0),"reverse"===k&&(f=f.reverse().slice(0)),
...
this.dirty=document.createElement("span"),this.dirty.id="dirty",this.dirty.className="modifiedFileMarker",this._container.appendChild(this.dirty));this.crumbs.style.width="auto";this.crumbs.style.visibility="visible";this.crumbs.parentNode.className="currentLocation";this.crumbs.parentNode.style.width="auto"},append:function(a){this.crumbs.appendChild(a)},addTitle:function(a,k){var f=k||document.title;0===this.crumbs.childNodes.length&&(a=document.createElement("span"),a.appendChild(document.createTextNode(f)),
a.classList.add("breadcrumb"),a.classList.add("currentLocation"),this.append(a))},finalSegment:function(a,k){if(!this._resource.skip){var f;f=k?k:this._resource.Name;this._makeFinalHref?(a=this.buildSegment(f),this.addSegmentHref(a,this._resource)):(a=document.createElement("span"),a.appendChild(document.createTextNode(f)));a.classList.add("currentLocation");this.path+=this._resource.Name;this.append(a)}},firstSegment:function(a){a&&(this.append(a),this._resource&&this._resource.Parents&&!this._resource.skip?
...
!0:this.INCLUDE_FIRST_SECTION=!1}.bind(this));this.segments=a.reverse()}},measure:function(){var a=this._container;a.style.width="auto";this.MAX_LENGTH=this._maxLength?this._maxLength:a.offsetWidth;this.refresh();this.segments=[];this.crumbs.style.visibility="hidden";var a=this.getNavigatorWorkspaceRootSegment(),k=this._rootSegmentName;k?this.addTitle(a,k):(this.finalSegment(a,k),this._resource&&this._resource.Parents&&(this.buildSegments(k,"reverse"),this.measureSegments(),this.firstSegment(a)),
this.crumbs.offsetWidth>=this.MAX_LENGTH&&(this.INCLUDE_FIRST_SECTION=!1))},render:function(){this.refresh();var a=this.getNavigatorWorkspaceRootSegment(),k=this._rootSegmentName;k?this.addTitle(a,k):(!0===this.INCLUDE_FIRST_SECTION&&this.firstSegment(a),this._resource&&this._resource.Parents&&(this.drawSegments(),this.finalSegment(a,k)));this.crumbs.parentNode.style.width=this.crumbs.offsetWidth+20+"px"}};p.prototype.constructor=p;return{BreadCrumbs:p}});
...
"You cannot copy files directly into the workspace.  Create a folder first.":"You cannot copy files directly into the workspace.  Create a folder first.","Unzip ${0}?":"Unzip ${0}?",NoFile:"Use the ${0} menu to create new files and folders. Click a file to start coding."});define("orion/navigate/nls/messages",["orion/i18n!orion/navigate/nls/messages","orion/navigate/nls/root/messages"],function(g,n){var p={root:n};Object.keys(g).forEach(function(a){"undefined"===typeof p[a]&&(p[a]=g[a])});return p});
define("orion/nls/root/messages",{Navigator:"Navigator",Sites:"Sites",Shell:"Shell","Get Plugins":"Get Plugins",Global:"Global",Editor:"Editor",EditorRelatedLink:"Go To Folder",EditorRelatedLinkTop:"Workspace",EditorRelatedLinkProj:"Go To Project Root","Filter bindings":"Filter bindings","Orion Editor":"Orion Editor","Orion Image Viewer":"Orion Image Viewer","Orion Markdown Viewer":"Orion Markdown Viewer","Orion JSON Editor":"Orion JSON Editor","View on Site":"View on Site","View this file or folder on a web site hosted by Orion":"View this file or folder on a web site hosted by Orion",
"Show a list of all the keybindings on this page":"Show a list of all the keybindings on this page","Show Keys":"Show Keys","Hide or show the page banner and footer":"Hide or show the page banner and footer","Toggle banner and footer":"Toggle banner and footer","Choose a file by name and open an editor on it":"Choose a file by name and open an editor on it","Find File Named...":"Find File Named...","System Configuration Details":"System Configuration Details","System Config Tooltip":"Go to the System Configuration Details page",
"Background Operations":"Background Operations","Background Operations Tooltip":"Go to the Background Operations page","Operation status is unknown":"Operation status is unknown","Unknown item":"Unknown item","Can't search: no search service is available":"Can't search: no search service is available","could not find banner parent, id was ":"could not find banner parent, id was ",Related:"Related",Options:"Options",FAQ:"FAQ","Report a Bug":"Bugs","Privacy Policy":"Privacy","Terms of Use":"Terms",
"Copyright Agent":"Copyright","Orion Logo":"Orion Logo","Orion is in Beta. Please try it out but BEWARE your data may be lost.":"@buildLabel@","LOG: ":"LOG: ",View:"View","no parent":"no parent","no tree model":"no tree model","no renderer":"no renderer","could not find table row ":"could not find table row ","Resource is out of sync with the server. Do you want to save it anyway?":"Resource is out of sync with the server. Do you want to save it anyway?",Operations:"Operations","Operations running":"Operations running",
"Some operations finished with warning":"Some operations finished with warning","Some operations finished with error":"Some operations finished with error","no service registry":"no service registry",Tasks:"Tasks",Close:"Close","Expand all":"Expand all","Collapse all":"Collapse all",Search:"Search","Advanced search":"Advanced search",Submit:"Submit",More:"More","Saved searches":"Saved searches","Recent searches":"Recent searches","Regular expression":"Regular expression","Search options":"Search options",
"Global search":"Global search","Orion Home":"Orion Home","Close notification":"Close notification","Operations - Press spacebar to show current operations":"Operations - Press spacebar to show current operations","Type a keyword or wild card to search in root":"Type a keyword or wild card to search in root","Toggle side panel":"Toggle side panel","Open or close the side panel":"Open or close the side panel",Projects:"Projects","Toggle Sidebar":"Toggle Sidebar","Sample HTML5 Site":"Sample HTML5 Site",
...
"To view the browser's context menu, trigger the context menu again.":"To view the browser's context menu, trigger the context menu again.",Edit:"Edit",CentralNavTooltip:"Toggle Navigation Menu"});define("orion/nls/messages",["orion/i18n!orion/nls/messages","orion/nls/root/messages"],function(g,n){var p={root:n};Object.keys(g).forEach(function(a){"undefined"===typeof p[a]&&(p[a]=g[a])});return p});
(function(){function g(q){if("string"!==typeof q)throw new TypeError;}function n(q){return q?q.split("&"):[]}function p(q){return 0===q.length?"":q.join("&")}function a(q){var b=/([^=]*)(?:=?)(.*)/.exec(q),q=b[1]?decodeURIComponent(b[1]):"",b=b[2]?decodeURIComponent(b[2]):"";return[q,b]}function k(q){var b=encodeURIComponent(q[0]);q[1]&&(b+="="+encodeURIComponent(q[1]));return b}function f(q,b){var v="",c=[],d=0;return{next:function(){v!==q.query&&(v=q.query,c=n(v));if(d<c.length){var l=a(c[d++]);
switch(b){case "keys":return l[0];case "values":return l[1];case "keys+values":return[l[0],l[1]];default:throw new TypeError;}}throw A;}}}function e(q){Object.defineProperty(this,"_url",{get:function(){return q._url}})}function d(q){return q?/[1-9]\d*$/.exec(q)[0]:""}function h(q){var b=[];q.split("/").forEach(function(q){".."===q?b.pop():"."!==q&&b.push(q)});return b.join("/")}function c(q,b){if("string"!==typeof q)throw new TypeError;var q=q.replace(/\s/g,function(q){return"%"+q.charCodeAt(0).toString(16)}),
v=r.exec(q);if(!v)return null;var c={};c.scheme=v[1]||"";if(c.scheme&&!x.test(c.scheme))return null;var l=v[2];if(l&&(l=s.exec(l),c.userinfo=l[1],c.host=l[2],c.port=l[3],c.port&&!t.test(c.port)))return null;c.path=v[3];c.query=v[4];c.fragment=v[5];!c.scheme&&b&&(c.scheme=b.scheme,!c.host&&b.host&&(c.userinfo=b.userinfo,c.host=b.host,c.port=b.port,c.pathRelative=!0));c.pathRelative&&(c.path?"/"!==c.path[0]&&(v=/^(.*\/)[^\/]*$/.exec(b.path)[1]||"/",c.path=v+c.path):c.path=b.path);c.scheme&&(c.scheme=
c.scheme.toLowerCase());c.port&&(c.port=d(c.port));c.host&&c.path&&(c.path=h(c.path));return c}function b(q,b){var v;if(b){b=b.href||b;v=c(b);if(!v||!v.scheme)throw new SyntaxError;Object.defineProperty(this,"_baseURL",{value:v})}v=c(q,v);if(!v)throw new SyntaxError;Object.defineProperty(this,"_input",{value:q,writable:!0});Object.defineProperty(this,"_url",{value:v,writable:!0});var d=new e(this);Object.defineProperty(this,"query",{get:function(){return this._url?d:null},enumerable:!0})}try{var l;
if("function"===typeof window.URL&&0!==window.URL.length&&"http:"===(l=new window.URL("http://www.w3.org?q")).protocol&&l.query)return}catch(m){}var r=/^(?:([^:\/?#]+):)?(?:\/\/([^\/?#]*))?([^?#]*)(?:\?([^#]*))?(?:#(.*))?$/,s=/^(?:(.*)@)?(\[[^\]]*\]|[^:]*)(?::(.*))?$/,x=/^([a-zA-Z](?:[a-zA-Z0-9+-.])*)$/,t=/^\d*$/,w=/^(\[[^\]\/?#\s]*\]|[^:\/?#\s]*)$/,y=/^(\[[^\]\/?#\s]*\]|[^:\/?#\s]*)(?::(\d*))?$/,u=/^([^?#\s]*)$/,z=/^([^\s]*)$/,q=/^\S*$/,v=/([^:]*):?(.*)/,A="undefined"!==typeof StopIteration?StopIteration:
Error("Stop Iteration"),C={"ftp:":"21","gopher:":"70","http:":"80","https:":"443","ws:":"80","wss:":"443"};Object.defineProperties(e.prototype,{get:{value:function(q){g(q);var b;n(this._url.query).some(function(v){v=a(v);if(v[0]===q)return b=v[1],!0});return b},enumerable:!0},set:{value:function(q,b){g(q);g(b);var v=n(this._url.query);v.some(function(c,d){var l=a(c);if(l[0]===q)return l[1]=b,v[d]=k(l),!0})||v.push(k([q,b]));this._url.query=p(v)},enumerable:!0},has:{value:function(q){g(q);return n(this._url.query).some(function(b){if(a(b)[0]===
q)return!0})},enumerable:!0},"delete":{value:function(q){g(q);var b=n(this._url.query),v=b.filter(function(b){return a(b)[0]!==q});return v.length!==b.length?(this._url.query=p(v),!0):!1},enumerable:!0},clear:{value:function(){this._url.query=""},enumerable:!0},forEach:{value:function(q,b){if("function"!==typeof q)throw new TypeError;var v=f(this._url,"keys+values");try{for(;;){var c=v.next();q.call(b,c[1],c[0],this)}}catch(d){if(d!==A)throw d;}},enumerable:!0},keys:{value:function(){return f(this._url,
"keys")},enumerable:!0},values:{value:function(){return f(this._url,"values")},enumerable:!0},items:{value:function(){return f(this._url,"keys+values")}},size:{get:function(){return n(this._url.query).length},enumerable:!0},getAll:{value:function(q){g(q);var b=[];n(this._url.query).forEach(function(v){v=a(v);v[0]===q&&b.push(v[1])});return b},enumerable:!0},append:{value:function(q,b){g(q);g(b);var v=n(this._url.query);v.push(k([q,b]));this._url.query=p(v)},enumerable:!0}});Object.defineProperties(b.prototype,
...
this._url.scheme+":":":"},set:function(q){g(q);if(this._url&&(q=":"===q.slice(-1)?q.substring(0,q.length-1):q,""===q||x.test(q)))this._url.scheme=q.toLowerCase()},enumerable:!0},_userinfo:{get:function(){return this._url?this._url.userinfo:""},set:function(q){g(q);this._url&&(this._url.userinfo=q)}},username:{get:function(){if(!this._url)return"";var q=v.exec(this._userinfo);return decodeURIComponent(q[1]||"")},set:function(q){g(q);if(this._url){var b=v.exec(this._userinfo),q=[encodeURIComponent(q||
"")];b[2]&&q.push(b[2]);this._userinfo=q.join(":")}},enumerable:!0},password:{get:function(){if(!this._url)return"";var q=v.exec(this._userinfo);return decodeURIComponent(q[2]||"")},set:function(q){g(q);if(this._url){var b=[v.exec(this._userinfo)[1]||""];q&&b.push(encodeURIComponent(q));this._userinfo=b.join(":")}},enumerable:!0},host:{get:function(){var q="";this._url&&this._url.host&&(q+=this._url.host,this._url.port&&(q+=":"+this._url.port));return q},set:function(q){g(q);if(this._url&&(q=y.exec(q)))this._url.host=
q[1],this._url.port=d(q[2])},enumerable:!0},hostname:{get:function(){return this._url?this._url.host:""},set:function(q){g(q);this._url&&w.exec(q)&&(this._url.host=q)},enumerable:!0},port:{get:function(){var q=this._url?this._url.port||"":"";q&&q===C[this.protocol]&&(q="");return q},set:function(q){g(q);this._url&&t.exec(q)&&(this._url.port=d(q))},enumerable:!0},pathname:{get:function(){return this._url?this._url.path:""},set:function(q){g(q);this._url&&u.exec(q)&&(this._url.host&&(q&&"/"!==q[0])&&
(q="/"+q),this._url.path=q?h(q):"")},enumerable:!0},search:{get:function(){return this._url&&this._url.query?"?"+this._url.query:""},set:function(q){g(q);this._url&&(q&&"?"===q[0]&&(q=q.substring(1)),z.exec(q)&&(this._url.query=q))},enumerable:!0},hash:{get:function(){return this._url&&this._url.fragment?"#"+this._url.fragment:""},set:function(b){g(b);this._url&&(b&&"#"===b[0]&&(b=b.substring(1)),q.exec(b)&&(this._url.fragment=b))},enumerable:!0}});if((l=window.URL||window.webkitURL)&&l.createObjectURL)Object.defineProperty(b,
"createObjectURL",{value:l.createObjectURL.bind(l),enumerable:!1}),Object.defineProperty(b,"revokeObjectURL",{value:l.revokeObjectURL.bind(l),enumerable:!1});window.URL=b})();define("orion/URL-shim",function(){});
...
define("orion/webui/treetable",["i18n!orion/nls/messages","orion/webui/littlelib"],function(g,n){function p(a){this._init(a)}p.prototype={_init:function(a){var k=a.parent,f=this,k=n.node(k);if(!k)throw g["no parent"];if(!a.model)throw g["no tree model"];if(!a.renderer)throw g["no renderer"];this._parent=k;this._treeModel=a.model;this._onComplete=a.onComplete;this._renderer=a.renderer;this._showRoot=void 0===a.showRoot?!1:a.showRoot;this._indent=void 0===a.indent?16:a.indent;this._onCollapse=a.onCollapse;
...
k){n.empty(this._parent);var f=document.createElement("div");this._renderer.wrapperCallback&&this._renderer.wrapperCallback(f);var e=document.createElement(this._tableElement);this._renderer.tableCallback&&this._renderer.tableCallback(e);e.id=this._id;this._tableStyle&&e.classList.add(this._tableStyle);this._renderer.initTable(e,this);this._bodyElement=document.createElement(this._tableBodyElement);this._renderer.bodyCallback&&this._renderer.bodyCallback(this._bodyElement);this._bodyElement.id=this._id+
"tbody";0===a.length?this._renderer.emptyCallback&&this._renderer.emptyCallback(this._bodyElement):this._generateChildren(a,k);e.appendChild(this._bodyElement);f.appendChild(e);this._parent.appendChild(f);this._rowsChanged();this._onComplete&&this._onComplete(this)},_generateChildren:function(a,k,f){for(var e=0;e<a.length;e++){var d=document.createElement(this._tableRowElement);d.id=this._treeModel.getId(a[e]);d._depth=k;d._item=a[e];this._renderer.render(a[e],d);d.childNodes[this._labelColumnIndex].style.paddingLeft=
this._indent*k+"px";this._renderer.rowCallback&&this._renderer.rowCallback(d,a[e]);f?(this._bodyElement.insertBefore(d,f.nextSibling),f&&(f=d)):this._bodyElement.appendChild(d)}},_rowsChanged:function(){this._renderer.rowsChanged&&this._renderer.rowsChanged()},getSelected:function(){return this._renderer.getSelected()},refresh:function(a,k,f){var e=this._treeModel.getId(a),d;if(e===this._id)this._removeChildRows(e),this._generateChildren(k,0),this._rowsChanged();else{var h=n.node(e);h?(h._item=a,
h&&(f||h._expanded)?(this._removeChildRows(e),k?(h._expanded=!0,this._renderer.updateExpandVisuals(h,!0),this._generateChildren(k,h._depth+1,h),this._rowsChanged()):(d=this,this._renderer.updateExpandVisuals(h,"progress"),k=this._treeModel.getChildren(h._item,function(c){d.destroyed||(d._renderer.updateExpandVisuals(h,!0),h._expanded||(h._expanded=!0,d._generateChildren(c,h._depth+1,h),d._rowsChanged()))}))):this._renderer.updateExpandVisuals(h,!1)):console.log(g["could not find table row "]+e)}},
getItem:function(a){var k=n.node(a);return k&&k._item?k._item:a},toggle:function(a){var k=n.node(a);k&&(k._expanded?this.collapse(a):this.expand(a))},isExpanded:function(a){a="string"===typeof a?a:this._treeModel.getId(a);return(a=n.node(a))?a._expanded:!1},expand:function(a,k,f){var a="string"===typeof a?a:this._treeModel.getId(a),e=n.node(a);if(e)if(e._expanded)k&&k.apply(d,f);else{var d=this;this._renderer.updateExpandVisuals(e,"progress");this._treeModel.getChildren(e._item,function(a){d.destroyed||
(d._renderer.updateExpandVisuals(e,!0),e._expanded||(e._expanded=!0,d._generateChildren(a,e._depth+1,e),d._rowsChanged()),k&&k.apply(d,f))})}},_removeChildRows:function(a){for(var k=a===this._id,f=!1,e=-1,d=[],h=n.$$array(".treeTableRow",this._parent),c=0;c<h.length;c++){var b=h[c];if(f)break;k?b._depth>e?d.push(b):f=!0:b.id===a&&(k=!0,e=b._depth)}for(a=0;a<d.length;a++)k=d[a],k.parentNode.removeChild(k)},collapse:function(a){var a="string"===typeof a?a:this._treeModel.getId(a),k=n.node(a);if(k){if(!k._expanded)return;
k._expanded=!1;this._renderer.updateExpandVisuals(k,!1);this._removeChildRows(a);this._rowsChanged()}this._onCollapse&&this._onCollapse(k._item)},getIndent:function(){return this._indent}};p.prototype.constructor=p;return{TableTree:p}});
...
this.forceExpandFunc){var k=this;return this.forceExpandFunc(this._cursor,"first",function(a){a&&k.setCursor(a)})}(a=this._findSibling(this._cursor,!0))&&this.setCursor(a)}return a},_backward:function(g){if(!this._cursor)return null;var a=this._findSibling(this._cursor,!1);a&&a!==this._cursor.parent&&(a=this._drillToLast(a));if(g&&a&&this._expandable(a)&&this.forceExpandFunc&&a!==this._cursor.parent){var k=this;return this.forceExpandFunc(a,"last",function(a){a&&k.setCursor(a)})}a&&this.setCursor(a);
return a},_findSibling:function(g,a){for(var k=this.topLevel(g),f=this._getChildren(g.parent),f=k?this.firstLevelChildren:f,e=0;e<f.length;e++)if(f[e]===g)return 0===e&&!a?k?null:g.parent:e===f.length-1&&a?k?null:this._findSibling(g.parent,a):a?f[e+1]:f[e-1];return null},_inParentChain:function(g,a){for(var k=g.parent;k;){if(k===a)return!0;k=k.parent}return!1},_getTopLevelParent:function(g){if(this.topLevel(g))return g;for(g=g.parent;g;){if(this.topLevel(g))return g;g=g.parent}return null},_onCollapse:function(g){return this._expanded(g.parent)?
g:this._onCollapse(g.parent)},_scan:function(g,a,k){this.setCursor(a);var f=[];for(f.push(a);;){if(this.iterate(g))f.push(this.cursor());else break;if(k===this.cursor())return f}return null},setCursor:function(g){this._prevCursor=this._cursor;this._cursor=g},setTree:function(g){this.firstLevelChildren=g;0<this.firstLevelChildren.length&&(this.root=this.firstLevelChildren[0].parent)},scan:function(g,a){var k=this.cursor(),f=this._scan(!0,g,a);f||(f=this._scan(!1,g,a));this.setCursor(k);return f},iterate:function(g,
a){return g?this._forward(a):this._backward(a)},iterateOnTop:function(g,a){var k=this._findSibling(this._getTopLevelParent(this.cursor()),g);k?this.setCursor(k):a&&0<this.firstLevelChildren.length&&this.setCursor(g?this.firstLevelChildren[0]:this.firstLevelChildren[this.firstLevelChildren.length-1])},collapse:function(g){return!this._cursor?null:this._inParentChain(this._cursor,g)?(this.setCursor(g),this._cursor):null},reset:function(){this.root=this._prevCursor=this._cursor=null;0<this.firstLevelChildren.length&&
...
define("orion/uiUtils",["orion/webui/littlelib"],function(g){function n(a){var k="",f=-1!==navigator.platform.indexOf("Mac");f?(a.mod4&&(k+="\u2303"),a.mod3&&(k+="\u2325"),a.mod2&&(k+="\u21e7"),a.mod1&&(k+="\u2318")):(a.mod1&&(k+="Ctrl+"),a.mod2&&(k+="Shift+"),a.mod3&&(k+="Alt+"));if(a.alphaKey)return k+a.alphaKey;if("keypress"===a.type)return k+a.keyCode;for(var e in g.KEY)if(typeof("number"===g.KEY[e])&&g.KEY[e]===a.keyCode){if(f)switch(g.KEY[e]){case g.KEY.BKSPC:e="\u232b";break;case g.KEY.TAB:e=
"\u21e5";break;case g.KEY.ENTER:e="\u23ce";break;case g.KEY.ESCAPE:e="\u238b";break;case g.KEY.SPACE:e="\u2423";break;case g.KEY.PAGEUP:e="\u21de";break;case g.KEY.PAGEDOWN:e="\u21df";break;case g.KEY.END:e="\u21f2";break;case g.KEY.HOME:e="\u21f1";break;case g.KEY.DEL:e="\u2326"}switch(g.KEY[e]){case g.KEY.DOWN:e="\u2193";break;case g.KEY.UP:e="\u2191";break;case g.KEY.RIGHT:e="\u2192";break;case g.KEY.LEFT:e="\u2190"}return k+e}var d;switch(a.keyCode){case 59:d=a.mod2?":":";";break;case 61:d=a.mod2?
"+":"=";break;case 188:d=a.mod2?"<":",";break;case 190:d=a.mod2?">":".";break;case 191:d=a.mod2?"?":"/";break;case 192:d=a.mod2?"~":"`";break;case 219:d=a.mod2?"{":"[";break;case 220:d=a.mod2?"|":"\\";break;case 221:d=a.mod2?"}":"]";break;case 222:d=a.mod2?'"':"'"}return d?k+d:112<=a.keyCode&&123>=a.keyCode?k+"F"+(a.keyCode-111):k+String.fromCharCode(a.keyCode)}function p(a){var k=-1!==window.navigator.platform.indexOf("Mac");return k&&a.metaKey||!k&&a.ctrlKey}return{getUserKeyString:function(a){for(var k=
"",a=a.getKeys(),f=0;f<a.length;f++)0!==f&&(k+=" "),k+=n(a[f]);return k},getUserText:function(a){var k=a.id,f=a.refNode,e=a.hideRefNode,d=a.initialText,h=a.onComplete,c=a.onEditDestroy,b=a.selectTo,l=a.isInitialValid,a=a.insertAsChild,m=!1,r=function(b){return function(a){if(!m){var r=g.node(k),s=r.value;r&&(b&&a.keyCode===g.KEY.ESCAPE?(e&&(f.style.display="inline"),m=!0,r.parentNode.removeChild(r),c&&c()):b&&a.keyCode!==g.KEY.ENTER||(0===s.length||!l&&s===d?e&&(f.style.display="inline"):(h(s),e&&
f.parentNode&&(f.style.display="inline")),m=!0,r.parentNode&&r.parentNode.removeChild(r),c&&c()))}}},s=document.createElement("input");s.id=k;s.value=d||"";a?f.appendChild(s):f.parentNode.insertBefore(s,f.nextSibling);s.classList.add("userEditBoxPrompt");e&&(f.style.display="none");s.addEventListener("keydown",r(!0),!1);s.addEventListener("blur",r(!1),!1);window.setTimeout(function(){s.focus();if(d){var c=g.node(k),l=b?d.indexOf(b):-1;0<l?c.createTextRange?(c=c.createTextRange(),c.collapse(!0),c.moveStart("character",
0),c.moveEnd("character",l),c.select()):c.setSelectionRange?c.setSelectionRange(0,l):void 0!==c.selectionStart&&(c.selectionStart=0,c.selectionEnd=l):c.select()}},0)},openInNewWindow:p,followLink:function(a,k){k&&p(k)?window.open(a):window.location=a},createButton:function(a,k){var f=document.createElement("button");f.className="orionButton commandButton commandMargins";f.addEventListener("click",function(a){k();g.stop(a)},!1);a&&f.appendChild(document.createTextNode(a));return f},createDropdownButton:function(){},
isFormElement:function(a){switch(a.tagName.toLowerCase()){case "button":case "fieldset":case "form":case "input":case "keygen":case "label":case "legend":case "meter":case "optgroup":case "output":case "progress":case "select":case "textarea":return!0}return!1}}});
define("orion/explorers/explorerNavHandler",["orion/webui/littlelib","orion/treeModelIterator","orion/uiUtils"],function(g,n,p){var a={},k=-1!==navigator.userAgent.indexOf("iPad"),f=-1!==window.navigator.platform.indexOf("Mac"),e=function(d,a,c){this.explorer=d;this.model=this.explorer.model;this._navDict=a;this._listeners=[];this._selections=[];this._currentColumn=0;d=this._getEventListeningDiv();d.tabIndex=0;d.classList.add("selectionModelContainer");var b=this;this._modelIterator=new n.TreeModelIterator([],
...
g.node(this.explorer._parentId)},isExpandable:function(d){return!d?!1:g.node(this.explorer.renderer.expandCollapseImageId(this.model.getId(d)))?!0:!1},isExpanded:function(d){return!d?!1:this.explorer.myTree.isExpanded(this.model.getId(d))},refreshSelection:function(d,a){var c=this;this.explorer.selection&&this.explorer.selection.getSelections(function(b){c._clearSelection(a);for(var l=0;l<b.length;l++)c._selections.push(b[l]);0<c._selections.length?c.cursorOn(c._selections[0],!0,!1,d):c.cursorOn(null,
...
c.classList.remove("treeIterationCursorRow_Dotted"))},currentModel:function(){return this._modelIterator.cursor()},cursorOn:function(d,a,c,b){var l,m;if(d||a){if(m===this._modelIterator.cursor())return;l=this._modelIterator.cursor();m=d;this._modelIterator.setCursor(m)}else l=this._modelIterator.prevCursor(),m=this._modelIterator.cursor();if(l!==m||a)if(this.toggleCursor(l,!1),!a||m){this.moveColumn(null,0);this.toggleCursor(m,!0);if((d=this.getRowDiv())&&!b){b=d.parentNode;for(a=document.documentElement;b&&
b!==a;){var r=window.getComputedStyle(b,null);if(!r)break;r=r.getPropertyValue("overflow-y");if("auto"===r||"scroll"===r)break;b=b.parentNode}b&&(a=!0,d.offsetTop<=b.scrollTop?(a=!1,void 0===c&&(c=!1)):d.offsetTop+d.offsetHeight>=b.scrollTop+b.clientHeight&&(a=!1,void 0===c&&(c=!0)),a||d.scrollIntoView(!c))}if(this.explorer.onCursorChanged)this.explorer.onCursorChanged(l,m)}},getSelection:function(){return this._selections},getSelectionIds:function(){for(var d=[],a=0;a<this._selections.length;a++)d.push(this.model.getId(this._selections[a]));
return d},getRowDiv:function(d){d=d?d:this._modelIterator.cursor();if(!d)return null;var d=this.model.getId(d),a=this._navDict.getValue(d);return a&&a.rowDomNode?a.rowDomNode:g.node(d)},iterate:function(d,a,c,b){var l=null;if(this.topIterationNodes&&0!==this.topIterationNodes.length)if(b){b=this.currentModel();for((l=this._modelIterator.iterate(d,a))&&this._setCursorOnItem(d,c);l&&l.isNotSelectable;)(l=this._modelIterator.iterate(d,a))&&this._setCursorOnItem(d,c);l||(this.cursorOn(b,!0,!1,!0),this._setCursorOnItem(d,
...
define("text",["module"],function(g){var n,p,a=["Msxml2.XMLHTTP","Microsoft.XMLHTTP","Msxml2.XMLHTTP.4.0"],k=/^\s*<\?xml(\s)+version=[\'\"](\d)*.(\d)*[\'\"](\s)*\?>/im,f=/<body[^>]*>\s*([\s\S]+)\s*<\/body>/im,e="undefined"!==typeof location&&location.href,d=e&&location.protocol&&location.protocol.replace(/\:/,""),h=e&&location.hostname,c=e&&(location.port||void 0),b=[],l=g.config&&g.config()||{};n={version:"2.0.5",strip:function(b){if(b){var b=b.replace(k,""),c=b.match(f);c&&(b=c[1])}else b="";return b},
jsEscape:function(b){return b.replace(/(['\\])/g,"\\$1").replace(/[\f]/g,"\\f").replace(/[\b]/g,"\\b").replace(/[\n]/g,"\\n").replace(/[\t]/g,"\\t").replace(/[\r]/g,"\\r").replace(/[\u2028]/g,"\\u2028").replace(/[\u2029]/g,"\\u2029")},createXhr:l.createXhr||function(){var b,c,d;if("undefined"!==typeof XMLHttpRequest)return new XMLHttpRequest;if("undefined"!==typeof ActiveXObject)for(c=0;3>c;c+=1){d=a[c];try{b=new ActiveXObject(d)}catch(l){}if(b){a=[d];break}}return b},parseName:function(b){var c,
d,a=!1,l=b.indexOf(".");c=0===b.indexOf("./")||0===b.indexOf("../");-1!==l&&(!c||1<l)?(c=b.substring(0,l),d=b.substring(l+1,b.length)):c=b;b=d||c;l=b.indexOf("!");-1!==l&&(a="strip"===b.substring(l+1),b=b.substring(0,l),d?d=b:c=b);return{moduleName:c,ext:d,strip:a}},xdRegExp:/^((\w+)\:)?\/\/([^\/\\]+)/,useXhr:function(b,c,d,a){var l,e;l=n.xdRegExp.exec(b);if(!l)return!0;b=l[2];l=l[3];l=l.split(":");e=l[1];l=l[0];return(!b||b===c)&&(!l||l.toLowerCase()===d.toLowerCase())&&(!e&&!l||e===a)},finishLoad:function(c,
d,a,e){a=d?n.strip(a):a;l.isBuild&&(b[c]=a);e(a)},load:function(b,a,k,f){if(f.isBuild&&!f.inlineText)k();else{l.isBuild=f.isBuild;var t=n.parseName(b),f=t.moduleName+(t.ext?"."+t.ext:""),g=a.toUrl(f),p=l.useXhr||n.useXhr;!e||p(g,d,h,c)?n.get(g,function(c){n.finishLoad(b,t.strip,c,k)},function(b){k.error&&k.error(b)}):a([f],function(b){n.finishLoad(t.moduleName+"."+t.ext,t.strip,b,k)})}},write:function(c,d,a){if(b.hasOwnProperty(d)){var l=n.jsEscape(b[d]);a.asModule(c+"!"+d,"define(function () { return '"+
l+"';});\n")}},writeFile:function(b,c,d,a,l){var c=n.parseName(c),e=c.ext?"."+c.ext:"",h=c.moduleName+e,k=d.toUrl(c.moduleName+e)+".js";n.load(h,d,function(){var c=function(q){return a(k,q)};c.asModule=function(q,b){return a.asModule(q,k,b)};n.write(b,h,c,l)},l)}};if("node"===l.env||!l.env&&"undefined"!==typeof process&&process.versions&&process.versions.node)p=require.nodeRequire("fs"),n.get=function(b,c){var d=p.readFileSync(b,"utf8");0===d.indexOf("\ufeff")&&(d=d.substring(1));c(d)};else if("xhr"===
l.env||!l.env&&n.createXhr())n.get=function(b,c,d,a){var e=n.createXhr(),h;e.open("GET",b,!0);if(a)for(h in a)a.hasOwnProperty(h)&&e.setRequestHeader(h.toLowerCase(),a[h]);if(l.onXhr)l.onXhr(e,b);e.onreadystatechange=function(){var a;4===e.readyState&&(a=e.status,399<a&&600>a?(a=Error(b+" HTTP status: "+a),a.xhr=e,d(a)):c(e.responseText))};e.send(null)};else if("rhino"===l.env||!l.env&&"undefined"!==typeof Packages&&"undefined"!==typeof java)n.get=function(b,c){var d,a,l=new java.io.File(b),e=java.lang.System.getProperty("line.separator"),
l=new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(l),"utf-8")),h="";try{d=new java.lang.StringBuffer;(a=l.readLine())&&(a.length()&&65279===a.charAt(0))&&(a=a.substring(1));for(d.append(a);null!==(a=l.readLine());)d.append(e),d.append(a);h=String(d.toString())}finally{l.close()}c(h)};return n});define("text!orion/webui/dropdowntriggerbutton.html",[],function(){return'<button class="dropdownTrigger">${ButtonText}<\!--span class="dropdownArrowDown core-sprite-openarrow"></span--\></button><ul class="dropdownMenu"></ul>'});
...
define("orion/webui/tooltip",["require","orion/webui/littlelib"],function(g,n){function p(a){this._init(a)}p.prototype={_init:function(a){this._node=n.node(a.node);if(!this._node)throw"no dom node for tooltip found";this._position=a.position||["right","above","below","left"];this._text=a.text;this._hideDelay=void 0===a.hideDelay?200:a.hideDelay;this._tailSize=a.tailSize||10;this._trigger=a.trigger||"mouseover";this._afterShowing=a.afterShowing;this._afterHiding=a.afterHiding;var k=this;if("click"===
this._trigger)this._showDelay=0,this._node.addEventListener("click",this._clickHandler=function(a){a.target===k._node&&(k.show(),n.stop(a))},!1);else if("mouseover"===this._trigger){this._showDelay=void 0===a.showDelay?500:a.showDelay;a=["mouseout","click"];this._node.addEventListener("mouseover",this._mouseoverHandler=function(a){n.contains(k._node,a.target)&&(k.show(),n.stop(a))},!1);this._leaveHandler=function(a){n.contains(k._node,a.target)&&k.hide()};for(var f=0;f<a.length;f++)this._node.addEventListener(a[f],
...
window.setTimeout(this._showImmediately.bind(this),this._showDelay):this._showImmediately()},_showImmediately:function(){for(var a=!1,k=0;!a&&k<this._position.length;)a=this._positionTip(this._position[k]),k++;a||this._positionTip(this._position[0],!0);this._tip.classList.add("tooltipShowing");this._afterShowing&&this._afterShowing()},hide:function(a){this._timeout&&(window.clearTimeout(this._timeout),this._timeout=null);if(this._tip&&this._tip.classList.contains("tooltipShowing")){void 0===a&&(a=
this._hideDelay);var k=this;this._timeout=window.setTimeout(function(){k._tip.classList.remove("tooltipShowing");k._tip.removeAttribute("style");k._afterHiding&&k._afterHiding()},a)}},destroy:function(){this._timeout&&(window.clearTimeout(this._timeout),this._timeout=null);this._tip&&(document.body.removeChild(this._tip),this._tail=this._tipTextContent=this._tipInner=this._tip=null);if(this._node){this._node.removeEventListener("click",this._clickHandler,!1);this._node.removeEventListener("mouseover",
this._mouseoverHandler,!1);for(var a=["mouseout","click"],k=0;k<a.length;k++)this._node.removeEventListener(a[k],this._leaveHandler,!1)}}};p.prototype.constructor=p;return{Tooltip:p}});
define("orion/commands","orion/util orion/webui/littlelib orion/webui/dropdown text!orion/webui/dropdowntriggerbutton.html text!orion/webui/dropdowntriggerbuttonwitharrow.html text!orion/webui/submenutriggerbutton.html text!orion/webui/checkedmenuitem.html orion/webui/tooltip".split(" "),function(g,n,p,a,k,f,e,d){function h(b){var c=b.invocation;if(c){var q=b.command;if(q.hrefCallback)return b=q.hrefCallback.call(c.handler||window,c),b.then?b.then(function(q){window.open(q)}):window.open(b),!0;if(c.commandRegistry)return c.commandRegistry._invoke(c),
!0;if(q.onClick||q.callback)return window.setTimeout(function(){(q.onClick||q.callback).call(c.handler||window,c)},0),!0}return!1}function c(b,c){for(var q in c)if(c[q]&&(c[q].keyBinding&&c[q].command)&&c[q].keyBinding.match(b)){var v=c[q],d=v.keyBinding;if((!d.domScope||n.contains(n.node(d.domScope),b.target))&&h(v)){n.stop(b);break}}}function b(){var b={};if(w){var c,q,v;q=Object.keys(y);for(c=0;c<q.length;c++)v=q[c],b[v]=y[v];var d=w();q=Object.keys(d);for(c=0;c<q.length;c++)v=q[c],b[v]=d[v]}else b=
y;return b}function l(d){c(d,b())}function m(b,c){b=b||window.event;if(function(q){if(g.isMac){if(q.metaKey&&!q.altKey)return!q.shiftKey&&!q.ctrlKey&&(65===q.keyCode||67===q.keyCode||86===q.keyCode||88===q.keyCode||90===q.keyCode)?!0:!1;if(q.ctrlKey)return!1}else{if(q.ctrlKey&&!q.altKey)return!q.shiftKey&&(65===q.keyCode||67===q.keyCode||86===q.keyCode||88===q.keyCode||90===q.keyCode)?!0:!1;if(q.altKey&&!q.ctrlKey)return!1}if(q["char"])return 0<q["char"].length;if(q.charCode||q.keyCode)switch(q=q.charCode||
q.keyCode,q){case 8:case 9:case 13:case 46:return!0;default:return 32<=q&&112>q||123<q}return!1}(b)){if("true"===b.target.contentEditable)return;var q=b.target.nodeName.toLowerCase();if("input"===q)switch(b.target.type.toLowerCase()){case "text":case "password":case "search":case "color":case "date":case "datetime":case "datetime-local":case "email":case "month":case "number":case "range":case "tel":case "time":case "url":case "week":return}else if("textarea"===q)return}c?c(b):l(b)}function r(){this._init()}
function s(b,c,q){c.classList.add("commandImage");var v;b.imageClass?b.addImageClassToElement?c.classList.add(b.imageClass):(v=document.createElement("span"),c.appendChild(v),v.classList.add(b.spriteClass),v.classList.add(b.imageClass)):(v=new Image,v.alt=b.name,v.name=q,v.id=q,v.src=b.image,c.appendChild(v));return v}function x(b,c,q,v,d){this.commandRegistry=d;this.handler=b;this.items=c;this.userData=q;this.command=v;v.parameters&&(this.parameters=v.parameters.makeCopy());this.id=v.id}function t(b){this._init(b)}
var w=null,y={};r.prototype={setProxy:function(b){this.proxy=b},setKeyBindings:function(b){this.bindings=b},_init:function(){var b=this;document.addEventListener("keydown",function(c){return m(c,function(q){var c=b.proxy,d=b.bindings;if(d&&c)for(var a=0;a<d.length;a++)d[a].match(q)&&(c.processKey({type:q.type,keyCode:q.keyCode,altKey:q.altKey,ctrlKey:q.ctrlKey,metaKey:q.metaKey,shiftKey:q.shiftKey}),n.stop(q))})})}};window.document.addEventListener("keydown",m,!1);x.prototype={collectsParameters:function(){return this.commandRegistry&&
this.commandRegistry.collectsParameters()},makeCopy:function(b){var c=new x(this.handler,this.items,this.userData,this.command,this.commandRegistry);c.domNode=this.domNode;c.domParent=this.domParent;b?c.parameters=b.makeCopy():this.parameters&&(c.parameters=this.parameters.makeCopy());return c}};x.prototype.constructor=x;t.prototype={_init:function(b){this.id=b.id;this.name=b.name;this.tooltip=b.tooltip;this.callback=b.callback;this.hrefCallback=b.hrefCallback;this.choiceCallback=b.choiceCallback;
this.positioningNode=b.positioningNode;this.image=b.image||"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAAtJREFUCNdjIBEAAAAwAAFletZ8AAAAAElFTkSuQmCC";this.imageClass=b.imageClass;this.addImageClassToElement=b.addImageClassToElement;this.selectionClass=b.selectionClass;this.spriteClass=b.spriteClass||"commandSprite";this.visibleWhen=b.visibleWhen;this.parameters=b.parameters;this.isEditor=b.isEditor},populateChoicesMenu:function(b,c,q,v,
d){this.getChoices(c,q,v).forEach(function(q){if(q.name){var v=document.createElement("li");b.appendChild(v);var a=document.createElement("span");a.tabIndex=0;a.role="menuitem";a.classList.add("dropdownMenuItem");var l=document.createTextNode(q.name);a.appendChild(l);v.appendChild(a);a.choice=q;a.addEventListener("click",function(q){q.target.choice&&q.target.choice.callback.call(q.target.choice,c)},!1);a.addEventListener("keydown",function(q){(q.keyCode===n.KEY.ENTER||q.keyCode===n.KEY.SPACE)&&q.target.choice&&
q.target.choice.callback.call(q.target.choice,c)},!1)}else d._generateMenuSeparator(b)})},getChoices:function(b,c,q){return this.choiceCallback?this.choiceCallback.call(c,b,q):null},makeChoiceCallback:function(b,c){return function(q){b.callback&&b.callback.call(b,c,q)}},hasImage:function(){return this.imageClass||"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAAtJREFUCNdjIBEAAAAwAAFletZ8AAAAAElFTkSuQmCC"!==this.image}};t.prototype.constructor=
t;return{Command:t,CommandInvocation:x,createDropdownMenu:function(b,c,q,v,d,l,r,m,e){b=n.node(b);if(!b)throw"no parent node was specified";var h=document.createRange();h.selectNode(b);h=e?h.createContextualFragment(k):h.createContextualFragment(a);n.processTextNodes(h,{ButtonText:c});b.appendChild(h);var b=b.lastChild,f;e?(f=b.previousSibling,e=f.previousSibling):e=b.previousSibling;v?(e.classList.add(v),f&&f.classList.add(v)):(e.classList.add("orionButton"),e.classList.add("commandButton"),f&&(f.classList.add("orionButton"),
f.classList.add("commandButton"),f.classList.add("commandHalfButton_right"),e.classList.add("commandHalfButton_left")));d&&(l||(e.textContent="",e.setAttribute("aria-label",c)),s({spriteClass:"commandSprite",imageClass:d},e,c),f&&(f.classList.add("commandImage"),f.classList.add("commandHalfImage_right"),e.classList.add("commandHalfImage_left")),e.classList.add("orionButton"));e.dropdown=new p.Dropdown({dropdown:b,populate:q,selectionClass:r,positioningNode:m});b.dropdown=e.dropdown;return{menuButton:e,
menu:b,dropdown:e.dropdown,extraDropdownButton:f}},createCheckedMenuItem:function(b,c,q,v){b=n.node(b);if(!b)throw"no parent node was specified";var d=document.createRange();d.selectNode(b);d=d.createContextualFragment(e);n.processTextNodes(d,{ItemText:c});b.appendChild(d);b=n.$(".checkedMenuItem",b.lastChild);b.checked=q;b.addEventListener("change",v,!1);return b},createCommandItem:function(b,c,q,v,a,l,r){var m,l=l||!c.name&&c.hasImage();if(c.hrefCallback)m=document.createElement("a"),m.id=v,l&&
c.hasImage()?s(c,m,v):(m.className="commandLink",m.appendChild(document.createTextNode(c.name))),r=c.hrefCallback.call(q.handler,q),r.then?r.then(function(q){m.href=q}):m.href=r?r:"#";else{m=document.createElement("button");m.className="orionButton";l?c.hasImage()?(s(c,m,v),c.name&&m.setAttribute("aria-label",c.name)):(m.classList.add("commandButton"),m.classList.add("commandMissingImageButton"),m.appendChild(document.createTextNode(c.name))):(m.classList.add("commandButton"),v=document.createTextNode(c.name),
m.appendChild(v));var e=r||c.callback;e&&(c.onClick=e,m.addEventListener("click",function(){e.call(q.handler,q)},!1))}"ul"===b.nodeName.toLowerCase()?(r=document.createElement("li"),b.appendChild(r),b=r):m.classList.add("commandMargins");b.appendChild(m);c.tooltip&&(m.commandTooltip=new d.Tooltip({node:m,text:c.tooltip,position:["above","below","right","left"]}));a&&(y[c.id]={keyBinding:a,command:c,invocation:q});return m},createCommandMenuItem:function(b,c,q,v,a,l){var r,m=b.dropdown;if(c.hrefCallback){r=
document.createElement("a");var e=document.createElement("span");e.appendChild(document.createTextNode(c.name));e.classList.add("dropdownCommandName");r.appendChild(e);a=c.hrefCallback.call(q.handler,q);a.then?a.then(function(q){r.href=q}):r.href=a?a:"#";r.addEventListener("keydown",function(q){(q.keyCode===n.KEY.ENTER||q.keyCode===n.KEY.SPACE)&&r.click()},!1)}else{r=document.createElement("span");r.tabIndex=0;e=document.createElement("span");e.appendChild(document.createTextNode(c.name));e.classList.add("dropdownCommandName");
r.appendChild(e);var h=a||c.callback;h&&(c.onClick=h,r.addEventListener("click",function(){m.close(!0);h.call(q.handler,q)},!1),r.addEventListener("keydown",function(q){if(q.keyCode===n.KEY.ENTER||q.keyCode===n.KEY.SPACE)q.preventDefault(),r.click()},!1))}r.className="dropdownMenuItem";r.role="menuitem";c.tooltip&&(r.commandTooltip=new d.Tooltip({node:r,text:c.tooltip,position:["above","below","right","left"]}));l&&(a=r,e=document.createElement("span"),e.classList.add("dropdownKeyBinding"),e.appendChild(document.createTextNode(l)),
a.appendChild(e));l=document.createElement("li");b.appendChild(l);l.appendChild(r);v&&(y[c.id]={keyBinding:v,command:c,invocation:q});return r},executeBinding:h,setKeyBindingProvider:function(b){w=b},localKeyBindings:y,CommandsProxy:r,getKeyBindings:b,processKey:l,NO_IMAGE:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAAtJREFUCNdjIBEAAAAwAAFletZ8AAAAAElFTkSuQmCC",_testMethodProcessKey:c}});
define("orion/explorers/explorer","i18n!orion/nls/messages require orion/webui/littlelib orion/webui/treetable orion/explorers/explorerNavHandler orion/commands".split(" "),function(g,n,p,a,k,f){var n={},e=function(d,a,c,b){this.registry=d;this.renderer=c;this.selection=a;this.commandService=b;this.renderer&&(this.renderer.explorer=this);this.myTree=null};e.prototype={destroy:function(){this._navHandler&&this._navHandler.destroy();this.model&&this.model.destroy();this.myTree&&this.myTree.destroy();
this.destroyed=!0},changedItem:function(d,a){this.myTree&&this.myTree.refresh.bind(this.myTree)(d,a,!0)},updateCommands:function(d){this.myTree&&this.myTree._renderer.updateCommands.bind(this.myTree._renderer)(d)},makeNewItemPlaceHolder:function(d,a,c,b){d=this.getRow(d);if(c)return d=d.childNodes[c],d.appendChild(document.createElement("br")),b=document.createElement("span"),b.id=a+"placeHolderRow",d.appendChild(b),{tempNode:b,refNode:b};if(d){var l=document.createElement("tr");l.id=a+"placeHolderRow";
c=document.createElement("td");c.id=a+"placeHolderCol";l.appendChild(c);b?(d.parentNode.insertBefore(l,d.nextSibling),d=parseInt(d.firstChild.style.paddingLeft),c.style.paddingLeft=this.myTree.getIndent()+d+"px"):d.appendChild(l);b=p.node(a+"placeHolderRow");d=p.node(a+"placeHolderCol");if(b&&d)return{tempNode:b,refNode:d}}return null},getRow:function(d){if(d=this.model.getId(d))return p.node(d)},collapseAll:function(){for(var d=this._navHandler.getTopLevelNodes(),a=0;a<d.length;a++)this.myTree.collapse(d[a])},
...
if(d&&this.getNavDict())for(var c=d.getSelection(),b=0;b<c.length;b++){var l=d.getRowDiv(c[b]);l&&l.parentNode&&(l=this.getNavDict().getValue(this.model.getId(c[b])),l.model&&a.push(l.model))}this.selection.setSelections(a)}},getRootPath:function(){return this.model&&this.model.root?this.model.root.Location:null},initNavHandler:function(){var d=this._treeOptions;if(!d||d&&!d.noSelection){this.getNavHandler()||(this._navHandler=d&&d.navHandlerFactory&&"function"===typeof d.navHandlerFactory.createNavHandler?
d.navHandlerFactory.createNavHandler(this,this._navDict,d):new k.ExplorerNavHandler(this,this._navDict,{getChildrenFunc:d?d.getChildrenFunc:null,setFocus:d&&d.setFocus,selectionPolicy:d?d.selectionPolicy:null}));var a=this;this.model.getRoot(function(c){c instanceof Array?a.getNavHandler().refreshModel(a.getNavDict(),a.model,c):c.children&&c.children instanceof Array&&a.getNavHandler().refreshModel(a.getNavDict(),a.model,c.children);d&&d.setFocus&&a.getNavHandler().cursorOn(null,!1,!1,!0)})}},_lastHash:null,
checkbox:!1};n.Explorer=e;n.createExplorerCommands=function(d,a){function c(b){return"function"===typeof b.getItemCount&&0<b.getItemCount()?a?a(b):!0:!1}var b=new f.Command({tooltip:g["Expand all"],imageClass:"core-sprite-expandAll",id:"orion.explorer.expandAll",groupId:"orion.explorerGroup",visibleWhen:function(b){return c(b)},callback:function(b){b.items.expandAll()}}),l=new f.Command({tooltip:g["Collapse all"],imageClass:"core-sprite-collapseAll",id:"orion.explorer.collapseAll",groupId:"orion.explorerGroup",
visibleWhen:function(b){return c(b)},callback:function(b){b.items.collapseAll()}});d.addCommand(b);d.addCommand(l)};e=function(d,a,c){this.rootPath=d;this.fetchItems=a;this.idPrefix=c||""};e.prototype={destroy:function(){this.destroyed=!0},getRoot:function(d){var a=this;this.fetchItems(this.rootPath).then(function(c){a.root=c;d(c)})},getChildren:function(d,a){d.Children?a(d.Children):d.ChildrenLocation?this.fetchItems(d.ChildrenLocation).then(function(c){d.Children=c;a(c)}):a([])},getId:function(d){if(d.Location===
this.root.Location)return this.rootId;for(var d=d.Location.replace(/[\\\/]/g,""),a=this.idPrefix,c=0;c<d.length;c++)a=d[c].match(/[^\.\:\-\_0-9A-Za-z]/g)?a+d.charCodeAt(c):a+d[c];return a}};n.ExplorerModel=e;e=function(a,e,c){this.rootPath=a;this.fetchItems=e;this.root=c};e.prototype=new n.ExplorerModel;e.prototype.getRoot=function(a){if(this.root)a(this.root);else{var e=this;this.fetchItems(this.rootPath).then(function(c){e.root=c;a(c)})}};e.prototype.getChildren=function(a,e){a===this.root?e(this.root):
e([])};n.ExplorerFlatModel=e;e=function(a,e){this.explorer=e;this._init(a);this._expandImageClass="core-sprite-openarrow";this._collapseImageClass="core-sprite-closedarrow";this._progressImageClass="core-sprite-progress";this._twistieSpriteClass="modelDecorationSprite"};e.prototype={_init:function(a){a&&(this._useCheckboxSelection=void 0===a.checkbox?!1:a.checkbox,this.selectionPolicy=a.singleSelection?"singleSelection":"",this._cachePrefix=a.cachePrefix,this.getCheckedFunc=a.getCheckedFunc,this.onCheckedFunc=
a.onCheckedFunc,this._highlightSelection=!0,this._treeTableClass=a.treeTableClass||"treetable",!1===a.highlightSelection&&(this._highlightSelection=!1),this.actionScopeId||(this.actionScopeId=a.actionScopeId),this.commandService||(this.commandService=a.commandService))},getLabelColumnIndex:function(){return this.explorer.checkbox?1:0},initTable:function(a,e){this.tableTree=e;p.empty(a);this._treeTableClass&&a.classList.add(this._treeTableClass);this.renderTableHeader(a)},getActionsColumn:function(a,
e,c,b,l){var c=c||"tool",m=document.createElement("td");m.id=e.id+"actionswrapper";b&&m.classList.add(b);this.actionScopeId&&this.commandService?this.commandService.renderCommands(this.actionScopeId,m,a,this.explorer,c,null,l&&this.explorer.getNavDict()?this.explorer.getNavDict().getGridNavHolder(a,!0):null):window.console.log("Warning, no command service or action scope was specified.  No commands rendered.");return m},initCheckboxColumn:function(){if(this._useCheckboxSelection)return document.createElement("th")},
getCheckboxColumn:function(a,e){if(this._useCheckboxSelection){var c=document.createElement("td"),b=document.createElement("span");b.id=this.getCheckBoxId(e.id);b.classList.add("core-sprite-check");b.classList.add("selectionCheckmarkSprite");b.rowId=e.id;this.getCheckedFunc&&(b.checked=this.getCheckedFunc(a),b.checked?(this._highlightSelection&&e.classList.add("checkedRow"),b.classList.add("core-sprite-check_on")):(this._highlightSelection&&e.classList.remove("checkedRow"),b.classList.remove("core-sprite-check_on")));
c.appendChild(b);var l=this;b.addEventListener("click",function(b){l.onCheck(e,b.target,b.target.checked?!1:!0,!0)},!1);return c}},getCheckBoxId:function(a){return a+"selectedState"},onCheck:function(a,e,c,b,l){(e.checked=c)?e.classList.add("core-sprite-check_on"):e.classList.remove("core-sprite-check_on");if(this.onCheckedFunc)this.onCheckedFunc(e.rowId,c,b);this.explorer.getNavHandler()&&l&&this.explorer.getNavHandler().setSelection(this.explorer.getNavDict().getValue(a.id).model,!0)},storeSelections:function(){if(this.explorer.getNavHandler()){var a=
this.explorer.getNavHandler().getSelectionIds(),e=this._getUIStatePreferencePath();e&&window.sessionStorage&&(window.sessionStorage[e+"selection"]=JSON.stringify(a))}},_restoreSelections:function(a){var e=this.explorer.getNavDict(),c=this.explorer.getNavHandler();if(c&&(e&&"cursorOnly"!==c.getSelectionPolicy())&&(a=window.sessionStorage[a+"selection"],"string"===typeof a&&(a=0<a.length?JSON.parse(a):null),a)){for(var b=[],c=0;c<a.length;c++){var l=e.getValue(a[c]);if(l&&(l.rowDomNode&&l.model)&&(b.push(l.model),
this._highlightSelection&&l.rowDomNode.classList.add("checkedRow"),l=p.node(this.getCheckBoxId(l.rowDomNode.id))))l.checked=!0,l.classList.add("core-sprite-check_on")}this.explorer.selection&&(this.explorer.selection.setSelections(b),this.explorer.getNavHandler()&&this.explorer.getNavHandler().refreshSelection())}},_storeExpansions:function(a){window.sessionStorage[a+"expanded"]=JSON.stringify(this._expanded)},_restoreExpansions:function(a){var e=!1,c=window.sessionStorage[a+"expanded"];"string"===
typeof c&&(c=0<c.length?JSON.parse(c):null);var b;if(c)for(b=0;b<c.length;b++)if(p.node(c[b])){this._expanded.push(c[b]);var l=this;this.tableTree.expand(c[b],function(){l._restoreSelections(a)});e=!0}return!e},_getUIStatePreferencePath:function(){if(this.explorer){var a=this.explorer.getRootPath();if(this._cachePrefix&&a)return a=a.replace(/[^\.\:\-\_0-9A-Za-z]/g,""),"/"+this._cachePrefix+"/"+a+"/uiState"}return null},expandCollapseImageId:function(a){return a+"__expand"},updateExpandVisuals:function(a,
e){var c=p.node(this.expandCollapseImageId(a.id));c&&(c.classList.remove(this._expandImageClass),c.classList.remove(this._collapseImageClass),c.classList.remove(this._progressImageClass),c.classList.add("progress"===e?this._progressImageClass:e?this._expandImageClass:this._collapseImageClass))},getExpandImage:function(a,e,c,b){var l=document.createElement("span");l.id=this.expandCollapseImageId(a.id);e.appendChild(l);l.classList.add(this._twistieSpriteClass);l.classList.add(this._collapseImageClass);
if(c){var m=document.createElement("span");e.appendChild(m);m.classList.add(b||"imageSprite");m.classList.add(c)}var r=this;l.onclick=function(){if(!r.explorer.getNavHandler().isDisabled(a)){r.tableTree.toggle(a.id);if(r.tableTree.isExpanded(a.id))r._expanded.push(a.id),r.explorer.postUserExpand&&r.explorer.postUserExpand(a.id);else for(var b in r._expanded)if(r._expanded[b]===a.id){r._expanded.splice(b,1);break}(b=r._getUIStatePreferencePath())&&window.sessionStorage&&r._storeExpansions(b)}};return l},
render:function(a,e){e.classList.add("navRow");this.renderRow(a,e)},rowsChanged:function(){"cursorOnly"!==this.explorer.selectionPolicy&&(this.explorer.refreshSelection(),this.explorer.initNavHandler())},updateCommands:function(){if(this.commandService)for(var a=p.$$array(".treeTableRow"),e=0;e<a.length;e++){var c=a[e],b=p.node(c.id+"actionswrapper");this.commandService.destroy(b);this.actionScopeId&&this.commandService.renderCommands(this.actionScopeId,b,c._item,this.explorer,"tool")}},_initializeUIState:function(){this._expanded=
[];var a=this._getUIStatePreferencePath();a&&window.sessionStorage&&this._restoreExpansions(a)&&this._restoreSelections(a)}};n.ExplorerRenderer=e;e=function(a,e){this._init(a);this.explorer=e};e.prototype=new n.ExplorerRenderer;e.prototype.renderTableHeader=function(a){var e=document.createElement("thead"),c=document.createElement("tr");e.classList.add("navTableHeading");this._useCheckboxSelection&&c.appendChild(this.initCheckboxColumn(a));for(var b=0,l=this.getCellHeaderElement(b);l;)0<l.innerHTML.length&&
l.classList.add("navColumn"),c.appendChild(l),l=this.getCellHeaderElement(++b);e.appendChild(c);0<b&&a.appendChild(e)};e.prototype.renderRow=function(a,e){e.verticalAlign="baseline";e.classList.add("treeTableRow");var c=this.explorer.getNavDict();if(c){c.addRow(a,e);var b=this;e.addEventListener("click",function(c){if(b.explorer.getNavHandler())b.explorer.getNavHandler().onClick(a,c)},!1)}if(c=this.getCheckboxColumn(a,e))c.classList.add("checkColumn"),e.appendChild(c);for(var c=0,l=this.getCellElement(c,
a,e);l;)e.appendChild(l),0===c?this.getPrimColumnStyle?l.classList.add(this.getPrimColumnStyle(a)):l.classList.add("navColumn"):this.getSecondaryColumnStyle?l.classList.add(this.getSecondaryColumnStyle()):l.classList.add("secondaryColumn"),l=this.getCellElement(++c,a,e)};e.prototype.getCellHeaderElement=function(){};e.prototype.getCellElement=function(){};n.SelectionRenderer=e;e=function(a,e,c){this.items=a;this.getKey=c;this.idPrefix=e;this.root={children:a}};e.prototype=new n.ExplorerModel;e.prototype.getRoot=
...
define("orion/explorers/explorer-table","i18n!orion/navigate/nls/messages orion/Deferred orion/webui/littlelib orion/i18nUtil orion/fileUtils orion/explorers/explorer orion/EventTarget orion/objects orion/util".split(" "),function(g,n,p,a,k,f,e,d,h){function c(b,c,a,d,l,e){this.registry=b;this.root=c;this.fileClient=a;this.idPrefix=d||"";this.excludeFiles=!!l;this.excludeFolders=!!e}function b(b){e.attach(this);this.registry=b.serviceRegistry;this.treeRoot=b.treeRoot;this.selection=b.selection;this.fileClient=
...
_makeDropTarget:function(b,c,d){function e(c,q,v,d,l,m){q=q||"";if(c.isFile)k.isAtRoot(v.Location)?d.registry&&d.registry.getService("orion.page.message").setProgressResult({Severity:"Error",Message:g["You cannot copy files directly into the workspace.  Create a folder first."]}):c.file(function(q){l(v,q,d,q.name.indexOf(".zip")===q.name.length-4&&window.confirm(a.formatMessage(g["Unzip ${0}?"],q.name)))});else if(c.isDirectory){var h=c.createReader(),f=function(b){h.readEntries(function(a){for(var v=
0;v<a.length;v++)e(a[v],q+c.name+"/",b,d,l,m)})},s=null;d.registry&&(s=d.registry.getService("orion.page.progress"));k.isAtRoot(v.Location)?(s?s.progress(m.createProject(v.ChildrenLocation,c.name),a.formatMessage(g["Creating ${0}"],c.name)):m.createProject(v.ChildrenLocation,c.name)).then(function(q){d.loadResourceList(d.treeRoot.Path,!0);(s?s.progress(m.read(q.ContentLocation,!0),g["Loading "]+q.name):m.read(q.ContentLocation,!0)).then(function(q){f(q)})}):(s?s.progress(m.createFolder(v.Location,
c.name),a.formatMessage(g["Creating ${0}"],c.name)):m.createFolder(v.Location,c.name)).then(function(q){d.modelEventDispatcher.dispatchEvent({type:"create",parent:b,newValue:q});f(q)})}}if(this.dragAndDrop){var f=this,n=this.dragAndDrop,u=function(b){l=b.target};d&&(this._oldDragStart&&c.removeEventListener("dragstart",this._oldDragStart,!1),this._oldDragStart=u);c.addEventListener("dragstart",u,!1);u=function(){l=null};d&&(this._oldDragEnd&&c.removeEventListener("dragend",this._oldDragEnd,!1),this._oldDragEnd=
u);c.addEventListener("dragend",u,!1);u=function(b){c.classList.remove("dragOver");b.preventDefault();b.stopPropagation()};d&&(this._oldDragLeave&&c.removeEventListener("dragleave",this._oldDragLeave,!1),this._oldDragLeave=u);c.addEventListener("dragleave",u,!1);u=function(b){if(l)m=b.dataTransfer.dropEffect=(h.isMac?b.altKey:b.ctrlKey)?"copy":"move";else if(!h.isIE&&("all"===b.dataTransfer.effectAllowed||"uninitialized"===b.dataTransfer.effectAllowed||0<=b.dataTransfer.effectAllowed.indexOf("copy")))b.dataTransfer.dropEffect=
"copy";c.classList.add("dragOver");p.stop(b)};d&&(this._oldDragEnter&&c.removeEventListener("dragenter",this._oldDragEnter,!1),this._oldDragEnter=u);c.addEventListener("dragenter",u,!1);u=function(b){if(l)m=b.dataTransfer.dropEffect=(h.isMac?b.altKey:b.ctrlKey)?"copy":"move";else if(!h.isIE&&("all"===b.dataTransfer.effectAllowed||"uninitialized"===b.dataTransfer.effectAllowed||0<=b.dataTransfer.effectAllowed.indexOf("copy")))b.dataTransfer.dropEffect="copy";p.stop(b)};d&&!this._oldDragOver&&(c.addEventListener("dragover",
u,!1),this._oldDragOver=u);u=function(d){var q;c.classList.remove("dragOver");if(l){q=f.fileClient;for(var v=l,A;v;){if(v._item){A=v._item;break}v=v.parentNode}if(!A)return;var C=null;f.registry&&(C=f.registry.getService("orion.page.progress"));var h="copy"===m,v=h?q.copyFile:q.moveFile;(C?C.showWhile(v.apply(q,[A.Location,b.Location]),a.formatMessage(g[h?"Copying ${0}":"Moving ${0}"],A.Location)):v.apply(q,[A.Location,b.Location])).then(function(q){f.modelEventDispatcher.dispatchEvent({type:h?"copy":
"move",oldValue:A,newValue:q,parent:b})},function(q){C?C.setProgressResult(q):window.console.log(q)})}else if(d.dataTransfer.items&&0<d.dataTransfer.items.length)for(q=0;q<d.dataTransfer.items.length;q++)v=null,"function"===typeof d.dataTransfer.items[q].getAsEntry?v=d.dataTransfer.items[q].getAsEntry():"function"===typeof d.dataTransfer.items[q].webkitGetAsEntry&&(v=d.dataTransfer.items[q].webkitGetAsEntry()),v&&e(v,null,b,f,n,f.fileClient);else if(d.dataTransfer.files&&0<d.dataTransfer.files.length)for(q=
0;q<d.dataTransfer.files.length;q++)v=d.dataTransfer.files[q],!v.length&&(!v.type||""===v.type)?f.registry&&f.registry.getService("orion.page.message").setProgressResult({Severity:"Error",Message:a.formatMessage(g["Did not drop ${0}.  Folder drop is not supported in this browser."],v.name)}):k.isAtRoot(b.Location)?f.registry&&f.registry.getService("orion.page.message").setProgressResult({Severity:"Error",Message:g["You cannot copy files directly into the workspace.  Create a folder first."]}):n(b,
v,f,v.name.indexOf(".zip")===v.name.length-4&&window.confirm(a.formatMessage(g["Unzip ${0}?"],v.name)));p.stop(d)};d&&(this._oldDrop&&c.removeEventListener("drop",this._oldDrop,!1),this._oldDrop=u);c.addEventListener("drop",u,!1)}},createModel:function(){return new c(this.registry,this.treeRoot,this.fileClient,this.parentId,this.excludeFiles,this.excludeFolders)},changedItem:function(b,c){if(this.treeRoot&&this.treeRoot.Location===b.Location)return this.loadResourceList(this.treeRoot,c);var a=this,
d=new n;b.children=null;this.model.getChildren(b,function(l){a.getNavHandler();a.myTree.refresh.bind(a.myTree)(b,l,c);d.resolve(l)});return d},showItem:function(b,c){var a=new n;if(!b||!this.model||!this.myTree||!this.myTree.showRoot&&b.Location===this.treeRoot.Location)return a.reject();var d=this.getRow(b);if(d)a.resolve(d._item||b);else return b.Parents&&0<b.Parents.length?(b.Parents[0].Parents=b.Parents.slice(1),this.expandItem(b.Parents[0],c).then(function(c){var a=this.getRow(b);return!a?this.changedItem(c,
...
return b}.bind(this))},reroot:function(){return(new n).reject()},isExpanded:function(b){b=this.model.getId(b);return this.renderer.tableTree.isExpanded(b)},getNameNode:function(b){if(b=this.model.getId(b))return p.node(b+"NameLink")},scopeUp:function(){},scopeDown:function(){},loadResourceList:function(b,c,a){b&&"object"===typeof b&&(b=b.ChildrenLocation||b.ContentLocation);b=k.makeRelative(b);if(!c&&b===this._lastPath)return(new n).resolve(this.treeRoot);this._lastPath=b;var d=this;return c||b!==
this.treeRoot.Path?this.load(this.fileClient.loadWorkspace(b),g["Loading "]+b).then(function(){d.treeRoot.Path=b;"function"===typeof a&&a();d.dispatchEvent({type:"rootChanged",root:d.treeRoot});return(new n).resolve(d.treeRoot)},function(b){d.treeRoot.Path=null;d.dispatchEvent({type:"rootChanged",root:d.treeRoot});return(new n).reject(b)}):(new n).resolve(d.treeRoot)},load:function(b,c,a){var d=p.node(this.parentId),l=p.node("progress");l||(l=document.createElement("div"),l.id="progress",p.empty(d),
d.appendChild(l));p.empty(l);var e=setTimeout(function(){p.empty(l);l.appendChild(document.createTextNode(c))},500),m=this;return n.when(b,function(b){clearTimeout(e);if(!m.destroyed){m.treeRoot={};for(var q in b)m.treeRoot[q]=b[q];m.model=m.createModel();m.dragAndDrop&&(m._hookedDrag?m._makeDropTarget(m.treeRoot,d,!0):(b=(b=d&&("draggable"in d||"ondragstart"in d&&"ondrop"in d))&&!(!window.File||!window.FileList||!window.FileReader),m._hookedDrag=!0,b?m._makeDropTarget(m.treeRoot,d,!0):(m.dragAndDrop=
null,window.console.log("Local file drag and drop is not supported in this browser."))));var c=new n;m.createTree(m.parentId,m.model,{onComplete:function(b){c.resolve(b)},navHandlerFactory:m.navHandlerFactory,setFocus:"undefined"===typeof m.setFocus?!0:m.setFocus,selectionPolicy:m.renderer.selectionPolicy,onCollapse:function(b){if(m.getNavHandler())m.getNavHandler().onCollapse(b)}});return c.then(function(){if("function"===typeof a)try{a()}catch(b){m.registry&&m.registry.getService("orion.page.message").setErrorMessage(b)}if("function"===
typeof m.onchange)m.onchange(m.treeRoot);return m.treeRoot})}},function(b){clearTimeout(e);m.registry&&m.registry.getService("orion.page.message").setProgressResult(b);return(new n).reject(b)})},onchange:function(){}});b.prototype.constructor=b;return{FileExplorer:b,FileModel:c}});
define("orion/explorers/navigationUtils",[],function(){function g(g,a){!n&&g&&(g.push({domNode:a}),a.tabIndex=-1,a.style.outline="none")}var n=-1!==navigator.userAgent.indexOf("iPad");return{addNavGrid:function(n,a,k){n&&(n=n.getGridNavHolder(a,!0))&&g(n,k)},generateNavGrid:g,removeNavGrid:function(g,a){if(g)for(var k=0;k<g.length;k++)if(g[k].domNode===a){g.splice(k,1);break}}}});define("orion/extensionCommands",[],function(){return{getOpenWithCommands:function(){return[]}}});
...
[],e=0;e<b.length;e++)"undefined"!==typeof b[e]&&d.push(p(b[e],c));return d.join(a)}function k(b,c,a,d){for(var e=Object.keys(b),k=[],h=0;h<e.length;h++)"undefined"!==typeof b[e[h]]&&k.push(p(e[h],c)+a+p(b[e[h]],c));return k.join(d)}function f(b){if(0===b.length)throw Error("Invalid Expression: 0 length expression");(this._operator=d[b[0]])?b=b.substring(1):this._operator=d.NUL;for(var c=[],a=b.split(","),e=0;e<a.length;e++){var k=a[e].match(h);if(null===k)throw Error("Bad VarSpec: "+b);c.push({name:k[1],
explode:!!k[2],prefix:k[3]?parseInt(k[3],10):-1})}this._varSpecList=c}function e(b){for(var c=[],a=0,d=b.indexOf("{",a);-1!==d;){c.push(new g(b.substring(a,d)));a=b.indexOf("}",d+1);if(-1===a)throw Error("Invalid template: "+b);c.push(new f(b.substring(d+1,a)));a+=1;d=b.indexOf("{",a)}c.push(new g(b.substring(a)));this._templateComponents=c}var d={NUL:{first:"",sep:",",named:!1,ifemp:"",allow:"U"},"+":{first:"",sep:",",named:!1,ifemp:"",allow:"U+R"},".":{first:".",sep:",",named:!1,ifemp:"",allow:"U"},
...
f.prototype={expand:function(b){for(var c=[],d=0;d<this._varSpecList.length;d++){var e=this._varSpecList[d],h=e.name,f=b[h],g=typeof f;if("undefined"!==g&&null!==f){var w=0===c.length?this._operator.first:this._operator.sep,n=w;if("string"===g)this._operator.named&&(n+=p(h,"U+R"),n+=0===f.length?this._operator.ifemp:"="),-1!==e.prefix&&e.prefix<f.length&&(f=f.substring(0,e.prefix)),n+=p(f,this._operator.allow);else if(Array.isArray(f))e.explode?n+=a(f,this._operator.allow,this._operator.sep):(this._operator.named&&
(n+=p(h,"U+R"),n+=0===f.length?this._operator.ifemp:"="),n+=a(f,this._operator.allow,","));else if("object"===g)e.explode?n+=k(f,this._operator.allow,"=",this._operator.sep):(this._operator.named&&(n+=p(h,"U+R"),n+=0===Object.keys(f).length?this._operator.ifemp:"="),n+=k(f,this._operator.allow,",",","));else throw Error("bad param type: "+h+" : "+g);(n!==w||d<this._varSpecList.length-1)&&c.push(n)}}return c.join("")}};e.prototype={expand:function(b){for(var c=[],a=0;a<this._templateComponents.length;a++)c.push(this._templateComponents[a].expand(b));
return c.join("")}};return e});
define("orion/explorers/navigatorRenderer","i18n!orion/navigate/nls/messages orion/Deferred orion/explorers/explorer orion/explorers/navigationUtils orion/extensionCommands orion/objects orion/URITemplate orion/webui/littlelib".split(" "),function(g,n,p,a,k,f,e,d){function h(b){switch(b&&b.id){case "image/jpeg":case "image/png":case "image/gif":case "image/ico":case "image/tiff":case "image/svg":return!0}return!1}function c(b,c,a,d,g,w,p,u,z,q){var c=f.clone(c),v;if(c.Directory)v=document.createElement("a"),
v.className="navlinkonpage",v.href=!b?l:(new e(b+"#{,resource,params*}")).expand({resource:c.ChildrenLocation}),c.Name&&v.appendChild(document.createTextNode(c.Name));else{g||(g=k.getOpenWithCommands(a));if(!w)for(b=0;b<g.length;b++)"default"===g[b].isEditor&&(w=g[b]);v=document.createElement("a");v.className="navlink targetSelector";p&&"object"===typeof p&&Object.keys(p).forEach(function(b){v[b]=p[b]});var A=null,C=null;if(A=z?z.holderDom:v)C=document.createElement("span"),C.className="core-sprite-file modelDecorationSprite thumbnail",
A.appendChild(C);c.Name&&v.appendChild(document.createTextNode(c.Name));var D=!1,M=c.Location;u&&"object"===typeof u&&(c.params={},f.mixin(c.params,u));for(b=0;b<g.length;b++)if(u=g[b],u.visibleWhen(c)){M=u.hrefCallback({items:c});D=!0;break}n.when(d.getFileContentType(c),function(b){!D&&(w&&!h(b))&&(M=w.hrefCallback({items:c}));if(A){var a=A,d=C;if(b){var l,e=b.imageClass,m=b.image;e?(l=document.createElement("span"),l.className+=e,l.classList.add("thumbnail")):m&&(l=document.createElement("img"),
l.src=m,l.classList.add("thumbnail"));l&&a.replaceChild(l,d)}}v.href=M;q&&"function"===typeof q.updateFileNode&&q.updateFileNode(c,v,h(b))})}return v}function b(b,c,a,d){this.explorer=c;this.commandService=a;this.contentTypeService=d;this.openWithCommands=null;this.actionScopeId=b.actionScopeId;this._init(b);this.target="_self"}var l=new e("#{,resource,params*}");b.prototype=new p.SelectionRenderer;b.prototype.wrapperCallback=function(b){b.setAttribute("role","tree")};b.prototype.tableCallback=function(b){b.setAttribute("aria-label",
g.Navigator);b.setAttribute("role","presentation")};b.prototype.rowCallback=function(b){b.setAttribute("role","treeitem")};b.prototype.emptyCallback=function(b){var c=document.createElement("tr"),a=document.createElement("td");a.colSpan=this.oneColumn?1:3;var l=document.createElement("div");l.classList.add("noFile");l.textContent=g.NoFile;var e=document.createElement("span");e.appendChild(document.createTextNode(g.File));d.processDOMNodes(l,[e]);a.appendChild(l);c.appendChild(a);b.appendChild(c)};
b.prototype.getCellHeaderElement=function(b){if(this.oneColumn&&0!==b)return null;switch(b){case 0:case 1:case 2:document.createElement("th").style.height="8px"}};b.prototype.setTarget=function(b){this.target=b};b.prototype.getFolderImage=function(){if(!this.showFolderImage)return null;var b=document.createElement("span");b.className="core-sprite-folder modelDecorationSprite";return b};b.prototype.createFolderNode=function(b){var a;this.showFolderLinks?(a=c(this.folderLink||"",b,this.commandService,
this.contentTypeService),(b=this.getFolderImage(b))&&a.insertBefore(b,a.firstChild)):(a=document.createElement("span"),a.textContent=b.Name);return a};b.prototype.updateFileNode=function(){};b.prototype.showFolderLinks=!0;b.prototype.getCellElement=function(b,d,l){switch(b){case 0:var b=document.createElement("td"),e=document.createElement("span");e.id=l.id+"MainCol";e.setAttribute("role","presentation");b.appendChild(e);b.setAttribute("role","presentation");e.className="mainNavColumn";var h;if(d.Directory)this.getExpandImage(l,
e),h=this.createFolderNode(d),e.appendChild(h),this.explorer._makeDropTarget(d,h),this.explorer._makeDropTarget(d,l);else{if(!this.openWithCommands){this.openWithCommands=k.getOpenWithCommands(this.commandService);for(h=0;h<this.openWithCommands.length;h++)"default"===this.openWithCommands[h].isEditor&&(this.defaultEditor=this.openWithCommands[h])}h=c("",d,this.commandService,this.contentTypeService,this.openWithCommands,this.defaultEditor,{target:this.target},null,null,this);e.appendChild(h)}h&&
(h.id=l.id+"NameLink",1===h.nodeType&&(a.addNavGrid(this.explorer.getNavDict(),d,h),h.setAttribute("role","link"),h.setAttribute("tabindex","-1")));this.actionScopeId&&this.commandService.renderCommands(this.actionScopeId,e,d,this.explorer,"tool",null,!0);return b;case 1:if(this.oneColumn)return null;l=document.createElement("td");d.LocalTimeStamp&&(l.textContent=(new Date(d.LocalTimeStamp)).toLocaleString());return l;case 2:if(this.oneColumn)return null;l=document.createElement("td");!d.Directory&&
"number"===typeof d.Length&&(d=parseInt(d.Length,10)/1024,l.textContent=Math.ceil(d).toLocaleString()+" KB");l.style.textAlign="right";return l}};b.prototype.constructor=b;return{NavigatorRenderer:b,isImage:h,createLink:c}});
...
function a(b,c){return b.replace(!c?/&(?!#?\w+;)/g:/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function k(b,c){b=b.source;c=c||"";return function r(a,d){if(!a)return RegExp(b,c);d=d.source||d;d=d.replace(/(^|[^\[])\^/g,"$1");b=b.replace(a,d);return r}}function f(){}function e(b){for(var c=1,a,d;c<arguments.length;c++)for(d in a=arguments[c],a)Object.prototype.hasOwnProperty.call(a,d)&&(b[d]=a[d]);return b}function d(b,c,m){if(m||"function"===
typeof c){m||(m=c,c=null);c&&(c=e({},d.defaults,c));var k=c.highlight,h,f,t=0;try{h=g.lex(b,c)}catch(w){return m(w)}f=h.length;var n=function(b){var q,a;!0!==b&&delete c.highlight;try{q=p.parse(h,c)}catch(d){a=d}c.highlight=k;return a?m(a):m(null,q)};if(!k||3>k.length)return n(!0);if(!f)return n();for(;t<h.length;t++)(function(b){return"code"!==b.type?--f||n():k(b.text,b.lang,function(q,c){if(null==c||c===b.text)return--f||n();b.text=c;b.escaped=!0;--f||n()})})(h[t])}else try{return c&&(c=e({},d.defaults,
c)),p.parse(g.lex(b,c),c)}catch(u){u.message+="\nPlease report this to https://github.com/chjj/marked.";if((c||d.defaults).silent)return"<p>An error occured:</p><pre>"+a(u.message+"",!0)+"</pre>";throw u;}}var h={newline:/^\n+/,code:/^( {4}[^\n]+\n*)+/,fences:f,hr:/^( *[-*_]){3,} *(?:\n+|$)/,heading:/^ *(#{1,6}) *([^\n]+?) *#* *(?:\n+|$)/,nptable:f,lheading:/^([^\n]+)\n *(=|-){3,} *\n*/,blockquote:/^( *>[^\n]+(\n[^\n]+)*\n*)+/,list:/^( *)(bull) [\s\S]+?(?:hr|\n{2,}(?! )(?!\1bull )\n*|\s*$)/,html:/^ *(?:comment|closed|closing) *(?:\n{2,}|\s*$)/,
def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +["(]([^\n]+)[")])? *(?:\n+|$)/,table:f,paragraph:/^((?:[^\n]+\n?(?!hr|heading|lheading|blockquote|tag|def))+)\n*/,text:/^[^\n]+/,bullet:/(?:[*+-]|\d+\.)/,item:/^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/};h.item=k(h.item,"gm")(/bull/g,h.bullet)();h.list=k(h.list)(/bull/g,h.bullet)("hr",/\n+(?=(?: *[-*_]){3,} *(?:\n+|$))/)();h._tag="(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|@)\\b";
h.html=k(h.html)("comment",/<\!--[\s\S]*?--\>/)("closed",/<(tag)[\s\S]+?<\/\1>/)("closing",/<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g,h._tag)();h.paragraph=k(h.paragraph)("hr",h.hr)("heading",h.heading)("lheading",h.lheading)("blockquote",h.blockquote)("tag","<"+h._tag)("def",h.def)();h.normal=e({},h);h.gfm=e({},h.normal,{fences:/^ *(`{3,}|~{3,}) *(\S+)? *\n([\s\S]+?)\s*\1 *(?:\n+|$)/,paragraph:/^/});h.gfm.paragraph=k(h.paragraph)("(?!","(?!"+h.gfm.fences.source.replace("\\1","\\2")+"|")();h.tables=
e({},h.gfm,{nptable:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,table:/^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/});g.rules=h;g.lex=function(b,c){return(new g(c)).lex(b)};g.prototype.lex=function(b){b=b.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ").replace(/\u00a0/g," ").replace(/\u2424/g,"\n");return this.token(b,!0)};g.prototype.token=function(b,c){for(var b=b.replace(/^ +$/gm,""),a,d,e,k,f,g,n;b;){if(e=this.rules.newline.exec(b))b=b.substring(e[0].length),1<
...
c.gfm=e({},c.normal,{escape:k(c.escape)("])","~|])")(),url:/^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/,del:/^~~(?=\S)([\s\S]*?\S)~~/,text:k(c.text)("]|","~]|")("|","|https?://|")()});c.breaks=e({},c.gfm,{br:k(c.br)("{2,}","*")(),text:k(c.gfm.text)("{2,}","*")()});n.rules=c;n.output=function(b,c,a){return(new n(c,a)).output(b)};n.prototype.output=function(b){for(var c="",d,e;b;)if(e=this.rules.escape.exec(b))b=b.substring(e[0].length),c+=e[1];else if(e=this.rules.autolink.exec(b))b=b.substring(e[0].length),
...
define("orion/editor/eventTarget",[],function(){function g(){}g.addMixin=function(n){var p=g.prototype,a;for(a in p)p.hasOwnProperty(a)&&(n[a]=p[a])};g.prototype={addEventListener:function(g,p,a){this._eventTypes||(this._eventTypes={});var k=this._eventTypes[g];k||(k=this._eventTypes[g]={level:0,listeners:[]});k.listeners.push({listener:p,useCapture:a})},dispatchEvent:function(g){var p=g.type;this._dispatchEvent("pre"+p,g);this._dispatchEvent(p,g);this._dispatchEvent("post"+p,g)},_dispatchEvent:function(g,
p){var a=this._eventTypes?this._eventTypes[g]:null;if(a){var k=a.listeners;try{if(a.level++,k)for(var f=0,e=k.length;f<e;f++)if(k[f]){var d=k[f].listener;"function"===typeof d?d.call(this,p):d.handleEvent&&"function"===typeof d.handleEvent&&d.handleEvent(p)}}finally{if(a.level--,a.compact&&0===a.level){for(f=k.length-1;0<=f;f--)k[f]||k.splice(f,1);0===k.length&&delete this._eventTypes[g];a.compact=!1}}}},isListening:function(g){return!this._eventTypes?!1:void 0!==this._eventTypes[g]},removeEventListener:function(g,
p,a){if(this._eventTypes){var k=this._eventTypes[g];if(k){for(var f=k.listeners,e=0,d=f.length;e<d;e++){var h=f[e];if(h&&h.listener===p&&h.useCapture===a){0!==k.level?(f[e]=null,k.compact=!0):f.splice(e,1);break}}0===f.length&&delete this._eventTypes[g]}}}};return{EventTarget:g}});define("orion/regex",[],function(){return{escape:function(g){return g.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g,"\\$&")},parse:function(g){return(g=/^\s*\/(.+)\/([gim]{0,3})\s*$/.exec(g))?{pattern:g[1],flags:g[2]}:null}}});
...
"[Ii\u0130\u0131]"));var b=null,l;if(d){var f=a.reverse,m=a.wrap,e=a.wholeWord,r=a.start||0,a=a.end,g=null!==a&&void 0!==a;-1===h.indexOf("g")&&(h+="g");-1===h.indexOf("m")&&(h+="m");c&&-1===h.indexOf("i")&&(h+="i");e&&(d="\\b"+d+"\\b");var x=this._text[0],t,w,p=0;g&&(c=r<a?r:a,x=x.substring(c,r<a?a:r),p=c);var u=RegExp(d,h);f?l=function(){var b=null;for(u.lastIndex=0;;){w=u.lastIndex;t=u.exec(x);if(w===u.lastIndex)return null;if(t){if(!(t.index+p<r)){if(!m||b)break;r=x.length+p}b={start:t.index+
p,end:u.lastIndex+p}}else break}b&&(r=b.start);return b}:(g||(u.lastIndex=r),l=function(){for(;;){w=u.lastIndex;t=u.exec(x);if(w===u.lastIndex)break;if(t)return{start:t.index+p,end:u.lastIndex+p};if(!(0!==w&&m))break}return null});b=l()}return{next:function(){var c=b;c&&(b=l());return c},hasNext:function(){return null!==b}}},getCharCount:function(){for(var a=0,f=0;f<this._text.length;f++)a+=this._text[f].length;return a},getLine:function(a,f){var e=this.getLineCount();if(!(0<=a&&a<e))return null;
var d=this._lineOffsets[a];if(a+1<e){e=this.getText(d,this._lineOffsets[a+1]);if(f)return e;for(var d=e.length,h;10===(h=e.charCodeAt(d-1))||13===h;)d--;return e.substring(0,d)}return this.getText(d)},getLineAtOffset:function(a){var f=this.getCharCount();if(!(0<=a&&a<=f))return-1;var e=this.getLineCount();if(a===f)return e-1;var d,h,c=this._lastLineIndex;if(0<=c&&c<e&&(d=this._lineOffsets[c],h=c+1<e?this._lineOffsets[c+1]:f,d<=a&&a<h))return c;for(var b=e,l=-1;1<b-l;)if(c=Math.floor((b+l)/2),d=this._lineOffsets[c],
h=c+1<e?this._lineOffsets[c+1]:f,a<=d)b=c;else if(a<h){b=c;break}else l=c;return this._lastLineIndex=b},getLineCount:function(){return this._lineOffsets.length},getLineDelimiter:function(){return this._lineDelimiter},getLineEnd:function(a,f){var e=this.getLineCount();if(!(0<=a&&a<e))return-1;if(a+1<e){e=this._lineOffsets[a+1];if(f)return e;for(var d=this.getText(Math.max(this._lineOffsets[a],e-2),e),h=d.length,c;10===(c=d.charCodeAt(h-1))||13===c;)h--;return e-(d.length-h)}return this.getCharCount()},
...
this.getCharCount());if(!(f===e&&""===a)){for(var d=this.getLineAtOffset(f),h=this.getLineAtOffset(e),c=f,b=e-f,l=h-d,m=a.length,r=0,g=this.getLineCount(),n=0,t=0,w=0,p=[];;){-1!==n&&n<=w&&(n=a.indexOf("\r",w));-1!==t&&t<=w&&(t=a.indexOf("\n",w));if(-1===t&&-1===n)break;w=-1!==n&&-1!==t?n+1===t?t+1:(n<t?n:t)+1:-1!==n?n+1:t+1;p.push(f+w);r++}this.onChanging({type:"Changing",text:a,start:c,removedCharCount:b,addedCharCount:m,removedLineCount:l,addedLineCount:r});0===p.length&&(w=this.getLineStart(d),
h=h+1<g?this.getLineStart(h+1):this.getCharCount(),f!==w&&(a=this.getText(w,f)+a,f=w),e!==h&&(a+=this.getText(e,h),e=h));w=m-b;for(h=d+l+1;h<g;h++)this._lineOffsets[h]+=w;if(5E4>p.length)d=[d+1,l].concat(p),Array.prototype.splice.apply(this._lineOffsets,d);else{w=d+1;this._lineOffsets.splice(w,l);for(g=0;g<p.length;g+=5E4)d=[w,0].concat(p.slice(g,Math.min(p.length,g+5E4))),Array.prototype.splice.apply(this._lineOffsets,d),w+=5E4}for(w=g=0;w<this._text.length;){h=this._text[w].length;if(f<=g+h)break;
g+=h;w++}d=g;for(p=w;w<this._text.length;){h=this._text[w].length;if(e<=g+h)break;g+=h;w++}h=this._text[w];f=this._text[p].substring(0,f-d);e=h.substring(e-g);p=[p,w-p+1];f&&p.push(f);a&&p.push(a);e&&p.push(e);Array.prototype.splice.apply(this._text,p);0===this._text.length&&(this._text=[""]);this.onChanged({type:"Changed",start:c,removedCharCount:b,addedCharCount:m,removedLineCount:l,addedLineCount:r})}}};g.EventTarget.addMixin(a.prototype);return{TextModel:a}});
define("orion/keyBinding",["orion/util"],function(g){function n(a,k,f,e,d,h){this.type=h||"keydown";this.keyCode="string"===typeof a&&"keydown"===this.type?a.toUpperCase().charCodeAt(0):a;this.mod1=void 0!==k&&null!==k?k:!1;this.mod2=void 0!==f&&null!==f?f:!1;this.mod3=void 0!==e&&null!==e?e:!1;this.mod4=void 0!==d&&null!==d?d:!1}function p(a){this.keys=a}n.prototype={getKeys:function(){return[this]},match:function(a,k){if(void 0!==k){if(0!==k)return!1}else if(a instanceof Array){if(1<a.length)return!1;
...
match:function(a,k){var f=this.keys;if(void 0!==k)return k>f.length?!1:f[k].match(a)?k===f.length-1?!0:k+1:!1;a instanceof Array||(a=[a]);if(a.length>f.length)return!1;var e;for(e=0;e<a.length;e++)if(!f[e].match(a[e]))return!1;return e===f.length?!0:e},equals:function(a){if(!a.keys||a.keys.length!==this.keys.length)return!1;for(var k=0;k<a.keys.length;k++)if(!a.keys[k].equals(this.keys[k]))return!1;return!0}};return{KeyBinding:n,KeyStroke:n,KeySequence:p}});
...
define("orion/editor/textTheme",["require","orion/editor/eventTarget","orion/util"],function(g,n,p){function a(a){a=a||{};this._document=a.document||document}var k={};a.getTheme=function(f){var f=f||"default",e=k[f];e||(e=k[f]=new a);return e};a.prototype={getThemeClass:function(){return this._themeClass},setThemeClass:function(a,e){var d=this,h=d._themeClass;d._themeClass=a;this._load(a,e,function(){d.onThemeChanged({type:"ThemeChanged",oldValue:h,newValue:d.getThemeClass()})})},onThemeChanged:function(a){return this.dispatchEvent(a)},
...
b.id=a,(c.getElementsByTagName("head")[0]||c.documentElement).appendChild(b);h||d()},_load:function(a,e,d){if(a)if("string"===typeof e)this._createStyle(a,e,d);else if(e=e.href,".css"!==e.substring(e.length-4)&&(e+=".css"),/^\//.test(e)||/[a-zA-Z0-9]+:\/\//i.test(e)||!g.toUrl)this._createStyle(a,e,d,!0);else{var h=this;g(["text!"+e],function(c){h._createStyle(a,c,d,!1)})}else d()}};n.EventTarget.addMixin(a.prototype);return{TextTheme:a}});
...
define("orion/editor/textView","i18n!orion/editor/nls/messages orion/editor/textModel orion/editor/keyModes orion/editor/eventTarget orion/editor/textTheme orion/editor/util orion/util".split(" "),function(g,n,p,a,k,f,e){function d(b,a,c){if(c){a.className="";for(var c=a.attributes,d=c.length;0<d--;)(!e.isIE||9<=e.isIE||9>e.isIE&&c[d].specified)&&a.removeAttribute(c[d].name)}if(b){b.styleClass&&(a.className=b.styleClass);if(c=b.style)for(var l in c)c.hasOwnProperty(l)&&(a.style[l]=c[l]);if(b=b.attributes)for(var m in b)b.hasOwnProperty(m)&&
...
Object)||!(a instanceof Object))return!1;for(c in q)if(q.hasOwnProperty(c)&&(!a.hasOwnProperty(c)||!b(q[c],a[c])))return!1;for(c in a)if(!q.hasOwnProperty(c))return!1;return!0}function l(b,a,c){for(var d=0,e=0,l=0,m=b.length;l<m;){-1!==d&&d<=l&&(d=b.indexOf("\r",l));-1!==e&&e<=l&&(e=b.indexOf("\n",l));var h=l,f;if(-1===e&&-1===d){a(b.substring(l));break}-1!==d&&-1!==e?d+1===e?(f=d,l=e+1):(f=d<e?d:e,l=(d<e?d:e)+1):-1!==d?(f=d,l=d+1):(f=e,l=e+1);a(b.substring(h,f));c()}}function m(b){var a,c,d,e,l=
b.ownerDocument.defaultView||b.ownerDocument.parentWindow;l.getComputedStyle?(b=l.getComputedStyle(b,null),a=b.getPropertyValue("padding-left"),c=b.getPropertyValue("padding-top"),d=b.getPropertyValue("padding-right"),e=b.getPropertyValue("padding-bottom")):b.currentStyle&&(a=b.currentStyle.paddingLeft,c=b.currentStyle.paddingTop,d=b.currentStyle.paddingRight,e=b.currentStyle.paddingBottom);return{left:parseInt(a,10)||0,top:parseInt(c,10)||0,right:parseInt(d,10)||0,bottom:parseInt(e,10)||0}}function r(b){var a,
c,d,e,l=b._trim;if(!l){var l=m(b),h=b.ownerDocument.defaultView||b.ownerDocument.parentWindow;h.getComputedStyle?(e=h.getComputedStyle(b,null),a=e.getPropertyValue("border-left-width"),c=e.getPropertyValue("border-top-width"),d=e.getPropertyValue("border-right-width"),e=e.getPropertyValue("border-bottom-width")):b.currentStyle&&(a=b.currentStyle.borderLeftWidth,c=b.currentStyle.borderTopWidth,d=b.currentStyle.borderRightWidth,e=b.currentStyle.borderBottomWidth);a=parseInt(a,10)||0;c=parseInt(c,10)||
0;d=parseInt(d,10)||0;e=parseInt(e,10)||0;l.left+=a;l.top+=c;l.right+=d;l.bottom+=e;b._trim=l}return l}function s(b,a,c){this.start=b;this.end=a;this.caret=c}function x(b){this.left=b.left;this.top=b.top;this.right=b.right;this.bottom=b.bottom}function t(b,a,c){this.view=b;this.lineIndex=a;this._lineDiv=c}function w(b){this._init(b||{})}var y=f.addEventListener,u=f.removeEventListener,z=function(b){this.options=b};z.prototype.play=function(){var b="number"===typeof this.options.duration?this.options.duration:
350,a=this.options.easing||this.defaultEasing,c=this.options.onAnimate||function(){},d=this.options.curve[0],e=this.options.curve[1],l=e-d,m=-1,h,f=this;this.interval=this.options.window.setInterval(function(){m=-1===m?(new Date).getTime():m;var r=((new Date).getTime()-m)/b;1>r?(r=a(r),h=d+r*l,c(h)):(c(e),f.stop())},"number"===typeof this.options.rate?this.options.rate:20)};z.prototype.stop=function(){this.options.window.clearInterval(this.interval);(this.options.onEnd||function(){})()};z.prototype.defaultEasing=
function(b){return Math.sin(b*(Math.PI/2))};s.prototype={clone:function(){return new s(this.start,this.end,this.caret)},collapse:function(){this.caret?this.end=this.start:this.start=this.end},extend:function(b){this.caret?this.start=b:this.end=b;this.start>this.end&&(b=this.start,this.start=this.end,this.end=b,this.caret=!this.caret)},setCaret:function(b){this.end=this.start=b;this.caret=!1},getCaret:function(){return this.caret?this.start:this.end},toString:function(){return"start="+this.start+" end="+
this.end+(this.caret?" caret is at start":" caret is at end")},isEmpty:function(){return this.start===this.end},equals:function(b){return this.caret===b.caret&&this.start===b.start&&this.end===b.end}};x.prototype={toString:function(){return"{l="+this.left+", t="+this.top+", r="+this.right+", b="+this.bottom+"}"}};t.prototype={create:function(b,a){if(!this._lineDiv){var c=this._lineDiv=this._createLine(b,a,this.lineIndex);c._line=this;return c}},_createLine:function(q,a,c){var l=this.view,m=l._model,
h=m.getLine(c),f=m.getLineStart(c),r={type:"LineStyle",textView:l,lineIndex:c,lineText:h,lineStart:f};if(2E3>h.length)l.onLineStyle(r);m=a||e.createElement(q.ownerDocument,"div");if(!a||!b(a.viewStyle,r.style))d(r.style,m,a),a&&(a._trim=null),m.viewStyle=r.style,m.setAttribute("role","presentation");m.lineIndex=c;c=[];this._createRanges(r.ranges,h,0,h.length,f,{tabOffset:0,ranges:c});h=" ";!l._fullSelection&&9>e.isIE&&(h="\ufeff");r={text:h,style:l._metrics.largestFontStyle,ignoreChars:1};0===c.length||
!c[c.length-1].style||"div"!==c[c.length-1].style.tagName?c.push(r):c.splice(c.length-1,0,r);var g,k,t,u,s,h=l=0,n,w;if(a){if(k=a.modelChangedEvent)0===k.removedLineCount&&0===k.addedLineCount?(w=k.start-f,n=k.addedCharCount-k.removedCharCount):w=-1,a.modelChangedEvent=void 0;k=a.firstChild}for(f=0;f<c.length;f++){r=c[f];u=r.text;l+=u.length;g=r.style;if(k)if(s=k.firstChild.data,t=k.viewStyle,s===u&&b(g,t)){h+=s.length;k._rectsCache=void 0;g=k=k.nextSibling;continue}else for(;k;){if(-1!==w){t=l;t>=
w&&(t-=n);s=(s=k.firstChild.data)?s.length:0;if(h+s>t)break;h+=s}t=k.nextSibling;m.removeChild(k);k=t}g=this._createSpan(m,u,g,r.ignoreChars);k?m.insertBefore(g,k):m.appendChild(g);a&&(a.lineWidth=void 0)}if(a)for(q=g?g.nextSibling:null;q;)t=q.nextSibling,a.removeChild(q),q=t;else q.appendChild(m);return m},_createRanges:function(q,a,c,d,e,l){if(!(c>d)){if(q)for(var m=0;m<q.length;m++){var h=q[m];if(!(h.end<e+c)){var f=Math.max(e+c,h.start)-e;if(f>d)break;var r=Math.min(e+d,h.end)-e;if(f<=r){f=Math.max(c,
f);r=Math.min(d,r);c<f&&this._createRange(a,c,f,null,l);if(!h.style||!h.style.unmergeable)for(;m+1<q.length&&q[m+1].start-e===r&&b(h.style,q[m+1].style);)h=q[m+1],r=Math.min(e+d,h.end)-e,m++;this._createRange(a,f,r,h.style,l);c=r}}}c<d&&this._createRange(a,c,d,null,l)}},_createRange:function(b,a,c,d,e){if(!(a>c)){var l=this.view._customTabSize;if(l&&8!==l)for(var m=b.indexOf("\t",a);-1!==m&&m<c;){a<m&&(a={text:b.substring(a,m),style:d},e.ranges.push(a),e.tabOffset+=a.text.length);a=l-e.tabOffset%
l;if(0<a){for(var h="\u00a0",f=1;f<a;f++)h+=" ";a={text:h,style:d,ignoreChars:a-1};e.ranges.push(a);e.tabOffset+=a.text.length}a=m+1;if(a===c)return;m=b.indexOf("\t",a)}a<=c&&(a={text:b.substring(a,c),style:d},e.ranges.push(a),e.tabOffset+=a.text.length)}},_createSpan:function(b,a,c,l){var m=this.view,h="span";c&&c.tagName&&(h=c.tagName.toLowerCase());var f="a"===h;f&&(b.hasLink=!0);f&&!m._linksVisible&&(h="span");f=b.ownerDocument;b=e.createElement(b.ownerDocument,h);c&&c.html?(b.innerHTML=c.html,
b.ignore=!0):c&&c.node?(b.appendChild(c.node),b.ignore=!0):b.appendChild(f.createTextNode(c&&c.text?c.text:a));d(c,b);if("a"===h){var r=m._getWindow();y(b,"click",function(b){return m._handleLinkClick(b?b:r.event)},!1)}b.viewStyle=c;l&&(b.ignoreChars=l);return b},_ensureCreated:function(){return this._lineDiv?this._lineDiv:this._createdDiv=this.create(this.view._clientDiv,null)},getBoundingClientRect:function(b,a){var c=this._ensureCreated(),d=this.view;if(void 0===b)return this._getLineBoundingClientRect(c,
!0);var l=d._model,m=c.ownerDocument,h=this.lineIndex,f=null;if(b<l.getLineEnd(h)){h=l.getLineStart(h);for(l=c.firstChild;l;){if(!l.ignore){var r=l.firstChild,g=r.length;l.ignoreChars&&(g-=l.ignoreChars);if(h+g>b){f=b-h;if(1===r.length)f=new x(l.getBoundingClientRect());else if(d._isRangeRects)m=m.createRange(),m.setStart(r,f),m.setEnd(r,f+1),f=new x(m.getBoundingClientRect());else if(e.isIE)m=m.body.createTextRange(),m.moveToElementText(l),m.collapse(),(h=0===f&&8===e.isIE)&&(f=1),m.moveEnd("character",
f+1),m.moveStart("character",f),f=new x(m.getBoundingClientRect()),h&&(f.left=l.getClientRects()[0].left);else{var k=r.data;l.removeChild(r);l.appendChild(m.createTextNode(k.substring(0,f)));var t=e.createElement(m,"span");t.appendChild(m.createTextNode(k.substring(f,f+1)));l.appendChild(t);l.appendChild(m.createTextNode(k.substring(f+1)));f=new x(t.getBoundingClientRect());l.innerHTML="";l.appendChild(r);this._createdDiv||(m=d._getSelection(),(h<=m.start&&m.start<h+g||h<=m.end&&m.end<h+g)&&d._updateDOMSelection())}e.isIE&&
(m=c.ownerDocument.defaultView||c.ownerDocument.parentWindow,c=m.screen.logicalXDPI/m.screen.deviceXDPI,m=m.screen.logicalYDPI/m.screen.deviceYDPI,f.left*=c,f.right*=c,f.top*=m,f.bottom*=m);break}h+=g}l=l.nextSibling}}c=this.getBoundingClientRect();f||(d._wrapMode?(d=this.getClientRects(),f=d[d.length-1],f.left=f.right,f.left+=c.left,f.top+=c.top,f.right+=c.left,f.bottom+=c.top):(f=new x(c),f.left=f.right));if(a||void 0===a)f.left-=c.left,f.top-=c.top,f.right-=c.left,f.bottom-=c.top;return f},_getClientRects:function(b,
c){var a,d,l,e;if(!b._rectsCache){a=b.getClientRects();d=Array(a.length);for(e=0;e<a.length;e++)l=d[e]=new x(a[e]),l.left-=c.left,l.top-=c.top,l.right-=c.left,l.bottom-=c.top;b._rectsCache=d}a=b._rectsCache;d=[a.length];for(e=0;e<a.length;e++)d[e]=new x(a[e]);return d},getClientRects:function(b){if(!this.view._wrapMode)return[this.getBoundingClientRect()];for(var c=this._ensureCreated(),a=[],d=c.firstChild,l,e=c.getBoundingClientRect();d;){if(!d.ignore)for(var m=this._getClientRects(d,e),c=0;c<m.length;c++){var f=
m[c],h;if(f.top!==f.bottom){var r=f.top+(f.bottom-f.top)/2;for(h=0;h<a.length&&!(l=a[h],l.top<=r&&r<l.bottom);h++);h===a.length?a.push(f):(f.left<l.left&&(l.left=f.left),f.top<l.top&&(l.top=f.top),f.right>l.right&&(l.right=f.right),f.bottom>l.bottom&&(l.bottom=f.bottom))}}d=d.nextSibling}return void 0!==b?a[b]:a},_getLineBoundingClientRect:function(b,c){var a=new x(b.getBoundingClientRect());if(!this.view._wrapMode){a.right=a.left;for(var d=b.lastChild;d&&d.ignoreChars===d.firstChild.length;)d=d.previousSibling;
d&&(d=d.getBoundingClientRect(),a.right=d.right+r(b).right)}c&&(d=r(b),a.left+=d.left,a.right-=d.right);return a},getLineCount:function(){return!this.view._wrapMode?1:this.getClientRects().length},getLineIndex:function(b){if(!this.view._wrapMode)return 0;for(var c=this.getClientRects(),b=this.getBoundingClientRect(b),b=b.top+(b.bottom-b.top)/2,a=0;a<c.length;a++)if(c[a].top<=b&&b<c[a].bottom)return a;return c.length-1},getLineStart:function(b){if(!this.view._wrapMode||0===b)return this.view._model.getLineStart(b);
var a=this.getClientRects();return this.getOffset(a[b].left+1,a[b].top+1)},getOffset:function(b,a){var c=this.view,d=c._model,l=this.lineIndex,m=d.getLineStart(l),f=d.getLineEnd(l);if(m===f)return m;var h=this._ensureCreated(),r=this.getBoundingClientRect(),g,k;if(c._wrapMode){g=this.getClientRects();a<g[0].top&&(a=g[0].top);for(var t=0;t<g.length&&!(k=g[t],k.top<=a&&a<k.bottom);t++);b<k.left&&(b=k.left);b>k.right&&(b=k.right-1)}else 0>b&&(b=0),b>r.right-r.left&&(b=r.right-r.left);var u=h.ownerDocument,
t=u.defaultView||u.parentWindow,s=e.isIE?t.screen.logicalXDPI/t.screen.deviceXDPI:1,n=e.isIE?t.screen.logicalYDPI/t.screen.deviceYDPI:1,t=m,w=h.firstChild;a:for(;w;){if(!w.ignore){var p=w.firstChild,h=p.length;w.ignoreChars&&(h-=w.ignoreChars);var x,z,y;g=this._getClientRects(w,r);for(var I=0;I<g.length;I++)if(k=g[I],k.left<=b&&b<k.right&&(!c._wrapMode||k.top<=a&&a<k.bottom)){var I=k.left+r.left,H;if(e.isIE||c._isRangeRects){for(var u=c._isRangeRects?u.createRange():u.body.createTextRange(),G=h,J=
-1;1<G-J;){var V=Math.floor((G+J)/2);g=J+1;k=V===h-1&&w.ignoreChars?p.length:V+1;H=0===g&&8===e.isIE;c._isRangeRects?(u.setStart(p,g),u.setEnd(p,k)):(H&&(g=1),u.moveToElementText(w),u.move("character",g),u.moveEnd("character",k-g));g=u.getClientRects();for(var X=!1,W=0;W<g.length;W++)if(k=g[W],x=(H?I:k.left)*s-r.left,y=k.right*s-r.left,z=k.top*n-r.top,k=k.bottom*n-r.top,x<=b&&b<y&&(!c._wrapMode||z<=a&&a<k)){X=!0;break}X?G=V:J=V}t+=G;g=G;k=G===h-1&&w.ignoreChars?p.length:Math.min(G+1,p.length);c._isRangeRects?
(u.setStart(p,g),u.setEnd(p,k)):(u.moveToElementText(w),u.move("character",g),u.moveEnd("character",k-g));g=u.getClientRects();c=!1;0<g.length&&(k=g[0],x=(H?I:k.left)*s-r.left,y=k.right*s-r.left,c=b>x+(y-x)/2);r=t-m;d=d.getLine(l);l=d.charCodeAt(r);55296<=l&&56319>=l&&c?r<d.length&&(l=d.charCodeAt(r+1),56320<=l&&57343>=l&&(t+=1)):56320<=l&&(57343>=l&&!c)&&0<r&&(l=d.charCodeAt(r-1),55296<=l&&56319>=l&&(t-=1));c&&t++}else{d=[];for(l=0;l<h;l++)d.push("<span>"),l===h-1?d.push(p.data.substring(l)):d.push(p.data.substring(l,
l+1)),d.push("</span>");w.innerHTML=d.join("");for(d=w.firstChild;d;){k=d.getBoundingClientRect();x=k.left-r.left;y=k.right-r.left;if(x<=b&&b<y){b>x+(y-x)/2&&t++;break}t++;d=d.nextSibling}this._createdDiv||(w.innerHTML="",w.appendChild(p),r=c._getSelection(),(t<=r.start&&r.start<t+h||t<=r.end&&r.end<t+h)&&c._updateDOMSelection())}break a}t+=h}w=w.nextSibling}return Math.min(f,Math.max(m,t))},getNextOffset:function(b,c){if("line"===c.unit){var a=this.view._model,d=a.getLineAtOffset(b);if(0<c.count)return c.count--,
a.getLineEnd(d);c.count++;return a.getLineStart(d)}return"wordend"===c.unit||"wordWS"===c.unit||"wordendWS"===c.unit?this._getNextOffset_W3C(b,c):e.isIE?this._getNextOffset_IE(b,c):this._getNextOffset_W3C(b,c)},_getNextOffset_W3C:function(b,c){function a(b){return 33<=b&&47>=b||58<=b&&64>=b||91<=b&&94>=b||96===b||123<=b&&126>=b}function d(b){return 32===b||9===b}var l=this.view._model,e=l.getLineAtOffset(b),m=l.getLine(e),f=l.getLineStart(e),l=l.getLineEnd(e),e=m.length,h=b-f,r,g=0>c.count?-1:1;if("word"===
c.unit||"wordend"===c.unit||"wordWS"===c.unit||"wordendWS"===c.unit)for(var k,t,u;0!==c.count;){if(0<c.count){if(h===e)return l;r=m.charCodeAt(h);k=a(r);t=!k&&!d(r);for(h++;h<e;){r=m.charCodeAt(h);if("wordWS"!==c.unit&&"wordendWS"!==c.unit){u=a(r);if("wordend"===c.unit){if(!u&&k)break}else if(u&&!k)break;r=!u&&!d(r)}else r=!d(r);if("wordend"===c.unit||"wordendWS"===c.unit){if(!r&&t)break}else if(r&&!t)break;t=r;k=u;h++}}else{if(0===h)return f;h--;r=m.charCodeAt(h);k=a(r);for(t=!k&&!d(r);0<h;){r=m.charCodeAt(h-
1);if("wordWS"!==c.unit&&"wordendWS"!==c.unit){u=a(r);if("wordend"===c.unit){if(u&&!k)break}else if(!u&&k)break;r=!u&&!d(r)}else r=!d(r);if("wordend"===c.unit||"wordendWS"===c.unit){if(r&&!t)break}else if(!r&&t)break;t=r;k=u;h--}}c.count-=g}else for(;0!==c.count&&0<=h+g&&h+g<=e;)h+=g,r=m.charCodeAt(h),56320<=r&&57343>=r&&0<h&&(r=m.charCodeAt(h-1),55296<=r&&56319>=r&&(h+=g)),c.count-=g;return f+h},_getNextOffset_IE:function(b,c){var a=this._ensureCreated(),d=this.view._model,l=this.lineIndex,e=0,m;
m=d.getLineStart(l);var h=a.ownerDocument,f=0>c.count?-1:1;if(b===d.getLineEnd(l)){for(a=a.lastChild;a&&a.ignoreChars===a.firstChild.length;)a=a.previousSibling;if(!a)return m;e=h.body.createTextRange();e.moveToElementText(a);m=e.text.length;e.moveEnd(c.unit,f);e=b+e.text.length-m}else if(b===m&&0>c.count)e=m;else for(a=a.firstChild;a;){d=a.firstChild.length;a.ignoreChars&&(d-=a.ignoreChars);if(m+d>b){e=h.body.createTextRange();b===m&&0>c.count?e.moveToElementText(a.previousSibling):(e.moveToElementText(a),
e.collapse(),e.moveEnd("character",b-m));m=e.text.length;e.moveEnd(c.unit,f);e=b+e.text.length-m;break}m=d+m;a=a.nextSibling}c.count-=f;return e},destroy:function(){var b=this._createdDiv;b&&(b.parentNode.removeChild(b),this._createdDiv=null)}};w.prototype={addKeyMode:function(b,c){var a=this._keyModes;void 0!==c?a.splice(c,0,b):a.push(b);b._modeAdded&&b._modeAdded()},addRuler:function(b,c){b.setView(this);var a=this._rulers;if(void 0!==c){var d,l;for(l=d=0;d<a.length&&l<c;d++)b.getLocation()===a[d].getLocation()&&
l++;a.splice(l,0,b);c=l}else a.push(b);this._createRuler(b,c);this._update()},computeSize:function(){var b=0,c=0,a=this._model,d=this._clientDiv;if(!d)return{width:b,height:c};var l=d.style.width;e.isWebkit&&(d.style.width="0x7fffffffpx");for(var a=a.getLineCount(),m=0;m<a;m++){var h=this._getLine(m),f=h.getBoundingClientRect(),b=Math.max(b,f.right-f.left),c=c+(f.bottom-f.top);h.destroy()}e.isWebkit&&(d.style.width=l);d=this._getViewPadding();b+=d.right+d.left+this._metrics.scrollWidth;c+=d.bottom+
d.top+this._metrics.scrollWidth;return{width:b,height:c}},convert:function(b,c,a){if(this._clientDiv){var d=this._getScroll(),l=this._getViewPadding(),e=this._viewDiv.getBoundingClientRect();"document"===c&&(void 0!==b.x&&(b.x+=-d.x+e.left+l.left),void 0!==b.y&&(b.y+=-d.y+e.top+l.top));"document"===a&&(void 0!==b.x&&(b.x+=d.x-e.left-l.left),void 0!==b.y&&(b.y+=d.y-e.top-l.top));return b}},destroy:function(){for(var b=0;b<this._rulers.length;b++)this._rulers[b].setView(null);this.rulers=null;this._destroyView();
this.onDestroy({type:"Destroy"});this._parent=null;this._model&&this._model.destroy&&this._model.destroy();this._actions=this._keyModes=this._doubleClickSelection=this._selection=this._theme=this._model=null},focus:function(){this._clientDiv&&(this._updateDOMSelection(),this._clientDiv.focus(),this._updateDOMSelection())},hasFocus:function(){return this._hasFocus},getActionDescription:function(b){if(b=this._actions[b])return b.actionDescription},getActions:function(b){var c=[],a=this._actions,d;for(d in a)a.hasOwnProperty(d)&&
(b||!a[d].defaultHandler)&&c.push(d);return c},getBottomIndex:function(b){return!this._clientDiv?0:this._getBottomIndex(b)},getBottomPixel:function(){return!this._clientDiv?0:this._getScroll().y+this._getClientHeight()},getCaretOffset:function(){return this._getSelection().getCaret()},getClientArea:function(){if(!this._clientDiv)return{x:0,y:0,width:0,height:0};var b=this._getScroll();return{x:b.x,y:b.y,width:this._getClientWidth(),height:this._getClientHeight()}},getHorizontalPixel:function(){return!this._clientDiv?
0:this._getScroll().x},getKeyBindings:function(b){for(var c=[],a=this._keyModes,d=0;d<a.length;d++)c=c.concat(a[d].getKeyBindings(b));return c},getKeyModes:function(){return this._keyModes.slice(0)},getLineHeight:function(b){return!this._clientDiv?0:this._getLineHeight(b)},getLineIndex:function(b){return!this._clientDiv?0:this._getLineIndex(b)},getLinePixel:function(b){return!this._clientDiv?0:this._getLinePixel(b)},getLocationAtOffset:function(b){if(!this._clientDiv)return{x:0,y:0};var c=this._model,
b=Math.min(Math.max(0,b),c.getCharCount()),c=c.getLineAtOffset(b),a=this._getLine(c),b=a.getBoundingClientRect(b);a.destroy();a=b.left;c=this._getLinePixel(c)+b.top;return{x:a,y:c}},getNextOffset:function(b,c){var a=new s(b,b,!1);this._doMove(c,a);return a.getCaret()},getOptions:function(){var b;if(0===arguments.length)b=this._defaultOptions();else if(1===arguments.length){if(b=arguments[0],"string"===typeof b)return h(this["_"+b])}else{b={};for(var c in arguments)arguments.hasOwnProperty(c)&&(b[arguments[c]]=
void 0)}for(var a in b)b.hasOwnProperty(a)&&(b[a]=h(this["_"+a]));return b},getModel:function(){return this._model},getOffsetAtLocation:function(b,c){if(!this._clientDiv)return 0;var a=this._getLineIndex(c),d=this._getLine(a),a=d.getOffset(b,c-this._getLinePixel(a));d.destroy();return a},getLineAtOffset:function(b){this.getModel().getLineAtOffset(b)},getLineStart:function(b){this.getModel().getLineStart(b)},getRulers:function(){return this._rulers.slice(0)},getSelection:function(){var b=this._getSelection();
return{start:b.start,end:b.end}},getText:function(b,c){return this._model.getText(b,c)},getTopIndex:function(b){return!this._clientDiv?0:this._getTopIndex(b)},getTopPixel:function(){return!this._clientDiv?0:this._getScroll().y},invokeAction:function(b,c,a){if(this._clientDiv){if(b=this._actions[b]){if(!c&&b.handler&&b.handler(a))return!0;if(b.defaultHandler)return"boolean"===typeof b.defaultHandler(a)}return!1}},isDestroyed:function(){return!this._clientDiv},onContextMenu:function(b){return this.dispatchEvent(b)},
...
onSelection:function(b){return this.dispatchEvent(b)},onScroll:function(b){return this.dispatchEvent(b)},onVerify:function(b){return this.dispatchEvent(b)},onFocus:function(b){return this.dispatchEvent(b)},onBlur:function(b){return this.dispatchEvent(b)},redraw:function(){if(!(0<this._redrawCount)){var b=this._model.getLineCount();this.redrawRulers(0,b);this.redrawLines(0,b)}},redrawRulers:function(b,c){if(!(0<this._redrawCount))for(var a=this.getRulers(),d=0;d<a.length;d++)this.redrawLines(b,c,a[d])},
redrawLines:function(b,c,a){if(!(0<this._redrawCount)&&(void 0===b&&(b=0),void 0===c&&(c=this._model.getLineCount()),b!==c)){var d=this._clientDiv;if(d){if(a)for(d=this._getRulerParent(a).firstChild;d&&d._ruler!==a;)d=d.nextSibling;a?d.rulerChanged=!0:this._lineHeight&&this._resetLineHeight(b,c);if(!a||"page"===a.getOverview())for(d=d.firstChild;d;){var l=d.lineIndex;b<=l&&l<c&&(d.lineChanged=!0);d=d.nextSibling}!a&&(!this._wrapMode&&b<=this._maxLineIndex&&this._maxLineIndex<c)&&(this._checkMaxLineIndex=
this._maxLineIndex,this._maxLineIndex=-1,this._maxLineWidth=0);this._queueUpdate()}}},redrawRange:function(b,c){if(!(0<this._redrawCount)){var a=this._model;void 0===b&&(b=0);void 0===c&&(c=a.getCharCount());var d=a.getLineAtOffset(b),a=a.getLineAtOffset(Math.max(b,c-1))+1;this.redrawLines(d,a)}},removeKeyMode:function(b){for(var c=this._keyModes,a=0;a<c.length;a++)if(c[a]===b){c.splice(a,1);break}b._modeRemoved&&b._modeRemoved()},removeRuler:function(b){for(var c=this._rulers,a=0;a<c.length;a++)if(c[a]===
b){c.splice(a,1);b.setView(null);this._destroyRuler(b);this._update();break}},resize:function(){this._clientDiv&&this._handleResize(null)},setAction:function(b,c,a){if(b){var d=this._actions,l=d[b];l||(l=d[b]={});l.handler=c;void 0!==a&&(l.actionDescription=a)}},setKeyBinding:function(b,c){this._keyModes[0].setKeyBinding(b,c)},setCaretOffset:function(b,c,a){var d=this._model.getCharCount(),b=Math.max(0,Math.min(b,d)),b=new s(b,b,!1);this._setSelection(b,void 0===c||c,!0,a)},setHorizontalPixel:function(b){this._clientDiv&&
(b=Math.max(0,b),this._scrollView(b-this._getScroll().x,0))},setRedraw:function(b){b?0===--this._redrawCount&&this.redraw():this._redrawCount++},setModel:function(b){if(b&&b!==this._model){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",this._modelListener.onChanged);var c=this._model.getLineCount(),a=this._model.getCharCount(),d=b.getLineCount(),l=b.getCharCount(),e={type:"ModelChanging",text:b.getText(),start:0,removedCharCount:a,
addedCharCount:l,removedLineCount:c,addedLineCount:d};this.onModelChanging(e);this._model=b;e={type:"ModelChanged",start:0,removedCharCount:a,addedCharCount:l,removedLineCount:c,addedLineCount:d};this.onModelChanged(e);this._model.addEventListener("preChanging",this._modelListener.onChanging);this._model.addEventListener("postChanged",this._modelListener.onChanged);this._reset();this._update()}},setOptions:function(c){var a=this._defaultOptions(),d;for(d in c)if(c.hasOwnProperty(d)){var l=c[d];if(!b(this["_"+
d],l)){var e=a[d]?a[d].update:null;e?e.call(this,l):this["_"+d]=h(l)}}},setSelection:function(b,c,a,d){var l=b>c;if(l)var e=b,b=c,c=e;e=this._model.getCharCount();b=Math.max(0,Math.min(b,e));c=Math.max(0,Math.min(c,e));b=new s(b,c,l);this._setSelection(b,void 0===a||a,!0,d)},setText:function(b,c,a){var d=void 0===c&&void 0===a;void 0===c&&(c=0);void 0===a&&(a=this._model.getCharCount());d&&(this._variableLineHeight=!1);this._modifyContent({text:b,start:c,end:a,_code:!0},!d);d&&(this._columnX=-1,this._setSelection(new s(0,
0,!1),!0),e.isFirefox&&this._fixCaret())},setTopIndex:function(b){this._clientDiv&&this._scrollView(0,this._getLinePixel(Math.max(0,b))-this._getScroll().y)},setTopPixel:function(b){this._clientDiv&&this._scrollView(0,Math.max(0,b)-this._getScroll().y)},showSelection:function(){return this._showCaret(!0)},update:function(b,c){this._clientDiv&&(b&&this._updateStyle(),void 0===c||c?this._update():this._queueUpdate())},_handleRootMouseDown:function(b){if(!this._ignoreEvent(b)){e.isFirefox&&1===b.which&&
(this._clientDiv.contentEditable=!1,this._ignoreBlur=(this._overlayDiv||this._clientDiv).draggable=!0);var c=this._overlayDiv||this._clientDiv;9>e.isIE&&(c=this._viewDiv);for(var a=b.target?b.target:b.srcElement;a;){if(c===a)return;a=a.parentNode}b.preventDefault&&b.preventDefault();b.stopPropagation&&b.stopPropagation();if(!this._isW3CEvents){var d=this;this._getWindow().setTimeout(function(){d._clientDiv.focus()},0)}}},_handleRootMouseUp:function(b){!this._ignoreEvent(b)&&(e.isFirefox&&1===b.which)&&
(this._clientDiv.contentEditable=!0,(this._overlayDiv||this._clientDiv).draggable=!1,this._fixCaret(),this._ignoreBlur=!1)},_handleBlur:function(){if(!this._ignoreBlur){this._hasFocus=!1;if(9>e.isIE&&!this._getSelection().isEmpty()){var b=this._rootDiv,c=e.createElement(b.ownerDocument,"div");b.appendChild(c);b.removeChild(c)}this._cursorDiv&&(this._cursorDiv.style.display="none");if(this._selDiv1)if(this._selDiv1.style.background="lightgray",this._selDiv2.style.background="lightgray",this._selDiv3.style.background=
"lightgray",b=this._getWindow(),c=this._selDiv1.ownerDocument,b.getSelection){c=b.getSelection();for(b=c.anchorNode;b;){if(b===this._clientDiv){0<c.rangeCount&&c.removeAllRanges();break}b=b.parentNode}}else if(c.selection){this._ignoreSelect=!1;for(b=c.selection.createRange().parentElement();b;){if(b===this._clientDiv){c.selection.empty();break}b=b.parentNode}this._ignoreSelect=!0}if(!this._ignoreFocus)this.onBlur({type:"Blur"})}},_handleContextMenu:function(b){if(!this._ignoreEvent(b)){e.isIE&&3===
this._lastMouseButton&&this._updateDOMSelection();var c=!1;this.isListening("ContextMenu")?(c=this._createMouseEvent("ContextMenu",b),c.screenX=b.screenX,c.screenY=b.screenY,this.onContextMenu(c),c=c.defaultPrevented):e.isMac&&(e.isFirefox&&0===b.button)&&(c=!0);if(c)return b.preventDefault&&b.preventDefault(),!1}},_handleCopy:function(b){if(!this._ignoreEvent(b)&&!this._ignoreCopy&&this._doCopy(b))return b.preventDefault&&b.preventDefault(),!1},_handleCut:function(b){if(!this._ignoreEvent(b)&&this._doCut(b))return b.preventDefault&&
b.preventDefault(),!1},_handleDataModified:function(b){this._ignoreEvent(b)||this._startIME()},_handleDblclick:function(b){this._ignoreEvent(b)||(this._lastMouseTime=b.timeStamp?b.timeStamp:(new Date).getTime(),2!==this._clickCount&&(this._clickCount=2,this._handleMouse(b)))},_handleDragStart:function(b){if(!this._ignoreEvent(b)){if(e.isFirefox){var c=this;this._getWindow().setTimeout(function(){c._clientDiv.contentEditable=!0;c._clientDiv.draggable=!1;c._ignoreBlur=!1},0)}if(this.isListening("DragStart")&&
...
"none"===b.dataTransfer.dropEffect&&!b.dataTransfer.mozUserCancelled&&this._fixCaret())}},_handleDragEnter:function(b){if(!this._ignoreEvent(b)){var c=!0;this._dropTarget=!0;this.isListening("DragEnter")&&(c=!1,this.onDragEnter(this._createMouseEvent("DragEnter",b)));if(e.isWebkit||c)return b.preventDefault&&b.preventDefault(),!1}},_handleDragOver:function(b){if(!this._ignoreEvent(b)){var c=!0;this.isListening("DragOver")&&(c=!1,this.onDragOver(this._createMouseEvent("DragOver",b)));if(e.isWebkit||
c)return c&&(b.dataTransfer.dropEffect="none"),b.preventDefault&&b.preventDefault(),!1}},_handleDragLeave:function(b){if(!this._ignoreEvent(b)&&(this._dropTarget=!1,this.isListening("DragLeave")))this.onDragLeave(this._createMouseEvent("DragLeave",b))},_handleDrop:function(b){if(!this._ignoreEvent(b)){this._dropTarget=!1;if(this.isListening("Drop"))this.onDrop(this._createMouseEvent("Drop",b));b.preventDefault&&b.preventDefault();return!1}},_handleFocus:function(){this._hasFocus=!0;e.isIOS&&void 0!==
this._lastTouchOffset?(this.setCaretOffset(this._lastTouchOffset,!0),this._lastTouchOffset=void 0):this._updateDOMSelection();this._cursorDiv&&(this._cursorDiv.style.display="block");if(this._selDiv1){var b=this._highlightRGB;this._selDiv1.style.background=b;this._selDiv2.style.background=b;this._selDiv3.style.background=b}if(!this._ignoreFocus)this.onFocus({type:"Focus"})},_handleKeyDown:function(b){if(!this._ignoreEvent(b)){if(this.isListening("KeyDown")){var c=this._createKeyEvent("KeyDown",b);
this.onKeyDown(c);if(c.defaultPrevented){e.isFirefox&&(this._keyDownPrevented=!0);b.preventDefault();return}}c=!1;switch(b.keyCode){case 16:case 17:case 18:case 91:c=!0;break;default:this._setLinksVisible(!1)}if(229===b.keyCode){if(this._readonly)return b.preventDefault&&b.preventDefault(),!1;c=!0;e.isSafari&&e.isMac&&b.ctrlKey&&(c=!1,b.keyCode=129);c&&this._startIME()}else c||this._commitIME();if((e.isMac||e.isLinux)&&4>e.isFirefox||12.16>e.isOpera)return this._keyDownEvent=b,!0;if(this._doAction(b))return b.preventDefault?
(b.preventDefault(),b.stopPropagation()):(b.cancelBubble=!0,b.returnValue=!1,b.keyCode=0),!1}},_handleKeyPress:function(b){if(!this._ignoreEvent(b))if(this._keyDownPrevented)b.preventDefault&&(b.preventDefault(),b.stopPropagation()),this._keyDownPrevented=void 0;else{if(e.isMac&&e.isWebkit&&(63232<=b.keyCode&&63487>=b.keyCode||13===b.keyCode||8===b.keyCode)||((e.isMac||e.isLinux)&&4>e.isFirefox||12.16>e.isOpera)&&this._doAction(this._keyDownEvent))return b.preventDefault&&b.preventDefault(),!1;var c=
e.isMac?b.metaKey:b.ctrlKey;if(void 0!==b.charCode&&c)switch(b.charCode){case 99:case 118:case 120:return!0}if(this.isListening("KeyPress")&&(c=this._createKeyEvent("KeyPress",b),this.onKeyPress(c),c.defaultPrevented)){b.preventDefault();return}if(this._doAction(b))return b.preventDefault?(b.preventDefault(),b.stopPropagation()):(b.cancelBubble=!0,b.returnValue=!1,b.keyCode=0),!1;c=!1;if(e.isMac){if(b.ctrlKey||b.metaKey)c=!0}else if(e.isFirefox){if(b.ctrlKey||b.altKey)c=!0}else b.ctrlKey^b.altKey&&
(c=!0);if(!c&&(c=e.isOpera?b.which:void 0!==b.charCode?b.charCode:b.keyCode,31<c))return this._doContent(String.fromCharCode(c)),b.preventDefault&&b.preventDefault(),!1}},_handleDocKeyUp:function(b){(e.isMac?b.metaKey:b.ctrlKey)||this._setLinksVisible(!1)},_handleKeyUp:function(b){if(!this._ignoreEvent(b)){if(this.isListening("KeyUp")){var c=this._createKeyEvent("KeyUp",b);this.onKeyUp(c);if(c.defaultPrevented){b.preventDefault();return}}this._handleDocKeyUp(b);13===b.keyCode&&this._commitIME()}},
_handleLinkClick:function(b){if(!(e.isMac?b.metaKey:b.ctrlKey))return b.preventDefault&&b.preventDefault(),!1},_handleMouse:function(b){var c=this._getWindow(),a=!0,d=c;if(e.isIE||e.isFirefox&&!this._overlayDiv)d=this._clientDiv;if(this._overlayDiv){this._hasFocus&&(this._ignoreFocus=!0);var l=this;c.setTimeout(function(){l.focus();l._ignoreFocus=!1},0)}1===this._clickCount?(a=this._setSelectionTo(b.clientX,b.clientY,b.shiftKey,(!e.isOpera||12.16<=e.isOpera)&&this._hasFocus&&this.isListening("DragStart")))&&
this._setGrab(d):(this._isW3CEvents&&this._setGrab(d),this._doubleClickSelection=null,this._setSelectionTo(b.clientX,b.clientY,b.shiftKey),this._doubleClickSelection=this._getSelection());return a},_handleMouseDown:function(b){if(!this._ignoreEvent(b)){if(this._linksVisible)if("A"!==(b.target||b.srcElement).tagName)this._setLinksVisible(!1);else return;this._commitIME();var c=b.which;c||(4===b.button&&(c=2),2===b.button&&(c=3),1===b.button&&(c=1));var a=2!==c&&b.timeStamp?b.timeStamp:(new Date).getTime(),
d=a-this._lastMouseTime,l=Math.abs(this._lastMouseX-b.clientX),m=Math.abs(this._lastMouseY-b.clientY),h=this._lastMouseButton===c;this._lastMouseX=b.clientX;this._lastMouseY=b.clientY;this._lastMouseTime=a;this._lastMouseButton=c;1===c&&(this._isMouseDown=!0,h&&d<=this._clickTime&&l<=this._clickDist&&m<=this._clickDist?this._clickCount++:this._clickCount=1);if(this.isListening("MouseDown")&&(a=this._createMouseEvent("MouseDown",b),this.onMouseDown(a),a.defaultPrevented)){b.preventDefault();return}if(1===
c&&this._handleMouse(b)&&(9<=e.isIE||e.isOpera||e.isChrome||e.isSafari||e.isFirefox&&!this._overlayDiv))this._hasFocus||this.focus(),b.preventDefault();e.isFirefox&&3===this._lastMouseButton&&this._updateDOMSelection()}},_handleMouseOver:function(b){if(!this._ignoreEvent(b)&&!this._animation&&this.isListening("MouseOver"))this.onMouseOver(this._createMouseEvent("MouseOver",b))},_handleMouseOut:function(b){if(!this._ignoreEvent(b)&&!this._animation&&this.isListening("MouseOut"))this.onMouseOut(this._createMouseEvent("MouseOut",
b))},_handleMouseMove:function(b){if(!this._animation){var c=this._isClientDiv(b);if(this.isListening("MouseMove")&&c)this.onMouseMove(this._createMouseEvent("MouseMove",b));if(!this._dropTarget){var a=this._linksVisible||this._lastMouseMoveX!==b.clientX||this._lastMouseMoveY!==b.clientY;this._lastMouseMoveX=b.clientX;this._lastMouseMoveY=b.clientY;this._setLinksVisible(a&&!this._isMouseDown&&(e.isMac?b.metaKey:b.ctrlKey));if(!this._isW3CEvents){if(0===b.button)return this._setGrab(null),!0;if(!this._isMouseDown&&
1===b.button&&0!==(this._clickCount&1)&&c)return this._clickCount=2,this._handleMouse(b,this._clickCount)}if(this._isMouseDown&&-1===this._dragOffset){var c=b.clientX,b=b.clientY,d=this._getViewPadding(),l=this._viewDiv.getBoundingClientRect(),m=this._getClientWidth(),h=this._getClientHeight(),a=l.left+d.left,f=l.top+d.top,m=l.left+d.left+m,d=l.top+d.top+h;b<f?this._doAutoScroll("up",c,b-f):b>d?this._doAutoScroll("down",c,b-d):c<a&&!this._wrapMode?this._doAutoScroll("left",c-a,b):c>m&&!this._wrapMode?
this._doAutoScroll("right",c-m,b):(this._endAutoScroll(),this._setSelectionTo(c,b,!0))}}}},_isClientDiv:function(b){for(var c=this._overlayDiv||this._clientDiv,b=b.target?b.target:b.srcElement;b;){if(c===b)return!0;b=b.parentNode}return!1},_createKeyEvent:function(b,c){return{type:b,event:c,preventDefault:function(){this.defaultPrevented=!0}}},_createMouseEvent:function(b,c){var a=this.convert({x:c.clientX,y:c.clientY},"page","document");return{type:b,event:c,clickCount:this._clickCount,x:a.x,y:a.y,
preventDefault:function(){this.defaultPrevented=!0}}},_handleMouseUp:function(b){var c=b.which?0===b.button:1===b.button;if(this.isListening("MouseUp")&&(this._isClientDiv(b)||c&&this._isMouseDown))this.onMouseUp(this._createMouseEvent("MouseUp",b));!this._linksVisible&&(c&&this._isMouseDown)&&(-1!==this._dragOffset&&(c=this._getSelection(),c.extend(this._dragOffset),c.collapse(),this._setSelection(c,!0,!0),this._dragOffset=-1),this._isMouseDown=!1,this._endAutoScroll(),this._isW3CEvents&&this._setGrab(null),
e.isFirefox&&b.preventDefault())},_handleMouseWheel:function(b){var c=this._getLineHeight(),a=0,d=0;e.isIE||e.isOpera?d=-b.wheelDelta/40*c:e.isFirefox?(c=e.isMac?3*b.detail:Math.max(-256,Math.min(256,b.detail))*c,b.axis===b.HORIZONTAL_AXIS?a=c:d=c):e.isMac?(d=b.timeStamp-this._wheelTimeStamp,this._wheelTimeStamp=b.timeStamp,a=0!==b.wheelDeltaX%120?1:40>d?40/(40-d):40,d=0!==b.wheelDeltaY%120?1:40>d?40/(40-d):40,a=Math.ceil(-b.wheelDeltaX/a),-1<a&&0>a&&(a=-1),0<a&&1>a&&(a=1),d=Math.ceil(-b.wheelDeltaY/
d),-1<d&&0>d&&(d=-1),0<d&&1>d&&(d=1)):(a=-b.wheelDeltaX,d=8*(-b.wheelDeltaY/120)*c);if(e.isSafari){for(c=b.target;c&&void 0===c.lineIndex;)c=c.parentNode;this._mouseWheelLine=c}c=this._getScroll();this._scrollView(a,d);a=this._getScroll();if(c.x!==a.x||c.y!==a.y)return b.preventDefault&&b.preventDefault(),!1},_handlePaste:function(b){if(!this._ignoreEvent(b)&&!this._ignorePaste&&this._doPaste(b)){if(e.isIE){var c=this;this._ignoreFocus=!0;this._getWindow().setTimeout(function(){c._updateDOMSelection();
c._ignoreFocus=!1},0)}b.preventDefault&&b.preventDefault();return!1}},_handleResize:function(){var c=this._rootDiv.clientWidth,a=this._rootDiv.clientHeight;if(this._rootWidth!==c||this._rootHeight!==a)this._rootWidth!==c&&this._wrapMode&&this._resetLineHeight(),this._rootWidth=c,this._rootHeight=a,c=9>e.isIE,a=this._calculateMetrics(),b(a,this._metrics)||(this._variableLineHeight&&(this._variableLineHeight=!1,this._resetLineHeight()),this._metrics=a,c=!0),c?this._queueUpdate():this._update()},_handleRulerEvent:function(b){for(var c=
b.target?b.target:b.srcElement,a=c.lineIndex;c&&!c._ruler;)void 0===a&&void 0!==c.lineIndex&&(a=c.lineIndex),c=c.parentNode;var d=c?c._ruler:null;if(void 0===a&&d&&"document"===d.getOverview()){var a=this._getClientHeight(),l=this._model.getLineCount(),e=this._getViewPadding(),m=this._viewDiv.getBoundingClientRect(),a=Math.floor((b.clientY-m.top-this._metrics.scrollWidth)*l/(a+e.top+e.bottom-2*this._metrics.scrollWidth));0<=a&&a<l||(a=void 0)}if(d)switch(b.type){case "click":if(d.onClick)d.onClick(a,
b);break;case "dblclick":if(d.onDblClick)d.onDblClick(a,b);break;case "mousemove":if(d.onMouseMove)d.onMouseMove(a,b);break;case "mouseover":if(d.onMouseOver)d.onMouseOver(a,b);break;case "mouseout":if(d.onMouseOut){for(l=b.relatedTarget;l&&l!==this._rootDiv;){if(l===c)return;l=l.parentNode}d.onMouseOut(a,b)}}},_handleScroll:function(){var b=this._getScroll(!1),c=this._hScroll,a=this._vScroll;if(c!==b.x||a!==b.y)this._hScroll=b.x,this._vScroll=b.y,this._commitIME(),this._update(a===b.y),this.onScroll({type:"Scroll",
oldValue:{x:c,y:a},newValue:b})},_handleSelectStart:function(b){if(this._ignoreSelect)return b&&b.preventDefault&&b.preventDefault(),!1},_getModelOffset:function(b,c){if(b){var a;a="DIV"===b.tagName?b:b.parentNode.parentNode;var d=0,l=a.lineIndex;if("DIV"!==b.tagName)for(a=a.firstChild;a;){var e=a.firstChild;if(e===b){a.ignoreChars&&(d-=a.ignoreChars);d+=c;break}a.ignoreChars&&(d-=a.ignoreChars);d+=e.data.length;a=a.nextSibling}return Math.max(0,d)+this._model.getLineStart(l)}},_updateSelectionFromDOM:function(){var b=
this._getWindow().getSelection(),c=this._getModelOffset(b.anchorNode,b.anchorOffset),b=this._getModelOffset(b.focusNode,b.focusOffset);void 0===c||void 0===b||this._setSelection(new s(c,b),!1,!1)},_handleSelectionChange:function(){if(-1===this._imeOffset)if(e.isAndroid){var b=this._getWindow();this._selTimer&&b.clearTimeout(this._selTimer);var c=this;this._selTimer=b.setTimeout(function(){c._clientDiv&&(c._selTimer=null,c._updateSelectionFromDOM())},250)}else this._updateSelectionFromDOM()},_handleTextInput:function(b){if(!this._ignoreEvent(b)){this._imeOffset=
-1;var c=this._getWindow().getSelection();if(c.anchorNode!==this._anchorNode||c.focusNode!==this._focusNode||c.anchorOffset!==this._anchorOffset||c.focusOffset!==this._focusOffset){for(var a=c.anchorNode;a&&void 0===a.lineIndex;)a=a.parentNode;if(a){var d=this._model,l=a.lineIndex,e=d.getLine(l),m=e,h=0,d=d.getLineStart(l);0<c.rangeCount&&(c.getRangeAt(0).deleteContents(),l=a.ownerDocument.createTextNode(b.data),c.getRangeAt(0).insertNode(l),h=this._getDOMText(a,l),m=h.text,h=h.offset,l.parentNode.removeChild(l));
a.lineRemoved=!0;for(a=0;e.charCodeAt(a)===m.charCodeAt(a)&&a<h;)a++;c=e.length-1;for(l=m.length-e.length;e.charCodeAt(c)===m.charCodeAt(c+l)&&c+l>=h+b.data.length;)c--;c++;e=m.substring(a,c+l);this._modifyContent({text:e,start:a+d,end:c+d,_ignoreDOMSelection:!0},!0)}}else this._doContent(b.data);b.preventDefault()}},_handleTouchStart:function(b){this._commitIME();var c=this._getWindow();this._touchScrollTimer&&(this._vScrollDiv.style.display="none",this._hScrollDiv.style.display="none",c.clearInterval(this._touchScrollTimer),
this._touchScrollTimer=null);var a=b.touches;if(1===a.length){var a=a[0],d=a.clientX,l=a.clientY;this._touchStartX=d;this._touchStartY=l;if(e.isAndroid&&(l<a.pageY-c.pageYOffset||d<a.pageX-c.pageXOffset))d=a.pageX-c.pageXOffset,l=a.pageY-c.pageYOffset;c=this.convert({x:d,y:l},"page","document");this._lastTouchOffset=this.getOffsetAtLocation(c.x,c.y);this._touchStartTime=b.timeStamp;this._touching=!0}},_handleTouchMove:function(b){var c=b.touches;if(1===c.length){c=c[0];this._touchCurrentX=c.clientX;
this._touchCurrentY=c.clientY;if(!this._touchScrollTimer&&200>b.timeStamp-this._touchStartTime){this._vScrollDiv.style.display="block";this._wrapMode||(this._hScrollDiv.style.display="block");var a=this,d=this._getWindow();this._touchScrollTimer=d.setInterval(function(){var b=0,c=0;if(a._touching)b=a._touchStartX-a._touchCurrentX,c=a._touchStartY-a._touchCurrentY,a._touchSpeedX=b/10,a._touchSpeedY=c/10,a._touchStartX=a._touchCurrentX,a._touchStartY=a._touchCurrentY;else{if(0.1>Math.abs(a._touchSpeedX)&&
0.1>Math.abs(a._touchSpeedY)){a._vScrollDiv.style.display="none";a._hScrollDiv.style.display="none";d.clearInterval(a._touchScrollTimer);a._touchScrollTimer=null;return}b=10*a._touchSpeedX;c=10*a._touchSpeedY;a._touchSpeedX*=0.95;a._touchSpeedY*=0.95}a._scrollView(b,c)},10)}this._touchScrollTimer&&b.preventDefault()}},_handleTouchEnd:function(b){0===b.touches.length&&(this._touching=!1)},_doAction:function(b){var c,a,d=this._keyModes;for(a=d.length-1;0<=a;a--)if(c=d[a],"function"===typeof c.match&&
(c=c.match(b),void 0!==c))return this.invokeAction(c);return!1},_doMove:function(b,c){var a=this._model,d=c.getCaret(),l=a.getLineAtOffset(d);b.count||(b.count=1);for(;0!==b.count;){var e=a.getLineStart(l);if(0>b.count&&d===e)if(0<l)"character"===b.unit&&b.count++,l--,c.extend(a.getLineEnd(l));else break;else if(0<b.count&&d===a.getLineEnd(l))if(l+1<a.getLineCount())"character"===b.unit&&b.count--,l++,c.extend(a.getLineStart(l));else break;else{var m=!1;b.expandTab&&("character"===b.unit&&0===(d-
e)%this._tabSize)&&(e=a.getText(e,d),m=!/[^ ]/.test(e));m?(c.extend(d-this._tabSize),b.count+=0>b.count?1:-1):(e=this._getLine(l),c.extend(e.getNextOffset(d,b)),e.destroy())}d=c.getCaret()}return c},_doBackspace:function(b){var c=this._getSelection();c.isEmpty()&&(b.count||(b.count=1),b.count*=-1,b.expandTab=this._expandTab,this._doMove(b,c));this._modifyContent({text:"",start:c.start,end:c.end},!0);return!0},_doCase:function(b){var c=this._getSelection();this._doMove(b,c);var a=this.getText(c.start,
c.end);this._setSelection(c,!0);switch(b.type){case "lower":a=a.toLowerCase();break;case "capitalize":a=a.replace(/(?:^|\s)\S/g,function(b){return b.toUpperCase()});break;case "reverse":b="";for(c=0;c<a.length;c++)var d=a[c],l=d.toLowerCase(),d=l!==d?l:d.toUpperCase(),b=b+d;a=b;break;default:a=a.toUpperCase()}this._doContent(a);return!0},_doContent:function(b){var c=this._getSelection();if(this._overwriteMode&&c.isEmpty()){var a=this._model,d=a.getLineAtOffset(c.end);c.end<a.getLineEnd(d)&&(a=this._getLine(d),
c.extend(a.getNextOffset(c.getCaret(),{unit:"character",count:1})),a.destroy())}this._modifyContent({text:b,start:c.start,end:c.end,_ignoreDOMSelection:!0},!0)},_doCopy:function(b){var c=this._getSelection();return!c.isEmpty()?(c=this._getBaseText(c.start,c.end),this._setClipboardText(c,b)):!0},_doCursorNext:function(b){var c=this._getSelection();!c.isEmpty()&&!b.select?c.start=c.end:this._doMove(b,c);b.select||c.collapse();this._setSelection(c,!0);return!0},_doCursorPrevious:function(b){var c=this._getSelection();
!c.isEmpty()&&!b.select?c.end=c.start:(b.count||(b.count=1),b.count*=-1,this._doMove(b,c));b.select||c.collapse();this._setSelection(c,!0);return!0},_doCut:function(b){var c=this._getSelection();return!c.isEmpty()?(c=this._getBaseText(c.start,c.end),this._doContent(""),this._setClipboardText(c,b)):!0},_doDelete:function(b){var c=this._getSelection();c.isEmpty()&&this._doMove(b,c);this._modifyContent({text:"",start:c.start,end:c.end},!0);return!0},_doEnd:function(b){var c=this._getSelection(),a=this._model,
d;if(b.ctrl)c.extend(a.getCharCount()),d=function(){};else{var l=c.getCaret(),e=a.getLineAtOffset(l);if(this._wrapMode){var m=this._getLine(e),l=m.getLineIndex(l),l=l===m.getLineCount()-1?a.getLineEnd(e):m.getLineStart(l+1)-1;m.destroy()}else b.count&&0<b.count&&(e=Math.min(e+b.count-1,a.getLineCount()-1)),l=a.getLineEnd(e);c.extend(l)}b.select||c.collapse();this._setSelection(c,!0,!0,d);return!0},_doEnter:function(b){var c=this._model,a=this._getSelection();this._doContent(c.getLineDelimiter());
b&&b.noCursor&&(a.end=a.start,this._setSelection(a,!0));return!0},_doHome:function(b){var c=this._getSelection(),a=this._model,d;if(b.ctrl)c.extend(0),d=function(){};else{var l=c.getCaret(),e=a.getLineAtOffset(l);this._wrapMode?(a=this._getLine(e),l=a.getLineIndex(l),l=a.getLineStart(l),a.destroy()):l=a.getLineStart(e);c.extend(l)}b.select||c.collapse();this._setSelection(c,!0,!0,d);return!0},_doLineDown:function(b){var c=this._model,a=this._getSelection(),d=a.getCaret(),l=c.getLineAtOffset(d),m=
this._getLine(l),h=this._columnX,f=1,r=!1;if(-1===h||b.wholeLine||b.select&&e.isIE)h=b.wholeLine?c.getLineEnd(l+1):d,h=m.getBoundingClientRect(h).left;(d=m.getLineIndex(d))<m.getLineCount()-1?f=m.getClientRects(d+1).top+1:(d=c.getLineCount()-1,r=l===d,b.count&&0<b.count?l=Math.min(l+b.count,d):l++);d=!1;if(r){if(b.select||e.isMac||e.isLinux)a.extend(c.getCharCount()),d=!0}else m.lineIndex!==l&&(m.destroy(),m=this._getLine(l)),a.extend(m.getOffset(h,f)),d=!0;d&&(b.select||a.collapse(),this._setSelection(a,
!0,!0));this._columnX=h;m.destroy();return!0},_doLineUp:function(b){var c=this._model,a=this._getSelection(),d=a.getCaret(),l=c.getLineAtOffset(d),m=this._getLine(l),h=this._columnX,f=!1,r;if(-1===h||b.wholeLine||b.select&&e.isIE)h=b.wholeLine?c.getLineStart(l-1):d,h=m.getBoundingClientRect(h).left;0<(d=m.getLineIndex(d))?r=m.getClientRects(d-1).top+1:(f=0===l,f||(b.count&&0<b.count?l=Math.max(l-b.count,0):l--,r=this._getLineHeight(l)-1));d=!1;if(f){if(b.select||e.isMac||e.isLinux)a.extend(0),d=!0}else m.lineIndex!==
l&&(m.destroy(),m=this._getLine(l)),a.extend(m.getOffset(h,r)),d=!0;d&&(b.select||a.collapse(),this._setSelection(a,!0,!0));this._columnX=h;m.destroy();return!0},_doNoop:function(){return!0},_doPageDown:function(b){var c=this,a=this._model,d=this._getSelection(),l=d.getCaret(),m=a.getLineAtOffset(l),h=a.getLineCount(),f=this._getScroll(),a=this._getClientHeight(),r,g;if(this._lineHeight){r=this._columnX;f=this._getBoundsAtOffset(l);if(-1===r||b.select&&e.isIE)r=f.left;l=this._getLineIndex(f.top+a);
g=this._getLine(l);m=this._getLinePixel(l);l=g.getOffset(r,f.top+a-m);a=g.getBoundingClientRect(l);g.destroy();d.extend(l);b.select||d.collapse();this._setSelection(d,!0,!0,function(){c._columnX=r},a.top+m-f.top);return!0}if(m<h-1){var k=this._getLineHeight(),t=Math.min(h-m-1,Math.floor(a/k)),t=Math.max(1,t);r=this._columnX;if(-1===r||b.select&&e.isIE)g=this._getLine(m),r=g.getBoundingClientRect(l).left,g.destroy();g=this._getLine(m+t);d.extend(g.getOffset(r,0));g.destroy();b.select||d.collapse();
b=h*k;l=f.y+t*k;l+a>b&&(l=b-a);this._setSelection(d,!0,!0,function(){c._columnX=r},l-f.y)}return!0},_doPageUp:function(b){var c=this,a=this._model,d=this._getSelection(),l=d.getCaret(),m=a.getLineAtOffset(l),h=this._getScroll(),f=this._getClientHeight(),r;if(this._lineHeight){r=this._columnX;h=this._getBoundsAtOffset(l);if(-1===r||b.select&&e.isIE)r=h.left;l=this._getLineIndex(h.bottom-f);a=this._getLine(l);m=this._getLinePixel(l);l=a.getOffset(r,h.bottom-f-m);f=a.getBoundingClientRect(l);a.destroy();
d.extend(l);b.select||d.collapse();this._setSelection(d,!0,!0,function(){c._columnX=r},f.top+m-h.top);return!0}if(0<m){var g=this._getLineHeight(),f=Math.max(1,Math.min(m,Math.floor(f/g)));r=this._columnX;if(-1===r||b.select&&e.isIE)a=this._getLine(m),r=a.getBoundingClientRect(l).left,a.destroy();a=this._getLine(m-f);d.extend(a.getOffset(r,this._getLineHeight(m-f)-1));a.destroy();b.select||d.collapse();b=Math.max(0,h.y-f*g);this._setSelection(d,!0,!0,function(){c._columnX=r},b-h.y)}return!0},_doPaste:function(b){var c=
this;return null!==this._getClipboardText(b,function(b){b&&(e.isLinux&&2===c._lastMouseButton&&(new Date).getTime()-c._lastMouseTime<=c._clickTime&&c._setSelectionTo(c._lastMouseX,c._lastMouseY),c._doContent(b))})},_doScroll:function(b){var c=b.type,a=this._model,d=a.getLineCount(),b=this._getClientHeight(),l=this._getLineHeight(),d=d*l,e=this._getScroll().y,m;switch(c){case "textStart":m=0;break;case "textEnd":m=d-b;break;case "pageDown":m=e+b;break;case "pageUp":m=e-b;break;case "lineDown":m=e+
l;break;case "lineUp":m=e-l;break;case "centerLine":c=this._getSelection(),m=a.getLineAtOffset(c.start),a=(a.getLineAtOffset(c.end)-m+1)*l,m=m*l-b/2+a/2}void 0!==m&&(m=Math.min(Math.max(0,m),d-b),this._scrollViewAnimated(0,m-e,function(){}));return!0},_doSelectAll:function(){var b=this._model,c=this._getSelection();c.setCaret(0);c.extend(b.getCharCount());this._setSelection(c,!1);return!0},_doTab:function(){if(this._tabMode&&!this._readonly){var b="\t";if(this._expandTab)var c=this._model,b=this._getSelection().getCaret(),
a=c.getLineAtOffset(b),c=c.getLineStart(a),b=Array(this._tabSize-(b-c)%this._tabSize+1).join(" ");this._doContent(b);return!0}},_doShiftTab:function(){if(this._tabMode&&!this._readonly)return!0},_doOverwriteMode:function(){if(!this._readonly)return this.setOptions({overwriteMode:!this.getOptions("overwriteMode")}),!0},_doTabMode:function(){this._tabMode=!this._tabMode;return!0},_doWrapMode:function(){this.setOptions({wrapMode:!this.getOptions("wrapMode")});return!0},_autoScroll:function(){var b=this._model,
c=this._getSelection(),a=this.convert({x:this._autoScrollX,y:this._autoScrollY},"page","document"),d=c.getCaret(),l=b.getLineCount(),m=b.getLineAtOffset(d),h;if("up"===this._autoScrollDir||"down"===this._autoScrollDir)d=this._autoScrollY/this._getLineHeight(),d=0>d?Math.floor(d):Math.ceil(d),h=Math.max(0,Math.min(l-1,m+d));else if("left"===this._autoScrollDir||"right"===this._autoScrollDir)h=this._getLineIndex(a.y),m=this._getLine(m),a.x+=m.getBoundingClientRect(d,!1).left,m.destroy();0===h&&(e.isMac||
e.isLinux)?c.extend(0):h===l-1&&(e.isMac||e.isLinux)?c.extend(b.getCharCount()):(m=this._getLine(h),c.extend(m.getOffset(a.x,a.y-this._getLinePixel(h))),m.destroy());this._setSelection(c,!0)},_autoScrollTimer:function(){this._autoScroll();var b=this;this._autoScrollTimerID=this._getWindow().setTimeout(function(){b._autoScrollTimer()},this._AUTO_SCROLL_RATE)},_calculateLineHeightTimer:function(b){if(this._lineHeight&&!this._calculateLHTimer){var c=this._model.getLineCount(),a=0;if(b){for(var b=0,d=
(new Date).getTime(),l=0;a<c&&!(this._lineHeight[a]||(b++,l||(l=a),this._lineHeight[a]=this._calculateLineHeight(a)),a++,100<(new Date).getTime()-d););this.redrawRulers(0,c);this._queueUpdate()}b=this._getWindow();if(a!==c){var e=this;this._calculateLHTimer=b.setTimeout(function(){e._calculateLHTimer=null;e._calculateLineHeightTimer(!0)},0)}else this._calculateLHTimer&&(b.clearTimeout(this._calculateLHTimer),this._calculateLHTimer=void 0)}},_calculateLineHeight:function(b){var b=this._getLine(b),
c=b.getBoundingClientRect();b.destroy();return Math.max(1,c.bottom-c.top)},_calculateMetrics:function(){var b=this._clientDiv,c=b.ownerDocument,a=e.createElement(c,"div");a.style.lineHeight="normal";var l={type:"LineStyle",textView:this,"0":0,lineText:this._model.getLine(0),lineStart:0};this.onLineStyle(l);d(l.style,a);a.style.position="fixed";a.style.left="-1000px";var h=e.createElement(c,"span");h.appendChild(c.createTextNode(" "));a.appendChild(h);var f=e.createElement(c,"span");f.style.fontStyle=
"italic";f.appendChild(c.createTextNode(" "));a.appendChild(f);var g=e.createElement(c,"span");g.style.fontWeight="bold";g.appendChild(c.createTextNode(" "));a.appendChild(g);l=e.createElement(c,"span");l.style.fontWeight="bold";l.style.fontStyle="italic";l.appendChild(c.createTextNode(" "));a.appendChild(l);b.appendChild(a);var k=a.getBoundingClientRect(),h=h.getBoundingClientRect(),f=f.getBoundingClientRect(),g=g.getBoundingClientRect(),l=l.getBoundingClientRect(),h=h.bottom-h.top,f=f.bottom-f.top,
g=g.bottom-g.top,t=l.bottom-l.top,u=0,l=0>=k.bottom-k.top,k=Math.max(1,k.bottom-k.top);f>h&&(u=1);g>f&&(u=2);t>g&&(u=3);var s;0!==u&&(s={style:{}},0!==(u&1)&&(s.style.fontStyle="italic"),0!==(u&2)&&(s.style.fontWeight="bold"));h=r(a);b.removeChild(a);t=m(this._viewDiv);a=e.createElement(c,"div");a.style.position="fixed";a.style.left="-1000px";a.style.paddingLeft=t.left+"px";a.style.paddingTop=t.top+"px";a.style.paddingRight=t.right+"px";a.style.paddingBottom=t.bottom+"px";a.style.width="100px";a.style.height=
"100px";t=e.createElement(c,"div");t.style.width="100%";t.style.height="100%";a.appendChild(t);b.appendChild(a);u=a.getBoundingClientRect();f=t.getBoundingClientRect();g=0;this._singleMode||(a.style.overflow="hidden",t.style.height="200px",g=a.clientWidth,a.style.overflow="scroll",g-=a.clientWidth);b.removeChild(a);t={left:f.left-u.left,top:f.top-u.top,right:u.right-f.right,bottom:u.bottom-f.bottom};f=u=0;if(!l&&(this._wrapOffset||this._marginOffset))a=e.createElement(c,"div"),a.style.position="fixed",
a.style.left="-1000px",a.innerHTML=Array(this._wrapOffset+1).join(" "),b.appendChild(a),u=a.getBoundingClientRect(),u=Math.ceil(u.right-u.left),a.innerHTML=Array(this._marginOffset+1).join(" "),f=a.getBoundingClientRect(),f=Math.ceil(f.right-f.left),b.removeChild(a);return{lineHeight:k,largestFontStyle:s,lineTrim:h,viewPadding:t,scrollWidth:g,wrapWidth:u,marginWidth:f,invalid:l}},_cancelAnimation:function(){this._animation&&(this._animation.stop(),this._animation=null)},_clearSelection:function(b){var c=
this._getSelection();if(c.isEmpty())return!1;"next"===b?c.start=c.end:c.end=c.start;this._setSelection(c,!0);return!0},_commitIME:function(){if(-1!==this._imeOffset){this._scrollDiv.focus();this._clientDiv.focus();var b=this._model,c=b.getLineAtOffset(this._imeOffset),a=b.getLineStart(c),d=this._getDOMText(this._getLineNode(c)).text,b=b.getLine(c),a=this._imeOffset-a,b=a+d.length-b.length;a!==b&&(d=d.substring(a,b),this._doContent(d));this._imeOffset=-1}},_createActions:function(){this.addKeyMode(new p.DefaultKeyMode(this));
...
l(m,function(b){d.push(b)},function(){d.push(c)}),m=d.join(""),a&&a(m),m;if(e.isFirefox){this._ignoreFocus=!0;var r=this._clipboardDiv,f=this._rootDiv.ownerDocument;r||(this._clipboardDiv=r=e.createElement(f,"div"),r.style.position="fixed",r.style.whiteSpace="pre",r.style.left="-1000px",this._rootDiv.appendChild(r));r.innerHTML="<pre contenteditable=''></pre>";r.firstChild.focus();var g=this,k=function(){var b=g._getTextFromElement(r);r.innerHTML="";d=[];l(b,function(b){d.push(b)},function(){d.push(c)});
return d.join("")},t=!1;this._ignorePaste=!0;if(!e.isLinux||2!==this._lastMouseButton)try{t=f.execCommand("paste",!1,null)}catch(u){t=1<r.childNodes.length||r.firstChild&&0<r.firstChild.childNodes.length}this._ignorePaste=!1;if(!t){if(b)return h.setTimeout(function(){g.focus();(m=k())&&a&&a(m);g._ignoreFocus=!1},0),null;this.focus();this._ignoreFocus=!1;return""}this.focus();this._ignoreFocus=!1;(m=k())&&a&&a(m);return m}return""},_getDOMText:function(b,a){for(var c=b.firstChild,d="",l=0;c;){var e;
if(!c.ignore)if(c.ignoreChars){e=c.lastChild;for(var m=0,h=[],f=-1;e;){var r=e.data;if(r)for(var g=r.length-1;0<=g;g--){var k=r.substring(g,g+1);m<c.ignoreChars&&(" "===k||"\u200b"===k||"\ufeff"===k)?m++:h.push("\u00a0"===k?"\t":k)}a===e&&(f=h.length);e=e.previousSibling}h=h.reverse().join("");-1!==f&&(l=d.length+h.length-f);d+=h}else for(e=c.firstChild;e;)a===e&&(l=d.length),d+=e.data,e=e.nextSibling;c=c.nextSibling}return{text:d,offset:l}},_getTextFromElement:function(b){var a=b.ownerDocument,c=
...
type:"dblclick",handler:function(a){return b._handleDblclick(a?a:f.event)}})}this._hookRulerEvents(this._leftDiv,a);this._hookRulerEvents(this._rightDiv,a);this._hookRulerEvents(this._marginDiv,a);for(d=0;d<a.length;d++)l=a[d],y(l.target,l.type,l.handler,l.capture)},_hookRulerEvents:function(b,a){if(b){var c=this,d=this._getWindow();e.isIE&&a.push({target:b,type:"selectstart",handler:function(){return!1}});a.push({target:b,type:e.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(b){return c._handleMouseWheel(b?
...
this._getSelection(),c.setCaret(b.start+b.text.length),this._setSelection(c,!0));this.onModify({type:"Modify"})}},_onModelChanged:function(b){b.type="ModelChanged";this.onModelChanged(b);b.type="Changed";var a=b.start,c=b.addedCharCount,d=b.removedCharCount,l=b.addedLineCount,e=b.removedLineCount,m=this._getSelection();m.end>a&&(m.end>a&&m.start<a+d?m.setCaret(a+c):(m.start+=c-d,m.end+=c-d),this._setSelection(m,!1,!1));a=this._model.getLineAtOffset(a);for(c=this._getLineNext();c;)d=c.lineIndex,a<=
d&&d<=a+e&&(a===d&&!c.modelChangedEvent&&!c.lineRemoved?(c.modelChangedEvent=b,c.lineChanged=!0):(c.lineRemoved=!0,c.lineChanged=!1,c.modelChangedEvent=null)),d>a+e&&(c.lineIndex=d+l-e,c._line.lineIndex=c.lineIndex),c=this._getLineNext(c);this._lineHeight&&(b=[a,e].concat(Array(l)),Array.prototype.splice.apply(this._lineHeight,b));!this._wrapMode&&(a<=this._maxLineIndex&&this._maxLineIndex<=a+e)&&(this._checkMaxLineIndex=this._maxLineIndex,this._maxLineIndex=-1,this._maxLineWidth=0);this._update()},
...
e.isFirefox&&(this._ignoreFocus=!1,(a=this._hasFocus)&&b.blur(),b.contentEditable=!1,b.contentEditable=!0,a&&b.focus(),this._ignoreFocus=!1)}},_scrollViewAnimated:function(b,a,c){var d=this._getWindow();if(c&&this._scrollAnimation){var l=this;this._animation=new z({window:d,duration:this._scrollAnimation,curve:[a,0],onAnimate:function(b){b=a-Math.floor(b);l._scrollView(0,b);a-=b},onEnd:function(){l._animation=null;l._scrollView(b,a);c&&d.setTimeout(c,0)}});this._animation.play()}else this._scrollView(b,
a),c&&d.setTimeout(c,0)},_scrollView:function(b,a){this._ensureCaretVisible=!1;var c=this._viewDiv;b&&(c.scrollLeft+=b);a&&(c.scrollTop+=a)},_setClipboardText:function(b,a){var c,d=this._getWindow(),m=d.clipboardData;!m&&a&&(m=a.clipboardData);if(m&&(c=[],l(b,function(b){c.push(b)},function(){c.push(e.platformDelimiter)}),m.setData(e.isIE?"Text":"text/plain",c.join(""))))return!0;var f=this._parent.ownerDocument,h=e.createElement(f,"pre");h.style.position="fixed";h.style.left="-1000px";l(b,function(b){h.appendChild(f.createTextNode(b))},
...
m();return!0},_setDOMSelection:function(b,a,c,d,l){for(var m,f,h,r,g=0,k=b.firstChild,t,u,s=this._model.getLine(b.lineIndex).length;k;){if(!k.ignore){t=k.firstChild;u=t.length;k.ignoreChars&&(u-=k.ignoreChars);if(g+u>a||g+u>=s){m=t;f=a-g;k.ignoreChars&&(0<u&&f===u)&&(f+=k.ignoreChars);break}g+=u}k=k.nextSibling}for(var g=0,k=c.firstChild,n=this._model.getLine(c.lineIndex).length;k;){if(!k.ignore){t=k.firstChild;u=t.length;k.ignoreChars&&(u-=k.ignoreChars);if(u+g>d||g+u>=n){h=t;r=d-g;k.ignoreChars&&
(0<u&&r===u)&&(r+=k.ignoreChars);break}g+=u}k=k.nextSibling}this._setDOMFullSelection(b,a,s,c,d,n);b=this._getWindow();a=this._parent.ownerDocument;if(b.getSelection){c=b.getSelection();b=a.createRange();b.setStart(m,f);b.setEnd(h,r);if(this._hasFocus&&(c.anchorNode!==m||c.anchorOffset!==f||c.focusNode!==h||c.focusOffset!==r||c.anchorNode!==h||c.anchorOffset!==r||c.focusNode!==m||c.focusOffset!==f))this._anchorNode=m,this._anchorOffset=f,this._focusNode=h,this._focusOffset=r,this._ignoreSelect=!1,
0<c.rangeCount&&c.removeAllRanges(),c.addRange(b),this._ignoreSelect=!0;this._cursorDiv&&(b=a.createRange(),l?(b.setStart(m,f),b.setEnd(m,f)):(b.setStart(h,r),b.setEnd(h,r)),h=b.getClientRects()[0],r=this._cursorDiv.parentNode,m=r.getBoundingClientRect(),h&&m&&(this._cursorDiv.style.top=h.top-m.top+r.scrollTop+"px",this._cursorDiv.style.left=h.left-m.left+r.scrollLeft+"px"))}else a.selection&&this._hasFocus&&(l=a.body,b=e.createElement(a,"div"),l.appendChild(b),l.removeChild(b),b=l.createTextRange(),
b.moveToElementText(m.parentNode),b.moveStart("character",f),m=l.createTextRange(),m.moveToElementText(h.parentNode),m.moveStart("character",r),b.setEndPoint("EndToStart",m),this._ignoreSelect=!1,b.select(),this._ignoreSelect=!0)},_setDOMFullSelection:function(b,a,c,d,l){if(this._selDiv1&&(c=this._selDiv1,c.style.width="0px",c.style.height="0px",c=this._selDiv2,c.style.width="0px",c.style.height="0px",c=this._selDiv3,c.style.width="0px",c.style.height="0px",!(b===d&&a===l))){var e=this._model,m=this._getViewPadding(),
f=this._clientDiv.getBoundingClientRect(),h=this._viewDiv.getBoundingClientRect(),c=h.left+m.left,r=f.right,m=h.top+m.top,g=f.bottom,h=f=0;this._clipDiv?(h=this._clipDiv.getBoundingClientRect(),f=h.left-this._clipDiv.scrollLeft):(h=this._rootDiv.getBoundingClientRect(),f=h.left);h=h.top;this._ignoreDOMSelection=!0;var k=(new t(this,b.lineIndex,b)).getBoundingClientRect(e.getLineStart(b.lineIndex)+a,!1),u=k.left,a=(new t(this,d.lineIndex,d)).getBoundingClientRect(e.getLineStart(d.lineIndex)+l,!1),
e=a.left;this._ignoreDOMSelection=!1;var s=this._selDiv1,u=Math.min(r,Math.max(c,u)),n=Math.min(g,Math.max(m,k.top)),w=r,l=Math.min(g,Math.max(m,k.bottom));s.style.left=u-f+"px";s.style.top=n-h+"px";s.style.width=Math.max(0,w-u)+"px";s.style.height=Math.max(0,l-n)+"px";b.lineIndex===d.lineIndex?(w=Math.min(e,r),s.style.width=Math.max(0,w-u)+"px"):(k=Math.min(g,Math.max(m,a.top)),e=Math.min(r,Math.max(c,e)),m=Math.min(g,Math.max(m,a.bottom)),g=this._selDiv3,g.style.left=c-f+"px",g.style.top=k-h+"px",
g.style.width=Math.max(0,e-c)+"px",g.style.height=Math.max(0,m-k)+"px",1<Math.abs(b.lineIndex-d.lineIndex)&&(b=this._selDiv2,b.style.left=c-f+"px",b.style.top=l-h+"px",b.style.width=Math.max(0,r-c)+"px",b.style.height=Math.max(0,k-l)+"px"))}},_setGrab:function(b){b!==this._grabControl&&(b?(b.setCapture&&b.setCapture(),this._grabControl=b):(this._grabControl.releaseCapture&&this._grabControl.releaseCapture(),this._grabControl=null))},_setLinksVisible:function(b){if(this._linksVisible!==b){this._linksVisible=
...
c,d,l){if(b){this._columnX=-1;void 0===c&&(c=!0);var e=this._selection;this._selection=b;!1!==a&&this._showCaret(!1,d,a,l);c&&this._updateDOMSelection();if(!e.equals(b))this.onSelection({type:"Selection",oldValue:{start:e.start,end:e.end},newValue:{start:b.start,end:b.end}})}},_setSelectionTo:function(b,a,c,d){var l=this._model,e=this._getSelection(),a=this.convert({x:b,y:a},"page","document"),b=this._getLineIndex(a.y);if(1===this._clickCount){l=this._getLine(b);b=l.getOffset(a.x,a.y-this._getLinePixel(b));
l.destroy();if(d&&!c&&e.start<=b&&b<e.end)return this._dragOffset=b,!1;e.extend(b);c||e.collapse()}else 0===(this._clickCount&1)?(l=this._getLine(b),b=l.getOffset(a.x,a.y-this._getLinePixel(b)),this._doubleClickSelection?b>=this._doubleClickSelection.start?(c=this._doubleClickSelection.start,d=l.getNextOffset(b,{unit:"wordend",count:1})):(c=l.getNextOffset(b,{unit:"word",count:-1}),d=this._doubleClickSelection.end):(c=l.getNextOffset(b,{unit:"word",count:-1}),d=l.getNextOffset(c,{unit:"wordend",count:1})),
l.destroy()):this._doubleClickSelection?(d=l.getLineAtOffset(this._doubleClickSelection.start),b>=d?(c=l.getLineStart(d),d=l.getLineEnd(b)):(c=l.getLineStart(b),d=l.getLineEnd(d))):(c=l.getLineStart(b),d=l.getLineEnd(b)),e.setCaret(c),e.extend(d);this._setSelection(e,!0,!0);return!0},_setFullSelection:function(b,a){this._fullSelection=b;e.isWebkit&&(this._fullSelection=!0);var c=this._clipDiv||this._rootDiv;if(c)if(this._fullSelection){if(!this._selDiv1&&this._fullSelection&&!e.isIOS){var d=c.ownerDocument;
this._highlightRGB=e.isWebkit?"transparent":"Highlight";var l=e.createElement(d,"div");this._selDiv1=l;l.style.position="absolute";l.style.borderWidth="0px";l.style.margin="0px";l.style.padding="0px";l.style.outline="none";l.style.background=this._highlightRGB;l.style.width="0px";l.style.height="0px";l.style.zIndex="0";c.appendChild(l);var m=e.createElement(d,"div");this._selDiv2=m;m.style.position="absolute";m.style.borderWidth="0px";m.style.margin="0px";m.style.padding="0px";m.style.outline="none";
...
m=this._getScroll(),f=e.getCaret(),h=e.start,r=e.end,g=l.getLineAtOffset(r),k=Math.max(Math.max(h,l.getLineStart(g)),r-1),l=this._getClientWidth(),g=this._getClientHeight(),t=l/4,u=this._getBoundsAtOffset(f===h?h:k),s=u.left,n=u.right,w=u.top,p=u.bottom;b&&!e.isEmpty()&&(u=this._getBoundsAtOffset(f===r?h:k),u.top===w?f===h?n=s+Math.min(u.right-s,l):s=n-Math.min(n-u.left,l):f===h?p=w+Math.min(u.bottom-w,g):w=p-Math.min(p-u.top,g));b=0;s<m.x&&(b=Math.min(s-m.x,-t));n>m.x+l&&(b=Math.max(n-m.x-l,t));
e=0;w<m.y?e=w-m.y:p>m.y+g&&(e=p-m.y-g);d&&(0<d?0<e&&(e=Math.max(e,d)):0>e&&(e=Math.min(e,d)));if(0!==b||0!==e)return 0!==e&&"number"===typeof c&&(0>c&&(c=0),1<c&&(c=1),e+=Math.floor(0<e?c*g:-c*g)),this._scrollViewAnimated(b,e,a),g!==this._getClientHeight()||l!==this._getClientWidth()?this._showCaret():this._ensureCaretVisible=!0,!0;a&&a();return!1}},_startIME:function(){if(-1===this._imeOffset){var b=this._getSelection();b.isEmpty()||this._modifyContent({text:"",start:b.start,end:b.end},!0);this._imeOffset=
b.start}},_unhookEvents:function(){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",this._modelListener.onChanged);this._theme.removeEventListener("ThemeChanged",this._themeListener.onChanged);this._modelListener=null;for(var b=0;b<this._handlers.length;b++){var a=this._handlers[b];u(a.target,a.type,a.handler)}this._handlers=null;this._mutationObserver&&(this._mutationObserver.disconnect(),this._mutationObserver=null)},_updateDOMSelection:function(){if(!(0<
this._redrawCount)&&!this._ignoreDOMSelection&&this._clientDiv){var b=this._getSelection(),a=this._model,c=a.getLineAtOffset(b.start),d=a.getLineAtOffset(b.end),l=this._getLineNext();if(l){var e=this._getLinePrevious(),m;c<l.lineIndex?(m=l,c=0):c>e.lineIndex?(m=e,c=0):(m=this._getLineNode(c),c=b.start-a.getLineStart(c));d<l.lineIndex?a=0:d>e.lineIndex?(l=e,a=0):(l=this._getLineNode(d),a=b.end-a.getLineStart(d));this._setDOMSelection(m,c,l,a,b.caret)}}},_update:function(b){if(!(0<this._redrawCount)){this._updateTimer&&
(this._getWindow().clearTimeout(this._updateTimer),this._updateTimer=null,b=!1);var a=this._clientDiv,c=this._viewDiv;if(a){this._metrics.invalid&&(this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1);var d=this._model,l=this._getScroll(!1),m=this._getViewPadding(),f=d.getLineCount(),h=this._getLineHeight(),r=!1,g=!1,k=!1,u=this._metrics.scrollWidth;this._wrapMode&&(a.style.width=(this._metrics.wrapWidth||this._getClientWidth())+"px");var s,n,w,p,x=0,z=0,y;if(this._lineHeight){for(;z<
f;){y=this._getLineHeight(z);if(x+y>l.y)break;x+=y;z++}s=z;n=Math.max(0,s-1);w=d=l.y-x;0<s&&(d+=this._getLineHeight(s-1))}else p=Math.max(0,l.y)/h,s=Math.floor(p),n=Math.max(0,s-1),d=Math.round((p-n)*h),w=Math.round((p-s)*h);this._topIndexY=w;p=this._rootDiv;var P=p.clientWidth,I=p.clientHeight;if(b){h=0;this._leftDiv&&(s=this._leftDiv.getBoundingClientRect(),h=s.right-s.left);s=this._getClientWidth();p=this._getClientHeight();g=s;this._wrapMode?this._metrics.wrapWidth&&(g=this._metrics.wrapWidth):
g=Math.max(this._maxLineWidth,g);for(;z<f;)y=this._getLineHeight(z,!1),x+=y,z++;f=x}else{p=this._getClientHeight();w=Math.min(s+Math.floor((p+w)/h),f-1);var l=Math.min(w+1,f-1),H;for(y=a.firstChild;y;){H=y.lineIndex;var G=y.nextSibling;if(!(n<=H&&H<=l)||y.lineRemoved||-1===y.lineIndex)this._mouseWheelLine===y?(y.style.display="none",y.lineIndex=-1):a.removeChild(y);y=G}y=this._getLineNext();var G=c.ownerDocument,J=G.createDocumentFragment();for(H=n;H<=l;H++)!y||y.lineIndex>H?(new t(this,H)).create(J,
null):(J.firstChild&&(a.insertBefore(J,y),J=G.createDocumentFragment()),y&&y.lineChanged&&(y=(new t(this,H)).create(J,y),y.lineChanged=!1),y=this._getLineNext(y));J.firstChild&&a.insertBefore(J,y);e.isWebkit&&!this._wrapMode&&(a.style.width="0x7fffffffpx");y=this._getLineNext();H=p+d;for(J=!1;y;)n=y.lineWidth,void 0===n&&(G=y._line.getBoundingClientRect(),n=y.lineWidth=Math.ceil(G.right-G.left),G=G.bottom-G.top,this._lineHeight?this._lineHeight[y.lineIndex]=G:0!==h&&(0!==G&&Math.ceil(h)!==Math.ceil(G))&&
(this._variableLineHeight=!0,this._lineHeight=[],this._lineHeight[y.lineIndex]=G)),this._lineHeight&&!J&&(H-=this._lineHeight[y.lineIndex],0>H&&(w=y.lineIndex,J=!0)),this._wrapMode||(n>=this._maxLineWidth&&(this._maxLineWidth=n,this._maxLineIndex=y.lineIndex),this._checkMaxLineIndex===y.lineIndex&&(this._checkMaxLineIndex=-1)),y.lineIndex===s&&(this._topChild=y),y.lineIndex===w&&(this._bottomChild=y),y=this._getLineNext(y);-1!==this._checkMaxLineIndex&&(H=this._checkMaxLineIndex,this._checkMaxLineIndex=
-1,0<=H&&H<f&&(h=new t(this,H),G=h.getBoundingClientRect(),n=G.right-G.left,n>=this._maxLineWidth&&(this._maxLineWidth=n,this._maxLineIndex=H),h.destroy()));for(;z<f;)y=this._getLineHeight(z,z<=w),x+=y,z++;f=x;this._updateRuler(this._leftDiv,s,l,I);this._updateRuler(this._rightDiv,s,l,I);this._updateRuler(this._marginDiv,s,l,I);h=0;this._leftDiv&&(s=this._leftDiv.getBoundingClientRect(),h=s.right-s.left);l=0;this._rightDiv&&(l=this._rightDiv.getBoundingClientRect(),l=l.right-l.left);c.style.left=
h+"px";c.style.right=l+"px";l=this._scrollDiv;l.style.height=f+"px";s=this._getClientWidth();!this._singleMode&&!this._wrapMode&&(x=r=p,(z="scroll"===c.style.overflowX)?r+=u:x-=u,y=w=s,(n="scroll"===c.style.overflowY)?w+=u:y-=u,p=r,s=w,f>p&&(k=!0,s=y),this._maxLineWidth>s&&(g=!0,p=x,f>p&&(k=!0,s=y)),z!==g&&(c.style.overflowX=g?"scroll":"hidden"),n!==k&&(c.style.overflowY=k?"scroll":"hidden"),r=z!==g||n!==k);k=s;this._wrapMode?this._metrics.wrapWidth&&(k=this._metrics.wrapWidth):k=Math.max(this._maxLineWidth,
k);g=k;if((!e.isIE||9<=e.isIE)&&this._maxLineWidth>s)k+=m.right+m.left;l.style.width=k+"px";this._clipScrollDiv&&(this._clipScrollDiv.style.width=k+"px");l=this._getScroll(!1)}this._vScrollDiv&&(k=p-8,x=Math.max(15,Math.ceil(Math.min(1,k/(f+m.top+m.bottom))*k)),this._vScrollDiv.style.left=h+s-8+"px",this._vScrollDiv.style.top=Math.floor(Math.max(0,l.y*k/f))+"px",this._vScrollDiv.style.height=x+"px");!this._wrapMode&&this._hScrollDiv&&(k=s-8,x=Math.max(15,Math.ceil(Math.min(1,k/(this._maxLineWidth+
m.left+m.right))*k)),this._hScrollDiv.style.left=h+Math.floor(Math.max(0,Math.floor(l.x*k/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=p-9+"px",this._hScrollDiv.style.width=x+"px");z=l.x;x=this._clipDiv;k=this._overlayDiv;if(w=this._marginDiv)w.style.left=-z+h+this._metrics.marginWidth+m.left+"px",w.style.bottom=("scroll"===c.style.overflowX?u:0)+"px";x?(x.scrollLeft=z,x.scrollTop=0,c=h+m.left,u=m.top,b=s,h=p,z=0,w=-d,0===l.x&&(c-=m.left,b+=m.left,z=m.left),l.x+s===g&&(b+=m.right),0===l.y&&
(u-=m.top,h+=m.top,w+=m.top),l.y+p===f&&(h+=m.bottom),x.style.left=c+"px",x.style.top=u+"px",x.style.right=P-b-c+"px",x.style.bottom=I-h-u+"px",a.style.left=z+"px",a.style.top=w+"px",a.style.width=g+"px",a.style.height=p+d+"px",k&&(k.style.left=a.style.left,k.style.top=a.style.top,k.style.width=a.style.width,k.style.height=a.style.height)):(c=z,u=d,P=z+s,I=d+p,0===c&&(c-=m.left),0===u&&(u-=m.top),P===g&&(P+=m.right),l.y+p===f&&(I+=m.bottom),a.style.clip="rect("+u+"px,"+P+"px,"+I+"px,"+c+"px)",a.style.left=
-z+h+m.left+"px",a.style.width=(this._wrapMode||e.isWebkit?g:s+z)+"px",b||(a.style.top=-d+m.top+"px",a.style.height=p+d+"px"),k&&(k.style.clip=a.style.clip,k.style.left=a.style.left,k.style.width=a.style.width,b||(k.style.top=a.style.top,k.style.height=a.style.height)));this._updateDOMSelection();r&&(a=this._ensureCaretVisible,this._ensureCaretVisible=!1,a&&this._showCaret(),this._queueUpdate())}}},_updateOverflow:function(){var b=this._viewDiv;this._wrapMode?(b.style.overflowX="hidden",b.style.overflowY=
"scroll"):b.style.overflow="hidden"},_updateRuler:function(b,a,c,l){if(b)for(var m=this._parent.ownerDocument,f=this._getLineHeight(),h=this._getViewPadding(),b=b.firstChild;b;){var r=b._ruler,g=f,k=r.getOverview();"page"===k&&(g+=this._topIndexY);b.style.top=-g+"px";b.style.height=l+g+"px";b.rulerChanged&&d(r.getRulerStyle(),b);var t,u=b.firstChild;u?(t=u,u=u.nextSibling):(t=e.createElement(m,"div"),t.style.visibility="hidden",b.appendChild(t));var s;if(b.rulerChanged&&t){g=-1;if(s=r.getWidestAnnotation())d(s.style,
t),s.html&&(t.innerHTML=s.html);t.lineIndex=g;t.style.height=f+h.top+"px"}var w;if("page"===k){for(r=r.getAnnotations(a,c+1);u;)g=u.lineIndex,s=u.nextSibling,(!(a<=g&&g<=c)||u.lineChanged)&&b.removeChild(u),u=s;u=b.firstChild.nextSibling;w=m.createDocumentFragment();for(g=a;g<=c;g++)if(!u||u.lineIndex>g){t=e.createElement(m,"div");if(s=r[g])d(s.style,t),s.html&&(t.innerHTML=s.html),t.annotation=s;t.lineIndex=g;t.style.height=this._getLineHeight(g)+"px";w.appendChild(t)}else w.firstChild&&(b.insertBefore(w,
u),w=m.createDocumentFragment()),u&&(u=u.nextSibling);w.firstChild&&b.insertBefore(w,u)}else{s=this._getClientHeight();g=this._model.getLineCount();u=s+h.top+h.bottom-2*this._metrics.scrollWidth;k=f*g<u?f:u/g;if(b.rulerChanged){for(s=b.childNodes.length;1<s;)b.removeChild(b.lastChild),s--;r=r.getAnnotations(0,g);w=m.createDocumentFragment();for(var n in r)g=n>>>0,0>g||(t=e.createElement(m,"div"),s=r[n],d(s.style,t),t.style.position="absolute",t.style.top=this._metrics.scrollWidth+f+Math.floor(g*k)+
"px",s.html&&(t.innerHTML=s.html),t.annotation=s,t.lineIndex=g,w.appendChild(t));b.appendChild(w)}else if(b._oldTrackHeight!==u)for(t=b.firstChild?b.firstChild.nextSibling:null;t;)t.style.top=this._metrics.scrollWidth+f+Math.floor(t.lineIndex*k)+"px",t=t.nextSibling;b._oldTrackHeight=u}b.rulerChanged=!1;b=b.nextSibling}},_updateStyleSheet:function(){var b="";e.isWebkit&&0<this._metrics.scrollWidth&&(b+="\n.textview ::-webkit-scrollbar-corner {background: #eeeeee;}");e.isFirefox&&(e.isMac&&this._highlightRGB&&
...
"normal");var a=this._metrics=this._calculateMetrics();this._rootDiv.style.lineHeight=e.isIE?a.lineHeight-(a.lineTrim.top+a.lineTrim.bottom)+"px":"normal";this._updateStyleSheet();b||(this.redraw(),this._resetLineWidth())}};a.EventTarget.addMixin(w.prototype);return{TextView:w}});
...
this._model.removeEventListener("preChanging",this._listener.onChanging),this._model=null)},addProjection:function(a){if(a){var k=this._model,f=this._projections;a._lineIndex=k.getLineAtOffset(a.start);a._lineCount=k.getLineAtOffset(a.end)-a._lineIndex;var e=a.text;e||(e="");a._model="string"===typeof e?new g.TextModel(e,k.getLineDelimiter()):e;var k=this.mapOffset(a.start,!0),e=a.end-a.start,d=a._lineCount,h=a._model.getCharCount(),c=a._model.getLineCount()-1,b={type:"Changing",text:a._model.getText(),
start:k,removedCharCount:e,addedCharCount:h,removedLineCount:d,addedLineCount:c};this.onChanging(b);b=this._binarySearch(f,a.start);f.splice(b,0,a);this.onChanged({type:"Changed",start:k,removedCharCount:e,addedCharCount:h,removedLineCount:d,addedLineCount:c})}},getProjections:function(){return this._projections.slice(0)},getBaseModel:function(){return this._model},mapOffset:function(a,g){var f=this._projections,e=0,d,h;if(g){for(d=0;d<f.length;d++){h=f[d];if(h.start>a)break;if(h.end>a)return-1;e+=
...
g[f],a=a+(e._model.getCharCount()-(e.end-e.start));return a},getLine:function(a,g){if(0>a)return null;var f=this._model,e=this._projections,d=0,h=[],c=0,b,l,m;for(b=0;b<e.length;b++){m=e[b];if(m._lineIndex>=a-d)break;l=m._model.getLineCount()-1;if(m._lineIndex+l>=a-d){c=a-(m._lineIndex+d);if(c<l)return m._model.getLine(c,g);h.push(m._model.getLine(l))}c=m.end;d+=l-m._lineCount}for(c=Math.max(c,f.getLineStart(a-d));b<e.length;b++){m=e[b];if(m._lineIndex>a-d)break;h.push(f.getText(c,m.start));l=m._model.getLineCount()-
1;if(m._lineIndex+l>a-d)return h.push(m._model.getLine(0,g)),h.join("");h.push(m._model.getText());c=m.end;d+=l-m._lineCount}e=f.getLineEnd(a-d,g);c<e&&h.push(f.getText(c,e));return h.join("")},getLineAtOffset:function(a){for(var g=this._model,f=this._projections,e=0,d=0,h=0;h<f.length;h++){var c=f[h];if(c.start>a-e)break;var b=c._model.getCharCount();if(c.start+b>a-e){f=a-(c.start+e);d+=c._model.getLineAtOffset(f);e+=f;break}d+=c._model.getLineCount()-1-c._lineCount;e+=b-(c.end-c.start)}return g.getLineAtOffset(a-
e)+d},getLineCount:function(){for(var a=this._projections,g=this._model.getLineCount(),f=0;f<a.length;f++)var e=a[f],g=g+(e._model.getLineCount()-1-e._lineCount);return g},getLineDelimiter:function(){return this._model.getLineDelimiter()},getLineEnd:function(a,g){if(0>a)return-1;for(var f=this._model,e=this._projections,d=0,h=0,c=0;c<e.length;c++){var b=e[c];if(b._lineIndex>a-d)break;var l=b._model.getLineCount()-1;if(b._lineIndex+l>a-d)return b._model.getLineEnd(a-(b._lineIndex+d),g)+b.start+h;h+=
b._model.getCharCount()-(b.end-b.start);d+=l-b._lineCount}return f.getLineEnd(a-d,g)+h},getLineStart:function(a){if(0>a)return-1;for(var g=this._model,f=this._projections,e=0,d=0,h=0;h<f.length;h++){var c=f[h];if(c._lineIndex>=a-e)break;var b=c._model.getLineCount()-1;if(c._lineIndex+b>=a-e)return c._model.getLineStart(a-(c._lineIndex+e))+c.start+d;d+=c._model.getCharCount()-(c.end-c.start);e+=b-c._lineCount}return g.getLineStart(a-e)+d},getText:function(a,g){void 0===a&&(a=0);var f=this._model,e=
this._projections,d=0,h=[],c,b,l;for(c=0;c<e.length;c++){b=e[c];if(b.start>a-d)break;l=b._model.getCharCount();if(b.start+l>a-d){if(void 0!==g&&b.start+l>g-d)return b._model.getText(a-(b.start+d),g-(b.start+d));h.push(b._model.getText(a-(b.start+d)));a=b.end+d+l-(b.end-b.start)}d+=l-(b.end-b.start)}var m=a-d;if(void 0!==g){for(;c<e.length;c++){b=e[c];if(b.start>g-d)break;h.push(f.getText(m,b.start));l=b._model.getCharCount();if(b.start+l>g-d)return h.push(b._model.getText(0,g-(b.start+d))),h.join("");
h.push(b._model.getText());m=b.end;d+=l-(b.end-b.start)}h.push(f.getText(m,g-d))}else{for(;c<e.length;c++)b=e[c],h.push(f.getText(m,b.start)),h.push(b._model.getText()),m=b.end;h.push(f.getText(m))}return h.join("")},_onChanged:function(){var a=this._change,g=a.baseStart,f=a.baseEnd,e,d,h=this._projections;for(e=0;e<h.length&&!(d=h[e],d.end>g);e++);var c=e;for(e=0;e<h.length&&!(d=h[e],d.start>=f);e++);var b=e,l=this._model,g=a.baseText.length-(f-g);for(e=b;e<h.length;e++)d=h[e],d.start+=g,d.end+=
g,d._lineIndex=l.getLineAtOffset(d.start);d=h.splice(c,b-c);for(e=0;e<d.length;e++)d[e].annotation&&d[e].annotation._expand();this.onChanged({type:"Changed",start:a.start,removedCharCount:a.removedCharCount,addedCharCount:a.addedCharCount,removedLineCount:a.removedLineCount,addedLineCount:a.addedLineCount});this._change=void 0},_onChanging:function(a){var g=!!this._change,f=this._change||{},e=a.start,d=e+a.removedCharCount;f.baseStart=e;f.baseEnd=d;f.baseText=a.text;f.addedLineCount=a.addedLineCount;
if(!g){this._change=f;f.text=a.text;var h=this._projections,c,b,l,a=function(a){for(c=b=0;b<h.length;b++){l=h[b];if(l.start>a)break;if(l.end>a)return-1;c+=l._model.getCharCount()-(l.end-l.start)}return a+c};f.start=a(e);-1===f.start&&(f.text=this._model.getText(l.start,e)+f.text,f.addedLineCount+=this._model.getLineAtOffset(e)-this._model.getLineAtOffset(l.start),f.start=l.start+c);f.end=a(d);-1===f.end&&(f.text+=this._model.getText(d,l.end),f.addedLineCount+=this._model.getLineAtOffset(l.end)-this._model.getLineAtOffset(d),
f.end=l.start+c)}f.addedCharCount=f.text.length;f.removedCharCount=f.end-f.start;f.removedLineCount=this.getLineAtOffset(f.end)-this.getLineAtOffset(f.start);this.onChanging({type:"Changing",text:f.text,start:f.start,removedCharCount:f.removedCharCount,addedCharCount:f.addedCharCount,removedLineCount:f.removedLineCount,addedLineCount:f.addedLineCount})},onChanging:function(a){return this.dispatchEvent(a)},onChanged:function(a){return this.dispatchEvent(a)},setLineDelimiter:function(a){this._model.setLineDelimiter(a)},
setText:function(a,g,f){function e(a){for(h=c=0;c<d.length;c++){b=d[c];if(b.start>a-h)break;var l=b._model.getCharCount();if(b.start+l>a-h)return-1;h+=l-(b.end-b.start)}return a-h}this._change={text:a||"",start:g||0,end:void 0===f?this.getCharCount():f};var d=this._projections,h,c,b,l,m,a=e(this._change.start);-1===a&&(l={projection:b,start:this._change.start-(b.start+h)},a=b.end);g=e(this._change.end);-1===g&&(m={projection:b,end:this._change.end-(b.start+h)},g=b.start);l&&m&&l.projection===m.projection?
b._model.setText(this._change.text,l.start,m.end):(this._model.setText(this._change.text,a,g),l&&(b=l.projection,b._model.setText("",l.start)),m&&(b=m.projection,b._model.setText("",0,m.end),b.start=b.end,b._lineCount=0));this._change=void 0}};n.EventTarget.addMixin(p.prototype);return{ProjectionTextModel:p}});
define("orion/editor/tooltip","i18n!orion/editor/nls/messages orion/editor/textView orion/editor/textModel orion/editor/projectionTextModel orion/editor/util orion/util".split(" "),function(g,n,p,a,k,f){function e(a){this._view=a;this._fadeDelay=500;this._hideDelay=200;this._showDelay=500;this._autoHideDelay=5E3;this._create(a.getOptions("parent").ownerDocument)}e.getTooltip=function(a){a._tooltip||(a._tooltip=new e(a));return a._tooltip};e.prototype={_create:function(a){if(!this._tooltipDiv){var e=
this._tooltipDiv=f.createElement(a,"div");e.tabIndex=0;e.className="textviewTooltip";e.setAttribute("aria-live","assertive");e.setAttribute("aria-atomic","true");var c=this._tooltipContents=f.createElement(a,"div");e.appendChild(c);a.body.appendChild(e);var b=this;k.addEventListener(e,"mouseover",function(){if(b._hideDelay){var a=b._getWindow();b._delayedHideTimeout&&(a.clearTimeout(b._delayedHideTimeout),b._delayedHideTimeout=null);b._hideTimeout&&(a.clearTimeout(b._hideTimeout),b._hideTimeout=null);
b._nextTarget=null}},!1);k.addEventListener(e,"mouseout",function(a){a=a.relatedTarget||a.toElement;!(a===e||b._hasFocus())&&(!a||!k.contains(e,a))&&b._hide()},!1);k.addEventListener(e,"keydown",function(a){27===a.keyCode&&b._hide()},!1);k.addEventListener(a,"mousedown",this._mouseDownHandler=function(a){b.isVisible()&&(k.contains(e,a.target||a.srcElement)||b._hide())},!0);this._view.addEventListener("Destroy",function(){b.destroy()});this._hide()}},_getWindow:function(){var a=this._tooltipDiv.ownerDocument;
return a.defaultView||a.parentWindow},destroy:function(){if(this._tooltipDiv){this._hide();var a=this._tooltipDiv.parentNode;a&&a.removeChild(this._tooltipDiv);k.removeEventListener(this._tooltipDiv.ownerDocument,"mousedown",this._mouseDownHandler,!0);this._tooltipDiv=null}},_hasFocus:function(){var a=this._tooltipDiv;return!a?!1:k.contains(a,a.ownerDocument.activeElement)},hide:function(a){void 0===a&&(a=this._hideDelay);var e=this._getWindow();this._delayedHideTimeout&&(e.clearTimeout(this._delayedHideTimeout),
...
this,a=b._getWindow();b._showTimeout&&(a.clearTimeout(b._showTimeout),b._showTimeout=null);0===e?b.show(!0):b._showTimeout=a.setTimeout(function(){b._showTimeout=null;b.show(!0)},e?e:b._showDelay)}},show:function(d){if(this._target){var e=this._target.getTooltipInfo();if(e){var c=this._tooltipDiv,b=this._tooltipContents;c.style.left=c.style.right=c.style.width=c.style.height=b.style.width=b.style.height="auto";var l=e.contents;l instanceof Array&&(l=this._getAnnotationContents(l));if("string"===typeof l)b.innerHTML=
l;else if(this._isNode(l))b.appendChild(l);else if(l instanceof a.ProjectionTextModel){var m=this._view,f=m.getOptions();f.wrapMode=!1;f.parent=b;var g=f.themeClass;g?((g=g.replace("tooltipTheme",""))&&(g=" "+g),g="tooltipTheme"+g):g="tooltipTheme";f.themeClass=g;f=this._contentsView=new n.TextView(f);f.addEventListener("LineStyle",function(b){m.onLineStyle(b)});f.setModel(l);l=f.computeSize();b.style.width=l.width+"px";b.style.height=l.height+"px";f.resize()}else return;b=c.ownerDocument.documentElement;
"right"===e.anchor?(l=b.clientWidth-e.x,c.style.right=l+"px"):(l=parseInt(this._getNodeStyle(c,"padding-left","0"),10),l+=parseInt(this._getNodeStyle(c,"border-left-width","0"),10),l=e.x-l,c.style.left=l+"px");c.style.maxWidth=b.clientWidth-l-10+"px";l=parseInt(this._getNodeStyle(c,"padding-top","0"),10);l+=parseInt(this._getNodeStyle(c,"border-top-width","0"),10);l=e.y-l;c.style.top=l+"px";c.style.maxHeight=b.clientHeight-l-10+"px";c.style.opacity="1";c.style.visibility="visible";if(d){var k=this,
t=this._getWindow();k._hideTimeout=t.setTimeout(function(){k._hideTimeout=null;var b=parseFloat(k._getNodeStyle(c,"opacity","1"));k._fadeTimeout=t.setInterval(function(){"visible"===c.style.visibility&&0<b?(b-=0.1,c.style.opacity=b):k._hide()},k._fadeDelay/10)},k._autoHideDelay)}}}},_getAnnotationContents:function(d){function e(b){var a=b.title,c=f.createElement(r,"div");c.className="tooltipRow";b.html&&(c.innerHTML=b.html,c.lastChild&&k.addEventListener(c.lastChild,"click",function(){var a=b.start,
c=b.end;n.getBaseModel&&(a=n.mapOffset(a,!0),c=n.mapOffset(c,!0));s.setSelection(a,c,1/3,function(){m._hide()})},!1),c.appendChild(r.createTextNode("\u00a0")));if(!a)var d=b.end,a=t.getLineStart(t.getLineAtOffset(b.start)),d=t.getLineEnd(t.getLineAtOffset(d),!0),a=t.getText(a,d);"function"===typeof a&&(a=b.title());"string"===typeof a&&(d=f.createElement(r,"span"),d.appendChild(r.createTextNode(a)),a=d);c.appendChild(a);return c}for(var c,b=[],l=0;l<d.length;l++)c=d[l],""!==c.title&&!c.groupAnnotation&&
b.push(c);d=b;if(0===d.length)return null;var m=this,r=this._tooltipDiv.ownerDocument,s=this._view,n=s.getModel(),t=n.getBaseModel?n.getBaseModel():n;if(1===d.length){c=d[0];if(void 0!==c.title)return c=e(c),c.firstChild&&((d=c.firstChild.className)&&(d+=" "),c.firstChild.className=d+"single"),c;d=new a.ProjectionTextModel(t);b=t.getLineStart(t.getLineAtOffset(c.start));l=t.getCharCount();c.end!==l&&d.addProjection({start:c.end,end:l});0<b&&d.addProjection({start:0,end:b});return d}b=f.createElement(r,
"div");c=f.createElement(r,"em");c.appendChild(r.createTextNode(g.multipleAnnotations));b.appendChild(c);for(l=0;l<d.length;l++)c=d[l],(c=e(c))&&b.appendChild(c);return b},_getNodeStyle:function(a,e,c){var b;if(a&&(b=a.style[e],!b))if(a.currentStyle){for(b=0;-1!==(b=e.indexOf("-",b));)e=e.substring(0,b)+e.substring(b+1,b+2).toUpperCase()+e.substring(b+2);b=a.currentStyle[e]}else b=(a=a.ownerDocument.defaultView.getComputedStyle(a,null))?a.getPropertyValue(e):null;return b||c},_isNode:function(a){return"object"===
typeof Node?a instanceof Node:a&&"object"===typeof a&&"number"===typeof a.nodeType&&"string"===typeof a.nodeName}};return{Tooltip:e}});
define("orion/editor/annotations",["i18n!orion/editor/nls/messages","orion/editor/eventTarget"],function(g,n){function p(a,b,d){this.start=a;this.end=b;this._projectionModel=d;this.html=this._expandedHTML;this.style=this._expandedStyle;this.expanded=!0}function a(){}function k(c,b){var d=c.lastIndexOf("."),d=c.substring(d+1),e={title:g[d],style:{styleClass:"annotation "+d},html:"<div class='annotationHTML "+d+"'></div>",overviewStyle:{styleClass:"annotationOverview "+d}};b?e.lineStyle={styleClass:"annotationLine "+
...
"orion.annotation.currentBlame";var h={};a.registerType=function(a,b){var d=b;"function"!==typeof d&&(d=function(b,a,c){this.start=b;this.end=a;void 0!==c&&(this.title=c)},d.prototype=b);d.prototype.type=a;h[a]=d;return a};a.createAnnotation=function(a,b,d,e){return new (this.getType(a))(b,d,e)};a.getType=function(a){return h[a]};k(a.ANNOTATION_ERROR);k(a.ANNOTATION_WARNING);k(a.ANNOTATION_TASK);k(a.ANNOTATION_BREAKPOINT);k(a.ANNOTATION_BOOKMARK);k(a.ANNOTATION_CURRENT_BRACKET);k(a.ANNOTATION_MATCHING_BRACKET);
k(a.ANNOTATION_CURRENT_SEARCH);k(a.ANNOTATION_MATCHING_SEARCH);k(a.ANNOTATION_READ_OCCURRENCE);k(a.ANNOTATION_WRITE_OCCURRENCE);k(a.ANNOTATION_SELECTED_LINKED_GROUP);k(a.ANNOTATION_CURRENT_LINKED_GROUP);k(a.ANNOTATION_LINKED_GROUP);k(a.ANNOTATION_CURRENT_LINE,!0);k(a.ANNOTATION_BLAME,!0);k(a.ANNOTATION_CURRENT_BLAME,!0);a.registerType(a.ANNOTATION_FOLDING,p);f.addMixin=function(a){var b=f.prototype,d;for(d in b)b.hasOwnProperty(d)&&(a[d]=b[d])};f.prototype={addAnnotationType:function(a){this._annotationTypes||
...
define("orion/editor/editor","i18n!orion/editor/nls/messages orion/editor/eventTarget orion/editor/tooltip orion/editor/annotations orion/objects orion/util".split(" "),function(g,n,p,a,k,f){function e(a){a=a||{};this._domNode=a.domNode;this._model=a.model;this._undoStack=a.undoStack;this._statusReporter=a.statusReporter;this._title=null;var b=this;this._listener={onChanged:function(a){b.onChanged(a)}};this._model&&this._model.addEventListener("Changed",this._listener.onChanged);this.checkDirty()}
...
_setModelText:function(a){this._model&&this._model.setText(a)},setInput:function(a,b,d,e){this._title=a;e||(b?this.reportStatus(b,"error"):null!==d&&(void 0!==d&&"string"===typeof d)&&this._setModelText(d),this._undoStack&&this._undoStack.reset());this.checkDirty();this.onInputChanged({type:"InputChanged",title:a,message:b,contents:d,contentsSaved:e})},setText:function(a,b,d){this.getModel().setText(a,b,d)},uninstall:function(){this.installed=!1}};n.EventTarget.addMixin(e.prototype);d.prototype=new e;
...
getFoldingRuler:function(){return this._foldingRuler},getLineNumberRuler:function(){return this._lineNumberRuler},getModel:function(){if(!this._textView)return null;var a=this._textView.getModel();a.getBaseModel&&(a=a.getBaseModel());return a},getOverviewRuler:function(){return this._overviewRuler},getTextView:function(){return this._textView},getKeyModes:function(){return this._textView.getKeyModes()},getSourceCodeActions:function(){return this._sourceCodeActions},getLinkedMode:function(){return this._linkedMode},
getTextActions:function(){return this._textActions},focus:function(){this._textView&&this._textView.focus()},resize:function(){this._textView&&this._textView.resize()},setAnnotationRulerVisible:function(a,b){if(this._annotationRulerVisible!==a||b)if(this._annotationRulerVisible=a,this._annotationRuler){var d=this._textView;a?d.addRuler(this._annotationRuler,0):d.removeRuler(this._annotationRuler)}},setFoldingRulerVisible:function(a,b){if(this._foldingRulerVisible!==a||b)if(this._foldingRulerVisible=
a,this._foldingRuler){var d=this._textView;d.getModel().getBaseModel&&(a?d.addRuler(this._foldingRuler):d.removeRuler(this._foldingRuler))}},setLineNumberRulerVisible:function(a,b){if(this._lineNumberRulerVisible!==a||b)if(this._lineNumberRulerVisible=a,this._lineNumberRuler){var d=this._textView;a?d.addRuler(this._lineNumberRuler,!this._annotationRulerVisible?0:1):d.removeRuler(this._lineNumberRuler)}},setOverviewRulerVisible:function(a,b){if(this._overviewRulerVisible!==a||b)if(this._overviewRulerVisible=
a,this._overviewRuler){var d=this._textView;a?d.addRuler(this._overviewRuler):d.removeRuler(this._overviewRuler)}},mapOffset:function(a,b){var d=this._textView.getModel();d.getBaseModel&&(a=d.mapOffset(a,b));return a},getLineAtOffset:function(a){return this.getModel().getLineAtOffset(this.mapOffset(a))},getLineStart:function(a){return this.getModel().getLineStart(a)},getCaretOffset:function(){return this.mapOffset(this._textView.getCaretOffset())},getSelection:function(){var a=this._textView,b=a.getSelection(),
a=a.getModel();a.getBaseModel&&(b.start=a.mapOffset(b.start),b.end=a.mapOffset(b.end));return b},_expandOffset:function(a){var b=this._textView.getModel(),d=this._annotationModel;if(d&&b.getBaseModel)for(a=d.getAnnotations(a,a+1);a.hasNext();)b=a.next(),b.type===h.ANNOTATION_FOLDING&&b.expand&&b.expand()},setCaretOffset:function(a,b,d){var e=this._textView,f=e.getModel();f.getBaseModel&&(this._expandOffset(a),a=f.mapOffset(a,!0));e.setCaretOffset(a,b,d)},setText:function(a,b,d){var e=this._textView,
f=e.getModel();f.getBaseModel&&(void 0!==b&&(this._expandOffset(b),b=f.mapOffset(b,!0)),void 0!==d&&(this._expandOffset(d),d=f.mapOffset(d,!0)));e.setText(a,b,d)},setSelection:function(a,b,d,e){var f=this._textView,h=f.getModel();h.getBaseModel&&(this._expandOffset(a),this._expandOffset(b),a=h.mapOffset(a,!0),b=h.mapOffset(b,!0));f.setSelection(a,b,d,e)},moveSelection:function(a,b,d,e){var f=this._textView;this.setSelection(a,b||a,1/3,function(){(void 0===e||e)&&f.focus();d&&d()})},_getTooltipInfo:function(a,
b){var d=this._textView,e=this.getAnnotationModel();if(!e)return null;var f=this._annotationStyler;if(!f)return null;var h=d.getOffsetAtLocation(a,b);if(-1===h)return null;h=this.mapOffset(h);f=f.getAnnotationsByType(e,h,h+1);e=[];for(h=0;h<f.length;h++)f[h].rangeStyle&&e.push(f[h]);if(0===e.length)return null;d=d.convert({x:a,y:b},"document","page");return{contents:e,anchor:"left",x:d.x+10,y:d.y+20}},_highlightCurrentLine:function(a,b){var d=this._annotationModel;if(d){var e=this._textView;if(!e.getOptions("singleMode")){var f=
e.getModel(),g=b?f.getLineAtOffset(b.start):-1,k=f.getLineAtOffset(a.start),e=a.start===a.end,t=!b||b.start===b.end,n=f.getLineStart(k),p=f.getLineEnd(k);f.getBaseModel&&(n=f.mapOffset(n),p=f.mapOffset(p));f=this._currentLineAnnotation;if(!(g===k&&t&&e&&f&&f.start===n&&f.end===p)){var g=f?[f]:null,u;e&&(f=h.createAnnotation(h.ANNOTATION_CURRENT_LINE,n,p),u=[f]);this._currentLineAnnotation=f;d.replaceAnnotations(g,u)}}}},installTextView:function(){this.install()},install:function(){if(!this._textView){this._textView=
this._textViewFactory();this._undoStackFactory&&(this._undoStack=this._undoStackFactory.createUndoStack(this),this.checkDirty());this._textDNDFactory&&(this._textDND=this._textDNDFactory.createTextDND(this,this._undoStack));this._contentAssistFactory&&(this._contentAssist=this._contentAssistFactory.createContentAssistMode(this).getContentAssist());var a=this,b=this._textView,d=this;this._listener={onModelChanged:function(){d.checkDirty()},onMouseOver:function(b){d._listener.onMouseMove(b)},onMouseMove:function(a){var c=
p.Tooltip.getTooltip(b);c&&!(d._listener.lastMouseX===a.event.clientX&&d._listener.lastMouseY===a.event.clientY)&&(d._listener.lastMouseX=a.event.clientX,d._listener.lastMouseY=a.event.clientY,c.setTarget({x:a.x,y:a.y,getTooltipInfo:function(){return d._getTooltipInfo(this.x,this.y)}}))},onMouseOut:function(a){var c=p.Tooltip.getTooltip(b);c&&!(d._listener.lastMouseX===a.event.clientX&&d._listener.lastMouseY===a.event.clientY)&&(d._listener.lastMouseX=a.event.clientX,d._listener.lastMouseY=a.event.clientY,
c.setTarget(null))},onScroll:function(){var a=p.Tooltip.getTooltip(b);a&&a.setTarget(null,0,0)},onSelection:function(b){d._updateCursorStatus();d._highlightCurrentLine(b.newValue,b.oldValue)}};b.addEventListener("ModelChanged",this._listener.onModelChanged);b.addEventListener("Selection",this._listener.onSelection);b.addEventListener("MouseOver",this._listener.onMouseOver);b.addEventListener("MouseOut",this._listener.onMouseOut);b.addEventListener("MouseMove",this._listener.onMouseMove);b.addEventListener("Scroll",
this._listener.onScroll);if(this._keyBindingFactory){var f;if(f="function"===typeof this._keyBindingFactory?this._keyBindingFactory(this,this.getKeyModes(),this._undoStack,this._contentAssist):this._keyBindingFactory.createKeyBindings(a,this._undoStack,this._contentAssist))this._textActions=f.textActions,this._linkedMode=f.linkedMode,this._sourceCodeActions=f.sourceCodeActions}f=function(b){if(void 0!==b&&-1!==b){for(var d=this.getView().getModel(),e=this.getAnnotationModel(),l=a.mapOffset(d.getLineStart(b)),
b=a.mapOffset(d.getLineEnd(b)),d=e.getAnnotations(l,b),f=null;d.hasNext();){var m=d.next();if(m.type===h.ANNOTATION_BOOKMARK){f=m;break}}f?e.removeAnnotation(f):(f=h.createAnnotation(h.ANNOTATION_BOOKMARK,l,b),f.title=void 0,e.addAnnotation(f))}};if(this._annotationFactory){var g=b.getModel();g.getBaseModel&&(g=g.getBaseModel());if(this._annotationModel=this._annotationFactory.createAnnotationModel(g))if(g=this._annotationStyler=this._annotationFactory.createAnnotationStyler(b,this._annotationModel))g.addAnnotationType(h.ANNOTATION_CURRENT_SEARCH),
g.addAnnotationType(h.ANNOTATION_MATCHING_SEARCH),g.addAnnotationType(h.ANNOTATION_ERROR),g.addAnnotationType(h.ANNOTATION_WARNING),g.addAnnotationType(h.ANNOTATION_MATCHING_BRACKET),g.addAnnotationType(h.ANNOTATION_CURRENT_BRACKET),g.addAnnotationType(h.ANNOTATION_CURRENT_LINE),g.addAnnotationType(h.ANNOTATION_READ_OCCURRENCE),g.addAnnotationType(h.ANNOTATION_WRITE_OCCURRENCE),g.addAnnotationType(h.ANNOTATION_SELECTED_LINKED_GROUP),g.addAnnotationType(h.ANNOTATION_CURRENT_LINKED_GROUP),g.addAnnotationType(h.ANNOTATION_LINKED_GROUP),
g.addAnnotationType("orion.annotation.highlightError");var g=this._annotationFactory.createAnnotationRulers(this._annotationModel),k=this._annotationRuler=g.annotationRuler;k&&(k.onDblClick=f,k.setMultiAnnotationOverlay({html:"<div class='annotationHTML overlay'></div>"}),k.addAnnotationType(h.ANNOTATION_ERROR),k.addAnnotationType(h.ANNOTATION_WARNING),k.addAnnotationType(h.ANNOTATION_TASK),k.addAnnotationType(h.ANNOTATION_BOOKMARK));this.setAnnotationRulerVisible(this._annotationRulerVisible||void 0===
this._annotationRulerVisible,!0);if(k=this._overviewRuler=g.overviewRuler)k.addAnnotationType(h.ANNOTATION_CURRENT_SEARCH),k.addAnnotationType(h.ANNOTATION_MATCHING_SEARCH),k.addAnnotationType(h.ANNOTATION_READ_OCCURRENCE),k.addAnnotationType(h.ANNOTATION_WRITE_OCCURRENCE),k.addAnnotationType(h.ANNOTATION_CURRENT_BLAME),k.addAnnotationType(h.ANNOTATION_ERROR),k.addAnnotationType(h.ANNOTATION_WARNING),k.addAnnotationType(h.ANNOTATION_TASK),k.addAnnotationType(h.ANNOTATION_BOOKMARK),k.addAnnotationType(h.ANNOTATION_MATCHING_BRACKET),
k.addAnnotationType(h.ANNOTATION_CURRENT_BRACKET),k.addAnnotationType(h.ANNOTATION_CURRENT_LINE);this.setOverviewRulerVisible(this._overviewRulerVisible||void 0===this._overviewRulerVisible,!0)}this._lineNumberRulerFactory&&(this._lineNumberRuler=this._lineNumberRulerFactory.createLineNumberRuler(this._annotationModel),this._lineNumberRuler.addAnnotationType(h.ANNOTATION_CURRENT_BLAME),this._lineNumberRuler.addAnnotationType(h.ANNOTATION_BLAME),this._lineNumberRuler.onDblClick=f,this.setLineNumberRulerVisible(this._lineNumberRulerVisible||
void 0===this._lineNumberRulerVisible,!0));this._foldingRulerFactory&&(this._foldingRuler=this._foldingRulerFactory.createFoldingRuler(this._annotationModel),this._foldingRuler.addAnnotationType(h.ANNOTATION_FOLDING),this.setFoldingRulerVisible(this._foldingRulerVisible||void 0===this._foldingRulerVisible,!0));this.dispatchEvent({type:"TextViewInstalled",textView:b});e.prototype.install.call(this)}},uninstallTextView:function(){this.uninstall()},uninstall:function(){var a=this._textView;a&&(a.destroy(),
...
this.getModel(),b=this.getCaretOffset(),d=a.getLineAtOffset(b),a=a.getLineStart(d),b=b-a,a=this.getKeyModes(),e=0;e<a.length;e++){var h=a[e];if(h.isActive()&&h.isStatusActive&&h.isStatusActive())return}this.reportStatus(f.formatMessage(g.lineColumn,d+1,b+1))},showAnnotations:function(a,b,d,e){var f=this._annotationModel;if(f){for(var g=[],k=[],t=f.getTextModel(),n=f.getAnnotations(),p;n.hasNext();)p=n.next(),-1!==b.indexOf(p.type)&&p.creatorID===this&&g.push(p);if(a)for(b=0;b<a.length;b++)if(p=a[b]){if(d)p=
d(p);else{var u;"number"===typeof p.line?(u=t.getLineStart(p.line-1),n=u+p.start-1,u=u+p.end-1):(n=p.start,u=p.end);var z=e(p);if(!z)continue;p=h.createAnnotation(z,n,u,p.description)}p.creatorID=this;k.push(p)}f.replaceAnnotations(g,k)}},showProblems:function(a){this.showAnnotations(a,[h.ANNOTATION_ERROR,h.ANNOTATION_WARNING,h.ANNOTATION_TASK],null,function(b){switch(b.severity){case "error":return h.ANNOTATION_ERROR;case "warning":return h.ANNOTATION_WARNING;case "task":return h.ANNOTATION_TASK}return null})},
...
define("orion/selection",["orion/EventTarget","orion/Deferred"],function(g){function n(n,a){a||(a="orion.page.selection");this._serviceRegistry=n;g.attach(this);this._serviceRegistration=n.registerService(a,this);this._selections=null}n.prototype={getSelection:function(g){var a=this._getSingleSelection();"function"===typeof g&&g(a);return a},getSelections:function(g){var a=Array.isArray(this._selections)?this._selections.slice():[];"function"===typeof g&&g(a);return a},_getSingleSelection:function(){return this._selections&&
...
define("orion/commandRegistry","require orion/commands orion/explorers/navigationUtils orion/PageUtil orion/uiUtils orion/webui/littlelib orion/webui/dropdown orion/webui/tooltip text!orion/webui/checkedmenuitem.html text!orion/webui/dropdowntriggerbutton.html text!orion/webui/submenutriggerbutton.html".split(" "),function(g,n,p,a,k,f,e,d,h,c,b){function l(b){this._commandList={};this._contributionsByScopeId={};this._activeBindings={};this._urlBindings={};this._pendingBindings={};this._init(b);this._parameterCollector=
null}function m(b,a){this.token=b;this.parameterName=a}function r(b,a,c){this.event=b;this.handler=a;this.capture=c||!1}function s(b,a,c,d,e,l){this.name=b;this.type=a;this.label=c;this.value=d;this.lines=e||1;this.eventListeners=Array.isArray(l)?l:l?[l]:[]}function x(b,a,c){this._storeParameters(b);this._hasOptionalParameters=a&&a.hasOptionalParameters;this._options=a;this.optionsRequested=!1;this.getParameters=c;this.clientCollect=a&&a.clientCollect}l.prototype={_init:function(b){this._selectionService=
b.selection;var a=this;n.setKeyBindingProvider(function(){return a._activeBindings})},processURL:function(b){for(var a in this._urlBindings)if(this._urlBindings[a]&&this._urlBindings[a].urlBinding&&this._urlBindings[a].command){var c=this._urlBindings[a].urlBinding.match(b);if(c){var d=this._urlBindings[a],e=d.command,l=d.invocation;if(l&&l.parameters&&e.callback){l.parameters.setValue(c.parameterName,c.parameterValue);var f=this;window.setTimeout(function(){f._invoke(l)},0);break}}}},findCommand:function(b){return this._commandList[b]},
...
a,c))},confirm:function(b,a,c,d,e,l){var f=!1;if(this._parameterCollector&&!e){var m=this;this._parameterCollector.close();if(this._parameterCollector.open(b,function(b,e){var l=document.createElement("span");l.classList.add("parameterPrompt");l.textContent=a;b.appendChild(l);l=document.createElement("button");l.addEventListener("click",function(){f=!0;m._parameterCollector.close()},!1);e.appendChild(l);l.appendChild(document.createTextNode(c));l.className="dismissButton";var h=document.createElement("button");
h.addEventListener("click",function(){f=!1;m._parameterCollector.close()},!1);e.appendChild(h);h.appendChild(document.createTextNode(d));h.className="dismissButton";return l},function(){l(f)}))return}f=window.confirm(a);l(f)},closeParameterCollector:function(){this._parameterCollector&&this._parameterCollector.close()},collectsParameters:function(){return this._parameterCollector},_invoke:function(b,a){return this._collectAndInvoke(b.makeCopy(a),!1)},_collectAndInvoke:function(b,a){if(b)if(this._parameterCollector&&
...
1]:null)&&d.classList.contains("commandSeparator"))return c?(b.removeChild(d),!1):!0;if("menu"===a&&(b=f.$$array("li > *",b),0<b.length&&b[b.length-1].classList.contains("dropdownSeparator")))if(d=b[b.length-1],c)d.parentNode.parentNode.removeChild(d.parentNode);else return!0;return!1},renderCommands:function(b,a,c,d,e,l,m){if("string"!==typeof b)throw"a scope id for rendering must be specified";a=f.node(a);if(!a)throw"no parent";var h=this._contributionsByScopeId[b];if(!c&&h){var c=h.localSelectionService||
this._selectionService,g=this;c&&c.getSelections(function(c){g.renderCommands(b,a,c,d,e,l)})}else h&&(this._render(h,a,c,d,e||"button",l,m),this._checkForTrailingSeparator(a,e,!0))},destroy:function(b){b=f.node(b);if(!b)throw"no parent";for(;b.hasChildNodes();){var a=b.firstChild;a.commandTooltip&&a.commandTooltip.destroy();a.extraCommandTooltip&&a.extraCommandTooltip.destroy();a.emptyGroupTooltip&&a.emptyGroupTooltip.destroy();this.destroy(a);b.removeChild(a)}},_render:function(b,a,c,e,l,f,m){var h=
b.sortedContributions;if(!h){var h=[],g=!1,r;for(r in b)if(Object.prototype.hasOwnProperty.call(b,r)){var s=b[r];s&&"number"===typeof s.position&&(s.id=r,h.push(s),g=!0)}g&&(h.sort(function(b,a){return b.position-a.position}),b.sortedContributions=h)}var x=0,B=this;h.forEach(function(b){var h;b.imageClass||(b.imageClass=null);if(b.children&&0<Object.getOwnPropertyNames(b.children).length){var g=b.children;if("tool"===l||"button"===l)if(b.title){var r;b.defaultActionId&&((g=B._commandList[b.defaultActionId])&&
(g.visibleWhen?g.visibleWhen(c):1)?(r=new n.CommandInvocation(e,c,f,g,B),r.domParent=a):b.pretendDefaultActionId=!0);g=B._createDropdownMenu(a,b.title,null,null,b.imageClass,b.tooltip,b.selectionClass,null,r,b.pretendDefaultActionId);m&&p.generateNavGrid(m,g.menuButton);g&&(B._render(b.children,g.menu,c,e,"menu",f,m),B._checkForTrailingSeparator(g.menu,"menu",!0),0===g.menu.childNodes.length?b.emptyGroupMessage?g.menuButton.emptyGroupTooltip||(g.menuButton.emptyGroupTooltip=new d.Tooltip({node:g.menuButton,
text:b.emptyGroupMessage,trigger:"click",position:["below","right","above","left"]})):(m&&p.removeNavGrid(m,g.menuButton),g.menu.parentNode&&(g.menu.remove(),g.menuButton.remove(),g.extraDropdownButton&&g.extraDropdownButton.remove()),g.destroyButton&&g.destroyButton.parentNode&&g.destroyButton.parentNode.removeChild(g.destroyButton)):g.menuButton.style.visibility="visible")}else{var t;0<a.childNodes.length&&!B._checkForTrailingSeparator(a,l)&&(t=B.generateSeparatorImage(a));B._render(g,a,c,e,l,f,
m);0<a.childNodes.length&&a.childNodes[a.childNodes.length-1]!==t&&(t=B.generateSeparatorImage(a))}else if(b.title){if(b=B._createDropdownMenu(a,b.title,!0,null,null,b.imageClass))B._render(g,b.menu,c,e,"menu",f,m),B._checkForTrailingSeparator(b.menu,"menu",!0),0===b.menu.childNodes.length&&b.destroyButton&&a.removeChild(b.destroyButton)}else 0<a.childNodes.length&&B._generateMenuSeparator(a),B._render(g,a,c,e,l,f,m),B._generateMenuSeparator(a)}else{var s=B._commandList[b.id],g=s?!0:!1;r=b=null;s&&
(h=new n.CommandInvocation(e,c,f,s,B),h.domParent=a,t=g&&(s.visibleWhen?s.visibleWhen(c):!0),B._activeBindings[s.id]&&B._activeBindings[s.id].keyBinding&&(b=B._activeBindings[s.id],b.invocation=t?h:null,b.bindingOnly&&(g=!1)),B._urlBindings[s.id]&&B._urlBindings[s.id].urlBinding&&(r=B._urlBindings[s.id],r.invocation=t?h:null,r.bindingOnly&&(g=!1)),g=g&&t);g&&(s.choiceCallback?("tool"===l||"button"===l?(b=a,g=!1,"ul"===a.nodeName.toLowerCase()&&(b=document.createElement("li"),a.appendChild(b))):(b=
a,g=!0),B._createDropdownMenu(b,s.name,g,function(b){s.populateChoicesMenu(b,c,e,f,B)}.bind(s),s.imageClass,s.tooltip||s.title,s.selectionClass,s.positioningNode)):(h.handler=h.handler||this,h.domParent=a,g=function(){B._invoke(h)},"menu"===l?(r=null,b&&b.keyBinding&&(r=k.getUserKeyString(b.keyBinding)),b=n.createCommandMenuItem(a,s,h,null,g,r)):(b=l+s.id+x,b=n.createCommandItem(a,s,h,b,null,"tool"===l,g)),p.generateNavGrid(m,b),h.domNode=b,x++))}})},_createDropdownMenu:function(a,c,l,m,h,g,k,r,p,
s){a=f.node(a);if(!a||!f.contains(document.body,a))return null;var x,E,B=a;if(l)g=document.createRange(),g.selectNode(a),g=g.createContextualFragment(b),f.processTextNodes(g,{ButtonText:c}),a.appendChild(g),E=a.lastChild,h=E.lastChild,s=h.previousSibling,s.dropdown=new e.Dropdown({dropdown:h,populate:m,parentDropdown:a.dropdown}),h.dropdown=s.dropdown;else{"ul"===a.nodeName.toLowerCase()&&(B=document.createElement("li"),a.appendChild(B),E=B);x=null;h&&(x="dropdownButtonWithIcon",g=g||c);g=h?g||c:
g;m=n.createDropdownMenu(B,c,m,x,h,!1,k,r,p||s);if(p){p.domNode=m.menuButton;var K=this;m.menuButton.onclick=function(){K._invoke(p)}}else s&&m.dropdown&&m.dropdown.addTriggerNode(m.menuButton);s=m.menuButton;h=m.menu;x=m.extraDropdownButton;g?(s.commandTooltip=new d.Tooltip({node:s,text:p&&p.command&&p.command.name?g+": "+p.command.name:g,position:["above","below","right","left"]}),m.extraDropdownButton&&(s.extraCommandTooltip=new d.Tooltip({node:m.extraDropdownButton,text:g,position:["above","below",
"right","left"]}))):p&&(p.command&&p.command.name)&&(s.commandTooltip=new d.Tooltip({node:s,text:c+": "+p.command.name,position:["above","below","right","left"]}))}return{menuButton:s,menu:h,dropdown:s.dropdown,destroyButton:E,extraDropdownButton:x}},_generateMenuSeparator:function(b){if(!this._checkForTrailingSeparator(b,"menu")){var a=document.createElement("li");a.classList.add("dropdownSeparator");var c=document.createElement("span");c.classList.add("dropdownSeparator");a.appendChild(c);b.appendChild(a)}},
generateSeparatorImage:function(b){var a;a="ul"===b.nodeName.toLowerCase()?document.createElement("li"):document.createElement("span");b.appendChild(a);a.classList.add("core-sprite-sep");a.classList.add("imageSprite");a.classList.add("commandSeparator");return a}};l.prototype.constructor=l;m.prototype={match:function(b){b=a.matchResourceParameters(b);return"undefined"!==typeof b[this.token]?(this.parameterValue=b[this.token],this):null}};m.prototype.constructor=m;r.prototype.constructor=r;s.prototype=
{optionsRequested:function(){return this.optionsRequested}};s.prototype.constructor=s;x.prototype={_storeParameters:function(b){this.parameterTable=null;if(b){var a=this.parameterTable={};b.forEach(function(b){a[b.name]=b})}},updateParameters:function(b){"function"===typeof this.getParameters&&this._storeParameters(this.getParameters(b))},hasParameters:function(){return null!==this.parameterTable},shouldCollectParameters:function(){return!this.clientCollect&&this.hasParameters()},parameterNamed:function(b){return this.parameterTable[b]},
valueFor:function(b){return(b=this.parameterTable[b])?b.value:null},setValue:function(b,a){var c=this.parameterTable[b];c&&(c.value=a)},forEach:function(b){for(var a in this.parameterTable)this.parameterTable[a].type&&this.parameterTable[a].name&&b(this.parameterTable[a])},makeCopy:function(){var b=[];this.forEach(function(a){a=new s(a.name,a.type,a.label,a.value,a.lines,a.eventListeners);b.push(a)});var a=new x(b,this._options,this.getParameters);a.clientCollect=this.clientCollect;return a},hasOptionalParameters:function(){return this._hasOptionalParameters}};
x.prototype.constructor=x;return{CommandRegistry:l,URLBinding:m,ParametersDescription:x,CommandParameter:s,CommandEventListener:r}});define("text!orion/banner/slideout.html",[],function(){return'<div id="slideContainer" class="slideParameters slideContainer">\r\n\t<span id="pageCommandParameters" class="layoutLeft parameters"></span>\r\n\t<span id="pageCommandDismiss" class="layoutRight parametersDismiss"></span>\r\n</div>'});
...
define("orion/widgets/browse/browseView","i18n!orion/edit/nls/messages orion/explorers/explorer-table orion/explorers/navigatorRenderer orion/markdownView orion/PageUtil orion/URITemplate orion/webui/littlelib orion/objects orion/Deferred orion/section".split(" "),function(g,n,p,a,k,f,e,d,h,c){function b(){s.apply(this,arguments)}function l(a){a.setFocus=!1;a.cachePrefix=null;a.rendererFactory=function(c){return new b({checkbox:!1,cachePrefix:"FolderNavigator"},c,a.commandRegistry,a.contentTypeRegistry)};
...
[this.newActionsScope,this.selectionActionsScope]}function m(b){this._parent=b.parent;this._metadata=b.metadata;this.fileClient=b.fileService;this.progress=b.progressService;this.commandRegistry=b.commandRegistry;this.contentTypeRegistry=b.contentTypeRegistry;this.preferences=b.preferences;this.readonly=!0;this.readmeHeaderClass=b.readmeHeaderClass;this.editorView=b.editorView;this._maxEditorLines=b.maxEditorLines;this.imageView=b.imageView;this.breadCrumbInHeader=b.breadCrumbInHeader;this.isMarkdownView=
b.isMarkdownView;this.breadCrumbMaker=b.breadCrumbMaker;this.branchSelector=b.branchSelector;this.componentSelector=b.componentSelector;this.clickHandler=b.clickHandler;this._init()}var r=n.FileExplorer,s=p.NavigatorRenderer,x=new f("#{,resource,params*}");b.prototype=Object.create(s.prototype);d.mixin(b.prototype,{showFolderImage:!0,createFolderNode:function(b){var a=p.NavigatorRenderer.prototype.createFolderNode.call(this,b);this.showFolderLinks&&"A"===a.tagName&&(a.href=x.expand({resource:b.Location}));
a.classList.add("folderNavFolder");a.classList.add("navlink");a.classList.add("targetSelector");a.classList.remove("navlinkonpage");this.explorer.readonly&&this.explorer.clickHandler&&(a.href="javascript:void(0)",a.addEventListener("click",function(){this.explorer.clickHandler(b.Location)}.bind(this),!1));return a},updateFileNode:function(b,a,c){p.NavigatorRenderer.prototype.updateFileNode.call(this,b,a,c);this.explorer.readonly&&"A"===a.tagName&&(this.explorer.clickHandler?(a.href="javascript:void(0)",
a.addEventListener("click",function(){this.explorer.clickHandler(b.Location)}.bind(this),!1)):a.href=x.expand({resource:b.Location}))},getCellHeaderElement:function(b){if(this.explorer.breadCrumbMaker)return null;if(0===b){b=document.createElement("th");b.colSpan=1;var a=this.explorer.treeRoot;b.appendChild(document.createTextNode(a.Parents?a.Name:this.explorer.fileClient.fileServiceName(a.Location)));return b}return null},emptyCallback:function(b){this.explorer.readonly?this.explorer.folderViewer.updateEmptyContents("This folder is empty."):
p.NavigatorRenderer.prototype.emptyCallback.call(this,b)},getExpandImage:function(){return null}});l.prototype=Object.create(r.prototype);d.mixin(l.prototype,{loadRoot:function(b){b?this.load(b,"Loading "+b.Name).then(this.loaded.bind(this)):this.loadResourceList(k.matchResourceParameters().resource+"?depth=1",!1).then(this.loaded.bind(this))},loaded:function(){},registerCommands:function(){return(new h).resolve()},updateCommands:function(){},setCommandsVisible:function(b,a){b.actionsNode.style.visibility=
a?"":"hidden";var c=a?null:"cursorOnly";this.renderer.selectionPolicy=c;var d=this.getNavHandler();d&&d.setSelectionPolicy(c);a?this.updateCommands():this.actionsSections&&this.actionsSections.forEach(function(b){e.node(b)&&this.commandRegistry.destroy(b)}.bind(this))}});m.prototype={_init:function(){this.markdownView=new a.MarkdownView({fileClient:this.fileClient,canHide:!this.readonly,progress:this.progress})},_isCommandsVisible:function(){return!this.readonly},displayWorkspaceView:function(){this._node||
(this._node=document.createElement("div"),this._node.classList.add("browse_inner_container"));this._parent.appendChild(this._node)},displayBrowseView:function(b){var b=b.Children,a;if(b)for(var d=0;d<b.length;d++){var f=b[d];!f.Directory&&(f.Name&&"readme.md"===f.Name.toLowerCase())&&(a=f)}var g;this._node||(this._node=document.createElement("div"),this._node.classList.add("browse_inner_container"));this._parent.appendChild(this._node);(function(b){b.forEach(function(b){if("folderNav"===b){b=document.createElement("div");
b.id="folderNavNode";this._foldersSection=new c.Section(this._node,{id:"folderNavSection",title:"Browse",canHide:!this.readonly});this.sectionContents=document.createElement("div");this.sectionContents.classList.add("browseSectionWrapper");this._foldersSection.setContent(this.sectionContents);var d=this._foldersSection.getTitleElement();d&&(e.empty(d),this.branchSelector&&(d.appendChild(this.branchSelector.parentNode),this.branchSelector.refresh()),this.componentSelector&&(d.appendChild(this.componentSelector.parentNode),
this.componentSelector.refresh()));if(this.breadCrumbMaker){var f=document.createElement("div"),m=document.createElement("div");f.appendChild(m);this.breadCrumbInHeader?(f.classList.add("breadCrumbContainerInHeader"),d.appendChild(f),this.breadCrumbMaker(m,this._foldersSection.getHeaderElement().offsetWidth-150-50)):(f.classList.add("breadCrumbContainer"),this.sectionContents.appendChild(f),this.breadCrumbMaker(m,this._foldersSection.getHeaderElement().offsetWidth-5))}if(this.editorView){this.sectionContents.appendChild(this.editorView.getParent());
this.editorView.getParent().style.height="30px";this.editorView.create();var h=this.editorView.editor.getTextView();h.getModel().addEventListener("Changed",this._editorViewModelChangedListener=function(){var b=h.getModel().getLineCount();this._maxEditorLines&&(0<this._maxEditorLines&&b>this._maxEditorLines)&&(b=this._maxEditorLines);b=h.getLineHeight()*b+20;this.editorView.getParent().style.height=b+"px"}.bind(this));this.editor=this.editorView.editor}else this.isMarkdownView?(g=document.createElement("div"),
this.markdownView.displayContents(g,this._metadata),this.sectionContents.appendChild(g)):this.imageView?this.imageView.image&&this.updateImage(this.imageView.image):(this.folderNavExplorer=new l({parentId:b,fodlerViewer:this,readonly:this.readonly,breadCrumbMaker:this.breadCrumbMaker,clickHandler:this.clickHandler,fileClient:this.fileClient,commandRegistry:this.commandRegistry,contentTypeRegistry:this.contentTypeRegistry}),this.sectionContents.appendChild(this.folderNavExplorer.parent),this.folderNavExplorer.setCommandsVisible(this._foldersSection,
this._isCommandsVisible()),this.folderNavExplorer.loadRoot(this._metadata))}else"readme"===b&&a&&(g=document.createElement("div"),this.markdownView.displayInFrame(g,a,this.readmeHeaderClass),this._node.appendChild(g))}.bind(this))}).apply(this,[["folderNav","readme"]])},updateImage:function(b){var a=document.createElement("table");a.classList.add("imageViewTable");var c=document.createElement("tr"),d=document.createElement("td"),e=document.createElement("div");e.appendChild(b);d.appendChild(e);c.appendChild(d);
a.appendChild(c);this.sectionContents.appendChild(a)},updateEmptyContents:function(b){var a=document.createElement("table");a.classList.add("emptyViewTable");var c=document.createElement("tr"),d=document.createElement("td"),e=document.createElement("div");e.appendChild(document.createTextNode(b));d.appendChild(e);c.appendChild(d);a.appendChild(c);this.sectionContents.appendChild(a)},create:function(){this._metadata.Projects&&this.displayWorkspaceView();this.editorView||this.imageView||this.isMarkdownView?
this.displayBrowseView(this._metadata):this._metadata.Children?this.displayBrowseView(this._metadata):this._metadata.ChildrenLocation&&this.progress.progress(this.fileClient.fetchChildren(this._metadata.ChildrenLocation),"Fetching children of "+this._metadata.Name).then(function(b){this._metadata.Children=b;this.displayBrowseView(this._metadata)}.bind(this))},destroy:function(){this.editorView&&(this.editorView.editor.getTextView().getModel().removeEventListener("Changed",this._editorViewModelChangedListener),
this.editorView.destroy(),this.editor=null);this.folderNavExplorer&&this.folderNavExplorer.destroy();this.folderNavExplorer=null;this._node&&this._node.parentNode&&this._node.parentNode.removeChild(this._node);this._node=null}};return{BrowseView:m}});
define("orion/editor/find","i18n!orion/editor/nls/messages orion/keyBinding orion/editor/keyModes orion/editor/annotations orion/regex orion/objects orion/util".split(" "),function(g,n,p,a,k,f,e){function d(b){var a=b.getTextView();p.KeyMode.call(this,a);this.editor=b;this._active=!1;this._success=!0;this._ignoreSelection=!1;this._prefix="";a.setAction("incrementalFindCancel",function(){this.setActive(!1);return!0}.bind(this));a.setAction("incrementalFindBackspace",function(){return this._backspace()}.bind(this));
var c=this;this._listener={onVerify:function(b){var a=c.editor,d=a.getModel(),e=a.mapOffset(b.start),a=a.mapOffset(b.end),d=d.getText(e,a);if((d=c._prefix.match(RegExp("^"+k.escape(d),"i")))&&0<d.length)c._prefix+=b.text,c._success=!0,c._status(),c.find(c._forward,!0),b.text=null},onSelection:function(){c._ignoreSelection||c.setActive(!1)}}}function h(b,a,c){if(b){this._editor=b;this._undoStack=a;this._showAll=!0;this._visible=!1;this._wrap=this._caseInsensitive=!0;this._wholeWord=!1;this._incremental=
...
this._doReplace(a.start,a.end,b,c),this.endUndo()}this._findAfterReplace&&b&&this._doFind(b,this.getStartOffset())},replaceAll:function(){var b=this.getFindString();if(b){this._replacingAll=!0;var a=this._editor,c=a.getTextView();a.reportStatus(g.replaceAll);var d=this._processReplaceString(this.getReplaceString()),f=this;window.setTimeout(function(){for(var h=0,k=0;;){var n=f._doFind(b,h,null,!0);if(!n)break;k++;1===k&&(c.setRedraw(!1),f.startUndo());f._doReplace(n.start,n.end,b,d);h=f.getStartOffset()}0<
k&&(f.endUndo(),c.setRedraw(!0));0<h?a.reportStatus(e.formatMessage(g.replacedMatches,k)):a.reportStatus(g.nothingReplaced,"error");f._replacingAll=!1},100)}},setOptions:function(b){if(b){if((!0===b.showAll||!1===b.showAll)&&this._showAll!==b.showAll)if(this._showAll=b.showAll,this.isVisible())if(this._showAll)this._markAllOccurrences();else{var c=this._editor.getAnnotationModel();c&&c.removeAnnotations(a.AnnotationType.ANNOTATION_MATCHING_SEARCH)}if(!0===b.caseInsensitive||!1===b.caseInsensitive)this._caseInsensitive=
...
f=c.getLineAtOffset(d.end>d.start?d.end-1:d.end);if(e!==f){var g=[];g.push("");for(var h=e;h<=f;h++)g.push(c.getLine(h,!0));h=c.getLineStart(e);c=c.getLineEnd(f,!0);a=a.getOptions("tabSize","expandTab");a=a.expandTab?Array(a.tabSize+1).join(" "):"\t";b.setText(g.join(a),h,c);b.setSelection(h===d.start?d.start:d.start+a.length,d.end+(f-e+1)*a.length);return!0}return!1}},gotoLastEdit:function(){"number"===typeof this._lastEditLocation&&this.editor.showSelection(this._lastEditLocation);return!0},gotoLine:function(){var b=
this.editor,a=b.getModel().getLineAtOffset(b.getCaretOffset());if(a=prompt(g.gotoLinePrompty,a+1))a=parseInt(a,10),b.onGotoLine(a-1,0);return!0},moveLinesDown:function(){var b=this.editor;if(b.getTextView().getOptions("readonly"))return!1;var a=b.getModel(),c=b.getSelection(),d=a.getLineAtOffset(c.start),e=a.getLineAtOffset(c.end>c.start?c.end-1:c.end),f=a.getLineCount();if(e===f-1)return!0;var d=a.getLineStart(d),c=a.getLineEnd(e,!0),g=a.getLineEnd(e+1,!0)-(c-d),h=0;e!==f-2?a=a.getText(d,c):(e=a.getLineEnd(e),
a=a.getText(e,c)+a.getText(d,e),h+=c-e);this.startUndo();b.setText("",d,c);b.setText(a,g,g);b.setSelection(g+h,g+h+a.length);this.endUndo();return!0},moveLinesUp:function(){var b=this.editor;if(b.getTextView().getOptions("readonly"))return!1;var a=b.getModel(),c=b.getSelection(),d=a.getLineAtOffset(c.start);if(0===d)return!0;var e=a.getLineAtOffset(c.end>c.start?c.end-1:c.end),f=a.getLineCount(),c=a.getLineStart(d-1),g=a.getLineStart(d),h=a.getLineEnd(e,!0),k=a.getText(g,h),n=0;e===f-1&&(e=a.getLineEnd(d-
1),d=a.getLineEnd(d-1,!0),k+=a.getText(e,d),g=e,n=d-e);this.startUndo();b.setText("",g,h);b.setText(k,c,c);b.setSelection(c,c+k.length-n);this.endUndo();return!0},nextAnnotation:function(b){function c(b){return!!b.lineStyle||b.type===h.ANNOTATION_MATCHING_BRACKET||b.type===h.ANNOTATION_CURRENT_BRACKET||!f.isAnnotationTypeVisible(b.type)}var d=this.editor,e=d.getAnnotationModel();if(!e)return!0;var f=d.getOverviewRuler()||d.getAnnotationStyler();if(!f)return!0;for(var g=d.getModel(),k=d.getCaretOffset(),
n=e.getAnnotations(b?k:0,b?g.getCharCount():k),p=null;n.hasNext();){var u=n.next();if(b){if(u.start<=k)continue}else if(u.start>=k)continue;if(!c(u)&&(p=u,b))break}if(p){for(var z=[p],n=e.getAnnotations(p.start,p.start);n.hasNext();)u=n.next(),u!==p&&!c(u)&&z.push(u);var q=d.getTextView(),v=g.getLineAtOffset(p.start),A=a.Tooltip.getTooltip(q);if(!A)return d.moveSelection(p.start),!0;d.moveSelection(p.start,p.start,function(){A.setTarget({getTooltipInfo:function(){var b=q.convert({x:q.getLocationAtOffset(p.start).x,
y:q.getLocationAtOffset(g.getLineStart(v)).y},"document","page");return{contents:z,x:b.x,y:b.y+Math.floor(1.33*q.getLineHeight(v))}}},0)})}return!0},unindentLines:function(){var b=this.editor,a=b.getTextView();if(a.getOptions("readonly"))return!1;if(a.getOptions("tabMode")){for(var c=b.getModel(),d=b.getSelection(),e=c.getLineAtOffset(d.start),f=c.getLineAtOffset(d.end>d.start?d.end-1:d.end),g=a.getOptions("tabSize"),h=Array(g+1).join(" "),k=[],n=a=0,p=e;p<=f;p++){var q=c.getLine(p,!0);if(c.getLineStart(p)!==
c.getLineEnd(p))if(0===q.indexOf("\t"))q=q.substring(1),a++;else if(0===q.indexOf(h))q=q.substring(g),a+=g;else return!0;p===e&&(n=a);k.push(q)}e=c.getLineStart(e);g=c.getLineEnd(f,!0);c=c.getLineStart(f);b.setText(k.join(""),e,g);f=e===d.start?d.start:d.start-n;d=Math.max(f,d.end-a+(d.end===c+1&&d.start!==d.end?1:0));b.setSelection(f,d);return!0}},startUndo:function(){this.undoStack&&this.undoStack.startCompoundChange()},endUndo:function(){this.undoStack&&this.undoStack.endCompoundChange()}};c.TextActions=
...
b.setKeyBinding(new n.KeyBinding('"',!1,!1,!1,!1,"keypress"),"autoPairDblQuotation");b.setAction("autoPairDblQuotation",function(){return this.autoPairQuotations('"')}.bind(this));b.setAction("deletePrevious",function(){return this.deletePrevious()}.bind(this))},autoIndent:function(){var b=this.editor,a=b.getTextView();if(a.getOptions("readonly"))return!1;var c=b.getSelection();if(c.start===c.end){for(var d=b.getModel(),e=d.getLineAtOffset(c.start),f=d.getLine(e,!1),g=d.getLineStart(e),h=0,k=c.start-
g,n;h<k&&(32===(n=f.charCodeAt(h))||9===n);)h++;var g=f.substring(0,h),a=a.getOptions("tabSize","expandTab"),p=a.expandTab?Array(a.tabSize+1).join(" "):"\t",a=d.getLineDelimiter(),q=/^[\s]*\/\*[\*]*[\s]*$/,v=/^[\s]*\*/,A=/\*\/[\s]*$/,C=f.substring(0,k),D=f.substring(k),M;if(this.smartIndentation&&123===f.charCodeAt(M=C.trimRight().length-1))return d=k-M-1,D=D.length-D.trimLeft().length,f=125===f.charCodeAt(k+D)?a+g+p+a+g:a+g+p,b.setText(f,c.start-d,c.end+D),b.setCaretOffset(c.start+a.length+g.length+
p.length-d),!0;if(this.autoCompleteComments&&!A.test(C)&&(q.test(C)||v.test(C))){if(h=q.exec(C)){f=a+g+" * ";f=A.test(D)?f+D.substring(0,D.length-2).trim():f+D.trim();if(d.getLineCount()===e+1||!v.test(d.getLine(e+1)))f+=a+g+" */";b.setText(f,c.start,c.end+D.length);b.setCaretOffset(c.start+a.length+g.length+3);return!0}if(h=v.exec(C))for(e-=1;0<=e;e--){h=d.getLine(e,!1);if(q.test(h))return A.test(D)||47===f.charCodeAt(k)?(f=a+g+"*"+D,g=c.start+a.length+g.length+1):(f=a+g+"* "+D,g=c.start+a.length+
g.length+2),b.setText(f,c.start,c.end+D.length),b.setCaretOffset(g),!0;if(!v.test(h))break}}else{if(A.test(C)&&32===g.charCodeAt(g.length-1))return f=a+g.substring(0,g.length-1),b.setText(f,c.start,c.end),b.setCaretOffset(c.start+f.length),!0;if(0<h){for(h=k;h<f.length&&(32===(n=f.charCodeAt(h++))||9===n);)c.end++;b.setText(d.getLineDelimiter()+g,c.start,c.end);return!0}}}return!1},addBlockComment:function(){var b=this.editor;if(b.getTextView().getOptions("readonly"))return!1;var a=b.getModel(),c=
...
if(a.getTextView().getOptions("readonly"))return!1;var c=a.getSelection(),d=a.getModel(),e=a.getCaretOffset(),f=0===e?"":d.getText(c.start-1,c.start).trim(),g=e===d.getCharCount()?"":d.getText(c.start,c.start+1).trim(),e=/^"$|^'$/,h=/\w/,k=/^$|[)}\]>]/;if(c.start!==c.end){d=d.getText(c.start,c.end);if(e.test(d))return!1;a.setText(b+d+b,c.start,c.end);a.setSelection(c.start+1,c.end+1)}else{if(g!==b){if(f===b||e.test(g)||h.test(f)||!k.test(g))return!1;a.setText(b+b,c.start,c.start)}a.setCaretOffset(c.start+
...
e=b.getLineAtOffset(c),f,g,h,k,n,p;for(f=d;0<=f&&!(g=b.getLine(f),h=f===d?a-b.getLineStart(d):g.length,k=g.lastIndexOf("/*",h),g=g.lastIndexOf("*/",h),g>k);f--)if(-1!==k){n=b.getLineStart(f)+k;break}for(f=e;f<b.getLineCount()&&!(g=b.getLine(f),h=f===e?c-b.getLineStart(e):0,k=g.indexOf("/*",h),g=g.indexOf("*/",h),-1!==k&&k<g);f++)if(-1!==g){p=b.getLineStart(f)+g;break}return{commentStart:n,commentEnd:p}},lineStart:function(){for(var b=this.editor,a=b.getModel(),c=b.getCaretOffset(),d=a.getLineAtOffset(c),
e=a.getLineStart(d),a=a.getLine(d),d=0;d<a.length;d++){var f=a.charCodeAt(d);if(!(32===f||9===f))break}d+=e;return c!==d?(b.setSelection(d,d),!0):!1},removeBlockComment:function(){var b=this.editor;if(b.getTextView().getOptions("readonly"))return!1;var a=b.getModel(),c=b.getSelection(),d=a.getText(c.start,c.end),e,f,g;for(g=0;g<d.length;g++)if("/*"===d.substring(g,g+2)){e=c.start+g;break}for(;g<d.length;g++)if("*/"===d.substring(g,g+2)){f=c.start+g;break}if(void 0!==e&&void 0!==f)b.setText(a.getText(e+
2,f),e,f+2),b.setSelection(e,f);else{d=this._findEnclosingComment(a,c.start,c.end);if(void 0===d.commentStart||void 0===d.commentEnd)return!0;a=a.getText(d.commentStart+2,d.commentEnd);b.setText(a,d.commentStart,d.commentEnd+2);b.setSelection(c.start-2,c.end-2)}return!0},toggleLineComment:function(){var b=this.editor;if(b.getTextView().getOptions("readonly"))return!1;for(var a=b.getModel(),c=b.getSelection(),d=a.getLineAtOffset(c.start),e=a.getLineAtOffset(c.end>c.start?c.end-1:c.end),f=!0,g=[],h,
k,n=d;n<=e;n++)if(h=a.getLine(n,!0),g.push(h),!f||-1===(k=h.indexOf("//")))f=!1;else if(0!==k){var p;for(p=0;p<k&&!(f=h.charCodeAt(p),!(32===f||9===f));p++);f=p===k}n=a.getLineStart(d);p=a.getLineEnd(e,!0);if(f){for(f=0;f<g.length;f++)h=g[f],k=h.indexOf("//"),g[f]=h.substring(0,k)+h.substring(k+2);g=g.join("");h=a.getLineStart(e);a=n===c.start?c.start:c.start-2;c=c.end-2*(e-d+1)+(c.end===h+1?2:0)}else g.splice(0,0,""),g=g.join("//"),a=n===c.start?c.start:c.start+2,c=c.end+2*(e-d+1);b.setText(g,n,
p);b.setSelection(a,c);return!0},trimTrailingWhitespaces:function(){var b=this.editor,a=b.getModel(),c=b.getSelection();b.getTextView().setRedraw(!1);b.getUndoStack().startCompoundChange();for(var d=/(\s+$)/,e=a.getLineCount(),f=0;f<e;f++){var g=a.getLine(f),h=d.exec(g);if(h){var k=a.getLineStart(f),g=h[0].length,h=k+h.index;a.setText("",h,h+g);c.start>h&&(c.start=Math.max(h,c.start-g));c.start!==c.end&&c.end>h&&(c.end=Math.max(h,c.end-g))}}b.getUndoStack().endCompoundChange();b.getTextView().setRedraw(!0);
...
_onDestroy:function(a){(!a||!this.shared)&&this.model.removeEventListener("Changing",this._listener.onChanging);this.view&&(this.view.removeEventListener("Destroy",this._listener.onDestroy),this.view=null)},_onChanging:function(a){if(!this._ignoreUndo){var k=a.text,f=a.start,e=a.addedCharCount,d=a.removedCharCount,a=f+d,h=0;0===e&&1===d?h=-1:1===e&&0===d&&(h=1);e=this.stack.length;d=this.model.getText(f,a);(!(0<e&&this.index===e)||!this.stack[e-1].merge(f,k,d,h,a))&&this.add(new g(this.model,f,k,
d,h))}}};return{UndoStack:p}});
define("orion/editor/rulers",["i18n!orion/editor/nls/messages","orion/editor/annotations","orion/editor/tooltip","orion/util"],function(g,n,p,a){function k(a,b,d,e){this._location=b||"left";this._overview=d||"page";this._rulerStyle=e;this._view=null;var f=this;this._listener={onTextModelChanged:function(b){f._onTextModelChanged(b)},onAnnotationModelChanged:function(b){f._onAnnotationModelChanged(b)}};this.setAnnotationModel(a)}function f(a,b,d,e,f){k.call(this,a,b,"page",d);this._oddStyle=e||{style:{backgroundColor:"white"}};
this._evenStyle=f||{style:{backgroundColor:"white"}};this._numOfDigits=0;this._firstLine=1}function e(a,b,d){k.call(this,a,b,"page",d)}function d(a,b,d){k.call(this,a,b,"document",d)}function h(a,b,d){e.call(this,a,b,d)}k.prototype={getAnnotations:function(a,b){var d=this._annotationModel;if(!d)return[];var e=this._view.getModel(),f=e.getLineStart(a),g=e.getLineEnd(b-1),h=e;e.getBaseModel&&(h=e.getBaseModel(),f=e.mapOffset(f),g=e.mapOffset(g));for(var k=[],d=this.getAnnotationsByType(d,f,g),f=0;f<
d.length;f++)for(var g=d[f],n=h.getLineAtOffset(g.start),p=h.getLineAtOffset(Math.max(g.start,g.end-1)),u=n;u<=p;u++){var z=u;if(e!==h){z=h.getLineStart(u);z=e.mapOffset(z,!0);if(-1===z)continue;z=e.getLineAtOffset(z)}if(a<=z&&z<b){var q=this._mergeAnnotation(k[z],g,u-n,p-n+1);q&&(k[z]=q)}}if(!this._multiAnnotation&&this._multiAnnotationOverlay)for(var v in k)k[v]._multiple&&(k[v].html+=this._multiAnnotationOverlay.html);return k},getAnnotationModel:function(){return this._annotationModel},getLocation:function(){return this._location},
...
a},setView:function(a){this._onTextModelChanged&&this._view&&this._view.removeEventListener("ModelChanged",this._listener.onTextModelChanged);this._view=a;this._onTextModelChanged&&this._view&&this._view.addEventListener("ModelChanged",this._listener.onTextModelChanged)},onClick:function(a){if(void 0!==a){var b=this._view,d=b.getModel(),e=d,f=d.getLineStart(a),g=f,h=f,k=this._annotationModel;if(k){b=b.getSelection();h=d.getLineEnd(a,!0);f<=b.start&&b.start<h&&(f=b.start);d.getBaseModel&&(f=d.mapOffset(f),
h=d.mapOffset(h),e=d.getBaseModel());for(var n,h=k.getAnnotations(f,h),k=null;!n&&h.hasNext();)b=h.next(),this.isAnnotationTypeVisible(b.type)&&(k=b,b.start<=f||(n=b));k&&void 0!==k.groupId&&(this._currentClickGroup=this._currentClickGroup===k.groupId?null:k.groupId,this._setCurrentGroup(a));n&&e.getLineAtOffset(n.start)===e.getLineAtOffset(f)?(f=n.start,h=n.end):h=f=g;d.getBaseModel&&(f=d.mapOffset(f,!0),h=d.mapOffset(h,!0))}(a=p.Tooltip.getTooltip(this._view))&&a.setTarget(null);this._view.setSelection(h,
...
a&&a.setTarget(null)},_getTooltipInfo:function(a,b){if(void 0!==a){var d=this._view,e=d.getModel(),f=this._annotationModel,g=[];if(f){var g=e.getLineStart(a),h=e.getLineEnd(a);e.getBaseModel&&(g=e.mapOffset(g),h=e.mapOffset(h));g=this.getAnnotationsByType(f,g,h)}f=this._getTooltipContents(a,g);if(!f)return null;f={contents:f,anchor:this.getLocation()};g=d.getClientArea();g.y="document"===this.getOverview()?d.convert({y:b},"view","document").y:d.getLocationAtOffset(e.getLineStart(a)).y;d.convert(g,
"document","page");f.x=g.x;f.y=g.y;"right"===f.anchor&&(f.x+=g.width);return f}},_getTooltipContents:function(a,b){return b},_onAnnotationModelChanged:function(a){function b(b){for(var a=0;a<b.length;a++)if(f.isAnnotationTypeVisible(b[a].type)){var c=b[a].start,g=b[a].end;e.getBaseModel&&(c=e.mapOffset(c,!0),g=e.mapOffset(g,!0));-1!==c&&-1!==g&&d.redrawLines(e.getLineAtOffset(c),e.getLineAtOffset(Math.max(c,g-1))+1,f)}}var d=this._view;if(d){var e=d.getModel(),f=this,g=e.getLineCount();a.textModelChangedEvent?
(a=a.textModelChangedEvent.start,e.getBaseModel&&(a=e.mapOffset(a,!0)),a=e.getLineAtOffset(a),d.redrawLines(a,g,f)):(b(a.added),b(a.removed),b(a.changed))}},_mergeAnnotation:function(a,b,d){a||(a={});0===d&&(a.html&&b.html?(b.html!==a.html&&(!a._multiple&&this._multiAnnotation)&&(a.html=this._multiAnnotation.html),a._multiple=!0):a.html=b.html);a.style=this._mergeStyle(a.style,b.style);return a},_mergeStyle:function(a,b){if(b){a||(a={});a.styleClass=a.styleClass&&b.styleClass&&a.styleClass!==b.styleClass?
a.styleClass+(" "+b.styleClass):b.styleClass;var d;if(b.style)for(d in a.style||(a.style={}),b.style)void 0===a.style[d]&&(a.style[d]=b.style[d]);if(b.attributes)for(d in a.attributes||(a.attributes={}),b.attributes)void 0===a.attributes[d]&&(a.attributes[d]=b.attributes[d])}return a},_setCurrentGroup:function(a){var b=this._annotationModel,d=null,e=b.getTextModel(),f,g=this._currentGroupAnnotation;if(-1!==a){var h=e.getLineStart(a),k=e.getLineEnd(a);e.getBaseModel&&(h=e.mapOffset(h),k=e.mapOffset(k));
for(f=b.getAnnotations(h,k);f.hasNext();)if(e=f.next(),this.isAnnotationTypeVisible(e.type)&&e.start<=h&&e.end>=k&&void 0!==e.groupId){d=e;break}if(g&&d&&g.groupId===d.groupId)return}this._currentGroupAnnotation=null;g&&b.removeAnnotations(g.groupType);if(d&&-1!==a){this._currentGroupAnnotation=d;f=b.getAnnotations();for(a=[];f.hasNext();)e=f.next(),delete e.groupAnnotation,e.groupId===d.groupId&&(e=e.createGroupAnnotation(),a.push(e));b.replaceAnnotations(null,a)}}};n.AnnotationTypeList.addMixin(k.prototype);
f.prototype=new k;f.prototype.getAnnotations=function(a,b){for(var d=k.prototype.getAnnotations.call(this,a,b),e=this._view.getModel(),f=a;f<b;f++){var g=f&1?this._oddStyle:this._evenStyle,h=f;e.getBaseModel&&(h=e.getLineStart(h),h=e.getBaseModel().getLineAtOffset(e.mapOffset(h)));d[f]||(d[f]={});d[f].html=this._firstLine+h+"";d[f].style||(d[f].style=g)}return d};f.prototype.getWidestAnnotation=function(){var a=this._view.getModel().getLineCount();return this.getAnnotations(a-1,a)[a-1]};f.prototype.setFirstLine=
function(a){this._firstLine=void 0!==a?a:1};f.prototype._onTextModelChanged=function(a){var b=a.start,a=this._view.getModel(),d=a.getBaseModel?a.getBaseModel().getLineCount():a.getLineCount(),d=(this._firstLine+d-1+"").length;this._numOfDigits!==d&&(this._numOfDigits=d,b=a.getLineAtOffset(b),this._view.redrawLines(b,a.getLineCount(),this))};e.prototype=new k;d.prototype=new k;d.prototype.getRulerStyle=function(){var a={style:{lineHeight:"1px",fontSize:"1px"}};return a=this._mergeStyle(a,this._rulerStyle)};
d.prototype._getTooltipContents=function(c,b){if(0===b.length){var d=this._view.getModel(),e=c;d.getBaseModel&&(e=d.getLineStart(e),e=d.getBaseModel().getLineAtOffset(d.mapOffset(e)));return a.formatMessage(g.line,e+1)}return k.prototype._getTooltipContents.call(this,c,b)};d.prototype._mergeAnnotation=function(a,b,d,e){if(0===d)return a||(a={html:"&nbsp;",style:{style:{height:3*e+"px"}}},a.style=this._mergeStyle(a.style,b.overviewStyle)),a};h.prototype=new e;h.prototype.onClick=function(a){if(void 0!==
...
null:e.prototype._getTooltipContents.call(this,a,b)};h.prototype._onAnnotationModelChanged=function(a){function b(b){for(h=0;h<b.length;h++)if(g.isAnnotationTypeVisible(b[h].type)){var a=b[h].start;f.getBaseModel&&(a=f.mapOffset(a,!0));-1!==a&&(n=Math.min(n,f.getLineAtOffset(a)))}}if(a.textModelChangedEvent)e.prototype._onAnnotationModelChanged.call(this,a);else{var d=this._view;if(d){var f=d.getModel(),g=this,h,k=f.getLineCount(),n=k;b(a.added);b(a.removed);b(a.changed);a=d.getRulers();for(h=0;h<
a.length;h++)d.redrawLines(n,k,a[h])}}};return{Ruler:k,AnnotationRuler:e,LineNumberRuler:f,OverviewRuler:d,FoldingRuler:h}});
define("orion/editor/textDND",["orion/util"],function(g){function n(g,a){this._view=g;this._undoStack=a;this._dragSelection=null;this._dropOffset=-1;this._dropText=null;var k=this;this._listener={onDragStart:function(a){k._onDragStart(a)},onDragEnd:function(a){k._onDragEnd(a)},onDragEnter:function(a){k._onDragEnter(a)},onDragOver:function(a){k._onDragOver(a)},onDrop:function(a){k._onDrop(a)},onDestroy:function(a){k._onDestroy(a)}};g.addEventListener("DragStart",this._listener.onDragStart);g.addEventListener("DragEnd",
...
this._listener.onDragOver),g.removeEventListener("Drop",this._listener.onDrop),g.removeEventListener("Destroy",this._listener.onDestroy),this._view=null)},_onDestroy:function(){this.destroy()},_onDragStart:function(g){var a=this._view,k=a.getSelection(),a=a.getModel();a.getBaseModel&&(k.start=a.mapOffset(k.start),k.end=a.mapOffset(k.end),a=a.getBaseModel());if(a=a.getText(k.start,k.end))this._dragSelection=k,g.event.dataTransfer.effectAllowed="copyMove",g.event.dataTransfer.setData("Text",a)},_onDragEnd:function(n){if(this._dragSelection){var a=
this._view,k=n.event.dataTransfer.dropEffect;if(!g.isFirefox&&("none"!==k||this._dropText))k=n.event.dataTransfer.dropEffect=this._dropEffect;this._undoStack&&this._undoStack.startCompoundChange();(n="move"===k)&&a.setText("",this._dragSelection.start,this._dragSelection.end);if(this._dropText){var k=this._dropText,f=this._dropOffset;n&&(f>=this._dragSelection.end?f-=this._dragSelection.end-this._dragSelection.start:f>=this._dragSelection.start&&(f=this._dragSelection.start));a.setText(k,f,f);a.setSelection(f,
f+k.length);this._dropText=null;this._dropOffset=-1}this._undoStack&&this._undoStack.endCompoundChange()}this._dragSelection=null},_onDragEnter:function(g){this._onDragOver(g)},_onDragOver:function(n){var a=n.event.dataTransfer.types,k=!this._view.getOptions("readonly");k&&a&&(k=a.contains?a.contains("text/plain")||a.contains("Text"):-1!==a.indexOf("text/plain")||-1!==a.indexOf("Text"));k?g.isFirefox||(this._dropEffect=n.event.dataTransfer.dropEffect=(g.isMac?n.event.altKey:n.event.ctrlKey)?"copy":
"move"):n.event.dataTransfer.dropEffect="none"},_onDrop:function(n){var a=this._view,k=n.event.dataTransfer.getData("Text");k&&(g.isFirefox||(n.event.dataTransfer.dropEffect=this._dropEffect),n=a.getOffsetAtLocation(n.x,n.y),this._dragSelection?(this._dropOffset=n,this._dropText=k):(a.setText(k,n,n),a.setSelection(n,n+k.length)))}};return{TextDND:n}});
define("orion/editor/templates",[],function(){function g(g,a,k,f){this.prefix=g;this.description=a;this.template=k;this.name=f;this._parse()}function n(g,a){this._keywords=g||[];this._templates=[];this.addTemplates(a||[])}g.prototype={getProposal:function(g,a,k){var g=a-g.length,a={},f,e=void 0!==k.delimiter?k.delimiter:"\n";k.indentation&&(e+=k.indentation);for(var d=void 0!==k.tab?k.tab:"\t",h=0,c=this.variables,b=this.segments,k=[],l=0;l<b.length;l++){var m=b[l],n=c[m];if(void 0!==n)switch(m){case "${tab}":m=
d;break;case "${delimiter}":m=e;break;case "${cursor}":m="";f=h;break;default:var s=a[m];s||(s=a[m]={data:n.data,positions:[]});m=n.substitution;s.data&&s.data.values&&(m=s.data.values[0]);s.positions.push({offset:g+h,length:m.length})}k.push(m);h+=m.length}var e=[],x;for(x in a)a.hasOwnProperty(x)&&e.push(a[x]);k=k.join("");void 0===f&&(f=k.length);return{proposal:k,name:this.name,description:this.description,groups:e,escapePosition:g+f,style:"noemphasis"}},match:function(g){return 0===this.prefix.indexOf(g)},
_parse:function(){var g=this.template,a=[],k={},f,e=0,g=g.replace(/\n/g,"${delimiter}"),g=g.replace(/\t/g,"${tab}");g.replace(/\$\{((?:[^\\}]+|\\.))*\}/g,function(d,h,c){var b=d.substring(2,d.length-1),h=d,l=b,m=null,n=l.indexOf(":");-1!==n&&(l=l.substring(0,n),h="${"+l+"}",m=JSON.parse(b.substring(n+1).replace("\\}","}").trim()));(b=k[h])||(b=k[h]={});b.substitution=l;m&&(b.data=m);(f=g.substring(e,c))&&a.push(f);a.push(h);e=c+d.length;return l});(f=g.substring(e,g.length))&&a.push(f);this.segments=
a;this.variables=k}};n.prototype={addTemplates:function(n){for(var a=this.getTemplates(),k=0;k<n.length;k++)a.push(new g(n[k].prefix,n[k].description,n[k].template,n[k].name))},computeProposals:function(g,a,k){var f=this.getPrefix(g,a,k),e=[];this.isValid(f,g,a,k)&&(e=e.concat(this.getTemplateProposals(f,a,k)),e=e.concat(this.getKeywordProposals(f)));return e},getKeywords:function(){return this._keywords},getKeywordProposals:function(g){var a=[],k=this.getKeywords();if(k){for(var f=0;f<k.length;f++)0===
k[f].indexOf(g)&&a.push({proposal:k[f].substring(g.length),description:k[f],style:"noemphasis_keyword"});0<a.length&&a.splice(0,0,{proposal:"",description:"Keywords",style:"noemphasis_title_keywords",unselectable:!0})}return a},getPrefix:function(g,a,k){return k.prefix},getTemplates:function(){return this._templates},getTemplateProposals:function(g,a,k){for(var f=[],e=this.getTemplates(),d=0;d<e.length;d++){var h=e[d];h.match(g)&&(h=h.getProposal(g,a,k),this.removePrefix(g,h),f.push(h))}0<f.length&&
(f.sort(function(a,b){return a.name<b.name?-1:a.name>b.name?1:0}),f.splice(0,0,{proposal:"",description:"Templates",style:"noemphasis_title",unselectable:!0}));return f},removePrefix:function(g,a){if(!(a.overwrite=a.proposal.substring(0,g.length)!==g))a.proposal=a.proposal.substring(g.length)},isValid:function(){return!0}};return{Template:g,TemplateContentAssist:n}});
define("orion/editor/linkedMode","i18n!orion/editor/nls/messages orion/keyBinding orion/editor/keyModes orion/editor/annotations orion/editor/templates orion/objects orion/util".split(" "),function(g,n,p,a,k,f){function e(a,c,b){var d=a.getTextView();p.KeyMode.call(this,d);this.editor=a;this.undoStack=c;this.contentAssist=b;this.linkedModeModel=null;d.setAction("linkedModeEnter",function(){this.exitLinkedMode(!0);return!0}.bind(this));d.setAction("linkedModeCancel",function(){this.exitLinkedMode(!1);
return!0}.bind(this));d.setAction("linkedModeNextGroup",function(){var b=this.linkedModeModel;this.selectLinkedGroup((b.selectedGroupIndex+1)%b.groups.length);return!0}.bind(this));d.setAction("linkedModePreviousGroup",function(){var b=this.linkedModeModel;this.selectLinkedGroup(0<b.selectedGroupIndex?b.selectedGroupIndex-1:b.groups.length-1);return!0}.bind(this));this.linkedModeListener={onActivating:function(){this._groupContentAssistProvider&&(this.contentAssist.setProviders([this._groupContentAssistProvider]),
this.contentAssist.setProgress(null))}.bind(this),onModelChanged:function(b){if(!this.ignoreVerify){for(var a=this.editor.mapOffset(b.start),c=this.linkedModeModel,d,e;c;)if(d=this._getPositionChanged(c,a,a+b.removedCharCount),e=d.position,void 0===e||e.model!==c)this.exitLinkedMode(!1),c=this.linkedModeModel;else break;if(c){c=0;b=b.addedCharCount-b.removedCharCount;d=d.positions;for(var f,g=0;g<d.length;++g){f=d[g];e=f.position;var h=e.offset<=a&&a<=e.offset+e.length;h&&!f.ansestor?(e.offset+=c,
e.length+=b,c+=b):(e.offset+=c,f.ansestor&&h&&(e.length+=b));f.escape&&(f.model.escapePosition=e.offset)}this._updateAnnotations(d)}}}.bind(this),onVerify:function(b){if(!this.ignoreVerify){for(var a=this.editor,c=a.mapOffset(b.start),d=this.editor.mapOffset(b.end),e=this.linkedModeModel,f,g;e;)if(f=this._getPositionChanged(e,c,d),g=f.position,void 0===g||g.model!==e)this.exitLinkedMode(!1),e=this.linkedModeModel;else break;if(e){var h=this._compoundChange;h?h.owner.model===e&&h.owner.group===g.group||
(this.endUndo(),this.startUndo()):this.startUndo();e.selectedGroupIndex=g.group;var h=0,l=b.text.length-(d-c);f=f.positions;for(var k,c=c-g.position.offset,n=d-g.position.offset,p=0;p<f.length;++p)k=f[p],d=k.position,k.oldOffset=d.offset,k.model===e&&k.group===g.group?(d.offset+=h,d.length+=l,h+=l):(d.offset+=h,k.ansestor&&(d.length+=g.count*l)),k.escape&&(k.model.escapePosition=d.offset);this.ignoreVerify=!0;for(p=f.length-1;0<=p;p--)k=f[p],k.model===e&&k.group===g.group&&a.setText(b.text,k.oldOffset+
c,k.oldOffset+n);this.ignoreVerify=!1;b.text=null;this._updateAnnotations(f)}}}.bind(this)}}var d={};e.prototype=new p.KeyMode;f.mixin(e.prototype,{createKeyBindings:function(){var a=n.KeyBinding,c=[];c.push({actionID:"linkedModeEnter",keyBinding:new a(13)});c.push({actionID:"linkedModeCancel",keyBinding:new a(27)});c.push({actionID:"linkedModeNextGroup",keyBinding:new a(9)});c.push({actionID:"linkedModePreviousGroup",keyBinding:new a(9,!1,!0)});return c},enterLinkedMode:function(a){if(!this.linkedModeModel){var c=
...
a;this.selectLinkedGroup(0)},exitLinkedMode:function(a){if(this.isActive()){this._compoundChange&&(this.endUndo(),this._compoundChange=null);this._sortedPositions=null;var c=this.linkedModeModel;this.linkedModeModel=c.previousModel;c.parentGroup=c.previousModel=void 0;this.linkedModeModel&&(this.linkedModeModel.nextModel=void 0);if(!this.linkedModeModel){var b=this.editor,d=b.getTextView();d.removeKeyMode(this);d.removeEventListener("Verify",this.linkedModeListener.onVerify);d.removeEventListener("ModelChanged",
this.linkedModeListener.onModelChanged);d=this.contentAssist;d.removeEventListener("Activating",this.linkedModeListener.onActivating);d.offset=void 0;this.editor.reportStatus(g.linkedModeExited,null,!0);a&&b.setCaretOffset(c.escapePosition,!1)}this.selectLinkedGroup(0)}},startUndo:function(){if(this.undoStack){var a=this,c=this.linkedModeModel;this._compoundChange=this.undoStack.startCompoundChange({model:c,group:c.selectedGroupIndex,end:function(){a._compoundChange=null}})}},endUndo:function(){this.undoStack&&
this.undoStack.endCompoundChange()},isActive:function(){return!!this.linkedModeModel},isStatusActive:function(){return!!this.linkedModeModel},selectLinkedGroup:function(a){var c=this.linkedModeModel;if(c){c.selectedGroupIndex=a;var a=c.groups[a],b=a.positions[0],d=this.editor;d.setSelection(b.offset,b.offset+b.length);if(c=this.contentAssist)c.offset=void 0,a.data&&"link"===a.data.type&&a.data.values?((this._groupContentAssistProvider=new k.TemplateContentAssist(a.data.values)).getPrefix=function(){var a=
d.getSelection();return a.start===a.end&&(a=d.getCaretOffset(),b.offset<=a&&a<=b.offset+b.length)?d.getText(b.offset,a):""},c.offset=b.offset,c.deactivate(),c.activate()):this._groupContentAssistProvider&&(this._groupContentAssistProvider=null,c.deactivate())}this._updateAnnotations()},_getModelPositions:function(a,c,b){for(var d=c.groups,e=0;e<d.length;e++)for(var f=d[e].positions,g=0;g<f.length;g++){var k=f[g];b&&(k={offset:k.offset+b,length:k.length});k={index:g,group:e,count:f.length,model:c,
position:k};a.push(k);c.nextModel&&c.nextModel.parentGroup===e&&(k.ansestor=!0,this._getModelPositions(a,c.nextModel,(b||0)+f[g].offset-f[0].offset))}},_getSortedPositions:function(a){var c=this._sortedPositions;if(!c){for(c=[];a.previousModel;)a=a.previousModel;for(this._getModelPositions(c,a);a;)void 0!==a.escapePosition&&c.push({escape:!0,model:a,position:{offset:a.escapePosition,length:0}}),a=a.nextModel;c.sort(function(b,a){return b.position.offset-a.position.offset});this._sortedPositions=c}return c},
_getPositionChanged:function(a,c,b){for(var d,a=this._getSortedPositions(a),e=a.length-1;0<=e;e--){var f=a[e].position;if(f.offset<=c&&b<=f.offset+f.length){d=a[e];break}}return{position:d,positions:a}},_updateAnnotations:function(d){var c=this.editor.getAnnotationModel();if(c){var b=[],e=[];c.getTextModel();for(var f=c.getAnnotations(),g;f.hasNext();)switch(g=f.next(),g.type){case a.AnnotationType.ANNOTATION_LINKED_GROUP:case a.AnnotationType.ANNOTATION_CURRENT_LINKED_GROUP:case a.AnnotationType.ANNOTATION_SELECTED_LINKED_GROUP:b.push(g)}if(f=
this.linkedModeModel)for(var d=d||this._getSortedPositions(f),k=0;k<d.length;k++)if(g=d[k],g.model===f){var n=a.AnnotationType.ANNOTATION_LINKED_GROUP;g.group===f.selectedGroupIndex&&(n=0===g.index?a.AnnotationType.ANNOTATION_SELECTED_LINKED_GROUP:a.AnnotationType.ANNOTATION_CURRENT_LINKED_GROUP);g=g.position;g=a.AnnotationType.createAnnotation(n,g.offset,g.offset+g.length,"");e.push(g)}c.replaceAnnotations(b,e)}}});d.LinkedMode=e;return d});
define("orion/editor/factories","orion/editor/actions orion/editor/undoStack orion/editor/rulers orion/editor/annotations orion/editor/textDND orion/editor/linkedMode".split(" "),function(g,n,p,a,k,f){function e(){}function d(){}function h(){}function c(){}function b(){}function l(){}var m={};e.prototype={createKeyBindings:function(b,a,c,d){var d=new g.TextActions(b,a,d),e=new f.LinkedMode(b,a,c),b=new g.SourceCodeActions(b,a,c,e);return{textActions:d,linkedMode:e,sourceCodeActions:b}}};m.KeyBindingsFactory=
...
createAnnotationStyler:function(b,c){return new a.AnnotationStyler(b,c)},createAnnotationRulers:function(b){var a=new p.AnnotationRuler(b,"left",{styleClass:"ruler annotations"}),b=new p.OverviewRuler(b,"right",{styleClass:"ruler overview"});return{annotationRuler:a,overviewRuler:b}}};m.AnnotationFactory=b;l.prototype={createTextDND:function(b,a){return new k.TextDND(b.getTextView(),a)}};m.TextDNDFactory=l;return m});
...
keyBindingsLocalVisible:!0};g.prototype={_initialize:function(a){var a=a.get("editorSettings")||{},g;for(g in p)a.hasOwnProperty(g)||(a[g]=p[g]);return a},getPrefs:function(a){this._preferences.getPreferences(n).then(function(g){g=this._initialize(g);"string"===typeof g&&(g=JSON.parse(g));a(g)}.bind(this))},setPrefs:function(a,g){this._preferences.getPreferences(n).then(function(f){f.put("editorSettings",a);a=this._initialize(f);g&&g(a);this._callback&&this._callback(a)}.bind(this))}};return{EditorPreferences:g}});
define("orion/widgets/themes/ThemePreferences",[],function(){function g(g,p){this._preferences=g;this._themeData=p;var a=p.getThemeStorageInfo(),k=g.listenForChangedSettings(a.storage,2,function(a){a.key===k&&this.apply()}.bind(this))}g.prototype={_initialize:function(g,p,a){var k=a.get(g.styleset);k||(k=p.getStyles(),a.put(g.styleset,JSON.stringify(k)));(p=a.get("selected"))&&(p=JSON.parse(p));if(!p||void 0===p[g.selectedKey])p=p||{},p[g.selectedKey]=g.defaultTheme,a.put("selected",JSON.stringify(p))},
apply:function(){this.setTheme()},getTheme:function(g){var p=this._themeData,a=p.getThemeStorageInfo();this._preferences.getPreferences(a.storage,2).then(function(k){this._initialize(a,p,k);var f=JSON.parse(k.get("selected")),k=JSON.parse(k.get(a.styleset)),e;if(k)for(var d=0;d<k.length;d++)if(k[d].name===f[a.selectedKey]){e=k[d];break}g({style:e,styles:k})}.bind(this))},setTheme:function(g,p){var a=this._themeData,k=a.getThemeStorageInfo();this._preferences.getPreferences(k.storage,2).then(function(f){this._initialize(k,
a,f);var e=JSON.parse(f.get("selected"));g||(g=e[k.selectedKey]);e[k.selectedKey]=g;f.put("selected",JSON.stringify(e));p?f.put(k.styleset,JSON.stringify(p)):p=JSON.parse(f.get(k.styleset));for(f=0;f<p.length;f++)if(p[f].name===e[k.selectedKey]){a.processSettings(p[f]);break}}.bind(this))},setFontSize:function(g){var p=this._themeData,a=p.getThemeStorageInfo();this._preferences.getPreferences(a.storage,2).then(function(k){this._initialize(a,p,k);var f=JSON.parse(k.get("selected")),e=JSON.parse(k.get(a.styleset)),
d;if(e)for(var h=0;h<e.length;h++)e[h].fontSize=g,e[h].name===f[a.selectedKey]&&(d=e[h]);k.put(a.styleset,JSON.stringify(e));p.processSettings(d)}.bind(this))}};return{ThemePreferences:g}});
...
a.lineNumber="#E73E36";a.currentLine="#F5B1AE";a.tag="#E73E36";a.attribute="cadetBlue";a.fontFamily=f;a.fontSize=e;this.styles.push(a)}function k(){return this.styles}var f='"Consolas", "Monaco", "Vera Mono", "monospace"',e="10pt";a.prototype.styles=[];a.prototype.getStyles=k;a.prototype.fontSettable=!0;a.prototype.getThemeStorageInfo=function(){return{storage:"/themes",styleset:"editorstyles",defaultTheme:"Prospecto",selectedKey:"editorSelected"}};a.prototype.parseToXML=function(a){try{var e=null;
...
family:"keyword",font:"9pt sans-serif"},{type:"RECTANGLE",name:g["Annotation Ruler"],x:e,y:c,width:46,height:a.height,family:"annotationRuler",fill:"white"}];for(var b=0;16>b;b++)a.shapes.push({type:"TEXT",name:g["Line Numbers"],label:b+1,x:e+20,y:c+20*b+20,fill:"darkSlateGray",family:"lineNumber",font:"9pt sans-serif"});return a};return{ThemeData:a,getStyles:k}});
define("orion/widgets/browse/readonlyEditorView","orion/editor/editor orion/editor/textView orion/editor/textModel orion/editor/projectionTextModel orion/editor/editorFeatures orion/editorPreferences orion/widgets/themes/ThemePreferences orion/widgets/themes/editor/ThemeData orion/objects".split(" "),function(g,n,p,a,k,f,e,d,h){function c(a){this._parent=a.parent;this.renderToolbars=a.renderToolbars;this.inputManager=a.inputManager;this.preferences=a.preferences;this.statusReporter=a.statusReporter;
...
define("orion/widgets/browse/resourceSelector",["orion/objects","orion/webui/littlelib","orion/commands","orion/URITemplate","orion/URL-shim"],function(g,n,p,a){function k(a){this.resourceChangeListener=a.resourceChangeListener;this.resourceChangeDispatcher=a.resourceChangeDispatcher;this.fetchChildren=a.fetchChildren;this.fileClient=a.fileClient;this.commandRegistry=a.commandRegistry;this.commandScopeId=a.commandScopeId;this.dropDownId=a.dropDownId;this.dropDownTooltip=a.dropDownTooltip;this.allItems=
a.allItems;this.activeResourceName=a.activeResourceName;this.labelHeader=a.labelHeader;this.parentNode=a.parentNode;this.listener=function(a){this.refresh(a.root)}.bind(this);this.resourceChangeListener&&this.resourceChangeListener.addEventListener("resourceChanged",this.listener);this.render()}var f=new a("#{,resource,params*}");g.mixin(k.prototype,{destroy:function(){this.resourceChangeListener&&this.resourceChangeListener.removeEventListener("resourceChanged",this.listener);this.commandRegistry.destroy(this.parentNode);
n.empty(this.parentNode);this.resourceChangeListener=this.resourceChangeDispatcher=this.listener=this.parentNode=null},registerCommands:function(){if(!this.commandsRegistered){this.commandsRegistered=!0;var a=this.commandRegistry,d=new p.Command({imageClass:"core-sprite-openarrow",selectionClass:"dropdownSelection",id:this.dropDownId,visibleWhen:function(){return!0},choiceCallback:this._switchBrMenuCallback.bind(this),positioningNode:this.parentNode});a.addCommand(d);a.registerCommandContribution(this.commandScopeId,
this.dropDownId,1)}},_switchBrMenuCallback:function(){var a=this;return this.allItems.map(function(d){return{name:d.Name,callback:a.setActiveResource.bind(a,{resource:d,changeHash:!0})}})},render:function(){this.resourceName=document.createElement("div");this.resourceName.classList.add("browserResourceSelectorName");this.resourceName.classList.add("layoutLeft");this.menu=document.createElement("ul");this.menu.classList.add("commandList");this.menu.classList.add("layoutRight");this.menu.classList.add("pageActions");
this.parentNode.appendChild(this.resourceName);this.parentNode.appendChild(this.menu);this.registerCommands();this.parentNode.addEventListener("click",this._openMenu.bind(this))},_openMenu:function(){var a=n.$(".dropdownTrigger",this.menu);if(a){var d=document.createEvent("MouseEvents");d.initEvent("click",!0,!0);a.dispatchEvent(d)}},_resourceLabel:function(){var a=document.createDocumentFragment();a.textContent=this.labelHeader+": ${0}";var d=document.createElement("b");d.textContent=this.activeResourceName;
d.classList.add("browserResourceSelectorNameBold");n.processDOMNodes(a,[d]);return a},refresh:function(){n.empty(this.resourceName);this.resourceName.appendChild(this._resourceLabel());this.commandRegistry.destroy(this.menu);this.commandRegistry.renderCommands(this.commandScopeId,this.menu,{},"menu")},setActiveResource:function(a){this.activeResourceName=a.resource.Name;this.fetchChildren?a.resource.selectorAllItems?this.resourceChangeDispatcher&&this.resourceChangeDispatcher.dispatchEvent({type:"resourceChanged",
newResource:a.resource,defaultChild:a.defaultChild,changeHash:a.changeHash}):this.fileClient.fetchChildren(a.resource.Location).then(function(d){d&&0<d.length&&(a.resource.selectorAllItems=d,this.resourceChangeDispatcher&&this.resourceChangeDispatcher.dispatchEvent({type:"resourceChanged",newResource:a.resource,defaultChild:a.defaultChild,changeHash:a.changeHash}))}.bind(this),function(a){console.log(a)}.bind(this)):window.location=f.expand({resource:a.resource.Location})},getActiveResource:function(a){var d=
this.allItems[0];this.allItems.some(function(f){if(f.Location===a)return d=f,!0});return d}});return{ResourceSelector:k}});
define("orion/fileClient",["i18n!orion/navigate/nls/messages","orion/Deferred","orion/i18nUtil"],function(g,n,p){function a(a,d,f){if(!a[d])throw d+g[" is not supported in this file system"];return a[d].apply(a,f)}function k(e,d,f,c){if(!e.readBlob)throw g["source file service does not support binary read"];if(!f.writeBlob)throw g["target file service does not support binary write"];if("/"!==d[d.length-1])return a(e,"readBlob",[d]).then(function(b){return a(f,"writeBlob",[c,b])});var b=c.substring(0,
c.length-1),l=decodeURIComponent(b.substring(b.lastIndexOf("/")+1)),b=b.substring(0,b.lastIndexOf("/")+1);return a(f,"createFolder",[b,l]).then(function(){},function(){}).then(function(){return a(e,"fetchChildren",[d]).then(function(a){for(var b=[],d=0;d<a.length;++d){var g=a[d].Location,l=g;a[d].Directory&&(l=g.substring(0,g.length-1));l=decodeURIComponent(l.substring(l.lastIndexOf("/")+1));l=c+encodeURIComponent(l);a[d].Directory&&(l+="/");b[d]=k(e,g,f,l)}return n.all(b)})})}function f(a,d){function f(a){var b=
new n;b.reject(g["No Matching FileService for location:"]+a);return b}var c=a.getServiceReferences("orion.core.file"),b=c;if(d)for(var b=[],l=0;l<c.length;++l)d(c[l])&&b.push(c[l]);for(var k=[],r=[],s=[],x=[],t={fetchChildren:function(){var a=new n;a.resolve(x);return a},createWorkspace:function(){var a=new n;a.reject(g["no file service"]);return a},loadWorkspaces:function(){var a=new n;a.reject(g["no file service"]);return a},loadWorkspace:function(){var a=new n;window.setTimeout(function(){a.resolve({Directory:!0,
Length:0,LocalTimeStamp:0,Name:g["File Servers"],Location:"/",Children:x,ChildrenLocation:"/"})},100);return a},search:f,createProject:f,createFolder:f,createFile:f,deleteFile:f,moveFile:f,copyFile:f,read:f,write:f},c=0;c<b.length;++c)x[c]={Directory:!0,Length:0,LocalTimeStamp:0,Location:b[c].getProperty("top"),ChildrenLocation:b[c].getProperty("top"),Name:b[c].getProperty("Name")},l=b[c].getProperty("pattern")||b[c].getProperty("top").replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1"),"^"!==l[0]&&(l=
"^"+l),k[c]=RegExp(l),r[c]=a.getService(b[c]),s[c]=b[c].getProperty("Name"),b[c].getProperty("NameKey")&&b[c].getProperty("nls")&&p.getMessageBundle(b[c].getProperty("nls")).then(function(a,c){x[a].Name=c[b[a].getProperty("NameKey")];s[a]=c[b[a].getProperty("NameKey")]}.bind(this,c));this._getServiceIndex=function(a){if("/"===a)return-1;if(!a||a.length&&0===a.length)return r[0]?0:-1;for(var b=0;b<k.length;++b)if(k[b].test(a))return b;throw g["No Matching FileService for location:"]+a;};this._getService=
function(a){a=this._getServiceIndex(a);return-1===a?t:r[a]};this._getServiceName=function(a){a=this._getServiceIndex(a);return-1===a?t.Name:s[a]};this._getServiceRootURL=function(a){a=this._getServiceIndex(a);return-1===a?t.Location:x[a].Location}}f.prototype={getService:function(a){return this._getService(a)},fileServiceName:function(a){return this._getServiceName(a)},fileServiceRootURL:function(a){return this._getServiceRootURL(a)},fetchChildren:function(e){return a(this._getService(e),"fetchChildren",
...
arguments)},deleteFile:function(e){return a(this._getService(e),"deleteFile",arguments)},moveFile:function(e,d,f){var c=this._getService(e),b=this._getService(d);if(c===b)return a(c,"moveFile",arguments);var g="/"===e[e.length-1],m=d;"/"!==m[m.length-1]&&(m+="/");if(f)m+=encodeURIComponent(f);else{var n=e;g&&(n=n.substring(0,n.length-1));m+=n.substring(n.lastIndexOf("/")+1)}g&&"/"!==m[m.length-1]&&(m+="/");return k(c,e,b,m).then(function(){return a(c,"deleteFile",[e])})},copyFile:function(e,d,f){var c=
this._getService(e),b=this._getService(d);if(c===b)return a(c,"copyFile",arguments);var g="/"===e[e.length-1],m=d;"/"!==m[m.length-1]&&(m+="/");if(f)m+=encodeURIComponent(f);else{var n=e;g&&(n=n.substring(0,n.length-1));m+=n.substring(n.lastIndexOf("/")+1)}g&&"/"!==m[m.length-1]&&(m+="/");return k(c,e,b,m)},read:function(e,d){return a(this._getService(e),"read",arguments)},readBlob:function(e){return a(this._getService(e),"readBlob",arguments)},write:function(e,d,f){return a(this._getService(e),"write",
...
c.length;b++)if(this.isExtensionOf(a,c[b]))return!0;return!1}};return{ContentTypeRegistry:k,getFilenameContentType:g}});
...
{};d&&(this._initPatterns(),this._subBlocks=w(d,d.getText(this.start,this.end),this,this.start))}function a(a){this._styler=a}function k(b,c,d,e){this.highlightCaretLine=this.whitespacesVisible=this.spacesVisible=this.tabsVisible=!1;this.detectTasks=this.foldingEnabled=!0;this.view=b;this.annotationModel=c;this.patternManager=new n(d,e);this._accessor=new a(this);this._bracketAnnotations=void 0;var f=this;this._listener={onChanged:function(a){f._onModelChanged(a)},onDestroy:function(a){f._onDestroy(a)},
onLineStyle:function(a){f._onLineStyle(a)},onMouseDown:function(a){f._onMouseDown(a)},onSelection:function(a){f._onSelection(a)}};d=b.getModel();d.getBaseModel&&(d=d.getBaseModel());d.addEventListener("Changed",this._listener.onChanged);b.addEventListener("MouseDown",this._listener.onMouseDown);b.addEventListener("Selection",this._listener.onSelection);b.addEventListener("Destroy",this._listener.onDestroy);b.addEventListener("LineStyle",this._listener.onLineStyle);e=d.getCharCount();this._rootBlock=
new p({start:0,contentStart:0,end:e,contentEnd:e},null,this,d);this._computeFolding(this._rootBlock.getBlocks());this.detectTasks&&(e=[],y(this._rootBlock,d,e),c.replaceAnnotations([],e));b.redrawLines()}var f={styleClass:"meta annotation currentLine"},e=/$/,d=/\\(\d)/g,h=/(.*)(?:[\r\n]|$)/g,c={regex:/ /g,style:{styleClass:"punctuation separator space",unmergeable:!0}},b={regex:/\t/g,style:{styleClass:"punctuation separator tab",unmergeable:!0}},l=function(a,b,c,d){var e=c,f=a.lastIndex;h.lastIndex=
c;var c=h.exec(b),g,l;a.lastIndex=0;if(c){for(l=c.index;0<=--l&&!(g=b.charAt(l),"\n"===g||"\r"===g););g=b.substring(l+1,c.index+c[1].length);a.lastIndex=l=c.index-l-1}for(;c&&c.index<b.length;){var k;if(d){var m=a.lastIndex;a.test(g)&&(a.lastIndex=m,k=a.exec(g))}else k=a.exec(g);if(k)return k.index+=e,k.index-=l,a.lastIndex=f,k;l=0;e+=c[0].length;if(c=h.exec(b))g=c[1],a.lastIndex=0}a.lastIndex=f;return null},m=function(a,b){var c=a.toString();d.lastIndex=0;if(!d.test(c))return a;d.lastIndex=0;for(var e=
...
-1:a.result.index>b.result.index?1:a.pattern.pattern.index<b.pattern.pattern.index?-1:1});for(var h=0;0<g.length;){var k=g[0];g.splice(0,1);if(!(k.result.index<h)){var n=k.result.index,p,t=[];if(k.pattern.regex){h=k.result;p=n+h[0].length;p={start:b+n,end:b+p,style:k.pattern.pattern.name};if(!f){k.pattern.pattern.captures&&s(h,k.pattern.pattern.captures,b+n,t);t.sort(function(a,b){return a.start<b.start?-1:a.start>b.start?1:0});for(n=0;n<t.length-1;n++)if(t[n+1].start<t[n].end){var w={start:t[n+1].end,
end:t[n].end,style:t[n].style};t[n].end=t[n+1].start;t.splice(n+2,0,w)}}x(p,t,d)}else h=k.pattern.regexEnd,h=m(h,k.result),h=l(h,a,k.result.index+k.result[0].length),h||(e.lastIndex=0,h=e.exec(a)),p=h.index+h[0].length,d.push({start:b+n,end:b+p,style:k.pattern.pattern.name});h=h.index+h[0].length}r(k,a,g,h)}c.forEach(function(a){a=a.regex||a.regexBegin;a.lastIndex=a.oldLastIndex})}},w=function(a,b,c,d){var f=[];c.getBlockPatterns().forEach(function(a){var c=l(a.regexBegin||a.regex,b,0);c&&f.push({result:c,
pattern:a})}.bind(this));if(!f.length)return f;f.sort(function(a,b){return a.result.index<b.result.index?-1:a.result.index>b.result.index?1:a.pattern.pattern.index<b.pattern.pattern.index?-1:1});for(var g=0,h=[];0<f.length;){var k=f[0];f.splice(0,1);if(!(k.result.index<g)){var n=a.getLineAtOffset(d+k.result.index),s=a.getLine(n),w=[];t(s,a.getLineStart(n),c,w);n=d+k.result.index;for(s=0;s<w.length;s++)if(w[s].start===n){var g=k.result.index,x=null,y=k.pattern.regexEnd;if(y)for(var g=g+k.result[0].length,
y=m(y,k.result),F=g;!x;){F=l(y,b,F);F||(e.lastIndex=0,F=e.exec(b));var O=[],Q=new p({start:n,end:d+F.index+F[0].length,contentStart:d+g,contentEnd:d+F.index},k.pattern,c.getStyler(),a,c);t(b.substring(g,F.index+F[0].length),g,Q,O);if(!O.length||O[O.length-1].end<=F.index)x=Q;F=F.index+F[0].length}else x=new p({start:n,end:n+k.result[0].length,contentStart:n,contentEnd:n+k.result[0].length},k.pattern,c.getStyler(),a,c);h.push(x);g=x.end-d;break}s===w.length&&(g=k.result.index+1)}r(k,b,f,g)}return h},
y=function(a,b,c){if(a.getAnnotationModel()){var d=g.AnnotationType.ANNOTATION_TASK;if(a.getLinePatterns().length&&a.pattern&&a.pattern.pattern.name&&0===a.pattern.pattern.name.indexOf("comment")){var e=[];t(b.getText(a.contentStart,a.end),a.contentStart,a,e,!0);for(var f=0;f<e.length;f++)"meta.annotation.task.todo"===e[f].style&&c.push(g.AnnotationType.createAnnotation(d,e[f].start,e[f].end,b.getText(e[f].start,e[f].end)))}a.getBlocks().forEach(function(a){y(a,b,c)}.bind(this))}};n.prototype={getPatterns:function(a){var b=
...
b=b.getLineAtOffset(d);return e===b?null:new (g.AnnotationType.getType(g.AnnotationType.ANNOTATION_FOLDING))(c,d,a)},_findBlock:function(a,b){var c=a.getBlocks();if(!c.length)return a;var d=this._binarySearch(c,b,!0);return d<c.length&&c[d].start<=b&&b<c[d].end?this._findBlock(c[d],b):a},_findBrackets:function(a,b,c,d,e,f){for(var g=[],h=[],l=e,k=c.getBlocks(),m=this._binarySearch(k,e,!0);m<k.length&&!(k[m].start>=f);m++){var n=k[m].start,p=k[m].end;l<n&&(t(d.substring(l-e,n-e),l,c,h),h.forEach(function(c){0===
c.style.indexOf(a.pattern.name)?g.push(c.start+1):0===c.style.indexOf(b.pattern.name)&&g.push(-(c.start+1))}),h=[]);l=p}l<f&&(t(d.substring(l-e,f-e),l,c,h),h.forEach(function(c){0===c.style.indexOf(a.pattern.name)?g.push(c.start+1):0===c.style.indexOf(b.pattern.name)&&g.push(-(c.start+1))}));return g},_findMatchingBracket:function(a,b,c){for(var d=a.getLineAtOffset(c),e=a.getLineEnd(d),f=a.getText(c,e),g,h=b.getEnclosurePatterns(),k=Object.keys(h),m=0;m<k.length;m++){var n=h[k[m]],p=l(n.regex,f,0);
if(p&&0===p.index){g=n;break}}if(!g)return-1;f=!1;-1!==g.pattern.name.indexOf(".begin")?(f=!0,m=g.pattern.name.replace(".begin",".end")):m=g.pattern.name.replace(".end",".begin");h=h[m];if(!h)return-1;k=a.getLine(d);n=a.getLineStart(d);e=this._findBrackets(g,h,b,k,n,e);for(m=0;m<e.length;m++)if(k=0<=e[m]?1:-1,e[m]*k-1===c){c=1;if(f){for(m++;m<e.length;m++)if(k=0<=e[m]?1:-1,c+=k,0===c)return e[m]*k-1;d+=1;for(m=a.getLineCount();d<m;){k=a.getLine(d);n=a.getLineStart(d);e=a.getLineEnd(d);e=this._findBrackets(g,
h,b,k,n,e);for(f=0;f<e.length;f++)if(k=0<=e[f]?1:-1,c+=k,0===c)return e[f]*k-1;d++}}else{for(m--;0<=m;m--)if(k=0<=e[m]?1:-1,c+=k,0===c)return e[m]*k-1;for(d-=1;0<=d;){k=a.getLine(d);n=a.getLineStart(d);e=a.getLineEnd(d);e=this._findBrackets(g,h,b,k,n,e);for(m=e.length-1;0<=m;m--)if(k=0<=e[m]?1:-1,c+=k,0===c)return e[m]*k-1;d--}}break}return-1},_getAnnotationModel:function(){return this.annotationModel},_getLineStyle:function(a){if(this.highlightCaretLine){var b=this.view,c=b.getModel(),b=b.getSelection();
if(b.start===b.end&&c.getLineAtOffset(b.start)===a)return f}return null},_getPatternManager:function(){return this.patternManager},_getStyles:function(a,b,c,d){b.getBaseModel&&(d=b.mapOffset(d));for(var e=d+c.length,f=[],g=d,h=a.getBlocks(),k=this._binarySearch(h,d,!0);k<h.length&&!(h[k].start>=e);k++){var m=h[k].start,n=h[k].end;g<m&&t(c.substring(g-d,m-d),g,a,f);var p=Math.max(g,m);if(p===m&&h[k].pattern.regexBegin){var r=l(h[k].pattern.regexBegin,c.substring(p-d),0);if(r){var w=h[k].pattern.pattern.beginCaptures||
h[k].pattern.pattern.captures;w?s(r,w,p,f):f.push({start:p,end:p+r[0].length,style:h[k].pattern.pattern.name});p+=r[0].length}}var m=Math.min(e,n),x=[];if(m===n&&h[k].pattern.regexEnd&&(g=c.substring(m-g-(h[k].end-h[k].contentEnd)),r=l(h[k].pattern.regexEnd,g,0)))(w=h[k].pattern.pattern.endCaptures||h[k].pattern.pattern.captures)?s(r,w,m-r[0].length,x):h[k].pattern.pattern.name&&x.push({start:m-r[0].length,end:m,style:h[k].pattern.pattern.name}),m-=r[0].length;var g=this._getStyles(h[k],b,c.substring(p-
d,m-d),p),y=h[k].pattern.pattern.contentName||h[k].pattern.pattern.name;if(y){var N=p;g.forEach(function(a){a.start-N&&f.push({start:N,end:a.start,style:y});f.push(a);N=a.end});m-N&&f.push({start:N,end:m,style:y})}else f=f.concat(g);f=f.concat(x);g=n}g<e&&t(c.substring(g-d,e-d),g,a,f);if(b.getBaseModel)for(a=0;a<f.length;a++)c=f[a].end-f[a].start,f[a].start=b.mapOffset(f[a].start,!0),f[a].end=f[a].start+c;return f},_isRenderingWhitespace:function(){return this.whitespacesVisible&&(this.tabsVisible||
this.spacesVisible)},_onDestroy:function(){this.destroy()},_onLineStyle:function(a){a.textView===this.view&&(a.style=this._getLineStyle(a.lineIndex));a.ranges=this._getStyles(this._rootBlock,a.textView.getModel(),a.lineText,a.lineStart);a.ranges.forEach(function(a){a.style&&(a.style={styleClass:a.style.replace(/\./g," ")})});this._isRenderingWhitespace()&&(this.spacesVisible&&this._spliceStyles(c,a.ranges,a.lineText,a.lineStart),this.tabsVisible&&this._spliceStyles(b,a.ranges,a.lineText,a.lineStart))},
...
c,k),-1!==a&&(l=[g.AnnotationType.createAnnotation(g.AnnotationType.ANNOTATION_MATCHING_BRACKET,a,a+1),g.AnnotationType.createAnnotation(g.AnnotationType.ANNOTATION_CURRENT_BRACKET,k,k+1)]);this._bracketAnnotations=l;this.annotationModel.replaceAnnotations(b,l)}},_onMouseDown:function(a){if(2===a.clickCount){var b=this.view,c=b.getModel(),d=b.getOffsetAtLocation(a.x,a.y);if(0<d){var e=d-1,f=c;c.getBaseModel&&(e=c.mapOffset(e),f=c.getBaseModel());var g=this._findBlock(this._rootBlock,e),e=this._findMatchingBracket(f,
g,e);-1!==e&&(a.preventDefault(),a=e,c.getBaseModel&&(a=c.mapOffset(a,!0)),d>a&&(d--,a++),b.setSelection(a,d))}}},_onModelChanged:function(a){var b=a.start,c=a.removedCharCount,a=a.addedCharCount-c,d=this.view,e=d.getModel(),f=e.getBaseModel?e.getBaseModel():e,c=b+c,h=f.getCharCount(),l=this._rootBlock.getBlocks(),k=l.length,m=f.getLineStart(f.getLineAtOffset(b)),n=this._binarySearch(l,m,!0),p=this._binarySearch(l,c,!1,n-1,k),r;n<k&&l[n].start<=m&&m<l[n].end?(r=l[n].start,r>b&&(r+=a)):r=n===k&&0<
k&&h-a===l[k-1].end?l[k-1].start:m;var s;do p<k?(s=l[p].end,s>b&&(s+=a),p+=1):(p=k,s=h),m=f.getText(r,s),m=w(f,m,this._rootBlock,r);while(m.length&&l.length&&p<k&&m[m.length-1].pattern.pattern.id!==l[p-1].pattern.pattern.id);for(h=n;h<l.length;h++)k=l[h],k.start>b&&k.adjustStart(a),k.start>b&&k.adjustEnd(a);var t=p-n!==m.length;if(!t)for(h=0;h<m.length;h++){var k=l[n+h],x=m[h];if(k.start!==x.start||k.end!==x.end||k.type!==x.type){t=!0;break}}h=[n,p-n].concat(m);Array.prototype.splice.apply(l,h);t&&
(h=r,k=s,e!==f&&(h=e.mapOffset(h,!0),k=e.mapOffset(k,!0)),d.redrawRange(h,k));if(this.annotationModel){d=[];l=[];n=[];r=this.annotationModel.getAnnotations(r,s);for(s=this.foldingEnabled&&f!==e;r.hasNext();)if(k=r.next(),s&&k.type===g.AnnotationType.ANNOTATION_FOLDING){n.push(k);for(h=0;h<m.length&&!(k.start===m[h].start&&k.end===m[h].end);h++);h===m.length?(d.push(k),k.expand()):(h=k.start,p=k.end,h>b&&(h-=a),p>b&&(p-=a),h<=b&&(b<p&&h<=c&&c<p)&&(h=f.getLineAtOffset(k.start),p=f.getLineAtOffset(k.end),
h!==p?k.expanded||k.expand():this.annotationModel.removeAnnotation(k)));for(h=0;h<m.length;h++){k=m[h];for(p=0;p<n.length&&!(n[p].start===k.start&&n[p].end===k.end);p++);p===n.length&&(k=this._createFoldingAnnotation(e,f,k.start,k.end))&&l.push(k)}}else k.type===g.AnnotationType.ANNOTATION_TASK&&d.push(k);if(this.detectTasks)for(h=0;h<m.length;h++)y(m[h],f,l);this.annotationModel.replaceAnnotations(d,l)}},_spliceStyles:function(a,b,c,d){for(var e=a.regex,f=e.lastIndex=0,g=e.exec(c);g;){for(g=d+g.index;f<
...
contentName:"source.php.embedded.html",patterns:[{include:"orion.php"}]},{begin:"(?i)<\\?(?:=|php)?(?:\\s|$)",end:"\\?>",captures:{"0":{name:"entity.name.declaration.php"}},contentName:"source.php.embedded.html",patterns:[{include:"orion.php"}]},{begin:"<%=?(?:\\s|$)",end:"%>",captures:{"0":{name:"entity.name.declaration.php"}},contentName:"source.php.embedded.html",patterns:[{include:"orion.php"}]}],repository:{xmlDeclaration:{}}});return{id:g[g.length-1].id,grammars:g,keywords:[]}});
define("orion/editor/stylers/text_x-java-source/syntax",["orion/editor/stylers/lib/syntax"],function(g){var n="abstract boolean break byte case catch char class continue default do double else extends false final finally float for if implements import instanceof int interface long native new null package private protected public return short static super switch synchronized this throw throws transient true try void volatile while".split(" "),g=g.grammars;g.push({id:"orion.java",contentTypes:["text/x-java-source"],
patterns:[{include:"orion.c-like"},{match:"\\b(?:"+n.join("|")+")\\b",name:"keyword.control.java"}],repository:{string_singleQuote:{}}});return{id:g[g.length-1].id,grammars:g,keywords:n}});
define("orion/editor/stylers/application_json/syntax",["orion/editor/stylers/lib/syntax"],function(g){var n=["false","true"],g=g.grammars;g.push({id:"orion.json",contentTypes:["application/json"],patterns:[{include:"orion.lib"},{match:"\\b(?:"+n.join("|")+")\\b",name:"keyword.control.json"}]});return{id:g[g.length-1].id,grammars:g,keywords:n}});
define("orion/editor/stylers/text_x-python/syntax",["orion/editor/stylers/lib/syntax"],function(g){var n="and as assert break class continue def del exec elif else except Ellipsis False finally for from global if import in is lambda not None NotImplemented or pass print raise return try True while with yield".split(" "),g=g.grammars;g.push({id:"orion.python",contentTypes:["text/x-python"],patterns:[{include:"orion.lib"},{match:"#.*",name:"comment.line.number-sign.python",patterns:[{include:"orion.lib#todo_comment_singleLine"}]},
{begin:"(['\"])\\1\\1",end:"\\1\\1\\1",name:"string.quoted.triple.python"},{match:"\\b(?:"+n.join("|")+")\\b",name:"keyword.control.python"}],repository:{number_decimal:{match:"\\b-?(?:\\.\\d+|\\d+\\.?\\d*)[lL]?\\b",name:"constant.numeric.number.python"}}});return{id:g[g.length-1].id,grammars:g,keywords:n}});
define("orion/editor/stylers/text_x-ruby/syntax",["orion/editor/stylers/lib/syntax"],function(g){var n="alias alias_method and attr_reader attr_writer attr_accessor attr BEGIN begin break case class catch def defined? do else elsif END end ensure extend false for if fail gem in include initialize load loop lambda module module_function new next nil not or public prepend private protected raise redo require require_relative rescue retry return self super then throw true undef unless until when while yield __ENCODING__ __END__ __FILE__ __LINE__".split(" "),g=
g.grammars;g.push({id:"orion.ruby",contentTypes:["text/x-ruby"],patterns:[{include:"orion.lib"},{match:"#.*",name:"comment.line.number-sign.ruby",patterns:[{include:"orion.lib#todo_comment_singleLine"}]},{begin:"^=begin",end:"^=end",name:"comment.block.ruby",patterns:[{match:"(\\b)(TODO)(\\b)(((?!\\*/).)*)",name:"meta.annotation.task.todo",captures:{2:{name:"keyword.other.documentation.task"},4:{name:"comment.block"}}}]},{match:"\\b0[bB][01]+\\b",name:"constant.numeric.binary.ruby"},{match:"\\b(?:"+
n.join("|")+")\\b",name:"keyword.control.ruby"}]});return{id:g[g.length-1].id,grammars:g,keywords:n}});
define("orion/widgets/browse/staticDataSource","orion/Deferred orion/editor/textStyler orion/editor/stylers/application_javascript/syntax orion/editor/stylers/text_css/syntax orion/editor/stylers/text_html/syntax orion/editor/stylers/text_x-java-source/syntax orion/editor/stylers/application_json/syntax orion/editor/stylers/text_x-php/syntax orion/editor/stylers/text_x-python/syntax orion/editor/stylers/text_x-ruby/syntax".split(" "),function(g,n,p,a,k,f,e,d,h,c){function b(){this.styler=null}b.prototype=
{setup:function(a,b,c){this.styler&&(this.styler.destroy&&this.styler.destroy(),this.styler=null);return this.highlight(a,b,c)},highlight:function(b,f,r){this.styler&&(this.styler.destroy(),this.styler=null);if(b)switch(b.id){case "application/javascript":this.styler=new n.TextStyler(f,r,p.grammars,"orion.js");break;case "text/css":this.styler=new n.TextStyler(f,r,a.grammars,"orion.css");break;case "text/html":this.styler=new n.TextStyler(f,r,k.grammars,"orion.html");break;case "text/x-java-source":this.styler=
new n.TextStyler(f,r,p.grammars,"orion.js");break;case "application/json":this.styler=new n.TextStyler(f,r,e.grammars,"orion.json");break;case "text/x-python":this.styler=new n.TextStyler(f,r,h.grammars,"orion.py");break;case "text/x-ruby":this.styler=new n.TextStyler(f,r,c.grammars,"orion.rb");break;case "text/x-php":this.styler=new n.TextStyler(f,r,d.grammars,"orion.php")}return(new g).resolve()},getStyler:function(){return this.styler}};return{ContentTypes:[{id:"text/plain",name:"Text",extension:["txt"],
...
SyntaxHighlighter:b}});
define("orion/widgets/browse/emptyFileClient",["orion/Deferred"],function(g){function n(){}var p={Directory:!1,Length:1159,LocaltimeStamp:1389974936424,Location:"readme",Name:"README.md"},a={Directory:!1,Length:1159,LocaltimeStamp:1389974936424,Location:"readme",Name:"README.md",Parents:[]},k={Children:[p],ChildrenLocation:"children",Directory:!0,Length:0,LocaltimeStamp:1389974936424,Location:"root",Name:""};n.prototype={fileServiceName:function(){return"Empty"},fileServiceRootURL:function(){return""},fetchChildren:function(){return(new g).resolve([p])},
loadWorkspaces:function(){return(new g).resolve(k)},read:function(f,e){return e?(new g).resolve(a):(new g).resolve("The goal of Orion is to build developer tooling that works in the browser, at web scale.\nThe vision behind Orion is to move software development to the web as a web experience, by\nenabling open tool integration through HTTP and REST, JSON, OAuth, OpenID, and others.\nThe idea is to exploit internet design principles throughout, instead of trying to bring\nexisting desktop IDE concepts to the browser. See the [Orion wiki](http://wiki.eclipse.org/Orion) for more\ninformation about Orion.\n\nContributing\n------------\n\nOrion source code is available in an Eclipse Git repository, and there is also a mirror\non GitHub. For complete details on getting the source and getting setup to develop Orion,\nsee the [Orion wiki](http://wiki.eclipse.org/Orion/Getting_the_source).\n\nBug reports and patches are welcome in [bugzilla](https://bugs.eclipse.org/bugs/enter_bug.cgi?product=Orion).\n\nLicense\n-------\n\nThis repository contains the Orion client and Node-based server. This source code is available\nunder the [Eclipse Public License](http://www.eclipse.org/legal/epl-v10.html)\nand [Eclipse Distribution License](http://www.eclipse.org/org/documents/edl-v10.php).\n")},
loadWorkspace:function(){return(new g).resolve(k)}};n.prototype.constructor=n;return{FileClient:n}});
define("orion/widgets/browse/fileBrowser","orion/PageUtil orion/inputManager orion/breadcrumbs orion/widgets/browse/browseView orion/explorers/navigatorRenderer orion/widgets/browse/readonlyEditorView orion/widgets/browse/resourceSelector orion/markdownView orion/commandRegistry orion/fileClient orion/contentTypes orion/widgets/browse/staticDataSource orion/widgets/browse/emptyFileClient orion/Deferred orion/URITemplate orion/objects orion/EventTarget orion/webui/littlelib".split(" "),function(g,
n,p,a,k,f,e,d,h,c,b,l,m,r,s,x,t,w){function y(){t.attach(this)}function u(a){this._parentDomNode=w.node(a.parent);this._parentDomNode.classList.add("browserParentDome");this._fileClient=a.fileClient?a.fileClient:a.serviceRegistry?new c.FileClient(a.serviceRegistry):new m.FileClient;this._syntaxHighlighter=a.syntaxHighlighter;this._syntaxHighlighter||(this._syntaxHighlighter=new l.SyntaxHighlighter);this._contentTypeService=a.contentTypeService;this._contentTypeService||(this._contentTypeService=new b.ContentTypeRegistry(l.ContentTypes));
this._preferences=a.preferences;this.rootName=a.rootName;this._showBranch=a.showBranch;this._breadCrumbInHeader=a.breadCrumbInHeader;this._showComponent=a.showComponent;this._lastInputResource=null;this._resourceChangeHandler=new y;this._resourceChangeHandler.addEventListener("resourceChanged",function(a){if(this._componentSelector&&a&&a.newResource&&a.newResource.selectorAllItems){this._componentSelector.allItems=a.newResource.selectorAllItems;var b=a.defaultChild;b||(a.newResource.selectorAllItems.some(function(a){if(a.Directory)return b=
a.Location,!0}),a.changeHash?window.location=(new s("#{,resource,params*}")).expand({resource:b}):this.refresh((new s("{,resource}")).expand({resource:b})));this._componentSelector.activeResourceName=this._componentSelector.getActiveResource(b).Name;this._componentSelector.refresh()}}.bind(this));this._init(a)}x.mixin(u.prototype,{_init:function(a){this._commandRegistry=new h.CommandRegistry({});this._maxEditorLines=a.maxEditorLines;this._inputManager=new n.InputManager({fileClient:this._fileClient,
statusReporter:this._statusReport,contentTypeRegistry:this._contentTypeService});this._uriTemplate=new s("#{,resource,params*}");this._inputManager.addEventListener("InputChanged",function(a){var b=a.metadata;if(this._branches&&this._branchSelector){var c=this._branches[0].Name;this._activeBranchLocation=this._branches[0].Location;var d=this._activeComponentLocation=null;b.Parents?0<b.Parents.length?(c=b.Parents[b.Parents.length-1].Name,this._activeBranchLocation=b.Parents[b.Parents.length-1].Location,
...
changeHash:b.Parents,defaultChild:this._activeComponentLocation}),!this._activeComponentLocation)return}else if(d){this.refresh((new s("{,resource}")).expand({resource:d}));return}}this._breadCrumbName=a.name;this._breadCrumbTarget=b;if(null===a.input||void 0===a.input)this._breadCrumbName=this._lastRoot?this._lastRoot.Name:"",this._breadCrumbTarget=this._lastRoot;b=this._getEditorView(a.input,a.contents,b);this._setEditor(b?b.editor:null);a.editor=this._editor}.bind(this));a={parent:document.createElement("div"),
syntaxHighlighter:this._syntaxHighlighter,inputManager:this._inputManager,preferences:this._preferences,statusReporter:function(a,b,c){this._statusReport(a,b,c)}.bind(this)};this._editorView=new f.ReadonlyEditorView(a);window.addEventListener("hashchange",function(){this.refresh(g.hash())}.bind(this));if(this._showBranch){var b=document.createElement("div");b.classList.add("resourceSelectorContainer");a=this._fileClient.fileServiceRootURL("");this._fileClient.fetchChildren(a).then(function(a){if(a&&
0<a.length&&(this._branches=a,this._branchSelector=new e.ResourceSelector({commandRegistry:this._commandRegistry,fileClient:this._fileClient,parentNode:b,labelHeader:this._showComponent?"stream":"branch",resourceChangeDispatcher:this._showComponent?this._resourceChangeHandler:null,fetchChildren:this._showComponent?!0:!1,commandScopeId:"orion.browse.brSelector",dropDownId:"orion.browse.switchbr",dropDownTooltip:this._showComponent?"Select a stream":"Select a branch",activeResourceName:"default",allItems:a}),
this._showComponent)){var c=document.createElement("div");c.classList.add("resourceSelectorContainer");c.classList.add("componentSelectorContainer");this._componentSelector=new e.ResourceSelector({commandRegistry:this._commandRegistry,fileClient:this._fileClient,parentNode:c,labelHeader:"component",commandScopeId:"orion.browse.compSelector",dropDownId:"orion.browse.switchcomp",dropDownTooltip:"Select a componet",activeResourceName:"default",allItems:a})}this.refresh(g.hash())}.bind(this))}else this.refresh(g.hash())},
_breadCrumbMaker:function(a,b){this._renderBreadCrumb({task:"Browse",name:this._breadCrumbName,target:this._breadCrumbTarget,breadCrumbContainer:a,makeBreadcrumbLink:function(a,b,c){this._makeBreadCrumbLink(a,b,c)}.bind(this),makeBreadcrumFinalLink:!1,fileClient:this._fileClient,maxLength:b})},_setEditor:function(a){this._editor!==a&&(this._editor=a)},_statusReport:function(){},_makeBreadCrumbLink:function(a,b,c){(c=c?c.Location:null)||(c=b?b:this._fileClient.fileServiceRootURL(b));a.href=this._uriTemplate.expand({resource:c})},
_renderBreadCrumb:function(a){var b=a.breadcrumbRootName,c=a.fileClient;a.target?c&&!a.breadcrumbTarget&&(c.fileServiceName(a.target.Location),b=null):a.breadcrumbTarget||(b=b||a.task||a.name);var d=w.node(a.breadCrumbContainer);if(d){w.empty(d);var e=a.breadcrumbTarget||a.target;this._componentSelector?e.Parents&&(1===e.Parents.length?(e.Parents[e.Parents.length-1].skip=!0,e.skip=!0):1<e.Parents.length&&(e.Parents[e.Parents.length-1].skip=!0,e.Parents[e.Parents.length-2].skip=!0)):this._branchSelector&&
e.Parents&&(0<e.Parents.length?e.Parents[e.Parents.length-1].skip=!0:e.skip=!0);c=c&&e&&e.Location?c.fileServiceRootURL(e.Location):null;new p.BreadCrumbs({container:d,maxLength:a.maxLength,resource:e,rootSegmentName:b,workspaceRootSegmentName:this.rootName?this.rootName:c,workspaceRootURL:this._calculateRootURL(c),makeFinalHref:a.makeBreadcrumFinalLink,makeHref:a.makeBreadcrumbLink})}},_calculateRootURL:function(a){return this._activeComponentLocation?this._activeComponentLocation:this._activeBranchLocation?
this._activeBranchLocation:a},_getEditorView:function(b,c,d){var e=null;d&&b&&(b={parent:this._parentDomNode,maxEditorLines:this._maxEditorLines,breadCrumbInHeader:this._breadCrumbInHeader,readmeHeaderClass:"readmeHeader",metadata:d,branchSelector:this._branchSelector,componentSelector:this._componentSelector,commandRegistry:this._commandRegistry,contentTypeRegistry:this._contentTypeService,inputManager:this._inputManager,fileService:this._fileClient,breadCrumbMaker:function(a,b){this._breadCrumbMaker(a,
b)}.bind(this)},d.Directory||((d=this._contentTypeService.getFileContentType(d))?"text/x-markdown"===d.id?b.isMarkdownView=!0:k.isImage(d)?(c=URL.createObjectURL(new Blob([c],{type:d.id})),d=document.createElement("img"),d.src=c,d.classList.add("readonlyImage"),b.imageView={image:d}):b.editorView=this._editorView:b.editorView=this._editorView),e=new a.BrowseView(b));this._currentEditorView!==e&&(this._currentEditorView&&this._currentEditorView.destroy(),(this._currentEditorView=e)&&this._currentEditorView.create());
return this._currentEditorView},refresh:function(a){a||(a=(new s("{,resource}")).expand({resource:this._fileClient.fileServiceRootURL("")}));this._inputManager.setInput(a)},create:function(){},destroy:function(){}});return{FileBrowser:u}});
define("orion/serviceregistry",["orion/Deferred","orion/EventTarget"],function(g,n){function p(a,e,c){this._properties=c||{};this._properties["service.id"]=a;this._properties.objectClass=e;this._properties["service.names"]=e}function a(a,e,c){this._serviceId=a;this._serviceReference=e;this._internalRegistry=c}function k(a,e){function c(b){return function(){var c;try{if(!e())throw Error("Service was unregistered");var f=a[b].apply(a,Array.prototype.slice.call(arguments));if(f&&"function"===typeof f.then)return f;
c=new g;c.resolve(f)}catch(k){c=new g,c.reject(k)}return c.promise}}for(var b in a)"function"===typeof a[b]&&(this[b]=c(b))}function f(a,e){this.type=a;this.serviceReference=e}function e(){this._entries=[];this._namedReferences={};this._serviceEventTarget=new n;var a=this;this._internalRegistry={isRegistered:function(e){return a._entries[e]?!0:!1},unregisterService:function(e){var c=a._entries[e];if(!c)throw Error("Service has already been unregistered: "+e);var b=c.reference;a._serviceEventTarget.dispatchEvent(new f("unregistering",
b));a._entries[e]=null;b.getProperty("objectClass").forEach(function(c){for(var e=a._namedReferences[c],f=0;f<e.length;f++)if(e[f]===b){1===e.length?delete a._namedReferences[c]:e.splice(f,1);break}})},modifyService:function(e){var c=a._entries[e];if(!c)throw Error("Service not found while trying to send modified event: "+e);a._serviceEventTarget.dispatchEvent(new f("modified",c.reference))}}}p.prototype={getPropertyKeys:function(){var a=[],e;for(e in this._properties)this._properties.hasOwnProperty(e)&&
a.push(e);return a},getProperty:function(a){return this._properties[a]}};p.prototype.constructor=p;a.prototype={unregister:function(){this._internalRegistry.unregisterService(this._serviceId)},getReference:function(){if(!this._internalRegistry.isRegistered(this._serviceId))throw Error("Service has already been unregistered: "+this._serviceId);return this._serviceReference},setProperties:function(a){var e=this._serviceReference._properties;this._serviceReference._properties=a||{};a["service.id"]=this._serviceId;
a.objectClass=e.objectClass;a["service.names"]=e["service.names"];this._internalRegistry.modifyService(this._serviceId)}};a.prototype.constructor=a;e.prototype={getService:function(a){var e;if("string"===typeof a)(a=this._namedReferences[a])&&a.some(function(a){e=this._entries[a.getProperty("service.id")].service;return!!e},this);else if(a=this._entries[a.getProperty("service.id")])e=a.service;return e||null},getServiceReferences:function(a){if(a)return this._namedReferences[a]?this._namedReferences[a]:
[];var e=[];this._entries.forEach(function(a){a&&e.push(a.reference)});return e},registerService:function(d,e,c){if("undefined"===typeof e||null===e)throw Error("invalid service");"string"===typeof d?d=[d]:Array.isArray(d)||(d=[]);var b=this._entries.length,g=new p(b,d,c),m=this._namedReferences;d.forEach(function(a){m[a]=m[a]||[];m[a].push(g)});d=new k(e,this._internalRegistry.isRegistered.bind(null,b));this._entries.push({reference:g,service:d});d=this._internalRegistry;this._serviceEventTarget.dispatchEvent(new f("registered",
g));return new a(b,g,d)},addEventListener:function(a,e){this._serviceEventTarget.addEventListener(a,e)},removeEventListener:function(a,e){this._serviceEventTarget.removeEventListener(a,e)}};e.prototype.constructor=e;return{ServiceRegistry:e}});
define("orion/pluginregistry",["orion/Deferred","orion/EventTarget","orion/URL-shim"],function(g,n){function p(a,c){var d=Object.keys(a),e=Object.keys(c);if(d.length!==e.length)return!1;d.sort();e.sort();for(var f=0,g=d.length;f<g;f++){var h=d[f];if(h!==e[f])return!1;var k=a[h],h=c[h];if(k!==h&&JSON.stringify(k)!==JSON.stringify(h))return!1}return!0}function a(a){if(-1===a.indexOf("://"))try{return(new URL(a,location.href)).href}catch(c){}return a}function k(a,c){if(c&&c instanceof XMLHttpRequest){var d,
e;try{d=c.status,e=c.statusText}catch(f){d=0,e=""}return{status:d||0,statusText:e}}return c}function f(a){var c=a?JSON.parse(JSON.stringify(a,k)):a;a instanceof Error&&(c.__isError=!0,c.message=c.message||a.message,c.name=c.name||a.name);return c}function e(a,c){this.type=a;this.plugin=c}function d(a,c){this.__objectId=a;this.__methods=c}function h(a,c,h){function k(a){L&&h.postMessage(a,L)}function s(a){if(!L)return(new g).reject(Error("plugin not connected"));a.id=String(O++);var b=new g;S[a.id]=
b;b.then(null,function(b){"active"===E&&(b instanceof Error&&"Cancel"===b.name)&&k({requestId:a.id,method:"cancel",params:b.message?[b.message]:[]})});var c=Object.prototype.toString;a.params.forEach(function(e,f){if("[object Object]"===c.call(e)&&!(e instanceof d)){var g,h;for(g in e)"[object Function]"===c.call(e[g])&&(h=h||[],h.push(g));if(h){var k=Q++;T[k]=e;g=function(){delete T[k]};b.then(g,g);a.params[f]=new d(k,h)}}});h.postMessage(a,L);return b.promise}function x(a,b){a||0===a?k({id:a,result:null,
error:b}):console.log(b)}function t(a,b,c,d){d.forEach(function(a,b){if(a&&"undefined"!==typeof a.__objectId){var c={};a.__methods.forEach(function(b){c[b]=function(){return s({objectId:a.__objectId,method:b,params:Array.prototype.slice.call(arguments)})}});d[b]=c}});var e=void 0===typeof a?null:{id:a,result:null,error:null};try{var g=c.apply(b,d);e&&(g&&"function"===typeof g.then?(N[a]=g,g.then(function(b){delete N[a];e.result=b;k(e)},function(b){N[a]&&(delete N[a],e.error=f(b),k(e))},function(){k({responseId:a,
method:"progress",params:Array.prototype.slice.call(arguments)})})):(e.result=g,k(e)))}catch(h){e&&(e.error=f(h),k(e))}}function w(a){try{if(a.method){var b=a.method,c=a.params||[];if("serviceId"in a){var d=Y[a.serviceId];d||x(a.id,"service not found");b in d?t(a.id,d,d[b],c):x(a.id,"method not found")}else if("objectId"in a){var e=T[a.objectId];e||x(a.id,"object not found");b in e?t(a.id,e,e[b],c):x(a.id,"method not found")}else if("requestId"in a){var f=N[a.requestId];f&&("cancel"===b&&f.cancel)&&
f.cancel.apply(f,c)}else if("responseId"in a){var g=S[a.responseId];g&&("progress"===b&&g.progress)&&g.progress.apply(g,c)}else if("plugin"===a.method){var k=a.params[0];U({headers:k.headers,services:k.services}).then(function(){K&&K.resolve(q)})}else if("timeout"===a.method)K&&K.reject(a.error);else throw Error("Bad method: "+a.method);}else{var l=S[String(a.id)];delete S[String(a.id)];if(a.error){var n=h.handleServiceError(q,a.error);l.reject(n)}else l.resolve(a.result)}}catch(p){console.log("Plugin._messageHandler "+
p)}}function y(c){var d=JSON.parse(JSON.stringify(c.properties));d.__plugin__=a;c=c.names||c.type||[];Array.isArray(c)||(c=[c]);d.objectClass=c;return d}function u(a){var b={};if(a.methods&&(a.methods.forEach(function(c){b[c]=function(){var b={serviceId:a.serviceId,method:c,params:Array.prototype.slice.call(arguments)};return"active"===E?s(b):q.start({"transient":!0}).then(function(){return s(b)})}}),b.addEventListener&&b.removeEventListener)){var c=new n,e=Q++;T[e]={handleEvent:c.dispatchEvent.bind(c)};
var f=new d(e,["handleEvent"]),g=b.addEventListener;b.addEventListener=function(a,b){c._namedListeners[a]||g(a,f);c.addEventListener(a,b)};var k=b.removeEventListener;b.removeEventListener=function(a,b){c.removeEventListener(a,b);c._namedListeners[a]||k(a,f)}}e=y(a);e=h.registerService(a.names||a.type,b,e);F[a.serviceId]={registration:e,proxy:b}}function z(){h.persist(a,{created:v,headers:A,services:C,autostart:D,lastModified:M})}var q=this,c=c||{},v=c.created||(new Date).getTime(),A=c.headers||{},
C=c.services||[],D=c.autostart,M=c.lastModified||0,E="installed",B,K,L,R,F={},O=0,Q=0,N={},S={},T={},Y={},U;this._persist=z;this._resolve=function(){E="resolved";h.dispatchEvent(new e("resolved",q))};this._getAutostart=function(){return D};this._getCreated=function(){return v};this.getLocation=function(){return a};this.getHeaders=function(){return JSON.parse(JSON.stringify(A))};this.getName=function(){var a=this.getHeaders();return a?a.name||"":null};this.getVersion=function(){var a=this.getHeaders();
return a?a.version||"0.0.0":null};this.getLastModified=function(){return M};this.getServiceReferences=function(){var a=[];Object.keys(F).forEach(function(b){a.push(F[b].registration.getReference())});return a};this.setParent=function(a){return R!==a?(R=a,q.stop({"transient":!0}).then(function(){if("started"===D)return q.start({"transient":!0});if("lazy"===D)return q.start({lazy:!0,"transient":!0})})):(new g).resolve()};this.getState=function(){return E};this.start=function(c){if("uninstalled"===E)return(new g).reject(Error("Plugin is uninstalled"));
if(B)return B.promise.then(this.start.bind(this,c));if("active"===E)return(new g).resolve();if(!c||!c.transient){var d=c&&c.lazy?"lazy":"started";d!==D&&(D=d,z())}d=h.getState();if("starting"!==d&&"active"!==d)return c.transient?(new g).reject(Error("start transient error")):(new g).resolve();if("installed"===E)try{this._resolve()}catch(f){return(new g).reject(f)}"resolved"===E&&C.forEach(function(a){u(a)});if(c&&c.lazy)return"starting"!==E&&(E="starting",h.dispatchEvent(new e("lazy activation",q))),
(new g).resolve();var k=new g;B=k;E="starting";h.dispatchEvent(new e("starting",q));K=new g;L=h.connect(a,w,R);K.then(function(){K=null;E="active";h.dispatchEvent(new e("started",q));B=null;k.resolve()},function(){K=null;E="stopping";h.dispatchEvent(new e("stopping",q));Object.keys(F).forEach(function(a){F[a].registration.unregister();delete F[a]});h.disconnect(L);L=null;E="resolved";B=null;h.dispatchEvent(new e("stopped",q));k.reject(Error("plugin activation error"))});return k.promise};this.stop=
function(a){if("uninstalled"===E)return(new g).reject(Error("Plugin is uninstalled"));if(B)return B.promise.then(this.stop.bind(this,a));if((!a||!a.transient)&&"stopped"!==D)D="stopped",z();if("active"!==E&&"starting"!==E)return(new g).resolve();B=a=new g;E="stopping";h.dispatchEvent(new e("stopping",q));Object.keys(F).forEach(function(a){F[a].registration.unregister();delete F[a]});L&&(h.disconnect(L),L=null);E="resolved";B=null;h.dispatchEvent(new e("stopped",q));a.resolve();return a.promise};U=
function(c){if("uninstalled"===E)return(new g).reject(Error("Plugin is uninstalled"));if(!c)return 0===M&&(M=(new Date).getTime(),z()),h.loadManifest(a).then(U);var d=A,f=C,k=D;A=c.headers||{};C=c.services||{};D=c.autostart||D;c.lastModified?M=c.lastModified:(M=(new Date).getTime(),z());if(p(A,d)&&p(C,f)&&D===k)return(new g).resolve();if("active"===E||"starting"===E){var l=[];Object.keys(C).forEach(function(a){var b=C[a];l.push(a);var c=F[a];if(c){if(p(b.methods,Object.keys(c.proxy))){var a=y(b),
d=c.registration.getReference(),e={};d.getPropertyKeys().forEach(function(a){e[a]=d.getProperty(a)});p(a,e)||c.registration.setProperties(a);return}c.registration.unregister();delete F[a]}u(b)});Object.keys(F).forEach(function(a){-1===l.indexOf(a)&&(F[a].registration.unregister(),delete F[a])})}"active"===E&&(h.disconnect(L),K=new g,L=h.connect(a,w,R),K.then(function(){K=null},function(){K=null;E="stopping";h.dispatchEvent(new e("stopping"),q);Object.keys(F).forEach(function(a){F[a].registration.unregister();
delete F[a]});h.disconnect(L);L=null;E="resolved";h.dispatchEvent(new e("stopped",q))}));return(new g).resolve()};this.update=function(a){return U(a).then(function(){h.dispatchEvent(new e("updated",q))})};this.uninstall=function(){if("uninstalled"===E)return(new g).reject(Error("Plugin is uninstalled"));if("active"===E||"starting"===E||"stopping"===E)return this.stop().then(this.uninstall.bind(this),this.uninstall.bind(this));h.removePlugin(this);E="uninstalled";h.dispatchEvent(new e("uninstalled",
q));return(new g).resolve()}}var c=/^http[s]?/i;return{Plugin:h,PluginRegistry:function(b,d){function f(a){var b=a.source;z.some(function(c){if(b===c.target){try{var d;if("undefined"===typeof c.useStructuredClone){var e="string"!==typeof a.data;d=e?a.data:JSON.parse(a.data);c.useStructuredClone=e}else d=c.useStructuredClone?a.data:JSON.parse(a.data);c.handler(d)}catch(f){}return!0}})}var d=d||{},k=d.storage||localStorage;if(!k.getItem){var p=k,x=null,t={key:function(a){return(x=x||Object.keys(p))[a]},
getItem:function(a){return p[a]},setItem:function(a,b){p[a]=b;x=null},removeItem:function(a){delete p[a];x=null},clear:function(){(x=x||Object.keys(p)).forEach(function(a){delete p[a]}.bind(this));x=null}};Object.defineProperty(t,"length",{get:function(){return(x=x||Object.keys(p)).length}});k=t}var w="installed",y,u=[],z=[],q=new n,v={},A={registerService:b.registerService.bind(b),connect:function(a,b,c,d){function e(a){a=Error(a);a.name="timeout";b({method:"timeout",error:a})}var f={handler:b,url:a},
...
0;b<z.length;b++)if(a===z[b]){z.splice(b,1);try{a.close()}catch(c){}break}},removePlugin:function(a){for(var b=0;b<u.length;b++)if(a===u[b]){u.splice(b,1);break}k.removeItem("plugin."+a.getLocation())},persist:function(a,b){k.setItem("plugin."+a,JSON.stringify(b))},postMessage:function(a,b){b.target.postMessage(b.useStructuredClone?a:JSON.stringify(a),b.url)},dispatchEvent:function(a){try{q.dispatchEvent(a)}catch(b){console&&console.log("PluginRegistry.dispatchEvent "+b)}},loadManifest:function(a){var b=
new g,c=A.connect(a,function(a){c&&a.method&&("manifest"===a.method||"plugin"===a.method?(a=a.params[0],A.disconnect(c),c=null,b.resolve(a)):"timeout"===a.method&&(A.disconnect(c),c=null,b.reject(a.error)))});return b.promise},getState:function(){return w},handleServiceError:function(a,b){if(b&&401===b.status){var d=a.getHeaders(),e=a.getName()||a.getLocation(),f=document.createElement("span");f.appendChild(document.createTextNode("Authentication required for: "+e+"."));d.login&&(f.appendChild(document.createTextNode(" ")),
...
this.getName=function(){return"System"};this.getVersion=function(){return"0.0.0"};this.getLastModified=function(){return 0};this.getState=A.getState;this.init=function(){if(!("starting"===w||"active"===w||"stopping"===w)){addEventListener("message",f,!1);for(var b=[],c=0,e=k.length;c<e;c++)b.push(k.key(c));b.forEach(function(a){if(0===a.indexOf("plugin.")){var b=a.substring(7),a=JSON.parse(k.getItem(a));a.created&&u.push(new h(b,a,A))}});u.sort(function(a,b){return a._getCreated()<b._getCreated()?
-1:1});d.parent?y=d.parent:(y=document.createElement("div"),d.visible||(y.style.display="none",y.style.visibility="hidden"),document.body.appendChild(y));d.plugins&&Object.keys(d.plugins).forEach(function(b){b=a(b);if(!this.getPlugin(b)){var c=d.plugins[b],c="object"===typeof c||{};c.autostart=c.autostart||d.defaultAutostart||"lazy";u.push(new h(b,c,A))}}.bind(this));w="starting"}};this.start=function(){"starting"!==w&&this.init();if("starting"!==w)return(new g).reject("Cannot start framework. Framework is already "+
w+".");var a=[],b=(new Date).getTime();u.forEach(function(c){var d=c._getAutostart();0===c.getLastModified()?a.push(c.update().then(function(){if("started"===d)return c.start({"transient":!0});if("lazy"===d)return c.start({lazy:!0,"transient":!0});c._resolve()})):"started"===d?a.push(c.start({"transient":!0})):"lazy"===d?(a.push(c.start({lazy:!0,"transient":!0})),b>c.getLastModified()+864E5&&c.update()):c._resolve()});return g.all(a,function(a){console.log("PluginRegistry.stop "+a)}).then(function(){w=
"active"})};this.stop=function(){if("starting"!==w&&"active"!==w)return(new g).reject("Cannot stop registry. Registry is already "+w+".");w="stopping";var a=[];u.forEach(function(b){a.push(b.stop({"transient":!0}))});return g.all(a,function(a){console.log("PluginRegistry.stop "+a)}).then(function(){if(!d.parent){var a=y.parentNode;a&&a.removeChild(y)}y=null;removeEventListener("message",f);w="resolved"})};this.update=function(){this.stop().then(this.start.bind(this))};this.uninstall=function(){return(new g).reject("Cannot uninstall registry")};
this.installPlugin=function(b,c){var b=a(b),d=this.getPlugin(b);if(d)return(new g).resolve(d);if(v[b])return v[b];if(c)return d=new h(b,c,A),u.push(d),d._persist(),A.dispatchEvent(new e("installed",d)),(new g).resolve(d);var f=A.loadManifest(b).then(function(a){d=new h(b,a,A);u.push(d);d._persist();delete v[b];A.dispatchEvent(new e("installed",d));return d},function(a){delete v[b];throw a;});return v[b]=f};this.getPlugins=function(){return u.slice()};this.getPlugin=function(b){var c=null,b=a(b);u.some(function(a){if(b===
a.getLocation())return c=a,!0});return c};this.addEventListener=q.addEventListener.bind(q);this.removeEventListener=q.removeEventListener.bind(q);this.resolvePlugins=function(){var a=!0;u.forEach(function(b){a=a&&b._resolve()});return a}}}});var _browser_script_source=null,_all_script=document.getElementsByTagName("script");
...
define("browse/builder/browse",["orion/widgets/browse/fileBrowser","orion/serviceregistry","orion/pluginregistry","orion/URL-shim"],function(g,n,p){function a(a){"string"===typeof a?(a={parentId:arguments[0],repo:arguments[1]},2<arguments.length&&(a.base=arguments[2])):a=a||{};var f,e=new URL(a.repo||window.location.href),d=e.href;f=a.base;var h=!1;if(!a.rootName){var c=d.match(/\/([^/]+)\/([^/]+)$/);c&&(a.rootName=decodeURIComponent(c[1])+" / "+decodeURIComponent(c[2]),a.rootName.match(/\.git$/)&&
(a.rootName=a.rootName.substring(0,a.rootName.length-4)))}if("github.com"===e.host)f=new URL("../../plugins/GitHubFilePlugin.html?repo="+e.href,_browser_script_source);else if(0===e.pathname.indexOf("/git/"))f=new URL("/gerrit/plugins/gerritFilesystem/static/plugins/GerritFilePlugin.html",e),f.query.set("project",e.pathname.substring(5));else if(0===e.pathname.indexOf("/ccm"))f||(e=e.pathname.match(/^\/ccm[^/]*/),f=(new URL(e,d)).href),f=new URL(f+"/service/com.ibm.team.filesystem.service.jazzhub.IOrionFilesystem/sr/pluginOrionWs.html?"+
d),h=!0;else if(0===e.pathname.indexOf("/project/"))f||(f=(new URL("/ccm01",d)).href),f=new URL(f+"/service/com.ibm.team.filesystem.service.jazzhub.IOrionFilesystem/sr/pluginOrionWs.html?"+d),h=!0;else throw"Bad Repo URL - "+d;var b=new n.ServiceRegistry,e={};e[f.href]=!0;(new p.PluginRegistry(b,{storage:{},plugins:e})).start().then(function(){this._fileBrowser=new g.FileBrowser({parent:a.parentId,showBranch:!0,repo:d,showComponent:h,rootName:a.rootName,maxEditorLines:300,serviceRegistry:b})}.bind(this))}
a.prototype={getFileBrowser:function(){return this._fileBrowser}};return a});orion=this.orion||(this.orion={});var browse=orion.browse||(orion.browse={});browse.browser=require("browse/builder/browse");
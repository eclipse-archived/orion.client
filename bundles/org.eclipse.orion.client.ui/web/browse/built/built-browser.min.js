...
(function(g){function n(b,c){var d,l,q,v,A,m,h,a,e,k=c&&c.split("/"),s=r.map,t=s&&s["*"]||{};if(b&&"."===b.charAt(0))if(c){k=k.slice(0,k.length-1);b=k.concat(b.split("/"));for(a=0;a<b.length;a+=1)if(d=b[a],"."===d)b.splice(a,1),a-=1;else if(".."===d)if(1===a&&(".."===b[2]||".."===b[0]))break;else 0<a&&(b.splice(a-1,2),a-=2);b=b.join("/")}else 0===b.indexOf("./")&&(b=b.substring(2));if((k||t)&&s){d=b.split("/");for(a=d.length;0<a;a-=1){l=d.slice(0,a).join("/");if(k)for(e=k.length;0<e;e-=1)if(q=s[k.slice(0,
e).join("/")])if(q=q[l]){v=q;A=a;break}if(v)break;!m&&(t&&t[l])&&(m=t[l],h=a)}!v&&m&&(v=m,A=h);v&&(d.splice(0,A,v),b=d.join("/"))}return b}function p(b,c){return function(){return h.apply(g,s.call(arguments,0).concat([b,c]))}}function a(b){return function(c){return n(c,b)}}function k(b){return function(c){l[b]=c}}function f(b){if(x.call(m,b)){var c=m[b];delete m[b];t[b]=!0;d.apply(g,c)}if(!x.call(l,b)&&!x.call(t,b))throw Error("No "+b);return l[b]}function e(b){var c,d=b?b.indexOf("!"):-1;-1<d&&(c=
b.substring(0,d),b=b.substring(d+1,b.length));return[c,b]}var d,h,c,b,l={},m={},r={},t={},x=Object.prototype.hasOwnProperty,s=[].slice;c=function(b,c){var d,l=e(b),q=l[0],b=l[1];q&&(q=n(q,c),d=f(q));q?b=d&&d.normalize?d.normalize(b,a(c)):n(b,c):(b=n(b,c),l=e(b),q=l[0],b=l[1],q&&(d=f(q)));return{f:q?q+"!"+b:b,n:b,pr:q,p:d}};b={require:function(b){return p(b)},exports:function(b){var c=l[b];return"undefined"!==typeof c?c:l[b]={}},module:function(b){return{id:b,uri:"",exports:l[b],config:function(){return r&&
r.config&&r.config[b]||{}}}}};d=function(d,r,a,h){var q,v,A,e,C=[],s,h=h||d;if("function"===typeof a){r=!r.length&&a.length?["require","exports","module"]:r;for(e=0;e<r.length;e+=1)if(A=c(r[e],h),v=A.f,"require"===v)C[e]=b.require(d);else if("exports"===v)C[e]=b.exports(d),s=!0;else if("module"===v)q=C[e]=b.module(d);else if(x.call(l,v)||x.call(m,v)||x.call(t,v))C[e]=f(v);else if(A.p)A.p.load(A.n,p(h,!0),k(v),{}),C[e]=l[v];else throw Error(d+" missing "+v);r=a.apply(l[d],C);if(d)if(q&&q.exports!==
g&&q.exports!==l[d])l[d]=q.exports;else if(r!==g||!s)l[d]=r}else d&&(l[d]=a)};requirejs=require=h=function(l,m,a,e,q){if("string"===typeof l)return b[l]?b[l](m):f(c(l,m).f);l.splice||(r=l,m.splice?(l=m,m=a,a=null):l=g);m=m||function(){};"function"===typeof a&&(a=e,e=q);e?d(g,l,m,a):setTimeout(function(){d(g,l,m,a)},4);return h};h.config=function(b){r=b;return h};define=function(b,c,d){c.splice||(d=c,c=[]);!x.call(l,b)&&!x.call(m,b)&&(m[b]=[b,c,d])};define.amd={jQuery:!0}})();define("almond",function(){});
...
(function(){function g(p,a,k){for(var f in a)a.hasOwnProperty(f)&&(!p.hasOwnProperty(f)||k)?p[f]=a[f]:"object"===typeof a[f]&&g(p[f],a[f],k)}var n=/(^.*(^|\/)nls(\/|$))([^\/]*)\/?([^\/]*)/;define("i18n",["module"],function(p){var a=p.config?p.config():{};return{version:"2.0.1+",load:function(k,f,e,d){d=d||{};d.locale&&(a.locale=d.locale);var h=n.exec(k),c=h[1],b=h[4],l=h[5],m=b.split("-"),r=[],t={},x,s="";h[5]?(c=h[1],k=c+l):(l=h[4],b=a.locale,b||(b=a.locale="undefined"===typeof navigator?"root":
(navigator.language||navigator.userLanguage||"root").toLowerCase()),m=b.split("-"));if(d.isBuild){r.push(k);d=c+"root/"+l;require._fileExists(f.toUrl(d+".js"))&&r.push(d);for(x=0;x<m.length;x++)d=m[x],s+=(s?"-":"")+d,d=r,h=c+s+"/"+l,require._fileExists(f.toUrl(h+".js"))&&d.push(h);f(r,function(){e()})}else f([k],function(b){var d=[],a;a=c;var h=l;b.root&&(d.push("root"),(!0===b.root||1===b.root)&&r.push(a+"root/"+h));for(x=0;x<m.length;x++){a=m[x];a=s+=(s?"-":"")+a;var h=b,q=r,v=c,A=l;h[a]&&(d.push(a),
(!0===h[a]||1===h[a])&&q.push(v+a+"/"+A))}f(r,function(){var q,v,A;for(q=d.length-1;-1<q&&d[q];q--){A=d[q];v=b[A];if(!0===v||1===v)v=f(c+A+"/"+l);g(t,v)}e(t)})})}}})})();define("orion/i18n",{load:function(g,n,p){n.specified&&n.specified("orion/bootstrap")?n(["orion/i18n!"+g],function(a){p(a)}):p({})}});
...
Project:"Project",New:"New",File:"File",Project:"Project",Edit:"Edit",Tools:"Tools",Add:"Add",NoFile:"Use the ${0} to create new files and folders. Click a file to start coding.",LocalEditorSettings:"Local Editor Settings",NoProject:"${0} is not a project. To convert it to a project use ${1}.",NoProjects:"There are no projects in your workspace. Use the ${0} menu to create projects.",disconnected:"(disconnected)",ChooseFS:"Choose Filesystem",ChooseFSTooltip:"Choose the filesystem you want to view.",
FSTitle:"${0} (${1})",Deploy:"Deploy",Import:"Import",Export:"Export",OpenWith:"Open With",Extensions:"Extensions",UnnamedCommand:"Unnamed"});define("orion/edit/nls/messages",["orion/i18n!orion/edit/nls/messages","orion/edit/nls/root/messages"],function(g,n){var p={root:n};Object.keys(g).forEach(function(a){"undefined"===typeof p[a]&&(p[a]=g[a])});return p});
...
typeof a||"function"===typeof a)&&a.then;if("function"===typeof h)if(a===d.promise)d.reject(new TypeError);else{var e=a.cancel;"function"===typeof e?d._protected(k).parentCancel=e.bind(a):delete d._protected(k).parentCancel;h.call(a,p(d.resolve),p(d.reject),p(d.progress))}else d.resolve(a)}catch(q){d.reject(q)}else d[r](b)}}function d(c){delete t.parentCancel;l="rejected";b=c;m.length&&n(e)}function h(c){function k(q){return function(b){f||(f=!0,q(b))}}var f=!1;delete t.parentCancel;try{var g=c&&
("object"===typeof c||"function"===typeof c)&&c.then;if("function"===typeof g)if(c===r)d(new TypeError);else{l="assumed";var u=c&&c.cancel;if("function"!==typeof u){var z=new a,c=z.promise;try{g(z.resolve,z.reject,z.progress)}catch(q){z.reject(q)}u=c.cancel;g=c.then}b=c;g.call(c,k(h),k(d));t.parentCancel=u.bind(c)}else l="fulfilled",b=c,m.length&&n(e)}catch(v){k(d)(v)}}function c(){var b=t.parentCancel;b?(delete t.parentCancel,b()):l||(b=Error("Cancel"),b.name="Cancel",d(b))}var b,l,m=[],r=this,t=
{};Object.defineProperty(this,"_protected",{value:function(b){if(b!==k)throw Error("protected");return t}});this.resolve=function(b){l||h(b);return r};this.reject=function(b){l||d(b);return r};this.progress=function(b){l||m.forEach(function(c){if(c.progress)try{c.progress(b)}catch(d){}});return r.promise};this.cancel=function(){t.parentCancel?setTimeout(c,0):c();return r};this.then=function(b,c,d){b={resolve:b,reject:c,progress:d,deferred:new a};m.push(b);b.deferred._protected(k).parentCancel=r.promise.cancel.bind(r);
...
"Generate a sample plugin for integrating with Orion.":"Generate a sample plugin for integrating with Orion.",Browser:"Web Browser",OutlineProgress:"Getting outline for ${0} from ${1}",UnknownError:"An unknown error occurred.",UnknownWarning:"An unknown warning occurred.",Filter:"Filter (* = any string, ? = any character)","To view the browser's context menu, trigger the context menu again.":"To view the browser's context menu, trigger the context menu again.",Edit:"Edit",CentralNavTooltip:"Toggle Side Menu"});
...
v=r.exec(q);if(!v)return null;var c={};c.scheme=v[1]||"";if(c.scheme&&!x.test(c.scheme))return null;var l=v[2];if(l&&(l=t.exec(l),c.userinfo=l[1],c.host=l[2],c.port=l[3],c.port&&!s.test(c.port)))return null;c.path=v[3];c.query=v[4];c.fragment=v[5];!c.scheme&&b&&(c.scheme=b.scheme,!c.host&&b.host&&(c.userinfo=b.userinfo,c.host=b.host,c.port=b.port,c.pathRelative=!0));c.pathRelative&&(c.path?"/"!==c.path[0]&&(v=/^(.*\/)[^\/]*$/.exec(b.path)[1]||"/",c.path=v+c.path):c.path=b.path);c.scheme&&(c.scheme=
...
if("function"===typeof window.URL&&0!==window.URL.length&&"http:"===(l=new window.URL("http://www.w3.org?q")).protocol&&l.query)return}catch(m){}var r=/^(?:([^:\/?#]+):)?(?:\/\/([^\/?#]*))?([^?#]*)(?:\?([^#]*))?(?:#(.*))?$/,t=/^(?:(.*)@)?(\[[^\]]*\]|[^:]*)(?::(.*))?$/,x=/^([a-zA-Z](?:[a-zA-Z0-9+-.])*)$/,s=/^\d*$/,w=/^(\[[^\]\/?#\s]*\]|[^:\/?#\s]*)$/,y=/^(\[[^\]\/?#\s]*\]|[^:\/?#\s]*)(?::(\d*))?$/,u=/^([^?#\s]*)$/,z=/^([^\s]*)$/,q=/^\S*$/,v=/([^:]*):?(.*)/,A="undefined"!==typeof StopIteration?StopIteration:
Error("Stop Iteration"),F={"ftp:":"21","gopher:":"70","http:":"80","https:":"443","ws:":"80","wss:":"443"};Object.defineProperties(e.prototype,{get:{value:function(q){g(q);var b;n(this._url.query).some(function(v){v=a(v);if(v[0]===q)return b=v[1],!0});return b},enumerable:!0},set:{value:function(q,b){g(q);g(b);var v=n(this._url.query);v.some(function(c,d){var l=a(c);if(l[0]===q)return l[1]=b,v[d]=k(l),!0})||v.push(k([q,b]));this._url.query=p(v)},enumerable:!0},has:{value:function(q){g(q);return n(this._url.query).some(function(b){if(a(b)[0]===
...
q[1],this._url.port=d(q[2])},enumerable:!0},hostname:{get:function(){return this._url?this._url.host:""},set:function(q){g(q);this._url&&w.exec(q)&&(this._url.host=q)},enumerable:!0},port:{get:function(){var q=this._url?this._url.port||"":"";q&&q===F[this.protocol]&&(q="");return q},set:function(q){g(q);this._url&&s.exec(q)&&(this._url.port=d(q))},enumerable:!0},pathname:{get:function(){return this._url?this._url.path:""},set:function(q){g(q);this._url&&u.exec(q)&&(this._url.host&&(q&&"/"!==q[0])&&
...
"",a=a.getKeys(),f=0;f<a.length;f++)0!==f&&(k+=" "),k+=n(a[f]);return k},getUserText:function(a){var k=a.id,f=a.refNode,e=a.hideRefNode,d=a.initialText,h=a.onComplete,c=a.onEditDestroy,b=a.selectTo,l=a.isInitialValid,a=a.insertAsChild,m=!1,r=function(b){return function(a){if(!m){var r=g.node(k),t=r.value;r&&(b&&a.keyCode===g.KEY.ESCAPE?(e&&(f.style.display="inline"),m=!0,r.parentNode.removeChild(r),c&&c()):b&&a.keyCode!==g.KEY.ENTER||(0===t.length||!l&&t===d?e&&(f.style.display="inline"):(h(t),e&&
f.parentNode&&(f.style.display="inline")),m=!0,r.parentNode&&r.parentNode.removeChild(r),c&&c()))}}},t=document.createElement("input");t.id=k;t.value=d||"";a?f.appendChild(t):f.parentNode.insertBefore(t,f.nextSibling);t.classList.add("userEditBoxPrompt");e&&(f.style.display="none");t.addEventListener("keydown",r(!0),!1);t.addEventListener("blur",r(!1),!1);window.setTimeout(function(){t.focus();if(d){var c=g.node(k),l=b?d.indexOf(b):-1;0<l?c.createTextRange?(c=c.createTextRange(),c.collapse(!0),c.moveStart("character",
...
d,a,e){a=d?n.strip(a):a;l.isBuild&&(b[c]=a);e(a)},load:function(b,a,k,f){if(f.isBuild&&!f.inlineText)k();else{l.isBuild=f.isBuild;var s=n.parseName(b),f=s.moduleName+(s.ext?"."+s.ext:""),g=a.toUrl(f),y=l.useXhr||n.useXhr;!e||y(g,d,h,c)?n.get(g,function(c){n.finishLoad(b,s.strip,c,k)},function(b){k.error&&k.error(b)}):a([f],function(b){n.finishLoad(s.moduleName+"."+s.ext,s.strip,b,k)})}},write:function(c,d,a){if(b.hasOwnProperty(d)){var l=n.jsEscape(b[d]);a.asModule(c+"!"+d,"define(function () { return '"+
...
visibleWhen:function(b){return c(b)},callback:function(b){b.items.collapseAll()}});d.addCommand(b);d.addCommand(l)};e=function(a,e,c){this.rootPath=a;this.fetchItems=e;this.idPrefix=c||""};e.prototype={destroy:function(){this.destroyed=!0},getRoot:function(a){var e=this;this.fetchItems(this.rootPath).then(function(c){e.root=c;a(c)})},getChildren:function(a,e){a.Children?e(a.Children):a.ChildrenLocation?this.fetchItems(a.ChildrenLocation).then(function(c){a.Children=c;e(c)}):e([])},getId:function(a){if(a.Location===
...
0;v<a.length;v++)e(a[v],q+c.name+"/",b,d,l,m)})},t=null;d.registry&&(t=d.registry.getService("orion.page.progress"));k.isAtRoot(v.Location)?(t?t.progress(m.createProject(v.ChildrenLocation,c.name),a.formatMessage(g["Creating ${0}"],c.name)):m.createProject(v.ChildrenLocation,c.name)).then(function(q){d.loadResourceList(d.treeRoot.Path,!0);(t?t.progress(m.read(q.ContentLocation,!0),g["Loading "]+q.name):m.read(q.ContentLocation,!0)).then(function(q){f(q)})}):(t?t.progress(m.createFolder(v.Location,
...
u,!1),this._oldDragOver=u);u=function(d){var q;c.classList.remove("dragOver");if(l){q=f.fileClient;for(var v=l,A;v;){if(v._item){A=v._item;break}v=v.parentNode}if(!A)return;var F=null;f.registry&&(F=f.registry.getService("orion.page.progress"));var h="copy"===m,v=h?q.copyFile:q.moveFile;(F?F.showWhile(v.apply(q,[A.Location,b.Location]),a.formatMessage(g[h?"Copying ${0}":"Moving ${0}"],A.Location)):v.apply(q,[A.Location,b.Location])).then(function(q){f.modelEventDispatcher.dispatchEvent({type:h?"copy":
"move",oldValue:A,newValue:q,parent:b})},function(q){F?F.setProgressResult(q):window.console.log(q)})}else if(d.dataTransfer.items&&0<d.dataTransfer.items.length)for(q=0;q<d.dataTransfer.items.length;q++)v=null,"function"===typeof d.dataTransfer.items[q].getAsEntry?v=d.dataTransfer.items[q].getAsEntry():"function"===typeof d.dataTransfer.items[q].webkitGetAsEntry&&(v=d.dataTransfer.items[q].webkitGetAsEntry()),v&&e(v,null,b,f,n,f.fileClient);else if(d.dataTransfer.files&&0<d.dataTransfer.files.length)for(q=
...
v.className="navlinkonpage",v.href=!b?l:(new e(b+"#{,resource,params*}")).expand({resource:c.ChildrenLocation}),c.Name&&v.appendChild(document.createTextNode(c.Name));else{g||(g=k.getOpenWithCommands(a));if(!w)for(b=0;b<g.length;b++)"default"===g[b].isEditor&&(w=g[b]);v=document.createElement("a");v.className="navlink targetSelector";p&&"object"===typeof p&&Object.keys(p).forEach(function(b){v[b]=p[b]});var A=null,F=null;if(A=z?z.holderDom:v)F=document.createElement("span"),F.className="core-sprite-file modelDecorationSprite thumbnail",
A.appendChild(F);c.Name&&v.appendChild(document.createTextNode(c.Name));var C=!1,M=c.Location;u&&"object"===typeof u&&(c.params={},f.mixin(c.params,u));for(b=0;b<g.length;b++)if(u=g[b],u.visibleWhen(c)){M=u.hrefCallback({items:c});C=!0;break}n.when(d.getFileContentType(c),function(b){!C&&(w&&!h(b))&&(M=w.hrefCallback({items:c}));if(A){var a=A,d=F;if(b){var l,e=b.imageClass,m=b.image;e?(l=document.createElement("span"),l.className+=e,l.classList.add("thumbnail")):m&&(l=document.createElement("img"),
...
typeof c){m||(m=c,c=null);c&&(c=e({},d.defaults,c));var k=c.highlight,h,f,s=0;try{h=g.lex(b,c)}catch(w){return m(w)}f=h.length;var n=function(b){var q,a;!0!==b&&delete c.highlight;try{q=p.parse(h,c)}catch(d){a=d}c.highlight=k;return a?m(a):m(null,q)};if(!k||3>k.length)return n(!0);if(!f)return n();for(;s<h.length;s++)(function(b){return"code"!==b.type?--f||n():k(b.text,b.lang,function(q,c){if(null==c||c===b.text)return--f||n();b.text=c;b.escaped=!0;--f||n()})})(h[s])}else try{return c&&(c=e({},d.defaults,
...
"[Ii\u0130\u0131]"));var b=null,l;if(d){var f=a.reverse,m=a.wrap,e=a.wholeWord,r=a.start||0,a=a.end,g=null!==a&&void 0!==a;-1===h.indexOf("g")&&(h+="g");-1===h.indexOf("m")&&(h+="m");c&&-1===h.indexOf("i")&&(h+="i");e&&(d="\\b"+d+"\\b");var x=this._text[0],s,w,p=0;g&&(c=r<a?r:a,x=x.substring(c,r<a?a:r),p=c);var u=RegExp(d,h);f?l=function(){var b=null;for(u.lastIndex=0;;){w=u.lastIndex;s=u.exec(x);if(w===u.lastIndex)return null;if(s){if(!(s.index+p<r)){if(!m||b)break;r=x.length+p}b={start:s.index+
p,end:u.lastIndex+p}}else break}b&&(r=b.start);return b}:(g||(u.lastIndex=r),l=function(){for(;;){w=u.lastIndex;s=u.exec(x);if(w===u.lastIndex)break;if(s)return{start:s.index+p,end:u.lastIndex+p};if(!(0!==w&&m))break}return null});b=l()}return{next:function(){var c=b;c&&(b=l());return c},hasNext:function(){return null!==b}}},getCharCount:function(){for(var a=0,f=0;f<this._text.length;f++)a+=this._text[f].length;return a},getLine:function(a,f){var e=this.getLineCount();if(!(0<=a&&a<e))return null;
...
this.getCharCount());if(!(f===e&&""===a)){for(var d=this.getLineAtOffset(f),h=this.getLineAtOffset(e),c=f,b=e-f,l=h-d,m=a.length,r=0,g=this.getLineCount(),n=0,s=0,w=0,p=[];;){-1!==n&&n<=w&&(n=a.indexOf("\r",w));-1!==s&&s<=w&&(s=a.indexOf("\n",w));if(-1===s&&-1===n)break;w=-1!==n&&-1!==s?n+1===s?s+1:(n<s?n:s)+1:-1!==n?n+1:s+1;p.push(f+w);r++}this.onChanging({type:"Changing",text:a,start:c,removedCharCount:b,addedCharCount:m,removedLineCount:l,addedLineCount:r});0===p.length&&(w=this.getLineStart(d),
...
!c[c.length-1].style||"div"!==c[c.length-1].style.tagName?c.push(r):c.splice(c.length-1,0,r);var g,k,s,u,t,h=l=0,n,w;if(a){if(k=a.modelChangedEvent)0===k.removedLineCount&&0===k.addedLineCount?(w=k.start-f,n=k.addedCharCount-k.removedCharCount):w=-1,a.modelChangedEvent=void 0;k=a.firstChild}for(f=0;f<c.length;f++){r=c[f];u=r.text;l+=u.length;g=r.style;if(k)if(t=k.firstChild.data,s=k.viewStyle,t===u&&b(g,s)){h+=t.length;k._rectsCache=void 0;g=k=k.nextSibling;continue}else for(;k;){if(-1!==w){s=l;s>=
w&&(s-=n);t=(t=k.firstChild.data)?t.length:0;if(h+t>s)break;h+=t}s=k.nextSibling;m.removeChild(k);k=s}g=this._createSpan(m,u,g,r.ignoreChars);k?m.insertBefore(g,k):m.appendChild(g);a&&(a.lineWidth=void 0)}if(a)for(q=g?g.nextSibling:null;q;)s=q.nextSibling,a.removeChild(q),q=s;else q.appendChild(m);return m},_createRanges:function(q,a,c,d,e,l){if(!(c>d)){if(q)for(var m=0;m<q.length;m++){var h=q[m];if(!(h.end<e+c)){var f=Math.max(e+c,h.start)-e;if(f>d)break;var r=Math.min(e+d,h.end)-e;if(f<=r){f=Math.max(c,
...
f+1),m.moveStart("character",f),f=new x(m.getBoundingClientRect()),h&&(f.left=l.getClientRects()[0].left);else{var k=r.data;l.removeChild(r);l.appendChild(m.createTextNode(k.substring(0,f)));var s=e.createElement(m,"span");s.appendChild(m.createTextNode(k.substring(f,f+1)));l.appendChild(s);l.appendChild(m.createTextNode(k.substring(f+1)));f=new x(s.getBoundingClientRect());l.innerHTML="";l.appendChild(r);this._createdDiv||(m=d._getSelection(),(h<=m.start&&m.start<h+g||h<=m.end&&m.end<h+g)&&d._updateDOMSelection())}e.isIE&&
...
c){var a,d,l,e;if(!b._rectsCache){a=b.getClientRects();d=Array(a.length);for(e=0;e<a.length;e++)l=d[e]=new x(a[e]),l.left-=c.left,l.top-=c.top,l.right-=c.left,l.bottom-=c.top;b._rectsCache=d}a=b._rectsCache;d=[a.length];for(e=0;e<a.length;e++)d[e]=new x(a[e]);return d},getClientRects:function(b){if(!this.view._wrapMode)return[this.getBoundingClientRect()];for(var c=this._ensureCreated(),a=[],d=c.firstChild,e,l=c.getBoundingClientRect();d;){if(!d.ignore)for(var m=this._getClientRects(d,l),c=0;c<m.length;c++){var f=
m[c],h;if(f.top!==f.bottom){var r=f.top+(f.bottom-f.top)/2;for(h=0;h<a.length&&!(e=a[h],e.top<=r&&r<e.bottom);h++);h===a.length?a.push(f):(f.left<e.left&&(e.left=f.left),f.top<e.top&&(e.top=f.top),f.right>e.right&&(e.right=f.right),f.bottom>e.bottom&&(e.bottom=f.bottom))}}d=d.nextSibling}return void 0!==b?a[b]:a},_getLineBoundingClientRect:function(b,c){var a=new x(b.getBoundingClientRect());if(!this.view._wrapMode){a.right=a.left;for(var d=b.lastChild;d&&d.ignoreChars===d.firstChild.length;)d=d.previousSibling;
...
var a=this.getClientRects();return this.getOffset(a[b].left+1,a[b].top+1)},getOffset:function(b,a){var c=this.view,d=c._model,l=this.lineIndex,m=d.getLineStart(l),f=d.getLineEnd(l);if(m===f)return m;var h=this._ensureCreated(),r=this.getBoundingClientRect(),g,k;if(c._wrapMode){g=this.getClientRects();a<g[0].top&&(a=g[0].top);for(var s=0;s<g.length&&!(k=g[s],k.top<=a&&a<k.bottom);s++);b<k.left&&(b=k.left);b>k.right&&(b=k.right-1)}else 0>b&&(b=0),b>r.right-r.left&&(b=r.right-r.left);var u=h.ownerDocument,
s=u.defaultView||u.parentWindow,t=e.isIE?s.screen.logicalXDPI/s.screen.deviceXDPI:1,n=e.isIE?s.screen.logicalYDPI/s.screen.deviceYDPI:1,s=m,w=h.firstChild;a:for(;w;){if(!w.ignore){var p=w.firstChild,h=p.length;w.ignoreChars&&(h-=w.ignoreChars);var x,z,y;g=this._getClientRects(w,r);for(var I=0;I<g.length;I++)if(k=g[I],k.left<=b&&b<k.right&&(!c._wrapMode||k.top<=a&&a<k.bottom)){var I=k.left+r.left,H;if(e.isIE||c._isRangeRects){for(var u=c._isRangeRects?u.createRange():u.body.createTextRange(),G=h,J=
-1;1<G-J;){var V=Math.floor((G+J)/2);g=J+1;k=V===h-1&&w.ignoreChars?p.length:V+1;H=0===g&&8===e.isIE;c._isRangeRects?(u.setStart(p,g),u.setEnd(p,k)):(H&&(g=1),u.moveToElementText(w),u.move("character",g),u.moveEnd("character",k-g));g=u.getClientRects();for(var X=!1,W=0;W<g.length;W++)if(k=g[W],x=(H?I:k.left)*t-r.left,y=k.right*t-r.left,z=k.top*n-r.top,k=k.bottom*n-r.top,x<=b&&b<y&&(!c._wrapMode||z<=a&&a<k)){X=!0;break}X?G=V:J=V}s+=G;g=G;k=G===h-1&&w.ignoreChars?p.length:Math.min(G+1,p.length);c._isRangeRects?
(u.setStart(p,g),u.setEnd(p,k)):(u.moveToElementText(w),u.move("character",g),u.moveEnd("character",k-g));g=u.getClientRects();c=!1;0<g.length&&(k=g[0],x=(H?I:k.left)*t-r.left,y=k.right*t-r.left,c=b>x+(y-x)/2);r=s-m;d=d.getLine(l);l=d.charCodeAt(r);55296<=l&&56319>=l&&c?r<d.length&&(l=d.charCodeAt(r+1),56320<=l&&57343>=l&&(s+=1)):56320<=l&&(57343>=l&&!c)&&0<r&&(l=d.charCodeAt(r-1),55296<=l&&56319>=l&&(s-=1));c&&s++}else{d=[];for(l=0;l<h;l++)d.push("<span>"),l===h-1?d.push(p.data.substring(l)):d.push(p.data.substring(l,
l+1)),d.push("</span>");w.innerHTML=d.join("");for(d=w.firstChild;d;){k=d.getBoundingClientRect();x=k.left-r.left;y=k.right-r.left;if(x<=b&&b<y){b>x+(y-x)/2&&s++;break}s++;d=d.nextSibling}this._createdDiv||(w.innerHTML="",w.appendChild(p),r=c._getSelection(),(s<=r.start&&r.start<s+h||s<=r.end&&r.end<s+h)&&c._updateDOMSelection())}break a}s+=h}w=w.nextSibling}return Math.min(f,Math.max(m,s))},getNextOffset:function(b,c){if("line"===c.unit){var a=this.view._model,d=a.getLineAtOffset(b);if(0<c.count)return c.count--,
...
c.unit||"wordend"===c.unit||"wordWS"===c.unit||"wordendWS"===c.unit)for(var k,s,u;0!==c.count;){if(0<c.count){if(h===e)return l;r=m.charCodeAt(h);k=a(r);s=!k&&!d(r);for(h++;h<e;){r=m.charCodeAt(h);if("wordWS"!==c.unit&&"wordendWS"!==c.unit){u=a(r);if("wordend"===c.unit){if(!u&&k)break}else if(u&&!k)break;r=!u&&!d(r)}else r=!d(r);if("wordend"===c.unit||"wordendWS"===c.unit){if(!r&&s)break}else if(r&&!s)break;s=r;k=u;h++}}else{if(0===h)return f;h--;r=m.charCodeAt(h);k=a(r);for(s=!k&&!d(r);0<h;){r=m.charCodeAt(h-
1);if("wordWS"!==c.unit&&"wordendWS"!==c.unit){u=a(r);if("wordend"===c.unit){if(u&&!k)break}else if(!u&&k)break;r=!u&&!d(r)}else r=!d(r);if("wordend"===c.unit||"wordendWS"===c.unit){if(r&&!s)break}else if(!r&&s)break;s=r;k=u;h--}}c.count-=g}else for(;0!==c.count&&0<=h+g&&h+g<=e;)h+=g,r=m.charCodeAt(h),56320<=r&&57343>=r&&0<h&&(r=m.charCodeAt(h-1),55296<=r&&56319>=r&&(h+=g)),c.count-=g;return f+h},_getNextOffset_IE:function(b,c){var a=this._ensureCreated(),d=this.view._model,l=this.lineIndex,e=0,m;
...
b=Math.min(Math.max(0,b),c.getCharCount()),c=c.getLineAtOffset(b),a=this._getLine(c),b=a.getBoundingClientRect(b);a.destroy();a=b.left;c=this._getLinePixel(c)+b.top;return{x:a,y:c}},getNextOffset:function(b,c){var a=new t(b,b,!1);this._doMove(c,a);return a.getCaret()},getOptions:function(){var b;if(0===arguments.length)b=this._defaultOptions();else if(1===arguments.length){if(b=arguments[0],"string"===typeof b)return h(this["_"+b])}else{b={};for(var c in arguments)arguments.hasOwnProperty(c)&&(b[arguments[c]]=
...
b){c.splice(a,1);b.setView(null);this._destroyRuler(b);this._update();break}},resize:function(){this._clientDiv&&this._handleResize(null)},setAction:function(b,c,a){if(b){var d=this._actions,e=d[b];e||(e=d[b]={});e.handler=c;void 0!==a&&(e.actionDescription=a)}},setKeyBinding:function(b,c){this._keyModes[0].setKeyBinding(b,c)},setCaretOffset:function(b,c,a){var d=this._model.getCharCount(),b=Math.max(0,Math.min(b,d)),b=new t(b,b,!1);this._setSelection(b,void 0===c||c,!0,a)},setHorizontalPixel:function(b){this._clientDiv&&
(b=Math.max(0,b),this._scrollView(b-this._getScroll().x,0))},setRedraw:function(b){b?0===--this._redrawCount&&this.redraw():this._redrawCount++},setModel:function(b){if(b&&b!==this._model){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",this._modelListener.onChanged);var c=this._model.getLineCount(),a=this._model.getCharCount(),d=b.getLineCount(),e=b.getCharCount(),l={type:"ModelChanging",text:b.getText(),start:0,removedCharCount:a,
addedCharCount:e,removedLineCount:c,addedLineCount:d};this.onModelChanging(l);this._model=b;l={type:"ModelChanged",start:0,removedCharCount:a,addedCharCount:e,removedLineCount:c,addedLineCount:d};this.onModelChanged(l);this._model.addEventListener("preChanging",this._modelListener.onChanging);this._model.addEventListener("postChanged",this._modelListener.onChanged);this._reset();this._update()}},setOptions:function(c){var a=this._defaultOptions(),d;for(d in c)if(c.hasOwnProperty(d)){var e=c[d];if(!b(this["_"+
d],e)){var l=a[d]?a[d].update:null;l?l.call(this,e):this["_"+d]=h(e)}}},setSelection:function(b,c,a,d){var e=b>c;if(e)var l=b,b=c,c=l;l=this._model.getCharCount();b=Math.max(0,Math.min(b,l));c=Math.max(0,Math.min(c,l));b=new t(b,c,e);this._setSelection(b,void 0===a||a,!0,d)},setText:function(b,c,a){var d=void 0===c&&void 0===a;void 0===c&&(c=0);void 0===a&&(a=this._model.getCharCount());d&&(this._variableLineHeight=!1);this._modifyContent({text:b,start:c,end:a,_code:!0},!d);d&&(this._columnX=-1,this._setSelection(new t(0,
...
(c=c.match(b),void 0!==c))return this.invokeAction(c);return!1},_doMove:function(b,c){var a=this._model,d=c.getCaret(),e=a.getLineAtOffset(d);b.count||(b.count=1);for(;0!==b.count;){var l=a.getLineStart(e);if(0>b.count&&d===l)if(0<e)"character"===b.unit&&b.count++,e--,c.extend(a.getLineEnd(e));else break;else if(0<b.count&&d===a.getLineEnd(e))if(e+1<a.getLineCount())"character"===b.unit&&b.count--,e++,c.extend(a.getLineStart(e));else break;else{var m=!1;b.expandTab&&("character"===b.unit&&0===(d-
l)%this._tabSize)&&(l=a.getText(l,d),m=!/[^ ]/.test(l));m?(c.extend(d-this._tabSize),b.count+=0>b.count?1:-1):(l=this._getLine(e),c.extend(l.getNextOffset(d,b)),l.destroy())}d=c.getCaret()}return c},_doBackspace:function(b){var c=this._getSelection();c.isEmpty()&&(b.count||(b.count=1),b.count*=-1,b.expandTab=this._expandTab,this._doMove(b,c));this._modifyContent({text:"",start:c.start,end:c.end},!0);return!0},_doCase:function(b){var c=this._getSelection();this._doMove(b,c);var a=this.getText(c.start,
c.end);this._setSelection(c,!0);switch(b.type){case "lower":a=a.toLowerCase();break;case "capitalize":a=a.replace(/(?:^|\s)\S/g,function(b){return b.toUpperCase()});break;case "reverse":b="";for(c=0;c<a.length;c++)var d=a[c],e=d.toLowerCase(),d=e!==d?e:d.toUpperCase(),b=b+d;a=b;break;default:a=a.toUpperCase()}this._doContent(a);return!0},_doContent:function(b){var c=this._getSelection();if(this._overwriteMode&&c.isEmpty()){var a=this._model,d=a.getLineAtOffset(c.end);c.end<a.getLineEnd(d)&&(a=this._getLine(d),
...
d;if(b.ctrl)c.extend(a.getCharCount()),d=function(){};else{var e=c.getCaret(),l=a.getLineAtOffset(e);if(this._wrapMode){var m=this._getLine(l),e=m.getLineIndex(e),e=e===m.getLineCount()-1?a.getLineEnd(l):m.getLineStart(e+1)-1;m.destroy()}else b.count&&0<b.count&&(l=Math.min(l+b.count-1,a.getLineCount()-1)),e=a.getLineEnd(l);c.extend(e)}b.select||c.collapse();this._setSelection(c,!0,!0,d);return!0},_doEnter:function(b){var c=this._model,a=this._getSelection();this._doContent(c.getLineDelimiter());
b&&b.noCursor&&(a.end=a.start,this._setSelection(a,!0));return!0},_doHome:function(b){var c=this._getSelection(),a=this._model,d;if(b.ctrl)c.extend(0),d=function(){};else{var e=c.getCaret(),l=a.getLineAtOffset(e);this._wrapMode?(a=this._getLine(l),e=a.getLineIndex(e),e=a.getLineStart(e),a.destroy()):e=a.getLineStart(l);c.extend(e)}b.select||c.collapse();this._setSelection(c,!0,!0,d);return!0},_doLineDown:function(b){var c=this._model,a=this._getSelection(),d=a.getCaret(),l=c.getLineAtOffset(d),m=
...
g=g.bottom-g.top,s=l.bottom-l.top,u=0,l=0>=k.bottom-k.top,k=Math.max(1,k.bottom-k.top);f>h&&(u=1);g>f&&(u=2);s>g&&(u=3);var t;0!==u&&(t={style:{}},0!==(u&1)&&(t.style.fontStyle="italic"),0!==(u&2)&&(t.style.fontWeight="bold"));h=r(a);b.removeChild(a);s=m(this._viewDiv);a=e.createElement(c,"div");a.style.position="fixed";a.style.left="-1000px";a.style.paddingLeft=s.left+"px";a.style.paddingTop=s.top+"px";a.style.paddingRight=s.right+"px";a.style.paddingBottom=s.bottom+"px";a.style.width="100px";a.style.height=
"100px";s=e.createElement(c,"div");s.style.width="100%";s.style.height="100%";a.appendChild(s);b.appendChild(a);u=a.getBoundingClientRect();f=s.getBoundingClientRect();g=0;this._singleMode||(a.style.overflow="hidden",s.style.height="200px",g=a.clientWidth,a.style.overflow="scroll",g-=a.clientWidth);b.removeChild(a);s={left:f.left-u.left,top:f.top-u.top,right:u.right-f.right,bottom:u.bottom-f.bottom};f=u=0;if(!l&&(this._wrapOffset||this._marginOffset))a=e.createElement(c,"div"),a.style.position="fixed",
a.style.left="-1000px",a.innerHTML=Array(this._wrapOffset+1).join(" "),b.appendChild(a),u=a.getBoundingClientRect(),u=Math.ceil(u.right-u.left),a.innerHTML=Array(this._marginOffset+1).join(" "),f=a.getBoundingClientRect(),f=Math.ceil(f.right-f.left),b.removeChild(a);return{lineHeight:k,largestFontStyle:t,lineTrim:h,viewPadding:s,scrollWidth:g,wrapWidth:u,marginWidth:f,invalid:l}},_cancelAnimation:function(){this._animation&&(this._animation.stop(),this._animation=null)},_clearSelection:function(b){var c=
...
m();return!0},_setDOMSelection:function(b,a,c,d,l){for(var m,f,h,r,g=0,k=b.firstChild,s,u,t=this._model.getLine(b.lineIndex).length;k;){if(!k.ignore){s=k.firstChild;u=s.length;k.ignoreChars&&(u-=k.ignoreChars);if(g+u>a||g+u>=t){m=s;f=a-g;k.ignoreChars&&(0<u&&f===u)&&(f+=k.ignoreChars);break}g+=u}k=k.nextSibling}for(var g=0,k=c.firstChild,w=this._model.getLine(c.lineIndex).length;k;){if(!k.ignore){s=k.firstChild;u=s.length;k.ignoreChars&&(u-=k.ignoreChars);if(u+g>d||g+u>=w){h=s;r=d-g;k.ignoreChars&&
(0<u&&r===u)&&(r+=k.ignoreChars);break}g+=u}k=k.nextSibling}this._setDOMFullSelection(b,a,t,c,d,w);b=this._getWindow();a=this._parent.ownerDocument;if(b.getSelection){c=b.getSelection();b=a.createRange();b.setStart(m,f);b.setEnd(h,r);if(this._hasFocus&&(c.anchorNode!==m||c.anchorOffset!==f||c.focusNode!==h||c.focusOffset!==r||c.anchorNode!==h||c.anchorOffset!==r||c.focusNode!==m||c.focusOffset!==f))this._anchorNode=m,this._anchorOffset=f,this._focusNode=h,this._focusOffset=r,this._ignoreSelect=!1,
...
f=this._clientDiv.getBoundingClientRect(),h=this._viewDiv.getBoundingClientRect(),c=h.left+m.left,r=f.right,m=h.top+m.top,g=f.bottom,h=f=0;this._clipDiv?(h=this._clipDiv.getBoundingClientRect(),f=h.left-this._clipDiv.scrollLeft):(h=this._rootDiv.getBoundingClientRect(),f=h.left);h=h.top;this._ignoreDOMSelection=!0;var k=(new s(this,b.lineIndex,b)).getBoundingClientRect(e.getLineStart(b.lineIndex)+a,!1),u=k.left,a=(new s(this,d.lineIndex,d)).getBoundingClientRect(e.getLineStart(d.lineIndex)+l,!1),
e=a.left;this._ignoreDOMSelection=!1;var t=this._selDiv1,u=Math.min(r,Math.max(c,u)),w=Math.min(g,Math.max(m,k.top)),n=r,l=Math.min(g,Math.max(m,k.bottom));t.style.left=u-f+"px";t.style.top=w-h+"px";t.style.width=Math.max(0,n-u)+"px";t.style.height=Math.max(0,l-w)+"px";b.lineIndex===d.lineIndex?(n=Math.min(e,r),t.style.width=Math.max(0,n-u)+"px"):(k=Math.min(g,Math.max(m,a.top)),e=Math.min(r,Math.max(c,e)),m=Math.min(g,Math.max(m,a.bottom)),g=this._selDiv3,g.style.left=c-f+"px",g.style.top=k-h+"px",
...
m=this._getScroll(),f=e.getCaret(),h=e.start,r=e.end,g=l.getLineAtOffset(r),k=Math.max(Math.max(h,l.getLineStart(g)),r-1),l=this._getClientWidth(),g=this._getClientHeight(),s=l/4,u=this._getBoundsAtOffset(f===h?h:k),t=u.left,w=u.right,n=u.top,p=u.bottom;b&&!e.isEmpty()&&(u=this._getBoundsAtOffset(f===r?h:k),u.top===n?f===h?w=t+Math.min(u.right-t,l):t=w-Math.min(w-u.left,l):f===h?p=n+Math.min(u.bottom-n,g):n=p-Math.min(p-u.top,g));b=0;t<m.x&&(b=Math.min(t-m.x,-s));w>m.x+l&&(b=Math.max(w-m.x-l,s));
e=0;n<m.y?e=n-m.y:p>m.y+g&&(e=p-m.y-g);d&&(0<d?0<e&&(e=Math.max(e,d)):0>e&&(e=Math.min(e,d)));if(0!==b||0!==e)return 0!==e&&"number"===typeof c&&(0>c&&(c=0),1<c&&(c=1),e+=Math.floor(0<e?c*g:-c*g)),this._scrollViewAnimated(b,e,a),g!==this._getClientHeight()||l!==this._getClientWidth()?this._showCaret():this._ensureCaretVisible=!0,!0;a&&a();return!1}},_startIME:function(){if(-1===this._imeOffset){var b=this._getSelection();b.isEmpty()||this._modifyContent({text:"",start:b.start,end:b.end},!0);this._imeOffset=
...
(this._getWindow().clearTimeout(this._updateTimer),this._updateTimer=null,b=!1);var a=this._clientDiv,c=this._viewDiv;if(a){this._metrics.invalid&&(this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1);var d=this._model,l=this._getScroll(!1),m=this._getViewPadding(),f=d.getLineCount(),h=this._getLineHeight(),r=!1,g=!1,k=!1,u=this._metrics.scrollWidth;this._wrapMode&&(a.style.width=(this._metrics.wrapWidth||this._getClientWidth())+"px");var t,w,n,p,x=0,z=0,y;if(this._lineHeight){for(;z<
f;){y=this._getLineHeight(z);if(x+y>l.y)break;x+=y;z++}t=z;w=Math.max(0,t-1);n=d=l.y-x;0<t&&(d+=this._getLineHeight(t-1))}else p=Math.max(0,l.y)/h,t=Math.floor(p),w=Math.max(0,t-1),d=Math.round((p-w)*h),n=Math.round((p-t)*h);this._topIndexY=n;p=this._rootDiv;var Q=p.clientWidth,I=p.clientHeight;if(b){h=0;this._leftDiv&&(t=this._leftDiv.getBoundingClientRect(),h=t.right-t.left);t=this._getClientWidth();p=this._getClientHeight();g=t;this._wrapMode?this._metrics.wrapWidth&&(g=this._metrics.wrapWidth):
g=Math.max(this._maxLineWidth,g);for(;z<f;)y=this._getLineHeight(z,!1),x+=y,z++;f=x}else{p=this._getClientHeight();n=Math.min(t+Math.floor((p+n)/h),f-1);var l=Math.min(n+1,f-1),H;for(y=a.firstChild;y;){H=y.lineIndex;var G=y.nextSibling;if(!(w<=H&&H<=l)||y.lineRemoved||-1===y.lineIndex)this._mouseWheelLine===y?(y.style.display="none",y.lineIndex=-1):a.removeChild(y);y=G}y=this._getLineNext();var G=c.ownerDocument,J=G.createDocumentFragment();for(H=w;H<=l;H++)!y||y.lineIndex>H?(new s(this,H)).create(J,
null):(J.firstChild&&(a.insertBefore(J,y),J=G.createDocumentFragment()),y&&y.lineChanged&&(y=(new s(this,H)).create(J,y),y.lineChanged=!1),y=this._getLineNext(y));J.firstChild&&a.insertBefore(J,y);e.isWebkit&&!this._wrapMode&&(a.style.width="0x7fffffffpx");y=this._getLineNext();H=p+d;for(J=!1;y;)w=y.lineWidth,void 0===w&&(G=y._line.getBoundingClientRect(),w=y.lineWidth=Math.ceil(G.right-G.left),G=G.bottom-G.top,this._lineHeight?this._lineHeight[y.lineIndex]=G:0!==h&&(0!==G&&Math.ceil(h)!==Math.ceil(G))&&
(this._variableLineHeight=!0,this._lineHeight=[],this._lineHeight[y.lineIndex]=G)),this._lineHeight&&!J&&(H-=this._lineHeight[y.lineIndex],0>H&&(n=y.lineIndex,J=!0)),this._wrapMode||(w>=this._maxLineWidth&&(this._maxLineWidth=w,this._maxLineIndex=y.lineIndex),this._checkMaxLineIndex===y.lineIndex&&(this._checkMaxLineIndex=-1)),y.lineIndex===t&&(this._topChild=y),y.lineIndex===n&&(this._bottomChild=y),y=this._getLineNext(y);-1!==this._checkMaxLineIndex&&(H=this._checkMaxLineIndex,this._checkMaxLineIndex=
-1,0<=H&&H<f&&(h=new s(this,H),G=h.getBoundingClientRect(),w=G.right-G.left,w>=this._maxLineWidth&&(this._maxLineWidth=w,this._maxLineIndex=H),h.destroy()));for(;z<f;)y=this._getLineHeight(z,z<=n),x+=y,z++;f=x;this._updateRuler(this._leftDiv,t,l,I);this._updateRuler(this._rightDiv,t,l,I);this._updateRuler(this._marginDiv,t,l,I);h=0;this._leftDiv&&(t=this._leftDiv.getBoundingClientRect(),h=t.right-t.left);l=0;this._rightDiv&&(l=this._rightDiv.getBoundingClientRect(),l=l.right-l.left);c.style.left=
h+"px";c.style.right=l+"px";l=this._scrollDiv;l.style.height=f+"px";t=this._getClientWidth();!this._singleMode&&!this._wrapMode&&(x=r=p,(z="scroll"===c.style.overflowX)?r+=u:x-=u,y=n=t,(w="scroll"===c.style.overflowY)?n+=u:y-=u,p=r,t=n,f>p&&(k=!0,t=y),this._maxLineWidth>t&&(g=!0,p=x,f>p&&(k=!0,t=y)),z!==g&&(c.style.overflowX=g?"scroll":"hidden"),w!==k&&(c.style.overflowY=k?"scroll":"hidden"),r=z!==g||w!==k);k=t;this._wrapMode?this._metrics.wrapWidth&&(k=this._metrics.wrapWidth):k=Math.max(this._maxLineWidth,
k);g=k;if((!e.isIE||9<=e.isIE)&&this._maxLineWidth>t)k+=m.right+m.left;l.style.width=k+"px";this._clipScrollDiv&&(this._clipScrollDiv.style.width=k+"px");l=this._getScroll(!1)}this._vScrollDiv&&(k=p-8,x=Math.max(15,Math.ceil(Math.min(1,k/(f+m.top+m.bottom))*k)),this._vScrollDiv.style.left=h+t-8+"px",this._vScrollDiv.style.top=Math.floor(Math.max(0,l.y*k/f))+"px",this._vScrollDiv.style.height=x+"px");!this._wrapMode&&this._hScrollDiv&&(k=t-8,x=Math.max(15,Math.ceil(Math.min(1,k/(this._maxLineWidth+
m.left+m.right))*k)),this._hScrollDiv.style.left=h+Math.floor(Math.max(0,Math.floor(l.x*k/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=p-9+"px",this._hScrollDiv.style.width=x+"px");z=l.x;x=this._clipDiv;k=this._overlayDiv;if(n=this._marginDiv)n.style.left=-z+h+this._metrics.marginWidth+m.left+"px",n.style.bottom=("scroll"===c.style.overflowX?u:0)+"px";x?(x.scrollLeft=z,x.scrollTop=0,c=h+m.left,u=m.top,b=t,h=p,z=0,n=-d,0===l.x&&(c-=m.left,b+=m.left,z=m.left),l.x+t===g&&(b+=m.right),0===l.y&&
(u-=m.top,h+=m.top,n+=m.top),l.y+p===f&&(h+=m.bottom),x.style.left=c+"px",x.style.top=u+"px",x.style.right=Q-b-c+"px",x.style.bottom=I-h-u+"px",a.style.left=z+"px",a.style.top=n+"px",a.style.width=g+"px",a.style.height=p+d+"px",k&&(k.style.left=a.style.left,k.style.top=a.style.top,k.style.width=a.style.width,k.style.height=a.style.height)):(c=z,u=d,Q=z+t,I=d+p,0===c&&(c-=m.left),0===u&&(u-=m.top),Q===g&&(Q+=m.right),l.y+p===f&&(I+=m.bottom),a.style.clip="rect("+u+"px,"+Q+"px,"+I+"px,"+c+"px)",a.style.left=
-z+h+m.left+"px",a.style.width=(this._wrapMode||e.isWebkit?g:t+z)+"px",b||(a.style.top=-d+m.top+"px",a.style.height=p+d+"px"),k&&(k.style.clip=a.style.clip,k.style.left=a.style.left,k.style.width=a.style.width,b||(k.style.top=a.style.top,k.style.height=a.style.height)));this._updateDOMSelection();r&&(a=this._ensureCaretVisible,this._ensureCaretVisible=!1,a&&this._showCaret(),this._queueUpdate())}}},_updateOverflow:function(){var b=this._viewDiv;this._wrapMode?(b.style.overflowX="hidden",b.style.overflowY=
"scroll"):b.style.overflow="hidden"},_updateRuler:function(b,a,c,l){if(b)for(var m=this._parent.ownerDocument,f=this._getLineHeight(),h=this._getViewPadding(),b=b.firstChild;b;){var r=b._ruler,g=f,k=r.getOverview();"page"===k&&(g+=this._topIndexY);b.style.top=-g+"px";b.style.height=l+g+"px";b.rulerChanged&&d(r.getRulerStyle(),b);var s,u=b.firstChild;u?(s=u,u=u.nextSibling):(s=e.createElement(m,"div"),s.style.visibility="hidden",b.appendChild(s));var t;if(b.rulerChanged&&s){g=-1;if(t=r.getWidestAnnotation())d(t.style,
s),t.html&&(s.innerHTML=t.html);s.lineIndex=g;s.style.height=f+h.top+"px"}var n;if("page"===k){for(r=r.getAnnotations(a,c+1);u;)g=u.lineIndex,t=u.nextSibling,(!(a<=g&&g<=c)||u.lineChanged)&&b.removeChild(u),u=t;u=b.firstChild.nextSibling;n=m.createDocumentFragment();for(g=a;g<=c;g++)if(!u||u.lineIndex>g){s=e.createElement(m,"div");if(t=r[g])d(t.style,s),t.html&&(s.innerHTML=t.html),s.annotation=t;s.lineIndex=g;s.style.height=this._getLineHeight(g)+"px";n.appendChild(s)}else n.firstChild&&(b.insertBefore(n,
u),n=m.createDocumentFragment()),u&&(u=u.nextSibling);n.firstChild&&b.insertBefore(n,u)}else{t=this._getClientHeight();g=this._model.getLineCount();u=t+h.top+h.bottom-2*this._metrics.scrollWidth;k=f*g<u?f:u/g;if(b.rulerChanged){for(t=b.childNodes.length;1<t;)b.removeChild(b.lastChild),t--;r=r.getAnnotations(0,g);n=m.createDocumentFragment();for(var w in r)g=w>>>0,0>g||(s=e.createElement(m,"div"),t=r[w],d(t.style,s),s.style.position="absolute",s.style.top=this._metrics.scrollWidth+f+Math.floor(g*k)+
"px",t.html&&(s.innerHTML=t.html),s.annotation=t,s.lineIndex=g,n.appendChild(s));b.appendChild(n)}else if(b._oldTrackHeight!==u)for(s=b.firstChild?b.firstChild.nextSibling:null;s;)s.style.top=this._metrics.scrollWidth+f+Math.floor(s.lineIndex*k)+"px",s=s.nextSibling;b._oldTrackHeight=u}b.rulerChanged=!1;b=b.nextSibling}},_updateStyleSheet:function(){var b="";e.isWebkit&&0<this._metrics.scrollWidth&&(b+="\n.textview ::-webkit-scrollbar-corner {background: #eeeeee;}");e.isFirefox&&(e.isMac&&this._highlightRGB&&
...
s=this._getWindow();k._hideTimeout=s.setTimeout(function(){k._hideTimeout=null;var b=parseFloat(k._getNodeStyle(c,"opacity","1"));k._fadeTimeout=s.setInterval(function(){"visible"===c.style.visibility&&0<b?(b-=0.1,c.style.opacity=b):k._hide()},k._fadeDelay/10)},k._autoHideDelay)}}}},_getAnnotationContents:function(d){function e(b){var a=b.title,c=f.createElement(r,"div");c.className="tooltipRow";b.html&&(c.innerHTML=b.html,c.lastChild&&k.addEventListener(c.lastChild,"click",function(){var a=b.start,
c=b.end;n.getBaseModel&&(a=n.mapOffset(a,!0),c=n.mapOffset(c,!0));t.setSelection(a,c,1/3,function(){m._hide()})},!1),c.appendChild(r.createTextNode("\u00a0")));if(!a)var d=b.end,a=s.getLineStart(s.getLineAtOffset(b.start)),d=s.getLineEnd(s.getLineAtOffset(d),!0),a=s.getText(a,d);"function"===typeof a&&(a=b.title());"string"===typeof a&&(d=f.createElement(r,"span"),d.appendChild(r.createTextNode(a)),a=d);c.appendChild(a);return c}for(var c,b=[],l=0;l<d.length;l++)c=d[l],""!==c.title&&!c.groupAnnotation&&
b.push(c);d=b;if(0===d.length)return null;var m=this,r=this._tooltipDiv.ownerDocument,t=this._view,n=t.getModel(),s=n.getBaseModel?n.getBaseModel():n;if(1===d.length){c=d[0];if(void 0!==c.title)return c=e(c),c.firstChild&&((d=c.firstChild.className)&&(d+=" "),c.firstChild.className=d+"single"),c;d=new a.ProjectionTextModel(s);b=s.getLineStart(s.getLineAtOffset(c.start));l=s.getCharCount();c.end!==l&&d.addProjection({start:c.end,end:l});0<b&&d.addProjection({start:0,end:b});return d}b=f.createElement(r,
...
d,e,s),e=b.slice(0);e.push(c.Shade);d.style=k.mixin({},d.style);d.style.style=k.mixin({},d.style.style);d.style.style.backgroundColor="rgba("+e.join()+")";d.groupId=c.Name;d.groupType=h.ANNOTATION_CURRENT_BLAME;d.createGroupAnnotation=p;d.html='<img class="annotationHTML blame" src="'+c.AuthorImage+'"/>';d.blame=c;return d})},showSelection:function(a,b,d,e,f){"number"===typeof a?("number"!==typeof b&&(b=a),this.moveSelection(a,b)):"number"===typeof d&&(a=this.getModel().getLineStart(d-1),"number"===
...
text:b.emptyGroupMessage,trigger:"click",position:["below","right","above","left"]})):(m&&p.removeNavGrid(m,g.menuButton),g.menu.parentNode&&(g.menu.remove(),g.menuButton.remove(),g.extraDropdownButton&&g.extraDropdownButton.remove()),g.destroyButton&&g.destroyButton.parentNode&&g.destroyButton.parentNode.removeChild(g.destroyButton)):g.menuButton.style.visibility="visible")}else{var s;0<a.childNodes.length&&!B._checkForTrailingSeparator(a,l)&&(s=B.generateSeparatorImage(a));B._render(g,a,c,e,l,f,
m);0<a.childNodes.length&&a.childNodes[a.childNodes.length-1]!==s&&(s=B.generateSeparatorImage(a))}else if(b.title){if(b=B._createDropdownMenu(a,b.title,!0,null,null,b.imageClass))B._render(g,b.menu,c,e,"menu",f,m),B._checkForTrailingSeparator(b.menu,"menu",!0),0===b.menu.childNodes.length&&b.destroyButton&&a.removeChild(b.destroyButton)}else 0<a.childNodes.length&&B._generateMenuSeparator(a),B._render(g,a,c,e,l,f,m),B._generateMenuSeparator(a)}else{var t=B._commandList[b.id],g=t?!0:!1;r=b=null;t&&
(h=new n.CommandInvocation(e,c,f,t,B),h.domParent=a,s=g&&(t.visibleWhen?t.visibleWhen(c):!0),B._activeBindings[t.id]&&B._activeBindings[t.id].keyBinding&&(b=B._activeBindings[t.id],b.invocation=s?h:null,b.bindingOnly&&(g=!1)),B._urlBindings[t.id]&&B._urlBindings[t.id].urlBinding&&(r=B._urlBindings[t.id],r.invocation=s?h:null,r.bindingOnly&&(g=!1)),g=g&&s);g&&(t.choiceCallback?("tool"===l||"button"===l?(b=a,g=!1,"ul"===a.nodeName.toLowerCase()&&(b=document.createElement("li"),a.appendChild(b))):(b=
a,g=!0),B._createDropdownMenu(b,t.name,g,function(b){t.populateChoicesMenu(b,c,e,f,B)}.bind(t),t.imageClass,t.tooltip||t.title,t.selectionClass,t.positioningNode)):(h.handler=h.handler||this,h.domParent=a,g=function(){B._invoke(h)},"menu"===l?(r=null,b&&b.keyBinding&&(r=k.getUserKeyString(b.keyBinding)),b=n.createCommandMenuItem(a,t,h,null,g,r)):(b=l+t.id+x,b=n.createCommandItem(a,t,h,b,null,"tool"===l,g)),p.generateNavGrid(m,b),h.domNode=b,x++))}})},_createDropdownMenu:function(a,c,l,m,h,g,k,r,p,
t){a=f.node(a);if(!a||!f.contains(document.body,a))return null;var x,D,B=a;if(l)g=document.createRange(),g.selectNode(a),g=g.createContextualFragment(b),f.processTextNodes(g,{ButtonText:c}),a.appendChild(g),D=a.lastChild,t=D.lastChild,c=t.previousSibling,c.dropdown=new e.Dropdown({dropdown:t,populate:m,parentDropdown:a.dropdown}),t.dropdown=c.dropdown;else{"ul"===a.nodeName.toLowerCase()&&(B=document.createElement("li"),a.appendChild(B),D=B);x=null;h&&(x="dropdownButtonWithIcon",g=g||c);g=h?g||c:
g;m=n.createDropdownMenu(B,c,m,x,h,!1,k,r,p||t);if(p){p.domNode=m.menuButton;var K=this;m.menuButton.onclick=function(){K._invoke(p)}}else t&&m.dropdown&&m.dropdown.addTriggerNode(m.menuButton);c=m.menuButton;t=m.menu;x=m.extraDropdownButton;g&&(c.commandTooltip=new d.Tooltip({node:c,text:p&&p.command&&p.command.name?g+": "+p.command.name:g,position:["above","below","right","left"]}),m.extraDropdownButton&&(c.extraCommandTooltip=new d.Tooltip({node:m.extraDropdownButton,text:g,position:["above","below",
"right","left"]})))}return{menuButton:c,menu:t,dropdown:c.dropdown,destroyButton:D,extraDropdownButton:x}},_generateMenuSeparator:function(b){if(!this._checkForTrailingSeparator(b,"menu")){var a=document.createElement("li");a.classList.add("dropdownSeparator");var c=document.createElement("span");c.classList.add("dropdownSeparator");a.appendChild(c);b.appendChild(a)}},generateSeparatorImage:function(b){var a;a="ul"===b.nodeName.toLowerCase()?document.createElement("li"):document.createElement("span");
b.appendChild(a);a.classList.add("core-sprite-sep");a.classList.add("imageSprite");a.classList.add("commandSeparator");return a}};l.prototype.constructor=l;m.prototype={match:function(b){b=a.matchResourceParameters(b);return"undefined"!==typeof b[this.token]?(this.parameterValue=b[this.token],this):null}};m.prototype.constructor=m;r.prototype.constructor=r;t.prototype={optionsRequested:function(){return this.optionsRequested}};t.prototype.constructor=t;x.prototype={_storeParameters:function(b){this.parameterTable=
null;if(b){var a=this.parameterTable={};b.forEach(function(b){a[b.name]=b})}},updateParameters:function(b){"function"===typeof this.getParameters&&this._storeParameters(this.getParameters(b))},hasParameters:function(){return null!==this.parameterTable},shouldCollectParameters:function(){return!this.clientCollect&&this.hasParameters()},parameterNamed:function(b){return this.parameterTable[b]},valueFor:function(b){return(b=this.parameterTable[b])?b.value:null},setValue:function(b,a){var c=this.parameterTable[b];
c&&(c.value=a)},forEach:function(b){for(var a in this.parameterTable)this.parameterTable[a].type&&this.parameterTable[a].name&&b(this.parameterTable[a])},makeCopy:function(){var b=[];this.forEach(function(a){a=new t(a.name,a.type,a.label,a.value,a.lines,a.eventListeners);b.push(a)});var a=new x(b,this._options,this.getParameters);a.clientCollect=this.clientCollect;return a},hasOptionalParameters:function(){return this._hasOptionalParameters}};x.prototype.constructor=x;return{CommandRegistry:l,URLBinding:m,
ParametersDescription:x,CommandParameter:t,CommandEventListener:r}});define("text!orion/banner/slideout.html",[],function(){return'<div id="slideContainer" class="slideParameters slideContainer">\r\n\t<span id="pageCommandParameters" class="layoutLeft parameters"></span>\r\n\t<span id="pageCommandDismiss" class="layoutRight parametersDismiss"></span>\r\n</div>'});
...
define("orion/widgets/browse/browseView","i18n!orion/edit/nls/messages orion/explorers/explorer-table orion/explorers/navigatorRenderer orion/markdownView orion/PageUtil orion/URITemplate orion/webui/littlelib orion/objects orion/Deferred orion/section".split(" "),function(g,n,p,a,k,f,e,d,h,c){function b(){t.apply(this,arguments)}function l(a){a.setFocus=!1;a.cachePrefix=null;a.rendererFactory=function(c){return new b({checkbox:!1,cachePrefix:"FolderNavigator"},c,a.commandRegistry,a.contentTypeRegistry)};
...
this.branchSelector=b.branchSelector;this.clickHandler=b.clickHandler;this._init()}var r=n.FileExplorer,t=p.NavigatorRenderer,x=new f("#{,resource,params*}");b.prototype=Object.create(t.prototype);d.mixin(b.prototype,{showFolderImage:!0,createFolderNode:function(b){var a=p.NavigatorRenderer.prototype.createFolderNode.call(this,b);this.showFolderLinks&&"A"===a.tagName&&(a.href=x.expand({resource:b.Location}));a.classList.add("folderNavFolder");a.classList.add("navlink");a.classList.add("targetSelector");
...
this.sectionContents=document.createElement("div");this.sectionContents.classList.add("browseSectionWrapper");this._foldersSection.setContent(this.sectionContents);var d=this._foldersSection.getTitleElement();d&&(e.empty(d),this.branchSelector&&(d.appendChild(this.branchSelector.node),this.branchSelector.refresh()));if(this.breadCrumbMaker){var f=document.createElement("div"),m=document.createElement("div");f.appendChild(m);this.breadCrumbInHeader?(f.classList.add("breadCrumbContainerInHeader"),d.appendChild(f),
this.breadCrumbMaker(m,this._foldersSection.getHeaderElement().offsetWidth-150-50)):(f.classList.add("breadCrumbContainer"),this.sectionContents.appendChild(f),this.breadCrumbMaker(m,this._foldersSection.getHeaderElement().offsetWidth-5))}if(this.editorView){this.sectionContents.appendChild(this.editorView.getParent());this.editorView.getParent().style.height="30px";this.editorView.create();var h=this.editorView.editor.getTextView();h.getModel().addEventListener("Changed",this._editorViewModelChangedListener=
function(){var b=h.getModel().getLineCount();this._maxEditorLines&&(0<this._maxEditorLines&&b>this._maxEditorLines)&&(b=this._maxEditorLines);b=h.getLineHeight()*b+20;this.editorView.getParent().style.height=b+"px"}.bind(this));this.editor=this.editorView.editor}else this.isMarkdownView?(g=document.createElement("div"),this.markdownView.displayContents(g,this._metadata),this.sectionContents.appendChild(g)):this.imageView||(this.folderNavExplorer=new l({parentId:b,readonly:this.readonly,breadCrumbMaker:this.breadCrumbMaker,
clickHandler:this.clickHandler,fileClient:this.fileClient,commandRegistry:this.commandRegistry,contentTypeRegistry:this.contentTypeRegistry}),this.sectionContents.appendChild(this.folderNavExplorer.parent),this.folderNavExplorer.setCommandsVisible(this._foldersSection,this._isCommandsVisible()),this.folderNavExplorer.loadRoot(this._metadata))}else"readme"===b&&a&&(g=document.createElement("div"),this.markdownView.displayInFrame(g,a,this.readmeHeaderClass),this._node.appendChild(g))}.bind(this))}).apply(this,
[["folderNav","readme"]])},updateImage:function(b){var a=document.createElement("table");a.classList.add("imageViewTable");var c=document.createElement("tr"),d=document.createElement("td"),e=document.createElement("div");e.appendChild(b);d.appendChild(e);c.appendChild(d);a.appendChild(c);this.sectionContents.appendChild(a)},create:function(){this._metadata.Projects&&this.displayWorkspaceView();this.editorView||this.imageView||this.isMarkdownView?this.displayBrowseView(this._metadata):this._metadata.Children?
this.displayBrowseView(this._metadata):this._metadata.ChildrenLocation&&this.progress.progress(this.fileClient.fetchChildren(this._metadata.ChildrenLocation),"Fetching children of "+this._metadata.Name).then(function(b){this._metadata.Children=b;this.displayBrowseView(this._metadata)}.bind(this))},destroy:function(){this.editorView&&(this.editorView.editor.getTextView().getModel().removeEventListener("Changed",this._editorViewModelChangedListener),this.editorView.destroy(),this.editor=null);this.folderNavExplorer&&
this.folderNavExplorer.destroy();this.folderNavExplorer=null;this._node&&this._node.parentNode&&this._node.parentNode.removeChild(this._node);this._node=null}};return{BrowseView:m}});
...
g,n;h<k&&(32===(n=f.charCodeAt(h))||9===n);)h++;var g=f.substring(0,h),a=a.getOptions("tabSize","expandTab"),p=a.expandTab?Array(a.tabSize+1).join(" "):"\t",a=d.getLineDelimiter(),q=/^[\s]*\/\*[\*]*[\s]*$/,v=/^[\s]*\*/,A=/\*\/[\s]*$/,F=f.substring(0,k),C=f.substring(k),M;if(this.smartIndentation&&123===f.charCodeAt(M=F.trimRight().length-1))return d=k-M-1,C=C.length-C.trimLeft().length,f=125===f.charCodeAt(k+C)?a+g+p+a+g:a+g+p,b.setText(f,c.start-d,c.end+C),b.setCaretOffset(c.start+a.length+g.length+
p.length-d),!0;if(this.autoCompleteComments&&!A.test(F)&&(q.test(F)||v.test(F))){if(h=q.exec(F)){f=a+g+" * ";f=A.test(C)?f+C.substring(0,C.length-2).trim():f+C.trim();if(d.getLineCount()===e+1||!v.test(d.getLine(e+1)))f+=a+g+" */";b.setText(f,c.start,c.end+C.length);b.setCaretOffset(c.start+a.length+g.length+3);return!0}if(h=v.exec(F))for(e-=1;0<=e;e--){h=d.getLine(e,!1);if(q.test(h))return A.test(C)||47===f.charCodeAt(k)?(f=a+g+"*"+C,g=c.start+a.length+g.length+1):(f=a+g+"* "+C,g=c.start+a.length+
g.length+2),b.setText(f,c.start,c.end+C.length),b.setCaretOffset(g),!0;if(!v.test(h))break}}else{if(A.test(F)&&32===g.charCodeAt(g.length-1))return f=a+g.substring(0,g.length-1),b.setText(f,c.start,c.end),b.setCaretOffset(c.start+f.length),!0;if(0<h){for(h=k;h<f.length&&(32===(n=f.charCodeAt(h++))||9===n);)c.end++;b.setText(d.getLineDelimiter()+g,c.start,c.end);return!0}}}return!1},addBlockComment:function(){var b=this.editor;if(b.getTextView().getOptions("readonly"))return!1;var a=b.getModel(),c=
...
d;break;case "${delimiter}":m=e;break;case "${cursor}":m="";f=h;break;default:var t=a[m];t||(t=a[m]={data:n.data,positions:[]});m=n.substitution;t.data&&t.data.values&&(m=t.data.values[0]);t.positions.push({offset:g+h,length:m.length})}k.push(m);h+=m.length}var e=[],x;for(x in a)a.hasOwnProperty(x)&&e.push(a[x]);k=k.join("");void 0===f&&(f=k.length);return{proposal:k,name:this.name,description:this.description,groups:e,escapePosition:g+f,style:"noemphasis"}},match:function(g){return 0===this.prefix.indexOf(g)},
...
this.branchChangeDispatcher.dispatchEvent({type:"branchChanged",newInput:d})}});return{BranchSelector:k}});
...
new n;b.reject(g["No Matching FileService for location:"]+a);return b}var c=a.getServiceReferences("orion.core.file"),b=c;if(d)for(var b=[],l=0;l<c.length;++l)d(c[l])&&b.push(c[l]);for(var k=[],r=[],t=[],x=[],s={fetchChildren:function(){var a=new n;a.resolve(x);return a},createWorkspace:function(){var a=new n;a.reject(g["no file service"]);return a},loadWorkspaces:function(){var a=new n;a.reject(g["no file service"]);return a},loadWorkspace:function(){var a=new n;window.setTimeout(function(){a.resolve({Directory:!0,
...
"^"+l),k[c]=RegExp(l),r[c]=a.getService(b[c]),t[c]=b[c].getProperty("Name"),b[c].getProperty("NameKey")&&b[c].getProperty("nls")&&p.getMessageBundle(b[c].getProperty("nls")).then(function(a,c){x[a].Name=c[b[a].getProperty("NameKey")];t[a]=c[b[a].getProperty("NameKey")]}.bind(this,c));this._getServiceIndex=function(a){if("/"===a)return-1;if(!a||a.length&&0===a.length)return r[0]?0:-1;for(var b=0;b<k.length;++b)if(k[b].test(a))return b;throw g["No Matching FileService for location:"]+a;};this._getService=
function(a){a=this._getServiceIndex(a);return-1===a?s:r[a]};this._getServiceName=function(a){a=this._getServiceIndex(a);return-1===a?s.Name:t[a]};this._getServiceRootURL=function(a){a=this._getServiceIndex(a);return-1===a?s.Location:x[a].Location}}f.prototype={getService:function(a){return this._getService(a)},fileServiceName:function(a){return this._getServiceName(a)},fileServiceRootURL:function(a){return this._getServiceRootURL(a)},fetchChildren:function(e){return a(this._getService(e),"fetchChildren",
...
if(!(k.result.index<h)){var n=k.result.index,p,s=[];if(k.pattern.regex){h=k.result;p=n+h[0].length;p={start:b+n,end:b+p,style:k.pattern.pattern.name};if(!f){k.pattern.pattern.captures&&t(h,k.pattern.pattern.captures,b+n,s);s.sort(function(a,b){return a.start<b.start?-1:a.start>b.start?1:0});for(n=0;n<s.length-1;n++)if(s[n+1].start<s[n].end){var y={start:s[n+1].end,end:s[n].end,style:s[n].style};s[n].end=s[n+1].start;s.splice(n+2,0,y)}}x(p,s,d)}else h=k.pattern.regexEnd,h=m(h,k.result),h=l(h,a,k.result.index+
k.result[0].length),h||(e.lastIndex=0,h=e.exec(a)),p=h.index+h[0].length,d.push({start:b+n,end:b+p,style:k.pattern.pattern.name});h=h.index+h[0].length}r(k,a,g,h)}c.forEach(function(a){a=a.regex||a.regexBegin;a.lastIndex=a.oldLastIndex})}},w=function(a,b,c,d){if(b.detectTasks()){var e=b.getAnnotationModel();if(e){var f=g.AnnotationType.ANNOTATION_TASK,h=[],l=[];d.forEach(function(a){for(var b=e.getAnnotations(a.start,a.end);b.hasNext();){var d=b.next();d.type===f&&l.push(d)}if(a.getLinePatterns().length&&
a.pattern.pattern.name&&0===a.pattern.pattern.name.indexOf("comment")){b=[];s(c.getText(a.contentStart,a.end),a.contentStart,a,b,!0);for(a=0;a<b.length;a++)"meta.annotation.task.todo"===b[a].style&&h.push(g.AnnotationType.createAnnotation(f,b[a].start,b[a].end,c.getText(b[a].start,b[a].end)))}}.bind(this));e.replaceAnnotations(l,h)}}},y=function(a,b,c,d){var f=[];c.getBlockPatterns().forEach(function(a){var c=l(a.regexBegin,b,0);c&&f.push({result:c,pattern:a})}.bind(this));f.sort(function(a,b){return a.result.index<
b.result.index?-1:a.result.index>b.result.index?1:a.pattern.pattern.index<b.pattern.pattern.index?-1:1});if(!f.length)return f;for(var g=0,h=[];0<f.length;){var k=f[0];f.splice(0,1);if(!(k.result.index<g)){var n=a.getLineAtOffset(d+k.result.index),t=a.getLine(n),y=[];s(t,a.getLineStart(n),c,y);n=d+k.result.index;for(t=0;t<y.length;t++)if(y[t].start===n){for(var g=k.result.index+k.result[0].length,x=null,O=k.pattern.regexEnd,O=m(O,k.result),E=g;!x;){E=l(O,b,E);E||(e.lastIndex=0,E=e.exec(b));var P=
[],R=new p({start:n,end:d+E.index+E[0].length,contentStart:d+g,contentEnd:d+E.index},k.pattern,c.getStyler(),a,c);s(b.substring(g,E.index+E[0].length),g,R,P);if(!P.length||P[P.length-1].end<=E.index)x=R;E=E.index+E[0].length}h.push(x);g=x.end-d;break}t===y.length&&(g=k.result.index+1)}r(k,b,f,g)}w(d,c,a,h);return h};n.prototype={getPatterns:function(a){var b=[0],c={},d=RegExp((a?"string"===typeof a?a:a.qualifiedId:this._rootId)+"#[^#]+$"),e=[];this._patterns.forEach(function(a){d.test(a.qualifiedId)&&
...
d=0===e?RegExp(a.parentId.substring(0,a.parentId.indexOf("#"))+a.include+"$"):-1===e?RegExp(a.include+"#[^#]+$"):RegExp(a.include);var f=[];this._patterns.forEach(function(a){d.test(a.qualifiedId)&&(a.include?f.push(a):c[a.id]||(a.index=b[0]++,c[a.id]=a))}.bind(this));f.forEach(function(a){this._processInclude(a,b,c)}.bind(this))},_UNNAMED:"noId"};p.prototype={adjustEnd:function(a){this.end+=a;this.contentEnd+=a;this._subBlocks.forEach(function(b){b.adjustEnd(a)})},adjustStart:function(a){this.start+=
...
if(!e)return c;d=this.pattern.regexBegin;f=a.getText(this.start,this.contentStart);g=this.start}else{e=this.pattern.pattern.endCaptures||this.pattern.pattern.captures;if(!e)return c;d=this.pattern.regexEnd;f=a.getText(this.contentEnd,this.end);g=this.contentEnd}d.lastIndex=0;if(f=d.exec(f)){d=[];t(f,e,g,d);for(e=0;e<d.length;e++)if(d[e].start<=b&&b<d[e].end)return d[e]}return c},detectTasks:function(){return this._styler._getDetectTasks()},getAnnotationModel:function(){return this._styler._getAnnotationModel()},
getBlockPatterns:function(){return this._blockPatterns},getBlocks:function(){return this._subBlocks},getEnclosurePatterns:function(){return this._enclosurePatterns},getLinePatterns:function(){return this._linePatterns},getParent:function(){return this._parent},getPatternManager:function(){return this._styler._getPatternManager()},getStyler:function(){return this._styler},isRenderingWhitespace:function(){return this._styler._isRenderingWhitespace()},_initPatterns:function(){var a=function(a){var b=
/^\(\?i\)\s*/.exec(a);b&&(a=a.substring(b[0].length));return a};this.getPatternManager().getPatterns(this.pattern?this.pattern.pattern:null).forEach(function(b){var c;if(b.match&&!b.begin&&!b.end){c="g";var d=a(b.match);d!==b.match&&(c+="i");c={regex:RegExp(d,c),pattern:b};this._linePatterns.push(c);if(b.name&&0===b.name.indexOf("punctuation.section")&&(-1!==b.name.indexOf(".begin")||-1!==b.name.indexOf(".end")))this._enclosurePatterns[b.name]=c}else if(!b.match&&b.begin&&b.end){c="g";d=a(b.begin);
d!==b.begin&&(c+="i");var e="g",f=a(b.end);f!==b.end&&(e+="i");c={regexBegin:RegExp(d,c),regexEnd:RegExp(f,e),pattern:b};this._linePatterns.push(c);this._blockPatterns.push(c)}}.bind(this))}};a.prototype={getStyles:function(a){return this._styler.getStyles(a)}};k.prototype={destroy:function(){var a=this.view;if(a){var b=a.getModel();b.getBaseModel&&(b=b.getBaseModel());b.removeEventListener("Changed",this._listener.onChanged);a.removeEventListener("MouseDown",this._listener.onMouseDown);a.removeEventListener("Selection",
this._listener.onSelection);a.removeEventListener("Destroy",this._listener.onDestroy);a.removeEventListener("LineStyle",this._listener.onLineStyle);this.view=null}},getStyleAccessor:function(){return this._accessor},getStyles:function(a){var b=[],c=this.view.getModel();c.getBaseModel&&(c=c.getBaseModel());var d=this._findBlock(this._rootBlock,a),e=c.getLineAtOffset(a),f=c.getLine(e),g=[];s(f,c.getLineStart(e),d,g);for(e=0;e<g.length&&!(a<g[e].start);e++)if(g[e].start<=a&&a<g[e].end){b.push(g[e]);
break}for(;d;)(g=d.computeStyle(c,a))&&b.splice(0,0,g),d=d.getParent();return b},setHighlightCaretLine:function(a){this.highlightCaretLine=a},setWhitespacesVisible:function(a,b){this.whitespacesVisible!==a&&(this.whitespacesVisible=a,b&&this.view.redraw())},setTabsVisible:function(a){this.tabsVisible!==a&&(this.tabsVisible=a,this.setWhitespacesVisible(this.tabsVisible||this.spacesVisible,!1),this.view.redraw())},setSpacesVisible:function(a){this.spacesVisible!==a&&(this.spacesVisible=a,this.setWhitespacesVisible(this.tabsVisible||
this.spacesVisible,!1),this.view.redraw())},setDetectHyperlinks:function(a){this.detectHyperlinks=a},setFoldingEnabled:function(a){this.foldingEnabled=a},setDetectTasks:function(a){this.detectTasks=a},_binarySearch:function(a,b,c,d,e){var f;void 0===d&&(d=-1);void 0===e&&(e=a.length);for(;1<e-d;)if(f=Math.floor((e+d)/2),b<=a[f].start)e=f;else if(c&&b<a[f].end){e=f;break}else d=f;return e},_computeFolding:function(a){if(this.foldingEnabled){var b=this.view.getModel();if(b.getBaseModel){var c=this.annotationModel;
if(c){c.removeAnnotations(g.AnnotationType.ANNOTATION_FOLDING);for(var d=[],e=b.getBaseModel(),f=0;f<a.length;f++){var h=a[f];(h=this._createFoldingAnnotation(b,e,h.start,h.end))&&d.push(h)}c.replaceAnnotations(null,d)}}}},_createFoldingAnnotation:function(a,b,c,d){var e=b.getLineAtOffset(c),b=b.getLineAtOffset(d);return e===b?null:new (g.AnnotationType.getType(g.AnnotationType.ANNOTATION_FOLDING))(c,d,a)},_findBlock:function(a,b){var c=a.getBlocks();if(!c.length)return a;var d=this._binarySearch(c,
b,!0);return d<c.length&&c[d].start<=b&&b<c[d].end?this._findBlock(c[d],b):a},_findBrackets:function(a,b,c,d,e,f){for(var g=[],h=[],l=e,k=c.getBlocks(),m=this._binarySearch(k,e,!0);m<k.length&&!(k[m].start>=f);m++){var n=k[m].start,p=k[m].end;l<n&&(s(d.substring(l-e,n-e),l,c,h),h.forEach(function(c){0===c.style.indexOf(a.pattern.name)?g.push(c.start+1):0===c.style.indexOf(b.pattern.name)&&g.push(-(c.start+1))}),h=[]);l=p}l<f&&(s(d.substring(l-e,f-e),l,c,h),h.forEach(function(c){0===c.style.indexOf(a.pattern.name)?
g.push(c.start+1):0===c.style.indexOf(b.pattern.name)&&g.push(-(c.start+1))}));return g},_findMatchingBracket:function(a,b,c){for(var d=a.getLineAtOffset(c),e=a.getLineEnd(d),f=a.getText(c,e),g,h=b.getEnclosurePatterns(),k=Object.keys(h),m=0;m<k.length;m++){var n=h[k[m]],p=l(n.regex,f,0);if(p&&0===p.index){g=n;break}}if(!g)return-1;f=!1;-1!==g.pattern.name.indexOf(".begin")?(f=!0,m=g.pattern.name.replace(".begin",".end")):m=g.pattern.name.replace(".end",".begin");h=h[m];if(!h)return-1;k=a.getLine(d);
n=a.getLineStart(d);e=this._findBrackets(g,h,b,k,n,e);for(m=0;m<e.length;m++)if(k=0<=e[m]?1:-1,e[m]*k-1===c){c=1;if(f){for(m++;m<e.length;m++)if(k=0<=e[m]?1:-1,c+=k,0===c)return e[m]*k-1;d+=1;for(m=a.getLineCount();d<m;){k=a.getLine(d);n=a.getLineStart(d);e=a.getLineEnd(d);e=this._findBrackets(g,h,b,k,n,e);for(f=0;f<e.length;f++)if(k=0<=e[f]?1:-1,c+=k,0===c)return e[f]*k-1;d++}}else{for(m--;0<=m;m--)if(k=0<=e[m]?1:-1,c+=k,0===c)return e[m]*k-1;for(d-=1;0<=d;){k=a.getLine(d);n=a.getLineStart(d);e=
a.getLineEnd(d);e=this._findBrackets(g,h,b,k,n,e);for(m=e.length-1;0<=m;m--)if(k=0<=e[m]?1:-1,c+=k,0===c)return e[m]*k-1;d--}}break}return-1},_getAnnotationModel:function(){return this.annotationModel},_getDetectTasks:function(){return this.detectTasks},_getLineStyle:function(a){if(this.highlightCaretLine){var b=this.view,c=b.getModel(),b=b.getSelection();if(b.start===b.end&&c.getLineAtOffset(b.start)===a)return f}return null},_getPatternManager:function(){return this.patternManager},_getStyles:function(a,
b,c,d){b.getBaseModel&&(d=b.mapOffset(d));for(var e=d+c.length,f=[],g=d,h=a.getBlocks(),k=this._binarySearch(h,d,!0);k<h.length&&!(h[k].start>=e);k++){var m=h[k].start,n=h[k].end;g<m&&s(c.substring(g-d,m-d),g,a,f);var p=Math.max(g,m);if(p===m){var r=l(h[k].pattern.regexBegin,c.substring(p-d),0);if(r){var y=h[k].pattern.pattern.beginCaptures||h[k].pattern.pattern.captures;y?t(r,y,p,f):f.push({start:p,end:p+r[0].length,style:h[k].pattern.pattern.name});p+=r[0].length}}var m=Math.min(e,n),w=[];if(m===
n&&(g=c.substring(m-g-(h[k].end-h[k].contentEnd)),r=l(h[k].pattern.regexEnd,g,0)))(y=h[k].pattern.pattern.endCaptures||h[k].pattern.pattern.captures)?t(r,y,m-r[0].length,w):h[k].pattern.pattern.name&&w.push({start:m-r[0].length,end:m,style:h[k].pattern.pattern.name}),m-=r[0].length;var g=this._getStyles(h[k],b,c.substring(p-d,m-d),p),x=h[k].pattern.pattern.contentName||h[k].pattern.pattern.name;if(x){var N=p;g.forEach(function(a){a.start-N&&f.push({start:N,end:a.start,style:x});f.push(a);N=a.end});
m-N&&f.push({start:N,end:m,style:x})}else f=f.concat(g);f=f.concat(w);g=n}g<e&&s(c.substring(g-d,e-d),g,a,f);if(b.getBaseModel)for(a=0;a<f.length;a++)c=f[a].end-f[a].start,f[a].start=b.mapOffset(f[a].start,!0),f[a].end=f[a].start+c;return f},_isRenderingWhitespace:function(){return this.whitespacesVisible&&(this.tabsVisible||this.spacesVisible)},_onDestroy:function(){this.destroy()},_onLineStyle:function(a){a.textView===this.view&&(a.style=this._getLineStyle(a.lineIndex));a.ranges=this._getStyles(this._rootBlock,
a.textView.getModel(),a.lineText,a.lineStart);a.ranges.forEach(function(a){a.style&&(a.style={styleClass:a.style.replace(/\./g," ")})});this._isRenderingWhitespace()&&(this.spacesVisible&&this._spliceStyles(c,a.ranges,a.lineText,a.lineStart),this.tabsVisible&&this._spliceStyles(b,a.ranges,a.lineText,a.lineStart))},_onSelection:function(a){var b=a.oldValue,c=a.newValue,d=this.view,a=d.getModel(),e;if(this.highlightCaretLine){var f=a.getLineAtOffset(b.start);e=a.getLineAtOffset(c.start);var h=c.start===
c.end,b=b.start===b.end;f===e&&b&&h||(b&&d.redrawLines(f,f+1),(f!==e||!b)&&h&&d.redrawLines(e,e+1))}if(this.annotationModel){var b=this._bracketAnnotations,l,k;if(c.start===c.end&&0<(k=d.getCaretOffset()))k-=1,a.getBaseModel&&(k=a.mapOffset(k),a=a.getBaseModel()),c=this._findBlock(this._rootBlock,k),a=this._findMatchingBracket(a,c,k),-1!==a&&(l=[g.AnnotationType.createAnnotation(g.AnnotationType.ANNOTATION_MATCHING_BRACKET,a,a+1),g.AnnotationType.createAnnotation(g.AnnotationType.ANNOTATION_CURRENT_BRACKET,
k,k+1)]);this._bracketAnnotations=l;this.annotationModel.replaceAnnotations(b,l)}},_onMouseDown:function(a){if(2===a.clickCount){var b=this.view,c=b.getModel(),d=b.getOffsetAtLocation(a.x,a.y);if(0<d){var e=d-1,f=c;c.getBaseModel&&(e=c.mapOffset(e),f=c.getBaseModel());var g=this._findBlock(this._rootBlock,e),e=this._findMatchingBracket(f,g,e);-1!==e&&(a.preventDefault(),a=e,c.getBaseModel&&(a=c.mapOffset(a,!0)),d>a&&(d--,a++),b.setSelection(a,d))}}},_onModelChanged:function(a){var b=a.start,c=a.removedCharCount,
d=a.addedCharCount-c,e=this.view,a=e.getModel(),f=a.getBaseModel?a.getBaseModel():a,c=b+c,h=f.getCharCount(),k=this._rootBlock.getBlocks(),l=k.length,m=f.getLineStart(f.getLineAtOffset(b)),n=this._binarySearch(k,m,!0),p=this._binarySearch(k,c,!1,n-1,l),r;n<l&&k[n].start<=m&&m<k[n].end?(r=k[n].start,r>b&&(r+=d)):r=n===l&&0<l&&h-d===k[l-1].end?k[l-1].start:m;var s;do p<l?(s=k[p].end,s>b&&(s+=d),p+=1):(p=l,s=h),m=f.getText(r,s),m=y(f,m,this._rootBlock,r);while(m.length&&k.length&&p<l&&m[m.length-1].pattern.pattern.id!==
k[p-1].pattern.pattern.id);for(h=n;h<k.length;h++)l=k[h],l.start>b&&l.adjustStart(d),l.start>b&&l.adjustEnd(d);var t=p-n!==m.length;if(!t)for(h=0;h<m.length;h++){var l=k[n+h],w=m[h];if(l.start!==w.start||l.end!==w.end||l.type!==w.type){t=!0;break}}h=[n,p-n].concat(m);Array.prototype.splice.apply(k,h);t&&(h=r,k=s,a!==f&&(h=a.mapOffset(h,!0),k=a.mapOffset(k,!0)),e.redrawRange(h,k));if(this.foldingEnabled&&f!==a&&this.annotationModel){e=this.annotationModel;l=e.getAnnotations(r,s);r=[];for(s=[];l.hasNext();)if(k=
l.next(),k.type===g.AnnotationType.ANNOTATION_FOLDING){s.push(k);for(h=0;h<m.length&&!(k.start===m[h].start&&k.end===m[h].end);h++);h===m.length?(r.push(k),k.expand()):(h=k.start,n=k.end,h>b&&(h-=d),n>b&&(n-=d),h<=b&&(b<n&&h<=c&&c<n)&&(h=f.getLineAtOffset(k.start),n=f.getLineAtOffset(k.end),h!==n?k.expanded||k.expand():e.removeAnnotation(k)))}b=[];for(h=0;h<m.length;h++){l=m[h];for(d=0;d<s.length&&!(s[d].start===l.start&&s[d].end===l.end);d++);d===s.length&&(k=this._createFoldingAnnotation(a,f,l.start,
l.end))&&b.push(k)}e.replaceAnnotations(r,b)}},_spliceStyles:function(a,b,c,d){for(var e=a.regex,f=e.lastIndex=0,g=e.exec(c);g;){for(g=d+g.index;f<b.length&&!(g<b[f].end);)f++;var h={start:g,end:g+1,style:a.style};if(f<b.length&&b[f].start<=g){var k={start:g+1,end:b[f].end,style:b[f].style};b[f].end=g;b.splice(f+1,0,k);b.splice(f+1,0,h);f+=2}else b.splice(f,0,h),f++;g=e.exec(c)}}};return{TextStyler:k}});
...
patterns:[{include:"orion.patterns"},{match:"\\b(?:"+n.join("|")+")\\b",name:"keyword.control.java"},{id:"string_singleQuote"}]});return{id:g[g.length-1].id,grammars:g,keywords:n}});
...
define("orion/widgets/browse/fileBrowser","orion/PageUtil orion/inputManager orion/breadcrumbs orion/widgets/browse/browseView orion/explorers/navigatorRenderer orion/widgets/browse/readonlyEditorView orion/widgets/browse/branchSelector orion/markdownView orion/commandRegistry orion/fileClient orion/contentTypes orion/widgets/browse/staticDataSource orion/widgets/browse/emptyFileClient orion/Deferred orion/URITemplate orion/objects orion/webui/littlelib".split(" "),function(g,n,p,a,k,f,e,d,h,c,b,
l,m,r,t,x,s){function w(a){this._parentDomNode=s.node(a.parent);this._parentDomNode.classList.add("browserParentDome");this._fileClient=a.fileClient?a.fileClient:a.serviceRegistry?new c.FileClient(a.serviceRegistry):new m.FileClient;this._syntaxHighlighter=a.syntaxHighlighter;this._syntaxHighlighter||(this._syntaxHighlighter=new l.SyntaxHighlighter);this._contentTypeService=a.contentTypeService;this._contentTypeService||(this._contentTypeService=new b.ContentTypeRegistry(l.ContentTypes));this._preferences=
a.preferences;this.rootName=a.rootName;this._showBranch=a.showBranch;this._breadCrumbInHeader=a.breadCrumbInHeader;this._showComponent=a.showComponent;this._init(a)}x.mixin(w.prototype,{_init:function(a){this._commandRegistry=new h.CommandRegistry({});this._maxEditorLines=a.maxEditorLines;this._inputManager=new n.InputManager({fileClient:this._fileClient,statusReporter:this._statusReport,contentTypeRegistry:this._contentTypeService});this._uriTemplate=new t("#{,resource,params*}");this._inputManager.addEventListener("InputChanged",
function(a){var b=a.metadata;if(this._branches&&this._branchSelector){var c=this._branches[0].Name;this._activeBranchLocation=this._branches[0].Location;var d=null,e=!1;b.Parents?(0<b.Parents.length?(c=b.Parents[b.Parents.length-1].Name,this._activeBranchLocation=b.Parents[b.Parents.length-1].Location):(c=b.Name,this._activeBranchLocation=b.Location),e=!0):(this._branches.some(function(a){if("master"===a.Name.toLowerCase())return c=a.Name,d=this._activeBranchLocation=a.Location,!0}.bind(this)),d=
d||this._branches[0].Location,this._activeBranchLocation=this._activeBranchLocation||this._branches[0].Location);this._branchSelector.activeBranchName=c;if(this._showComponent&&!e){this._fileClient.fetchChildren(this._activeBranchLocation).then(function(a){if(a&&0<a.length){var b=null;a.some(function(a){if(a.Directory)return b=a,!0}.bind(this));this.refresh(b.Location)}}.bind(this),function(a){console.log(a)}.bind(this));return}if(d){this.refresh(d);return}}this._breadCrumbName=a.name;this._breadCrumbTarget=
b;if(null===a.input||void 0===a.input)this._breadCrumbName=this._lastRoot?this._lastRoot.Name:"",this._breadCrumbTarget=this._lastRoot;b=this._getEditorView(a.input,b);this._setEditor(b?b.editor:null);a.editor=this._editor}.bind(this));a={parent:document.createElement("div"),syntaxHighlighter:this._syntaxHighlighter,inputManager:this._inputManager,preferences:this._preferences,statusReporter:function(a,b,c){this._statusReport(a,b,c)}.bind(this)};this._editorView=new f.ReadonlyEditorView(a);window.addEventListener("hashchange",
function(){this.refresh(g.hash())}.bind(this));if(this._showBranch){var b=document.createElement("div");b.classList.add("brSelectorContainer");a=this._fileClient.fileServiceRootURL("");this._fileClient.fetchChildren(a).then(function(a){a&&0<a.length&&(this._branches=a,this._branchSelector=new e.BranchSelector({commandRegistry:this._commandRegistry,fileClient:this._fileClient,node:b,activeBranchName:"default",branches:a}));this.refresh(g.hash())}.bind(this))}else this.refresh(g.hash())},_breadCrumbMaker:function(a,
...
_renderBreadCrumb:function(a){var b=a.breadcrumbRootName,c=a.fileClient;a.target?c&&!a.breadcrumbTarget&&(c.fileServiceName(a.target.Location),b=null):a.breadcrumbTarget||(b=b||a.task||a.name);var d=s.node(a.breadCrumbContainer);if(d){s.empty(d);var e=a.breadcrumbTarget||a.target;this._branches&&e.Parents&&(0<e.Parents.length?e.Parents[e.Parents.length-1].skip=!0:e.skip=!0);c=c&&e&&e.Location?c.fileServiceRootURL(e.Location):null;new p.BreadCrumbs({container:d,maxLength:a.maxLength,resource:e,rootSegmentName:b,
workspaceRootSegmentName:this.rootName?this.rootName:c,workspaceRootURL:this._activeBranchLocation,makeFinalHref:a.makeBreadcrumFinalLink,makeHref:a.makeBreadcrumbLink})}},_getEditorView:function(b,c){var d=null;if(c&&b){var e={parent:this._parentDomNode,maxEditorLines:this._maxEditorLines,breadCrumbInHeader:this._breadCrumbInHeader,readmeHeaderClass:"readmeHeader",metadata:c,branchSelector:this._branchSelector,commandRegistry:this._commandRegistry,contentTypeRegistry:this._contentTypeService,inputManager:this._inputManager,
fileService:this._fileClient,breadCrumbMaker:function(a,b){this._breadCrumbMaker(a,b)}.bind(this)};if(c.Directory)d=new a.BrowseView(e);else{var f=b.editor;if(!f||"orion.editor"===f){var g=this._contentTypeService.getFileContentType(c);"text/x-markdown"===g.id?e.isMarkdownView=!0:k.isImage(g)?(e.imageView={},this._fileClient.readBlob(c.Location).then(function(a){var a=URL.createObjectURL(new Blob([a],{type:g.id})),b=document.createElement("img");b.src=a;b.classList.add("readonlyImage");this._currentEditorView.updateImage(b)}.bind(this))):
e.editorView=this._editorView;d=new a.BrowseView(e)}}}this._currentEditorView!==d&&(this._currentEditorView&&this._currentEditorView.destroy(),(this._currentEditorView=d)&&this._currentEditorView.create());return this._currentEditorView},refresh:function(a){a||(a=this._fileClient.fileServiceRootURL(""));this._inputManager.setInput(a)},create:function(){},destroy:function(){}});return{FileBrowser:w}});
...
e;try{d=c.status,e=c.statusText}catch(f){d=0,e=""}return{status:d||0,statusText:e}}return c}function f(a){var c=a?JSON.parse(JSON.stringify(a,k)):a;a instanceof Error&&(c.__isError=!0,c.message=c.message||a.message,c.name=c.name||a.name);return c}function e(a,c){this.type=a;this.plugin=c}function d(a,c){this.__objectId=a;this.__methods=c}function h(a,c,h){function k(a){L&&h.postMessage(a,L)}function t(a){if(!L)return(new g).reject(Error("plugin not connected"));a.id=String(P++);var b=new g;S[a.id]=
b;b.then(null,function(b){"active"===D&&(b instanceof Error&&"Cancel"===b.name)&&k({requestId:a.id,method:"cancel",params:b.message?[b.message]:[]})});var c=Object.prototype.toString;a.params.forEach(function(e,f){if("[object Object]"===c.call(e)&&!(e instanceof d)){var g,h;for(g in e)"[object Function]"===c.call(e[g])&&(h=h||[],h.push(g));if(h){var k=R++;T[k]=e;g=function(){delete T[k]};b.then(g,g);a.params[f]=new d(k,h)}}});h.postMessage(a,L);return b.promise}function x(a,b){a||0===a?k({id:a,result:null,
error:b}):console.log(b)}function s(a,b,c,d){d.forEach(function(a,b){if(a&&"undefined"!==typeof a.__objectId){var c={};a.__methods.forEach(function(b){c[b]=function(){return t({objectId:a.__objectId,method:b,params:Array.prototype.slice.call(arguments)})}});d[b]=c}});var e=void 0===typeof a?null:{id:a,result:null,error:null};try{var g=c.apply(b,d);e&&(g&&"function"===typeof g.then?(N[a]=g,g.then(function(b){delete N[a];e.result=b;k(e)},function(b){N[a]&&(delete N[a],e.error=f(b),k(e))},function(){k({responseId:a,
method:"progress",params:Array.prototype.slice.call(arguments)})})):(e.result=g,k(e)))}catch(h){e&&(e.error=f(h),k(e))}}function w(a){try{if(a.method){var b=a.method,c=a.params||[];if("serviceId"in a){var d=Y[a.serviceId];d||x(a.id,"service not found");b in d?s(a.id,d,d[b],c):x(a.id,"method not found")}else if("objectId"in a){var e=T[a.objectId];e||x(a.id,"object not found");b in e?s(a.id,e,e[b],c):x(a.id,"method not found")}else if("requestId"in a){var f=N[a.requestId];f&&("cancel"===b&&f.cancel)&&
...
p)}}function y(c){var d=JSON.parse(JSON.stringify(c.properties));d.__plugin__=a;c=c.names||c.type||[];Array.isArray(c)||(c=[c]);d.objectClass=c;return d}function u(a){var b={};if(a.methods&&(a.methods.forEach(function(c){b[c]=function(){var b={serviceId:a.serviceId,method:c,params:Array.prototype.slice.call(arguments)};return"active"===D?t(b):q.start({"transient":!0}).then(function(){return t(b)})}}),b.addEventListener&&b.removeEventListener)){var c=new n,e=R++;T[e]={handleEvent:c.dispatchEvent.bind(c)};
var f=new d(e,["handleEvent"]),g=b.addEventListener;b.addEventListener=function(a,b){c._namedListeners[a]||g(a,f);c.addEventListener(a,b)};var k=b.removeEventListener;b.removeEventListener=function(a,b){c.removeEventListener(a,b);c._namedListeners[a]||k(a,f)}}e=y(a);e=h.registerService(a.names||a.type,b,e);E[a.serviceId]={registration:e,proxy:b}}function z(){h.persist(a,{created:v,headers:A,services:F,autostart:C,lastModified:M})}var q=this,c=c||{},v=c.created||(new Date).getTime(),A=c.headers||{},
F=c.services||[],C=c.autostart,M=c.lastModified||0,D="installed",B,K,L,O,E={},P=0,R=0,N={},S={},T={},Y={},U;this._persist=z;this._resolve=function(){D="resolved";h.dispatchEvent(new e("resolved",q))};this._getAutostart=function(){return C};this._getCreated=function(){return v};this.getLocation=function(){return a};this.getHeaders=function(){return JSON.parse(JSON.stringify(A))};this.getName=function(){var a=this.getHeaders();return a?a.name||"":null};this.getVersion=function(){var a=this.getHeaders();
return a?a.version||"0.0.0":null};this.getLastModified=function(){return M};this.getServiceReferences=function(){var a=[];Object.keys(E).forEach(function(b){a.push(E[b].registration.getReference())});return a};this.setParent=function(a){return O!==a?(O=a,q.stop({"transient":!0}).then(function(){if("started"===C)return q.start({"transient":!0});if("lazy"===C)return q.start({lazy:!0,"transient":!0})})):(new g).resolve()};this.getState=function(){return D};this.start=function(c){if("uninstalled"===D)return(new g).reject(Error("Plugin is uninstalled"));
if(B)return B.promise.then(this.start.bind(this,c));if("active"===D)return(new g).resolve();if(!c||!c.transient){var d=c&&c.lazy?"lazy":"started";d!==C&&(C=d,z())}d=h.getState();if("starting"!==d&&"active"!==d)return c.transient?(new g).reject(Error("start transient error")):(new g).resolve();if("installed"===D)try{this._resolve()}catch(f){return(new g).reject(f)}"resolved"===D&&F.forEach(function(a){u(a)});if(c&&c.lazy)return"starting"!==D&&(D="starting",h.dispatchEvent(new e("lazy activation",q))),
(new g).resolve();var k=new g;B=k;D="starting";h.dispatchEvent(new e("starting",q));K=new g;L=h.connect(a,w,O);K.then(function(){K=null;D="active";h.dispatchEvent(new e("started",q));B=null;k.resolve()},function(){K=null;D="stopping";h.dispatchEvent(new e("stopping",q));Object.keys(E).forEach(function(a){E[a].registration.unregister();delete E[a]});h.disconnect(L);L=null;D="resolved";B=null;h.dispatchEvent(new e("stopped",q));k.reject(Error("plugin activation error"))});return k.promise};this.stop=
function(a){if("uninstalled"===D)return(new g).reject(Error("Plugin is uninstalled"));if(B)return B.promise.then(this.stop.bind(this,a));if((!a||!a.transient)&&"stopped"!==C)C="stopped",z();if("active"!==D&&"starting"!==D)return(new g).resolve();B=a=new g;D="stopping";h.dispatchEvent(new e("stopping",q));Object.keys(E).forEach(function(a){E[a].registration.unregister();delete E[a]});L&&(h.disconnect(L),L=null);D="resolved";B=null;h.dispatchEvent(new e("stopped",q));a.resolve();return a.promise};U=
function(c){if("uninstalled"===D)return(new g).reject(Error("Plugin is uninstalled"));if(!c)return 0===M&&(M=(new Date).getTime(),z()),h.loadManifest(a).then(U);var d=A,f=F,k=C;A=c.headers||{};F=c.services||{};C=c.autostart||C;c.lastModified?M=c.lastModified:(M=(new Date).getTime(),z());if(p(A,d)&&p(F,f)&&C===k)return(new g).resolve();if("active"===D||"starting"===D){var l=[];Object.keys(F).forEach(function(a){var b=F[a];l.push(a);var c=E[a];if(c){if(p(b.methods,Object.keys(c.proxy))){var a=y(b),
d=c.registration.getReference(),e={};d.getPropertyKeys().forEach(function(a){e[a]=d.getProperty(a)});p(a,e)||c.registration.setProperties(a);return}c.registration.unregister();delete E[a]}u(b)});Object.keys(E).forEach(function(a){-1===l.indexOf(a)&&(E[a].registration.unregister(),delete E[a])})}"active"===D&&(h.disconnect(L),K=new g,L=h.connect(a,w,O),K.then(function(){K=null},function(){K=null;D="stopping";h.dispatchEvent(new e("stopping"),q);Object.keys(E).forEach(function(a){E[a].registration.unregister();
delete E[a]});h.disconnect(L);L=null;D="resolved";h.dispatchEvent(new e("stopped",q))}));return(new g).resolve()};this.update=function(a){return U(a).then(function(){h.dispatchEvent(new e("updated",q))})};this.uninstall=function(){if("uninstalled"===D)return(new g).reject(Error("Plugin is uninstalled"));if("active"===D||"starting"===D||"stopping"===D)return this.stop().then(this.uninstall.bind(this),this.uninstall.bind(this));h.removePlugin(this);D="uninstalled";h.dispatchEvent(new e("uninstalled",
q));return(new g).resolve()}}var c=/^http[s]?/i;return{Plugin:h,PluginRegistry:function(b,d){function f(a){var b=a.source;z.some(function(c){if(b===c.target){try{var d;if("undefined"===typeof c.useStructuredClone){var e="string"!==typeof a.data;d=e?a.data:JSON.parse(a.data);c.useStructuredClone=e}else d=c.useStructuredClone?a.data:JSON.parse(a.data);c.handler(d)}catch(f){}return!0}})}var d=d||{},k=d.storage||localStorage;if(!k.getItem){var p=k,x=null,s={key:function(a){return(x=x||Object.keys(p))[a]},
getItem:function(a){return p[a]},setItem:function(a,b){p[a]=b;x=null},removeItem:function(a){delete p[a];x=null},clear:function(){(x=x||Object.keys(p)).forEach(function(a){delete p[a]}.bind(this));x=null}};Object.defineProperty(s,"length",{get:function(){return(x=x||Object.keys(p)).length}});k=s}var w="installed",y,u=[],z=[],q=new n,v={},A={registerService:b.registerService.bind(b),connect:function(a,b,c,d){function e(a){a=Error(a);a.name="timeout";b({method:"timeout",error:a})}var f={handler:b,url:a},

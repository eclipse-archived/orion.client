...
ReadingMetadata:"Reading metadata of ${0}",Reading:"Reading ${0}",readonly:"Read Only.",saveFile:"Save this file",gotoLine:"Go to Line...",gotoLineTooltip:"Go to specified line number",gotoLinePrompt:"Go to line:",Undo:"Undo",Redo:"Redo",Find:"Find...",noResponse:"No response from server.  Check your internet connection and try again.",savingFile:"Saving file ${0}",running:"Running ${0}","Saving...":"Saving...",View:"View",Show:"Show",ShowTooltip:"Show",Actions:"Actions",Navigator:"Navigator",FolderNavigator:"Folder Navigator",
Project:"Project",New:"New",File:"File",Project:"Project",Edit:"Edit",Tools:"Tools",Add:"Add",noActions:"There are no actions for the current selection.",NoFile:"Use the ${0} to create new files and folders. Click a file to start coding.",LocalEditorSettings:"Local Editor Settings",NoProject:"${0} is not a project. To convert it to a project use ${1}.",NoProjects:"There are no projects in your workspace. Use the ${0} menu to create projects.",disconnected:"(disconnected)",ChooseFS:"Choose Filesystem",
ChooseFSTooltip:"Choose the filesystem you want to view.",FSTitle:"${0} (${1})",Deploy:"Deploy",Import:"Import",Export:"Export",OpenWith:"Open With",Extensions:"Extensions",UnnamedCommand:"Unnamed"});define("orion/edit/nls/messages",["orion/i18n!orion/edit/nls/messages","orion/edit/nls/root/messages"],function(g,n){var p={root:n};Object.keys(g).forEach(function(a){"undefined"===typeof p[a]&&(p[a]=g[a])});return p});
...
"To view the browser's context menu, trigger the context menu again.":"To view the browser's context menu, trigger the context menu again.",Edit:"Edit",CentralNavTooltip:"Toggle Side Menu"});define("orion/nls/messages",["orion/i18n!orion/nls/messages","orion/nls/root/messages"],function(g,n){var p={root:n};Object.keys(g).forEach(function(a){"undefined"===typeof p[a]&&(p[a]=g[a])});return p});
...
t),s.html&&(t.innerHTML=s.html);t.lineIndex=g;t.style.height=f+h.top+"px"}var n;if("page"===k){for(r=r.getAnnotations(a,c+1);u;)g=u.lineIndex,s=u.nextSibling,(!(a<=g&&g<=c)||u.lineChanged)&&b.removeChild(u),u=s;u=b.firstChild.nextSibling;n=m.createDocumentFragment();for(g=a;g<=c;g++)if(!u||u.lineIndex>g){t=e.createElement(m,"div");if(s=r[g])d(s.style,t),s.html&&(t.innerHTML=s.html),t.annotation=s;t.lineIndex=g;t.style.height=this._getLineHeight(g)+"px";n.appendChild(t)}else n.firstChild&&(b.insertBefore(n,
u),n=m.createDocumentFragment()),u&&(u=u.nextSibling);n.firstChild&&b.insertBefore(n,u)}else{s=this._getClientHeight();g=this._model.getLineCount();u=s+h.top+h.bottom-2*this._metrics.scrollWidth;k=f*g<u?f:u/g;if(b.rulerChanged){for(s=b.childNodes.length;1<s;)b.removeChild(b.lastChild),s--;r=r.getAnnotations(0,g);n=m.createDocumentFragment();for(var w in r)g=w>>>0,0>g||(t=e.createElement(m,"div"),s=r[w],d(s.style,t),t.style.position="absolute",t.style.top=this._metrics.scrollWidth+f+Math.floor(g*k)+
"px",s.html&&(t.innerHTML=s.html),t.annotation=s,t.lineIndex=g,n.appendChild(t));b.appendChild(n)}else if(b._oldTrackHeight!==u)for(t=b.firstChild?b.firstChild.nextSibling:null;t;)t.style.top=this._metrics.scrollWidth+f+Math.floor(t.lineIndex*k)+"px",t=t.nextSibling;b._oldTrackHeight=u}b.rulerChanged=!1;b=b.nextSibling}},_updateStyleSheet:function(){var b="";e.isWebkit&&0<this._metrics.scrollWidth&&(b+="\n.textview ::-webkit-scrollbar-corner {background: #eeeeee;}");e.isFirefox&&(e.isMac&&this._highlightRGB&&
...
function m(b){this._parent=b.parent;this._metadata=b.metadata;this.fileClient=b.fileService;this.progress=b.progressService;this.commandRegistry=b.commandRegistry;this.contentTypeRegistry=b.contentTypeRegistry;this.preferences=b.preferences;this.readonly=!0;this.readmeHeaderClass=b.readmeHeaderClass;this.editorView=b.editorView;this._maxEditorLines=b.maxEditorLines;this.imageView=b.imageView;this.breadCrumbInHeader=b.breadCrumbInHeader;this.isMarkdownView=b.isMarkdownView;this.breadCrumbMaker=b.breadCrumbMaker;
this.branchSelector=b.branchSelector;this.componentSelector=b.componentSelector;this.clickHandler=b.clickHandler;this._init()}var r=n.FileExplorer,s=p.NavigatorRenderer,x=new f("#{,resource,params*}");b.prototype=Object.create(s.prototype);d.mixin(b.prototype,{showFolderImage:!0,createFolderNode:function(b){var a=p.NavigatorRenderer.prototype.createFolderNode.call(this,b);this.showFolderLinks&&"A"===a.tagName&&(a.href=x.expand({resource:b.Location}));a.classList.add("folderNavFolder");a.classList.add("navlink");
a.classList.add("targetSelector");a.classList.remove("navlinkonpage");this.explorer.readonly&&this.explorer.clickHandler&&(a.href="javascript:void(0)",a.addEventListener("click",function(){this.explorer.clickHandler(b.Location)}.bind(this),!1));return a},updateFileNode:function(b,a,c){p.NavigatorRenderer.prototype.updateFileNode.call(this,b,a,c);this.explorer.readonly&&"A"===a.tagName&&(this.explorer.clickHandler?(a.href="javascript:void(0)",a.addEventListener("click",function(){this.explorer.clickHandler(b.Location)}.bind(this),
!1)):a.href=x.expand({resource:b.Location}))},getCellHeaderElement:function(b){if(this.explorer.breadCrumbMaker)return null;if(0===b){b=document.createElement("th");b.colSpan=1;var a=this.explorer.treeRoot;b.appendChild(document.createTextNode(a.Parents?a.Name:this.explorer.fileClient.fileServiceName(a.Location)));return b}return null},emptyCallback:function(b){this.explorer.readonly||p.NavigatorRenderer.prototype.emptyCallback.call(this,b)},getExpandImage:function(){return null}});l.prototype=Object.create(r.prototype);
d.mixin(l.prototype,{loadRoot:function(b){b?this.load(b,"Loading "+b.Name).then(this.loaded.bind(this)):this.loadResourceList(k.matchResourceParameters().resource+"?depth=1",!1).then(this.loaded.bind(this))},loaded:function(){},registerCommands:function(){return(new h).resolve()},updateCommands:function(){},setCommandsVisible:function(b,a){b.actionsNode.style.visibility=a?"":"hidden";var c=a?null:"cursorOnly";this.renderer.selectionPolicy=c;var d=this.getNavHandler();d&&d.setSelectionPolicy(c);a?
...
displayBrowseView:function(b){var b=b.Children,a;if(b)for(var d=0;d<b.length;d++){var f=b[d];!f.Directory&&(f.Name&&"readme.md"===f.Name.toLowerCase())&&(a=f)}var g;this._node||(this._node=document.createElement("div"),this._node.classList.add("browse_inner_container"));this._parent.appendChild(this._node);(function(b){b.forEach(function(b){if("folderNav"===b){b=document.createElement("div");b.id="folderNavNode";this._foldersSection=new c.Section(this._node,{id:"folderNavSection",title:"Browse",canHide:!this.readonly});
this.sectionContents=document.createElement("div");this.sectionContents.classList.add("browseSectionWrapper");this._foldersSection.setContent(this.sectionContents);var d=this._foldersSection.getTitleElement();d&&(e.empty(d),this.branchSelector&&(d.appendChild(this.branchSelector.parentNode),this.branchSelector.refresh()),this.componentSelector&&(d.appendChild(this.componentSelector.parentNode),this.componentSelector.refresh()));if(this.breadCrumbMaker){var f=document.createElement("div"),m=document.createElement("div");
f.appendChild(m);this.breadCrumbInHeader?(f.classList.add("breadCrumbContainerInHeader"),d.appendChild(f),this.breadCrumbMaker(m,this._foldersSection.getHeaderElement().offsetWidth-150-50)):(f.classList.add("breadCrumbContainer"),this.sectionContents.appendChild(f),this.breadCrumbMaker(m,this._foldersSection.getHeaderElement().offsetWidth-5))}if(this.editorView){this.sectionContents.appendChild(this.editorView.getParent());this.editorView.getParent().style.height="30px";this.editorView.create();var h=
this.editorView.editor.getTextView();h.getModel().addEventListener("Changed",this._editorViewModelChangedListener=function(){var b=h.getModel().getLineCount();this._maxEditorLines&&(0<this._maxEditorLines&&b>this._maxEditorLines)&&(b=this._maxEditorLines);b=h.getLineHeight()*b+20;this.editorView.getParent().style.height=b+"px"}.bind(this));this.editor=this.editorView.editor}else this.isMarkdownView?(g=document.createElement("div"),this.markdownView.displayContents(g,this._metadata),this.sectionContents.appendChild(g)):
this.imageView||(this.folderNavExplorer=new l({parentId:b,readonly:this.readonly,breadCrumbMaker:this.breadCrumbMaker,clickHandler:this.clickHandler,fileClient:this.fileClient,commandRegistry:this.commandRegistry,contentTypeRegistry:this.contentTypeRegistry}),this.sectionContents.appendChild(this.folderNavExplorer.parent),this.folderNavExplorer.setCommandsVisible(this._foldersSection,this._isCommandsVisible()),this.folderNavExplorer.loadRoot(this._metadata))}else"readme"===b&&a&&(g=document.createElement("div"),
this.markdownView.displayInFrame(g,a,this.readmeHeaderClass),this._node.appendChild(g))}.bind(this))}).apply(this,[["folderNav","readme"]])},updateImage:function(b){var a=document.createElement("table");a.classList.add("imageViewTable");var c=document.createElement("tr"),d=document.createElement("td"),e=document.createElement("div");e.appendChild(b);d.appendChild(e);c.appendChild(d);a.appendChild(c);this.sectionContents.appendChild(a)},create:function(){this._metadata.Projects&&this.displayWorkspaceView();
this.editorView||this.imageView||this.isMarkdownView?this.displayBrowseView(this._metadata):this._metadata.Children?this.displayBrowseView(this._metadata):this._metadata.ChildrenLocation&&this.progress.progress(this.fileClient.fetchChildren(this._metadata.ChildrenLocation),"Fetching children of "+this._metadata.Name).then(function(b){this._metadata.Children=b;this.displayBrowseView(this._metadata)}.bind(this))},destroy:function(){this.editorView&&(this.editorView.editor.getTextView().getModel().removeEventListener("Changed",
...
this.dropDownId,1)}},_switchBrMenuCallback:function(){var a=this;return this.allItems.map(function(d){return{name:d.Name,callback:a.setActiveResource.bind(a,{resource:d})}})},render:function(){this.resourceName=document.createElement("div");this.resourceName.classList.add("browserResourceSelectorName");this.resourceName.classList.add("layoutLeft");this.menu=document.createElement("ul");this.menu.classList.add("commandList");this.menu.classList.add("layoutRight");this.menu.classList.add("pageActions");
this.parentNode.appendChild(this.resourceName);this.parentNode.appendChild(this.menu);this.registerCommands();this.resourceName.addEventListener("click",this._openMenu.bind(this))},_openMenu:function(){var a=n.$(".dropdownTrigger",this.menu);if(a){var d=document.createEvent("MouseEvents");d.initEvent("click",!0,!0);a.dispatchEvent(d)}},_resourceLabel:function(){var a=document.createDocumentFragment();a.textContent=this.labelHeader+": ${0}";var d=document.createElement("b");d.textContent=this.activeResourceName;
n.processDOMNodes(a,[d]);return a},refresh:function(){n.empty(this.resourceName);this.resourceName.appendChild(this._resourceLabel());this.commandRegistry.destroy(this.menu);this.commandRegistry.renderCommands(this.commandScopeId,this.menu,{},"menu")},setActiveResource:function(a){this.activeResourceName=a.resource.Name;this.fetchChildren?a.resource.selectorAllItems?this.resourceChangeDispatcher&&this.resourceChangeDispatcher.dispatchEvent({type:"resourceChanged",newResource:a.resource,defaultChild:a.defaultChild}):
this.fileClient.fetchChildren(a.resource.Location).then(function(d){d&&0<d.length&&(a.resource.selectorAllItems=d,this.resourceChangeDispatcher&&this.resourceChangeDispatcher.dispatchEvent({type:"resourceChanged",newResource:a.resource,defaultChild:a.defaultChild}))}.bind(this),function(a){console.log(a)}.bind(this)):window.location=f.expand({resource:a.resource.Location})},getActiveResource:function(a){var d=this.allItems[0];this.allItems.some(function(f){if(f.Location===a)return d=f,!0});return d}});
return{ResourceSelector:k}});
...
new p({start:0,contentStart:0,end:e,contentEnd:e},null,this,d);this._computeFolding(this._rootBlock.getBlocks());this.detectTasks&&(e=[],y(this._rootBlock,d,e),c.replaceAnnotations([],e));b.redrawLines()}var f={styleClass:"line_caret"},e=/$/,d=/\\(\d)/g,h=/(.*)(?:[\r\n]|$)/g,c={regex:/ /g,style:{styleClass:"punctuation separator space",unmergeable:!0}},b={regex:/\t/g,style:{styleClass:"punctuation separator tab",unmergeable:!0}},l=function(a,b,c,d){var e=c,f=a.lastIndex;h.lastIndex=c;var c=h.exec(b),
g,l;a.lastIndex=0;if(c){for(l=c.index;0<=--l&&!(g=b.charAt(l),"\n"===g||"\r"===g););g=b.substring(l+1,c.index+c[1].length);a.lastIndex=l=c.index-l-1}for(;c&&c.index<b.length;){var k;if(d){var m=a.lastIndex;a.test(g)&&(a.lastIndex=m,k=a.exec(g))}else k=a.exec(g);if(k)return k.index+=e,k.index-=l,a.lastIndex=f,k;l=0;e+=c[0].length;if(c=h.exec(b))g=c[1],a.lastIndex=0}a.lastIndex=f;return null},m=function(a,b){var c=a.toString();d.lastIndex=0;if(!d.test(c))return a;d.lastIndex=0;for(var e=d.exec(c);e;)c=
c.replace(e[0],b[e[1]]||""),d.lastIndex=0,e=d.exec(c);return RegExp(c.substring(1,c.length-2),"g")},r=function(a,b,c,d){if(b=l(a.pattern.regex?a.pattern.regex:a.pattern.regexBegin,b,d,!0)){a.result=b;for(d=0;d<c.length;d++)if(b.index<c[d].result.index||b.index===c[d].result.index&&a.pattern.pattern.index<c[d].pattern.pattern.index){c.splice(d,0,a);return}c.push(a)}},s=function(a,b,c,d){if(b[0])d.push({start:c,end:c+a[0].length,style:b[0].name});else for(var e=0,f=1;f<a.length;f++)if(a[f]){var g=b[f];
...
a.Location,!0}),this.refresh(b));this._componentSelector.activeResourceName=this._componentSelector.getActiveResource(b).Name;this._componentSelector.refresh()}}.bind(this));this._init(a)}x.mixin(u.prototype,{_init:function(a){this._commandRegistry=new h.CommandRegistry({});this._maxEditorLines=a.maxEditorLines;this._inputManager=new n.InputManager({fileClient:this._fileClient,statusReporter:this._statusReport,contentTypeRegistry:this._contentTypeService});this._uriTemplate=new s("#{,resource,params*}");
this._inputManager.addEventListener("InputChanged",function(a){var b=a.metadata;if(this._branches&&this._branchSelector){var c=this._branches[0].Name;this._activeBranchLocation=this._branches[0].Location;var d=this._activeComponentLocation=null;b.Parents?0<b.Parents.length?(c=b.Parents[b.Parents.length-1].Name,this._activeBranchLocation=b.Parents[b.Parents.length-1].Location,this._activeComponentLocation=1<b.Parents.length?b.Parents[b.Parents.length-2].Location:b.Location):(c=b.Name,this._activeBranchLocation=
b.Location):(this._branches.some(function(a){if("master"===a.Name.toLowerCase())return c=a.Name,d=this._activeBranchLocation=a.Location,!0}.bind(this)),d=d||this._branches[0].Location,this._activeBranchLocation=this._activeBranchLocation||this._branches[0].Location);this._branchSelector.activeResourceName=c;if(this._showComponent){if(this._branchSelector.setActiveResource({resource:this._branchSelector.getActiveResource(this._activeBranchLocation),defaultChild:this._activeComponentLocation}),!this._activeComponentLocation)return}else if(d){this.refresh(d);
return}}this._breadCrumbName=a.name;this._breadCrumbTarget=b;if(null===a.input||void 0===a.input)this._breadCrumbName=this._lastRoot?this._lastRoot.Name:"",this._breadCrumbTarget=this._lastRoot;b=this._getEditorView(a.input,b);this._setEditor(b?b.editor:null);a.editor=this._editor}.bind(this));a={parent:document.createElement("div"),syntaxHighlighter:this._syntaxHighlighter,inputManager:this._inputManager,preferences:this._preferences,statusReporter:function(a,b,c){this._statusReport(a,b,c)}.bind(this)};
this._editorView=new f.ReadonlyEditorView(a);window.addEventListener("hashchange",function(){this.refresh(g.hash())}.bind(this));if(this._showBranch){var b=document.createElement("div");b.classList.add("resourceSelectorContainer");a=this._fileClient.fileServiceRootURL("");this._fileClient.fetchChildren(a).then(function(a){if(a&&0<a.length&&(this._branches=a,this._branchSelector=new e.ResourceSelector({commandRegistry:this._commandRegistry,fileClient:this._fileClient,parentNode:b,labelHeader:this._showComponent?
"stream":"branch",resourceChangeDispatcher:this._showComponent?this._resourceChangeHandler:null,fetchChildren:this._showComponent?!0:!1,commandScopeId:"orion.browse.brSelector",dropDownId:"orion.browse.switchbr",dropDownTooltip:this._showComponent?"Select a stream":"Select a branch",activeResourceName:"default",allItems:a}),this._showComponent)){var c=document.createElement("div");c.classList.add("resourceSelectorContainer");c.classList.add("componentSelectorContainer");this._componentSelector=new e.ResourceSelector({commandRegistry:this._commandRegistry,
fileClient:this._fileClient,parentNode:c,labelHeader:"component",commandScopeId:"orion.browse.compSelector",dropDownId:"orion.browse.switchcomp",dropDownTooltip:"Select a componet",activeResourceName:"default",allItems:a})}this.refresh(g.hash())}.bind(this))}else this.refresh(g.hash())},_breadCrumbMaker:function(a,b){this._renderBreadCrumb({task:"Browse",name:this._breadCrumbName,target:this._breadCrumbTarget,breadCrumbContainer:a,makeBreadcrumbLink:function(a,b,c){this._makeBreadCrumbLink(a,b,c)}.bind(this),
...
var d=w.node(a.breadCrumbContainer);if(d){w.empty(d);var e=a.breadcrumbTarget||a.target;this._componentSelector?e.Parents&&(1===e.Parents.length?(e.Parents[e.Parents.length-1].skip=!0,e.skip=!0):1<e.Parents.length&&(e.Parents[e.Parents.length-1].skip=!0,e.Parents[e.Parents.length-2].skip=!0)):this._branchSelector&&e.Parents&&(0<e.Parents.length?e.Parents[e.Parents.length-1].skip=!0:e.skip=!0);c=c&&e&&e.Location?c.fileServiceRootURL(e.Location):null;new p.BreadCrumbs({container:d,maxLength:a.maxLength,
resource:e,rootSegmentName:b,workspaceRootSegmentName:this.rootName?this.rootName:c,workspaceRootURL:this._calculateRootURL(c),makeFinalHref:a.makeBreadcrumFinalLink,makeHref:a.makeBreadcrumbLink})}},_calculateRootURL:function(a){return this._activeComponentLocation?this._activeComponentLocation:this._activeBranchLocation?this._activeBranchLocation:a},_getEditorView:function(b,c){var d=null;if(c&&b){d={parent:this._parentDomNode,maxEditorLines:this._maxEditorLines,breadCrumbInHeader:this._breadCrumbInHeader,
readmeHeaderClass:"readmeHeader",metadata:c,branchSelector:this._branchSelector,componentSelector:this._componentSelector,commandRegistry:this._commandRegistry,contentTypeRegistry:this._contentTypeService,inputManager:this._inputManager,fileService:this._fileClient,breadCrumbMaker:function(a,b){this._breadCrumbMaker(a,b)}.bind(this)};if(!c.Directory){var e=this._contentTypeService.getFileContentType(c);"text/x-markdown"===e.id?d.isMarkdownView=!0:k.isImage(e)?(d.imageView={},this._fileClient.readBlob(c.Location).then(function(a){var a=
URL.createObjectURL(new Blob([a],{type:e.id})),b=document.createElement("img");b.src=a;b.classList.add("readonlyImage");this._currentEditorView.updateImage(b)}.bind(this))):d.editorView=this._editorView}d=new a.BrowseView(d)}this._currentEditorView!==d&&(this._currentEditorView&&this._currentEditorView.destroy(),(this._currentEditorView=d)&&this._currentEditorView.create());return this._currentEditorView},refresh:function(a){a||(a=this._fileClient.fileServiceRootURL(""));this._inputManager.setInput(a)},
create:function(){},destroy:function(){}});return{FileBrowser:u}});
...
define("browse/builder/browse",["orion/widgets/browse/fileBrowser","orion/serviceregistry","orion/pluginregistry","orion/URL-shim"],function(g,n,p){function a(a){"string"===typeof a?(a={parentId:arguments[0],repo:arguments[1]},2<arguments.length&&(a.base=arguments[2])):a=a||{};var f,e=new URL(a.repo||window.location.href);f=e.href;var d=a.base,h=!1;if(!a.rootName){var c=f.match(/\/([^/]+)\/([^/]+)$/);c&&(a.rootName=decodeURIComponent(c[1])+" / "+decodeURIComponent(c[2]),a.rootName.match(/\.git$/)&&
(a.rootName=a.rootName.substring(0,a.rootName.length-4)))}if("github.com"===e.host)f=new URL("../../plugins/GitHubFilePlugin.html?repo="+e.href,_browser_script_source);else if(0===e.pathname.indexOf("/git/"))f=new URL("/gerrit/plugins/gerritFilesystem/static/plugins/GerritFilePlugin.html",e),f.query.set("project",e.pathname.substring(5));else if(0===e.pathname.indexOf("/ccm"))d||(e=e.pathname.match(/^\/ccm[^/]*/),d=(new URL(e,f)).href),f=new URL(d+"/service/com.ibm.team.filesystem.service.jazzhub.IOrionFilesystem/sr/pluginOrionWs.html?"+
f),h=!0;else if(0===e.pathname.indexOf("/project/"))d||(d=(new URL("/ccm01",f)).href),f=new URL(d+"/service/com.ibm.team.filesystem.service.jazzhub.IOrionFilesystem/sr/pluginOrionWs.html?"+f),h=!0;else throw"Bad Repo URL - "+f;var b=new n.ServiceRegistry,e={};e[f.href]=!0;(new p.PluginRegistry(b,{storage:{},plugins:e})).start().then(function(){this._fileBrowser=new g.FileBrowser({parent:a.parentId,showBranch:!0,showComponent:h,rootName:a.rootName,maxEditorLines:300,serviceRegistry:b})}.bind(this))}

...
e,!0);m<l.length&&!(l[m].start>=f);m++){var n=l[m].start,p=l[m].end;k<n&&(v(d.substring(k-e,n-e),k,c,h),h.forEach(function(c){0===c.style.indexOf(a.pattern.name)?g.push(c.start+1):0===c.style.indexOf(b.pattern.name)&&g.push(-(c.start+1))}),h=[]);k=p}k<f&&(v(d.substring(k-e,f-e),k,c,h),h.forEach(function(c){0===c.style.indexOf(a.pattern.name)?g.push(c.start+1):0===c.style.indexOf(b.pattern.name)&&g.push(-(c.start+1))}));return g},_findMatchingBracket:function(a,b,c){for(var d=a.getLineAtOffset(c),
...
define("orion/editor/stylers/text_html/syntax",["orion/editor/stylers/shared/syntax","orion/editor/stylers/application_javascript/syntax","orion/editor/stylers/text_css/syntax","orion/editor/stylers/text_x-php/syntax"],function(g,n,p,b){g=g.grammars.concat(n.grammars).concat(p.grammars).concat(b.grammars);g.push({id:"orion.html",contentTypes:["text/html"],patterns:[{begin:"(<!(?:doctype|DOCTYPE))",end:"(>)",captures:{1:{name:"entity.name.tag.doctype.html"}},name:"meta.tag.doctype.html"},{begin:"(?i)(<style)([^>]*)(>)",
...
define("orion/widgets/browse/staticDataSource","orion/Deferred orion/editor/textStyler orion/editor/stylers/application_javascript/syntax orion/editor/stylers/text_css/syntax orion/editor/stylers/text_html/syntax orion/editor/stylers/text_x-java-source/syntax orion/editor/stylers/application_json/syntax orion/editor/stylers/text_x-php/syntax orion/editor/stylers/text_x-python/syntax orion/editor/stylers/text_x-ruby/syntax".split(" "),function(g,n,p,b,l,f,e,d,h,c){function a(){this.styler=null}a.prototype=
{setup:function(a,b,c){this.styler&&(this.styler.destroy&&this.styler.destroy(),this.styler=null);return this.highlight(a,b,c)},highlight:function(a,f,r){this.styler&&(this.styler.destroy(),this.styler=null);if(a)switch(a.id){case "application/javascript":this.styler=new n.TextStyler(f,r,p.grammars,"orion.js");break;case "text/css":this.styler=new n.TextStyler(f,r,b.grammars,"orion.css");break;case "text/html":this.styler=new n.TextStyler(f,r,l.grammars,"orion.html");break;case "text/x-java-source":this.styler=
...
SyntaxHighlighter:a}});
define("orion/widgets/browse/readonlyFileClient",["i18n!orion/navigate/nls/messages","orion/Deferred","orion/i18nUtil"],function(g,n,p){function b(b){function e(a){return function(){var c;try{var e=b[a].apply(b,Array.prototype.slice.call(arguments));if(e&&"function"===typeof e.then)return e;c=new n;c.resolve(e)}catch(f){c=new n,c.reject(f)}return c.promise}}for(var c in b)"function"===typeof b[c]&&(this[c]=e(c))}function l(b,e,c,a){this._properties=c||{};this._properties["service.id"]=b;this._properties.objectClass=
e;this._properties["service.names"]=e;this.service=a}function f(b,e,c){if(!b[e])throw e+g[" is not supported in this file system"];return b[e].apply(b,c)}function e(d,e){function c(a){var b=new n;b.reject(g["No Matching FileService for location:"]+a);return b}var a=[];d.forEach(function(c){var d=new b(c.impl);a.push(new l(c.id,"readonly.file.service",c.serviceProperties,d))});var f=a;if(e)for(var f=[],m=0;m<a.length;++m)e(a[m])&&f.push(a[m]);for(var r=[],w=[],v=[],t=[],y={fetchChildren:function(){var a=
...
{Directory:!0,Length:0,LocalTimeStamp:0,Location:f[m].getProperty("top"),ChildrenLocation:f[m].getProperty("top"),Name:f[m].getProperty("Name")};var s=f[m].getProperty("pattern")||".*";"^"!==s[0]&&(s="^"+s);r[m]=RegExp(s);w[m]=f[m].service;v[m]=f[m].getProperty("Name");f[m].getProperty("NameKey")&&f[m].getProperty("nls")&&p.getMessageBundle(f[m].getProperty("nls")).then(function(a,b){t[a].Name=b[f[a].getProperty("NameKey")];v[a]=b[f[a].getProperty("NameKey")]}.bind(this,m))}this._getServiceIndex=
function(a){if("/"===a)return-1;if(!a||a.length&&0===a.length)return w[0]?0:-1;for(var b=0;b<r.length;++b)if(r[b].test(a))return b;throw g["No Matching FileService for location:"]+a;};this._getService=function(a){a=this._getServiceIndex(a);return-1===a?y:w[a]};this._getServiceName=function(a){a=this._getServiceIndex(a);return-1===a?y.Name:v[a]};this._getServiceRootURL=function(a){a=this._getServiceIndex(a);return-1===a?y.Location:t[a].Location}}l.prototype={getPropertyKeys:function(){var b=[],e;for(e in this._properties)this._properties.hasOwnProperty(e)&&
b.push(e);return b},getProperty:function(b){return this._properties[b]}};l.prototype.constructor=l;e.prototype={getService:function(b){return this._getService(b)},fileServiceName:function(b){return this._getServiceName(b)},fileServiceRootURL:function(b){return this._getServiceRootURL(b)},fetchChildren:function(b){return f(this._getService(b),"fetchChildren",arguments)},loadWorkspaces:function(){return f(this._getService(),"loadWorkspaces",arguments)},read:function(b,e){return f(this._getService(b),
"read",arguments)},loadWorkspace:function(b){return f(this._getService(b),"loadWorkspace",arguments)}};e.prototype.constructor=e;return{FileClient:e}});
...
n,p,b,l,f,e,d,h,c,a,k,m,r,w,v,t,y){function s(b){this._parentDomNode=y.node(b.parent);this._parentDomNode.classList.add("browserParentDome");this._fileClient=b.fileClient;this._repoURL=b.repoURL;b.serviceRegistry?this._fileClient=new c.FileClient(b.serviceRegistry):!this._fileClient&&b.serviceRefs&&(this._fileClient=new m.FileClient(b.serviceRefs));this._fileClient||(this._fileClient=new r.FileClient);this._syntaxHighlighter=b.syntaxHighlighter;this._syntaxHighlighter||(this._syntaxHighlighter=new k.SyntaxHighlighter);
this._contentTypeService=b.contentTypeService;this._contentTypeService||(this._contentTypeService=new a.ContentTypeRegistry(k.ContentTypes));this._preferences=b.preferences;this.rootName=b.rootName;this._showBranch=b.showBranch;this._showComponent=b.showComponent;this._init(b)}t.mixin(s.prototype,{_init:function(a){this._commandRegistry=new h.CommandRegistry({});this._maxEditorLines=a.maxEditorLines;this._inputManager=new n.InputManager({fileClient:this._fileClient,statusReporter:this._statusReport,
contentTypeRegistry:this._contentTypeService});this._uriTemplate=new v("#{,resource,params*}");this._inputManager.addEventListener("InputChanged",function(a){var b=a.metadata;if(this._branches&&this._branchSelector){var c=this._branches[0].Name;this._activeBranchLocation=this._branches[0].Location;var d=null,e=!1;b.Parents?(0<b.Parents.length?(c=b.Parents[b.Parents.length-1].Name,this._activeBranchLocation=b.Parents[b.Parents.length-1].Location):(c=b.Name,this._activeBranchLocation=b.Location),e=
...
[];var e=[];this._entries.forEach(function(b){b&&e.push(b.reference)});return e},registerService:function(d,e,c){if("undefined"===typeof e||null===e)throw Error("invalid service");"string"===typeof d?d=[d]:Array.isArray(d)||(d=[]);var a=this._entries.length,g=new p(a,d,c),m=this._namedReferences;d.forEach(function(a){m[a]=m[a]||[];m[a].push(g)});d=new l(e,this._internalRegistry.isRegistered.bind(null,a));this._entries.push({reference:g,service:d});d=this._internalRegistry;this._serviceEventTarget.dispatchEvent(new f("registered",
g));return new b(a,g,d)},addEventListener:function(b,e){this._serviceEventTarget.addEventListener(b,e)},removeEventListener:function(b,e){this._serviceEventTarget.removeEventListener(b,e)}};e.prototype.constructor=e;return{ServiceRegistry:e}});
define("orion/pluginregistry",["orion/Deferred","orion/EventTarget","orion/URL-shim"],function(g,n){function p(a,b){var c=Object.keys(a),d=Object.keys(b);if(c.length!==d.length)return!1;c.sort();d.sort();for(var e=0,f=c.length;e<f;e++){var g=c[e];if(g!==d[e])return!1;var h=a[g],g=b[g];if(h!==g&&JSON.stringify(h)!==JSON.stringify(g))return!1}return!0}function b(a){if(-1===a.indexOf("://"))try{return(new URL(a,location.href)).href}catch(b){}return a}function l(a,b){if(b&&b instanceof XMLHttpRequest){var c,
d;try{c=b.status,d=b.statusText}catch(e){c=0,d=""}return{status:c||0,statusText:d}}return b}function f(a){var b=a?JSON.parse(JSON.stringify(a,l)):a;a instanceof Error&&(b.__isError=!0,b.message=b.message||a.message,b.name=b.name||a.name);return b}function e(a,b){this.type=a;this.plugin=b}function d(a,b){this.__objectId=a;this.__methods=b}function h(a,b,c){function h(a){H&&c.postMessage(a,H)}function l(a){if(!H)return(new g).reject(Error("plugin not connected"));a.id=String(O++);var b=new g;S[a.id]=
b;b.then(null,function(b){"active"===E&&(b instanceof Error&&"Cancel"===b.name)&&h({requestId:a.id,method:"cancel",params:b.message?[b.message]:[]})});var e=Object.prototype.toString;a.params.forEach(function(c,f){if("[object Object]"===e.call(c)&&!(c instanceof d)){var g,h;for(g in c)"[object Function]"===e.call(c[g])&&(h=h||[],h.push(g));if(h){var k=P++;T[k]=c;g=function(){delete T[k]};b.then(g,g);a.params[f]=new d(k,h)}}});c.postMessage(a,H);return b.promise}function v(a,b){a||0===a?h({id:a,result:null,
error:b}):console.log(b)}function t(a,b,c,d){d.forEach(function(a,b){if(a&&"undefined"!==typeof a.__objectId){var c={};a.__methods.forEach(function(b){c[b]=function(){return l({objectId:a.__objectId,method:b,params:Array.prototype.slice.call(arguments)})}});d[b]=c}});var e=void 0===typeof a?null:{id:a,result:null,error:null};try{var g=c.apply(b,d);e&&(g&&"function"===typeof g.then?(R[a]=g,g.then(function(b){delete R[a];e.result=b;h(e)},function(b){R[a]&&(delete R[a],e.error=f(b),h(e))},function(){h({responseId:a,
method:"progress",params:Array.prototype.slice.call(arguments)})})):(e.result=g,h(e)))}catch(k){e&&(e.error=f(k),h(e))}}function y(a){try{if(a.method){var b=a.method,d=a.params||[];if("serviceId"in a){var e=Y[a.serviceId];e||v(a.id,"service not found");b in e?t(a.id,e,e[b],d):v(a.id,"method not found")}else if("objectId"in a){var f=T[a.objectId];f||v(a.id,"object not found");b in f?t(a.id,f,f[b],d):v(a.id,"method not found")}else if("requestId"in a){var g=R[a.requestId];g&&("cancel"===b&&g.cancel)&&
g.cancel.apply(g,d)}else if("responseId"in a){var h=S[a.responseId];h&&("progress"===b&&h.progress)&&h.progress.apply(h,d)}else if("plugin"===a.method){var k=a.params[0];U({headers:k.headers,services:k.services}).then(function(){I&&I.resolve(q)})}else if("timeout"===a.method)I&&I.reject(a.error);else throw Error("Bad method: "+a.method);}else{var l=S[String(a.id)];delete S[String(a.id)];if(a.error){var n=c.handleServiceError(q,a.error);l.reject(n)}else l.resolve(a.result)}}catch(p){console.log("Plugin._messageHandler "+
p)}}function s(b){var c=JSON.parse(JSON.stringify(b.properties));c.__plugin__=a;b=b.names||b.type||[];Array.isArray(b)||(b=[b]);c.objectClass=b;return c}function u(a){var b={};if(a.methods&&(a.methods.forEach(function(c){b[c]=function(){var b={serviceId:a.serviceId,method:c,params:Array.prototype.slice.call(arguments)};return"active"===E?l(b):q.start({"transient":!0}).then(function(){return l(b)})}}),b.addEventListener&&b.removeEventListener)){var e=new n,f=P++;T[f]={handleEvent:e.dispatchEvent.bind(e)};
var g=new d(f,["handleEvent"]),h=b.addEventListener;b.addEventListener=function(a,b){e._namedListeners[a]||h(a,g);e.addEventListener(a,b)};var k=b.removeEventListener;b.removeEventListener=function(a,b){e.removeEventListener(a,b);e._namedListeners[a]||k(a,g)}}f=s(a);f=c.registerService(a.names||a.type,b,f);D[a.serviceId]={registration:f,proxy:b}}function z(){c.persist(a,{created:x,headers:A,services:B,autostart:C,lastModified:M})}var q=this,b=b||{},x=b.created||(new Date).getTime(),A=b.headers||{},
B=b.services||[],C=b.autostart,M=b.lastModified||0,E="installed",N,I,H,J,D={},O=0,P=0,R={},S={},T={},Y={},U;this._persist=z;this._resolve=function(){E="resolved";c.dispatchEvent(new e("resolved",q))};this._getAutostart=function(){return C};this._getCreated=function(){return x};this.getLocation=function(){return a};this.getHeaders=function(){return JSON.parse(JSON.stringify(A))};this.getName=function(){var a=this.getHeaders();return a?a.name||"":null};this.getVersion=function(){var a=this.getHeaders();
return a?a.version||"0.0.0":null};this.getLastModified=function(){return M};this.getServiceReferences=function(){var a=[];Object.keys(D).forEach(function(b){a.push(D[b].registration.getReference())});return a};this.setParent=function(a){return J!==a?(J=a,q.stop({"transient":!0}).then(function(){if("started"===C)return q.start({"transient":!0});if("lazy"===C)return q.start({lazy:!0,"transient":!0})})):(new g).resolve()};this.getState=function(){return E};this.start=function(b){if("uninstalled"===E)return(new g).reject(Error("Plugin is uninstalled"));
if(N)return N.promise.then(this.start.bind(this,b));if("active"===E)return(new g).resolve();if(!b||!b.transient){var d=b&&b.lazy?"lazy":"started";d!==C&&(C=d,z())}d=c.getState();if("starting"!==d&&"active"!==d)return b.transient?(new g).reject(Error("start transient error")):(new g).resolve();if("installed"===E)try{this._resolve()}catch(f){return(new g).reject(f)}"resolved"===E&&B.forEach(function(a){u(a)});if(b&&b.lazy)return"starting"!==E&&(E="starting",c.dispatchEvent(new e("lazy activation",q))),
(new g).resolve();var h=new g;N=h;E="starting";c.dispatchEvent(new e("starting",q));I=new g;H=c.connect(a,y,J);I.then(function(){I=null;E="active";c.dispatchEvent(new e("started",q));N=null;h.resolve()},function(){I=null;E="stopping";c.dispatchEvent(new e("stopping",q));Object.keys(D).forEach(function(a){D[a].registration.unregister();delete D[a]});c.disconnect(H);H=null;E="resolved";N=null;c.dispatchEvent(new e("stopped",q));h.reject(Error("plugin activation error"))});return h.promise};this.stop=
function(a){if("uninstalled"===E)return(new g).reject(Error("Plugin is uninstalled"));if(N)return N.promise.then(this.stop.bind(this,a));if((!a||!a.transient)&&"stopped"!==C)C="stopped",z();if("active"!==E&&"starting"!==E)return(new g).resolve();N=a=new g;E="stopping";c.dispatchEvent(new e("stopping",q));Object.keys(D).forEach(function(a){D[a].registration.unregister();delete D[a]});H&&(c.disconnect(H),H=null);E="resolved";N=null;c.dispatchEvent(new e("stopped",q));a.resolve();return a.promise};U=
function(b){if("uninstalled"===E)return(new g).reject(Error("Plugin is uninstalled"));if(!b)return 0===M&&(M=(new Date).getTime(),z()),c.loadManifest(a).then(U);var d=A,f=B,h=C;A=b.headers||{};B=b.services||{};C=b.autostart||C;b.lastModified?M=b.lastModified:(M=(new Date).getTime(),z());if(p(A,d)&&p(B,f)&&C===h)return(new g).resolve();if("active"===E||"starting"===E){var k=[];Object.keys(B).forEach(function(a){var b=B[a];k.push(a);var c=D[a];if(c){if(p(b.methods,Object.keys(c.proxy))){var a=s(b),
d=c.registration.getReference(),e={};d.getPropertyKeys().forEach(function(a){e[a]=d.getProperty(a)});p(a,e)||c.registration.setProperties(a);return}c.registration.unregister();delete D[a]}u(b)});Object.keys(D).forEach(function(a){-1===k.indexOf(a)&&(D[a].registration.unregister(),delete D[a])})}"active"===E&&(c.disconnect(H),I=new g,H=c.connect(a,y,J),I.then(function(){I=null},function(){I=null;E="stopping";c.dispatchEvent(new e("stopping"),q);Object.keys(D).forEach(function(a){D[a].registration.unregister();
delete D[a]});c.disconnect(H);H=null;E="resolved";c.dispatchEvent(new e("stopped",q))}));return(new g).resolve()};this.update=function(a){return U(a).then(function(){c.dispatchEvent(new e("updated",q))})};this.uninstall=function(){if("uninstalled"===E)return(new g).reject(Error("Plugin is uninstalled"));if("active"===E||"starting"===E||"stopping"===E)return this.stop().then(this.uninstall.bind(this),this.uninstall.bind(this));c.removePlugin(this);E="uninstalled";c.dispatchEvent(new e("uninstalled",
q));return(new g).resolve()}}var c=/^http[s]?/i;return{Plugin:h,PluginRegistry:function(a,d){function f(a){var b=a.source;z.some(function(c){if(b===c.target){try{var d;if("undefined"===typeof c.useStructuredClone){var e="string"!==typeof a.data;d=e?a.data:JSON.parse(a.data);c.useStructuredClone=e}else d=c.useStructuredClone?a.data:JSON.parse(a.data);c.handler(d)}catch(f){}return!0}})}var d=d||{},l=d.storage||localStorage;if(!l.getItem){var p=l,v=null,t={key:function(a){return(v=v||Object.keys(p))[a]},
getItem:function(a){return p[a]},setItem:function(a,b){p[a]=b;v=null},removeItem:function(a){delete p[a];v=null},clear:function(){(v=v||Object.keys(p)).forEach(function(a){delete p[a]}.bind(this));v=null}};Object.defineProperty(t,"length",{get:function(){return(v=v||Object.keys(p)).length}});l=t}var y="installed",s,u=[],z=[],q=new n,x={},A={registerService:a.registerService.bind(a),connect:function(a,b,c,d){function e(a){a=Error(a);a.name="timeout";b({method:"timeout",error:a})}var f={handler:b,url:a},
...
this.getName=function(){return"System"};this.getVersion=function(){return"0.0.0"};this.getLastModified=function(){return 0};this.getState=A.getState;this.init=function(){if(!("starting"===y||"active"===y||"stopping"===y)){addEventListener("message",f,!1);for(var a=[],c=0,e=l.length;c<e;c++)a.push(l.key(c));a.forEach(function(a){if(0===a.indexOf("plugin.")){var b=a.substring(7),a=JSON.parse(l.getItem(a));a.created&&u.push(new h(b,a,A))}});u.sort(function(a,b){return a._getCreated()<b._getCreated()?
-1:1});d.parent?s=d.parent:(s=document.createElement("div"),d.visible||(s.style.display="none",s.style.visibility="hidden"),document.body.appendChild(s));d.plugins&&Object.keys(d.plugins).forEach(function(a){a=b(a);if(!this.getPlugin(a)){var c=d.plugins[a],c="object"===typeof c||{};c.autostart=c.autostart||d.defaultAutostart||"lazy";u.push(new h(a,c,A))}}.bind(this));y="starting"}};this.start=function(){"starting"!==y&&this.init();if("starting"!==y)return(new g).reject("Cannot start framework. Framework is already "+
y+".");var a=[],b=(new Date).getTime();u.forEach(function(c){var d=c._getAutostart();0===c.getLastModified()?a.push(c.update().then(function(){if("started"===d)return c.start({"transient":!0});if("lazy"===d)return c.start({lazy:!0,"transient":!0});c._resolve()})):"started"===d?a.push(c.start({"transient":!0})):"lazy"===d?(a.push(c.start({lazy:!0,"transient":!0})),b>c.getLastModified()+864E5&&c.update()):c._resolve()});return g.all(a,function(a){console.log("PluginRegistry.stop "+a)}).then(function(){y=
"active"})};this.stop=function(){if("starting"!==y&&"active"!==y)return(new g).reject("Cannot stop registry. Registry is already "+y+".");y="stopping";var a=[];u.forEach(function(b){a.push(b.stop({"transient":!0}))});return g.all(a,function(a){console.log("PluginRegistry.stop "+a)}).then(function(){if(!d.parent){var a=s.parentNode;a&&a.removeChild(s)}s=null;removeEventListener("message",f);y="resolved"})};this.update=function(){this.stop().then(this.start.bind(this))};this.uninstall=function(){return(new g).reject("Cannot uninstall registry")};
this.installPlugin=function(a,c){var a=b(a),d=this.getPlugin(a);if(d)return(new g).resolve(d);if(x[a])return x[a];if(c)return d=new h(a,c,A),u.push(d),d._persist(),A.dispatchEvent(new e("installed",d)),(new g).resolve(d);var f=A.loadManifest(a).then(function(b){d=new h(a,b,A);u.push(d);d._persist();delete x[a];A.dispatchEvent(new e("installed",d));return d},function(b){delete x[a];throw b;});return x[a]=f};this.getPlugins=function(){return u.slice()};this.getPlugin=function(a){var c=null,a=b(a);u.some(function(b){if(a===
b.getLocation())return c=b,!0});return c};this.addEventListener=q.addEventListener.bind(q);this.removeEventListener=q.removeEventListener.bind(q);this.resolvePlugins=function(){var a=!0;u.forEach(function(b){a=a&&b._resolve()});return a}}}});var _browser_script_source=null,_all_script=document.getElementsByTagName("script");
...
define("browse/builder/browse",["orion/widgets/browse/fileBrowser","orion/serviceregistry","orion/pluginregistry","orion/URL-shim"],function(g,n,p){function b(b){"string"===typeof b?(b={parentId:arguments[0],repo:arguments[1]},2<arguments.length&&(b.base=arguments[2])):b=b||{};var f,e=new URL(b.repo||window.location.href);f=e.href;var d=b.base,h=!1;if(!b.rootName){var c=f.match(/\/([^/]+)\/([^/]+)$/);c&&(b.rootName=decodeURIComponent(c[1])+" / "+decodeURIComponent(c[2]),b.rootName.match(/\.git$/)&&
(b.rootName=b.rootName.substring(0,b.rootName.length-4)))}if("github.com"===e.host)f=new URL("../../plugins/GitHubFilePlugin.html?repo="+e.href,_browser_script_source);else if(0===e.pathname.indexOf("/git/"))f=new URL("/gerrit/plugins/gerritFilesystem/static/plugins/GerritFilePlugin.html",e),f.query.set("project",e.pathname.substring(5));else if(0===e.pathname.indexOf("/ccm"))d||(e=e.pathname.match(/^\/ccm[^/]*/),d=(new URL(e,f)).href),f=new URL(d+"/service/com.ibm.team.filesystem.service.jazzhub.IOrionFilesystem/sr/pluginOrionWs.html?"+
f),h=!0;else if(0===e.pathname.indexOf("/project/"))d||(d=(new URL("/ccm01",f)).href),f=new URL(d+"/service/com.ibm.team.filesystem.service.jazzhub.IOrionFilesystem/sr/pluginOrionWs.html?"+f),h=!0;else throw"Bad Repo URL - "+f;var a=new n.ServiceRegistry,e={};e[f.href]=!0;(new p.PluginRegistry(a,{storage:{},plugins:e})).start().then(function(){this._fileBrowser=new g.FileBrowser({parent:b.parentId,showBranch:!0,showComponent:h,rootName:b.rootName,maxEditorLines:100,serviceRegistry:a})}.bind(this))}

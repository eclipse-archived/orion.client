...
(function(f){function m(a,c){var h,d,r,t,A,n,C,k,b,e=c&&c.split("/"),l=p.map,s=l&&l["*"]||{};if(a&&"."===a.charAt(0))if(c){e=e.slice(0,e.length-1);a=e.concat(a.split("/"));for(k=0;k<a.length;k+=1)if(h=a[k],"."===h)a.splice(k,1),k-=1;else if(".."===h)if(1===k&&(".."===a[2]||".."===a[0]))break;else 0<k&&(a.splice(k-1,2),k-=2);a=a.join("/")}else 0===a.indexOf("./")&&(a=a.substring(2));if((e||s)&&l){h=a.split("/");for(k=h.length;0<k;k-=1){d=h.slice(0,k).join("/");if(e)for(b=e.length;0<b;b-=1)if(r=l[e.slice(0,
b).join("/")])if(r=r[d]){t=r;A=k;break}if(t)break;!n&&(s&&s[d])&&(n=s[d],C=k)}!t&&n&&(t=n,A=C);t&&(h.splice(0,A,t),a=h.join("/"))}return a}function q(a,c){return function(){return k.apply(f,w.call(arguments,0).concat([a,c]))}}function b(a){return function(c){return m(c,a)}}function l(a){return function(c){h[a]=c}}function g(a){if(s.call(n,a)){var c=n[a];delete n[a];u[a]=!0;d.apply(f,c)}if(!s.call(h,a)&&!s.call(u,a))throw Error("No "+a);return h[a]}function e(a){var c,h=a?a.indexOf("!"):-1;-1<h&&(c=
a.substring(0,h),a=a.substring(h+1,a.length));return[c,a]}var d,k,c,a,h={},n={},p={},u={},s=Object.prototype.hasOwnProperty,w=[].slice;c=function(a,c){var h,d=e(a),r=d[0],a=d[1];r&&(r=m(r,c),h=g(r));r?a=h&&h.normalize?h.normalize(a,b(c)):m(a,c):(a=m(a,c),d=e(a),r=d[0],a=d[1],r&&(h=g(r)));return{f:r?r+"!"+a:a,n:a,pr:r,p:h}};a={require:function(a){return q(a)},exports:function(a){var c=h[a];return"undefined"!==typeof c?c:h[a]={}},module:function(a){return{id:a,uri:"",exports:h[a],config:function(){return p&&
p.config&&p.config[a]||{}}}}};d=function(d,p,k,b){var r,t,A,e,C=[],w,b=b||d;if("function"===typeof k){p=!p.length&&k.length?["require","exports","module"]:p;for(e=0;e<p.length;e+=1)if(A=c(p[e],b),t=A.f,"require"===t)C[e]=a.require(d);else if("exports"===t)C[e]=a.exports(d),w=!0;else if("module"===t)r=C[e]=a.module(d);else if(s.call(h,t)||s.call(n,t)||s.call(u,t))C[e]=g(t);else if(A.p)A.p.load(A.n,q(b,!0),l(t),{}),C[e]=h[t];else throw Error(d+" missing "+t);p=k.apply(h[d],C);if(d)if(r&&r.exports!==
f&&r.exports!==h[d])h[d]=r.exports;else if(p!==f||!w)h[d]=p}else d&&(h[d]=k)};requirejs=require=k=function(h,n,b,e,r){if("string"===typeof h)return a[h]?a[h](n):g(c(h,n).f);h.splice||(p=h,n.splice?(h=n,n=b,b=null):h=f);n=n||function(){};"function"===typeof b&&(b=e,e=r);e?d(f,h,n,b):setTimeout(function(){d(f,h,n,b)},4);return k};k.config=function(a){p=a;return k};define=function(a,c,d){c.splice||(d=c,c=[]);!s.call(h,a)&&!s.call(n,a)&&(n[a]=[a,c,d])};define.amd={jQuery:!0}})();define("almond",function(){});
...
(function(){function f(q,b,l){for(var g in b)b.hasOwnProperty(g)&&(!q.hasOwnProperty(g)||l)?q[g]=b[g]:"object"===typeof b[g]&&f(q[g],b[g],l)}var m=/(^.*(^|\/)nls(\/|$))([^\/]*)\/?([^\/]*)/;define("i18n",["module"],function(q){var b=q.config?q.config():{};return{version:"2.0.1+",load:function(l,g,e,d){d=d||{};d.locale&&(b.locale=d.locale);var k=m.exec(l),c=k[1],a=k[4],h=k[5],n=a.split("-"),p=[],u={},s,w="";k[5]?(c=k[1],l=c+h):(h=k[4],a=b.locale,a||(a=b.locale="undefined"===typeof navigator?"root":
(navigator.language||navigator.userLanguage||"root").toLowerCase()),n=a.split("-"));if(d.isBuild){p.push(l);d=c+"root/"+h;require._fileExists(g.toUrl(d+".js"))&&p.push(d);for(s=0;s<n.length;s++)d=n[s],w+=(w?"-":"")+d,d=p,k=c+w+"/"+h,require._fileExists(g.toUrl(k+".js"))&&d.push(k);g(p,function(){e()})}else g([l],function(a){var d=[],k;k=c;var b=h;a.root&&(d.push("root"),(!0===a.root||1===a.root)&&p.push(k+"root/"+b));for(s=0;s<n.length;s++){k=n[s];k=w+=(w?"-":"")+k;var b=a,r=p,t=c,A=h;b[k]&&(d.push(k),
(!0===b[k]||1===b[k])&&r.push(t+k+"/"+A))}g(p,function(){var r,t,A;for(r=d.length-1;-1<r&&d[r];r--){A=d[r];t=a[A];if(!0===t||1===t)t=g(c+A+"/"+h);f(u,t)}e(u)})})}}})})();define("orion/i18n",{load:function(f,m,q){m.specified&&m.specified("orion/bootstrap")?m(["orion/i18n!"+f],function(b){q(b)}):q({})}});
...
(function(f,m){"function"===typeof define&&define.amd?define("orion/Deferred",m):"object"===typeof exports?module.exports=m():(f.orion=f.orion||{},f.orion.Deferred=m())})(this,function(){function f(){for(var b;b=l.shift();)b();g=!1}function m(b){l.push(b);g||(g=!0,setTimeout(f,0))}function q(b){return function(){b.apply(void 0,arguments)}}function b(){function e(){for(var c;c=n.shift();){var d=c.deferred,p="fulfilled"===h?"resolve":"reject";if("function"===typeof c[p])try{var k=(0,c[p])(a),b=k&&("object"===
typeof k||"function"===typeof k)&&k.then;if("function"===typeof b)if(k===d.promise)d.reject(new TypeError);else{var e=k.cancel;"function"===typeof e?d._protected(l).parentCancel=e.bind(k):delete d._protected(l).parentCancel;b.call(k,q(d.resolve),q(d.reject),q(d.progress))}else d.resolve(k)}catch(r){d.reject(r)}else d[p](a)}}function d(c){delete u.parentCancel;h="rejected";a=c;n.length&&m(e)}function k(c){function l(r){return function(a){g||(g=!0,r(a))}}var g=!1;delete u.parentCancel;try{var f=c&&
("object"===typeof c||"function"===typeof c)&&c.then;if("function"===typeof f)if(c===p)d(new TypeError);else{h="assumed";var v=c&&c.cancel;if("function"!==typeof v){var q=new b,c=q.promise;try{f(q.resolve,q.reject,q.progress)}catch(r){q.reject(r)}v=c.cancel;f=c.then}a=c;f.call(c,l(k),l(d));u.parentCancel=v.bind(c)}else h="fulfilled",a=c,n.length&&m(e)}catch(t){l(d)(t)}}function c(){var a=u.parentCancel;a?(delete u.parentCancel,a()):h||(a=Error("Cancel"),a.name="Cancel",d(a))}var a,h,n=[],p=this,u=
{};Object.defineProperty(this,"_protected",{value:function(a){if(a!==l)throw Error("protected");return u}});this.resolve=function(a){h||k(a);return p};this.reject=function(a){h||d(a);return p};this.progress=function(a){h||n.forEach(function(c){if(c.progress)try{c.progress(a)}catch(h){}});return p.promise};this.cancel=function(){u.parentCancel?setTimeout(c,0):c();return p};this.then=function(a,c,d){a={resolve:a,reject:c,progress:d,deferred:new b};n.push(a);a.deferred._protected(l).parentCancel=p.promise.cancel.bind(p);
("fulfilled"===h||"rejected"===h)&&m(e);return a.deferred.promise};this.promise={then:p.then,cancel:p.cancel}}var l=[],g=!1;b.all=function(e,d){function k(c,d){n||(h[c]=d,0===--a&&p.resolve(h))}function c(a,c){if(!n){if(d)try{k(a,d(c));return}catch(h){c=h}p.reject(c)}}var a=e.length,h=[],n=!1,p=new b;p.then(void 0,function(){n=!0;e.forEach(function(a){a.cancel&&a.cancel()})});0===a?p.resolve(h):e.forEach(function(a,h){a.then(k.bind(void 0,h),c.bind(void 0,h))});return p.promise};b.when=function(e,
...
(new q).resolve(c)},_read:function(c){var a=this.fileClient,h=Array.prototype.slice.call(arguments,1);return this._maybeLoadWorkspace(c).then(function(c){return a.read.apply(a,[c].concat(h))})},load:function(){var c=this.getInput();if(c){var a=this.fileClient,h=this._parsedLocation.resource,k=this.progressService,p=function(r,a,c){return!k?r:k.progress(r,m.formatMessage(a,c))},b=this.getEditor();if(this._fileMetadata)!this._saving&&(!this._fileMetadata.Directory&&!this._readonly)&&p(a.read(h,!0),
f.ReadingMetadata,c).then(function(r){this._fileMetadata&&(this._fileMetadata.Location===r.Location&&this._fileMetadata.ETag!==r.ETag)&&(this._fileMetadata=r,(!b.isDirty()||window.confirm(f.loadOutOfSync))&&p(a.read(h),f.Reading,c).then(function(r){b.setInput(c,null,r);this._unsavedChanges=[]}.bind(this)))}.bind(this));else{var e=h;if(0===e.indexOf("/gitapi/commit/")){var l=e.indexOf("/file"),g=e.indexOf("?",l);-1===g&&(g=e.length);e=e.substring(l,g);this._readonly=!0}var q=window.setTimeout(function(){q=
...
a;this._setInputContents(this._parsedLocation,c,a,r)}.bind(this),z):this._isText(r)?p(a.read(h,!1,!0),f.Reading,c).then(function(a){v();"string"!==typeof a&&(this._acceptPatch=a.acceptPatch,a=a.result);this._setInputContents(this._parsedLocation,c,a,r)}.bind(this),z):p(a._getService(h).readBlob(h),f.Reading,c).then(function(a){v();this._setInputContents(this._parsedLocation,c,a,r)}.bind(this),z):z({responseText:m.formatMessage(f.ReadingMetadataError,e)})}.bind(this),z)}}},processParameters:function(c){var a=
...
onFocus:function(){this._autoSaveEnabled&&this._errorSaving?this.save():this._autoLoadEnabled&&this.load()},onChanging:function(c){if(this._getSaveDiffsEnabled()){var a=this._unsavedChanges.length,h=c.removedCharCount,d=c.start,p=c.start+h,k=0;0===c.addedCharCount?k=-1:0===h&&(k=1);if(0<a&&k===this.previousChangeType){a=this._unsavedChanges[a-1];if(0===h&&d===a.end+a.text.length){a.text+=c.text;return}if(0===c.addedCharCount&&p===a.start){a.start=d;return}}this.previousChangeType=k;this._unsavedChanges.push({start:d,
end:p,text:c.text})}},reportStatus:function(c){this.statusReporter?this.statusReporter(c):this.editor&&this.editor.reportStatus(c)},save:function(){function c(a){p===t.getInput()&&(t.getFileMetadata().ETag=a.ETag,h.setInput(p,null,b,!0));t.reportStatus("");k&&r&&r.setProgressResult({Message:f.Saved,Severity:"Normal"});t.afterSave&&t.afterSave();t._saving=!1}function a(a){t.reportStatus("");d(r,a);t._saving=!1;t._errorSaving=!0}if(!this._saving){var h=this.getEditor();if(h&&h.isDirty()&&!this.getReadOnly()){var k=
...
p;return}}a=a&&d.editor!==h.editor;this._location=c;this._parsedLocation=h;this._ignoreInput=!0;this.selection&&this.selection.setSelections(c);this._ignoreInput=!1;(c=h.resource)?c===this._input?a?(this.reportStatus(""),this._setInputContents(h,c,null,this._fileMetadata,this._isText(this._fileMetadata))):this.processParameters(h):(this._input=c,this._readonly=!1,this._fileMetadata=null,this.load()):this._setNoInput(!0)}},setTitle:function(c){var a=c.lastIndexOf("/");-1!==a&&(c=c.substring(a+1));
...
a.ChildrenLocation;this._setInputContents(a.ChildrenLocation,null,a,a)}.bind(this)):(this._input=this._title=this._fileMetadata=null,this.setContentType(null),this.dispatchEvent({type:"InputChanged",input:null}))},_setInputContents:function(c,a,d,k,p){var b,e=!1;k?(this._fileMetadata=k,this.setTitle(k.Location||String(k)),this.setContentType(this.contentTypeRegistry.getFileContentType(k)),b=k.Name,e=k.Directory):(this._fileMetadata=null,this.setTitle(a),this.setContentType(this.contentTypeRegistry.getFilenameContentType(this.getTitle())),
...
l=k.editor;e||(l&&(l.getTextView&&l.getTextView())&&l.getTextView().addEventListener("Focus",this._focusListener=this.onFocus.bind(this)),l&&(l.getModel&&l.getModel())&&l.getModel().addEventListener("Changing",this._changingListener=this.onChanging.bind(this)),p||l.setInput(a,null,d),this._unsavedChanges=[],this.processParameters(c))}});return{InputManager:k}});
define("orion/util",[],function(){var f=navigator.userAgent,m=-1!==f.indexOf("MSIE")||-1!==f.indexOf("Trident")?document.documentMode:void 0,q=parseFloat(f.split("Firefox/")[1]||f.split("Minefield/")[1])||void 0,b=-1!==f.indexOf("Opera")?parseFloat(f.split("Version/")[1]):void 0,l=parseFloat(f.split("Chrome/")[1])||void 0,g=-1!==f.indexOf("Safari")&&!l,e=parseFloat(f.split("WebKit/")[1])||void 0,d=-1!==f.indexOf("Android"),k=-1!==f.indexOf("iPad"),f=-1!==f.indexOf("iPhone"),c=k||f,a=-1!==navigator.platform.indexOf("Mac"),
...
(d.preventDefault(),d.stopPropagation())},processTextNodes:function(d,c){g(d,function(a,d){a.parentNode.replaceChild(document.createTextNode(c[d[1]]||d[1]),a)})},processDOMNodes:function(d,c){g(d,function(a,d){var k=c[d[1]];if(k){var p=document.createRange(),b=d.index;p.setStart(a,b);p.setEnd(a,b+d[0].length);p.deleteContents();p.insertNode(k)}})},addAutoDismiss:function(k,c){function a(a){d.forEach(function(c){var d=!1,k=c.excludeNodes.some(function(c){return document.body.contains(c)?(d=!0,c.contains(a.target)):
!1});if(d&&!k)try{c.dismiss(a)}catch(b){"undefined"!==typeof console&&console&&console.error(b&&b.message)}});d=d.filter(function(a){return a.excludeNodes.some(function(a){return document.body.contains(a)})})}null===d&&(d=[],document.addEventListener("click",a,!0),f.isIOS&&document.addEventListener("touchend",function(a){function c(){a.target.removeEventListener("click",c)}0===a.touches.length&&a.target.addEventListener("click",c)},!1));d.push({excludeNodes:k,dismiss:c})},setFramesEnabled:function(d){for(var c=
document.getElementsByTagName("iframe"),a=0;a<c.length;a++)c[a].parentNode.style.pointerEvents=d?"":"none"},removeAutoDismiss:function(k){d=d.filter(function(c){return k!==c.dismiss})},KEY:{BKSPC:8,TAB:9,ENTER:13,ESCAPE:27,SPACE:32,PAGEUP:33,PAGEDOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,INSERT:45,DEL:46}}});
...
(function(){function f(r){if("string"!==typeof r)throw new TypeError;}function m(r){return r?r.split("&"):[]}function q(r){return 0===r.length?"":r.join("&")}function b(r){var a=/([^=]*)(?:=?)(.*)/.exec(r),r=a[1]?decodeURIComponent(a[1]):"",a=a[2]?decodeURIComponent(a[2]):"";return[r,a]}function l(r){var a=encodeURIComponent(r[0]);r[1]&&(a+="="+encodeURIComponent(r[1]));return a}function g(r,a){var c="",t=[],d=0;return{next:function(){c!==r.query&&(c=r.query,t=m(c));if(d<t.length){var h=b(t[d++]);
switch(a){case "keys":return h[0];case "values":return h[1];case "keys+values":return[h[0],h[1]];default:throw new TypeError;}}throw A;}}}function e(r){Object.defineProperty(this,"_url",{get:function(){return r._url}})}function d(r){return r?/[1-9]\d*$/.exec(r)[0]:""}function k(r){var a=[];r.split("/").forEach(function(r){".."===r?a.pop():"."!==r&&a.push(r)});return a.join("/")}function c(r,a){if("string"!==typeof r)throw new TypeError;var r=r.replace(/\s/g,function(r){return"%"+r.charCodeAt(0).toString(16)}),
c=p.exec(r);if(!c)return null;var t={};t.scheme=c[1]||"";if(t.scheme&&!s.test(t.scheme))return null;var h=c[2];if(h&&(h=u.exec(h),t.userinfo=h[1],t.host=h[2],t.port=h[3],t.port&&!w.test(t.port)))return null;t.path=c[3];t.query=c[4];t.fragment=c[5];!t.scheme&&a&&(t.scheme=a.scheme,!t.host&&a.host&&(t.userinfo=a.userinfo,t.host=a.host,t.port=a.port,t.pathRelative=!0));t.pathRelative&&(t.path?"/"!==t.path[0]&&(c=/^(.*\/)[^\/]*$/.exec(a.path)[1]||"/",t.path=c+t.path):t.path=a.path);t.scheme&&(t.scheme=
t.scheme.toLowerCase());t.port&&(t.port=d(t.port));t.host&&t.path&&(t.path=k(t.path));return t}function a(r,a){var t;if(a){a=a.href||a;t=c(a);if(!t||!t.scheme)throw new SyntaxError;Object.defineProperty(this,"_baseURL",{value:t})}t=c(r,t);if(!t)throw new SyntaxError;Object.defineProperty(this,"_input",{value:r,writable:!0});Object.defineProperty(this,"_url",{value:t,writable:!0});var d=new e(this);Object.defineProperty(this,"query",{get:function(){return this._url?d:null},enumerable:!0})}try{var h;
if("function"===typeof window.URL&&0!==window.URL.length&&"http:"===(h=new window.URL("http://www.w3.org?q")).protocol&&h.query)return}catch(n){}var p=/^(?:([^:\/?#]+):)?(?:\/\/([^\/?#]*))?([^?#]*)(?:\?([^#]*))?(?:#(.*))?$/,u=/^(?:(.*)@)?(\[[^\]]*\]|[^:]*)(?::(.*))?$/,s=/^([a-zA-Z](?:[a-zA-Z0-9+-.])*)$/,w=/^\d*$/,y=/^(\[[^\]\/?#\s]*\]|[^:\/?#\s]*)$/,x=/^(\[[^\]\/?#\s]*\]|[^:\/?#\s]*)(?::(\d*))?$/,v=/^([^?#\s]*)$/,z=/^([^\s]*)$/,r=/^\S*$/,t=/([^:]*):?(.*)/,A="undefined"!==typeof StopIteration?StopIteration:
Error("Stop Iteration"),D={"ftp:":"21","gopher:":"70","http:":"80","https:":"443","ws:":"80","wss:":"443"};Object.defineProperties(e.prototype,{get:{value:function(r){f(r);var a;m(this._url.query).some(function(t){t=b(t);if(t[0]===r)return a=t[1],!0});return a},enumerable:!0},set:{value:function(r,a){f(r);f(a);var t=m(this._url.query);t.some(function(c,d){var h=b(c);if(h[0]===r)return h[1]=a,t[d]=l(h),!0})||t.push(l([r,a]));this._url.query=q(t)},enumerable:!0},has:{value:function(r){f(r);return m(this._url.query).some(function(a){if(b(a)[0]===
...
(r="/"+r),this._url.path=r?k(r):"")},enumerable:!0},search:{get:function(){return this._url&&this._url.query?"?"+this._url.query:""},set:function(r){f(r);this._url&&(r&&"?"===r[0]&&(r=r.substring(1)),z.exec(r)&&(this._url.query=r))},enumerable:!0},hash:{get:function(){return this._url&&this._url.fragment?"#"+this._url.fragment:""},set:function(a){f(a);this._url&&(a&&"#"===a[0]&&(a=a.substring(1)),r.exec(a)&&(this._url.fragment=a))},enumerable:!0}});if((h=window.URL||window.webkitURL)&&h.createObjectURL)Object.defineProperty(a,
...
"",b=b.getKeys(),g=0;g<b.length;g++)0!==g&&(l+=" "),l+=m(b[g]);return l},getUserText:function(b){var l=b.id,g=b.refNode,e=b.hideRefNode,d=b.initialText,k=b.onComplete,c=b.onEditDestroy,a=b.selectTo,h=b.isInitialValid,b=b.insertAsChild,n=!1,p=function(a){return function(p){if(!n){var b=f.node(l),u=b.value;b&&(a&&p.keyCode===f.KEY.ESCAPE?(e&&(g.style.display="inline"),n=!0,b.parentNode.removeChild(b),c&&c()):a&&p.keyCode!==f.KEY.ENTER||(0===u.length||!h&&u===d?e&&(g.style.display="inline"):(k(u),e&&
g.parentNode&&(g.style.display="inline")),n=!0,b.parentNode&&b.parentNode.removeChild(b),c&&c()))}}},u=document.createElement("input");u.id=l;u.value=d||"";b?g.appendChild(u):g.parentNode.insertBefore(u,g.nextSibling);u.classList.add("userEditBoxPrompt");e&&(g.style.display="none");u.addEventListener("keydown",p(!0),!1);u.addEventListener("blur",p(!1),!1);window.setTimeout(function(){u.focus();if(d){var c=f.node(l),h=a?d.indexOf(a):-1;0<h?c.createTextRange?(c=c.createTextRange(),c.collapse(!0),c.moveStart("character",
0),c.moveEnd("character",h),c.select()):c.setSelectionRange?c.setSelectionRange(0,h):void 0!==c.selectionStart&&(c.selectionStart=0,c.selectionEnd=h):c.select()}},0)},openInNewWindow:q,followLink:function(b,l){l&&q(l)?window.open(b):window.location=b},createButton:function(b,l){var g=document.createElement("button");g.className="orionButton commandButton commandMargins";g.addEventListener("click",function(b){l();f.stop(b)},!1);b&&g.appendChild(document.createTextNode(b));return g},createDropdownButton:function(){},
...
a!==b;){var p=window.getComputedStyle(a,null);if(!p)break;p=p.getPropertyValue("overflow-y");if("auto"===p||"scroll"===p)break;a=a.parentNode}a&&(b=!0,d.offsetTop<=a.scrollTop?(b=!1,void 0===c&&(c=!1)):d.offsetTop+d.offsetHeight>=a.scrollTop+a.clientHeight&&(b=!1,void 0===c&&(c=!0)),b||d.scrollIntoView(!c))}if(this.explorer.onCursorChanged)this.explorer.onCursorChanged(h,n)}},getSelection:function(){return this._selections},getSelectionIds:function(){for(var d=[],b=0;b<this._selections.length;b++)d.push(this.model.getId(this._selections[b]));
...
d,b,e){b=d?m.strip(b):b;h.isBuild&&(a[c]=b);e(b)},load:function(a,b,l,s){if(s.isBuild&&!s.inlineText)l();else{h.isBuild=s.isBuild;var g=m.parseName(a),s=g.moduleName+(g.ext?"."+g.ext:""),f=b.toUrl(s),q=h.useXhr||m.useXhr;!e||q(f,d,k,c)?m.get(f,function(c){m.finishLoad(a,g.strip,c,l)},function(a){l.error&&l.error(a)}):b([s],function(a){m.finishLoad(g.moduleName+"."+g.ext,g.strip,a,l)})}},write:function(c,d,h){if(a.hasOwnProperty(d)){var b=m.jsEscape(a[d]);h.asModule(c+"!"+d,"define(function () { return '"+
b+"';});\n")}},writeFile:function(a,c,d,h,b){var c=m.parseName(c),e=c.ext?"."+c.ext:"",k=c.moduleName+e,l=d.toUrl(c.moduleName+e)+".js";m.load(k,d,function(){var c=function(r){return h(l,r)};c.asModule=function(r,a){return h.asModule(r,l,a)};m.write(a,k,c,b)},b)}};if("node"===h.env||!h.env&&"undefined"!==typeof process&&process.versions&&process.versions.node)q=require.nodeRequire("fs"),m.get=function(a,c){var d=q.readFileSync(a,"utf8");0===d.indexOf("\ufeff")&&(d=d.substring(1));c(d)};else if("xhr"===
...
d){var r=this.getChoices(c,r,t),b=r.some(function(r){return r.checked});r.forEach(function(r){if(r.name){var t=document.createElement("li");a.appendChild(t);var h=document.createElement("span");h.tabIndex=0;h.role="menuitem";h.classList.add("dropdownMenuItem");if(b){var p=document.createElement("span");p.classList.add("check");p.appendChild(document.createTextNode(r.checked?"\u25cf":""));h.appendChild(p)}p=document.createTextNode(r.name);h.appendChild(p);t.appendChild(h);h.choice=r;h.addEventListener("click",
function(r){r.target.choice&&r.target.choice.callback.call(r.target.choice,c)},!1);h.addEventListener("keydown",function(r){(r.keyCode===m.KEY.ENTER||r.keyCode===m.KEY.SPACE)&&r.target.choice&&r.target.choice.callback.call(r.target.choice,c)},!1)}else d._generateMenuSeparator(a)})},getChoices:function(a,c,r){return this.choiceCallback?this.choiceCallback.call(c,a,r):null},makeChoiceCallback:function(a,c){return function(r){a.callback&&a.callback.call(a,c,r)}},hasImage:function(){return this.imageClass||
"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAAtJREFUCNdjIBEAAAAwAAFletZ8AAAAAElFTkSuQmCC"!==this.image}};w.prototype.constructor=w;return{Command:w,CommandInvocation:s,createDropdownMenu:function(a,c,r,t,d,h,p,e,n){a=m.node(a);if(!a)throw"no parent node was specified";var k=document.createRange();k.selectNode(a);k=n?k.createContextualFragment(l):k.createContextualFragment(b);m.processTextNodes(k,{ButtonText:c});a.appendChild(k);var a=
a.lastChild,s;n?(n=a.previousSibling,s=n.lastChild):n=a.previousSibling;t?n.classList.add(t):(n.classList.add("orionButton"),n.classList.add("commandButton"));d&&(h||(n.textContent="",n.setAttribute("aria-label",c)),u({spriteClass:"commandSprite",imageClass:d},n,c),n.classList.add("orionButton"));n.dropdown=new q.Dropdown({dropdown:a,populate:r,selectionClass:p,skipTriggerEventListeners:!!s,positioningNode:e});a.dropdown=n.dropdown;return{menuButton:n,menu:a,dropdown:n.dropdown,dropdownArrow:s}},
createCheckedMenuItem:function(a,c,r,t){a=m.node(a);if(!a)throw"no parent node was specified";var d=document.createRange();d.selectNode(a);d=d.createContextualFragment(e);m.processTextNodes(d,{ItemText:c});a.appendChild(d);a=m.$(".checkedMenuItem",a.lastChild);a.checked=r;a.addEventListener("change",t,!1);return a},createCommandItem:function(a,c,r,t,b,h,p){var n,h=h||!c.name&&c.hasImage();if(c.hrefCallback)n=document.createElement("a"),n.id=t,h&&c.hasImage()?u(c,n,t):(n.className="commandLink",n.appendChild(document.createTextNode(c.name))),
p=c.hrefCallback.call(r.handler,r),p.then?p.then(function(r){n.href=r}):n.href=p?p:"#";else{n=document.createElement("button");n.className="orionButton";h?c.hasImage()?(u(c,n,t),c.name&&n.setAttribute("aria-label",c.name)):(n.classList.add("commandButton"),n.classList.add("commandMissingImageButton"),n.appendChild(document.createTextNode(c.name))):(n.classList.add("commandButton"),t=document.createTextNode(c.name),n.appendChild(t));var e=p||c.callback;e&&(c.onClick=e,n.addEventListener("click",function(){e.call(r.handler,
r)},!1))}"ul"===a.nodeName.toLowerCase()?(p=document.createElement("li"),a.appendChild(p),a=p):n.classList.add("commandMargins");a.appendChild(n);c.tooltip&&(n.commandTooltip=new d.Tooltip({node:n,text:c.tooltip,position:["above","below","right","left"]}));b&&(x[c.id]={keyBinding:b,command:c,invocation:r});return n},createCommandMenuItem:function(a,c,r,t,b,h){var p,n=a.dropdown;if(c.hrefCallback){p=document.createElement("a");var e=document.createElement("span");e.appendChild(document.createTextNode(c.name));
e.classList.add("dropdownCommandName");p.appendChild(e);b=c.hrefCallback.call(r.handler,r);b.then?b.then(function(r){p.href=r}):p.href=b?b:"#";p.addEventListener("keydown",function(r){(r.keyCode===m.KEY.ENTER||r.keyCode===m.KEY.SPACE)&&p.click()},!1)}else{p=document.createElement("span");p.tabIndex=0;e=document.createElement("span");e.appendChild(document.createTextNode(c.name));e.classList.add("dropdownCommandName");p.appendChild(e);var k=b||c.callback;k&&(c.onClick=k,p.addEventListener("click",
function(){n.close(!0);k.call(r.handler,r)},!1),p.addEventListener("keydown",function(r){if(r.keyCode===m.KEY.ENTER||r.keyCode===m.KEY.SPACE)r.preventDefault(),p.click()},!1))}p.className="dropdownMenuItem";p.role="menuitem";c.tooltip&&(p.commandTooltip=new d.Tooltip({node:p,text:c.tooltip,position:["above","below","right","left"]}));h&&(b=p,e=document.createElement("span"),e.classList.add("dropdownKeyBinding"),e.appendChild(document.createTextNode(h)),b.appendChild(e));h=document.createElement("li");
a.appendChild(h);h.appendChild(p);t&&(x[c.id]={keyBinding:t,command:c,invocation:r});return p},executeBinding:k,setKeyBindingProvider:function(a){y=a},localKeyBindings:x,CommandsProxy:p,getKeyBindings:a,processKey:h,NO_IMAGE:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAAtJREFUCNdjIBEAAAAwAAFletZ8AAAAAElFTkSuQmCC",_testMethodProcessKey:c}});
...
b,c,a,h){var c=c||"tool",n=document.createElement("td");n.id=b.id+"actionswrapper";a&&n.classList.add(a);this.actionScopeId&&this.commandService?this.commandService.renderCommands(this.actionScopeId,n,d,this.explorer,c,null,h&&this.explorer.getNavDict()?this.explorer.getNavDict().getGridNavHolder(d,!0):null):window.console.log("Warning, no command service or action scope was specified.  No commands rendered.");return n},initCheckboxColumn:function(){if(this._useCheckboxSelection)return document.createElement("th")},
...
if(c){var n=document.createElement("span");b.appendChild(n);n.classList.add(a||"imageSprite");n.classList.add(c)}var p=this;h.onclick=function(){if(!p.explorer.getNavHandler().isDisabled(d)){p.tableTree.toggle(d.id);if(p.tableTree.isExpanded(d.id))p._expanded.push(d.id),p.explorer.postUserExpand&&p.explorer.postUserExpand(d.id);else for(var a in p._expanded)if(p._expanded[a]===d.id){p._expanded.splice(a,1);break}(a=p._getUIStatePreferencePath())&&window.sessionStorage&&p._storeExpansions(a)}};return h},
...
[],e=0;e<a.length;e++)"undefined"!==typeof a[e]&&d.push(q(a[e],c));return d.join(b)}function l(a,c,b,d){for(var e=Object.keys(a),l=[],k=0;k<e.length;k++)"undefined"!==typeof a[e[k]]&&l.push(q(e[k],c)+b+q(a[e[k]],c));return l.join(d)}function g(a){if(0===a.length)throw Error("Invalid Expression: 0 length expression");(this._operator=d[a[0]])?a=a.substring(1):this._operator=d.NUL;for(var c=[],b=a.split(","),e=0;e<b.length;e++){var l=b[e].match(k);if(null===l)throw Error("Bad VarSpec: "+a);c.push({name:l[1],
...
g.prototype={expand:function(a){for(var c=[],d=0;d<this._varSpecList.length;d++){var e=this._varSpecList[d],k=e.name,g=a[k],f=typeof g;if("undefined"!==f&&null!==g){var y=0===c.length?this._operator.first:this._operator.sep,m=y;if("string"===f)this._operator.named&&(m+=q(k,"U+R"),m+=0===g.length?this._operator.ifemp:"="),-1!==e.prefix&&e.prefix<g.length&&(g=g.substring(0,e.prefix)),m+=q(g,this._operator.allow);else if(Array.isArray(g))e.explode?m+=b(g,this._operator.allow,this._operator.sep):(this._operator.named&&
(m+=q(k,"U+R"),m+=0===g.length?this._operator.ifemp:"="),m+=b(g,this._operator.allow,","));else if("object"===f)e.explode?m+=l(g,this._operator.allow,"=",this._operator.sep):(this._operator.named&&(m+=q(k,"U+R"),m+=0===Object.keys(g).length?this._operator.ifemp:"="),m+=l(g,this._operator.allow,",",","));else throw Error("bad param type: "+k+" : "+f);(m!==y||d<this._varSpecList.length-1)&&c.push(m)}}return c.join("")}};e.prototype={expand:function(a){for(var c=[],b=0;b<this._templateComponents.length;b++)c.push(this._templateComponents[b].expand(a));
return c.join("")}};return e});
define("orion/explorers/navigatorRenderer","i18n!orion/navigate/nls/messages orion/Deferred orion/explorers/explorer orion/explorers/navigationUtils orion/extensionCommands orion/objects orion/URITemplate orion/webui/littlelib".split(" "),function(f,m,q,b,l,g,e,d){function k(a){switch(a&&a.id){case "image/jpeg":case "image/png":case "image/gif":case "image/ico":case "image/tiff":case "image/svg":return!0}return!1}function c(a,c,b,d,f,y,q,v,z,r){var c=g.clone(c),t;if(c.Directory)t=document.createElement("a"),
...
A.appendChild(D);c.Name&&t.appendChild(document.createTextNode(c.Name));var C=!1,H=c.Location;v&&"object"===typeof v&&(c.params={},g.mixin(c.params,v));for(a=0;a<f.length;a++)if(v=f[a],v.visibleWhen(c)){H=v.hrefCallback({items:c});C=!0;break}m.when(d.getFileContentType(c),function(a){!C&&(y&&!k(a))&&(H=y.hrefCallback({items:c}));if(A){var b=A,d=D;if(a){var h,e=a.imageClass,n=a.image;e?(h=document.createElement("span"),h.className+=e,h.classList.add("thumbnail")):n&&(h=document.createElement("img"),
h.src=n,h.classList.add("thumbnail"));h&&b.replaceChild(h,d)}}t.href=H;r&&"function"===typeof r.updateFileNode&&r.updateFileNode(c,t,k(a))})}return t}function a(a,c,b,d){this.explorer=c;this.commandService=b;this.contentTypeService=d;this.openWithCommands=null;this.actionScopeId=a.actionScopeId;this._init(a);this.target="_self"}var h=new e("#{,resource,params*}");a.prototype=new q.SelectionRenderer;a.prototype.wrapperCallback=function(a){a.setAttribute("role","tree")};a.prototype.tableCallback=function(a){a.setAttribute("aria-label",
...
typeof c){n||(n=c,c=null);c&&(c=e({},d.defaults,c));var l=c.highlight,k,g,w=0;try{k=f.lex(a,c)}catch(m){return n(m)}g=k.length;var x=function(a){var r,b;!0!==a&&delete c.highlight;try{r=q.parse(k,c)}catch(d){b=d}c.highlight=l;return b?n(b):n(null,r)};if(!l||3>l.length)return x(!0);if(!g)return x();for(;w<k.length;w++)(function(a){return"code"!==a.type?--g||x():l(a.text,a.lang,function(r,c){if(null==c||c===a.text)return--g||x();a.text=c;a.escaped=!0;--g||x()})})(k[w])}else try{return c&&(c=e({},d.defaults,
...
q,b){if(this._eventTypes){var l=this._eventTypes[f];if(l){for(var g=l.listeners,e=0,d=g.length;e<d;e++){var k=g[e];if(k&&k.listener===q&&k.useCapture===b){0!==l.level?(g[e]=null,l.compact=!0):g.splice(e,1);break}}0===g.length&&delete this._eventTypes[f]}}}};return{EventTarget:f}});define("orion/regex",[],function(){return{escape:function(f){return f.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g,"\\$&")},parse:function(f){return(f=/^\s*\/(.+)\/([gim]{0,3})\s*$/.exec(f))?{pattern:f[1],flags:f[2]}:null}}});
...
"[Ii\u0130\u0131]"));var a=null,h;if(d){var g=b.reverse,n=b.wrap,e=b.wholeWord,p=b.start||0,b=b.end,f=null!==b&&void 0!==b;-1===k.indexOf("g")&&(k+="g");-1===k.indexOf("m")&&(k+="m");c&&-1===k.indexOf("i")&&(k+="i");e&&(d="\\b"+d+"\\b");var s=this._text[0],w,q,x=0;f&&(c=p<b?p:b,s=s.substring(c,p<b?b:p),x=c);var v=RegExp(d,k);g?h=function(){var a=null;for(v.lastIndex=0;;){q=v.lastIndex;w=v.exec(s);if(q===v.lastIndex)return null;if(w){if(!(w.index+x<p)){if(!n||a)break;p=s.length+x}a={start:w.index+
x,end:v.lastIndex+x}}else break}a&&(p=a.start);return a}:(f||(v.lastIndex=p),h=function(){for(;;){q=v.lastIndex;w=v.exec(s);if(q===v.lastIndex)break;if(w)return{start:w.index+x,end:v.lastIndex+x};if(!(0!==q&&n))break}return null});a=h()}return{next:function(){var c=a;c&&(a=h());return c},hasNext:function(){return null!==a}}},getCharCount:function(){for(var b=0,g=0;g<this._text.length;g++)b+=this._text[g].length;return b},getLine:function(b,g){var e=this.getLineCount();if(!(0<=b&&b<e))return null;
...
e},onChanging:function(b){return this.dispatchEvent(b)},onChanged:function(b){return this.dispatchEvent(b)},setLineDelimiter:function(b,g){"auto"===b&&(b=void 0,1<this.getLineCount()&&(b=this.getText(this.getLineEnd(0),this.getLineEnd(0,!0))));this._lineDelimiter=b?b:q.platformDelimiter;if(g){var e=this.getLineCount();if(1<e){for(var d=Array(e),k=0;k<e;k++)d[k]=this.getLine(k);this.setText(d.join(this._lineDelimiter))}}},setText:function(b,g,e){void 0===b&&(b="");void 0===g&&(g=0);void 0===e&&(e=
this.getCharCount());if(!(g===e&&""===b)){for(var d=this.getLineAtOffset(g),k=this.getLineAtOffset(e),c=g,a=e-g,h=k-d,n=b.length,p=0,f=this.getLineCount(),s=0,w=0,m=0,q=[];;){-1!==s&&s<=m&&(s=b.indexOf("\r",m));-1!==w&&w<=m&&(w=b.indexOf("\n",m));if(-1===w&&-1===s)break;m=-1!==s&&-1!==w?s+1===w?w+1:(s<w?s:w)+1:-1!==s?s+1:w+1;q.push(g+m);p++}this.onChanging({type:"Changing",text:b,start:c,removedCharCount:a,addedCharCount:n,removedLineCount:h,addedLineCount:p});0===q.length&&(m=this.getLineStart(d),
k=k+1<f?this.getLineStart(k+1):this.getCharCount(),g!==m&&(b=this.getText(m,g)+b,g=m),e!==k&&(b+=this.getText(e,k),e=k));m=n-a;for(k=d+h+1;k<f;k++)this._lineOffsets[k]+=m;if(5E4>q.length)d=[d+1,h].concat(q),Array.prototype.splice.apply(this._lineOffsets,d);else{m=d+1;this._lineOffsets.splice(m,h);for(f=0;f<q.length;f+=5E4)d=[m,0].concat(q.slice(f,Math.min(q.length,f+5E4))),Array.prototype.splice.apply(this._lineOffsets,d),m+=5E4}for(m=f=0;m<this._text.length;){k=this._text[m].length;if(g<=f+k)break;
f+=k;m++}d=f;for(q=m;m<this._text.length;){k=this._text[m].length;if(e<=f+k)break;f+=k;m++}k=this._text[m];g=this._text[q].substring(0,g-d);e=k.substring(e-f);q=[q,m-q+1];g&&q.push(g);b&&q.push(b);e&&q.push(e);Array.prototype.splice.apply(this._text,q);0===this._text.length&&(this._text=[""]);this.onChanged({type:"Changed",start:c,removedCharCount:a,addedCharCount:n,removedLineCount:h,addedLineCount:p})}}};f.EventTarget.addMixin(b.prototype);return{TextModel:b}});
...
d("comment.block.documentation",e.comment,!1);d("keyword.other.documentation.markup",e.comment,!1);return k.join("\n")},_createStyle:function(b,e,d,k){var c=this._document,b="orion-theme-"+b,a=c.getElementById(b);if(a){if(k||a.firstChild.data===e)return;a.removeChild(a.firstChild);a.appendChild(c.createTextNode(e))}else k?(a=q.createElement(c,"link"),a.rel="stylesheet",a.type="text/css",a.href=e,a.addEventListener("load",function(){d()})):(a=q.createElement(c,"style"),a.appendChild(c.createTextNode(e))),
...
define("orion/editor/textView","i18n!orion/editor/nls/messages orion/editor/textModel orion/editor/keyModes orion/editor/eventTarget orion/editor/textTheme orion/editor/util orion/util".split(" "),function(f,m,q,b,l,g,e){function d(a,c,b){if(b){c.className="";for(var b=c.attributes,d=b.length;0<d--;)(!e.isIE||9<=e.isIE||9>e.isIE&&b[d].specified)&&c.removeAttribute(b[d].name)}if(a){a.styleClass&&(c.className=a.styleClass);if(b=a.style)for(var h in b)b.hasOwnProperty(h)&&(c.style[h]=b[h]);if(a=a.attributes)for(var n in a)a.hasOwnProperty(n)&&
c.setAttribute(n,a[n])}}function k(a){return a instanceof Array?a.slice(0):a}function c(a,c){if(!a)return c;if(!c)return a;for(var b in c)c.hasOwnProperty(b)&&(a.hasOwnProperty(b)||(a[b]=c[b]));return a}function a(r,c){if(r===c)return!0;if(r&&!c||!r&&c||r&&r.constructor===String||c&&c.constructor===String)return!1;if(r instanceof Array||c instanceof Array){if(!(r instanceof Array&&c instanceof Array)||r.length!==c.length)return!1;for(var b=0;b<r.length;b++)if(!a(r[b],c[b]))return!1;return!0}if(!(r instanceof
Object)||!(c instanceof Object))return!1;for(b in r)if(r.hasOwnProperty(b)&&(!c.hasOwnProperty(b)||!a(r[b],c[b])))return!1;for(b in c)if(!r.hasOwnProperty(b))return!1;return!0}function h(a,c,b){for(var d=0,h=0,e=0,n=a.length;e<n;){-1!==d&&d<=e&&(d=a.indexOf("\r",e));-1!==h&&h<=e&&(h=a.indexOf("\n",e));var k=e,p;if(-1===h&&-1===d){c(a.substring(e));break}-1!==d&&-1!==h?d+1===h?(p=d,e=h+1):(p=d<h?d:h,e=(d<h?d:h)+1):-1!==d?(p=d,e=d+1):(p=h,e=h+1);c(a.substring(k,p));b()}}function n(a){var c,b,d,h,e=
a.ownerDocument.defaultView||a.ownerDocument.parentWindow;e.getComputedStyle?(a=e.getComputedStyle(a,null),c=a.getPropertyValue("padding-left"),b=a.getPropertyValue("padding-top"),d=a.getPropertyValue("padding-right"),h=a.getPropertyValue("padding-bottom")):a.currentStyle&&(c=a.currentStyle.paddingLeft,b=a.currentStyle.paddingTop,d=a.currentStyle.paddingRight,h=a.currentStyle.paddingBottom);return{left:parseInt(c,10)||0,top:parseInt(b,10)||0,right:parseInt(d,10)||0,bottom:parseInt(h,10)||0}}function p(a){var c,
...
350,c=this.options.easing||this.defaultEasing,b=this.options.onAnimate||function(){},d=this.options.curve[0],h=this.options.curve[1],e=h-d,n=-1,k,p=this;this.interval=this.options.window.setInterval(function(){n=-1===n?(new Date).getTime():n;var g=((new Date).getTime()-n)/a;1>g?(g=c(g),k=d+g*e,b(k)):(b(h),p.stop())},"number"===typeof this.options.rate?this.options.rate:20)};z.prototype.stop=function(){this.options.window.clearInterval(this.interval);(this.options.onEnd||function(){})()};z.prototype.defaultEasing=
...
this.end+(this.caret?" caret is at start":" caret is at end")},isEmpty:function(){return this.start===this.end},equals:function(a){return this.caret===a.caret&&this.start===a.start&&this.end===a.end}};s.prototype={toString:function(){return"{l="+this.left+", t="+this.top+", r="+this.right+", b="+this.bottom+"}"}};w.prototype={create:function(a,c){if(!this._lineDiv){var b=this._lineDiv=this._createLine(a,c,this.lineIndex);b._line=this;return b}},_createLine:function(r,c,b){var h=this.view,n=h._model,
k=n.getLine(b),p=n.getLineStart(b),g={type:"LineStyle",textView:h,lineIndex:b,lineText:k,lineStart:p};if(2E3>k.length)h.onLineStyle(g);n=c||e.createElement(r.ownerDocument,"div");if(!c||!a(c.viewStyle,g.style))d(g.style,n,c),c&&(c._trim=null),n.viewStyle=g.style,n.setAttribute("role","presentation");n.lineIndex=b;b=[];this._createRanges(g.ranges,k,0,k.length,p,{tabOffset:0,ranges:b});k=" ";!h._fullSelection&&9>e.isIE&&(k="\ufeff");g={text:k,style:h._metrics.largestFontStyle,ignoreChars:1};0===b.length||
!b[b.length-1].style||"div"!==b[b.length-1].style.tagName?b.push(g):b.splice(b.length-1,0,g);var f,l,s,m,w,k=h=0,v,u;if(c){if(l=c.modelChangedEvent)0===l.removedLineCount&&0===l.addedLineCount?(u=l.start-p,v=l.addedCharCount-l.removedCharCount):u=-1,c.modelChangedEvent=void 0;l=c.firstChild}for(p=0;p<b.length;p++){g=b[p];m=g.text;h+=m.length;f=g.style;if(l)if(w=l.firstChild.data,s=l.viewStyle,w===m&&a(f,s)){k+=w.length;l._rectsCache=void 0;f=l=l.nextSibling;continue}else for(;l;){if(-1!==u){s=h;s>=
u&&(s-=v);w=(w=l.firstChild.data)?w.length:0;if(k+w>s)break;k+=w}s=l.nextSibling;n.removeChild(l);l=s}f=this._createSpan(n,m,f,g.ignoreChars);l?n.insertBefore(f,l):n.appendChild(f);c&&(c.lineWidth=void 0)}if(c)for(r=f?f.nextSibling:null;r;)s=r.nextSibling,c.removeChild(r),r=s;else r.appendChild(n);return n},_createRanges:function(r,c,b,d,h,e){if(!(b>d)){if(r)for(var n=0;n<r.length;n++){var k=r[n];if(!(k.end<h+b)){var p=Math.max(h+b,k.start)-h;if(p>d)break;var g=Math.min(h+d,k.end)-h;if(p<=g){p=Math.max(b,
p);g=Math.min(d,g);b<p&&this._createRange(c,b,p,null,e);if(!k.style||!k.style.unmergeable)for(;n+1<r.length&&r[n+1].start-h===g&&a(k.style,r[n+1].style);)k=r[n+1],g=Math.min(h+d,k.end)-h,n++;this._createRange(c,p,g,k.style,e);b=g}}}b<d&&this._createRange(c,b,d,null,e)}},_createRange:function(a,c,b,d,h){if(!(c>b)){var e=this.view._customTabSize;if(e&&8!==e)for(var n=a.indexOf("\t",c);-1!==n&&n<b;){c<n&&(c={text:a.substring(c,n),style:d},h.ranges.push(c),h.tabOffset+=c.text.length);c=e-h.tabOffset%
e;if(0<c){for(var k="\u00a0",p=1;p<c;p++)k+=" ";c={text:k,style:d,ignoreChars:c-1};h.ranges.push(c);h.tabOffset+=c.text.length}c=n+1;if(c===b)return;n=a.indexOf("\t",c)}c<=b&&(c={text:a.substring(c,b),style:d},h.ranges.push(c),h.tabOffset+=c.text.length)}},_createSpan:function(a,c,b,h){var n=this.view,k="span";b&&b.tagName&&(k=b.tagName.toLowerCase());var p="a"===k;p&&(a.hasLink=!0);p&&!n._linksVisible&&(k="span");p=a.ownerDocument;a=e.createElement(a.ownerDocument,k);b&&b.html?(a.innerHTML=b.html,
a.ignore=!0):b&&b.node?(a.appendChild(b.node),a.ignore=!0):a.appendChild(p.createTextNode(b&&b.text?b.text:c));d(b,a);if("a"===k){var g=n._getWindow();x(a,"click",function(a){return n._handleLinkClick(a?a:g.event)},!1)}a.viewStyle=b;h&&(a.ignoreChars=h);return a},_ensureCreated:function(){return this._lineDiv?this._lineDiv:this._createdDiv=this.create(this.view._clientDiv,null)},getBoundingClientRect:function(a,c){var b=this._ensureCreated(),d=this.view;if(void 0===a)return this._getLineBoundingClientRect(b,
!0);var h=d._model,n=b.ownerDocument,k=this.lineIndex,p=null;if(a<h.getLineEnd(k)){k=h.getLineStart(k);for(h=b.firstChild;h;){if(!h.ignore){var g=h.firstChild,f=g.length;h.ignoreChars&&(f-=h.ignoreChars);if(k+f>a){p=a-k;if(1===g.length)p=new s(h.getBoundingClientRect());else if(d._isRangeRects)n=n.createRange(),n.setStart(g,p),n.setEnd(g,p+1),p=new s(n.getBoundingClientRect());else if(e.isIE)n=n.body.createTextRange(),n.moveToElementText(h),n.collapse(),(k=0===p&&8===e.isIE)&&(p=1),n.moveEnd("character",
p+1),n.moveStart("character",p),p=new s(n.getBoundingClientRect()),k&&(p.left=h.getClientRects()[0].left);else{var l=g.data;h.removeChild(g);h.appendChild(n.createTextNode(l.substring(0,p)));var m=e.createElement(n,"span");m.appendChild(n.createTextNode(l.substring(p,p+1)));h.appendChild(m);h.appendChild(n.createTextNode(l.substring(p+1)));p=new s(m.getBoundingClientRect());h.innerHTML="";h.appendChild(g);this._createdDiv||(n=d._getSelection(),(k<=n.start&&n.start<k+f||k<=n.end&&n.end<k+f)&&d._updateDOMSelection())}e.isIE&&
(n=b.ownerDocument.defaultView||b.ownerDocument.parentWindow,b=n.screen.logicalXDPI/n.screen.deviceXDPI,n=n.screen.logicalYDPI/n.screen.deviceYDPI,p.left*=b,p.right*=b,p.top*=n,p.bottom*=n);break}k+=f}h=h.nextSibling}}b=this.getBoundingClientRect();p||(d._wrapMode?(d=this.getClientRects(),p=d[d.length-1],p.left=p.right,p.left+=b.left,p.top+=b.top,p.right+=b.left,p.bottom+=b.top):(p=new s(b),p.left=p.right));if(c||void 0===c)p.left-=b.left,p.top-=b.top,p.right-=b.left,p.bottom-=b.top;return p},_getClientRects:function(a,
...
n[c],p;if(k.top!==k.bottom){var g=k.top+(k.bottom-k.top)/2;for(p=0;p<b.length&&!(h=b[p],h.top<=g&&g<h.bottom);p++);p===b.length?b.push(k):(k.left<h.left&&(h.left=k.left),k.top<h.top&&(h.top=k.top),k.right>h.right&&(h.right=k.right),k.bottom>h.bottom&&(h.bottom=k.bottom))}}d=d.nextSibling}return void 0!==a?b[a]:b},_getLineBoundingClientRect:function(a,c){var b=new s(a.getBoundingClientRect());if(!this.view._wrapMode){b.right=b.left;for(var d=a.lastChild;d&&d.ignoreChars===d.firstChild.length;)d=d.previousSibling;
...
var c=this.getClientRects();return this.getOffset(c[a].left+1,c[a].top+1)},getOffset:function(a,c){var b=this.view,d=b._model,h=this.lineIndex,n=d.getLineStart(h),k=d.getLineEnd(h);if(n===k)return n;var p=this._ensureCreated(),g=this.getBoundingClientRect(),f,l;if(b._wrapMode){f=this.getClientRects();c<f[0].top&&(c=f[0].top);for(var s=0;s<f.length&&!(l=f[s],l.top<=c&&c<l.bottom);s++);a<l.left&&(a=l.left);a>l.right&&(a=l.right-1)}else 0>a&&(a=0),a>g.right-g.left&&(a=g.right-g.left);var m=p.ownerDocument,
...
(m.setStart(q,f),m.setEnd(q,l)):(m.moveToElementText(u),m.move("character",f),m.moveEnd("character",l-f));f=m.getClientRects();b=!1;0<f.length&&(l=f[0],y=(G?K:l.left)*w-g.left,x=l.right*w-g.left,b=a>y+(x-y)/2);g=s-n;d=d.getLine(h);h=d.charCodeAt(g);55296<=h&&56319>=h&&b?g<d.length&&(h=d.charCodeAt(g+1),56320<=h&&57343>=h&&(s+=1)):56320<=h&&(57343>=h&&!b)&&0<g&&(h=d.charCodeAt(g-1),55296<=h&&56319>=h&&(s-=1));b&&s++}else{d=[];for(h=0;h<p;h++)d.push("<span>"),h===p-1?d.push(q.data.substring(h)):d.push(q.data.substring(h,
h+1)),d.push("</span>");u.innerHTML=d.join("");for(d=u.firstChild;d;){l=d.getBoundingClientRect();y=l.left-g.left;x=l.right-g.left;if(y<=a&&a<x){a>y+(x-y)/2&&s++;break}s++;d=d.nextSibling}this._createdDiv||(u.innerHTML="",u.appendChild(q),g=b._getSelection(),(s<=g.start&&g.start<s+p||s<=g.end&&g.end<s+p)&&b._updateDOMSelection())}break a}s+=p}u=u.nextSibling}return Math.min(k,Math.max(n,s))},getNextOffset:function(a,c){if("line"===c.unit){var b=this.view._model,d=b.getLineAtOffset(a);if(0<c.count)return c.count--,
b.getLineEnd(d);c.count++;return b.getLineStart(d)}return"wordend"===c.unit||"wordWS"===c.unit||"wordendWS"===c.unit?this._getNextOffset_W3C(a,c):e.isIE?this._getNextOffset_IE(a,c):this._getNextOffset_W3C(a,c)},_getNextOffset_W3C:function(a,c){function b(a){return 33<=a&&47>=a||58<=a&&64>=a||91<=a&&94>=a||96===a||123<=a&&126>=a}function d(a){return 32===a||9===a}var h=this.view._model,e=h.getLineAtOffset(a),n=h.getLine(e),k=h.getLineStart(e),h=h.getLineEnd(e),e=n.length,p=a-k,g,f=0>c.count?-1:1;if("word"===
c.unit||"wordend"===c.unit||"wordWS"===c.unit||"wordendWS"===c.unit)for(var l,s,m;0!==c.count;){if(0<c.count){if(p===e)return h;g=n.charCodeAt(p);l=b(g);s=!l&&!d(g);for(p++;p<e;){g=n.charCodeAt(p);if("wordWS"!==c.unit&&"wordendWS"!==c.unit){m=b(g);if("wordend"===c.unit){if(!m&&l)break}else if(m&&!l)break;g=!m&&!d(g)}else g=!d(g);if("wordend"===c.unit||"wordendWS"===c.unit){if(!g&&s)break}else if(g&&!s)break;s=g;l=m;p++}}else{if(0===p)return k;p--;g=n.charCodeAt(p);l=b(g);for(s=!l&&!d(g);0<p;){g=n.charCodeAt(p-
1);if("wordWS"!==c.unit&&"wordendWS"!==c.unit){m=b(g);if("wordend"===c.unit){if(m&&!l)break}else if(!m&&l)break;g=!m&&!d(g)}else g=!d(g);if("wordend"===c.unit||"wordendWS"===c.unit){if(g&&!s)break}else if(!g&&s)break;s=g;l=m;p--}}c.count-=f}else for(;0!==c.count&&0<=p+f&&p+f<=e;)p+=f,g=n.charCodeAt(p),56320<=g&&57343>=g&&0<p&&(g=n.charCodeAt(p-1),55296<=g&&56319>=g&&(p+=f)),c.count-=f;return k+p},_getNextOffset_IE:function(a,c){var b=this._ensureCreated(),d=this.view._model,h=this.lineIndex,e=0,n;
n=d.getLineStart(h);var k=b.ownerDocument,p=0>c.count?-1:1;if(a===d.getLineEnd(h)){for(b=b.lastChild;b&&b.ignoreChars===b.firstChild.length;)b=b.previousSibling;if(!b)return n;e=k.body.createTextRange();e.moveToElementText(b);n=e.text.length;e.moveEnd(c.unit,p);e=a+e.text.length-n}else if(a===n&&0>c.count)e=n;else for(b=b.firstChild;b;){d=b.firstChild.length;b.ignoreChars&&(d-=b.ignoreChars);if(n+d>a){e=k.body.createTextRange();if(a===n&&0>c.count){for(n=b.previousSibling;n&&(!n.firstChild||!n.firstChild.length);)n=
...
this._getLine(h),k=this._columnX,p=1,g=!1;if(-1===k||a.wholeLine||a.select&&e.isIE)k=a.wholeLine?c.getLineEnd(h+1):d,k=n.getBoundingClientRect(k).left;(d=n.getLineIndex(d))<n.getLineCount()-1?p=n.getClientRects(d+1).top+1:(d=c.getLineCount()-1,g=h===d,a.count&&0<a.count?h=Math.min(h+a.count,d):h++);d=!1;if(g){if(a.select||e.isMac||e.isLinux)b.extend(c.getCharCount()),d=!0}else n.lineIndex!==h&&(n.destroy(),n=this._getLine(h)),b.extend(n.getOffset(k,p)),d=!0;d&&(a.select||b.collapse(),this._setSelection(b,
!0,!0));this._columnX=k;n.destroy();return!0},_doLineUp:function(a){var c=this._model,b=this._getSelection(),d=b.getCaret(),h=c.getLineAtOffset(d),n=this._getLine(h),k=this._columnX,p=!1,g;if(-1===k||a.wholeLine||a.select&&e.isIE)k=a.wholeLine?c.getLineStart(h-1):d,k=n.getBoundingClientRect(k).left;0<(d=n.getLineIndex(d))?g=n.getClientRects(d-1).top+1:(p=0===h,p||(a.count&&0<a.count?h=Math.max(h-a.count,0):h--,g=this._getLineHeight(h)-1));d=!1;if(p){if(a.select||e.isMac||e.isLinux)b.extend(0),d=!0}else n.lineIndex!==
h&&(n.destroy(),n=this._getLine(h)),b.extend(n.getOffset(k,g)),d=!0;d&&(a.select||b.collapse(),this._setSelection(b,!0,!0));this._columnX=k;n.destroy();return!0},_doNoop:function(){return!0},_doPageDown:function(a){var c=this,b=this._model,d=this._getSelection(),h=d.getCaret(),n=b.getLineAtOffset(h),k=b.getLineCount(),p=this._getScroll(),b=this._getClientHeight(),g,f;if(this._lineHeight){g=this._columnX;p=this._getBoundsAtOffset(h);if(-1===g||a.select&&e.isIE)g=p.left;h=this._getLineIndex(p.top+b);
f=this._getLine(h);n=this._getLinePixel(h);h=f.getOffset(g,p.top+b-n);b=f.getBoundingClientRect(h);f.destroy();d.extend(h);a.select||d.collapse();this._setSelection(d,!0,!0,function(){c._columnX=g},b.top+n-p.top);return!0}if(n<k-1){var l=this._getLineHeight(),s=Math.min(k-n-1,Math.floor(b/l)),s=Math.max(1,s);g=this._columnX;if(-1===g||a.select&&e.isIE)f=this._getLine(n),g=f.getBoundingClientRect(h).left,f.destroy();f=this._getLine(n+s);d.extend(f.getOffset(g,0));f.destroy();a.select||d.collapse();
a=k*l;h=p.y+s*l;h+b>a&&(h=a-b);this._setSelection(d,!0,!0,function(){c._columnX=g},h-p.y)}return!0},_doPageUp:function(a){var c=this,b=this._model,d=this._getSelection(),h=d.getCaret(),n=b.getLineAtOffset(h),k=this._getScroll(),p=this._getClientHeight(),g;if(this._lineHeight){g=this._columnX;k=this._getBoundsAtOffset(h);if(-1===g||a.select&&e.isIE)g=k.left;h=this._getLineIndex(k.bottom-p);b=this._getLine(h);n=this._getLinePixel(h);h=b.getOffset(g,k.bottom-p-n);p=b.getBoundingClientRect(h);b.destroy();
d.extend(h);a.select||d.collapse();this._setSelection(d,!0,!0,function(){c._columnX=g},p.top+n-k.top);return!0}if(0<n){var f=this._getLineHeight(),p=Math.max(1,Math.min(n,Math.floor(p/f)));g=this._columnX;if(-1===g||a.select&&e.isIE)b=this._getLine(n),g=b.getBoundingClientRect(h).left,b.destroy();b=this._getLine(n-p);d.extend(b.getOffset(g,this._getLineHeight(n-p)-1));b.destroy();a.select||d.collapse();a=Math.max(0,k.y-p*f);this._setSelection(d,!0,!0,function(){c._columnX=g},a-k.y)}return!0},_doPaste:function(a){var c=
...
b=this._getLinePixel(c.lineIndex);a.top+=b;a.bottom+=b;c.destroy();return a},_getClientHeight:function(){var a=this._getViewPadding();return Math.max(0,this._viewDiv.clientHeight-a.top-a.bottom)},_getClientWidth:function(){var a=this._getViewPadding();return Math.max(0,this._viewDiv.clientWidth-a.left-a.right)},_getClipboardText:function(a,c){var b=this._model.getLineDelimiter(),d,n,k=this._getWindow(),p=k.clipboardData;!p&&a&&(p=a.clipboardData);if(p)return d=[],n=p.getData(e.isIE?"Text":"text/plain"),
h(n,function(a){d.push(a)},function(){d.push(b)}),n=d.join(""),c&&c(n),n;if(e.isFirefox){this._ignoreFocus=!0;var g=this._clipboardDiv,p=this._rootDiv.ownerDocument;g||(this._clipboardDiv=g=e.createElement(p,"div"),g.style.position="fixed",g.style.whiteSpace="pre",g.style.left="-1000px",this._rootDiv.appendChild(g));g.innerHTML="<pre contenteditable=''></pre>";g.firstChild.focus();var f=this,l=function(){var a=f._getTextFromElement(g);g.innerHTML="";d=[];h(a,function(a){d.push(a)},function(){d.push(b)});
return d.join("")},s=!1;this._ignorePaste=!0;if(!e.isLinux||2!==this._lastMouseButton)try{s=p.execCommand("paste",!1,null)}catch(m){s=1<g.childNodes.length||g.firstChild&&0<g.firstChild.childNodes.length}this._ignorePaste=!1;if(!s){if(a)return k.setTimeout(function(){f.focus();(n=l())&&c&&c(n);f._ignoreFocus=!1},0),null;this.focus();this._ignoreFocus=!1;return""}this.focus();this._ignoreFocus=!1;(n=l())&&c&&c(n);return n}return""},_getDOMText:function(a,c){for(var b=a.firstChild,d="",h=0;b;){var e;
if(!b.ignore)if(b.ignoreChars){e=b.lastChild;for(var n=0,k=[],p=-1;e;){var g=e.data;if(g)for(var f=g.length-1;0<=f;f--){var l=g.substring(f,f+1);n<b.ignoreChars&&(" "===l||"\u200b"===l||"\ufeff"===l)?n++:k.push("\u00a0"===l?"\t":l)}c===e&&(p=k.length);e=e.previousSibling}k=k.reverse().join("");-1!==p&&(h=d.length+k.length-p);d+=k}else for(e=b.firstChild;e;)c===e&&(h=d.length),d+=e.data,e=e.nextSibling;b=b.nextSibling}return{text:d,offset:h}},_getTextFromElement:function(a){var c=a.ownerDocument,b=
...
type:"keypress",handler:function(c){return a._handleKeyPress(c?c:p.event)}});c.push({target:b,type:"keyup",handler:function(c){return a._handleKeyUp(c?c:p.event)}});e.isIE&&c.push({target:k,type:"keyup",handler:function(c){return a._handleDocKeyUp(c?c:p.event)}});c.push({target:b,type:"contextmenu",handler:function(c){return a._handleContextMenu(c?c:p.event)}});c.push({target:b,type:"copy",handler:function(c){return a._handleCopy(c?c:p.event)}});c.push({target:b,type:"cut",handler:function(c){return a._handleCut(c?
c:p.event)}});c.push({target:b,type:"paste",handler:function(c){return a._handlePaste(c?c:p.event)}});if(e.isIOS||e.isAndroid)c.push({target:k,type:"selectionchange",handler:function(c){return a._handleSelectionChange(c?c:p.event)}}),c.push({target:b,type:"touchstart",handler:function(c){return a._handleTouchStart(c?c:p.event)}}),c.push({target:b,type:"touchmove",handler:function(c){return a._handleTouchMove(c?c:p.event)}}),c.push({target:b,type:"touchend",handler:function(c){return a._handleTouchEnd(c?
...
type:"mousemove",handler:function(c){return a._handleMouseMove(c?c:p.event)}});c.push({target:h,type:"mousedown",handler:function(c){return a._handleRootMouseDown(c?c:p.event)}});c.push({target:h,type:"mouseup",handler:function(c){return a._handleRootMouseUp(c?c:p.event)}});c.push({target:n,type:"dragstart",handler:function(c){return a._handleDragStart(c?c:p.event)}});c.push({target:n,type:"drag",handler:function(c){return a._handleDrag(c?c:p.event)}});c.push({target:n,type:"dragend",handler:function(c){return a._handleDragEnd(c?
...
type:"dblclick",handler:function(c){return a._handleDblclick(c?c:p.event)}})}this._hookRulerEvents(this._leftDiv,c);this._hookRulerEvents(this._rightDiv,c);this._hookRulerEvents(this._marginDiv,c);for(d=0;d<c.length;d++)h=c[d],x(h.target,h.type,h.handler,h.capture)},_hookRulerEvents:function(a,c){if(a){var b=this,d=this._getWindow();e.isIE&&c.push({target:a,type:"selectstart",handler:function(){return!1}});c.push({target:a,type:e.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(a){return b._handleMouseWheel(a?
...
c),b&&d.setTimeout(b,0)},_scrollView:function(a,c){this._ensureCaretVisible=!1;var b=this._viewDiv;a&&(b.scrollLeft+=a);c&&(b.scrollTop+=c)},_setClipboardText:function(a,c){var b,d=this._getWindow(),n=d.clipboardData;!n&&c&&(n=c.clipboardData);if(n&&(b=[],h(a,function(a){b.push(a)},function(){b.push(e.platformDelimiter)}),n.setData(e.isIE?"Text":"text/plain",b.join(""))))return!0;var k=this._parent.ownerDocument,p=e.createElement(k,"pre");p.style.position="fixed";p.style.left="-1000px";h(a,function(a){p.appendChild(k.createTextNode(a))},
function(){p.appendChild(e.createElement(k,"br"))});p.appendChild(k.createTextNode(" "));this._clientDiv.appendChild(p);n=k.createRange();n.setStart(p.firstChild,0);n.setEndBefore(p.lastChild);var g=d.getSelection();0<g.rangeCount&&g.removeAllRanges();g.addRange(n);var f=this,n=function(){p&&p.parentNode===f._clientDiv&&f._clientDiv.removeChild(p);f._updateDOMSelection()},g=!1;this._ignoreCopy=!0;try{g=k.execCommand("copy",!1,null)}catch(l){}this._ignoreCopy=!1;if(!g&&c)return d.setTimeout(n,0),!1;
n();return!0},_setDOMSelection:function(a,c,b,d,h){for(var n,k,p,g,f=0,l=a.firstChild,s,m,w=this._model.getLine(a.lineIndex).length;l;){if(!l.ignore){s=l.firstChild;m=s.length;l.ignoreChars&&(m-=l.ignoreChars);if(f+m>c||f+m>=w){n=s;k=c-f;l.ignoreChars&&(0<m&&k===m)&&(k+=l.ignoreChars);break}f+=m}l=l.nextSibling}for(var f=0,l=b.firstChild,u=this._model.getLine(b.lineIndex).length;l;){if(!l.ignore){s=l.firstChild;m=s.length;l.ignoreChars&&(m-=l.ignoreChars);if(m+f>d||f+m>=u){p=s;g=d-f;l.ignoreChars&&
(0<m&&g===m)&&(g+=l.ignoreChars);break}f+=m}l=l.nextSibling}this._setDOMFullSelection(a,c,w,b,d,u);a=this._getWindow();c=this._parent.ownerDocument;if(a.getSelection){b=a.getSelection();a=c.createRange();a.setStart(n,k);a.setEnd(p,g);if(this._hasFocus&&(b.anchorNode!==n||b.anchorOffset!==k||b.focusNode!==p||b.focusOffset!==g||b.anchorNode!==p||b.anchorOffset!==g||b.focusNode!==n||b.focusOffset!==k))this._anchorNode=n,this._anchorOffset=k,this._focusNode=p,this._focusOffset=g,this._ignoreSelect=!1,
0<b.rangeCount&&b.removeAllRanges(),b.addRange(a),this._ignoreSelect=!0;this._cursorDiv&&(a=c.createRange(),h?(a.setStart(n,k),a.setEnd(n,k)):(a.setStart(p,g),a.setEnd(p,g)),p=a.getClientRects()[0],g=this._cursorDiv.parentNode,n=g.getBoundingClientRect(),p&&n&&(this._cursorDiv.style.top=p.top-n.top+g.scrollTop+"px",this._cursorDiv.style.left=p.left-n.left+g.scrollLeft+"px"))}else c.selection&&this._hasFocus&&(h=c.body,a=e.createElement(c,"div"),h.appendChild(a),h.removeChild(a),a=h.createTextRange(),
a.moveToElementText(n.parentNode),a.moveStart("character",k),n=h.createTextRange(),n.moveToElementText(p.parentNode),n.moveStart("character",g),a.setEndPoint("EndToStart",n),this._ignoreSelect=!1,a.select(),this._ignoreSelect=!0)},_setDOMFullSelection:function(a,c,b,d,h){if(this._selDiv1&&(b=this._selDiv1,b.style.width="0px",b.style.height="0px",b=this._selDiv2,b.style.width="0px",b.style.height="0px",b=this._selDiv3,b.style.width="0px",b.style.height="0px",!(a===d&&c===h))){var e=this._model,n=this._getViewPadding(),
k=this._clientDiv.getBoundingClientRect(),p=this._viewDiv.getBoundingClientRect(),b=p.left+n.left,g=k.right,n=p.top+n.top,f=k.bottom,p=k=0;this._clipDiv?(p=this._clipDiv.getBoundingClientRect(),k=p.left-this._clipDiv.scrollLeft):(p=this._rootDiv.getBoundingClientRect(),k=p.left);p=p.top;this._ignoreDOMSelection=!0;var l=(new w(this,a.lineIndex,a)).getBoundingClientRect(e.getLineStart(a.lineIndex)+c,!1),s=l.left,c=(new w(this,d.lineIndex,d)).getBoundingClientRect(e.getLineStart(d.lineIndex)+h,!1),
e=c.left;this._ignoreDOMSelection=!1;var m=this._selDiv1,s=Math.min(g,Math.max(b,s)),u=Math.min(f,Math.max(n,l.top)),v=g,h=Math.min(f,Math.max(n,l.bottom));m.style.left=s-k+"px";m.style.top=u-p+"px";m.style.width=Math.max(0,v-s)+"px";m.style.height=Math.max(0,h-u)+"px";a.lineIndex===d.lineIndex?(v=Math.min(e,g),m.style.width=Math.max(0,v-s)+"px"):(l=Math.min(f,Math.max(n,c.top)),e=Math.min(g,Math.max(b,e)),n=Math.min(f,Math.max(n,c.bottom)),f=this._selDiv3,f.style.left=b-k+"px",f.style.top=l-p+"px",
f.style.width=Math.max(0,e-b)+"px",f.style.height=Math.max(0,n-l)+"px",1<Math.abs(a.lineIndex-d.lineIndex)&&(a=this._selDiv2,a.style.left=b-k+"px",a.style.top=h-p+"px",a.style.width=Math.max(0,g-b)+"px",a.style.height=Math.max(0,l-h)+"px"))}},_setGrab:function(a){a!==this._grabControl&&(a?(a.setCapture&&a.setCapture(),this._grabControl=a):(this._grabControl.releaseCapture&&this._grabControl.releaseCapture(),this._grabControl=null))},_setLinksVisible:function(a){if(this._linksVisible!==a){this._linksVisible=
...
n=this._getScroll(),k=e.getCaret(),p=e.start,g=e.end,f=h.getLineAtOffset(g),l=Math.max(Math.max(p,h.getLineStart(f)),g-1),h=this._getClientWidth(),f=this._getClientHeight(),s=h/4,m=this._getBoundsAtOffset(k===p?p:l),w=m.left,u=m.right,v=m.top,q=m.bottom;a&&!e.isEmpty()&&(m=this._getBoundsAtOffset(k===g?p:l),m.top===v?k===p?u=w+Math.min(m.right-w,h):w=u-Math.min(u-m.left,h):k===p?q=v+Math.min(m.bottom-v,f):v=q-Math.min(q-m.top,f));a=0;w<n.x&&(a=Math.min(w-n.x,-s));u>n.x+h&&(a=Math.max(u-n.x-h,s));
e=0;v<n.y?e=v-n.y:q>n.y+f&&(e=q-n.y-f);d&&(0<d?0<e&&(e=Math.max(e,d)):0>e&&(e=Math.min(e,d)));if(0!==a||0!==e)return 0!==e&&"number"===typeof b&&(0>b&&(b=0),1<b&&(b=1),e+=Math.floor(0<e?b*f:-b*f)),this._scrollViewAnimated(a,e,c),f!==this._getClientHeight()||h!==this._getClientWidth()?this._showCaret():this._ensureCaretVisible=!0,!0;c&&c();return!1}},_startIME:function(){if(-1===this._imeOffset){var a=this._getSelection();a.isEmpty()||this._modifyContent({text:"",start:a.start,end:a.end},!0);this._imeOffset=
...
(this._getWindow().clearTimeout(this._updateTimer),this._updateTimer=null,a=!1);var c=this._clientDiv,b=this._viewDiv;if(c){this._metrics.invalid&&(this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1);var d=this._model,h=this._getScroll(!1),n=this._getViewPadding(),k=d.getLineCount(),p=this._getLineHeight(),g=!1,f=!1,l=!1,s=this._metrics.scrollWidth;this._wrapMode&&(c.style.width=(this._metrics.wrapWidth||this._getClientWidth())+"px");var m,u,v,q,y=0,z=0,x;if(this._lineHeight){for(;z<
k;){x=this._getLineHeight(z);if(y+x>h.y)break;y+=x;z++}m=z;u=Math.max(0,m-1);v=d=h.y-y;0<m&&(d+=this._getLineHeight(m-1))}else q=Math.max(0,h.y)/p,m=Math.floor(q),u=Math.max(0,m-1),d=Math.round((q-u)*p),v=Math.round((q-m)*p);this._topIndexY=v;q=this._rootDiv;var P=q.clientWidth,K=q.clientHeight;if(a){p=0;this._leftDiv&&(m=this._leftDiv.getBoundingClientRect(),p=m.right-m.left);m=this._getClientWidth();q=this._getClientHeight();f=m;this._wrapMode?this._metrics.wrapWidth&&(f=this._metrics.wrapWidth):
f=Math.max(this._maxLineWidth,f);for(;z<k;)x=this._getLineHeight(z,!1),y+=x,z++;k=y}else{q=this._getClientHeight();v=Math.min(m+Math.floor((q+v)/p),k-1);var h=Math.min(v+1,k-1),G;for(x=c.firstChild;x;){G=x.lineIndex;var F=x.nextSibling;if(!(u<=G&&G<=h)||x.lineRemoved||-1===x.lineIndex)this._mouseWheelLine===x?(x.style.display="none",x.lineIndex=-1):c.removeChild(x);x=F}x=this._getLineNext();var F=b.ownerDocument,L=F.createDocumentFragment();for(G=u;G<=h;G++)!x||x.lineIndex>G?(new w(this,G)).create(L,
...
-1,0<=G&&G<k&&(p=new w(this,G),F=p.getBoundingClientRect(),u=F.right-F.left,u>=this._maxLineWidth&&(this._maxLineWidth=u,this._maxLineIndex=G),p.destroy()));for(;z<k;)x=this._getLineHeight(z,z<=v),y+=x,z++;k=y;this._updateRuler(this._leftDiv,m,h,K);this._updateRuler(this._rightDiv,m,h,K);this._updateRuler(this._marginDiv,m,h,K);p=0;this._leftDiv&&(m=this._leftDiv.getBoundingClientRect(),p=m.right-m.left);h=0;this._rightDiv&&(h=this._rightDiv.getBoundingClientRect(),h=h.right-h.left);b.style.left=
p+"px";b.style.right=h+"px";h=this._scrollDiv;h.style.height=k+"px";m=this._getClientWidth();!this._singleMode&&!this._wrapMode&&(y=g=q,(z="scroll"===b.style.overflowX)?g+=s:y-=s,x=v=m,(u="scroll"===b.style.overflowY)?v+=s:x-=s,q=g,m=v,k>q&&(l=!0,m=x),this._maxLineWidth>m&&(f=!0,q=y,k>q&&(l=!0,m=x)),z!==f&&(b.style.overflowX=f?"scroll":"hidden"),u!==l&&(b.style.overflowY=l?"scroll":"hidden"),g=z!==f||u!==l);l=m;this._wrapMode?this._metrics.wrapWidth&&(l=this._metrics.wrapWidth):l=Math.max(this._maxLineWidth,
l);f=l;if((!e.isIE||9<=e.isIE)&&this._maxLineWidth>m)l+=n.right+n.left;h.style.width=l+"px";this._clipScrollDiv&&(this._clipScrollDiv.style.width=l+"px");h=this._getScroll(!1)}this._vScrollDiv&&(l=q-8,y=Math.max(15,Math.ceil(Math.min(1,l/(k+n.top+n.bottom))*l)),this._vScrollDiv.style.left=p+m-8+"px",this._vScrollDiv.style.top=Math.floor(Math.max(0,h.y*l/k))+"px",this._vScrollDiv.style.height=y+"px");!this._wrapMode&&this._hScrollDiv&&(l=m-8,y=Math.max(15,Math.ceil(Math.min(1,l/(this._maxLineWidth+
n.left+n.right))*l)),this._hScrollDiv.style.left=p+Math.floor(Math.max(0,Math.floor(h.x*l/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=q-9+"px",this._hScrollDiv.style.width=y+"px");z=h.x;y=this._clipDiv;l=this._overlayDiv;if(v=this._marginDiv)v.style.left=-z+p+this._metrics.marginWidth+n.left+"px",v.style.bottom=("scroll"===b.style.overflowX?s:0)+"px";y?(y.scrollLeft=z,y.scrollTop=0,b=p+n.left,s=n.top,a=m,p=q,z=0,v=-d,0===h.x&&(b-=n.left,a+=n.left,z=n.left),h.x+m===f&&(a+=n.right),0===h.y&&
(s-=n.top,p+=n.top,v+=n.top),h.y+q===k&&(p+=n.bottom),y.style.left=b+"px",y.style.top=s+"px",y.style.right=P-a-b+"px",y.style.bottom=K-p-s+"px",c.style.left=z+"px",c.style.top=v+"px",c.style.width=f+"px",c.style.height=q+d+"px",l&&(l.style.left=c.style.left,l.style.top=c.style.top,l.style.width=c.style.width,l.style.height=c.style.height)):(b=z,s=d,P=z+m,K=d+q,0===b&&(b-=n.left),0===s&&(s-=n.top),P===f&&(P+=n.right),h.y+q===k&&(K+=n.bottom),c.style.clip="rect("+s+"px,"+P+"px,"+K+"px,"+b+"px)",c.style.left=
...
a._model.setText(this._change.text,h.start,n.end):(this._model.setText(this._change.text,b,f),h&&(a=h.projection,a._model.setText("",h.start)),n&&(a=n.projection,a._model.setText("",0,n.end),a.start=a.end,a._lineCount=0));this._change=void 0}};m.EventTarget.addMixin(q.prototype);return{ProjectionTextModel:q}});
...
h;else if(this._isNode(h))a.appendChild(h);else if(h instanceof b.ProjectionTextModel){var n=this._view,p=n.getOptions();p.wrapMode=!1;p.parent=a;var f=p.themeClass;f?((f=f.replace("tooltipTheme",""))&&(f=" "+f),f="tooltipTheme"+f):f="tooltipTheme";p.themeClass=f;p=this._contentsView=new m.TextView(p);p.addEventListener("LineStyle",function(a){n.onLineStyle(a)});p.setModel(h);h=p.computeSize();a.style.width=h.width+"px";a.style.height=h.height+"px";p.resize()}else return;a=c.ownerDocument.documentElement;
"right"===e.anchor?(h=a.clientWidth-e.x,c.style.right=h+"px"):(h=parseInt(this._getNodeStyle(c,"padding-left","0"),10),h+=parseInt(this._getNodeStyle(c,"border-left-width","0"),10),h=e.x-h,c.style.left=h+"px");c.style.maxWidth=a.clientWidth-h-10+"px";h=parseInt(this._getNodeStyle(c,"padding-top","0"),10);h+=parseInt(this._getNodeStyle(c,"border-top-width","0"),10);h=e.y-h;c.style.top=h+"px";c.style.maxHeight=a.clientHeight-h-10+"px";c.style.opacity="1";c.style.visibility="visible";if(d){var g=this,
...
this._annotations,d,e=0,k;k=void 0===c&&void 0===a?function(){return e<b.length?b[e++]:null}:function(){for(;e<b.length;){var d=b[e++];if(c===d.start||(c>d.start?c<d.end:d.start<a))return d;if(d.start>=a)break}return null};d=k();return{next:function(){var a=d;a&&(d=k());return a},hasNext:function(){return null!==d}}},modifyAnnotation:function(c){if(c&&!(0>this._getAnnotationIndex(c)))this.onChanged({type:"Changed",added:[],removed:[],changed:[c]})},onChanged:function(c){return this.dispatchEvent(c)},
...
d,e,k,f=[];if(c)for(d=c.length-1;0<=d;d--)k=c[d],e=this._getAnnotationIndex(k),0>e||(k._annotationModel=null,b.splice(e,1),f.splice(0,0,k));a||(a=[]);for(d=0;d<a.length;d++)k=a[d],e=this._binarySearch(b,k.start),k._annotationModel=this,b.splice(e,0,k);this.onChanged({type:"Changed",removed:f,added:a,changed:[]})},setTextModel:function(c){this._model&&this._model.removeEventListener("Changed",this._listener.onChanged);(this._model=c)&&this._model.addEventListener("Changed",this._listener.onChanged)},
_binarySearch:function(c,a){for(var b=c.length,d=-1,e;1<b-d;)e=Math.floor((b+d)/2),a<=c[e].start?b=e:d=e;return b},_getAnnotationIndex:function(c){for(var a=this._annotations,b=this._binarySearch(a,c.start);b<a.length&&a[b].start===c.start;){if(a[b]===c)return b;b++}return-1},_onChanged:function(c){var a=c.start,b=c.addedCharCount,d=c.removedCharCount,e=this._annotations,k=a+d;if(0<e.length){c={type:"Changed",added:[],removed:[],changed:[],textModelChangedEvent:c};b-=d;for(d=0;d<e.length;d++){var f=
e[d];f.start>=k?(f._oldStart=f.start,f._oldEnd=f.end,f.start+=b,f.end+=b,c.changed.push(f)):f.end<=a||(f.start<a&&k<f.end?(f._oldStart=f.start,f._oldEnd=f.end,f.end+=b,c.changed.push(f)):(e.splice(d,1),c.removed.push(f),f._annotationModel=null,f.expand&&f.expand(),d--))}if(0<c.added.length||0<c.removed.length||0<c.changed.length)this.onChanged(c)}}};m.EventTarget.addMixin(e.prototype);d.prototype={destroy:function(){var c=this._view;c&&(c.removeEventListener("Destroy",this._listener.onDestroy),c.removeEventListener("LineStyle",
...
(c.attributes[b]=a.attributes[b])}return c},_mergeStyleRanges:function(c,a){c||(c=[]);var b,d;for(d=0;d<c.length&&a;d++){var e=c[d];if(a.end<=e.start)break;if(!(a.start>=e.end)){b=this._mergeStyle({},e.style);b=this._mergeStyle(b,a.style);var k=[];k.push(d,1);a.start<e.start&&k.push({start:a.start,end:e.start,style:a.style});a.start>e.start&&k.push({start:e.start,end:a.start,style:e.style});k.push({start:Math.max(e.start,a.start),end:Math.min(e.end,a.end),style:b});a.end<e.end&&k.push({start:a.end,
end:e.end,style:e.style});a=a.end>e.end?{start:e.end,end:a.end,style:a.style}:null;Array.prototype.splice.apply(c,k)}}a&&(b=this._mergeStyle({},a.style),c.splice(d,0,{start:a.start,end:a.end,style:b}));return c},_onAnnotationModelChanged:function(c){function a(a,c){k.getBaseModel&&(a=k.mapOffset(a,!0),c=k.mapOffset(c,!0));-1!==a&&-1!==c&&d.redrawRange(a,c)}function b(c,d){for(var h=0;h<c.length;h++)if(e.isAnnotationTypeVisible(c[h].type)){var n=c[h];a(n.start,n.end);d&&(void 0!==n._oldStart&&n._oldEnd)&&
a(n._oldStart,n._oldEnd)}}var d=this._view;if(d){var e=this,k=d.getModel();b(c.added);b(c.removed);b(c.changed,!0)}},_onDestroy:function(){this.destroy()},_onLineStyle:function(c){var a=this._annotationModel,b=c.textView.getModel(),d=a.getTextModel(),e=c.lineStart,k=c.lineStart+c.lineText.length;d!==b&&(e=b.mapOffset(e),k=b.mapOffset(k));for(a=a.getAnnotations(e,k);a.hasNext();)if(e=a.next(),this.isAnnotationTypeVisible(e.type)){if(e.rangeStyle){var k=e.start,f=e.end;d!==b&&(k=b.mapOffset(k,!0),f=
b.mapOffset(f,!0));c.ranges=this._mergeStyleRanges(c.ranges,{start:k,end:f,style:e.rangeStyle})}e.lineStyle&&(c.style=this._mergeStyle({},c.style),c.style=this._mergeStyle(c.style,e.lineStyle))}}};g.addMixin(d.prototype);return{FoldingAnnotation:q,AnnotationType:b,AnnotationTypeList:g,AnnotationModel:e,AnnotationStyler:d}});
...
e=d.getModel();e.getBaseModel&&(void 0!==a&&(this._expandOffset(a),a=e.mapOffset(a,!0)),void 0!==b&&(this._expandOffset(b),b=e.mapOffset(b,!0)));d.setText(c,a,b)},setSelection:function(c,a,b,d){var e=this._textView,k=e.getModel();k.getBaseModel&&(this._expandOffset(c),this._expandOffset(a),c=k.mapOffset(c,!0),a=k.mapOffset(a,!0));e.setSelection(c,a,b,d)},moveSelection:function(c,a,b,d){var e=this._textView;this.setSelection(c,a||c,1/3,function(){(void 0===d||d)&&e.focus();b&&b()})},_getTooltipInfo:function(c,
a){var b=this._textView,d=this.getAnnotationModel();if(!d)return null;var e=this._annotationStyler;if(!e)return null;var k=b.getOffsetAtLocation(c,a);if(-1===k)return null;k=this.mapOffset(k);e=e.getAnnotationsByType(d,k,k+1);d=[];for(k=0;k<e.length;k++)e[k].rangeStyle&&d.push(e[k]);if(0===d.length)return null;b=b.convert({x:c,y:a},"document","page");return{contents:d,anchor:"left",x:b.x+10,y:b.y+20}},_highlightCurrentLine:function(c,a){var b=this._annotationModel;if(b){var d=this._textView;if(!d.getOptions("singleMode")){var e=
d.getModel(),f=a?e.getLineAtOffset(a.start):-1,g=e.getLineAtOffset(c.start),d=c.start===c.end,l=!a||a.start===a.end,m=e.getLineStart(g),q=e.getLineEnd(g);e.getBaseModel&&(m=e.mapOffset(m),q=e.mapOffset(q));e=this._currentLineAnnotation;if(!(f===g&&l&&d&&e&&e.start===m&&e.end===q)){var f=e?[e]:null,v;d&&(e=k.createAnnotation(k.ANNOTATION_CURRENT_LINE,m,q),v=[e]);this._currentLineAnnotation=e;b.replaceAnnotations(f,v)}}}},installTextView:function(){this.install()},install:function(){if(!this._textView){this._textView=
...
-1===c&&(c=this.blame.Message.length);var b=g.createElement(d,"a");b.href=this.blame.CommitLink;b.appendChild(d.createTextNode(this.blame.Message.substring(0,c)));a.appendChild(b);a.appendChild(g.createElement(d,"br"));a.appendChild(d.createTextNode(g.formatMessage(f.committerOnTime,this.blame.AuthorName,this.blame.Time)));return a},y=this.getModel();this.showAnnotations(c,[k.ANNOTATION_BLAME,k.ANNOTATION_CURRENT_BLAME],function(c){var d=y.getLineStart(c.Start-1),e=y.getLineEnd(c.End-1,!0),d=b.AnnotationType.createAnnotation(k.ANNOTATION_BLAME,
d,e,q),e=a.slice(0);e.push(c.Shade);d.style=l.mixin({},d.style);d.style.style=l.mixin({},d.style.style);d.style.style.backgroundColor="rgba("+e.join()+")";d.groupId=c.Name;d.groupType=k.ANNOTATION_CURRENT_BLAME;d.createGroupAnnotation=s;d.html='<img class="annotationHTML blame" src="'+c.AuthorImage+'"/>';d.blame=c;return d})},showSelection:function(c,a,b,d,e){"number"===typeof c?("number"!==typeof a&&(a=c),this.moveSelection(c,a)):"number"===typeof b&&(c=this.getModel().getLineStart(b-1),"number"===
typeof d&&(c+=d),"number"!==typeof e&&(e=0),this.moveSelection(c,c+e))},_setModelText:function(c){this._textView&&(this._textView.setText(c),this._textView.getModel().setLineDelimiter("auto"),this._highlightCurrentLine(this._textView.getSelection()))},setInput:function(c,a,b,d,k){e.prototype.setInput.call(this,c,a,b,d);this._textView&&(!d&&!k)&&this._textView.focus()},onGotoLine:function(c,a,b,d){if(this._textView){var e=this.getModel(),c=Math.max(0,Math.min(c,e.getLineCount()-1)),k=e.getLineStart(c),
f=0;void 0===b&&(b=0);"string"===typeof a?(c=e.getLine(c).indexOf(a),-1!==c&&(f=c,b=f+a.length)):(f=a,a=e.getLineEnd(c)-k,f=Math.min(f,a),b=Math.min(b,a));this.moveSelection(k+f,k+b,d)}}});return{BaseEditor:e,Editor:d}});
...
1]:null)&&d.classList.contains("commandSeparator"))return b?(a.removeChild(d),!1):!0;if("menu"===c&&(a=l.$$array("li > *",a),0<a.length&&a[a.length-1].classList.contains("dropdownSeparator")))if(d=a[a.length-1],b)d.parentNode.parentNode.removeChild(d.parentNode);else return!0;return!1},renderCommands:function(a,c,b,d,e,h,n){if("string"!==typeof a)throw"a scope id for rendering must be specified";c=l.node(c);if(!c)throw"no parent";var k=this._contributionsByScopeId[a];if(!b&&k){var b=k.localSelectionService||
this._selectionService,f=this;b&&b.getSelections(function(b){f.renderCommands(a,c,b,d,e,h)})}else k&&(this._render(k,c,b,d,e||"button",h,n),this._checkForTrailingSeparator(c,e,!0))},destroy:function(a){a=l.node(a);if(!a)throw"no parent";for(;a.hasChildNodes();){var c=a.firstChild;c.commandTooltip&&c.commandTooltip.destroy();c.emptyGroupTooltip&&c.emptyGroupTooltip.destroy();this.destroy(c);a.removeChild(c)}},_render:function(a,c,d,h,n,k,g){var p=a.sortedContributions;if(!p){var p=[],l=!1,q;for(q in a)if(Object.prototype.hasOwnProperty.call(a,
q)){var u=a[q];u&&"number"===typeof u.position&&(u.id=q,p.push(u),l=!0)}l&&(p.sort(function(a,c){return a.position-c.position}),a.sortedContributions=p)}var H=0,B=this;p.forEach(function(a){var p;a.imageClass||(a.imageClass=null);if(a.children&&0<Object.getOwnPropertyNames(a.children).length){var l=a.children;if("tool"===n||"button"===n)if(a.title){var s;a.defaultActionId&&((l=B._commandList[a.defaultActionId])&&(l.visibleWhen?l.visibleWhen(d):1)?(s=new f.CommandInvocation(h,d,k,l,B),s.domParent=
c):a.pretendDefaultActionId=!0);l=B._createDropdownMenu(c,a.title,null,null,a.imageClass,a.tooltip,a.selectionClass,null,s,a.pretendDefaultActionId);g&&m.generateNavGrid(g,l.menuButton);l&&(B._render(a.children,l.menu,d,h,"menu",k,g),B._checkForTrailingSeparator(l.menu,"menu",!0),0===l.menu.childNodes.length?a.emptyGroupMessage?l.menuButton.emptyGroupTooltip||(l.menuButton.emptyGroupTooltip=new e.Tooltip({node:l.menuButton,text:a.emptyGroupMessage,trigger:"click",position:["below","right","above",
"left"]})):(g&&m.removeNavGrid(g,l.menuButton),a=function(a){a&&a.parentNode&&a.parentNode.removeChild(a)},a(l.menu),a(l.menuButton),a(l.destroyButton)):l.menuButton.style.visibility="visible")}else{var q;0<c.childNodes.length&&!B._checkForTrailingSeparator(c,n)&&(q=B.generateSeparatorImage(c));B._render(l,c,d,h,n,k,g);0<c.childNodes.length&&c.childNodes[c.childNodes.length-1]!==q&&(q=B.generateSeparatorImage(c))}else if(a.title){if(a=B._createDropdownMenu(c,a.title,!0,null,null,a.imageClass))B._render(l,
a.menu,d,h,"menu",k,g),B._checkForTrailingSeparator(a.menu,"menu",!0),0===a.menu.childNodes.length&&a.destroyButton&&c.removeChild(a.destroyButton)}else 0<c.childNodes.length&&B._generateMenuSeparator(c),B._render(l,c,d,h,n,k,g),B._generateMenuSeparator(c)}else{var u=B._commandList[a.id],l=u?!0:!1;s=a=null;u&&(p=new f.CommandInvocation(h,d,k,u,B),p.domParent=c,q=l&&(u.visibleWhen?u.visibleWhen(d):!0),B._activeBindings[u.id]&&B._activeBindings[u.id].keyBinding&&(a=B._activeBindings[u.id],a.invocation=
q?p:null,a.bindingOnly&&(l=!1)),B._urlBindings[u.id]&&B._urlBindings[u.id].urlBinding&&(s=B._urlBindings[u.id],s.invocation=q?p:null,s.bindingOnly&&(l=!1)),l=l&&q);l&&(u.choiceCallback?("tool"===n||"button"===n?(a=c,l=!1,"ul"===c.nodeName.toLowerCase()&&(a=document.createElement("li"),c.appendChild(a))):(a=c,l=!0),B._createDropdownMenu(a,u.name,l,function(a){u.populateChoicesMenu(a,d,h,k,B)}.bind(u),u.imageClass,u.tooltip||u.title,u.selectionClass,u.positioningNode)):(p.handler=p.handler||this,p.domParent=
c,l=function(){B._invoke(p)},"menu"===n?(s=null,a&&a.keyBinding&&(s=b.getUserKeyString(a.keyBinding)),a=f.createCommandMenuItem(c,u,p,null,l,s)):(a=n+u.id+H,a=f.createCommandItem(c,u,p,a,null,"tool"===n,l)),m.generateNavGrid(g,a),p.domNode=a,H++))}})},_createDropdownMenu:function(a,b,d,h,n,k,p,m,q,u){a=l.node(a);if(!a||!l.contains(document.body,a))return null;var C,H,B=a;if(d)k=document.createRange(),k.selectNode(a),k=k.createContextualFragment(c),l.processTextNodes(k,{ButtonText:b}),a.appendChild(k),
H=a.lastChild,n=H.lastChild,b=n.previousSibling,b.dropdown=new g.Dropdown({dropdown:n,populate:h,parentDropdown:a.dropdown}),n.dropdown=b.dropdown;else{"ul"===a.nodeName.toLowerCase()&&(B=document.createElement("li"),a.appendChild(B),H=B);a=null;n&&(a="dropdownButtonWithIcon",k=k||b);var k=n?k||b:k,J=f.createDropdownMenu(B,b,h,a,n,!1,p,m,q||u);C=J.dropdownArrow;b=J.menuButton;if(C){q&&(q.domNode=J.menuButton);var M=this;b.onclick=function(a){var c=l.bounds(C);a.clientX>=c.left&&J.dropdown?J.dropdown.toggle(a):
M._invoke(q)};J.dropdown&&(b.onkeydown=function(a){l.KEY.DOWN===a.keyCode&&(J.dropdown.toggle(a),l.stop(a))})}var n=J.menu,I;(h=q&&q.command&&(q.command.tooltip||q.command.name))?I=q.command.tooltip||q.command.name:h&&(I=k);I&&(b.commandTooltip=new e.Tooltip({node:b,text:I,position:["above","below","right","left"]}))}return{menuButton:b,menu:n,dropdown:b.dropdown,destroyButton:H,dropdownArrow:C}},_generateMenuSeparator:function(a){if(!this._checkForTrailingSeparator(a,"menu")){var c=document.createElement("li");
c.classList.add("dropdownSeparator");var b=document.createElement("span");b.classList.add("dropdownSeparator");c.appendChild(b);a.appendChild(c)}},generateSeparatorImage:function(a){var c;c="ul"===a.nodeName.toLowerCase()?document.createElement("li"):document.createElement("span");a.appendChild(c);c.classList.add("core-sprite-sep");c.classList.add("imageSprite");c.classList.add("commandSeparator");return c}};a.prototype.constructor=a;h.prototype={match:function(a){a=q.matchResourceParameters(a);return"undefined"!==
typeof a[this.token]?(this.parameterValue=a[this.token],this):null}};h.prototype.constructor=h;n.prototype.constructor=n;p.prototype={optionsRequested:function(){return this.optionsRequested}};p.prototype.constructor=p;u.prototype={_storeParameters:function(a){this.parameterTable=null;if(a){var c=this.parameterTable={};a.forEach(function(a){c[a.name]=a})}},updateParameters:function(a){"function"===typeof this.getParameters&&this._storeParameters(this.getParameters(a))},hasParameters:function(){return null!==
...
c.type,c.label,c.value,c.lines,c.eventListeners);a.push(c)});var c=new u(a,this._options,this.getParameters);c.clientCollect=this.clientCollect;return c},hasOptionalParameters:function(){return this._hasOptionalParameters}};u.prototype.constructor=u;return{CommandRegistry:a,URLBinding:h,ParametersDescription:u,CommandParameter:p,CommandEventListener:n}});define("text!orion/banner/slideout.html",[],function(){return'<div id="slideContainer" class="slideParameters slideContainer">\r\n\t<span id="pageCommandParameters" class="layoutLeft parameters"></span>\r\n\t<span id="pageCommandDismiss" class="layoutRight parametersDismiss"></span>\r\n</div>'});
...
d.pathname)).href}:(e=new URL(b.href,d),n&&(e.protocol="",e.host=""));b.href="!"!==a[0][0]?h.expand({resource:e.href}):e.href}catch(f){console.log(f)}return c.call(this,a,b)};a=f(a,{sanitize:!0});f.InlineLexer.prototype.outputLink=c;return a}function k(a){this.fileClient=a.fileClient;this.progress=a.progress;this.canHide=a.canHide;this._node=null}function c(a){this.id="orion.markdownViewer";n.apply(this,arguments)}function a(a){this._parent=a.parent;this.serviceRegistry=a.serviceRegistry;this.contentTypeRegistry=
a.contentTypeRegistry;this.commandRegistry=a.commandRegistry;this.progress=a.progressService;this.model=a.model;this.undoStack=a.undoStack}var h=new l("#{,resource,params*}");k.prototype={display:function(a,c){a.classList.add("orionMarkdown");a.innerHTML=d(c)},displayContents:function(a,c){var d=c.Location||c;b.empty(a);var e=document.createElement("div");(this.progress?this.progress.progress(this.fileClient.read(d),"Reading file "+(c.Name||d)):this.fileClient.read(d)).then(function(a){this.display.bind(this)(e,
a)}.bind(this));a.appendChild(e)},displayInFrame:function(a,c,b,d,h){a=new e.Section(a,{id:"markdownSection",title:c.Name||h||"readme",headerClass:b,canHide:this.canHide});d&&(b=a.getTitleElement())&&b.classList.add(d);this.displayContents.call(this,a.getContentElement(),c)}};var n=m.BaseEditor;c.prototype=Object.create(n.prototype);q.mixin(c.prototype,{install:function(){var a=this._rootDiv=document.createElement("div");a.style.width="100%";a.style.height="100%";var c=this._contentDiv=document.createElement("div");
...
destroy:function(){this.editor&&this.editor.destroy();this.editor=null}};return{MarkdownEditorView:a,MarkdownView:k}});
define("orion/widgets/browse/browseView","i18n!orion/edit/nls/messages orion/explorers/explorer-table orion/explorers/navigatorRenderer orion/markdownView orion/PageUtil orion/URITemplate orion/webui/littlelib orion/objects orion/Deferred orion/webui/dropdown orion/section".split(" "),function(f,m,q,b,l,g,e,d,k,c,a){function h(){s.apply(this,arguments)}function n(a){a.setFocus=!1;a.cachePrefix=null;a.rendererFactory=function(c){return new h({checkbox:!1,treeTableClass:"sectionTreeTable",cachePrefix:"FolderNavigator"},
...
y:r.getLocationAtOffset(g.getLineStart(t)).y},"document","page");return{contents:z,x:a.x,y:a.y+Math.floor(1.33*r.getLineHeight(t))}}},0)})}return!0},unindentLines:function(){var a=this.editor,c=a.getTextView();if(c.getOptions("readonly"))return!1;if(c.getOptions("tabMode")){for(var b=a.getModel(),d=a.getSelection(),e=b.getLineAtOffset(d.start),f=b.getLineAtOffset(d.end>d.start?d.end-1:d.end),k=c.getOptions("tabSize"),g=Array(k+1).join(" "),l=[],m=c=0,q=e;q<=f;q++){var r=b.getLine(q,!0);if(b.getLineStart(q)!==
b.getLineEnd(q))if(0===r.indexOf("\t"))r=r.substring(1),c++;else if(0===r.indexOf(g))r=r.substring(k),c+=k;else return!0;q===e&&(m=c);l.push(r)}e=b.getLineStart(e);k=b.getLineEnd(f,!0);b=b.getLineStart(f);a.setText(l.join(""),e,k);f=e===d.start?d.start:d.start-m;d=Math.max(f,d.end-c+(d.end===b+1&&d.start!==d.end?1:0));a.setSelection(f,d);return!0}},startUndo:function(){this.undoStack&&this.undoStack.startCompoundChange()},endUndo:function(){this.undoStack&&this.undoStack.endCompoundChange()}};c.TextActions=
...
k,m;g<l&&(32===(m=f.charCodeAt(g))||9===m);)g++;var k=f.substring(0,g),c=c.getOptions("tabSize","expandTab"),q=c.expandTab?Array(c.tabSize+1).join(" "):"\t",c=d.getLineDelimiter(),r=/^[\s]*\/\*[\*]*[\s]*$/,t=/^[\s]*\*/,A=/\*\/[\s]*$/,D=f.substring(0,l),C=f.substring(l),H;if(this.smartIndentation&&123===f.charCodeAt(H=D.trimRight().length-1))return d=l-H-1,C=C.length-C.trimLeft().length,f=125===f.charCodeAt(l+C)?c+k+q+c+k:c+k+q,a.setText(f,b.start-d,b.end+C),a.setCaretOffset(b.start+c.length+k.length+
...
e=a.getLineAtOffset(b),f,k,g,l,m,q;for(f=d;0<=f&&!(k=a.getLine(f),g=f===d?c-a.getLineStart(d):k.length,l=k.lastIndexOf("/*",g),k=k.lastIndexOf("*/",g),k>l);f--)if(-1!==l){m=a.getLineStart(f)+l;break}for(f=e;f<a.getLineCount()&&!(k=a.getLine(f),g=f===e?b-a.getLineStart(e):0,l=k.indexOf("/*",g),k=k.indexOf("*/",g),-1!==l&&l<k);f++)if(-1!==k){q=a.getLineStart(f)+k;break}return{commentStart:m,commentEnd:q}},lineStart:function(){for(var a=this.editor,c=a.getModel(),b=a.getCaretOffset(),d=c.getLineAtOffset(b),
...
l,m=d;m<=e;m++)if(g=c.getLine(m,!0),k.push(g),!f||-1===(l=g.indexOf("//")))f=!1;else if(0!==l){var q;for(q=0;q<l&&!(f=g.charCodeAt(q),!(32===f||9===f));q++);f=q===l}m=c.getLineStart(d);q=c.getLineEnd(e,!0);if(f){for(f=0;f<k.length;f++)g=k[f],l=g.indexOf("//"),k[f]=g.substring(0,l)+g.substring(l+2);k=k.join("");g=c.getLineStart(e);c=m===b.start?b.start:b.start-2;b=b.end-2*(e-d+1)+(b.end===g+1?2:0)}else k.splice(0,0,""),k=k.join("//"),c=m===b.start?b.start:b.start+2,b=b.end+2*(e-d+1);a.setText(k,m,
...
b.length;e++)for(var f=b[e],l=k.getLineAtOffset(f.start),m=k.getLineAtOffset(Math.max(f.start,f.end-1)),q=l;q<=m;q++){var z=q;if(d!==k){z=k.getLineStart(q);z=d.mapOffset(z,!0);if(-1===z)continue;z=d.getLineAtOffset(z)}if(c<=z&&z<a){var r=this._mergeAnnotation(g[z],f,q-l,m-l+1);r&&(g[z]=r)}}if(!this._multiAnnotation&&this._multiAnnotationOverlay)for(var t in g)g[t]._multiple&&(g[t].html+=this._multiAnnotationOverlay.html);return g},getAnnotationModel:function(){return this._annotationModel},getLocation:function(){return this._location},
...
(this.endUndo(),this.startUndo()):this.startUndo();e.selectedGroupIndex=k.group;var h=0,g=a.text.length-(d-b);f=f.positions;for(var l,b=b-k.position.offset,m=d-k.position.offset,q=0;q<f.length;++q)l=f[q],d=l.position,l.oldOffset=d.offset,l.model===e&&l.group===k.group?(d.offset+=h,d.length+=g,h+=g):(d.offset+=h,l.ansestor&&(d.length+=k.count*g)),l.escape&&(l.model.escapePosition=d.offset);this.ignoreVerify=!0;for(q=f.length-1;0<=q;q--)l=f[q],l.model===e&&l.group===k.group&&c.setText(a.text,l.oldOffset+
...
define("orion/editor/factories","orion/editor/actions orion/editor/undoStack orion/editor/rulers orion/editor/annotations orion/editor/textDND orion/editor/linkedMode".split(" "),function(f,m,q,b,l,g){function e(){}function d(){}function k(){}function c(){}function a(){}function h(){}var n={};e.prototype={createKeyBindings:function(a,b,c,d){var d=new f.TextActions(a,b,d),e=new g.LinkedMode(a,b,c),a=new f.SourceCodeActions(a,b,c,e);return{textActions:d,linkedMode:e,sourceCodeActions:a}}};n.KeyBindingsFactory=
e;d.prototype={createUndoStack:function(a){a=a.getTextView();return new m.UndoStack(a,200)}};n.UndoFactory=d;k.prototype={createLineNumberRuler:function(a){return new q.LineNumberRuler(a,"left",{styleClass:"ruler lines"},{styleClass:"rulerLines odd"},{styleClass:"rulerLines even"})}};n.LineNumberRulerFactory=k;c.prototype={createFoldingRuler:function(a){return new q.FoldingRuler(a,"left",{styleClass:"ruler folding"})}};n.FoldingRulerFactory=c;a.prototype={createAnnotationModel:function(a){return new b.AnnotationModel(a)},
createAnnotationStyler:function(a,c){return new b.AnnotationStyler(a,c)},createAnnotationRulers:function(a){var b=new q.AnnotationRuler(a,"left",{styleClass:"ruler annotations"}),a=new q.OverviewRuler(a,"right",{styleClass:"ruler overview"});return{annotationRuler:b,overviewRuler:a}}};n.AnnotationFactory=a;h.prototype={createTextDND:function(a,b){return new l.TextDND(a.getTextView(),b)}};n.TextDNDFactory=h;return n});
...
d;if(e)for(var k=0;k<e.length;k++)e[k].fontSize=f,e[k].name===g[b.selectedKey]&&(d=e[k]);l.put(b.styleset,JSON.stringify(e));q.processSettings(d)}.bind(this))}};return{ThemePreferences:f}});
...
define("orion/widgets/browse/readonlyEditorView","orion/editor/editor orion/editor/textView orion/editor/textModel orion/editor/projectionTextModel orion/editor/editorFeatures orion/editorPreferences orion/widgets/themes/ThemePreferences orion/widgets/themes/editor/ThemeData orion/objects".split(" "),function(f,m,q,b,l,g,e,d,k){function c(a){this._parent=a.parent;this.renderToolbars=a.renderToolbars;this.inputManager=a.inputManager;this.preferences=a.preferences;this.statusReporter=a.statusReporter;
...
c.apply());var n=this._parent,c=this.inputManager,p=function(){var a=this.updateViewOptions(this.settings);k.mixin(a,{parent:n,model:new b.ProjectionTextModel(this.model||new q.TextModel)});return new m.TextView(a)}.bind(this),u=this.editor=new f.Editor({textViewFactory:p,annotationFactory:new l.AnnotationFactory,foldingRulerFactory:new l.FoldingRulerFactory,lineNumberRulerFactory:new l.LineNumberRulerFactory,statusReporter:this.statusReporter,domNode:n});u.id="orion.editor";c.addEventListener("InputChanged",
...
"^"+h),l[c]=RegExp(h),p[c]=b.getService(a[c]),u[c]=a[c].getProperty("Name"),a[c].getProperty("NameKey")&&a[c].getProperty("nls")&&q.getMessageBundle(a[c].getProperty("nls")).then(function(b,c){s[b].Name=c[a[b].getProperty("NameKey")];u[b]=c[a[b].getProperty("NameKey")]}.bind(this,c));this._getServiceIndex=function(a){if("/"===a)return-1;if(!a||a.length&&0===a.length)return p[0]?0:-1;for(var b=0;b<l.length;++b)if(l[b].test(a))return b;throw f["No Matching FileService for location:"]+a;};this._getService=
...
arguments)},deleteFile:function(e){return b(this._getService(e),"deleteFile",arguments)},moveFile:function(e,d,f){var c=this._getService(e),a=this._getService(d);if(c===a)return b(c,"moveFile",arguments);var g="/"===e[e.length-1],n=d;"/"!==n[n.length-1]&&(n+="/");if(f)n+=encodeURIComponent(f);else{var m=e;g&&(m=m.substring(0,m.length-1));n+=m.substring(m.lastIndexOf("/")+1)}g&&"/"!==n[n.length-1]&&(n+="/");return l(c,e,a,n).then(function(){return b(c,"deleteFile",[e])})},copyFile:function(e,d,f){var c=
...
new q({start:0,contentStart:0,end:e,contentEnd:e},null,this,d);this._computeFolding(this._rootBlock.getBlocks());c&&this.detectTasks&&(e=[],x(this._rootBlock,d,e),c.replaceAnnotations([],e));a.redrawLines()}var g={styleClass:"meta annotation currentLine"},e=/$/,d=/\\(\d)/g,k=/(.*)(?:[\r\n]|$)/g,c={regex:/ /g,style:{styleClass:"punctuation separator space",unmergeable:!0}},a={regex:/\t/g,style:{styleClass:"punctuation separator tab",unmergeable:!0}},h=function(a,b,c,d){var e=c,f=a.lastIndex;k.lastIndex=
...
-1:a.result.index>b.result.index?1:a.pattern.pattern.index<b.pattern.pattern.index?-1:1});for(var k=0;0<g.length;){var l=g[0];g.splice(0,1);if(!(l.result.index<k)){var m=l.result.index,q,w=[];if(l.pattern.regex){k=l.result;q=m+k[0].length;q={start:b+m,end:b+q,style:l.pattern.pattern.name};if(!f){l.pattern.pattern.captures&&u(k,l.pattern.pattern.captures,b+m,w);w.sort(function(a,b){return a.start<b.start?-1:a.start>b.start?1:0});for(m=0;m<w.length-1;m++)if(w[m+1].start<w[m].end){var x={start:w[m+1].end,
end:w[m].end,style:w[m].style};w[m].end=w[m+1].start;w.splice(m+2,0,x)}}s(q,w,d)}else k=l.pattern.regexEnd,k=n(k,l.result),k=h(k,a,l.result.index+l.result[0].length),k||(e.lastIndex=0,k=e.exec(a)),q=k.index+k[0].length,d.push({start:b+m,end:b+q,style:l.pattern.pattern.name});k=k.index+k[0].length}p(l,a,g,k)}c.forEach(function(a){a=a.regex||a.regexBegin;a.lastIndex=a.oldLastIndex})}},y=function(a,b,c,d){var f=[];c.getBlockPatterns().forEach(function(a){var c=h(a.regexBegin||a.regex,b,0);c&&f.push({result:c,
pattern:a})}.bind(this));if(!f.length)return f;f.sort(function(a,b){return a.result.index<b.result.index?-1:a.result.index>b.result.index?1:a.pattern.pattern.index<b.pattern.pattern.index?-1:1});for(var g=0,k=[];0<f.length;){var l=f[0];f.splice(0,1);if(!(l.result.index<g)){var m=a.getLineAtOffset(d+l.result.index),s=a.getLine(m),u=[];w(s,a.getLineStart(m),c,u);m=d+l.result.index;for(s=0;s<u.length;s++)if(u[s].start===m){var g=l.result.index,x=null,y=l.pattern.regexEnd;if(y)for(var g=g+l.result[0].length,
y=n(y,l.result),E=g;!x;){E=h(y,b,E);E||(e.lastIndex=0,E=e.exec(b));var O=[],Q=new q({start:m,end:d+E.index+E[0].length,contentStart:d+g,contentEnd:d+E.index},l.pattern,c.getStyler(),a,c);w(b.substring(g,E.index+E[0].length),g,Q,O);if(!O.length||O[O.length-1].end<=E.index)x=Q;E=E.index+E[0].length}else x=new q({start:m,end:m+l.result[0].length,contentStart:m,contentEnd:m+l.result[0].length},l.pattern,c.getStyler(),a,c);k.push(x);g=x.end-d;break}s===u.length&&(g=l.result.index+1)}p(l,b,f,g)}return k},
...
if(b.start===b.end&&c.getLineAtOffset(b.start)===a)return g}return null},_getPatternManager:function(){return this.patternManager},_getStyles:function(a,b,c,d){b.getBaseModel&&(d=b.mapOffset(d));for(var e=d+c.length,f=[],g=d,k=a.getBlocks(),l=this._binarySearch(k,d,!0);l<k.length&&!(k[l].start>=e);l++){var m=k[l].start,n=k[l].end;g<m&&w(c.substring(g-d,m-d),g,a,f);var p=Math.max(g,m);if(p===m&&k[l].pattern.regexBegin){var q=h(k[l].pattern.regexBegin,c.substring(p-d),0);if(q){var s=k[l].pattern.pattern.beginCaptures||
k[l].pattern.pattern.captures;s?u(q,s,p,f):f.push({start:p,end:p+q[0].length,style:k[l].pattern.pattern.name});p+=q[0].length}}var m=Math.min(e,n),x=[];if(m===n&&k[l].pattern.regexEnd&&(g=c.substring(m-g-(k[l].end-k[l].contentEnd)),q=h(k[l].pattern.regexEnd,g,0)))(s=k[l].pattern.pattern.endCaptures||k[l].pattern.pattern.captures)?u(q,s,m-q[0].length,x):k[l].pattern.pattern.name&&x.push({start:m-q[0].length,end:m,style:k[l].pattern.pattern.name}),m-=q[0].length;var g=this._getStyles(k[l],b,c.substring(p-
d,m-d),p),y=k[l].pattern.pattern.contentName||k[l].pattern.pattern.name;if(y){var N=p;g.forEach(function(a){a.start-N&&f.push({start:N,end:a.start,style:y});f.push(a);N=a.end});m-N&&f.push({start:N,end:m,style:y})}else f=f.concat(g);f=f.concat(x);g=n}g<e&&w(c.substring(g-d,e-d),g,a,f);if(b.getBaseModel)for(a=0;a<f.length;a++)c=f[a].end-f[a].start,f[a].start=b.mapOffset(f[a].start,!0),f[a].end=f[a].start+c;return f},_isRenderingWhitespace:function(){return this.whitespacesVisible&&(this.tabsVisible||
...
new m.TextStyler(g,p,q.grammars,"orion.js");break;case "application/json":this.styler=new m.TextStyler(g,p,e.grammars,"orion.json");break;case "text/x-python":this.styler=new m.TextStyler(g,p,k.grammars,"orion.py");break;case "text/x-ruby":this.styler=new m.TextStyler(g,p,c.grammars,"orion.rb");break;case "text/x-php":this.styler=new m.TextStyler(g,p,d.grammars,"orion.php")}return(new f).resolve()},getStyler:function(){return this.styler}};return{ContentTypes:[{id:"text/plain",name:"Text",extension:["txt"],
...
function(f,m,q,b,l,g,e,d,k,c,a,h,n,p,u,s,w,y,x,v,z){function r(){w.attach(this)}function t(a){this.fileBrowser=a}function A(a,b){this.repoURL=a;if(this.baseURL=b){this.RepoURLTriggerTemplate=x;var c=this.repoURL.match(/\/([^\/]+)\/([^\/]+)$/);this.promptValue=c?"teamRepository="+this.baseURL+"\nuserId="+decodeURIComponent(c[1])+"\nuserName="+decodeURIComponent(c[1])+"\nprojectAreaName="+decodeURIComponent(c[1])+" | "+decodeURIComponent(c[2]):this.baseURL}else this.RepoURLTriggerTemplate=y,this.promptValue=
...
method:"progress",params:Array.prototype.slice.call(arguments)})})):(e.result=f,k(e)))}catch(h){e&&(e.error=g(h),k(e))}}function y(a){try{if(a.method){var b=a.method,d=a.params||[];if("serviceId"in a){var e=Y[a.serviceId];e||s(a.id,"service not found");b in e?w(a.id,e,e[b],d):s(a.id,"method not found")}else if("objectId"in a){var f=T[a.objectId];f||s(a.id,"object not found");b in f?w(a.id,f,f[b],d):s(a.id,"method not found")}else if("requestId"in a){var g=N[a.requestId];g&&("cancel"===b&&g.cancel)&&
...
-1:1});d.parent?x=d.parent:(x=document.createElement("div"),d.visible||(x.style.display="none",x.style.visibility="hidden"),document.body.appendChild(x));d.plugins&&Object.keys(d.plugins).forEach(function(a){a=b(a);if(!this.getPlugin(a)){var c=d.plugins[a];"object"!==typeof c&&(c={});c.autostart=c.autostart||d.defaultAutostart||"lazy";v.push(new k(a,c,A))}}.bind(this));y="starting"}};this.start=function(){"starting"!==y&&this.init();if("starting"!==y)return(new f).reject("Cannot start framework. Framework is already "+
...
d),c=2;else if(0===e.pathname.indexOf("/project/"))k||(k=(new URL("/ccm01",d)).href),g=new URL(k+"/service/com.ibm.team.filesystem.service.jazzhub.IOrionFilesystem/sr/pluginOrionWs.html?"+d),c=2;else throw"Bad Repo URL - "+d;var a=new m.ServiceRegistry,e={};e[g.href]={autostart:"started",lastModified:-1};this._fileBrowser=new f.FileBrowser({parent:b.parentId,repoURL:d,baseURL:2===c?k:null,codeURL:b.codeURL,selectorNumber:c,rootName:b.rootName,maxEditorLines:300,init:!0});(new q.PluginRegistry(a,{storage:{},

...
(function(g){function n(b,c){var k,d,q,u,A,m,h,a,e,l=c&&c.split("/"),t=r.map,x=t&&t["*"]||{};if(b&&"."===b.charAt(0))if(c){l=l.slice(0,l.length-1);b=l.concat(b.split("/"));for(a=0;a<b.length;a+=1)if(k=b[a],"."===k)b.splice(a,1),a-=1;else if(".."===k)if(1===a&&(".."===b[2]||".."===b[0]))break;else 0<a&&(b.splice(a-1,2),a-=2);b=b.join("/")}else 0===b.indexOf("./")&&(b=b.substring(2));if((l||x)&&t){k=b.split("/");for(a=k.length;0<a;a-=1){d=k.slice(0,a).join("/");if(l)for(e=l.length;0<e;e-=1)if(q=t[l.slice(0,
e).join("/")])if(q=q[d]){u=q;A=a;break}if(u)break;!m&&(x&&x[d])&&(m=x[d],h=a)}!u&&m&&(u=m,A=h);u&&(k.splice(0,A,u),b=k.join("/"))}return b}function p(b,c){return function(){return h.apply(g,t.call(arguments,0).concat([b,c]))}}function a(b){return function(c){return n(c,b)}}function l(b){return function(c){k[b]=c}}function f(b){if(w.call(m,b)){var c=m[b];delete m[b];x[b]=!0;d.apply(g,c)}if(!w.call(k,b)&&!w.call(x,b))throw Error("No "+b);return k[b]}function e(b){var c,k=b?b.indexOf("!"):-1;-1<k&&(c=
b.substring(0,k),b=b.substring(k+1,b.length));return[c,b]}var d,h,c,b,k={},m={},r={},x={},w=Object.prototype.hasOwnProperty,t=[].slice;c=function(b,c){var k,d=e(b),q=d[0],b=d[1];q&&(q=n(q,c),k=f(q));q?b=k&&k.normalize?k.normalize(b,a(c)):n(b,c):(b=n(b,c),d=e(b),q=d[0],b=d[1],q&&(k=f(q)));return{f:q?q+"!"+b:b,n:b,pr:q,p:k}};b={require:function(b){return p(b)},exports:function(b){var c=k[b];return"undefined"!==typeof c?c:k[b]={}},module:function(b){return{id:b,uri:"",exports:k[b],config:function(){return r&&
r.config&&r.config[b]||{}}}}};d=function(d,r,h,a){var q,u,A,B,C=[],e,a=a||d;if("function"===typeof h){r=!r.length&&h.length?["require","exports","module"]:r;for(B=0;B<r.length;B+=1)if(A=c(r[B],a),u=A.f,"require"===u)C[B]=b.require(d);else if("exports"===u)C[B]=b.exports(d),e=!0;else if("module"===u)q=C[B]=b.module(d);else if(w.call(k,u)||w.call(m,u)||w.call(x,u))C[B]=f(u);else if(A.p)A.p.load(A.n,p(a,!0),l(u),{}),C[B]=k[u];else throw Error(d+" missing "+u);r=h.apply(k[d],C);if(d)if(q&&q.exports!==
g&&q.exports!==k[d])k[d]=q.exports;else if(r!==g||!e)k[d]=r}else d&&(k[d]=h)};requirejs=require=h=function(k,m,a,e,q){if("string"===typeof k)return b[k]?b[k](m):f(c(k,m).f);k.splice||(r=k,m.splice?(k=m,m=a,a=null):k=g);m=m||function(){};"function"===typeof a&&(a=e,e=q);e?d(g,k,m,a):setTimeout(function(){d(g,k,m,a)},4);return h};h.config=function(b){r=b;return h};define=function(b,c,d){c.splice||(d=c,c=[]);!w.call(k,b)&&!w.call(m,b)&&(m[b]=[b,c,d])};define.amd={jQuery:!0}})();define("almond",function(){});
...
(function(){function g(p,a,l){for(var f in a)a.hasOwnProperty(f)&&(!p.hasOwnProperty(f)||l)?p[f]=a[f]:"object"===typeof a[f]&&g(p[f],a[f],l)}var n=/(^.*(^|\/)nls(\/|$))([^\/]*)\/?([^\/]*)/;define("i18n",["module"],function(p){var a=p.config?p.config():{};return{version:"2.0.1+",load:function(l,f,e,d){d=d||{};d.locale&&(a.locale=d.locale);var h=n.exec(l),c=h[1],b=h[4],k=h[5],m=b.split("-"),r=[],x={},w,t="";h[5]?(c=h[1],l=c+k):(k=h[4],b=a.locale,b||(b=a.locale="undefined"===typeof navigator?"root":
(navigator.language||navigator.userLanguage||"root").toLowerCase()),m=b.split("-"));if(d.isBuild){r.push(l);d=c+"root/"+k;require._fileExists(f.toUrl(d+".js"))&&r.push(d);for(w=0;w<m.length;w++)d=m[w],t+=(t?"-":"")+d,d=r,h=c+t+"/"+k,require._fileExists(f.toUrl(h+".js"))&&d.push(h);f(r,function(){e()})}else f([l],function(b){var d=[],h;h=c;var a=k;b.root&&(d.push("root"),(!0===b.root||1===b.root)&&r.push(h+"root/"+a));for(w=0;w<m.length;w++){h=m[w];h=t+=(t?"-":"")+h;var a=b,q=r,u=c,A=k;a[h]&&(d.push(h),
(!0===a[h]||1===a[h])&&q.push(u+h+"/"+A))}f(r,function(){var q,u,A;for(q=d.length-1;-1<q&&d[q];q--){A=d[q];u=b[A];if(!0===u||1===u)u=f(c+A+"/"+k);g(x,u)}e(x)})})}}})})();define("orion/i18n",{load:function(g,n,p){n.specified&&n.specified("orion/bootstrap")?n(["orion/i18n!"+g],function(a){p(a)}):p({})}});
...
("object"===typeof c||"function"===typeof c)&&c.then;if("function"===typeof s)if(c===r)d(new TypeError);else{k="assumed";var v=c&&c.cancel;if("function"!==typeof v){var z=new a,c=z.promise;try{s(z.resolve,z.reject,z.progress)}catch(q){z.reject(q)}v=c.cancel;s=c.then}b=c;s.call(c,l(h),l(d));x.parentCancel=v.bind(c)}else k="fulfilled",b=c,m.length&&n(e)}catch(u){l(d)(u)}}function c(){var b=x.parentCancel;b?(delete x.parentCancel,b()):k||(b=Error("Cancel"),b.name="Cancel",d(b))}var b,k,m=[],r=this,x=
...
getTitle:function(){return this._title},getFileMetadata:function(){return this._fileMetadata},getReadOnly:function(){var c=this._fileMetadata;return this._readonly||!c||c.Attributes&&c.Attributes.ReadOnly},getContentType:function(){return this._contentType},onFocus:function(){this._autoSaveEnabled&&this._errorSaving?this.save():this._autoLoadEnabled&&this.load()},onChanging:function(c){if(this._getSaveDiffsEnabled()){var b=this._unsavedChanges.length,d=c.removedCharCount,m=c.start,r=c.start+d,h=0;
0===c.addedCharCount?h=-1:0===d&&(h=1);if(0<b&&h===this.previousChangeType){b=this._unsavedChanges[b-1];if(0===d&&m===b.end+b.text.length){b.text+=c.text;return}if(0===c.addedCharCount&&r===b.start){b.start=m;return}}this.previousChangeType=h;this._unsavedChanges.push({start:m,end:r,text:c.text})}},reportStatus:function(c){this.statusReporter?this.statusReporter(c):this.editor&&this.editor.reportStatus(c)},save:function(){function c(b){r===u.getInput()&&(u.getFileMetadata().ETag=b.ETag,k.setInput(r,
null,h,!0));u.reportStatus("");m&&q&&q.setProgressResult({Message:g.Saved,Severity:"Normal"});u.afterSave&&u.afterSave();u._saving=!1}function b(b){u.reportStatus("");d(q,b);u._saving=!1;u._errorSaving=!0}if(!this._saving){var k=this.getEditor();if(k&&k.isDirty()&&!this.getReadOnly()){var m=this._errorSaving;this._saving=!0;var r=this.getInput();this.reportStatus(g["Saving..."]);this.dispatchEvent({type:"Saving",inputManager:this});k.markClean();var h=k.getText(),a=h;if(this._getSaveDiffsEnabled()&&
!this._errorSaving){for(var e=this._unsavedChanges,l=0,f=0;f<e.length;f++)l+=e[f].text.length;h.length>l&&(a={diff:e})}this._unsavedChanges=[];this._errorSaving=!1;var e={ETag:this.getFileMetadata().ETag},v=this._parsedLocation.resource,a=this.fileClient.write(v,a,e),z=this.progressService,q=null;this.serviceRegistry&&(q=this.serviceRegistry.getService("orion.page.message"));z&&(a=z.progress(a,n.formatMessage(g.savingFile,r)));var u=this;a.then(c,function(q){412===q.status?window.confirm(g.saveOutOfSync)?
(q=u.fileClient.write(v,h),z&&(q=z.progress(q,n.formatMessage(g.savingFile,r))),q.then(c,b)):u._saving=!1:b(q)})}}},setAutoLoadEnabled:function(c){this._autoLoadEnabled=c},setAutoSaveTimeout:function(c){this._autoSaveEnabled=-1!==c;this._idle?this._idle.setTimeout(c):(this._idle=new e({document:document,timeout:c}),this._idle.addEventListener("Idle",function(){this._errorSaving||this.save()}.bind(this)))},setContentType:function(c){this._contentType=c},setInput:function(c){if(!this._ignoreInput&&
...
b,d,m,r){var h,a=!1;m?(this._fileMetadata=m,this.setTitle(m.Location||String(m)),this.setContentType(this.contentTypeRegistry.getFileContentType(m)),h=m.Name,a=m.Directory):(this._fileMetadata=null,this.setTitle(b),this.setContentType(this.contentTypeRegistry.getFilenameContentType(this.getTitle())),h=this.getTitle());var e=this.getEditor();this._focusListener&&(e&&(e.getTextView&&e.getTextView())&&e.getTextView().removeEventListener("Focus",this._focusListener),this._focusListener=null);this._changingListener&&
(e&&(e.getModel&&e.getModel())&&e.getModel().removeEventListener("Changing",this._changingListener),this._changingListener=null);m={type:"InputChanged",input:c,name:h,title:b,contentType:this.getContentType(),metadata:m,location:window.location,contents:d};this.dispatchEvent(m);this.editor=e=m.editor;a||(e&&(e.getTextView&&e.getTextView())&&e.getTextView().addEventListener("Focus",this._focusListener=this.onFocus.bind(this)),e&&(e.getModel&&e.getModel())&&e.getModel().addEventListener("Changing",
...
define("orion/webui/littlelib",["orion/util"],function(g){function n(d,h){h||(h=document);return h.querySelectorAll(d)}function p(d){if(0<=d.tabIndex)return d;if(d.hasChildNodes())for(var h=0;h<d.childNodes.length;h++){var c=p(d.childNodes[h]);if(c)return c}return null}function a(d){if(0<=d.tabIndex)return d;if(d.hasChildNodes())for(var h=d.childNodes.length-1;0<=h;h--){var c=a(d.childNodes[h]);if(c)return c}return null}function l(d,h){if(3===d.nodeType){var c=f.exec(d.nodeValue);c&&1<c.length&&h(d,
c)}if(d.hasChildNodes())for(c=0;c<d.childNodes.length;c++)l(d.childNodes[c],h)}var f=/\$\{([^\}]+)\}/,e=null;return{$:function(d,h){h||(h=document);return h.querySelector(d)},$$:n,$$array:function(d,h){return Array.prototype.slice.call(n(d,h))},node:function(d){var h=d;"string"===typeof d&&(h=document.getElementById(d));return h},contains:function(d,h){if(!d||!h)return!1;if(d===h)return!0;var c=d.compareDocumentPosition(h);return Boolean(c&16)},bounds:function(d){d=d.getBoundingClientRect();return{left:d.left+
document.documentElement.scrollLeft,top:d.top+document.documentElement.scrollTop,width:d.width,height:d.height}},empty:function(d){for(;d.hasChildNodes();)d.removeChild(d.firstChild)},firstTabbable:p,lastTabbable:a,stop:function(d){window.document.all&&(d.keyCode=0);d.preventDefault&&(d.preventDefault(),d.stopPropagation())},processTextNodes:function(d,h){l(d,function(c,b){c.parentNode.replaceChild(document.createTextNode(h[b[1]]||b[1]),c)})},processDOMNodes:function(d,h){l(d,function(c,b){var d=
h[b[1]];if(d){var m=document.createRange(),r=b.index;m.setStart(c,r);m.setEnd(c,r+b[0].length);m.deleteContents();m.insertNode(d)}})},addAutoDismiss:function(d,h){function c(b){e.forEach(function(c){var d=!1,r=c.excludeNodes.some(function(c){return document.body.contains(c)?(d=!0,c.contains(b.target)):!1});if(d&&!r)try{c.dismiss(b)}catch(h){"undefined"!==typeof console&&console&&console.error(h&&h.message)}});e=e.filter(function(b){return b.excludeNodes.some(function(b){return document.body.contains(b)})})}
null===e&&(e=[],document.addEventListener("click",c,!0),g.isIOS&&document.addEventListener("touchend",function(b){function c(){b.target.removeEventListener("click",c)}0===b.touches.length&&b.target.addEventListener("click",c)},!1));e.push({excludeNodes:d,dismiss:h})},setFramesEnabled:function(d){for(var h=document.getElementsByTagName("iframe"),c=0;c<h.length;c++)h[c].parentNode.style.pointerEvents=d?"":"none"},removeAutoDismiss:function(d){e=e.filter(function(h){return d!==h.dismiss})},KEY:{BKSPC:8,
...
a.makeFinalHref;this._maxLength=a.maxLength;this.path="";this.measure();this.render()},getNavigatorWorkspaceRootSegment:function(){if(this._workspaceRootSegmentName){var a;if(this._resource&&this._resource.Parents){a=document.createElement("a");var l=this._workspaceRootURL?this._workspaceRootURL:"";this._makeHref?this._makeHref(a,l):a.href=g.toUrl("edit/edit.html")+"#"+l}else a=document.createElement("span");n.empty(a);a.appendChild(document.createTextNode(this._workspaceRootSegmentName));return a}return null},
MAX_LENGTH:500,INCLUDE_FIRST_SECTION:!0,segments:[],buildSegment:function(a){var l=document.createElement("a");l.classList.add("breadcrumb");l.appendChild(document.createTextNode(a));return l},addSegmentHref:function(a,l){this._makeHref?this._makeHref(a,l.Location,l):a.href=g.toUrl("edit/edit.html")+"#"+l.ChildrenLocation},buildSegments:function(a,l){if(this._resource.Parents){var f=this._resource.Parents.slice(0),e,d;f&&(f=f.slice(0),"reverse"===l&&(f=f.reverse().slice(0)),f.forEach(function(h){h.skip||
(a?(d=a,a=null):d=h.Name,e=this.buildSegment(d),this.path+=h.Name,this.addSegmentHref(e,h),e.include=!1,this.segments.push(e))}.bind(this)))}},addDivider:function(){var a=document.createElement("span");a.appendChild(document.createTextNode(" / "));this.path+="/";a.classList.add("breadcrumbSeparator");this.append(a)},refresh:function(){(this.crumbs=n.node(this._id))?n.empty(this.crumbs):(this.crumbs=document.createElement("span"),this.crumbs.id=this._id,this._container.appendChild(this.crumbs),this.dirty=
...
(function(){function g(q){if("string"!==typeof q)throw new TypeError;}function n(q){return q?q.split("&"):[]}function p(q){return 0===q.length?"":q.join("&")}function a(q){var b=/([^=]*)(?:=?)(.*)/.exec(q),q=b[1]?decodeURIComponent(b[1]):"",b=b[2]?decodeURIComponent(b[2]):"";return[q,b]}function l(q){var b=encodeURIComponent(q[0]);q[1]&&(b+="="+encodeURIComponent(q[1]));return b}function f(q,b){var u="",c=[],d=0;return{next:function(){u!==q.query&&(u=q.query,c=n(u));if(d<c.length){var k=a(c[d++]);
switch(b){case "keys":return k[0];case "values":return k[1];case "keys+values":return[k[0],k[1]];default:throw new TypeError;}}throw A;}}}function e(q){Object.defineProperty(this,"_url",{get:function(){return q._url}})}function d(q){return q?/[1-9]\d*$/.exec(q)[0]:""}function h(q){var b=[];q.split("/").forEach(function(q){".."===q?b.pop():"."!==q&&b.push(q)});return b.join("/")}function c(q,b){if("string"!==typeof q)throw new TypeError;var q=q.replace(/\s/g,function(q){return"%"+q.charCodeAt(0).toString(16)}),
u=r.exec(q);if(!u)return null;var c={};c.scheme=u[1]||"";if(c.scheme&&!w.test(c.scheme))return null;var k=u[2];if(k&&(k=x.exec(k),c.userinfo=k[1],c.host=k[2],c.port=k[3],c.port&&!t.test(c.port)))return null;c.path=u[3];c.query=u[4];c.fragment=u[5];!c.scheme&&b&&(c.scheme=b.scheme,!c.host&&b.host&&(c.userinfo=b.userinfo,c.host=b.host,c.port=b.port,c.pathRelative=!0));c.pathRelative&&(c.path?"/"!==c.path[0]&&(u=/^(.*\/)[^\/]*$/.exec(b.path)[1]||"/",c.path=u+c.path):c.path=b.path);c.scheme&&(c.scheme=
c.scheme.toLowerCase());c.port&&(c.port=d(c.port));c.host&&c.path&&(c.path=h(c.path));return c}function b(q,b){var u;if(b){b=b.href||b;u=c(b);if(!u||!u.scheme)throw new SyntaxError;Object.defineProperty(this,"_baseURL",{value:u})}u=c(q,u);if(!u)throw new SyntaxError;Object.defineProperty(this,"_input",{value:q,writable:!0});Object.defineProperty(this,"_url",{value:u,writable:!0});var d=new e(this);Object.defineProperty(this,"query",{get:function(){return this._url?d:null},enumerable:!0})}try{var k;
if("function"===typeof window.URL&&0!==window.URL.length&&"http:"===(k=new window.URL("http://www.w3.org?q")).protocol&&k.query)return}catch(m){}var r=/^(?:([^:\/?#]+):)?(?:\/\/([^\/?#]*))?([^?#]*)(?:\?([^#]*))?(?:#(.*))?$/,x=/^(?:(.*)@)?(\[[^\]]*\]|[^:]*)(?::(.*))?$/,w=/^([a-zA-Z](?:[a-zA-Z0-9+-.])*)$/,t=/^\d*$/,y=/^(\[[^\]\/?#\s]*\]|[^:\/?#\s]*)$/,s=/^(\[[^\]\/?#\s]*\]|[^:\/?#\s]*)(?::(\d*))?$/,v=/^([^?#\s]*)$/,z=/^([^\s]*)$/,q=/^\S*$/,u=/([^:]*):?(.*)/,A="undefined"!==typeof StopIteration?StopIteration:
Error("Stop Iteration"),B={"ftp:":"21","gopher:":"70","http:":"80","https:":"443","ws:":"80","wss:":"443"};Object.defineProperties(e.prototype,{get:{value:function(q){g(q);var b;n(this._url.query).some(function(u){u=a(u);if(u[0]===q)return b=u[1],!0});return b},enumerable:!0},set:{value:function(q,b){g(q);g(b);var u=n(this._url.query);u.some(function(c,d){var k=a(c);if(k[0]===q)return k[1]=b,u[d]=l(k),!0})||u.push(l([q,b]));this._url.query=p(u)},enumerable:!0},has:{value:function(q){g(q);return n(this._url.query).some(function(b){if(a(b)[0]===
q)return!0})},enumerable:!0},"delete":{value:function(q){g(q);var b=n(this._url.query),u=b.filter(function(b){return a(b)[0]!==q});return u.length!==b.length?(this._url.query=p(u),!0):!1},enumerable:!0},clear:{value:function(){this._url.query=""},enumerable:!0},forEach:{value:function(q,b){if("function"!==typeof q)throw new TypeError;var u=f(this._url,"keys+values");try{for(;;){var c=u.next();q.call(b,c[1],c[0],this)}}catch(d){if(d!==A)throw d;}},enumerable:!0},keys:{value:function(){return f(this._url,
"keys")},enumerable:!0},values:{value:function(){return f(this._url,"values")},enumerable:!0},items:{value:function(){return f(this._url,"keys+values")}},size:{get:function(){return n(this._url.query).length},enumerable:!0},getAll:{value:function(q){g(q);var b=[];n(this._url.query).forEach(function(u){u=a(u);u[0]===q&&b.push(u[1])});return b},enumerable:!0},append:{value:function(q,b){g(q);g(b);var u=n(this._url.query);u.push(l([q,b]));this._url.query=p(u)},enumerable:!0}});Object.defineProperties(b.prototype,
...
this._url.scheme+":":":"},set:function(q){g(q);if(this._url&&(q=":"===q.slice(-1)?q.substring(0,q.length-1):q,""===q||w.test(q)))this._url.scheme=q.toLowerCase()},enumerable:!0},_userinfo:{get:function(){return this._url?this._url.userinfo:""},set:function(q){g(q);this._url&&(this._url.userinfo=q)}},username:{get:function(){if(!this._url)return"";var q=u.exec(this._userinfo);return decodeURIComponent(q[1]||"")},set:function(q){g(q);if(this._url){var b=u.exec(this._userinfo),q=[encodeURIComponent(q||
"")];b[2]&&q.push(b[2]);this._userinfo=q.join(":")}},enumerable:!0},password:{get:function(){if(!this._url)return"";var q=u.exec(this._userinfo);return decodeURIComponent(q[2]||"")},set:function(q){g(q);if(this._url){var b=[u.exec(this._userinfo)[1]||""];q&&b.push(encodeURIComponent(q));this._userinfo=b.join(":")}},enumerable:!0},host:{get:function(){var q="";this._url&&this._url.host&&(q+=this._url.host,this._url.port&&(q+=":"+this._url.port));return q},set:function(q){g(q);if(this._url&&(q=s.exec(q)))this._url.host=
q[1],this._url.port=d(q[2])},enumerable:!0},hostname:{get:function(){return this._url?this._url.host:""},set:function(q){g(q);this._url&&y.exec(q)&&(this._url.host=q)},enumerable:!0},port:{get:function(){var q=this._url?this._url.port||"":"";q&&q===B[this.protocol]&&(q="");return q},set:function(q){g(q);this._url&&t.exec(q)&&(this._url.port=d(q))},enumerable:!0},pathname:{get:function(){return this._url?this._url.path:""},set:function(q){g(q);this._url&&v.exec(q)&&(this._url.host&&(q&&"/"!==q[0])&&
...
f&&(l+=" "),l+=n(a[f]);return l},getUserText:function(a){var l=a.id,f=a.refNode,e=a.shouldHideRefNode,d=a.initialText,h=a.onComplete,c=a.onEditDestroy,b=a.selectTo,k=a.isInitialValid,a=a.insertAsChild,m=!1,r=function(b){return function(r){if(!m){var a=g.node(l),x=a.value;a&&(b&&r.keyCode===g.KEY.ESCAPE?(e&&(f.style.display="inline"),m=!0,a.parentNode.removeChild(a),c&&c()):b&&r.keyCode!==g.KEY.ENTER||(0===x.length||!k&&x===d?e&&(f.style.display="inline"):(h(x),e&&f.parentNode&&(f.style.display="inline")),
m=!0,a.parentNode&&a.parentNode.removeChild(a),c&&c()))}}},x=document.createElement("input");x.id=l;x.value=d||"";a?f.appendChild(x):f.parentNode.insertBefore(x,f.nextSibling);x.classList.add("userEditBoxPrompt");e&&(f.style.display="none");x.addEventListener("keydown",r(!0),!1);x.addEventListener("blur",r(!1),!1);window.setTimeout(function(){x.focus();if(d){var c=g.node(l),k=b?d.indexOf(b):-1;0<k?c.createTextRange?(c=c.createTextRange(),c.collapse(!0),c.moveStart("character",0),c.moveEnd("character",
...
n.KEY.ENTER||d.keyCode===n.KEY.SPACE)e.toggle(),n.stop(d)},!1)}this._dropdownNode.addEventListener("keydown",this._dropdownKeyDown.bind(this),!1)},toggle:function(a){return this.isVisible()?this.close():this.open(a)},isVisible:function(){return this._isVisible},open:function(a){var f=!1;if(!this.isVisible()){this.dispatchEvent({type:"triggered",dropdown:this,event:a});n.setFramesEnabled(!1);this._populate&&(this.empty(),this._populate(this._dropdownNode));var e=this.getItems();0<e.length&&(this._hookedAutoDismiss||
(this._boundAutoDismiss?n.removeAutoDismiss(this._boundAutoDismiss):this._boundAutoDismiss=this._autoDismiss.bind(this),f=n.$$array(".dropdownSubMenu",this._dropdownNode),n.addAutoDismiss([this._triggerNode].concat(f),this._boundAutoDismiss),this._hookedAutoDismiss=!0),this._triggerNode.classList.add("dropdownTriggerOpen"),this._selectionClass&&this._triggerNode.classList.add(this._selectionClass),this._dropdownNode.classList.add("dropdownMenuOpen"),this._isVisible=!0,this._positionDropdown(a),e[0].focus(),
f=!0,this._parentDropdown&&this._parentDropdown.submenuOpen(this))}return f},_autoDismiss:function(a){if(this.close(!1)&&this._dropdownNode.contains(a.target))for(a=this._parentDropdown;a;)a.close(!1),a=a._parentDropdown},_positionDropdown:function(){this._dropdownNode.style.left="";this._dropdownNode.style.top="";if(this._positioningNode)this._dropdownNode.style.left=this._positioningNode.offsetLeft+"px";else{var a=n.bounds(this._dropdownNode),f=n.bounds(document.body);if(a.left+a.width>f.left+f.width)if(this._triggerNode.classList.contains("dropdownMenuItem"))this._dropdownNode.style.left=
-a.width+"px";else{var e=n.bounds(this._boundingNode(this._triggerNode)),d=n.bounds(this._triggerNode);this._dropdownNode.style.left=d.left-e.left-a.width+d.width+"px"}a=a.top+a.height-(f.top+f.height);0<a&&(this._dropdownNode.style.top=Math.floor(this._dropdownNode.style.top-a)+"px")}},_boundingNode:function(a){var f=window.getComputedStyle(a,null);return null===f||"absolute"===f.getPropertyValue("position")||!a.parentNode||a===document.body?a:this._boundingNode(a.parentNode)},close:function(a){var f=
!1;this.isVisible()&&(this._triggerNode.classList.remove("dropdownTriggerOpen"),this._selectionClass&&this._triggerNode.classList.remove(this._selectionClass),this._dropdownNode.classList.remove("dropdownMenuOpen"),n.setFramesEnabled(!0),a&&this._triggerNode.focus(),this._isVisible=!1,f=!0);return f},getItems:function(){var a=[],f=this;n.$$array("li:not(.dropdownSeparator) > .dropdownMenuItem",this._dropdownNode,!0).forEach(function(e){e.parentNode.parentNode===f._dropdownNode&&a.push(e)});a.forEach(function(a){a._hasDropdownMouseover||
(a.addEventListener("mouseover",function(d){a.dropdown?a.dropdown.open(d):(f._closeSelectedSubmenu(),n.stop(d))}),a._hasDropdownMouseover=!0)});return a},empty:function(){var a=this;n.$$array("li",this._dropdownNode).forEach(function(f){f.parentNode===a._dropdownNode&&f.parentNode.removeChild(f)});this._hookedAutoDismiss=!1},_dropdownKeyDown:function(a){if(a.keyCode===n.KEY.UP||a.keyCode===n.KEY.DOWN||a.keyCode===n.KEY.RIGHT||a.keyCode===n.KEY.ENTER||a.keyCode===n.KEY.LEFT){var f=this.getItems(),
e=document.activeElement;if(f.length&&0<f.length&&e){var d=f.indexOf(e);0>d&&(d=f.indexOf(e.parentNode));0<=d&&(a.keyCode===n.KEY.UP&&0<d?(d--,f[d].focus()):a.keyCode===n.KEY.DOWN&&d<f.length-1?(d++,f[d].focus()):a.keyCode===n.KEY.ENTER||a.keyCode===n.KEY.RIGHT?e.classList.contains("dropdownTrigger")&&e.dropdown&&e.dropdown.open():a.keyCode===n.KEY.LEFT&&e.parentNode.parentNode.classList.contains("dropdownMenuOpen")&&this.close(!0),n.stop(a))}}else a.keyCode===n.KEY.ESCAPE&&(this.close(!0),n.stop(a))},
submenuOpen:function(a){a!==this._selectedSubmenu&&(this._closeSelectedSubmenu(),this._selectedSubmenu=a)},_closeSelectedSubmenu:function(){for(var a=this._selectedSubmenu;a;)a.close(),a=a._selectedSubmenu},destroy:function(){this.empty();this._boundAutoDismiss&&n.removeAutoDismiss(this._boundAutoDismiss)}};a.prototype.constructor=a;return{Dropdown:a}});
...
d,k=!1,a=b.indexOf(".");c=0===b.indexOf("./")||0===b.indexOf("../");-1!==a&&(!c||1<a)?(c=b.substring(0,a),d=b.substring(a+1,b.length)):c=b;b=d||c;a=b.indexOf("!");-1!==a&&(k="strip"===b.substring(a+1),b=b.substring(0,a),d?d=b:c=b);return{moduleName:c,ext:d,strip:k}},xdRegExp:/^((\w+)\:)?\/\/([^\/\\]+)/,useXhr:function(b,c,d,k){var a,h;a=n.xdRegExp.exec(b);if(!a)return!0;b=a[2];a=a[3];a=a.split(":");h=a[1];a=a[0];return(!b||b===c)&&(!a||a.toLowerCase()===d.toLowerCase())&&(!h&&!a||h===k)},finishLoad:function(c,
d,a,h){a=d?n.strip(a):a;k.isBuild&&(b[c]=a);h(a)},load:function(b,a,l,f){if(f.isBuild&&!f.inlineText)l();else{k.isBuild=f.isBuild;var t=n.parseName(b),f=t.moduleName+(t.ext?"."+t.ext:""),g=a.toUrl(f),s=k.useXhr||n.useXhr;!e||s(g,d,h,c)?n.get(g,function(c){n.finishLoad(b,t.strip,c,l)},function(b){l.error&&l.error(b)}):a([f],function(b){n.finishLoad(t.moduleName+"."+t.ext,t.strip,b,l)})}},write:function(c,d,a){if(b.hasOwnProperty(d)){var k=n.jsEscape(b[d]);a.asModule(c+"!"+d,"define(function () { return '"+
k+"';});\n")}},writeFile:function(b,c,d,a,k){var c=n.parseName(c),h=c.ext?"."+c.ext:"",e=c.moduleName+h,l=d.toUrl(c.moduleName+h)+".js";n.load(e,d,function(){var c=function(q){return a(l,q)};c.asModule=function(q,b){return a.asModule(q,l,b)};n.write(b,e,c,k)},k)}};if("node"===k.env||!k.env&&"undefined"!==typeof process&&process.versions&&process.versions.node)p=require.nodeRequire("fs"),n.get=function(b,c){var d=p.readFileSync(b,"utf8");0===d.indexOf("\ufeff")&&(d=d.substring(1));c(d)};else if("xhr"===
k.env||!k.env&&n.createXhr())n.get=function(b,c,d,a){var h=n.createXhr(),e;h.open("GET",b,!0);if(a)for(e in a)a.hasOwnProperty(e)&&h.setRequestHeader(e.toLowerCase(),a[e]);if(k.onXhr)k.onXhr(h,b);h.onreadystatechange=function(){var a;4===h.readyState&&(a=h.status,399<a&&600>a?(a=Error(b+" HTTP status: "+a),a.xhr=h,d(a)):c(h.responseText))};h.send(null)};else if("rhino"===k.env||!k.env&&"undefined"!==typeof Packages&&"undefined"!==typeof java)n.get=function(b,c){var d,a,k=new java.io.File(b),h=java.lang.System.getProperty("line.separator"),
k=new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(k),"utf-8")),e="";try{d=new java.lang.StringBuffer;(a=k.readLine())&&(a.length()&&65279===a.charAt(0))&&(a=a.substring(1));for(d.append(a);null!==(a=k.readLine());)d.append(h),d.append(a);e=String(d.toString())}finally{k.close()}c(e)};return n});define("text!orion/webui/dropdowntriggerbutton.html",[],function(){return'<button class="dropdownTrigger">${ButtonText}<span class="dropdownArrowDown core-sprite-openarrow"></span></button><ul class="dropdownMenu"></ul>'});
...
define("orion/commands","require orion/util orion/webui/littlelib orion/webui/dropdown text!orion/webui/dropdowntriggerbutton.html text!orion/webui/submenutriggerbutton.html text!orion/webui/checkedmenuitem.html orion/webui/tooltip".split(" "),function(g,n,p,a,l,f,e,d){function h(b){var c=b.invocation;if(c){var q=b.command;if(q.hrefCallback)return b=q.hrefCallback.call(c.handler||window,c),b.then?b.then(function(q){window.open(q)}):window.open(b),!0;if(c.commandRegistry)return c.commandRegistry._invoke(c),
!0;if(q.onClick||q.callback)return window.setTimeout(function(){(q.onClick||q.callback).call(c.handler||window,c)},0),!0}return!1}function c(b,c){for(var q in c)if(c[q]&&(c[q].keyBinding&&c[q].command)&&c[q].keyBinding.match(b)){var u=c[q],d=u.keyBinding;if((!d.domScope||p.contains(p.node(d.domScope),b.target))&&h(u)){p.stop(b);break}}}function b(){var b={};if(y){var c,q,u;q=Object.keys(s);for(c=0;c<q.length;c++)u=q[c],b[u]=s[u];var d=y();q=Object.keys(d);for(c=0;c<q.length;c++)u=q[c],b[u]=d[u]}else b=
s;return b}function k(d){c(d,b())}function m(b,c){b=b||window.event;if(function(q){if(n.isMac){if(q.metaKey&&!q.altKey)return!q.shiftKey&&!q.ctrlKey&&(65===q.keyCode||67===q.keyCode||86===q.keyCode||88===q.keyCode||90===q.keyCode)?!0:!1;if(q.ctrlKey)return!1}else{if(q.ctrlKey&&!q.altKey)return!q.shiftKey&&(65===q.keyCode||67===q.keyCode||86===q.keyCode||88===q.keyCode||90===q.keyCode)?!0:!1;if(q.altKey&&!q.ctrlKey)return!1}if(q["char"])return 0<q["char"].length;if(q.charCode||q.keyCode)switch(q=q.charCode||
q.keyCode,q){case 8:case 9:case 13:case 46:return!0;default:return 32<=q&&112>q||123<q}return!1}(b)){if("true"===b.target.contentEditable)return;var q=b.target.nodeName.toLowerCase();if("input"===q)switch(b.target.type.toLowerCase()){case "text":case "password":case "search":case "color":case "date":case "datetime":case "datetime-local":case "email":case "month":case "number":case "range":case "tel":case "time":case "url":case "week":return}else if("textarea"===q)return}c?c(b):k(b)}function r(){this._init()}
function x(b,c,q){c.classList.add("commandImage");var u;b.imageClass?b.addImageClassToElement?c.classList.add(b.imageClass):(u=document.createElement("span"),c.appendChild(u),u.classList.add(b.spriteClass),u.classList.add(b.imageClass)):(u=new Image,u.alt=b.name,u.name=q,u.id=q,u.src=b.image,c.appendChild(u));return u}function w(b,c,q,u,d){this.commandRegistry=d;this.handler=b;this.items=c;this.userData=q;this.command=u;u.parameters&&(this.parameters=u.parameters.makeCopy());this.id=u.id}function t(b){this._init(b)}
var y=null,s={};r.prototype={setProxy:function(b){this.proxy=b},setKeyBindings:function(b){this.bindings=b},_init:function(){var b=this;document.addEventListener("keydown",function(c){return m(c,function(q){var c=b.proxy,d=b.bindings;if(d&&c)for(var a=0;a<d.length;a++)d[a].match(q)&&(c.processKey({type:q.type,keyCode:q.keyCode,altKey:q.altKey,ctrlKey:q.ctrlKey,metaKey:q.metaKey,shiftKey:q.shiftKey}),p.stop(q))})})}};window.document.addEventListener("keydown",m,!1);w.prototype={collectsParameters:function(){return this.commandRegistry&&
this.commandRegistry.collectsParameters()},makeCopy:function(b){var c=new w(this.handler,this.items,this.userData,this.command,this.commandRegistry);c.domNode=this.domNode;c.domParent=this.domParent;b?c.parameters=b.makeCopy():this.parameters&&(c.parameters=this.parameters.makeCopy());return c}};w.prototype.constructor=w;t.prototype={_init:function(b){this.id=b.id;this.name=b.name;this.tooltip=b.tooltip;this.callback=b.callback;this.hrefCallback=b.hrefCallback;this.choiceCallback=b.choiceCallback;
this.positioningNode=b.positioningNode;this.image=b.image||g.toUrl&&g.toUrl("images/none.png");this.imageClass=b.imageClass;this.addImageClassToElement=b.addImageClassToElement;this.selectionClass=b.selectionClass;this.spriteClass=b.spriteClass||"commandSprite";this.visibleWhen=b.visibleWhen;this.parameters=b.parameters;this.isEditor=b.isEditor},populateChoicesMenu:function(b,c,q,u,d){this.getChoices(c,q,u).forEach(function(q){if(q.name){var u=document.createElement("li");b.appendChild(u);var a=document.createElement("span");
a.tabIndex=0;a.role="menuitem";a.classList.add("dropdownMenuItem");var k=document.createTextNode(q.name);a.appendChild(k);u.appendChild(a);a.choice=q;a.addEventListener("click",function(q){q.target.choice&&q.target.choice.callback.call(q.target.choice,c)},!1);a.addEventListener("keydown",function(q){(q.keyCode===p.KEY.ENTER||q.keyCode===p.KEY.SPACE)&&q.target.choice&&q.target.choice.callback.call(q.target.choice,c)},!1)}else d._generateMenuSeparator(b)})},getChoices:function(b,c,q){return this.choiceCallback?
this.choiceCallback.call(c,b,q):null},makeChoiceCallback:function(b,c){return function(q){b.callback&&b.callback.call(b,c,q)}},hasImage:function(){return this.imageClass||this.image!==g.toUrl("images/none.png")}};t.prototype.constructor=t;return{Command:t,CommandInvocation:w,createDropdownMenu:function(b,c,q,u,d,k,r,m){b=p.node(b);if(!b)throw"no parent node was specified";var h=document.createRange();h.selectNode(b);h=h.createContextualFragment(l);p.processTextNodes(h,{ButtonText:c});b.appendChild(h);
b=b.lastChild;h=b.previousSibling;u?h.classList.add(u):(h.classList.add("orionButton"),h.classList.add("commandButton"));d&&(k||(h.textContent="",h.setAttribute("aria-label",c)),x({spriteClass:"commandSprite",imageClass:d},h,c),h.classList.add("orionButton"));h.dropdown=new a.Dropdown({dropdown:b,populate:q,selectionClass:r,positioningNode:m});b.dropdown=h.dropdown;return{menuButton:h,menu:b,dropdown:h.dropdown}},createCheckedMenuItem:function(b,c,q,u){b=p.node(b);if(!b)throw"no parent node was specified";
var d=document.createRange();d.selectNode(b);d=d.createContextualFragment(e);p.processTextNodes(d,{ItemText:c});b.appendChild(d);b=p.$(".checkedMenuItem",b.lastChild);b.checked=q;b.addEventListener("change",u,!1);return b},createCommandItem:function(b,c,q,u,a,k,r){var m,k=k||!c.name&&c.hasImage();if(c.hrefCallback)m=document.createElement("a"),m.id=u,k&&c.hasImage()?x(c,m,u):(m.className="commandLink",m.appendChild(document.createTextNode(c.name))),r=c.hrefCallback.call(q.handler,q),r.then?r.then(function(q){m.href=
q}):m.href=r?r:"#";else{m=document.createElement("button");m.className="orionButton";k?c.hasImage()?(x(c,m,u),c.name&&m.setAttribute("aria-label",c.name)):(m.classList.add("commandButton"),m.classList.add("commandMissingImageButton"),m.appendChild(document.createTextNode(c.name))):(m.classList.add("commandButton"),u=document.createTextNode(c.name),m.appendChild(u));var h=r||c.callback;h&&(c.onClick=h,m.addEventListener("click",function(){h.call(q.handler,q)},!1))}"ul"===b.nodeName.toLowerCase()?(r=
document.createElement("li"),b.appendChild(r),b=r):m.classList.add("commandMargins");b.appendChild(m);c.tooltip&&(m.commandTooltip=new d.Tooltip({node:m,text:c.tooltip,position:["above","below","right","left"]}));a&&(s[c.id]={keyBinding:a,command:c,invocation:q});return m},createCommandMenuItem:function(b,c,q,u,d){var a,k=b.dropdown;if(c.hrefCallback)a=document.createElement("a"),a.appendChild(document.createTextNode(c.name)),d=c.hrefCallback.call(q.handler,q),d.then?d.then(function(q){a.href=q}):
a.href=d?d:"#",a.addEventListener("keydown",function(q){(q.keyCode===p.KEY.ENTER||q.keyCode===p.KEY.SPACE)&&a.click()},!1);else{a=document.createElement("span");a.tabIndex=0;a.appendChild(document.createTextNode(c.name));var r=d||c.callback;r&&(c.onClick=r,a.addEventListener("click",function(){k.close(!0);r.call(q.handler,q)},!1),a.addEventListener("keydown",function(q){if(q.keyCode===p.KEY.ENTER||q.keyCode===p.KEY.SPACE)q.preventDefault(),a.click()},!1))}a.className="dropdownMenuItem";a.role="menuitem";
d=document.createElement("li");b.appendChild(d);d.appendChild(a);u&&(s[c.id]={keyBinding:u,command:c,invocation:q});return a},executeBinding:h,setKeyBindingProvider:function(b){y=b},localKeyBindings:s,CommandsProxy:r,getKeyBindings:b,processKey:k,_testMethodProcessKey:c}});
...
_makeDropTarget:function(b,c,d){function e(c,q,u,d,k,m){q=q||"";if(c.isFile)l.isAtRoot(u.Location)?d.registry&&d.registry.getService("orion.page.message").setProgressResult({Severity:"Error",Message:g["You cannot copy files directly into the workspace.  Create a folder first."]}):c.file(function(q){k(u,q,d,q.name.indexOf(".zip")===q.name.length-4&&window.confirm(a.formatMessage(g["Unzip ${0}?"],q.name)))});else if(c.isDirectory){var h=c.createReader(),f=function(b){h.readEntries(function(u){for(var a=
0;a<u.length;a++)e(u[a],q+c.name+"/",b,d,k,m)})},x=null;d.registry&&(x=d.registry.getService("orion.page.progress"));l.isAtRoot(u.Location)?(x?x.progress(m.createProject(u.ChildrenLocation,c.name),a.formatMessage(g["Creating ${0}"],c.name)):m.createProject(u.ChildrenLocation,c.name)).then(function(q){d.loadResourceList(d.treeRoot.Path,!0);(x?x.progress(m.read(q.ContentLocation,!0),g["Loading "]+q.name):m.read(q.ContentLocation,!0)).then(function(q){f(q)})}):(x?x.progress(m.createFolder(u.Location,
c.name),a.formatMessage(g["Creating ${0}"],c.name)):m.createFolder(u.Location,c.name)).then(function(q){d.modelEventDispatcher.dispatchEvent({type:"create",parent:b,newValue:q});f(q)})}}if(this.dragAndDrop){var f=this,s=this.dragAndDrop,v=function(b){k=b.target};d&&(this._oldDragStart&&c.removeEventListener("dragstart",this._oldDragStart,!1),this._oldDragStart=v);c.addEventListener("dragstart",v,!1);v=function(){k=null};d&&(this._oldDragEnd&&c.removeEventListener("dragend",this._oldDragEnd,!1),this._oldDragEnd=
...
v,!1),this._oldDragOver=v);v=function(d){var q;c.classList.remove("dragOver");if(k){q=f.fileClient;for(var u=k,A;u;){if(u._item){A=u._item;break}u=u.parentNode}if(!A)return;var B=null;f.registry&&(B=f.registry.getService("orion.page.progress"));var h="copy"===m,u=h?q.copyFile:q.moveFile;(B?B.showWhile(u.apply(q,[A.Location,b.Location]),a.formatMessage(g[h?"Copying ${0}":"Moving ${0}"],A.Location)):u.apply(q,[A.Location,b.Location])).then(function(q){f.modelEventDispatcher.dispatchEvent({type:h?"copy":
"move",oldValue:A,newValue:q,parent:b})},function(q){B?B.setProgressResult(q):window.console.log(q)})}else if(d.dataTransfer.items&&0<d.dataTransfer.items.length)for(q=0;q<d.dataTransfer.items.length;q++)u=null,"function"===typeof d.dataTransfer.items[q].getAsEntry?u=d.dataTransfer.items[q].getAsEntry():"function"===typeof d.dataTransfer.items[q].webkitGetAsEntry&&(u=d.dataTransfer.items[q].webkitGetAsEntry()),u&&e(u,null,b,f,s,f.fileClient);else if(d.dataTransfer.files&&0<d.dataTransfer.files.length)for(q=
0;q<d.dataTransfer.files.length;q++)u=d.dataTransfer.files[q],!u.length&&(!u.type||""===u.type)?f.registry&&f.registry.getService("orion.page.message").setProgressResult({Severity:"Error",Message:a.formatMessage(g["Did not drop ${0}.  Folder drop is not supported in this browser."],u.name)}):l.isAtRoot(b.Location)?f.registry&&f.registry.getService("orion.page.message").setProgressResult({Severity:"Error",Message:g["You cannot copy files directly into the workspace.  Create a folder first."]}):s(b,
u,f,u.name.indexOf(".zip")===u.name.length-4&&window.confirm(a.formatMessage(g["Unzip ${0}?"],u.name)));p.stop(d)};d&&(this._oldDrop&&c.removeEventListener("drop",this._oldDrop,!1),this._oldDrop=v);c.addEventListener("drop",v,!1)}},createModel:function(){return new c(this.registry,this.treeRoot,this.fileClient,this.parentId,this.excludeFiles,this.excludeFolders)},changedItem:function(b,c){if(this.treeRoot&&this.treeRoot.Location===b.Location)return this.loadResourceList(this.treeRoot,c);var a=this,
...
define("orion/explorers/navigationUtils",[],function(){function g(g,a){!n&&g&&(g.push({domNode:a}),a.tabIndex=-1,a.style.outline="none")}var n=-1!==navigator.userAgent.indexOf("iPad");return{addNavGrid:function(p,a,l){p&&(p=p.getGridNavHolder(a,!0))&&g(p,l)},generateNavGrid:g,removeNavGrid:function(g,a){if(g)for(var l=0;l<g.length;l++)if(g[l].domNode===a){g.splice(l,1);break}}}});
define("orion/regex",[],function(){return{escape:function(g){return g.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g,"\\$&")},parse:function(g){return(g=/^\s*\/(.+)\/([gim]{0,3})\s*$/.exec(g))?{pattern:g[1],flags:g[2]}:null}}});
define("orion/contentTypes",[],function(){function g(a,c){if("string"!==typeof a)return null;for(var b=a&&a.split(".").pop(),d=null,m=0;m<c.length;m++){var e=c[m],l;a:{l=d;var f=e,t=b,g=0<=f.filename.indexOf(a),s;s=t.toLowerCase();s=-1!==f.extension.indexOf(s);if(g||s){if(!(s=!l))g&&(t=t.toLowerCase(),g=-1!==l.extension.indexOf(t)),s=g;if(s){l=f;break a}}}l===e&&(d=e)}return d}function n(a){return null===a||"undefined"===typeof a?[]:Array.isArray(a)?a:[a]}function p(a){return{id:a.id,name:a.name,
image:a.image,imageClass:a.imageClass,"extends":a["extends"],extension:n(a.extension).map(function(c){return String.prototype.toLowerCase.call(c)}),filename:n(a.filename)}}function a(a){var c=Object.create(null);a.map(p).forEach(function(b){Object.prototype.hasOwnProperty.call(c,b.id)||(c[b.id]=b)});return c}function l(h){if(h&&h.registerService){this.serviceRegistry=h;for(var c=h.getServiceReferences(e).concat(h.getServiceReferences(d)),b=[],k=0;k<c.length;k++)for(var m=n(c[k].getProperty("contentTypes")),
r=0;r<m.length;r++)b.push(m[r]);this.map=a(b);h.registerService(f,this)}else if(Array.isArray(h))this.serviceRegistry=null,this.map=a(h);else throw Error("Invalid parameter");}var f="orion.core.contentTypeRegistry",e="orion.core.contenttype",d="orion.file.contenttype";l.prototype={getContentTypes:function(){var a=this.getContentTypesMap(),c=[],b;for(b in a)Object.prototype.hasOwnProperty.call(a,b)&&c.push(a[b]);return c},getContentTypesMap:function(){return this.map},getFileContentType:function(a){return g(a.Name,
...
f.prototype={expand:function(b){for(var c=[],d=0;d<this._varSpecList.length;d++){var e=this._varSpecList[d],h=e.name,f=b[h],t=typeof f;if("undefined"!==t&&null!==f){var g=0===c.length?this._operator.first:this._operator.sep,s=g;if("string"===t)this._operator.named&&(s+=p(h,"U+R"),s+=0===f.length?this._operator.ifemp:"="),-1!==e.prefix&&e.prefix<f.length&&(f=f.substring(0,e.prefix)),s+=p(f,this._operator.allow);else if(Array.isArray(f))e.explode?s+=a(f,this._operator.allow,this._operator.sep):(this._operator.named&&
(s+=p(h,"U+R"),s+=0===f.length?this._operator.ifemp:"="),s+=a(f,this._operator.allow,","));else if("object"===t)e.explode?s+=l(f,this._operator.allow,"=",this._operator.sep):(this._operator.named&&(s+=p(h,"U+R"),s+=0===Object.keys(f).length?this._operator.ifemp:"="),s+=l(f,this._operator.allow,",",","));else throw Error("bad param type: "+h+" : "+t);(s!==g||d<this._varSpecList.length-1)&&c.push(s)}}return c.join("")}};e.prototype={expand:function(b){for(var c=[],a=0;a<this._templateComponents.length;a++)c.push(this._templateComponents[a].expand(b));
return c.join("")}};return e});
define("orion/PageLinks","require orion/Deferred orion/PageUtil orion/URITemplate orion/i18nUtil orion/URL-shim".split(" "),function(g,n,p,a,l){function f(){return g.toUrl?(new URL(g.toUrl("orion/../"),window.location.href)).href.slice(0,-1):(new URL("/",window.location.href)).href.slice(0,-1)}function e(d,e){var c=d.getServiceReferences(e||"orion.page.link"),b=p.matchResourceParameters(window.location.href),k={OrionHome:f(),Location:b.resource},m=[];c.forEach(function(b){var c={};b.getPropertyKeys().forEach(function(a){c[a]=
b.getProperty(a)});if(c.uriTemplate&&c.nls&&(c.name||c.nameKey)){var d=new n;l.getMessageBundle(c.nls).then(function(b){var e=(new a(c.uriTemplate)).expand(k),e=p.validateURLScheme(e);c.href=e;c.textContent=c.nameKey?b[c.nameKey]:c.name;d.resolve(c)});m.push(d)}else if(c.uriTemplate&&c.name){var e=(new a(c.uriTemplate)).expand(k),e=p.validateURLScheme(e);c.href=e;c.textContent=c.name;m.push((new n).resolve(c))}});return n.all(m)}return{createPageLinks:function(a,l){return e(a,l).then(function(c){c.sort(function(b,
c){var a=b.textContent&&b.textContent.toLowerCase(),d=c.textContent&&c.textContent.toLowerCase();return a<d?-1:a>d?1:0});return c.map(function(b){var c=b.href,b=b.textContent,a=document.createElement("a");a.href=c;a.target="_self";a.classList.add("targetSelector");a.textContent=b;return a})})},getPageLinksInfo:e,getOrionHome:f}});
define("orion/extensionCommands","require orion/Deferred orion/commands orion/regex orion/contentTypes orion/URITemplate orion/i18nUtil orion/URL-shim orion/PageLinks i18n!orion/edit/nls/messages".split(" "),function(g,n,p,a,l,f,e,d,h,c){function b(b){var c={};b.getPropertyKeys().forEach(function(a){c[a]=b.getProperty(a)});return c}var k={},m=h.getOrionHome();k._cloneItemWithoutChildren=function w(b){if(null===b||"object"!==typeof b)return b;var c=b.constructor(),a;for(a in b)"children"!==a&&"Children"!==
a&&(c[a]=w(b[a]));return c};k._getOpenWithNavCommandExtensions=function(c){for(var a,d,k=c.getServiceReferences("orion.edit.editor"),e=[],m=0;m<k.length;m++){var q=k[m],u=q.getProperty("id");e.push({id:u,name:q.getProperty("name"),nameKey:q.getProperty("nameKey"),nls:q.getProperty("nls"),uriTemplate:q.getProperty("orionTemplate")||q.getProperty("uriTemplate"),validationProperties:q.getProperty("validationProperties")||[]})}k=null;m=c.getServiceReferences("orion.navigate.openWith.default");0<m.length&&
(k=b(m[0]));m=[];for(q=0;q<e.length;q++){var u=e[q],A=k&&k.editor===u.id;a=u;var r=c.getServiceReferences("orion.navigate.openWith"),l=[];d=[];for(var h=0;h<r.length;h++){var f=r[h];if(f.getProperty("editor")===a.id){var g=f.getProperty("contentType");g instanceof Array?l=l.concat(g):null!==g&&"undefined"!==typeof g&&l.push(g);f=f.getProperty("excludedContentTypes");f instanceof Array?d=d.concat(f):null!==f&&"undefined"!==typeof f&&d.push(f)}}0===l.length&&(l=null);0===d.length&&(d=null);a=l;m.push({properties:{name:u.name||
u.id,nameKey:u.nameKey,id:"eclipse.openWithCommand."+u.id,contentType:a,excludedContentTypes:d,uriTemplate:u.uriTemplate,nls:u.nls,forceSingleItem:!0,isEditor:A?"default":"editor",validationProperties:u.validationProperties},service:{}})}return m};k._makeValidator=function(b,c,a,d){function k(b,c,a,d){var e=a.match,m;if(0===c.indexOf("[")){if(0>c.indexOf("]")||!Array.isArray(b))return!1;m=c.replace("[","").replace("]","");for(c=0;c<b.length;c++)if(k(b[c],m,a,d))return!0}else{if(0<=c.indexOf("|"))return m=
c.substring(0,c.indexOf("|")),c=c.substring(c.indexOf("|")+1),k(b,m,a,d)?!0:k(b,c,a,d);if(0<=c.indexOf(":"))return m=c.substring(0,c.indexOf(":")),c=c.substring(c.indexOf(":")+1),b[m]?k(b[m],c,a,d):!1;a:{m=!1;var r;if("!"===c.charAt(0))a="undefined"===typeof b[c.substring(1)];else if("undefined"!==typeof b[c]){if("undefined"===typeof e)r=b[c],m=!0;else if("string"===typeof e){if(!typeof("string"===b[c])){a=!1;break a}if(a.variableName){if(e=RegExp(e).exec(b[c]))m=e[0],r="before"===a.variableMatchPosition?
b[c].substring(0,e.index):"after"===a.variableMatchPosition?b[c].substring(e.index+m.length):"only"===a.variableMatchPosition?m:b[c],m=!0}else{a=RegExp(e).test(b[c]);break a}}else b[c]===e&&(r=b[c],m=!0);if(m&&a.variableName&&(d[a.variableName]=r,d.itemCached=b,a.replacements))for(b=0;b<a.replacements.length;b++)c=!1,a.replacements[b].pattern?d[a.variableName]=d[a.variableName].replace(RegExp(a.replacements[b].pattern),a.replacements[b].replacement||""):c=!0,c&&window.console.log("Invalid replacements specified in validation property.  "+
a.replacements[b]);a=m}else a=!1}return a}}function e(q,c,a){if(a.info.validationProperties)for(var d=0;d<a.info.validationProperties.length;d++){var m=a.info.validationProperties[d];if("undefined"!==typeof m.source){if(!k(q,m.source,m,a))return!1}else return window.console.log("Invalid validationProperties in "+b.id+".  No source property specified."),!1}var m=!0,r=null;a.info.excludedContentTypes&&c&&(r=l.getFilenameContentType(q.Name,c))&&(m=a.info.excludedContentTypes.every(function(b){b=b.replace(/([*?])/g,
".$1");return-1!==r.id.search(b)?!1:!0}));if(m&&(a.info.contentType&&c)&&(m=!1,r=l.getFilenameContentType(q.Name,c)))for(d=0;d<a.info.contentType.length;d++)if(r.id===a.info.contentType[d]){m=!0;break}return m}return{info:b,validationFunction:function(b){"function"===typeof d&&(b=d.call(this,b));if(b){if(Array.isArray(b)){if((this.info.forceSingleItem||this.info.uriTemplate)&&1!==b.length||1>b.length)return!1}else b=[b];for(var c=0;c<b.length;c++)if(!e(b[c],a,this))return!1;return!0}return!1},generatesURI:function(){return!!this.info.uriTemplate},
getURI:function(b){if(this.info.uriTemplate){var c={},a;for(a in b)Object.prototype.hasOwnProperty.call(b,a)&&(c[a]=b[a]);if(this.info.validationProperties)for(a=0;a<this.info.validationProperties.length;a++){var d=this.info.validationProperties[a];d.source&&d.variableName&&(this.itemCached===b&&this[d.variableName]||k(b,d.source,d,this),b[d.variableName]?window.console.log("Variable name "+d.variableName+" in the extension "+this.info.id+" conflicts with an existing property in the item metadata."):
c[d.variableName]=this[d.variableName])}c.OrionHome=m;return(new f(this.info.uriTemplate)).expand(c)}return null}}};k._createCommandOptions=function(b,c,a,d,m,r){function q(q,u){var e=k._makeValidator(b,a,d,r);q.visibleWhen=e.validationFunction.bind(e);if(m)if(e.generatesURI.bind(e)())q.hrefCallback=function(b){b=Array.isArray(b.items)?b.items[0]:b.items;return e.getURI.bind(e)(b)};else{var l=b;q.callback=function(b){var d;if(l.forceSingleItem)b=Array.isArray(b.items)?b.items[0]:b.items,d=k._cloneItemWithoutChildren(b);
else if(Array.isArray(b.items)){d=[];for(var u=0;u<b.items.length;u++)d.push(k._cloneItemWithoutChildren(b.items[u]))}else d=k._cloneItemWithoutChildren(b.items);if(a)var m=a.getService("orion.page.progress");c.run?m?m.progress(c.run(d),"Running command: "+q.name):c.run(d):a&&(m?m.progress(a.getService(c).run(d),"Running command: "+q.name):a.getService(c).run(d))}}u.resolve(q)}var u=new n;b.nls?e.getMessageBundle(b.nls).then(function(c){q({name:b.nameKey?c[b.nameKey]:b.name,image:b.image,id:b.id||
b.name,tooltip:b.tooltipKey?c[b.tooltipKey]:b.tooltip,isEditor:b.isEditor,showGlobally:b.showGlobally},u)}):q({name:b.name,image:b.image,id:b.id||b.name,tooltip:b.tooltip,isEditor:b.isEditor,showGlobally:b.showGlobally},u);return u};k.getOpenWithCommands=function(b){var c=[],a;for(a in b._commandList){var d=b._commandList[a];d.isEditor&&c.push(d)}return c};var r;k.createAndPlaceFileCommandsExtension=function(b,a,d,m,e,r){return k.createFileCommands(b,null,r?"all":void 0,!!r,a).then(function(b){e&&
0<b.length&&(a.addCommandGroup(d,"eclipse.openWith",1E3,c.OpenWith,e,null,null,null,"dropdownSelection"),a.addCommandGroup(d,"eclipse.fileCommandExtensions",1E3,c.Extensions,e));b.forEach(function(b){var q=null;e&&(q=b.isEditor?e+"/eclipse.openWith":e+"/eclipse.fileCommandExtensions");a.registerCommandContribution(d,b.id,m,q)});return{}})};k.createFileCommands=function(b,c,a,d,m){var a=void 0===a?"global":a,d=void 0===d?!0:d,e=[];k._cachedFileCommands||k._createCachedFileCommands(b);("all"===a||"global"===
a)&&k._cachedFileCommands.forEach(function(b){var c=b.properties;("all"===a||c.forceSingleItem&&c.showGlobally)&&e.push(b)});return n.when(function(){var q=b.getService("orion.core.contentTypeRegistry")||c;return r||n.when(q.getContentTypes(),function(b){return r=b})}(),function(){d&&(k._cachedOpenWithExtensions||(k._cachedOpenWithExtensions=k._getOpenWithNavCommandExtensions(b,r)),e=e.concat(k._cachedOpenWithExtensions),m._addedOpenWithCommands=d);var q=e.map(function(q){var c=q.properties,q=q.service,
a=m.findCommand(c.id||c.name);return a?(new n).resolve(a):k._createCommandOptions(c,q,b,r,!0).then(function(b){b=new p.Command(b);m.addCommand(b);return b})});return n.all(q,function(b){return{_error:b}}).then(function(b){return b})})};k._createCachedFileCommands=function(c){var a=c.getServiceReferences("orion.navigate.command");k._cachedFileCommands=[];for(var d=0;d<a.length;d++)if("orion.navigateFromMetadata"!==a[d].getProperty("id")){var m=c.getService(a[d]),e=b(a[d]);k._cachedFileCommands.push({properties:e,
service:m})}};k.getFileCommandIds=function(){var b=[];if(k._cachedFileCommands)k._cachedFileCommands.length&&(b=k._cachedFileCommands.map(function(b){return b.properties.id}));else throw"extensionCommandUtils._cachedFileCommands is not initialized";return b};k.createOpenWithCommands=function(b,c,a){return a&&a._addedOpenWithCommands?(new n).resolve(k.getOpenWithCommands(a)):k.createFileCommands(b,c,"none",!0,a)};return k});
define("orion/explorers/navigatorRenderer","i18n!orion/navigate/nls/messages orion/Deferred orion/explorers/explorer orion/explorers/navigationUtils orion/extensionCommands orion/objects orion/URITemplate orion/webui/littlelib".split(" "),function(g,n,p,a,l,f,e,d){function h(b){switch(b&&b.id){case "image/jpeg":case "image/png":case "image/gif":case "image/ico":case "image/tiff":case "image/svg":return!0}return!1}function c(b,c,a,d,g,y,s,v,p,q){var c=f.clone(c),u;if(c.Directory)u=document.createElement("a"),
u.className="navlinkonpage",u.href=!b?k:(new e(b+"#{,resource,params*}")).expand({resource:c.ChildrenLocation}),c.Name&&u.appendChild(document.createTextNode(c.Name));else{g||(g=l.getOpenWithCommands(a));if(!y)for(b=0;b<g.length;b++)"default"===g[b].isEditor&&(y=g[b]);u=document.createElement("a");u.className="navlink targetSelector";s&&"object"===typeof s&&Object.keys(s).forEach(function(b){u[b]=s[b]});var A=null,B=null;if(A=p?p.holderDom:u)B=document.createElement("span"),B.className="core-sprite-file modelDecorationSprite thumbnail",
A.appendChild(B);c.Name&&u.appendChild(document.createTextNode(c.Name));var C=!1,M=c.Location;v&&"object"===typeof v&&(c.params={},f.mixin(c.params,v));for(b=0;b<g.length;b++)if(v=g[b],v.visibleWhen(c)){M=v.hrefCallback({items:c});C=!0;break}n.when(d.getFileContentType(c),function(b){!C&&(y&&!h(b))&&(M=y.hrefCallback({items:c}));if(A){var a=A,d=B;if(b){var k,e=b.imageClass,m=b.image;e?(k=document.createElement("span"),k.className+=e,k.classList.add("thumbnail")):m&&(k=document.createElement("img"),
k.src=m,k.classList.add("thumbnail"));k&&a.replaceChild(k,d)}}u.href=M;q&&"function"===typeof q.updateFileNode&&q.updateFileNode(c,u,h(b))})}return u}function b(b,c,a,d){this.explorer=c;this.commandService=a;this.contentTypeService=d;this.openWithCommands=null;this.actionScopeId=b.actionScopeId;this._init(b);this.target="_self"}var k=new e("#{,resource,params*}");b.prototype=new p.SelectionRenderer;b.prototype.wrapperCallback=function(b){b.setAttribute("role","tree")};b.prototype.tableCallback=function(b){b.setAttribute("aria-label",
...
typeof c){m||(m=c,c=null);c&&(c=e({},d.defaults,c));var r=c.highlight,l,h,f=0;try{l=g.lex(b,c)}catch(y){return m(y)}h=l.length;var s=function(b){var q,a;!0!==b&&delete c.highlight;try{q=p.parse(l,c)}catch(d){a=d}c.highlight=r;return a?m(a):m(null,q)};if(!r||3>r.length)return s(!0);if(!h)return s();for(;f<l.length;f++)(function(b){return"code"!==b.type?--h||s():r(b.text,b.lang,function(q,c){if(null==c||c===b.text)return--h||s();b.text=c;b.escaped=!0;--h||s()})})(l[f])}else try{return c&&(c=e({},d.defaults,
...
p,a){if(this._eventTypes){var l=this._eventTypes[g];if(l){for(var f=l.listeners,e=0,d=f.length;e<d;e++){var h=f[e];if(h&&h.listener===p&&h.useCapture===a){0!==l.level?(f[e]=null,l.compact=!0):f.splice(e,1);break}}0===f.length&&delete this._eventTypes[g]}}}};return{EventTarget:g}});
...
"[Ii\u0130\u0131]"));var b=null,k;if(d){var f=a.reverse,m=a.wrap,e=a.wholeWord,r=a.start||0,a=a.end,g=null!==a&&void 0!==a;-1===h.indexOf("g")&&(h+="g");-1===h.indexOf("m")&&(h+="m");c&&-1===h.indexOf("i")&&(h+="i");e&&(d="\\b"+d+"\\b");var w=this._text[0],t,y,s=0;g&&(c=r<a?r:a,w=w.substring(c,r<a?a:r),s=c);var v=RegExp(d,h);f?k=function(){var b=null;for(v.lastIndex=0;;){y=v.lastIndex;t=v.exec(w);if(y===v.lastIndex)return null;if(t){if(!(t.index+s<r)){if(!m||b)break;r=w.length+s}b={start:t.index+
s,end:v.lastIndex+s}}else break}b&&(r=b.start);return b}:(g||(v.lastIndex=r),k=function(){for(;;){y=v.lastIndex;t=v.exec(w);if(y===v.lastIndex)break;if(t)return{start:t.index+s,end:v.lastIndex+s};if(!(0!==y&&m))break}return null});b=k()}return{next:function(){var c=b;c&&(b=k());return c},hasNext:function(){return null!==b}}},getCharCount:function(){for(var a=0,f=0;f<this._text.length;f++)a+=this._text[f].length;return a},getLine:function(a,f){var e=this.getLineCount();if(!(0<=a&&a<e))return null;
...
this.getCharCount());if(!(f===e&&""===a)){for(var d=this.getLineAtOffset(f),h=this.getLineAtOffset(e),c=f,b=e-f,k=h-d,m=a.length,r=0,g=this.getLineCount(),w=0,t=0,y=0,s=[];;){-1!==w&&w<=y&&(w=a.indexOf("\r",y));-1!==t&&t<=y&&(t=a.indexOf("\n",y));if(-1===t&&-1===w)break;y=-1!==w&&-1!==t?w+1===t?t+1:(w<t?w:t)+1:-1!==w?w+1:t+1;s.push(f+y);r++}this.onChanging({type:"Changing",text:a,start:c,removedCharCount:b,addedCharCount:m,removedLineCount:k,addedLineCount:r});0===s.length&&(y=this.getLineStart(d),
...
define("orion/editor/textView","i18n!orion/editor/nls/messages orion/editor/textModel orion/editor/keyModes orion/editor/eventTarget orion/editor/textTheme orion/editor/util orion/util".split(" "),function(g,n,p,a,l,f,e){function d(b,c,a){if(a){c.className="";for(var a=c.attributes,d=a.length;0<d--;)(!e.isIE||9<=e.isIE||9>e.isIE&&a[d].specified)&&c.removeAttribute(a[d].name)}if(b){b.styleClass&&(c.className=b.styleClass);if(a=b.style)for(var k in a)a.hasOwnProperty(k)&&(c.style[k]=a[k]);if(b=b.attributes)for(var m in b)b.hasOwnProperty(m)&&
c.setAttribute(m,b[m])}}function h(b){return b instanceof Array?b.slice(0):b}function c(b,c){if(!b)return c;if(!c)return b;for(var a in c)c.hasOwnProperty(a)&&(b.hasOwnProperty(a)||(b[a]=c[a]));return b}function b(q,c){if(q===c)return!0;if(q&&!c||!q&&c||q&&q.constructor===String||c&&c.constructor===String)return!1;if(q instanceof Array||c instanceof Array){if(!(q instanceof Array&&c instanceof Array)||q.length!==c.length)return!1;for(var a=0;a<q.length;a++)if(!b(q[a],c[a]))return!1;return!0}if(!(q instanceof
Object)||!(c instanceof Object))return!1;for(a in q)if(q.hasOwnProperty(a)&&(!c.hasOwnProperty(a)||!b(q[a],c[a])))return!1;for(a in c)if(!q.hasOwnProperty(a))return!1;return!0}function k(b,c,a){for(var d=0,k=0,e=0,m=b.length;e<m;){-1!==d&&d<=e&&(d=b.indexOf("\r",e));-1!==k&&k<=e&&(k=b.indexOf("\n",e));var h=e,f;if(-1===k&&-1===d){c(b.substring(e));break}-1!==d&&-1!==k?d+1===k?(f=d,e=k+1):(f=d<k?d:k,e=(d<k?d:k)+1):-1!==d?(f=d,e=d+1):(f=k,e=k+1);c(b.substring(h,f));a()}}function m(b){var c,a,d,k,e=
b.ownerDocument.defaultView||b.ownerDocument.parentWindow;e.getComputedStyle?(b=e.getComputedStyle(b,null),c=b.getPropertyValue("padding-left"),a=b.getPropertyValue("padding-top"),d=b.getPropertyValue("padding-right"),k=b.getPropertyValue("padding-bottom")):b.currentStyle&&(c=b.currentStyle.paddingLeft,a=b.currentStyle.paddingTop,d=b.currentStyle.paddingRight,k=b.currentStyle.paddingBottom);return{left:parseInt(c,10)||0,top:parseInt(a,10)||0,right:parseInt(d,10)||0,bottom:parseInt(k,10)||0}}function r(b){var c,
a,d,k,e=b._trim;if(!e){var e=m(b),h=b.ownerDocument.defaultView||b.ownerDocument.parentWindow;h.getComputedStyle?(k=h.getComputedStyle(b,null),c=k.getPropertyValue("border-left-width"),a=k.getPropertyValue("border-top-width"),d=k.getPropertyValue("border-right-width"),k=k.getPropertyValue("border-bottom-width")):b.currentStyle&&(c=b.currentStyle.borderLeftWidth,a=b.currentStyle.borderTopWidth,d=b.currentStyle.borderRightWidth,k=b.currentStyle.borderBottomWidth);c=parseInt(c,10)||0;a=parseInt(a,10)||
0;d=parseInt(d,10)||0;k=parseInt(k,10)||0;e.left+=c;e.top+=a;e.right+=d;e.bottom+=k;b._trim=e}return e}function x(b,c,a){this.start=b;this.end=c;this.caret=a}function w(b){this.left=b.left;this.top=b.top;this.right=b.right;this.bottom=b.bottom}function t(b,c,a){this.view=b;this.lineIndex=c;this._lineDiv=a}function y(b){this._init(b||{})}var s=f.addEventListener,v=f.removeEventListener,z=function(b){this.options=b};z.prototype.play=function(){var b="number"===typeof this.options.duration?this.options.duration:
350,c=this.options.easing||this.defaultEasing,a=this.options.onAnimate||function(){},d=this.options.curve[0],k=this.options.curve[1],e=k-d,m=-1,h,f=this;this.interval=this.options.window.setInterval(function(){m=-1===m?(new Date).getTime():m;var r=((new Date).getTime()-m)/b;1>r?(r=c(r),h=d+r*e,a(h)):(a(k),f.stop())},"number"===typeof this.options.rate?this.options.rate:20)};z.prototype.stop=function(){this.options.window.clearInterval(this.interval);(this.options.onEnd||function(){})()};z.prototype.defaultEasing=
...
this.end+(this.caret?" caret is at start":" caret is at end")},isEmpty:function(){return this.start===this.end},equals:function(b){return this.caret===b.caret&&this.start===b.start&&this.end===b.end}};w.prototype={toString:function(){return"{l="+this.left+", t="+this.top+", r="+this.right+", b="+this.bottom+"}"}};t.prototype={create:function(b,c){if(!this._lineDiv){var a=this._lineDiv=this._createLine(b,c,this.lineIndex);a._line=this;return a}},_createLine:function(q,c,a){var k=this.view,m=k._model,
h=m.getLine(a),f=m.getLineStart(a),r={type:"LineStyle",textView:k,lineIndex:a,lineText:h,lineStart:f};if(2E3>h.length)k.onLineStyle(r);m=c||e.createElement(q.ownerDocument,"div");if(!c||!b(c.viewStyle,r.style))d(r.style,m,c),c&&(c._trim=null),m.viewStyle=r.style,m.setAttribute("role","presentation");m.lineIndex=a;a=[];this._createRanges(r.ranges,h,0,h.length,f,{tabOffset:0,ranges:a});h=" ";!k._fullSelection&&9>e.isIE&&(h="\ufeff");r={text:h,style:k._metrics.largestFontStyle,ignoreChars:1};0===a.length||
!a[a.length-1].style||"div"!==a[a.length-1].style.tagName?a.push(r):a.splice(a.length-1,0,r);var g,l,s,t,v,h=k=0,x,w;if(c){if(l=c.modelChangedEvent)0===l.removedLineCount&&0===l.addedLineCount?(w=l.start-f,x=l.addedCharCount-l.removedCharCount):w=-1,c.modelChangedEvent=void 0;l=c.firstChild}for(f=0;f<a.length;f++){r=a[f];t=r.text;k+=t.length;g=r.style;if(l)if(v=l.firstChild.data,s=l.viewStyle,v===t&&b(g,s)){h+=v.length;l._rectsCache=void 0;g=l=l.nextSibling;continue}else for(;l;){if(-1!==w){s=k;s>=
w&&(s-=x);v=(v=l.firstChild.data)?v.length:0;if(h+v>s)break;h+=v}s=l.nextSibling;m.removeChild(l);l=s}g=this._createSpan(m,t,g,r.ignoreChars);l?m.insertBefore(g,l):m.appendChild(g);c&&(c.lineWidth=void 0)}if(c)for(q=g?g.nextSibling:null;q;)s=q.nextSibling,c.removeChild(q),q=s;else q.appendChild(m);return m},_createRanges:function(q,c,a,d,k,e){if(!(a>d)){if(q)for(var m=0;m<q.length;m++){var h=q[m];if(!(h.end<k+a)){var f=Math.max(k+a,h.start)-k;if(f>d)break;var r=Math.min(k+d,h.end)-k;if(f<=r){f=Math.max(a,
f);r=Math.min(d,r);a<f&&this._createRange(c,a,f,null,e);if(!h.style||!h.style.unmergeable)for(;m+1<q.length&&q[m+1].start-k===r&&b(h.style,q[m+1].style);)h=q[m+1],r=Math.min(k+d,h.end)-k,m++;this._createRange(c,f,r,h.style,e);a=r}}}a<d&&this._createRange(c,a,d,null,e)}},_createRange:function(b,c,a,d,k){if(!(c>a)){var e=this.view._customTabSize;if(e&&8!==e)for(var m=b.indexOf("\t",c);-1!==m&&m<a;){c<m&&(c={text:b.substring(c,m),style:d},k.ranges.push(c),k.tabOffset+=c.text.length);c=e-k.tabOffset%
e;if(0<c){for(var h="\u00a0",f=1;f<c;f++)h+=" ";c={text:h,style:d,ignoreChars:c-1};k.ranges.push(c);k.tabOffset+=c.text.length}c=m+1;if(c===a)return;m=b.indexOf("\t",c)}c<=a&&(c={text:b.substring(c,a),style:d},k.ranges.push(c),k.tabOffset+=c.text.length)}},_createSpan:function(b,c,a,k){var m=this.view,h="span";a&&a.tagName&&(h=a.tagName.toLowerCase());var f="a"===h;f&&(b.hasLink=!0);f&&!m._linksVisible&&(h="span");f=b.ownerDocument;b=e.createElement(b.ownerDocument,h);a&&a.html?(b.innerHTML=a.html,
b.ignore=!0):a&&a.node?(b.appendChild(a.node),b.ignore=!0):b.appendChild(f.createTextNode(a&&a.text?a.text:c));d(a,b);if("a"===h){var r=m._getWindow();s(b,"click",function(b){return m._handleLinkClick(b?b:r.event)},!1)}b.viewStyle=a;k&&(b.ignoreChars=k);return b},_ensureCreated:function(){return this._lineDiv?this._lineDiv:this._createdDiv=this.create(this.view._clientDiv,null)},getBoundingClientRect:function(b,c){var a=this._ensureCreated(),d=this.view;if(void 0===b)return this._getLineBoundingClientRect(a,
!0);var k=d._model,m=a.ownerDocument,h=this.lineIndex,f=null;if(b<k.getLineEnd(h)){h=k.getLineStart(h);for(k=a.firstChild;k;){if(!k.ignore){var r=k.firstChild,g=r.length;k.ignoreChars&&(g-=k.ignoreChars);if(h+g>b){f=b-h;if(1===r.length)f=new w(k.getBoundingClientRect());else if(d._isRangeRects)m=m.createRange(),m.setStart(r,f),m.setEnd(r,f+1),f=new w(m.getBoundingClientRect());else if(e.isIE)m=m.body.createTextRange(),m.moveToElementText(k),m.collapse(),(h=0===f&&8===e.isIE)&&(f=1),m.moveEnd("character",
f+1),m.moveStart("character",f),f=new w(m.getBoundingClientRect()),h&&(f.left=k.getClientRects()[0].left);else{var l=r.data;k.removeChild(r);k.appendChild(m.createTextNode(l.substring(0,f)));var s=e.createElement(m,"span");s.appendChild(m.createTextNode(l.substring(f,f+1)));k.appendChild(s);k.appendChild(m.createTextNode(l.substring(f+1)));f=new w(s.getBoundingClientRect());k.innerHTML="";k.appendChild(r);this._createdDiv||(m=d._getSelection(),(h<=m.start&&m.start<h+g||h<=m.end&&m.end<h+g)&&d._updateDOMSelection())}e.isIE&&
(m=a.ownerDocument.defaultView||a.ownerDocument.parentWindow,a=m.screen.logicalXDPI/m.screen.deviceXDPI,m=m.screen.logicalYDPI/m.screen.deviceYDPI,f.left*=a,f.right*=a,f.top*=m,f.bottom*=m);break}h+=g}k=k.nextSibling}}a=this.getBoundingClientRect();f||(d._wrapMode?(d=this.getClientRects(),f=d[d.length-1],f.left=f.right,f.left+=a.left,f.top+=a.top,f.right+=a.left,f.bottom+=a.top):(f=new w(a),f.left=f.right));if(c||void 0===c)f.left-=a.left,f.top-=a.top,f.right-=a.left,f.bottom-=a.top;return f},_getClientRects:function(b,
a){var c,d,k,e;if(!b._rectsCache){c=b.getClientRects();d=Array(c.length);for(e=0;e<c.length;e++)k=d[e]=new w(c[e]),k.left-=a.left,k.top-=a.top,k.right-=a.left,k.bottom-=a.top;b._rectsCache=d}c=b._rectsCache;d=[c.length];for(e=0;e<c.length;e++)d[e]=new w(c[e]);return d},getClientRects:function(b){if(!this.view._wrapMode)return[this.getBoundingClientRect()];for(var c=this._ensureCreated(),a=[],d=c.firstChild,k,e=c.getBoundingClientRect();d;){if(!d.ignore)for(var m=this._getClientRects(d,e),c=0;c<m.length;c++){var h=
m[c],f;if(h.top!==h.bottom){var r=h.top+(h.bottom-h.top)/2;for(f=0;f<a.length&&!(k=a[f],k.top<=r&&r<k.bottom);f++);f===a.length?a.push(h):(h.left<k.left&&(k.left=h.left),h.top<k.top&&(k.top=h.top),h.right>k.right&&(k.right=h.right),h.bottom>k.bottom&&(k.bottom=h.bottom))}}d=d.nextSibling}return void 0!==b?a[b]:a},_getLineBoundingClientRect:function(b,c){var a=new w(b.getBoundingClientRect());if(!this.view._wrapMode){a.right=a.left;for(var d=b.lastChild;d&&d.ignoreChars===d.firstChild.length;)d=d.previousSibling;
...
var a=this.getClientRects();return this.getOffset(a[b].left+1,a[b].top+1)},getOffset:function(b,a){var c=this.view,d=c._model,k=this.lineIndex,m=d.getLineStart(k),h=d.getLineEnd(k);if(m===h)return m;var f=this._ensureCreated(),r=this.getBoundingClientRect(),g,l;if(c._wrapMode){g=this.getClientRects();a<g[0].top&&(a=g[0].top);for(var s=0;s<g.length&&!(l=g[s],l.top<=a&&a<l.bottom);s++);b<l.left&&(b=l.left);b>l.right&&(b=l.right-1)}else 0>b&&(b=0),b>r.right-r.left&&(b=r.right-r.left);var t=f.ownerDocument,
s=t.defaultView||t.parentWindow,v=e.isIE?s.screen.logicalXDPI/s.screen.deviceXDPI:1,x=e.isIE?s.screen.logicalYDPI/s.screen.deviceYDPI:1,s=m,w=f.firstChild;a:for(;w;){if(!w.ignore){var y=w.firstChild,f=y.length;w.ignoreChars&&(f-=w.ignoreChars);var p,n,z;g=this._getClientRects(w,r);for(var K=0;K<g.length;K++)if(l=g[K],l.left<=b&&b<l.right&&(!c._wrapMode||l.top<=a&&a<l.bottom)){var K=l.left+r.left,G;if(e.isIE||c._isRangeRects){for(var t=c._isRangeRects?t.createRange():t.body.createTextRange(),F=f,L=
-1;1<F-L;){var V=Math.floor((F+L)/2);g=L+1;l=V===f-1&&w.ignoreChars?y.length:V+1;G=0===g&&8===e.isIE;c._isRangeRects?(t.setStart(y,g),t.setEnd(y,l)):(G&&(g=1),t.moveToElementText(w),t.move("character",g),t.moveEnd("character",l-g));g=t.getClientRects();for(var X=!1,W=0;W<g.length;W++)if(l=g[W],p=(G?K:l.left)*v-r.left,z=l.right*v-r.left,n=l.top*x-r.top,l=l.bottom*x-r.top,p<=b&&b<z&&(!c._wrapMode||n<=a&&a<l)){X=!0;break}X?F=V:L=V}s+=F;g=F;l=F===f-1&&w.ignoreChars?y.length:Math.min(F+1,y.length);c._isRangeRects?
(t.setStart(y,g),t.setEnd(y,l)):(t.moveToElementText(w),t.move("character",g),t.moveEnd("character",l-g));g=t.getClientRects();c=!1;0<g.length&&(l=g[0],p=(G?K:l.left)*v-r.left,z=l.right*v-r.left,c=b>p+(z-p)/2);r=s-m;d=d.getLine(k);k=d.charCodeAt(r);55296<=k&&56319>=k&&c?r<d.length&&(k=d.charCodeAt(r+1),56320<=k&&57343>=k&&(s+=1)):56320<=k&&(57343>=k&&!c)&&0<r&&(k=d.charCodeAt(r-1),55296<=k&&56319>=k&&(s-=1));c&&s++}else{d=[];for(k=0;k<f;k++)d.push("<span>"),k===f-1?d.push(y.data.substring(k)):d.push(y.data.substring(k,
k+1)),d.push("</span>");w.innerHTML=d.join("");for(d=w.firstChild;d;){l=d.getBoundingClientRect();p=l.left-r.left;z=l.right-r.left;if(p<=b&&b<z){b>p+(z-p)/2&&s++;break}s++;d=d.nextSibling}this._createdDiv||(w.innerHTML="",w.appendChild(y),r=c._getSelection(),(s<=r.start&&r.start<s+f||s<=r.end&&r.end<s+f)&&c._updateDOMSelection())}break a}s+=f}w=w.nextSibling}return Math.min(h,Math.max(m,s))},getNextOffset:function(b,c){if("line"===c.unit){var a=this.view._model,d=a.getLineAtOffset(b);if(0<c.count)return c.count--,
a.getLineEnd(d);c.count++;return a.getLineStart(d)}return"wordend"===c.unit||"wordWS"===c.unit||"wordendWS"===c.unit?this._getNextOffset_W3C(b,c):e.isIE?this._getNextOffset_IE(b,c):this._getNextOffset_W3C(b,c)},_getNextOffset_W3C:function(b,c){function a(b){return 33<=b&&47>=b||58<=b&&64>=b||91<=b&&94>=b||96===b||123<=b&&126>=b}function d(b){return 32===b||9===b}var k=this.view._model,e=k.getLineAtOffset(b),m=k.getLine(e),h=k.getLineStart(e),k=k.getLineEnd(e),e=m.length,f=b-h,r,g=0>c.count?-1:1;if("word"===
c.unit||"wordend"===c.unit||"wordWS"===c.unit||"wordendWS"===c.unit)for(var l,s,t;0!==c.count;){if(0<c.count){if(f===e)return k;r=m.charCodeAt(f);l=a(r);s=!l&&!d(r);for(f++;f<e;){r=m.charCodeAt(f);if("wordWS"!==c.unit&&"wordendWS"!==c.unit){t=a(r);if("wordend"===c.unit){if(!t&&l)break}else if(t&&!l)break;r=!t&&!d(r)}else r=!d(r);if("wordend"===c.unit||"wordendWS"===c.unit){if(!r&&s)break}else if(r&&!s)break;s=r;l=t;f++}}else{if(0===f)return h;f--;r=m.charCodeAt(f);l=a(r);for(s=!l&&!d(r);0<f;){r=m.charCodeAt(f-
1);if("wordWS"!==c.unit&&"wordendWS"!==c.unit){t=a(r);if("wordend"===c.unit){if(t&&!l)break}else if(!t&&l)break;r=!t&&!d(r)}else r=!d(r);if("wordend"===c.unit||"wordendWS"===c.unit){if(r&&!s)break}else if(!r&&s)break;s=r;l=t;f--}}c.count-=g}else for(;0!==c.count&&0<=f+g&&f+g<=e;)f+=g,r=m.charCodeAt(f),56320<=r&&57343>=r&&0<f&&(r=m.charCodeAt(f-1),55296<=r&&56319>=r&&(f+=g)),c.count-=g;return h+f},_getNextOffset_IE:function(b,c){var a=this._ensureCreated(),d=this.view._model,k=this.lineIndex,e=0,m;
m=d.getLineStart(k);var h=a.ownerDocument,f=0>c.count?-1:1;if(b===d.getLineEnd(k)){for(a=a.lastChild;a&&a.ignoreChars===a.firstChild.length;)a=a.previousSibling;if(!a)return m;e=h.body.createTextRange();e.moveToElementText(a);m=e.text.length;e.moveEnd(c.unit,f);e=b+e.text.length-m}else if(b===m&&0>c.count)e=m;else for(a=a.firstChild;a;){d=a.firstChild.length;a.ignoreChars&&(d-=a.ignoreChars);if(m+d>b){e=h.body.createTextRange();b===m&&0>c.count?e.moveToElementText(a.previousSibling):(e.moveToElementText(a),
e.collapse(),e.moveEnd("character",b-m));m=e.text.length;e.moveEnd(c.unit,f);e=b+e.text.length-m;break}m=d+m;a=a.nextSibling}c.count-=f;return e},destroy:function(){var b=this._createdDiv;b&&(b.parentNode.removeChild(b),this._createdDiv=null)}};y.prototype={addKeyMode:function(b,c){var a=this._keyModes;void 0!==c?a.splice(c,0,b):a.push(b);b._modeAdded&&b._modeAdded()},addRuler:function(b,c){b.setView(this);var a=this._rulers;if(void 0!==c){var d,k;for(k=d=0;d<a.length&&k<c;d++)b.getLocation()===a[d].getLocation()&&
k++;a.splice(k,0,b);c=k}else a.push(b);this._createRuler(b,c);this._update()},computeSize:function(){var b=0,c=0,a=this._model,d=this._clientDiv;if(!d)return{width:b,height:c};var k=d.style.width;e.isWebkit&&(d.style.width="0x7fffffffpx");for(var a=a.getLineCount(),m=0;m<a;m++){var h=this._getLine(m),f=h.getBoundingClientRect(),b=Math.max(b,f.right-f.left),c=c+(f.bottom-f.top);h.destroy()}e.isWebkit&&(d.style.width=k);d=this._getViewPadding();b+=d.right+d.left+this._metrics.scrollWidth;c+=d.bottom+
d.top+this._metrics.scrollWidth;return{width:b,height:c}},convert:function(b,c,a){if(this._clientDiv){var d=this._getScroll(),k=this._getViewPadding(),e=this._viewDiv.getBoundingClientRect();"document"===c&&(void 0!==b.x&&(b.x+=-d.x+e.left+k.left),void 0!==b.y&&(b.y+=-d.y+e.top+k.top));"document"===a&&(void 0!==b.x&&(b.x+=d.x-e.left-k.left),void 0!==b.y&&(b.y+=d.y-e.top-k.top));return b}},destroy:function(){for(var b=0;b<this._rulers.length;b++)this._rulers[b].setView(null);this.rulers=null;this._destroyView();
...
b=Math.min(Math.max(0,b),c.getCharCount()),c=c.getLineAtOffset(b),a=this._getLine(c),b=a.getBoundingClientRect(b);a.destroy();a=b.left;c=this._getLinePixel(c)+b.top;return{x:a,y:c}},getNextOffset:function(b,c){var a=new x(b,b,!1);this._doMove(c,a);return a.getCaret()},getOptions:function(){var b;if(0===arguments.length)b=this._defaultOptions();else if(1===arguments.length){if(b=arguments[0],"string"===typeof b)return h(this["_"+b])}else{b={};for(var c in arguments)arguments.hasOwnProperty(c)&&(b[arguments[c]]=
...
b){c.splice(a,1);b.setView(null);this._destroyRuler(b);this._update();break}},resize:function(){this._clientDiv&&this._handleResize(null)},setAction:function(b,c,a){if(b){var d=this._actions,k=d[b];k||(k=d[b]={});k.handler=c;void 0!==a&&(k.actionDescription=a)}},setKeyBinding:function(b,c){this._keyModes[0].setKeyBinding(b,c)},setCaretOffset:function(b,c,a){var d=this._model.getCharCount(),b=Math.max(0,Math.min(b,d)),b=new x(b,b,!1);this._setSelection(b,void 0===c||c,!0,a)},setHorizontalPixel:function(b){this._clientDiv&&
(b=Math.max(0,b),this._scrollView(b-this._getScroll().x,0))},setRedraw:function(b){b?0===--this._redrawCount&&this.redraw():this._redrawCount++},setModel:function(b){if(b&&b!==this._model){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",this._modelListener.onChanged);var c=this._model.getLineCount(),a=this._model.getCharCount(),d=b.getLineCount(),k=b.getCharCount(),e={type:"ModelChanging",text:b.getText(),start:0,removedCharCount:a,
addedCharCount:k,removedLineCount:c,addedLineCount:d};this.onModelChanging(e);this._model=b;e={type:"ModelChanged",start:0,removedCharCount:a,addedCharCount:k,removedLineCount:c,addedLineCount:d};this.onModelChanged(e);this._model.addEventListener("preChanging",this._modelListener.onChanging);this._model.addEventListener("postChanged",this._modelListener.onChanged);this._reset();this._update()}},setOptions:function(c){var a=this._defaultOptions(),d;for(d in c)if(c.hasOwnProperty(d)){var k=c[d];if(!b(this["_"+
d],k)){var e=a[d]?a[d].update:null;e?e.call(this,k):this["_"+d]=h(k)}}},setSelection:function(b,c,a,d){var k=b>c;if(k)var e=b,b=c,c=e;e=this._model.getCharCount();b=Math.max(0,Math.min(b,e));c=Math.max(0,Math.min(c,e));b=new x(b,c,k);this._setSelection(b,void 0===a||a,!0,d)},setText:function(b,c,a){var d=void 0===c&&void 0===a;void 0===c&&(c=0);void 0===a&&(a=this._model.getCharCount());d&&(this._variableLineHeight=!1);this._modifyContent({text:b,start:c,end:a,_code:!0},!d);d&&(this._columnX=-1,this._setSelection(new x(0,
...
_handleLinkClick:function(b){if(!(e.isMac?b.metaKey:b.ctrlKey))return b.preventDefault&&b.preventDefault(),!1},_handleMouse:function(b){var c=this._getWindow(),a=!0,d=c;if(e.isIE||e.isFirefox&&!this._overlayDiv)d=this._clientDiv;if(this._overlayDiv){this._hasFocus&&(this._ignoreFocus=!0);var k=this;c.setTimeout(function(){k.focus();k._ignoreFocus=!1},0)}1===this._clickCount?(a=this._setSelectionTo(b.clientX,b.clientY,b.shiftKey,(!e.isOpera||12.16<=e.isOpera)&&this._hasFocus&&this.isListening("DragStart")))&&
...
d=a-this._lastMouseTime,k=Math.abs(this._lastMouseX-b.clientX),m=Math.abs(this._lastMouseY-b.clientY),h=this._lastMouseButton===c;this._lastMouseX=b.clientX;this._lastMouseY=b.clientY;this._lastMouseTime=a;this._lastMouseButton=c;1===c&&(this._isMouseDown=!0,h&&d<=this._clickTime&&k<=this._clickDist&&m<=this._clickDist?this._clickCount++:this._clickCount=1);if(this.isListening("MouseDown")&&(a=this._createMouseEvent("MouseDown",b),this.onMouseDown(a),a.defaultPrevented)){b.preventDefault();return}if(1===
...
1===b.button&&0!==(this._clickCount&1)&&c)return this._clickCount=2,this._handleMouse(b,this._clickCount)}if(this._isMouseDown&&-1===this._dragOffset){var c=b.clientX,b=b.clientY,d=this._getViewPadding(),k=this._viewDiv.getBoundingClientRect(),m=this._getClientWidth(),h=this._getClientHeight(),a=k.left+d.left,f=k.top+d.top,m=k.left+d.left+m,d=k.top+d.top+h;b<f?this._doAutoScroll("up",c,b-f):b>d?this._doAutoScroll("down",c,b-d):c<a&&!this._wrapMode?this._doAutoScroll("left",c-a,b):c>m&&!this._wrapMode?
...
(c=c.match(b),void 0!==c))return this.invokeAction(c);return!1},_doMove:function(b,c){var a=this._model,d=c.getCaret(),k=a.getLineAtOffset(d);b.count||(b.count=1);for(;0!==b.count;){var e=a.getLineStart(k);if(0>b.count&&d===e)if(0<k)"character"===b.unit&&b.count++,k--,c.extend(a.getLineEnd(k));else break;else if(0<b.count&&d===a.getLineEnd(k))if(k+1<a.getLineCount())"character"===b.unit&&b.count--,k++,c.extend(a.getLineStart(k));else break;else{var m=!1;b.expandTab&&("character"===b.unit&&0===(d-
e)%this._tabSize)&&(e=a.getText(e,d),m=!/[^ ]/.test(e));m?(c.extend(d-this._tabSize),b.count+=0>b.count?1:-1):(e=this._getLine(k),c.extend(e.getNextOffset(d,b)),e.destroy())}d=c.getCaret()}return c},_doBackspace:function(b){var c=this._getSelection();c.isEmpty()&&(b.count||(b.count=1),b.count*=-1,b.expandTab=this._expandTab,this._doMove(b,c));this._modifyContent({text:"",start:c.start,end:c.end},!0);return!0},_doCase:function(b){var c=this._getSelection();this._doMove(b,c);var a=this.getText(c.start,
c.end);this._setSelection(c,!0);switch(b.type){case "lower":a=a.toLowerCase();break;case "capitalize":a=a.replace(/(?:^|\s)\S/g,function(b){return b.toUpperCase()});break;case "reverse":b="";for(c=0;c<a.length;c++)var d=a[c],k=d.toLowerCase(),d=k!==d?k:d.toUpperCase(),b=b+d;a=b;break;default:a=a.toUpperCase()}this._doContent(a);return!0},_doContent:function(b){var c=this._getSelection();if(this._overwriteMode&&c.isEmpty()){var a=this._model,d=a.getLineAtOffset(c.end);c.end<a.getLineEnd(d)&&(a=this._getLine(d),
...
d;if(b.ctrl)c.extend(a.getCharCount()),d=function(){};else{var k=c.getCaret(),e=a.getLineAtOffset(k);if(this._wrapMode){var m=this._getLine(e),k=m.getLineIndex(k),k=k===m.getLineCount()-1?a.getLineEnd(e):m.getLineStart(k+1)-1;m.destroy()}else b.count&&0<b.count&&(e=Math.min(e+b.count-1,a.getLineCount()-1)),k=a.getLineEnd(e);c.extend(k)}b.select||c.collapse();this._setSelection(c,!0,!0,d);return!0},_doEnter:function(b){var c=this._model,a=this._getSelection();this._doContent(c.getLineDelimiter());
b&&b.noCursor&&(a.end=a.start,this._setSelection(a,!0));return!0},_doHome:function(b){var c=this._getSelection(),a=this._model,d;if(b.ctrl)c.extend(0),d=function(){};else{var k=c.getCaret(),e=a.getLineAtOffset(k);this._wrapMode?(a=this._getLine(e),k=a.getLineIndex(k),k=a.getLineStart(k),a.destroy()):k=a.getLineStart(e);c.extend(k)}b.select||c.collapse();this._setSelection(c,!0,!0,d);return!0},_doLineDown:function(b){var c=this._model,a=this._getSelection(),d=a.getCaret(),k=c.getLineAtOffset(d),m=
this._getLine(k),h=this._columnX,f=1,r=!1;if(-1===h||b.wholeLine||b.select&&e.isIE)h=b.wholeLine?c.getLineEnd(k+1):d,h=m.getBoundingClientRect(h).left;(d=m.getLineIndex(d))<m.getLineCount()-1?f=m.getClientRects(d+1).top+1:(d=c.getLineCount()-1,r=k===d,b.count&&0<b.count?k=Math.min(k+b.count,d):k++);d=!1;if(r){if(b.select||e.isMac||e.isLinux)a.extend(c.getCharCount()),d=!0}else m.lineIndex!==k&&(m.destroy(),m=this._getLine(k)),a.extend(m.getOffset(h,f)),d=!0;d&&(b.select||a.collapse(),this._setSelection(a,
!0,!0));this._columnX=h;m.destroy();return!0},_doLineUp:function(b){var c=this._model,a=this._getSelection(),d=a.getCaret(),k=c.getLineAtOffset(d),m=this._getLine(k),h=this._columnX,f=!1,r;if(-1===h||b.wholeLine||b.select&&e.isIE)h=b.wholeLine?c.getLineStart(k-1):d,h=m.getBoundingClientRect(h).left;0<(d=m.getLineIndex(d))?r=m.getClientRects(d-1).top+1:(f=0===k,f||(b.count&&0<b.count?k=Math.max(k-b.count,0):k--,r=this._getLineHeight(k)-1));d=!1;if(f){if(b.select||e.isMac||e.isLinux)a.extend(0),d=!0}else m.lineIndex!==
k&&(m.destroy(),m=this._getLine(k)),a.extend(m.getOffset(h,r)),d=!0;d&&(b.select||a.collapse(),this._setSelection(a,!0,!0));this._columnX=h;m.destroy();return!0},_doNoop:function(){return!0},_doPageDown:function(b){var c=this,a=this._model,d=this._getSelection(),k=d.getCaret(),m=a.getLineAtOffset(k),h=a.getLineCount(),f=this._getScroll(),a=this._getClientHeight(),r,g;if(this._lineHeight){r=this._columnX;f=this._getBoundsAtOffset(k);if(-1===r||b.select&&e.isIE)r=f.left;k=this._getLineIndex(f.top+a);
g=this._getLine(k);m=this._getLinePixel(k);k=g.getOffset(r,f.top+a-m);a=g.getBoundingClientRect(k);g.destroy();d.extend(k);b.select||d.collapse();this._setSelection(d,!0,!0,function(){c._columnX=r},a.top+m-f.top);return!0}if(m<h-1){var l=this._getLineHeight(),s=Math.min(h-m-1,Math.floor(a/l)),s=Math.max(1,s);r=this._columnX;if(-1===r||b.select&&e.isIE)g=this._getLine(m),r=g.getBoundingClientRect(k).left,g.destroy();g=this._getLine(m+s);d.extend(g.getOffset(r,0));g.destroy();b.select||d.collapse();
b=h*l;k=f.y+s*l;k+a>b&&(k=b-a);this._setSelection(d,!0,!0,function(){c._columnX=r},k-f.y)}return!0},_doPageUp:function(b){var c=this,a=this._model,d=this._getSelection(),k=d.getCaret(),m=a.getLineAtOffset(k),h=this._getScroll(),f=this._getClientHeight(),r;if(this._lineHeight){r=this._columnX;h=this._getBoundsAtOffset(k);if(-1===r||b.select&&e.isIE)r=h.left;k=this._getLineIndex(h.bottom-f);a=this._getLine(k);m=this._getLinePixel(k);k=a.getOffset(r,h.bottom-f-m);f=a.getBoundingClientRect(k);a.destroy();
d.extend(k);b.select||d.collapse();this._setSelection(d,!0,!0,function(){c._columnX=r},f.top+m-h.top);return!0}if(0<m){var g=this._getLineHeight(),f=Math.max(1,Math.min(m,Math.floor(f/g)));r=this._columnX;if(-1===r||b.select&&e.isIE)a=this._getLine(m),r=a.getBoundingClientRect(k).left,a.destroy();a=this._getLine(m-f);d.extend(a.getOffset(r,this._getLineHeight(m-f)-1));a.destroy();b.select||d.collapse();b=Math.max(0,h.y-f*g);this._setSelection(d,!0,!0,function(){c._columnX=r},b-h.y)}return!0},_doPaste:function(b){var c=
...
c=this._getSelection(),a=this.convert({x:this._autoScrollX,y:this._autoScrollY},"page","document"),d=c.getCaret(),k=b.getLineCount(),m=b.getLineAtOffset(d),h;if("up"===this._autoScrollDir||"down"===this._autoScrollDir)d=this._autoScrollY/this._getLineHeight(),d=0>d?Math.floor(d):Math.ceil(d),h=Math.max(0,Math.min(k-1,m+d));else if("left"===this._autoScrollDir||"right"===this._autoScrollDir)h=this._getLineIndex(a.y),m=this._getLine(m),a.x+=m.getBoundingClientRect(d,!1).left,m.destroy();0===h&&(e.isMac||
e.isLinux)?c.extend(0):h===k-1&&(e.isMac||e.isLinux)?c.extend(b.getCharCount()):(m=this._getLine(h),c.extend(m.getOffset(a.x,a.y-this._getLinePixel(h))),m.destroy());this._setSelection(c,!0)},_autoScrollTimer:function(){this._autoScroll();var b=this;this._autoScrollTimerID=this._getWindow().setTimeout(function(){b._autoScrollTimer()},this._AUTO_SCROLL_RATE)},_calculateLineHeightTimer:function(b){if(this._lineHeight&&!this._calculateLHTimer){var c=this._model.getLineCount(),a=0;if(b){for(var b=0,d=
(new Date).getTime(),k=0;a<c&&!(this._lineHeight[a]||(b++,k||(k=a),this._lineHeight[a]=this._calculateLineHeight(a)),a++,100<(new Date).getTime()-d););this.redrawRulers(0,c);this._queueUpdate()}b=this._getWindow();if(a!==c){var e=this;this._calculateLHTimer=b.setTimeout(function(){e._calculateLHTimer=null;e._calculateLineHeightTimer(!0)},0)}else this._calculateLHTimer&&(b.clearTimeout(this._calculateLHTimer),this._calculateLHTimer=void 0)}},_calculateLineHeight:function(b){var b=this._getLine(b),
c=b.getBoundingClientRect();b.destroy();return Math.max(1,c.bottom-c.top)},_calculateMetrics:function(){var b=this._clientDiv,c=b.ownerDocument,a=e.createElement(c,"div");a.style.lineHeight="normal";var k={type:"LineStyle",textView:this,"0":0,lineText:this._model.getLine(0),lineStart:0};this.onLineStyle(k);d(k.style,a);a.style.position="fixed";a.style.left="-1000px";var h=e.createElement(c,"span");h.appendChild(c.createTextNode(" "));a.appendChild(h);var f=e.createElement(c,"span");f.style.fontStyle=
"italic";f.appendChild(c.createTextNode(" "));a.appendChild(f);var g=e.createElement(c,"span");g.style.fontWeight="bold";g.appendChild(c.createTextNode(" "));a.appendChild(g);k=e.createElement(c,"span");k.style.fontWeight="bold";k.style.fontStyle="italic";k.appendChild(c.createTextNode(" "));a.appendChild(k);b.appendChild(a);var l=a.getBoundingClientRect(),h=h.getBoundingClientRect(),f=f.getBoundingClientRect(),g=g.getBoundingClientRect(),k=k.getBoundingClientRect(),h=h.bottom-h.top,f=f.bottom-f.top,
g=g.bottom-g.top,s=k.bottom-k.top,t=0,k=0>=l.bottom-l.top,l=Math.max(1,l.bottom-l.top);f>h&&(t=1);g>f&&(t=2);s>g&&(t=3);var v;0!==t&&(v={style:{}},0!==(t&1)&&(v.style.fontStyle="italic"),0!==(t&2)&&(v.style.fontWeight="bold"));h=r(a);b.removeChild(a);s=m(this._viewDiv);a=e.createElement(c,"div");a.style.position="fixed";a.style.left="-1000px";a.style.paddingLeft=s.left+"px";a.style.paddingTop=s.top+"px";a.style.paddingRight=s.right+"px";a.style.paddingBottom=s.bottom+"px";a.style.width="100px";a.style.height=
"100px";s=e.createElement(c,"div");s.style.width="100%";s.style.height="100%";a.appendChild(s);b.appendChild(a);t=a.getBoundingClientRect();f=s.getBoundingClientRect();g=0;this._singleMode||(a.style.overflow="hidden",s.style.height="200px",g=a.clientWidth,a.style.overflow="scroll",g-=a.clientWidth);b.removeChild(a);s={left:f.left-t.left,top:f.top-t.top,right:t.right-f.right,bottom:t.bottom-f.bottom};f=t=0;if(!k&&(this._wrapOffset||this._marginOffset))a=e.createElement(c,"div"),a.style.position="fixed",
a.style.left="-1000px",a.innerHTML=Array(this._wrapOffset+1).join(" "),b.appendChild(a),t=a.getBoundingClientRect(),t=Math.ceil(t.right-t.left),a.innerHTML=Array(this._marginOffset+1).join(" "),f=a.getBoundingClientRect(),f=Math.ceil(f.right-f.left),b.removeChild(a);return{lineHeight:l,largestFontStyle:v,lineTrim:h,viewPadding:s,scrollWidth:g,wrapWidth:t,marginWidth:f,invalid:k}},_cancelAnimation:function(){this._animation&&(this._animation.stop(),this._animation=null)},_clearSelection:function(b){var c=
...
e=a.left;this._ignoreDOMSelection=!1;var v=this._selDiv1,s=Math.min(r,Math.max(c,s)),w=Math.min(g,Math.max(m,l.top)),x=r,k=Math.min(g,Math.max(m,l.bottom));v.style.left=s-f+"px";v.style.top=w-h+"px";v.style.width=Math.max(0,x-s)+"px";v.style.height=Math.max(0,k-w)+"px";b.lineIndex===d.lineIndex?(x=Math.min(e,r),v.style.width=Math.max(0,x-s)+"px"):(l=Math.min(g,Math.max(m,a.top)),e=Math.min(r,Math.max(c,e)),m=Math.min(g,Math.max(m,a.bottom)),g=this._selDiv3,g.style.left=c-f+"px",g.style.top=l-h+"px",
...
(this._getWindow().clearTimeout(this._updateTimer),this._updateTimer=null,b=!1);var a=this._clientDiv,c=this._viewDiv;if(a){this._metrics.invalid&&(this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1);var d=this._model,k=this._getScroll(!1),m=this._getViewPadding(),f=d.getLineCount(),h=this._getLineHeight(),r=!1,g=!1,l=!1,s=this._metrics.scrollWidth;this._wrapMode&&(a.style.width=(this._metrics.wrapWidth||this._getClientWidth())+"px");var v,w,x,y,p=0,n=0,z;if(this._lineHeight){for(;n<
f;){z=this._getLineHeight(n);if(p+z>k.y)break;p+=z;n++}v=n;w=Math.max(0,v-1);x=d=k.y-p;0<v&&(d+=this._getLineHeight(v-1))}else y=Math.max(0,k.y)/h,v=Math.floor(y),w=Math.max(0,v-1),d=Math.round((y-w)*h),x=Math.round((y-v)*h);this._topIndexY=x;y=this._rootDiv;var Q=y.clientWidth,K=y.clientHeight;if(b){h=0;this._leftDiv&&(v=this._leftDiv.getBoundingClientRect(),h=v.right-v.left);v=this._getClientWidth();y=this._getClientHeight();g=v;this._wrapMode?this._metrics.wrapWidth&&(g=this._metrics.wrapWidth):
g=Math.max(this._maxLineWidth,g);for(;n<f;)z=this._getLineHeight(n,!1),p+=z,n++;f=p}else{y=this._getClientHeight();x=Math.min(v+Math.floor((y+x)/h),f-1);var k=Math.min(x+1,f-1),G;for(z=a.firstChild;z;){G=z.lineIndex;var F=z.nextSibling;if(!(w<=G&&G<=k)||z.lineRemoved||-1===z.lineIndex)this._mouseWheelLine===z?(z.style.display="none",z.lineIndex=-1):a.removeChild(z);z=F}z=this._getLineNext();var F=c.ownerDocument,L=F.createDocumentFragment();for(G=w;G<=k;G++)!z||z.lineIndex>G?(new t(this,G)).create(L,
null):(L.firstChild&&(a.insertBefore(L,z),L=F.createDocumentFragment()),z&&z.lineChanged&&(z=(new t(this,G)).create(L,z),z.lineChanged=!1),z=this._getLineNext(z));L.firstChild&&a.insertBefore(L,z);e.isWebkit&&!this._wrapMode&&(a.style.width="0x7fffffffpx");z=this._getLineNext();G=y+d;for(L=!1;z;)w=z.lineWidth,void 0===w&&(F=z._line.getBoundingClientRect(),w=z.lineWidth=Math.ceil(F.right-F.left),F=F.bottom-F.top,this._lineHeight?this._lineHeight[z.lineIndex]=F:0!==h&&(0!==F&&Math.ceil(h)!==Math.ceil(F))&&
(this._variableLineHeight=!0,this._lineHeight=[],this._lineHeight[z.lineIndex]=F)),this._lineHeight&&!L&&(G-=this._lineHeight[z.lineIndex],0>G&&(x=z.lineIndex,L=!0)),this._wrapMode||(w>=this._maxLineWidth&&(this._maxLineWidth=w,this._maxLineIndex=z.lineIndex),this._checkMaxLineIndex===z.lineIndex&&(this._checkMaxLineIndex=-1)),z.lineIndex===v&&(this._topChild=z),z.lineIndex===x&&(this._bottomChild=z),z=this._getLineNext(z);-1!==this._checkMaxLineIndex&&(G=this._checkMaxLineIndex,this._checkMaxLineIndex=
-1,0<=G&&G<f&&(h=new t(this,G),F=h.getBoundingClientRect(),w=F.right-F.left,w>=this._maxLineWidth&&(this._maxLineWidth=w,this._maxLineIndex=G),h.destroy()));for(;n<f;)z=this._getLineHeight(n,n<=x),p+=z,n++;f=p;this._updateRuler(this._leftDiv,v,k,K);this._updateRuler(this._rightDiv,v,k,K);this._updateRuler(this._marginDiv,v,k,K);h=0;this._leftDiv&&(v=this._leftDiv.getBoundingClientRect(),h=v.right-v.left);k=0;this._rightDiv&&(k=this._rightDiv.getBoundingClientRect(),k=k.right-k.left);c.style.left=
h+"px";c.style.right=k+"px";k=this._scrollDiv;k.style.height=f+"px";v=this._getClientWidth();!this._singleMode&&!this._wrapMode&&(p=r=y,(n="scroll"===c.style.overflowX)?r+=s:p-=s,z=x=v,(w="scroll"===c.style.overflowY)?x+=s:z-=s,y=r,v=x,f>y&&(l=!0,v=z),this._maxLineWidth>v&&(g=!0,y=p,f>y&&(l=!0,v=z)),n!==g&&(c.style.overflowX=g?"scroll":"hidden"),w!==l&&(c.style.overflowY=l?"scroll":"hidden"),r=n!==g||w!==l);l=v;this._wrapMode?this._metrics.wrapWidth&&(l=this._metrics.wrapWidth):l=Math.max(this._maxLineWidth,
...
m.left+m.right))*l)),this._hScrollDiv.style.left=h+Math.floor(Math.max(0,Math.floor(k.x*l/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=y-9+"px",this._hScrollDiv.style.width=p+"px");n=k.x;p=this._clipDiv;l=this._overlayDiv;if(x=this._marginDiv)x.style.left=-n+h+this._metrics.marginWidth+m.left+"px",x.style.bottom=("scroll"===c.style.overflowX?s:0)+"px";p?(p.scrollLeft=n,p.scrollTop=0,c=h+m.left,s=m.top,b=v,h=y,n=0,x=-d,0===k.x&&(c-=m.left,b+=m.left,n=m.left),k.x+v===g&&(b+=m.right),0===k.y&&
(s-=m.top,h+=m.top,x+=m.top),k.y+y===f&&(h+=m.bottom),p.style.left=c+"px",p.style.top=s+"px",p.style.right=Q-b-c+"px",p.style.bottom=K-h-s+"px",a.style.left=n+"px",a.style.top=x+"px",a.style.width=g+"px",a.style.height=y+d+"px",l&&(l.style.left=a.style.left,l.style.top=a.style.top,l.style.width=a.style.width,l.style.height=a.style.height)):(c=n,s=d,Q=n+v,K=d+y,0===c&&(c-=m.left),0===s&&(s-=m.top),Q===g&&(Q+=m.right),k.y+y===f&&(K+=m.bottom),a.style.clip="rect("+s+"px,"+Q+"px,"+K+"px,"+c+"px)",a.style.left=
...
s),v.html&&(s.innerHTML=v.html);s.lineIndex=g;s.style.height=f+h.top+"px"}var w;if("page"===l){for(r=r.getAnnotations(a,c+1);t;)g=t.lineIndex,v=t.nextSibling,(!(a<=g&&g<=c)||t.lineChanged)&&b.removeChild(t),t=v;t=b.firstChild.nextSibling;w=m.createDocumentFragment();for(g=a;g<=c;g++)if(!t||t.lineIndex>g){s=e.createElement(m,"div");if(v=r[g])d(v.style,s),v.html&&(s.innerHTML=v.html),s.annotation=v;s.lineIndex=g;s.style.height=this._getLineHeight(g)+"px";w.appendChild(s)}else w.firstChild&&(b.insertBefore(w,
t),w=m.createDocumentFragment()),t&&(t=t.nextSibling);w.firstChild&&b.insertBefore(w,t)}else{v=this._getClientHeight();g=this._model.getLineCount();t=v+h.top+h.bottom-2*this._metrics.scrollWidth;l=f*g<t?f:t/g;if(b.rulerChanged){for(v=b.childNodes.length;1<v;)b.removeChild(b.lastChild),v--;r=r.getAnnotations(0,g);w=m.createDocumentFragment();for(var x in r)g=x>>>0,0>g||(s=e.createElement(m,"div"),v=r[x],d(v.style,s),s.style.position="absolute",s.style.top=this._metrics.scrollWidth+f+Math.floor(g*l)+
"px",v.html&&(s.innerHTML=v.html),s.annotation=v,s.lineIndex=g,w.appendChild(s));b.appendChild(w)}else if(b._oldTrackHeight!==t)for(s=b.firstChild?b.firstChild.nextSibling:null;s;)s.style.top=this._metrics.scrollWidth+f+Math.floor(s.lineIndex*l)+"px",s=s.nextSibling;b._oldTrackHeight=t}b.rulerChanged=!1;b=b.nextSibling}},_updateStyleSheet:function(){var b="";e.isWebkit&&0<this._metrics.scrollWidth&&(b+="\n.textview ::-webkit-scrollbar-corner {background: #eeeeee;}");e.isFirefox&&(e.isMac&&this._highlightRGB&&
...
define("orion/editor/projectionTextModel",["orion/editor/textModel","orion/editor/eventTarget"],function(g,n){function p(a){this._model=a;this._projections=[];var g=this;this._listener={onChanged:function(a){g._onChanged(a)},onChanging:function(a){g._onChanging(a)}};a.addEventListener("preChanged",this._listener.onChanged);a.addEventListener("preChanging",this._listener.onChanging)}p.prototype={destroy:function(){this._model&&(this._model.removeEventListener("preChanged",this._listener.onChanged),
...
this._annotations,e,f=0,h=function(){for(;f<d.length;){var e=d[f++];if(a===e.start||(a>e.start?a<e.end:e.start<b))return e;if(e.start>=b)break}return null};e=h();return{next:function(){var b=e;b&&(e=h());return b},hasNext:function(){return null!==e}}},modifyAnnotation:function(a){if(a&&!(0>this._getAnnotationIndex(a)))this.onChanged({type:"Changed",added:[],removed:[],changed:[a]})},onChanged:function(a){return this.dispatchEvent(a)},removeAnnotations:function(a){var b=this._annotations,d,e;if(a){d=
[];for(e=b.length-1;0<=e;e--){var f=b[e];f.type===a&&(b.splice(e,1),d.splice(0,0,f),f._annotationModel=null)}}else d=b;this.onChanged({type:"Changed",removed:d,added:[],changed:[]})},removeAnnotation:function(a){if(a){var b=this._getAnnotationIndex(a);0>b||(a._annotationModel=null,a={type:"Changed",removed:this._annotations.splice(b,1),added:[],changed:[]},this.onChanged(a))}},replaceAnnotations:function(a,b){var d=this._annotations,e,f,h,g=[];if(a)for(e=a.length-1;0<=e;e--)h=a[e],f=this._getAnnotationIndex(h),
0>f||(h._annotationModel=null,d.splice(f,1),g.splice(0,0,h));b||(b=[]);for(e=0;e<b.length;e++)h=b[e],f=this._binarySearch(d,h.start),h._annotationModel=this,d.splice(f,0,h);this.onChanged({type:"Changed",removed:g,added:b,changed:[]})},setTextModel:function(a){this._model&&this._model.removeEventListener("Changed",this._listener.onChanged);(this._model=a)&&this._model.addEventListener("Changed",this._listener.onChanged)},_binarySearch:function(a,b){for(var d=a.length,e=-1,f;1<d-e;)f=Math.floor((d+
e)/2),b<=a[f].start?d=f:e=f;return d},_getAnnotationIndex:function(a){for(var b=this._annotations,d=this._binarySearch(b,a.start);d<b.length&&b[d].start===a.start;){if(b[d]===a)return d;d++}return-1},_onChanged:function(a){var b=a.start,d=a.addedCharCount,e=a.removedCharCount,f=this._annotations,h=b+e;if(0<f.length){a={type:"Changed",added:[],removed:[],changed:[],textModelChangedEvent:a};d-=e;for(e=0;e<f.length;e++){var g=f[e];g.start>=h?(g._oldStart=g.start,g._oldEnd=g.end,g.start+=d,g.end+=d,a.changed.push(g)):
g.end<=b||(g.start<b&&h<g.end?(g._oldStart=g.start,g._oldEnd=g.end,g.end+=d,a.changed.push(g)):(f.splice(e,1),a.removed.push(g),g._annotationModel=null,g.expand&&g.expand(),e--))}if(0<a.added.length||0<a.removed.length||0<a.changed.length)this.onChanged(a)}}};n.EventTarget.addMixin(e.prototype);d.prototype={destroy:function(){var a=this._view;a&&(a.removeEventListener("Destroy",this._listener.onDestroy),a.removeEventListener("LineStyle",this._listener.onLineStyle),this.view=null);(a=this._annotationModel)&&
...
b){a||(a=[]);var d,e;for(e=0;e<a.length&&b;e++){var f=a[e];if(b.end<=f.start)break;if(!(b.start>=f.end)){d=this._mergeStyle({},f.style);d=this._mergeStyle(d,b.style);var h=[];h.push(e,1);b.start<f.start&&h.push({start:b.start,end:f.start,style:b.style});b.start>f.start&&h.push({start:f.start,end:b.start,style:f.style});h.push({start:Math.max(f.start,b.start),end:Math.min(f.end,b.end),style:d});b.end<f.end&&h.push({start:b.end,end:f.end,style:f.style});b=b.end>f.end?{start:f.end,end:b.end,style:b.style}:
null;Array.prototype.splice.apply(a,h)}}b&&(d=this._mergeStyle({},b.style),a.splice(e,0,{start:b.start,end:b.end,style:d}));return a},_onAnnotationModelChanged:function(a){function b(b,a){h.getBaseModel&&(b=h.mapOffset(b,!0),a=h.mapOffset(a,!0));-1!==b&&-1!==a&&e.redrawRange(b,a)}function d(a,c){for(var k=0;k<a.length;k++)if(f.isAnnotationTypeVisible(a[k].type)){var e=a[k];b(e.start,e.end);c&&(void 0!==e._oldStart&&e._oldEnd)&&b(e._oldStart,e._oldEnd)}}var e=this._view;if(e){var f=this,h=e.getModel();
d(a.added);d(a.removed);d(a.changed,!0)}},_onDestroy:function(){this.destroy()},_onLineStyle:function(a){var b=this._annotationModel,d=a.textView.getModel(),e=b.getTextModel(),f=a.lineStart,h=a.lineStart+a.lineText.length;e!==d&&(f=d.mapOffset(f),h=d.mapOffset(h));for(b=b.getAnnotations(f,h);b.hasNext();)if(f=b.next(),this.isAnnotationTypeVisible(f.type)){if(f.rangeStyle){var h=f.start,g=f.end;e!==d&&(h=d.mapOffset(h,!0),g=d.mapOffset(g,!0));a.ranges=this._mergeStyleRanges(a.ranges,{start:h,end:g,
style:f.rangeStyle})}f.lineStyle&&(a.style=this._mergeStyle({},a.style),a.style=this._mergeStyle(a.style,f.lineStyle))}}};f.addMixin(d.prototype);return{FoldingAnnotation:p,AnnotationType:a,AnnotationTypeList:f,AnnotationModel:e,AnnotationStyler:d}});
...
this.getModel(),b=this.getCaretOffset(),d=a.getLineAtOffset(b),a=a.getLineStart(d),b=b-a,a=this.getKeyModes(),e=0;e<a.length;e++){var h=a[e];if(h.isActive()&&h.isStatusActive&&h.isStatusActive())return}this.reportStatus(f.formatMessage(g.lineColumn,d+1,b+1))},showAnnotations:function(a,b,d,e){var f=this._annotationModel;if(f){for(var g=[],l=[],t=f.getTextModel(),p=f.getAnnotations(0,t.getCharCount()),s;p.hasNext();)s=p.next(),-1!==b.indexOf(s.type)&&s.creatorID===this&&g.push(s);if(a)for(b=0;b<a.length;b++)if(s=
a[b]){if(d)s=d(s);else{var v;"number"===typeof s.line?(v=t.getLineStart(s.line-1),p=v+s.start-1,v=v+s.end-1):(p=s.start,v=s.end);var n=e(s);if(!n)continue;s=h.createAnnotation(n,p,v,s.description)}s.creatorID=this;l.push(s)}f.replaceAnnotations(g,l)}},showProblems:function(a){this.showAnnotations(a,[h.ANNOTATION_ERROR,h.ANNOTATION_WARNING,h.ANNOTATION_TASK],null,function(b){switch(b.severity){case "error":return h.ANNOTATION_ERROR;case "warning":return h.ANNOTATION_WARNING;case "task":return h.ANNOTATION_TASK}return null})},
...
c[m].forEach(function(c){d=l.getUserKeyString(c.keyBinding);b.createItem(d,c.command.name||c.command.tooltip,a(c))}))},addCommand:function(b){this._commandList[b.id]=b;var a=this._pendingBindings[b.id];if(a){var c=this;a.forEach(function(a){c._addBinding(b,a.type,a.binding,a.bindingOnly)});delete this._pendingBindings[b.id]}},addCommandGroup:function(b,a,c,d,e,k,f,m,h){this._contributionsByScopeId[b]||(this._contributionsByScopeId[b]={});b=this._contributionsByScopeId[b];e&&(b=this._createEntryForPath(b,
e));b[a]?(d&&(b[a].title=d),c&&(b[a].position=c),f&&(b[a].imageClass=f),m&&(b[a].tooltip=m),h&&(b[a].selectionClass=h),b[a].emptyGroupMessage=k):(b[a]={title:d,position:c,emptyGroupMessage:k,imageClass:f,tooltip:m,selectionClass:h,children:{}},b.sortedContributions=null)},_createEntryForPath:function(b,a){a&&a.split("/").forEach(function(a){1<a.length&&(b[a]||(b[a]={position:0,children:{}},b.sortedContributions=null),b=b[a].children)});return b},registerSelectionService:function(b,a){this._contributionsByScopeId[b]||
(this._contributionsByScopeId[b]={});this._contributionsByScopeId[b].localSelectionService=a},registerCommandContribution:function(b,a,c,d,e,k,f){this._contributionsByScopeId[b]||(this._contributionsByScopeId[b]={});b=this._contributionsByScopeId[b];d&&(b=this._createEntryForPath(b,d));b[a]={position:c};k&&((c=this._commandList[a])?this._addBinding(c,"key",k,e):this._addPendingBinding(a,"key",k,e));f&&((c=this._commandList[a])?this._addBinding(c,"url",f,e):this._addPendingBinding(a,"url",f,e));b.sortedContributions=
null},unregisterCommandContribution:function(b,a,c){if(this._contributionsByScopeId[b]){delete this._commandList[a];delete this._activeBindings[a];delete this._urlBindings[a];delete this._pendingBindings[a];var d=this._contributionsByScopeId[b];c&&c.split("/").forEach(function(b){1<b.length&&d[b]&&(d=d[b].children)});delete d[a];d.sortedContributions=null}},_addBinding:function(b,a,c,d){if(!b.id)throw Error("No command id: "+b);"key"===a?this._activeBindings[b.id]={command:b,keyBinding:c,bindingOnly:d}:
"url"===a&&(this._urlBindings[b.id]={command:b,urlBinding:c,bindingOnly:d})},_addPendingBinding:function(b,a,c,d){this._pendingBindings[b]=this._pendingBindings[b]||[];this._pendingBindings[b].push({type:a,binding:c,bindingOnly:d})},_checkForTrailingSeparator:function(b,a,c){var d;if("tool"===a||"button"===a)if((d=0<b.childNodes.length?b.childNodes[b.childNodes.length-1]:null)&&d.classList.contains("commandSeparator"))return c?(b.removeChild(d),!1):!0;if("menu"===a&&(b=f.$$array("li > *",b),0<b.length&&
b[b.length-1].classList.contains("dropdownSeparator")))if(d=b[b.length-1],c)d.parentNode.parentNode.removeChild(d.parentNode);else return!0;return!1},renderCommands:function(b,a,c,d,e,k,m){if("string"!==typeof b)throw"a scope id for rendering must be specified";a=f.node(a);if(!a)throw"no parent";var h=this._contributionsByScopeId[b];if(!c&&h){var c=h.localSelectionService||this._selectionService,g=this;c&&c.getSelections(function(c){g.renderCommands(b,a,c,d,e,k)})}else h&&(this._render(this._contributionsByScopeId[b],
a,c,d,e||"button",k,m),this._checkForTrailingSeparator(a,e,!0))},destroy:function(b){b=f.node(b);if(!b)throw"no parent";for(;b.hasChildNodes();){var a=b.firstChild;a.commandTooltip&&a.commandTooltip.destroy();a.emptyGroupTooltip&&a.emptyGroupTooltip.destroy();this.destroy(a);b.removeChild(a)}},_render:function(b,a,c,e,k,f,m){var h=b.sortedContributions;if(!h){var h=[],g=!1,r;for(r in b)if(Object.prototype.hasOwnProperty.call(b,r)){var l=b[r];l&&"number"===typeof l.position&&(l.id=r,h.push(l),g=!0)}g&&
(h.sort(function(b,a){return b.position-a.position}),b.sortedContributions=h)}var w=0,x=this;h.forEach(function(b){var h,g;b.imageClass||(b.imageClass=null);if(b.children&&0<Object.getOwnPropertyNames(b.children).length){h=b.children;var r;if("tool"===k||"button"===k)if(b.title)r=x._createDropdownMenu(a,b.title,null,null,b.imageClass,b.tooltip,b.selectionClass),m&&p.generateNavGrid(m,r.menuButton),r&&window.setTimeout(function(){x._render(b.children,r.menu,c,e,"menu",f,m);x._checkForTrailingSeparator(r.menu,
"menu",!0);0===r.menu.childNodes.length?b.emptyGroupMessage?r.menuButton.emptyGroupTooltip||(r.menuButton.emptyGroupTooltip=new d.Tooltip({node:r.menuButton,text:b.emptyGroupMessage,trigger:"click",position:["below","right","above","left"]})):(m&&p.removeNavGrid(m,r.menuButton),r.menu.parentNode&&r.menu.parentNode.removeChild(r.menu),r.destroyButton&&r.destroyButton.parentNode&&r.destroyButton.parentNode.removeChild(r.destroyButton)):r.menuButton.style.visibility="visible"},0);else{var l;0<a.childNodes.length&&
!x._checkForTrailingSeparator(a,k)&&(l=x.generateSeparatorImage(a));x._render(h,a,c,e,k,f,m);0<a.childNodes.length&&a.childNodes[a.childNodes.length-1]!==l&&(l=x.generateSeparatorImage(a))}else if(b.title){if(l=x._createDropdownMenu(a,b.title,!0,null,null,b.imageClass))x._render(h,l.menu,c,e,"menu",f,m),0===l.menu.childNodes.length&&l.destroyButton&&a.removeChild(l.destroyButton)}else 0<a.childNodes.length&&x._generateMenuSeparator(a),x._render(h,a,c,e,k,f,m),x._generateMenuSeparator(a)}else{var t=
x._commandList[b.id];h=t?!0:!1;var B=null,B=null;t&&(g=new n.CommandInvocation(e,c,f,t,x),g.domParent=a,l=h&&(t.visibleWhen?t.visibleWhen(c):!0),x._activeBindings[t.id]&&x._activeBindings[t.id].keyBinding&&(B=x._activeBindings[t.id],B.invocation=l?g:null,B.bindingOnly&&(h=!1)),x._urlBindings[t.id]&&x._urlBindings[t.id].urlBinding&&(B=x._urlBindings[t.id],B.invocation=l?g:null,B.bindingOnly&&(h=!1)),h=h&&l);h&&(t.choiceCallback?("tool"===k||"button"===k?(h=a,l=!1,"ul"===a.nodeName.toLowerCase()&&(h=
document.createElement("li"),a.appendChild(h))):(h=a,l=!0),x._createDropdownMenu(h,t.name,l,function(b){t.populateChoicesMenu(b,c,e,f,x)}.bind(t),t.imageClass,t.tooltip||t.title,t.selectionClass,t.positioningNode)):(g.handler=g.handler||this,g.domParent=a,l=function(){x._invoke(g)},"menu"===k?h=n.createCommandMenuItem(a,t,g,null,l):(h=k+t.id+w,h=n.createCommandItem(a,t,g,h,null,"tool"===k,l)),p.generateNavGrid(m,h),g.domNode=h,w++))}})},_createDropdownMenu:function(a,c,k,m,h,g,r,l){a=f.node(a);if(!a||
!f.contains(document.body,a))return null;var p,x=a;k?(g=document.createRange(),g.selectNode(a),g=g.createContextualFragment(b),f.processTextNodes(g,{ButtonText:c}),a.appendChild(g),p=a.lastChild,h=p.lastChild,c=h.previousSibling,c.dropdown=new e.Dropdown({dropdown:h,populate:m,parentDropdown:a.dropdown}),h.dropdown=c.dropdown):("ul"===a.nodeName.toLowerCase()&&(x=document.createElement("li"),a.appendChild(x),p=x),a=null,h&&(a="dropdownButtonWithIcon",g=g||c),g=h?g||c:g,m=n.createDropdownMenu(x,c,
m,a,h,!1,r,l),c=m.menuButton,h=m.menu,g&&(c.commandTooltip=new d.Tooltip({node:c,text:g,position:["above","below","right","left"]})));return{menuButton:c,menu:h,dropdown:c.dropdown,destroyButton:p}},_generateMenuSeparator:function(b){if(!this._checkForTrailingSeparator(b,"menu")){var a=document.createElement("li");a.classList.add("dropdownSeparator");var c=document.createElement("span");c.classList.add("dropdownSeparator");a.appendChild(c);b.appendChild(a)}},generateSeparatorImage:function(b){var a;
a="ul"===b.nodeName.toLowerCase()?document.createElement("li"):document.createElement("span");b.appendChild(a);a.classList.add("core-sprite-sep");a.classList.add("imageSprite");a.classList.add("commandSeparator");return a}};k.prototype.constructor=k;m.prototype={match:function(b){b=a.matchResourceParameters(b);return"undefined"!==typeof b[this.token]?(this.parameterValue=b[this.token],this):null}};m.prototype.constructor=m;r.prototype.constructor=r;x.prototype={optionsRequested:function(){return this.optionsRequested}};
x.prototype.constructor=x;w.prototype={_storeParameters:function(b){this.parameterTable=null;if(b){var a=this.parameterTable={};b.forEach(function(b){a[b.name]=b})}},updateParameters:function(b){"function"===typeof this.getParameters&&this._storeParameters(this.getParameters(b))},hasParameters:function(){return null!==this.parameterTable},shouldCollectParameters:function(){return!this.clientCollect&&this.hasParameters()},parameterNamed:function(b){return this.parameterTable[b]},valueFor:function(b){return(b=
this.parameterTable[b])?b.value:null},setValue:function(b,a){var c=this.parameterTable[b];c&&(c.value=a)},forEach:function(b){for(var a in this.parameterTable)this.parameterTable[a].type&&this.parameterTable[a].name&&b(this.parameterTable[a])},makeCopy:function(){var b=[];this.forEach(function(a){a=new x(a.name,a.type,a.label,a.value,a.lines,a.eventListeners);b.push(a)});var a=new w(b,this._options,this.getParameters);a.clientCollect=this.clientCollect;return a},hasOptionalParameters:function(){return this._hasOptionalParameters}};
w.prototype.constructor=w;return{CommandRegistry:k,URLBinding:m,ParametersDescription:w,CommandParameter:x,CommandEventListener:r}});define("text!orion/banner/slideout.html",[],function(){return'<div id="slideContainer" class="slideParameters slideContainer">\r\n\t<span id="pageCommandParameters" class="layoutLeft parameters"></span>\r\n\t<span id="pageCommandDismiss" class="layoutRight parametersDismiss"></span>\r\n</div>'});
...
"region";this._contentParent.classList.add("sectionTable");this._contentParent.setAttribute("aria-labelledby",this.titleNode.id);d.appendChild(this._contentParent);c.content&&this.setContent(c.content);this.hidden=c.hidden;"function"===typeof c.onExpandCollapse&&(this._onExpandCollapse=c.onExpandCollapse);this._preferenceService=c.preferenceService;this._contentParent.style.display="none";this.domNode.classList.add("sectionWrapperClosed");if(this._preferenceService){var l=this;this._preferenceService.getPreferences("/window/views").then(function(b){b=
b.get(l.id);void 0!==b&&(l.hidden=!b);l.hidden||(l._contentParent.style.display="block",l.domNode.classList.remove("sectionWrapperClosed"));l._updateExpandedState(!l.hidden,!1)})}else this.hidden||(this._contentParent.style.display="block",this.domNode.classList.remove("sectionWrapperClosed")),this._updateExpandedState(!this.hidden,!1);this._commandService=c.commandService;this._lastMonitor=0;this._loading={}}function d(a){this._section=a;this._id=++a._lastMonitor}e.prototype={setTitle:function(a){this.titleNode.textContent=
...
function m(b){this._parent=b.parent;this._metadata=b.metadata;this.fileClient=b.fileService;this.progress=b.progressService;this.commandRegistry=b.commandRegistry;this.contentTypeRegistry=b.contentTypeRegistry;this.preferences=b.preferences;this.readonly="undefined"===typeof b.readonly?!1:b.readonly;this.showFolderNav=!0;this.readmeHeaderClass=b.readmeHeaderClass;this.editorView=b.editorView;this._maxEditorHeight=b.maxEditorHeight;this.imageView=b.imageView;this.breadCrumbMaker=b.breadCrumbMaker;
this.branchSelector=b.branchSelector;this.clickHandler=b.clickHandler;this._init()}var r=n.FileExplorer,x=p.NavigatorRenderer,w=new f("#{,resource,params*}");b.prototype=Object.create(x.prototype);d.mixin(b.prototype,{showFolderImage:!0,createFolderNode:function(b){var a=p.NavigatorRenderer.prototype.createFolderNode.call(this,b);this.showFolderLinks&&"A"===a.tagName&&(a.href=w.expand({resource:b.Location}));a.classList.add("folderNavFolder");a.classList.add("navlink");a.classList.add("targetSelector");
...
document.createElement("div");b.id="folderNavNode";this._foldersSection=new c.Section(this._node,{id:"folderNavSection",title:"Files",canHide:!this.readonly});if(this.editorView){this._foldersSection.setContent(this.editorView.getParent());this.editorView.getParent().style.height="30px";this.editorView.create();var d=this.editorView.editor.getTextView();d.getModel().addEventListener("Changed",this._editorViewModelChangedListener=function(){var b=d.getLineHeight()*d.getModel().getLineCount()+20;this._maxEditorHeight&&
(0<this._maxEditorHeight&&b>this._maxEditorHeight)&&(b=this._maxEditorHeight);this.editorView.getParent().style.height=b+"px"}.bind(this));this.editor=this.editorView.editor}else this.imageView||(this.folderNavExplorer=new k({parentId:b,readonly:this.readonly,breadCrumbMaker:this.breadCrumbMaker,clickHandler:this.clickHandler,fileClient:this.fileClient,commandRegistry:this.commandRegistry,contentTypeRegistry:this.contentTypeRegistry}),this._foldersSection.embedExplorer(this.folderNavExplorer,null,
!0),this.folderNavExplorer.setCommandsVisible(this._isCommandsVisible()),this.folderNavExplorer.loadRoot(this._metadata));if(this.breadCrumbMaker&&(b=this._foldersSection.getTitleElement())){e.empty(b);var f=document.createElement("div");f.classList.add("breadCrumbContainer");var h=document.createElement("div");this.branchSelector&&b.appendChild(this.branchSelector.node);f.appendChild(h);b.appendChild(f);this.breadCrumbMaker(h,this._foldersSection.getHeaderElement().offsetWidth-150-50);this.branchSelector&&
this.branchSelector.refresh()}}}else"readme"===b&&a&&(m=document.createElement("div"),this.markdownView.displayInFrame(m,a,this.readmeHeaderClass),this._node.appendChild(m))}.bind(this))}).apply(this,[["folderNav","readme"]])},updateImage:function(b){var a=document.createElement("table");a.classList.add("imageViewTable");var c=document.createElement("tr"),d=document.createElement("td"),e=document.createElement("div");e.appendChild(b);d.appendChild(e);c.appendChild(d);a.appendChild(c);this._foldersSection.setContent(a)},
create:function(){this._metadata.Projects&&this.displayWorkspaceView();this.editorView||this.imageView?this.displayBrowseView(this._metadata):this._metadata.Children?this.displayBrowseView(this._metadata):this._metadata.ChildrenLocation&&this.progress.progress(this.fileClient.fetchChildren(this._metadata.ChildrenLocation),"Fetching children of "+this._metadata.Name).then(function(b){this._metadata.Children=b;this.displayBrowseView(this._metadata)}.bind(this))},destroy:function(){this.editorView&&
...
d.length;f++)for(var h=d[f],p=g.getLineAtOffset(h.start),s=g.getLineAtOffset(Math.max(h.start,h.end-1)),n=p;n<=s;n++){var z=n;if(e!==g){z=g.getLineStart(n);z=e.mapOffset(z,!0);if(-1===z)continue;z=e.getLineAtOffset(z)}if(a<=z&&z<b){var q=this._mergeAnnotation(l[z],h,n-p,s-p+1);q&&(l[z]=q)}}if(!this._multiAnnotation&&this._multiAnnotationOverlay)for(var u in l)l[u]._multiple&&(l[u].html+=this._multiAnnotationOverlay.html);return l},getAnnotationModel:function(){return this._annotationModel},getLocation:function(){return this._location},
...
a.styleClass+(" "+b.styleClass):b.styleClass;var d;if(b.style)for(d in a.style||(a.style={}),b.style)void 0===a.style[d]&&(a.style[d]=b.style[d]);if(b.attributes)for(d in a.attributes||(a.attributes={}),b.attributes)void 0===a.attributes[d]&&(a.attributes[d]=b.attributes[d])}return a},_setCurrentGroup:function(a){var b=this._annotationModel,d=null,e=b.getTextModel(),f,h,g=this._currentGroupAnnotation;if(-1!==a){var l=e.getLineStart(a),p=e.getLineEnd(a);e.getBaseModel&&(l=e.mapOffset(l),p=e.mapOffset(p));
for(h=b.getAnnotations(l,p);h.hasNext();)if(f=h.next(),this.isAnnotationTypeVisible(f.type)&&f.start<=l&&f.end>=p&&void 0!==f.groupId){d=f;break}if(g&&d&&g.groupId===d.groupId)return}this._currentGroupAnnotation=null;g&&b.removeAnnotations(g.groupType);if(d&&-1!==a){this._currentGroupAnnotation=d;h=b.getAnnotations(0,e.getCharCount());for(a=[];h.hasNext();)f=h.next(),delete f.groupAnnotation,f.groupId===d.groupId&&(f=f.createGroupAnnotation(),a.push(f));b.replaceAnnotations(null,a)}}};n.AnnotationTypeList.addMixin(l.prototype);
...
d;break;case "${delimiter}":m=e;break;case "${cursor}":m="";f=h;break;default:var n=a[m];n||(n=a[m]={data:r.data,positions:[]});m=r.substitution;n.data&&n.data.values&&(m=n.data.values[0]);n.positions.push({offset:g+h,length:m.length})}l.push(m);h+=m.length}var e=[],w;for(w in a)a.hasOwnProperty(w)&&e.push(a[w]);l=l.join("");void 0===f&&(f=l.length);return{proposal:l,name:this.name,description:this.description,groups:e,escapePosition:g+f,style:"noemphasis"}},match:function(g){return 0===this.prefix.indexOf(g)},
...
define("orion/editor/linkedMode","i18n!orion/editor/nls/messages orion/keyBinding orion/editor/keyModes orion/editor/annotations orion/editor/templates orion/objects orion/util".split(" "),function(g,n,p,a,l,f){function e(a,c,b){var d=a.getTextView();p.KeyMode.call(this,d);this.editor=a;this.undoStack=c;this.contentAssist=b;this.linkedModeModel=null;d.setAction("linkedModeEnter",function(){this.exitLinkedMode(!0);return!0}.bind(this));d.setAction("linkedModeCancel",function(){this.exitLinkedMode(!1);
...
(this.endUndo(),this.startUndo()):this.startUndo();e.selectedGroupIndex=g.group;var h=0,k=b.text.length-(d-c);f=f.positions;for(var l,c=c-g.position.offset,n=d-g.position.offset,p=0;p<f.length;++p)l=f[p],d=l.position,l.oldOffset=d.offset,l.model===e&&l.group===g.group?(d.offset+=h,d.length+=k,h+=k):(d.offset+=h,l.ansestor&&(d.length+=g.count*k)),l.escape&&(l.model.escapePosition=d.offset);this.ignoreVerify=!0;for(p=f.length-1;0<=p;p--)l=f[p],l.model===e&&l.group===g.group&&a.setText(b.text,l.oldOffset+
c,l.oldOffset+n);this.ignoreVerify=!1;b.text=null;this._updateAnnotations(f)}}}.bind(this)}}var d={};e.prototype=new p.KeyMode;f.mixin(e.prototype,{createKeyBindings:function(){var a=n.KeyBinding,c=[];c.push({actionID:"linkedModeEnter",keyBinding:new a(13)});c.push({actionID:"linkedModeCancel",keyBinding:new a(27)});c.push({actionID:"linkedModeNextGroup",keyBinding:new a(9)});c.push({actionID:"linkedModePreviousGroup",keyBinding:new a(9,!1,!0)});return c},enterLinkedMode:function(a){if(!this.linkedModeModel){var c=
...
this.undoStack.endCompoundChange()},isActive:function(){return!!this.linkedModeModel},isStatusActive:function(){return!!this.linkedModeModel},selectLinkedGroup:function(a){var c=this.linkedModeModel;if(c){c.selectedGroupIndex=a;var a=c.groups[a],b=a.positions[0],d=this.editor;d.setSelection(b.offset,b.offset+b.length);if(c=this.contentAssist)c.offset=void 0,a.data&&"link"===a.data.type&&a.data.values?((this._groupContentAssistProvider=new l.TemplateContentAssist(a.data.values)).getPrefix=function(){var a=
d.getSelection();return a.start===a.end&&(a=d.getCaretOffset(),b.offset<=a&&a<=b.offset+b.length)?d.getText(b.offset,a):""},c.offset=b.offset,c.deactivate(),c.activate()):this._groupContentAssistProvider&&(this._groupContentAssistProvider=null,c.deactivate())}this._updateAnnotations()},_getModelPositions:function(a,c,b){for(var d=c.groups,e=0;e<d.length;e++)for(var f=d[e].positions,g=0;g<f.length;g++){var l=f[g];b&&(l={offset:l.offset+b,length:l.length});l={index:g,group:e,count:f.length,model:c,
position:l};a.push(l);c.nextModel&&c.nextModel.parentGroup===e&&(l.ansestor=!0,this._getModelPositions(a,c.nextModel,(b||0)+f[g].offset-f[0].offset))}},_getSortedPositions:function(a){var c=this._sortedPositions;if(!c){for(c=[];a.previousModel;)a=a.previousModel;for(this._getModelPositions(c,a);a;)void 0!==a.escapePosition&&c.push({escape:!0,model:a,position:{offset:a.escapePosition,length:0}}),a=a.nextModel;c.sort(function(b,a){return b.position.offset-a.position.offset});this._sortedPositions=c}return c},
_getPositionChanged:function(a,c,b){for(var d,a=this._getSortedPositions(a),e=a.length-1;0<=e;e--){var f=a[e].position;if(f.offset<=c&&b<=f.offset+f.length){d=a[e];break}}return{position:d,positions:a}},_updateAnnotations:function(d){var c=this.editor.getAnnotationModel();if(c){for(var b=[],e=[],f=c.getTextModel(),f=c.getAnnotations(0,f.getCharCount()),g;f.hasNext();)switch(g=f.next(),g.type){case a.AnnotationType.ANNOTATION_LINKED_GROUP:case a.AnnotationType.ANNOTATION_CURRENT_LINKED_GROUP:case a.AnnotationType.ANNOTATION_SELECTED_LINKED_GROUP:b.push(g)}if(f=
...
new n;b.reject(g["No Matching FileService for location:"]+a);return b}var c=a.getServiceReferences("orion.core.file"),b=c;if(d)for(var b=[],k=0;k<c.length;++k)d(c[k])&&b.push(c[k]);for(var l=[],r=[],x=[],w=[],t={fetchChildren:function(){var a=new n;a.resolve(w);return a},createWorkspace:function(){var a=new n;a.reject(g["no file service"]);return a},loadWorkspaces:function(){var a=new n;a.reject(g["no file service"]);return a},loadWorkspace:function(){var a=new n;window.setTimeout(function(){a.resolve({Directory:!0,
Length:0,LocalTimeStamp:0,Name:g["File Servers"],Location:"/",Children:w,ChildrenLocation:"/"})},100);return a},search:f,createProject:f,createFolder:f,createFile:f,deleteFile:f,moveFile:f,copyFile:f,read:f,write:f},c=0;c<b.length;++c)w[c]={Directory:!0,Length:0,LocalTimeStamp:0,Location:b[c].getProperty("top"),ChildrenLocation:b[c].getProperty("top"),Name:b[c].getProperty("Name")},k=b[c].getProperty("pattern")||b[c].getProperty("top").replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1"),"^"!==k[0]&&(k=
"^"+k),l[c]=RegExp(k),r[c]=a.getService(b[c]),x[c]=b[c].getProperty("Name"),b[c].getProperty("NameKey")&&b[c].getProperty("nls")&&p.getMessageBundle(b[c].getProperty("nls")).then(function(a,c){w[a].Name=c[b[a].getProperty("NameKey")];x[a]=c[b[a].getProperty("NameKey")]}.bind(this,c));this._getServiceIndex=function(a){if("/"===a)return-1;if(!a||a.length&&0===a.length)return r[0]?0:-1;for(var b=0;b<l.length;++b)if(l[b].test(a))return b;throw g["No Matching FileService for location:"]+a;};this._getService=
function(a){a=this._getServiceIndex(a);return-1===a?t:r[a]};this._getServiceName=function(a){a=this._getServiceIndex(a);return-1===a?t.Name:x[a]};this._getServiceRootURL=function(a){a=this._getServiceIndex(a);return-1===a?t.Location:w[a].Location}}f.prototype={getService:function(a){return this._getService(a)},fileServiceName:function(a){return this._getServiceName(a)},fileServiceRootURL:function(a){return this._getServiceRootURL(a)},fetchChildren:function(e){return a(this._getService(e),"fetchChildren",
...
g.splice(0,1);if(!(k.result.index<h)){var l=k.result.index,n,p=[];if(k.pattern.regex){h=k.result;n=l+h[0].length;n={start:b+l,end:b+n,style:k.pattern.pattern.name,isWhitespace:k.pattern.isWhitespace};if(!f){k.pattern.pattern.captures&&r(h,k.pattern.pattern.captures,b+l,p);p.sort(function(a,b){return a.start<b.start?-1:a.start>b.start?1:0});for(l=0;l<p.length-1;l++)if(p[l+1].start<p[l].end){var t={start:p[l+1].end,end:p[l].end,style:p[l].style};p[l].end=p[l+1].start;p.splice(l+2,0,t)}}x(n,p,d)}else k.pattern.regexEnd.lastIndex=
...
b.next();d.type===f&&k.push(d)}if(a.getLinePatterns().length&&a.pattern.pattern.name&&0===a.pattern.pattern.name.indexOf("comment")){b=[];w(c.getText(a.contentStart,a.end),a.contentStart,a,b,!0);for(a=0;a<b.length;a++)"meta.annotation.task.todo"===b[a].style&&h.push(g.AnnotationType.createAnnotation(f,b[a].start,b[a].end,c.getText(b[a].start,b[a].end)))}}.bind(this));e.replaceAnnotations(k,h)}}},y=function(a,b,c,f){var g=[];c.getBlockPatterns().forEach(function(a){var c=k(a.regexBegin,b,0);c&&g.push({result:c,
pattern:a})}.bind(this));g.sort(function(a,b){return a.result.index<b.result.index?-1:a.result.index>b.result.index?1:a.pattern.pattern.index<b.pattern.pattern.index?-1:1});if(!g.length)return g;for(var h=0,l=[];0<g.length;){var n=g[0];g.splice(0,1);if(!(n.result.index<h)){var r=a.getLineAtOffset(f+n.result.index),x=a.getLine(r),y=[];w(x,a.getLineStart(r),c,y);r=f+n.result.index;for(x=0;x<y.length;x++)if(y[x].start===r){var h=n.result.index+n.result[0].length,I=null,H=n.pattern.regexEnd,J=H.toString();
d.lastIndex=0;if(d.test(J)){d.lastIndex=0;for(var D=d.exec(J);D;)J=J.replace(D[0],n.result[D[1]]||""),D=d.exec(J);H=RegExp(J.substring(1,J.length-2),"g")}for(D=h;!I;){D=k(H,b,D);D||(e.lastIndex=0,D=e.exec(b));var J=[],O=new p({start:r,end:f+D.index+D[0].length,contentStart:f+h,contentEnd:f+D.index},n.pattern,c.getStyler(),a,c);w(b.substring(h,D.index+D[0].length),h,O,J);if(!J.length||J[J.length-1].end<=D.index)I=O;D=D.index+D[0].length}l.push(I);h=I.end-f;break}x===y.length&&(h=n.result.index+1)}m(n,
...
b?null:new (g.AnnotationType.getType(g.AnnotationType.ANNOTATION_FOLDING))(c,d,a)},_findBlock:function(a,b){var c=a.getBlocks();if(!c.length)return a;var d=this._binarySearch(c,b,!0);return d<c.length&&c[d].start<=b&&b<c[d].end?this._findBlock(c[d],b):a},_findBrackets:function(a,b,c,d,e,f){for(var g=[],h=[],k=e,l=c.getBlocks(),m=this._binarySearch(l,e,!0);m<l.length&&!(l[m].start>=f);m++){var n=l[m].start,p=l[m].end;k<n&&(w(d.substring(k-e,n-e),k,c,h),h.forEach(function(c){0===c.style.indexOf(a.pattern.name)?
g.push(c.start+1):0===c.style.indexOf(b.pattern.name)&&g.push(-(c.start+1))}),h=[]);k=p}k<f&&(w(d.substring(k-e,f-e),k,c,h),h.forEach(function(c){0===c.style.indexOf(a.pattern.name)?g.push(c.start+1):0===c.style.indexOf(b.pattern.name)&&g.push(-(c.start+1))}));return g},_findMatchingBracket:function(a,b,c){for(var d=a.getLineAtOffset(c),e=a.getLineEnd(d),f=a.getText(c,e),g,h=b.getEnclosurePatterns(),l=Object.keys(h),m=0;m<l.length;m++){var n=h[l[m]],p=k(n.regex,f,0);if(p&&0===p.index){g=n;break}}if(!g)return-1;
f=!1;-1!==g.pattern.name.indexOf(".begin")?(f=!0,m=g.pattern.name.replace(".begin",".end")):m=g.pattern.name.replace(".end",".begin");h=h[m];if(!h)return-1;l=a.getLine(d);n=a.getLineStart(d);e=this._findBrackets(g,h,b,l,n,e);for(m=0;m<e.length;m++)if(l=0<=e[m]?1:-1,e[m]*l-1===c){c=1;if(f){for(m++;m<e.length;m++)if(l=0<=e[m]?1:-1,c+=l,0===c)return e[m]*l-1;d+=1;for(m=a.getLineCount();d<m;){l=a.getLine(d);n=a.getLineStart(d);e=a.getLineEnd(d);e=this._findBrackets(g,h,b,l,n,e);for(f=0;f<e.length;f++)if(l=
0<=e[f]?1:-1,c+=l,0===c)return e[f]*l-1;d++}}else{for(m--;0<=m;m--)if(l=0<=e[m]?1:-1,c+=l,0===c)return e[m]*l-1;for(d-=1;0<=d;){l=a.getLine(d);n=a.getLineStart(d);e=a.getLineEnd(d);e=this._findBrackets(g,h,b,l,n,e);for(m=e.length-1;0<=m;m--)if(l=0<=e[m]?1:-1,c+=l,0===c)return e[m]*l-1;d--}}break}return-1},_getAnnotationModel:function(){return this.annotationModel},_getDetectTasks:function(){return this.detectTasks},_getLineStyle:function(a){if(this.highlightCaretLine){var b=this.view,c=b.getModel(),
b=b.getSelection();if(b.start===b.end&&c.getLineAtOffset(b.start)===a)return f}return null},_getPatternManager:function(){return this.patternManager},_getStyles:function(a,b,c,d){b.getBaseModel&&(d=b.mapOffset(d));for(var e=d+c.length,f=[],g=d,h=a.getBlocks(),l=this._binarySearch(h,d,!0);l<h.length&&!(h[l].start>=e);l++){var m=h[l].start,n=h[l].end;g<m&&w(c.substring(g-d,m-d),g,a,f);var p=Math.max(g,m);if(p===m){var t=k(h[l].pattern.regexBegin,c.substring(p-d),0);if(t){var x=h[l].pattern.pattern.beginCaptures||
h[l].pattern.pattern.captures;x?r(t,x,p,f):f.push({start:p,end:p+t[0].length,style:h[l].pattern.pattern.name});p+=t[0].length}}var m=Math.min(e,n),y=[];if(m===n&&(g=c.substring(m-g-(h[l].end-h[l].contentEnd)),t=k(h[l].pattern.regexEnd,g,0)))(x=h[l].pattern.pattern.endCaptures||h[l].pattern.pattern.captures)?r(t,x,m-t[0].length,y):h[l].pattern.pattern.name&&y.push({start:m-t[0].length,end:m,style:h[l].pattern.pattern.name}),m-=t[0].length;var g=this._getStyles(h[l],b,c.substring(p-d,m-d),p),O=h[l].pattern.pattern.contentName||
h[l].pattern.pattern.name;if(O){var P=p;g.forEach(function(a){a.start-P&&f.push({start:P,end:a.start,style:O});f.push(a);P=a.end});m-P&&f.push({start:P,end:m,style:O})}else f=f.concat(g);f=f.concat(y);g=n}g<e&&w(c.substring(g-d,e-d),g,a,f);if(b.getBaseModel)for(a=0;a<f.length;a++)c=f[a].end-f[a].start,f[a].start=b.mapOffset(f[a].start,!0),f[a].end=f[a].start+c;return f},_isRenderingWhitespace:function(){return this.whitespacesVisible&&(this.tabsVisible||this.spacesVisible)},_onDestroy:function(){this.destroy()},
_onLineStyle:function(a){a.textView===this.view&&(a.style=this._getLineStyle(a.lineIndex));a.ranges=this._getStyles(this._rootBlock,a.textView.getModel(),a.lineText,a.lineStart);a.ranges.forEach(function(a){a.style&&(a.style={styleClass:a.style.replace(/\./g," ")})});this._isRenderingWhitespace()&&(this.spacesVisible&&this._spliceStyles(c,a.ranges,a.lineText,a.lineStart),this.tabsVisible&&this._spliceStyles(b,a.ranges,a.lineText,a.lineStart))},_onSelection:function(a){var b=a.oldValue,c=a.newValue,
d=this.view,a=d.getModel(),e;if(this.highlightCaretLine){var f=a.getLineAtOffset(b.start);e=a.getLineAtOffset(c.start);var h=c.start===c.end,b=b.start===b.end;f===e&&b&&h||(b&&d.redrawLines(f,f+1),(f!==e||!b)&&h&&d.redrawLines(e,e+1))}if(this.annotationModel){var b=this._bracketAnnotations,k,l;if(c.start===c.end&&0<(l=d.getCaretOffset()))l-=1,a.getBaseModel&&(l=a.mapOffset(l),a=a.getBaseModel()),c=this._findBlock(this._rootBlock,l),a=this._findMatchingBracket(a,c,l),-1!==a&&(k=[g.AnnotationType.createAnnotation(g.AnnotationType.ANNOTATION_MATCHING_BRACKET,
a,a+1),g.AnnotationType.createAnnotation(g.AnnotationType.ANNOTATION_CURRENT_BRACKET,l,l+1)]);this._bracketAnnotations=k;this.annotationModel.replaceAnnotations(b,k)}},_onMouseDown:function(a){if(2===a.clickCount){var b=this.view,c=b.getModel(),d=b.getOffsetAtLocation(a.x,a.y);if(0<d){var e=d-1,f=c;c.getBaseModel&&(e=c.mapOffset(e),f=c.getBaseModel());var g=this._findBlock(this._rootBlock,e),e=this._findMatchingBracket(f,g,e);-1!==e&&(a.preventDefault(),a=e,c.getBaseModel&&(a=c.mapOffset(a,!0)),d>
...
patterns:[{include:"orion.patterns"},{match:"\\b(?:"+n.join("|")+")\\b",name:"keyword.control.js"},{begin:"'(?:\\\\.|[^'\\n])*\\\\\\n",end:"(?:(?:\\\\.|[^'\\n])*\\\\\\n)*(?:\\n|(?:\\\\.|[^'\\n])*'?)",name:"string.quoted.single.js"},{begin:'"(?:\\\\.|[^"\\n])*\\\\\\n',end:'(?:(?:\\\\.|[^"\\n])*\\\\\\n)*(?:\\n|(?:\\\\.|[^"\\n])*"?)',name:"string.quoted.double.js"}]});return{id:g[g.length-1].id,grammars:g,keywords:n}});
...
g=g.grammars;g.push({id:"orion.css",contentTypes:["text/css"],patterns:[{include:"orion.patterns"},{match:"(?:-webkit-|-moz-|-ms-|\\b)(?:"+n.join("|")+")\\b",name:"keyword.control.css"},{match:"(?i)\\b-?(?:\\.\\d+|\\d+\\.?\\d*)(?:%|em|ex|ch|rem|vw|vh|vmin|vmax|in|cm|mm|pt|pc|px|deg|grad|rad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx)?\\b",name:"constant.numeric.value.css"},{match:"#[0-9A-Fa-f]+\\b",name:"constant.numeric.hex.css"},{begin:"'[^'\\n]*\\\\\n",end:"(?:[^'\\n]*\\\\\\n)*[^'\\n]*'?",name:"string.quoted.single.css"},
{begin:'"[^"\\n]*\\\\\n',end:'(?:[^"\\n]*\\\\\\n)*[^"\\n]*"?',name:"string.quoted.double.css"},{id:"comment_singleline"}]});return{id:g[g.length-1].id,grammars:g,keywords:n}});
...
captures:{2:{name:"keyword.other.documentation.task"},4:{name:"comment.line"}}}]},{begin:"(</?[A-Za-z0-9]+)",end:"(/?>)",captures:{1:{name:"entity.name.tag.html"}},name:"meta.tag.html",patterns:[{include:"#comment"},{include:"orion.patterns#string"},{include:"orion.patterns#string_singleQuote"}]}]});return{id:g[g.length-1].id,grammars:g,keywords:[]}});
...
SyntaxHighlighter:b}});
define("orion/widgets/browse/readonlyFileClient",["i18n!orion/navigate/nls/messages","orion/Deferred","orion/i18nUtil"],function(g,n,p){function a(a){function e(b){return function(){var c;try{var e=a[b].apply(a,Array.prototype.slice.call(arguments));if(e&&"function"===typeof e.then)return e;c=new n;c.resolve(e)}catch(f){c=new n,c.reject(f)}return c.promise}}for(var c in a)"function"===typeof a[c]&&(this[c]=e(c))}function l(a,e,c,b){this._properties=c||{};this._properties["service.id"]=a;this._properties.objectClass=
e;this._properties["service.names"]=e;this.service=b}function f(a,e,c){if(!a[e])throw e+g[" is not supported in this file system"];return a[e].apply(a,c)}function e(d,e){function c(a){var b=new n;b.reject(g["No Matching FileService for location:"]+a);return b}var b=[];d.forEach(function(c){var d=new a(c.impl);b.push(new l(c.id,"readonly.file.service",c.serviceProperties,d))});var f=b;if(e)for(var f=[],m=0;m<b.length;++m)e(b[m])&&f.push(b[m]);for(var r=[],x=[],w=[],t=[],y={fetchChildren:function(){var a=
new n;a.resolve(t);return a},createWorkspace:function(){var a=new n;a.reject(g["no file service"]);return a},loadWorkspaces:function(){var a=new n;a.reject(g["no file service"]);return a},loadWorkspace:function(){var a=new n;window.setTimeout(function(){a.resolve({Directory:!0,Length:0,LocalTimeStamp:0,Name:g["File Servers"],Location:"/",Children:t,ChildrenLocation:"/"})},100);return a},search:c,createProject:c,createFolder:c,createFile:c,deleteFile:c,moveFile:c,copyFile:c,read:c,write:c},m=0;m<f.length;++m){t[m]=
{Directory:!0,Length:0,LocalTimeStamp:0,Location:f[m].getProperty("top"),ChildrenLocation:f[m].getProperty("top"),Name:f[m].getProperty("Name")};var s=f[m].getProperty("pattern")||".*";"^"!==s[0]&&(s="^"+s);r[m]=RegExp(s);x[m]=f[m].service;w[m]=f[m].getProperty("Name");f[m].getProperty("NameKey")&&f[m].getProperty("nls")&&p.getMessageBundle(f[m].getProperty("nls")).then(function(a,b){t[a].Name=b[f[a].getProperty("NameKey")];w[a]=b[f[a].getProperty("NameKey")]}.bind(this,m))}this._getServiceIndex=
function(a){if("/"===a)return-1;if(!a||a.length&&0===a.length)return x[0]?0:-1;for(var b=0;b<r.length;++b)if(r[b].test(a))return b;throw g["No Matching FileService for location:"]+a;};this._getService=function(a){a=this._getServiceIndex(a);return-1===a?y:x[a]};this._getServiceName=function(a){a=this._getServiceIndex(a);return-1===a?y.Name:w[a]};this._getServiceRootURL=function(a){a=this._getServiceIndex(a);return-1===a?y.Location:t[a].Location}}l.prototype={getPropertyKeys:function(){var a=[],e;for(e in this._properties)this._properties.hasOwnProperty(e)&&
a.push(e);return a},getProperty:function(a){return this._properties[a]}};l.prototype.constructor=l;e.prototype={getService:function(a){return this._getService(a)},fileServiceName:function(a){return this._getServiceName(a)},fileServiceRootURL:function(a){return this._getServiceRootURL(a)},fetchChildren:function(a){return f(this._getService(a),"fetchChildren",arguments)},loadWorkspaces:function(){return f(this._getService(),"loadWorkspaces",arguments)},read:function(a,e){return f(this._getService(a),
"read",arguments)},loadWorkspace:function(a){return f(this._getService(a),"loadWorkspace",arguments)}};e.prototype.constructor=e;return{FileClient:e}});
...
fetchChildren:function(){return(new g).resolve([p])},loadWorkspaces:function(){return(new g).resolve(l)},read:function(f,e){return e?(new g).resolve(a):(new g).resolve("The goal of Orion is to build developer tooling that works in the browser, at web scale.\nThe vision behind Orion is to move software development to the web as a web experience, by\nenabling open tool integration through HTTP and REST, JSON, OAuth, OpenID, and others.\nThe idea is to exploit internet design principles throughout, instead of trying to bring\nexisting desktop IDE concepts to the browser. See the [Orion wiki](http://wiki.eclipse.org/Orion) for more\ninformation about Orion.\n\nContributing\n------------\n\nOrion source code is available in an Eclipse Git repository, and there is also a mirror\non GitHub. For complete details on getting the source and getting setup to develop Orion,\nsee the [Orion wiki](http://wiki.eclipse.org/Orion/Getting_the_source).\n\nBug reports and patches are welcome in [bugzilla](https://bugs.eclipse.org/bugs/enter_bug.cgi?product=Orion).\n\nLicense\n-------\n\nThis repository contains the Orion client and Node-based server. This source code is available\nunder the [Eclipse Public License](http://www.eclipse.org/legal/epl-v10.html)\nand [Eclipse Distribution License](http://www.eclipse.org/org/documents/edl-v10.php).\n")},
loadWorkspace:function(){return(new g).resolve(l)}};n.prototype.constructor=n;return{FileClient:n}});
define("orion/widgets/browse/fileBrowser","orion/PageUtil orion/inputManager orion/breadcrumbs orion/widgets/browse/browseView orion/explorers/navigatorRenderer orion/widgets/browse/readonlyEditorView orion/widgets/browse/branchSelector orion/markdownView orion/commandRegistry orion/fileClient orion/contentTypes orion/widgets/browse/staticDataSource orion/widgets/browse/readonlyFileClient orion/widgets/browse/emptyFileClient orion/Deferred orion/URITemplate orion/objects orion/webui/littlelib".split(" "),function(g,
n,p,a,l,f,e,d,h,c,b,k,m,r,x,w,t,y){function s(a){this._parentDomNode=y.node(a.parent);this._parentDomNode.classList.add("browserParentDome");this._fileClient=a.fileClient;this._repoURL=a.repoURL;a.serviceRegistry?this._fileClient=new c.FileClient(a.serviceRegistry):!this._fileClient&&a.serviceRefs&&(this._fileClient=new m.FileClient(a.serviceRefs));this._fileClient||(this._fileClient=new r.FileClient);this._syntaxHighlighter=a.syntaxHighlighter;this._syntaxHighlighter||(this._syntaxHighlighter=new k.SyntaxHighlighter);
this._contentTypeService=a.contentTypeService;this._contentTypeService||(this._contentTypeService=new b.ContentTypeRegistry(k.ContentTypes));this._preferences=a.preferences;this.rootName=a.rootName;this._showBranch=a.showBranch;this._showComponent=a.showComponent;this._init(a)}t.mixin(s.prototype,{_init:function(a){this._commandRegistry=new h.CommandRegistry({});this._maxEditorHeight=a.maxEditorHeight;this._inputManager=new n.InputManager({fileClient:this._fileClient,statusReporter:this._statusReport,
contentTypeRegistry:this._contentTypeService});this._uriTemplate=new w("#{,resource,params*}");this._inputManager.addEventListener("InputChanged",function(a){var b=a.metadata;if(this._branches&&this._branchSelector){var c=this._branches[0].Name;this._activeBranchLocation=this._branches[0].Location;var d=null,e=!1;b.Parents?(0<b.Parents.length?(c=b.Parents[b.Parents.length-1].Name,this._activeBranchLocation=b.Parents[b.Parents.length-1].Location):(c=b.Name,this._activeBranchLocation=b.Location),e=
!0):(this._branches.some(function(a){if("master"===a.Name.toLowerCase())return c=a.Name,d=this._activeBranchLocation=a.Location,!0}.bind(this)),d=d||this._branches[0].Location,this._activeBranchLocation=this._activeBranchLocation||this._branches[0].Location);this._branchSelector.activeBranchName=c;if(this._showComponent&&!e){this._fileClient.fetchChildren(this._activeBranchLocation).then(function(a){if(a&&0<a.length){var b=null;a.some(function(a){if(a.Directory)return b=a,!0}.bind(this));this.refresh(b.Location)}}.bind(this));
return}if(d){this.refresh(d);return}}this._breadCrumbName=a.name;this._breadCrumbTarget=b;if(null===a.input||void 0===a.input)this._breadCrumbName=this._lastRoot?this._lastRoot.Name:"",this._breadCrumbTarget=this._lastRoot;b=this._getEditorView(a.input,b);this._setEditor(b?b.editor:null);a.editor=this._editor}.bind(this));a={parent:document.createElement("div"),syntaxHighlighter:this._syntaxHighlighter,inputManager:this._inputManager,preferences:this._preferences,statusReporter:function(a,b,c){this._statusReport(a,
b,c)}.bind(this)};this._editorView=new f.ReadonlyEditorView(a);window.addEventListener("hashchange",function(){this.refresh(g.hash())}.bind(this));if(this._showBranch){var b=document.createElement("div");b.classList.add("brSelectorContainer");a=this._fileClient.fileServiceRootURL("");this._fileClient.fetchChildren(a).then(function(a){a&&0<a.length&&(this._branches=a,this._branchSelector=new e.BranchSelector({commandRegistry:this._commandRegistry,fileClient:this._fileClient,node:b,activeBranchName:"default",
branches:a}));this.refresh(g.hash())}.bind(this))}else this.refresh(g.hash())},_breadCrumbMaker:function(a,b){this._renderBreadCrumb({task:"Browse",name:this._breadCrumbName,target:this._breadCrumbTarget,breadCrumbContainer:a,makeBreadcrumbLink:function(a,b,c){this._makeBreadCrumbLink(a,b,c)}.bind(this),makeBreadcrumFinalLink:!0,fileClient:this._fileClient,maxLength:b})},_setEditor:function(a){this._editor!==a&&(this._editor=a)},_statusReport:function(){},_makeBreadCrumbLink:function(a,b,c){(c=c?
c.Location:null)||(c=b?b:this._fileClient.fileServiceRootURL(b));a.href=this._uriTemplate.expand({resource:c})},_renderBreadCrumb:function(a){var b=a.breadcrumbRootName,c=a.fileClient;a.target?c&&!a.breadcrumbTarget&&(c.fileServiceName(a.target.Location),b=null):a.breadcrumbTarget||(b=b||a.task||a.name);var d=y.node(a.breadCrumbContainer);if(d){y.empty(d);var e=a.breadcrumbTarget||a.target;this._branches&&e.Parents&&(0<e.Parents.length?e.Parents[e.Parents.length-1].skip=!0:e.skip=!0);c=c&&e&&e.Location?
c.fileServiceRootURL(e.Location):null;new p.BreadCrumbs({container:d,maxLength:a.maxLength,resource:e,rootSegmentName:b,workspaceRootSegmentName:this.rootName?this.rootName:c,workspaceRootURL:this._activeBranchLocation,makeFinalHref:a.makeBreadcrumFinalLink,makeHref:a.makeBreadcrumbLink})}},_getEditorView:function(b,c){var d=null;if(c&&b){var e={parent:this._parentDomNode,readonly:!0,showProjectView:!1,maxEditorHeight:this._maxEditorHeight,readmeHeaderClass:"readmeHeader",metadata:c,branchSelector:this._branchSelector,
commandRegistry:this._commandRegistry,contentTypeRegistry:this._contentTypeService,inputManager:this._inputManager,fileService:this._fileClient,breadCrumbMaker:function(a,b){this._breadCrumbMaker(a,b)}.bind(this)};if(c.Directory)d=new a.BrowseView(e);else{var f=b.editor;if(!f||"orion.editor"===f){var g=this._contentTypeService.getFileContentType(c);l.isImage(g)?(e.imageView={},this._fileClient.readBlob(c.Location).then(function(a){var a=URL.createObjectURL(new Blob([a],{type:g.id})),b=document.createElement("img");
b.src=a;b.classList.add("readonlyImage");this._currentEditorView.updateImage(b)}.bind(this))):e.editorView=this._editorView;d=new a.BrowseView(e)}}}this._currentEditorView!==d&&(this._currentEditorView&&this._currentEditorView.destroy(),(this._currentEditorView=d)&&this._currentEditorView.create());return this._currentEditorView},refresh:function(a){a||(a=this._fileClient.fileServiceRootURL(""));this._inputManager.setInput(a)},create:function(){},destroy:function(){}});return{FileBrowser:s}});
define("orion/serviceregistry",["orion/Deferred","orion/EventTarget"],function(g,n){function p(a,e,c){this._properties=c||{};this._properties["service.id"]=a;this._properties.objectClass=e;this._properties["service.names"]=e}function a(a,e,c){this._serviceId=a;this._serviceReference=e;this._internalRegistry=c}function l(a,e){function c(b){return function(){var c;try{if(!e())throw Error("Service was unregistered");var f=a[b].apply(a,Array.prototype.slice.call(arguments));if(f&&"function"===typeof f.then)return f;
c=new g;c.resolve(f)}catch(l){c=new g,c.reject(l)}return c.promise}}for(var b in a)"function"===typeof a[b]&&(this[b]=c(b))}function f(a,e){this.type=a;this.serviceReference=e}function e(){this._entries=[];this._namedReferences={};this._serviceEventTarget=new n;var a=this;this._internalRegistry={isRegistered:function(e){return a._entries[e]?!0:!1},unregisterService:function(e){var c=a._entries[e];if(!c)throw Error("Service has already been unregistered: "+e);var b=c.reference;a._serviceEventTarget.dispatchEvent(new f("unregistering",
...
define("orion/pluginregistry",["orion/Deferred","orion/EventTarget","orion/URL-shim"],function(g,n){function p(a,c){var d=Object.keys(a),e=Object.keys(c);if(d.length!==e.length)return!1;d.sort();e.sort();for(var f=0,g=d.length;f<g;f++){var h=d[f];if(h!==e[f])return!1;var l=a[h],h=c[h];if(l!==h&&JSON.stringify(l)!==JSON.stringify(h))return!1}return!0}function a(a){if(-1===a.indexOf("://"))try{return(new URL(a,location.href)).href}catch(c){}return a}function l(a,c){if(c&&c instanceof XMLHttpRequest){var d,
e;try{d=c.status,e=c.statusText}catch(f){d=0,e=""}return{status:d||0,statusText:e}}return c}function f(a){var c=a?JSON.parse(JSON.stringify(a,l)):a;a instanceof Error&&(c.__isError=!0,c.message=c.message||a.message,c.name=c.name||a.name);return c}function e(a,c){this.type=a;this.plugin=c}function d(a,c){this.__objectId=a;this.__methods=c}function h(a,c,h){function l(a){H&&h.postMessage(a,H)}function x(a){if(!H)return(new g).reject(Error("plugin not connected"));a.id=String(O++);var b=new g;S[a.id]=
b;b.then(null,function(b){"active"===E&&(b instanceof Error&&"Cancel"===b.name)&&l({requestId:a.id,method:"cancel",params:b.message?[b.message]:[]})});var c=Object.prototype.toString;a.params.forEach(function(e,f){if("[object Object]"===c.call(e)&&!(e instanceof d)){var g,h;for(g in e)"[object Function]"===c.call(e[g])&&(h=h||[],h.push(g));if(h){var k=P++;T[k]=e;g=function(){delete T[k]};b.then(g,g);a.params[f]=new d(k,h)}}});h.postMessage(a,H);return b.promise}function w(a,b){a||0===a?l({id:a,result:null,
error:b}):console.log(b)}function t(a,b,c,d){d.forEach(function(a,b){if(a&&"undefined"!==typeof a.__objectId){var c={};a.__methods.forEach(function(b){c[b]=function(){return x({objectId:a.__objectId,method:b,params:Array.prototype.slice.call(arguments)})}});d[b]=c}});var e=void 0===typeof a?null:{id:a,result:null,error:null};try{var g=c.apply(b,d);e&&(g&&"function"===typeof g.then?(R[a]=g,g.then(function(b){delete R[a];e.result=b;l(e)},function(b){R[a]&&(delete R[a],e.error=f(b),l(e))},function(){l({responseId:a,
method:"progress",params:Array.prototype.slice.call(arguments)})})):(e.result=g,l(e)))}catch(h){e&&(e.error=f(h),l(e))}}function y(a){try{if(a.method){var b=a.method,c=a.params||[];if("serviceId"in a){var d=Y[a.serviceId];d||w(a.id,"service not found");b in d?t(a.id,d,d[b],c):w(a.id,"method not found")}else if("objectId"in a){var e=T[a.objectId];e||w(a.id,"object not found");b in e?t(a.id,e,e[b],c):w(a.id,"method not found")}else if("requestId"in a){var f=R[a.requestId];f&&("cancel"===b&&f.cancel)&&
f.cancel.apply(f,c)}else if("responseId"in a){var g=S[a.responseId];g&&("progress"===b&&g.progress)&&g.progress.apply(g,c)}else if("plugin"===a.method){var k=a.params[0];U({headers:k.headers,services:k.services}).then(function(){I&&I.resolve(q)})}else if("timeout"===a.method)I&&I.reject(a.error);else throw Error("Bad method: "+a.method);}else{var l=S[String(a.id)];delete S[String(a.id)];if(a.error){var n=h.handleServiceError(q,a.error);l.reject(n)}else l.resolve(a.result)}}catch(p){console.log("Plugin._messageHandler "+
p)}}function s(c){var d=JSON.parse(JSON.stringify(c.properties));d.__plugin__=a;c=c.names||c.type||[];Array.isArray(c)||(c=[c]);d.objectClass=c;return d}function v(a){var b={};if(a.methods&&(a.methods.forEach(function(c){b[c]=function(){var b={serviceId:a.serviceId,method:c,params:Array.prototype.slice.call(arguments)};return"active"===E?x(b):q.start({"transient":!0}).then(function(){return x(b)})}}),b.addEventListener&&b.removeEventListener)){var c=new n,e=P++;T[e]={handleEvent:c.dispatchEvent.bind(c)};
var f=new d(e,["handleEvent"]),g=b.addEventListener;b.addEventListener=function(a,b){c._namedListeners[a]||g(a,f);c.addEventListener(a,b)};var k=b.removeEventListener;b.removeEventListener=function(a,b){c.removeEventListener(a,b);c._namedListeners[a]||k(a,f)}}e=s(a);e=h.registerService(a.names||a.type,b,e);D[a.serviceId]={registration:e,proxy:b}}function z(){h.persist(a,{created:u,headers:A,services:B,autostart:C,lastModified:M})}var q=this,c=c||{},u=c.created||(new Date).getTime(),A=c.headers||{},
B=c.services||[],C=c.autostart,M=c.lastModified||0,E="installed",N,I,H,J,D={},O=0,P=0,R={},S={},T={},Y={},U;this._persist=z;this._resolve=function(){E="resolved";h.dispatchEvent(new e("resolved",q))};this._getAutostart=function(){return C};this._getCreated=function(){return u};this.getLocation=function(){return a};this.getHeaders=function(){return JSON.parse(JSON.stringify(A))};this.getName=function(){var a=this.getHeaders();return a?a.name||"":null};this.getVersion=function(){var a=this.getHeaders();
return a?a.version||"0.0.0":null};this.getLastModified=function(){return M};this.getServiceReferences=function(){var a=[];Object.keys(D).forEach(function(b){a.push(D[b].registration.getReference())});return a};this.setParent=function(a){return J!==a?(J=a,q.stop({"transient":!0}).then(function(){if("started"===C)return q.start({"transient":!0});if("lazy"===C)return q.start({lazy:!0,"transient":!0})})):(new g).resolve()};this.getState=function(){return E};this.start=function(c){if("uninstalled"===E)return(new g).reject(Error("Plugin is uninstalled"));
if(N)return N.promise.then(this.start.bind(this,c));if("active"===E)return(new g).resolve();if(!c||!c.transient){var d=c&&c.lazy?"lazy":"started";d!==C&&(C=d,z())}d=h.getState();if("starting"!==d&&"active"!==d)return c.transient?(new g).reject(Error("start transient error")):(new g).resolve();if("installed"===E)try{this._resolve()}catch(f){return(new g).reject(f)}"resolved"===E&&B.forEach(function(a){v(a)});if(c&&c.lazy)return"starting"!==E&&(E="starting",h.dispatchEvent(new e("lazy activation",q))),
(new g).resolve();var k=new g;N=k;E="starting";h.dispatchEvent(new e("starting",q));I=new g;H=h.connect(a,y,J);I.then(function(){I=null;E="active";h.dispatchEvent(new e("started",q));N=null;k.resolve()},function(){I=null;E="stopping";h.dispatchEvent(new e("stopping",q));Object.keys(D).forEach(function(a){D[a].registration.unregister();delete D[a]});h.disconnect(H);H=null;E="resolved";N=null;h.dispatchEvent(new e("stopped",q));k.reject(Error("plugin activation error"))});return k.promise};this.stop=
function(a){if("uninstalled"===E)return(new g).reject(Error("Plugin is uninstalled"));if(N)return N.promise.then(this.stop.bind(this,a));if((!a||!a.transient)&&"stopped"!==C)C="stopped",z();if("active"!==E&&"starting"!==E)return(new g).resolve();N=a=new g;E="stopping";h.dispatchEvent(new e("stopping",q));Object.keys(D).forEach(function(a){D[a].registration.unregister();delete D[a]});H&&(h.disconnect(H),H=null);E="resolved";N=null;h.dispatchEvent(new e("stopped",q));a.resolve();return a.promise};U=
function(c){if("uninstalled"===E)return(new g).reject(Error("Plugin is uninstalled"));if(!c)return 0===M&&(M=(new Date).getTime(),z()),h.loadManifest(a).then(U);var d=A,f=B,k=C;A=c.headers||{};B=c.services||{};C=c.autostart||C;c.lastModified?M=c.lastModified:(M=(new Date).getTime(),z());if(p(A,d)&&p(B,f)&&C===k)return(new g).resolve();if("active"===E||"starting"===E){var l=[];Object.keys(B).forEach(function(a){var b=B[a];l.push(a);var c=D[a];if(c){if(p(b.methods,Object.keys(c.proxy))){var a=s(b),
d=c.registration.getReference(),e={};d.getPropertyKeys().forEach(function(a){e[a]=d.getProperty(a)});p(a,e)||c.registration.setProperties(a);return}c.registration.unregister();delete D[a]}v(b)});Object.keys(D).forEach(function(a){-1===l.indexOf(a)&&(D[a].registration.unregister(),delete D[a])})}"active"===E&&(h.disconnect(H),I=new g,H=h.connect(a,y,J),I.then(function(){I=null},function(){I=null;E="stopping";h.dispatchEvent(new e("stopping"),q);Object.keys(D).forEach(function(a){D[a].registration.unregister();
delete D[a]});h.disconnect(H);H=null;E="resolved";h.dispatchEvent(new e("stopped",q))}));return(new g).resolve()};this.update=function(a){return U(a).then(function(){h.dispatchEvent(new e("updated",q))})};this.uninstall=function(){if("uninstalled"===E)return(new g).reject(Error("Plugin is uninstalled"));if("active"===E||"starting"===E||"stopping"===E)return this.stop().then(this.uninstall.bind(this),this.uninstall.bind(this));h.removePlugin(this);E="uninstalled";h.dispatchEvent(new e("uninstalled",
q));return(new g).resolve()}}var c=/^http[s]?/i;return{Plugin:h,PluginRegistry:function(b,d){function f(a){var b=a.source;z.some(function(c){if(b===c.target){try{var d;if("undefined"===typeof c.useStructuredClone){var e="string"!==typeof a.data;d=e?a.data:JSON.parse(a.data);c.useStructuredClone=e}else d=c.useStructuredClone?a.data:JSON.parse(a.data);c.handler(d)}catch(f){}return!0}})}var d=d||{},l=d.storage||localStorage;if(!l.getItem){var p=l,w=null,t={key:function(a){return(w=w||Object.keys(p))[a]},
getItem:function(a){return p[a]},setItem:function(a,b){p[a]=b;w=null},removeItem:function(a){delete p[a];w=null},clear:function(){(w=w||Object.keys(p)).forEach(function(a){delete p[a]}.bind(this));w=null}};Object.defineProperty(t,"length",{get:function(){return(w=w||Object.keys(p)).length}});l=t}var y="installed",s,v=[],z=[],q=new n,u={},A={registerService:b.registerService.bind(b),connect:function(a,b,c,d){function e(a){a=Error(a);a.name="timeout";b({method:"timeout",error:a})}var f={handler:b,url:a},
g=setTimeout(e.bind(null,"Load timeout for: "+a),d||15E3),h=document.createElement("iframe");h.name=a+"_"+(new Date).getTime();h.src=a;h.onload=function(){clearTimeout(g);g=setTimeout(e.bind(null,"Plugin handshake timeout for: "+a),5E3)};h.sandbox="allow-scripts allow-same-origin";h.style.width=h.style.height="100%";h.frameBorder=0;(c||s).appendChild(h);f.target=h.contentWindow;f.close=function(){clearTimeout(g);if(h){var a=h.parentNode;a&&a.removeChild(h);h=null}};z.push(f);return f},disconnect:function(a){for(var b=
...
this.getName=function(){return"System"};this.getVersion=function(){return"0.0.0"};this.getLastModified=function(){return 0};this.getState=A.getState;this.init=function(){if(!("starting"===y||"active"===y||"stopping"===y)){addEventListener("message",f,!1);for(var b=[],c=0,e=l.length;c<e;c++)b.push(l.key(c));b.forEach(function(a){if(0===a.indexOf("plugin.")){var b=a.substring(7),a=JSON.parse(l.getItem(a));a.created&&v.push(new h(b,a,A))}});v.sort(function(a,b){return a._getCreated()<b._getCreated()?
-1:1});d.parent?s=d.parent:(s=document.createElement("div"),d.visible||(s.style.display="none",s.style.visibility="hidden"),document.body.appendChild(s));d.plugins&&Object.keys(d.plugins).forEach(function(b){b=a(b);if(!this.getPlugin(b)){var c=d.plugins[b],c="object"===typeof c||{};c.autostart=c.autostart||d.defaultAutostart||"lazy";v.push(new h(b,c,A))}}.bind(this));y="starting"}};this.start=function(){"starting"!==y&&this.init();if("starting"!==y)return(new g).reject("Cannot start framework. Framework is already "+
...
"active"})};this.stop=function(){if("starting"!==y&&"active"!==y)return(new g).reject("Cannot stop registry. Registry is already "+y+".");y="stopping";var a=[];v.forEach(function(b){a.push(b.stop({"transient":!0}))});return g.all(a,function(a){console.log("PluginRegistry.stop "+a)}).then(function(){if(!d.parent){var a=s.parentNode;a&&a.removeChild(s)}s=null;removeEventListener("message",f);y="resolved"})};this.update=function(){this.stop().then(this.start.bind(this))};this.uninstall=function(){return(new g).reject("Cannot uninstall registry")};
this.installPlugin=function(b,c){var b=a(b),d=this.getPlugin(b);if(d)return(new g).resolve(d);if(u[b])return u[b];if(c)return d=new h(b,c,A),v.push(d),d._persist(),A.dispatchEvent(new e("installed",d)),(new g).resolve(d);var f=A.loadManifest(b).then(function(a){d=new h(b,a,A);v.push(d);d._persist();delete u[b];A.dispatchEvent(new e("installed",d));return d},function(a){delete u[b];throw a;});return u[b]=f};this.getPlugins=function(){return v.slice()};this.getPlugin=function(b){var c=null,b=a(b);v.some(function(a){if(b===
a.getLocation())return c=a,!0});return c};this.addEventListener=q.addEventListener.bind(q);this.removeEventListener=q.removeEventListener.bind(q);this.resolvePlugins=function(){var a=!0;v.forEach(function(b){a=a&&b._resolve()});return a}}}});var _browser_script_source=null,_all_script=document.getElementsByTagName("script");
...
f),h=!0;else if(0===e.pathname.indexOf("/project/"))d||(d=(new URL("/ccm01",f)).href),f=new URL(d+"/service/com.ibm.team.filesystem.service.jazzhub.IOrionFilesystem/sr/pluginOrionWs.html?"+f),h=!0;else throw"Bad Repo URL - "+f;var b=new n.ServiceRegistry,e={};e[f.href]=!0;(new p.PluginRegistry(b,{storage:{},plugins:e})).start().then(function(){this._fileBrowser=new g.FileBrowser({parent:a.parentId,showBranch:!0,showComponent:h,rootName:a.rootName,serviceRegistry:b})}.bind(this))}a.prototype={getFileBrowser:function(){return this._fileBrowser}};
return a});orion=this.orion||(this.orion={});var browse=orion.browse||(orion.browse={});browse.browser=require("browse/builder/browse");
...
define([
     ...
     * @return {Element}
     */
    DebugPane.prototype._createDebugCommandButton = function(className, displayText, disabled, hideOnDisabled) {
    ...
    DebugPane.prototype._getSourceProjectPath = function(source) {
        if (source.sourceReference) {
            return '/debug/file/' + this._debugSocket.getId() + '/' + source.sourceReference + '/' + source.path;
        } else {

		...
		build : function(){
			...
			return new mWizard.WizardPage({
				...
				render: function(){
					...
					if(!isRendered() || target.Org != self._getTargetSelection().getSelection().Org ||  target.Space != self._getTargetSelection().getSelection().Space ||  target.Url != self._getTargetSelection().getSelection().Url){

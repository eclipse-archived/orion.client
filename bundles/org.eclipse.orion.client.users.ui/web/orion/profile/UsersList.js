...
eclipse.UsersList = (function(){
	...
	UsersList.prototype.loadUsers = function(){
		...
		this.createTree(this.parentId, new mExplorer.ExplorerFlatModel("/users", service.getUsersList));
	};
	...
	UsersList.prototype = {
		...
		deleteUser : function(userName, userLocation) {
			if (confirm("Do you want to delete user " + userName + "?")) {
				this.registry.getService("orion.core.user").deleteUser(userLocation, dojo.hitch(this, function(jsonData, secondArg) {
					this.reloadUsers();
				}));
			}
		}

		...
		getChildren: function(parentItem, onComplete) {
			...
			var getSimpleLog = function() {
				return Deferred.when(that.log || that._getLog(parentItem), function(log) {
					...
					if (section && that.currentBranch && that.currentBranch.Detached) {
						section.setTitle(i18nUtil.formatMessage(messages['DetachedHead ${0}'], util.shortenSHA(that.currentBranch.SHA)));
					}

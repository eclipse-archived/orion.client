...
//					detailsView.className = "stretch"; //$NON-NLS-0$
					...
					actionsArea = document.createElement("ul"); //$NON-NLS-0$
					actionsArea.className = "layoutRight commandList toolComposite commitCommands"; //$NON-NLS-0$
					actionsArea.id = itemActionScope;
					var moreDiv = detailsView.getElementsByClassName("gitCommitMore")[0].parentNode;

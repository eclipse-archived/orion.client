...
define([
	...
	//				commandRegistry.registerCommandContribution(selectionNodeScope, "eclipse.orion.git.precommitAndPushCommand", 200, "eclipse.gitCommitGroup"); //$NON-NLS-0$
				...
				commandRegistry.registerCommandContribution(actionsNodeScope, "eclipse.checkoutHead", 2); //$NON-NLS-1$ //$NON-NLS-0$
				...
				commandRegistry.registerCommandContribution(actionsNodeScope, "eclipse.openGitCommit", 8); //$NON-NLS-1$ //$NON-NLS-0$
				commandRegistry.registerCommandContribution(actionsNodeScope, "eclipse.orion.git.showCommitPatchCommand", 9); //$NON-NLS-1$ //$NON-NLS-0$

...
(function() {
	...
	exports.createFileCommands = function(serviceRegistry, commandService, explorer, toolbarId) {
		...
		var pushCallbackTags = mGitPushLogic(serviceRegistry, commandService, explorer, toolbarId,true,true).perform;
		var pushCallbackNoTags = mGitPushLogic(serviceRegistry, commandService, explorer, toolbarId,true,false).perform;
	...
	exports.createGitStatusCommands = function(serviceRegistry, commandService, explorer) {
		...
		var logic = mGitCommitLogic(serviceRegistry,commandService,explorer,true);
	...
	exports.createSharedCommands = function(serviceRegistry, commandService, explorer, toolbarId, selectionTools, fileClient) {
		...
		var closeDialogCallback = function() { explorer.changedItem(); }; //used both as confirm and remotePrompter dialogs callback
		
		var pushLogic = mGitPushLogic(serviceRegistry, commandService, explorer, toolbarId,true,true,closeDialogCallback,closeDialogCallback);
		var commitLogic = mGitCommitLogic(serviceRegistry, commandService, explorer,false);

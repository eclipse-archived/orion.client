...
//									console.info("Folder project is used");
	...
	exports.createSharedCommands = function(serviceRegistry, commandService, explorer, toolbarId) {
		...
		var updateSubmodulesCommand = new mCommands.Command({
			name: messages["UpdateSubmodules"],
			tooltip: messages["Update Submodules"],
		...
		var deleteSubmodulesCommand = new mCommands.Command({
			name: messages["DeleteSubmodule"],
			tooltip: messages["Delete Submodule"],
		...
		var syncSubmodulesCommand = new mCommands.Command({
			name: messages["SyncSubmodules"],
			tooltip: messages["Sync Submodules"],
			imageClass: "git-sprite-apply-patch",

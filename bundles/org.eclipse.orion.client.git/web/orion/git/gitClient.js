...
eclipse.GitService = (function() {
	...
	GitService.prototype = /** @lends eclipse.GitService.prototype */
	{
		...
		updateSubmodules : function(submoduleLocation){
			var service = this;
			var postData = {};
			postData.OperationType = "submodule";
		...
		syncSubmodules : function(submoduleLocation){
			var service = this;
			var postData = {};
			postData.OperationType = "submodule";//$NON-NLS-0$
		...
		deleteSubmodule : function(submoduleLocation, parents){
			...
			postData.SubmodulePath = submoduleLocation;//$NON-NLS-0$
			postData.Parents = parents;//$NON-NLS-0$
			var clientDeferred = new Deferred();
			xhr("PUT", submoduleLocation, { 
				headers : { 
					"Orion-Version" : "1",

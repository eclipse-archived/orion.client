...
define([
	...
	return function(dependencies) {
		...
		var performDrop = function(data) {
			...
			gitService.doStashDrop(dropLocation).then(function(){
				d.resolve(data);
			}, function(error){
				d.reject(error);
			});
		...
		var performApply = function(data) {
			...
			gitService.doStashApply(applyLocation).then(function(){
				d.resolve(data);
			}, function(error){
				d.reject(error);
			});
		...
		var performPop = function(data) {
			...
			gitService.doStashPop(gitStashLocation).then(function(){
				d.resolve(data);
			}, function(error){
				d.reject(error);
			});

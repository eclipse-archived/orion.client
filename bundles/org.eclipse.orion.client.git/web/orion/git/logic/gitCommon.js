 ...
 */
define(['orion/git/util','orion/i18nUtil','orion/git/gitPreferenceStorage','orion/git/widgets/GitCredentialsDialog','orion/Deferred'],
		function(mGitUtil,i18nUtil,GitPreferenceStorage,mGitCredentials,Deferred) {
	...
	var handleSshAuthenticationError = function(serviceRegistry, errorData, options, func, title){
	...
	var gatherSshCredentials = function(serviceRegistry, data, title){

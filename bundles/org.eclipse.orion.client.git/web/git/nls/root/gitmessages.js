...
define({
	...
	"MoreStashes": "More stashes",
	"MoreStashesProgress": "Loading more stashes...",
	...
	"tracksNoBranch": "tracks no branch",
	"tracks": "tracks ${0}",
	...
	"Changes for \"${0}\" branch": "Changes for ${0}",
	"Commits for \"${0}\" branch": "Commits for ${0}",
	...
	"ChangeId:": "ChangeId:",
	"SmartChangeId": "Add Change-ID to message",
	"Committer Name:": "Committer Name:",
	"Committer Email:": "Committer Email:",
	"AuthorNamePlaceholder": "Enter author name",
	"AuthorEmailPlaceholder": "Enter author email",
	"CommitterNamePlaceholder": "Enter committer name",
	"CommitterEmailPlaceholder": "Enter committer email",
	"Name:": "Name:",
	"Author Name:": "Author Name:",
	...
	"CheckoutCommitTooltip": "Checkout this commit, creating a local branch based on its contents.",
	"CheckoutTagTooltip": "Checkout this tag, creating a local branch based on its contents.",
	"Checking out ${0}": "Checking out ${0}",
	...
	"Adding branch ${0}...": "Adding branch ${0}",
	"Removing branch ${0}...": "Removing branch ${0}",
	"Adding remote ${0}...": "Adding remote ${0}",
	"Removing remote ${0}...": "Removing remote ${0}",
	"Removing repository ${0}": "Removing repository ${0}",
	"Merging ${0}": "Merging ${0}",
	...
	"Reset your active branch to the state of the selected ref. Discard all staged and unstaged changes.": "Reset your active branch to the state of this reference. Discard all staged and unstaged changes.",
	...
	"ShowCommitPatchTip": "Show patch for changes in this commit",
	"Continue": "Continue",
	"Contibue Rebase": "Continue Rebase",
	...
	"Active Branch (${0})": "Active Branch (${0})",
	"Branch (${0})": "Branch (${0})",
	"Tag (${0})": "Tag (${0})",
	"Commit (${0})": "Commit (${0})",
	"StashCommit (${0})": "Stash (${0})",
	"RemoteTrackingBranch (${0})": "Remote Branch (${0})",
	...
	"Committer:" : "Committer:",
	"SHA1:" : "SHA1:",
	"ShowActiveBranch" : "Show Active Branch",
	"ShowReference": "Show Reference",
	"ShowActiveBranchTooltip": "Show the history of the active branch against the selected reference.",
	"ShowReferenceTooltip": "Show the history of the selected reference.",
	"Path:" : "Path:",

...
define({//Default message bundle
	...
	"Please make sure at least one change is checked to be included in the patch": "Please make sure at least one change is checked to be included in the patch", //$NON-NLS-0$  //$NON-NLS-1$ 

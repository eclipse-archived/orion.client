...
define([
	...
	"text!js-tests/editor/textStyler/vbhtml/text.vbhtml",
	"text!js-tests/editor/textStyler/vbhtml/styles.txt"
], function(mVBHTML, mText, mStyles) {

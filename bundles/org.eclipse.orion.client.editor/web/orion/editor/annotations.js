...
define("orion/editor/annotations", ['i18n!orion/editor/nls/messages', 'orion/editor/eventTarget'], function(messages, mEventTarget) { //$NON-NLS-2$ //$NON-NLS-1$ //$NON-NLS-0$
	...
	*/
	...
	/**
	 * Diff Addition annotation type.
	 */
	AnnotationType.ANNOTATION_DIFF_ADDITION = "orion.annotation.diffAddition"; //$NON-NLS-0$
	/**
	 * Diff Deletion annotation type.
	 */
	AnnotationType.ANNOTATION_DIFF_DELETION = "orion.annotation.diffDeletion"; //$NON-NLS-0$
	/**
	...
	registerType(AnnotationType.ANNOTATION_DIFF_ADDITION);
	registerType(AnnotationType.ANNOTATION_DIFF_DELETION);

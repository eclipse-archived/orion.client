...
({
    ...
    modules: (function() {
        var modules = [
            ...
            { name: "plugins/languages/go/goPlugin.html" },
            { name: "plugins/languages/haml/hamlPlugin.html" },
            { name: "plugins/languages/java/javaPlugin" },
            { name: "plugins/languages/lua/luaPlugin.html" },
            { name: "plugins/languages/markdown/markdownPlugin.html" },
            { name: "plugins/languages/objectiveC/objectiveCPlugin.html" },

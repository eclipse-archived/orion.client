...
function getDomain(req, res) {
	...
	getCFdomains(req.user.username, targetRequest.Url, targetRequest.Org, domainName, defaultDomainMode)
...
function getCFdomains(UserId, targetUrl, orgName, domainName, defaultDomainMode) {

...
function getOrgsRequest(userId, targetRequest){
	...
	var simpleorgsArray = [];
	return cfutil.cfRequest('GET', userId, null,targetRequest.Url + '/v2/organizations', {'inline-relations-depth':'1'})
		...
		return new Promise(function(fulfill,reject){
			if(completeOrgsArray){
				async.each(completeOrgsArray, function(resource, cb) {
					var space = [];
					var orgWithSpace = {};
					return cfutil.cfRequest('GET', userId, null, targetRequest.Url + resource.entity.spaces_url, {'inline-relations-depth':'1'})

...
function getService(req, res){
	...
	new Promise(function(fulfill, reject) {
		...
		function doRequest(serviceUrl){
			return cfutil.cfRequest('GET', req.user.username, task, targetURL + serviceUrl,{'inline-relations-depth':'1','return_user_provided_service_instances':'true'});
		}
...
function getCFService(userId, targetURL,serviceGuid){
	return cfutil.cfRequest('GET', userId, null , targetURL + '/v2/services/' + serviceGuid);
}
};
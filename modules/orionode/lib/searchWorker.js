...
try {
	...
	function search(originalUrl, workspaceDir, contextPath, userId, indexDir, isElectron, usingIndex, isIndexForCurrentWorkspaceExsit) {
	...
	this.onmessage = function(event) {
		search(event.data.originalUrl, event.data.workspaceDir, event.data.contextPath, event.data.userId, event.data.indexDir, event.data.isElectron, event.data.usingIndex, event.data.isIndexForCurrentWorkspaceExsit)

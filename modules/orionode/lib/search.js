...
module.exports = function(options) {
	...
	.get('*', function(req, res) {
		...
		var excludeNames = (generalSetting ? generalSetting.settings.generalSettings.indexExcludeFileNames : ["node_modules"]) || ["node_modules"];
		search(req.originalUrl, req.user.workspaceDir, req.contextPath, req.user.username, options.indexDir, options.configParams.isElectron, usingIndex, isIndexForCurrentWorkspaceExsit, excludeNames)

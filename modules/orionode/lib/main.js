...
function registerContextMenu() {
	...
	document.addEventListener("click", function(evt) { 
		if (clickInsideElement(evt, 'context-menu-item')) {
			...
			Array.prototype.forEach.call(contextSrcEl.parentNode.childNodes, function(eachOne) {
				if(eachOne.id !== contextSrcEl.id){
					 contextSrcEl.parentNode.removeChild(eachOne);
				}
			});
			Array.prototype.forEach.call(corrspondingiframe.parentNode.childNodes, function(eachOne) {

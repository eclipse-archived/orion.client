		...
		return fs.readFileAsync("orionIndex.json", "utf8").then(function (file) {
			...
			if (oldfilePath) {
				...
				if(oldIndexEntry){
					...
					// Means a folder has been deleted or renamed
					indexing(workspaceDir);
					return;
				}
			}
			...
			return Promise.resolve(addNewIndexPromise).then(function () {

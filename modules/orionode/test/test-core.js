...
describe("Orion server core", function() {
	// before(function() {
	...
	// });
	/**
	 * From: org.eclipse.orion.server.tests.core.EndingAwareLinereaderTest.java
	 */
	describe("Core ending aware reader tests", function() {
		it("shouldProperlyReadStrings");
	});
	/**
	 * From: org.eclipse.orion.server.tests.core.IOUtilitiesTest.java
	 */
	describe("IO utilities tests", function() {
		it("testParseMultiPartWithURL");
		it("testParseMultiPartWithPatch");
		it("testGetQueryParameter");
	});
});